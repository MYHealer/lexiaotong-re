        ...
        if (view instanceof ViewGroup) {
            ...
            while (i6 < childCount) {
                ...
                if (i < 0 || !(childAt.getTag() instanceof String)) {
                    ...
                    if (!str2.endsWith("_0") || !str2.startsWith(TtmlNode.TAG_LAYOUT) || str2.indexOf(47) <= 0 || (iFindIncludeIndex = findIncludeIndex(str2, i7, includedLayouts, i)) < 0) {
                        i2 = i6;
                        i3 = i7;
                        z3 = false;
                    } else {
                        int i8 = iFindIncludeIndex + 1;
                        int i9 = includedLayouts.indexes[i][iFindIncludeIndex];
                        int i10 = includedLayouts.layoutIds[i][iFindIncludeIndex];
                        int iFindLastMatching = findLastMatching(viewGroup, i6);
                        if (iFindLastMatching == i6) {
                            objArr[i9] = DataBindingUtil.bind(dataBindingComponent, childAt, i10);
                            i2 = i6;
                            z3 = z4;
                            i3 = i8;
                        } else {
                            int i11 = iFindLastMatching - i6;
                            int i12 = i11 + 1;
                            View[] viewArr = new View[i12];
                            int i13 = 0;
                            while (i13 < i12) {
                                viewArr[i13] = viewGroup.getChildAt(i6 + i13);
                                i13++;
                                i8 = i8;
                            }
                            objArr[i9] = DataBindingUtil.bind(dataBindingComponent, viewArr, i10);
                            i3 = i8;
                            i2 = i6 + i11;
                            z3 = true;
                        }
