...
public class Grid extends VirtualLayout {
    ...
    private boolean generateGrid(boolean z) {
        ...
        boolean zHandleSkips = (str == null || str.trim().isEmpty() || (spans2 = parseSpans(this.mStrSkips)) == null) ? true : handleSkips(spans2) & true;
    ...
    private int[][] parseSpans(String str) {
        ...
        for (int i = 0; i < strArrSplit.length; i++) {
            String[] strArrSplit2 = strArrSplit[i].trim().split(x.bQ);
