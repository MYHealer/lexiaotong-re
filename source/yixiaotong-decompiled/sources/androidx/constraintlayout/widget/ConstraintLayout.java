...
public class ConstraintLayout extends ViewGroup {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i6 != 1) {
                if (i6 == 2) {
                    ...
                    childMeasureSpec = ViewGroup.getChildMeasureSpec(this.mLayoutWidthSpec, i5 + constraintWidget.getHorizontalMargin(), -1);
                } else if (i6 != 4) {
                    iMakeMeasureSpec = 0;
                } else {
            ...
            if (i7 == 1) {
                ...
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.mLayoutHeightSpec, i4 + constraintWidget.getVerticalMargin(), -1);
            } else if (i7 != 4) {
                iMakeMeasureSpec2 = 0;
            } else {
                iMakeMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.mLayoutHeightSpec, i4, -2);
            ...
            if (measure.measureStrategy != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && measure.measureStrategy != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z5 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z6 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                ...
                if (measuredWidth == iMax && measuredHeight == iMax2) {
                    ...
                    int iMakeMeasureSpec3 = measuredHeight != iMax2 ? View.MeasureSpec.makeMeasureSpec(iMax2, 1073741824) : iMakeMeasureSpec2;
    ...
    /* JADX WARN: Code duplicated, block: B:17:0x0040 A[PHI: r3
 ...
 binds: [B:20:0x004c, B:16:0x003e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:6:0x001b A[PHI: r2
