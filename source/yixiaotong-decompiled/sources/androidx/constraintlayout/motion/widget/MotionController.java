...
public class MotionController {
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            for (int i6 = 0; i6 < i3; i6++) {
                if (motionPathsArr[i6].mAttributes.containsKey(str8) && (constraintAttribute = motionPathsArr[i6].mAttributes.get(str8)) != null) {
        ...
        for (int i12 = 0; i12 < i3; i12++) {
            ...
            dArr2[i12] = motionPathsArr[i12].mTime;
        }
        int i13 = 0;
        while (true) {
            ...
            if (iArr2[i13] < MotionPaths.sNames.length) {
                String str9 = MotionPaths.sNames[this.mInterpolateVariables[i13]] + " [";
        ...
        while (true) {
            ...
            while (i16 < i3) {
                if (motionPathsArr[i16].hasCustomData(str10)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i3];
                        dArr4 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i3, motionPathsArr[i16].getCustomDataCount(str10));
                    }
                    dArr3[i17] = motionPathsArr[i16].mTime;
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i18 = 0; i18 < i3; i18++) {
                ...
                dArr5[i18] = motionPathsArr[i18].mTime;
                dArr6[i18][0] = motionPathsArr[i18].mX;
                dArr6[i18][1] = motionPathsArr[i18].mY;
            }
    ...
    void endTrigger(boolean z) {
        if (!a.hnadsk.equals(Debug.getName(this.mView)) || this.mKeyTriggers == null) {
            return;
        }
        int i = 0;
        while (true) {
    ...
    boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            i = 1;
            float f5 = this.mStartMotionPath.mX + ((this.mEndMotionPath.mX - this.mStartMotionPath.mX) * f4);
            float f6 = f5 + 0.5f;
            int i4 = (int) f6;
            float f7 = this.mStartMotionPath.mY + ((this.mEndMotionPath.mY - this.mStartMotionPath.mY) * f4) + 0.5f;
            int i5 = (int) f7;
