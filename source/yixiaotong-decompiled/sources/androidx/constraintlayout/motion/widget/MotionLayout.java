...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            String strConcat2;
            String strConcat3;
            StringBuilder sb = new StringBuilder(PPSLabelView.Code);
            ...
            if (constraintAnchor != null) {
                strConcat = ExifInterface.GPS_DIRECTION_TRUE.concat(constraintWidget.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : "B");
            } else {
                strConcat = "__";
            }
            ...
            if (constraintWidget.mLeft.mTarget != null) {
                strConcat3 = "L".concat(constraintWidget.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
            } else {
                strConcat3 = "__";
            }
            StringBuilder sbAppend3 = new StringBuilder().append(sbAppend2.append(strConcat3).toString());
            if (constraintWidget.mRight.mTarget != null) {
                strConcat4 = "R".concat(constraintWidget.mRight.mTarget.mType != ConstraintAnchor.Type.LEFT ? "R" : "L");
            }
            Log.v(MotionLayout.TAG, str + sbAppend3.append(strConcat4).toString() + " ---  " + constraintWidget);
        }

        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String str2 = str + PPSLabelView.Code + Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str3 + "  " + name + PPSLabelView.Code + constraintWidget + PPSLabelView.Code + str4);
            }
                ...
                if (motionController2 == null) {
                    ...
                    if (this.mStart == null) {
                        if (MotionLayout.this.mInRotation) {
                            motionController2.setStartState(MotionLayout.this.mPreRotate.get(childAt2), childAt2, MotionLayout.this.mRotatMode, MotionLayout.this.mPreRotateWidth, MotionLayout.this.mPreRotateHeight);
                        }
                        if (this.mEnd == null) {
    ...
    private class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> map, int i, int i2) {
            ...
            if (!MotionLayout.this.isInEditMode() && (i2 & 1) == 2) {
                String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + x.bQ + MotionLayout.this.getProgress();
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            Log.v(TAG, PPSLabelView.Code + Debug.getLocation() + PPSLabelView.Code + Debug.getName(this) + PPSLabelView.Code + Debug.getName(getContext(), this.mCurrentState) + PPSLabelView.Code + Debug.getName(childAt) + childAt.getLeft() + PPSLabelView.Code + childAt.getTop());
        }
    }
  ...
  0x00e2: PHI (r3v50 float) = (r3v49 float), (r3v51 float), (r3v51 float) binds: [B:47:0x00ab, B:58:0x00d6, B:60:0x00da] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    void evaluate(boolean z) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (z || this.mTransitionGoalPosition != f))) {
            ...
            float f2 = !(interpolator3 instanceof MotionInterpolator) ? (((nanoTime2 - this.mTransitionLastTime) * fSignum) * 1.0E-9f) / this.mTransitionDuration : 0.0f;
