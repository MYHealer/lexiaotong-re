...
public class Utils {
    ...
    public static void logStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= iMin; i2++) {
            ...
            String str3 = ".(" + stackTraceElement.getFileName() + x.bQ + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName();
    ...
    public static void log(String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + x.bQ + stackTraceElement.getLineNumber() + ")" + "    ".substring(Integer.toString(stackTraceElement.getLineNumber()).length()) + (stackTraceElement.getMethodName() + "                  ").substring(0, 17);
        System.out.println(str2 + PPSLabelView.Code + str);
        DebugHandle debugHandle = sOurHandle;
        if (debugHandle != null) {
            debugHandle.message(str2 + PPSLabelView.Code + str);
        }
    }
}
