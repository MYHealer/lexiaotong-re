...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        String str2 = ((str + " ===== " + this.mType + IOUtils.LINE_SEPARATOR_UNIX) + str + (this.mBackwards ? "backwards" : "forward ") + " time = " + f + "  stages " + this.mNumberOfStages + IOUtils.LINE_SEPARATOR_UNIX) + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + IOUtils.LINE_SEPARATOR_UNIX;
        if (this.mNumberOfStages > 1) {
            str2 = str2 + str + " dur " + this.mStage2Duration + " vel " + this.mStage2Velocity + " pos " + this.mStage2EndPosition + IOUtils.LINE_SEPARATOR_UNIX;
        }
        if (this.mNumberOfStages > 2) {
            str2 = str2 + str + " dur " + this.mStage3Duration + " vel " + this.mStage3Velocity + " pos " + this.mStage3EndPosition + IOUtils.LINE_SEPARATOR_UNIX;
        }
        float f2 = this.mStage1Duration;
        if (f <= f2) {
    ...
    public static class Decelerate implements StopEngine {
        ...
        @Override // androidx.constraintlayout.core.motion.utils.StopEngine
        public String debug(String str, float f) {
            return this.mDuration + PPSLabelView.Code + this.mLastVelocity;
        }
