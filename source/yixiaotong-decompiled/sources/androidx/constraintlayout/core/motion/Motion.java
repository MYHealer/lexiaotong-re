...
public class Motion implements TypedValues {
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            for (int i6 = 0; i6 < i3; i6++) {
                if (motionPathsArr[i6].mCustomAttributes.containsKey(str8) && (customVariable = motionPathsArr[i6].mCustomAttributes.get(str8)) != null) {
        ...
        while (true) {
            ...
            for (int i17 = 0; i17 < i3; i17++) {
                if (motionPathsArr[i17].hasCustomData(str10)) {
                    ...
                    dArr3[i16] = motionPathsArr[i17].mTime;
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            motionWidget.layout((int) f5, (int) f6, (int) (f5 + this.mStartMotionPath.mWidth + ((this.mEndMotionPath.mWidth - this.mStartMotionPath.mWidth) * f4)), (int) (f6 + this.mStartMotionPath.mHeight + ((this.mEndMotionPath.mHeight - this.mStartMotionPath.mHeight) * f4)));
        }
