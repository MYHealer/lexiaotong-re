...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo11clone() {
        CLContainer cLContainer = (CLContainer) super.mo11clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement cLElementMo11clone = it.next().mo11clone();
            cLElementMo11clone.setContainer(cLContainer);
            arrayList.add(cLElementMo11clone);
        }
