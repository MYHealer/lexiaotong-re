...
public class PriorityGoalRow extends ArrayRow {
    ...
    class GoalVariableAccessor {
        ...
        public String toString() {
            ...
            if (this.mVariable != null) {
                for (int i = 0; i < 9; i++) {
                    str = str + this.mVariable.mGoalStrengthVector[i] + PPSLabelView.Code;
                }
            }
    ...
    public SolverVariable getPivotCandidate(LinearSystem linearSystem, boolean[] zArr) {
        ...
        for (int i2 = 0; i2 < this.mNumGoals; i2++) {
            ...
            if (!zArr[solverVariable.id]) {
                ...
                } else if (this.mAccessor.isSmallerThan(this.mArrayGoals[i])) {
                    i = i2;
                }
            }
        }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mNumGoals; i++) {
            ...
            str = str + this.mAccessor + PPSLabelView.Code;
        }
        return str;
    }
}
