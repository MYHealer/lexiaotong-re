...
public class GridCore extends VirtualLayout {
        ...
        try {
            ...
            if (this.mRows == 1 || this.mColumns == 1) {
                ...
                for (int i3 = 0; i3 < strArrSplit.length; i3++) {
                    String[] strArrSplit2 = strArrSplit[i3].trim().split(x.bQ);
                ...
                for (int i4 = 0; i4 < strArrSplit.length; i4++) {
                    String[] strArrSplit3 = strArrSplit[i4].trim().split(x.bQ);
    ...
    static /* synthetic */ int lambda$parseSpans$0(String str, String str2) {
        return Integer.parseInt(str.split(x.bQ)[0]) - Integer.parseInt(str2.split(x.bQ)[0]);
    }
