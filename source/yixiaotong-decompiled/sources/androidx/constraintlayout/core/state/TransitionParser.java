...
public class TransitionParser {
    ...
    public static void parse(CLObject cLObject, Transition transition) throws CLParsingException {
        ...
        if (!Float.isNaN(floatOrNaN)) {
            ...
            objectOrNull = cLObject.getObjectOrNull("onSwipe");
            ...
            while (i8 < size2) {
                ...
                if (cLKey.getValue() instanceof CLArray) {
                    ...
                    if (size3 != size || size3 <= 0) {
                        ...
                        int i9 = 0;
                        while (i9 < size) {
                            customVariableArr[i9][i8] = new CustomVariable(strContent, 901, cLArray.get(i9).getFloat());
                            i9++;
                            cLObject3 = cLObject3;
                        }
                        cLObject2 = cLObject3;
                        ...
                        while (i10 < size) {
                            ...
                            if (colorString != -1) {
                                customVariableArr[i10][i8] = new CustomVariable(strContent, 902, (int) colorString);
                            }
                            i10++;
                            size2 = size2;
                        }
                    ...
                    if (value instanceof CLNumber) {
                        ...
                        for (int i11 = 0; i11 < size; i11++) {
                            customVariableArr[i11][i8] = new CustomVariable(strContent, 901, f);
                        }
                    } else {
                        ...
                        if (colorString2 != -1) {
                            int i12 = 0;
                            while (i12 < size) {
                                customVariableArr[i12][i8] = new CustomVariable(strContent, 902, (int) colorString2);
                                i12++;
    ...
    private static void parseKeyCycle(CLObject cLObject, Transition transition) throws CLParsingException {
        ...
        CLArray array2 = cLObject.getArray("frames");
        String stringOrNull = cLObject.getStringOrNull("transitionEasing");
        String[] strArr = {"scaleX", "scaleY", "translationX", "translationY", "translationZ", "rotationX", "rotationY", "rotationZ", "alpha", "period", TypedValues.CycleType.S_WAVE_OFFSET, TypedValues.CycleType.S_WAVE_PHASE};
