...
public class Transition implements TypedValues {
    ...
    static class OnSwipe {
        ...
        private long mStart;
        public static final String[] SIDES = {Constant.MAP_KEY_TOP, TtmlNode.LEFT, TtmlNode.RIGHT, "bottom", "middle", "start", TtmlNode.END};
    ...
    public float[] getPath(String str) {
        WidgetState widgetState = this.mState.get(str);
        float[] fArr = new float[AppTypeIdUtil.NewDevice4GDrinkOTA_1];
    ...
    public static class WidgetState {
        ...
        public WidgetFrame getFrame(int i) {
            ...
            return i == 1 ? this.mEnd : this.mInterpolated;
        }
