...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindPreviousPosition != null) {
                i5 = (int) (keyPositionFindPreviousPosition.mX * i);
                i9 = i2;
            ...
            if (keyPositionFindNextPosition != null) {
                int i21 = (int) (keyPositionFindNextPosition.mX * i);
                int i22 = (int) (keyPositionFindNextPosition.mY * i9);
    ...
    public StringBuilder serialize(StringBuilder sb, boolean z) {
        ...
        add(sb, Constant.MAP_KEY_TOP, this.top);
    ...
    void printCustomAttributes() {
        ...
        String str2 = (".(" + stackTraceElement.getFileName() + x.bQ + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + PPSLabelView.Code + (hashCode() % 1000);
        if (this.widget != null) {
            str = str2 + "/" + (this.widget.hashCode() % 1000) + PPSLabelView.Code;
        } else {
            str = str2 + "/NULL ";
        }
    ...
    void logv(String str) {
        String str2;
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str3 = (".(" + stackTraceElement.getFileName() + x.bQ + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + PPSLabelView.Code + (hashCode() % 1000);
        if (this.widget != null) {
            str2 = str3 + "/" + (this.widget.hashCode() % 1000);
        } else {
            str2 = str3 + "/NULL";
        }
        System.out.println(str2 + PPSLabelView.Code + str);
    }
}
