...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public void display() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                System.out.print(variable + " = " + getVariableValue(i2) + PPSLabelView.Code);
            }
        }
        System.out.println(" }");
    }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            SolverVariable variable = getVariable(i2);
            if (variable != null) {
                String str4 = str3 + variable + " = " + getVariableValue(i2) + PPSLabelView.Code;
    ...
    private void displayHash() {
        for (int i = 0; i < this.mHashSize; i++) {
            if (this.mKeys[i] != -1) {
                ...
                boolean z = false;
                while (!z) {
                    str = str + PPSLabelView.Code + this.mVariables[i2];
