...
public class DependencyNode implements Dependency {
    ...
    public String toString() {
        return this.mRun.mWidget.getDebugName() + x.bQ + this.mType + "(" + (this.resolved ? Integer.valueOf(this.value) : "unresolved") + ") <t=" + this.mTargets.size() + ":d=" + this.mDependencies.size() + SimpleComparison.GREATER_THAN_OPERATION;
    }
    ...
    public String name() {
        ...
        return str + x.bQ + this.mType.name();
    }
