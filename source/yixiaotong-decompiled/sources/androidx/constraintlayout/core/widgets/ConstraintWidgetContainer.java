...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    /* JADX WARN: Code duplicated, block: B:158:0x0325 A[PHI: r13 r16
  0x0325: PHI (r13v8 ??) = (r13v7 ??), (r13v10 ??), (r13v10 ??), (r13v10 ??) binds: [B:145:0x02e4, B:153:0x030b, B:154:0x030d, B:156:0x0313] A[DONT_GENERATE, DONT_INLINE]
  0x0325: PHI (r16v4 boolean) = (r16v3 boolean), (r16v5 boolean), (r16v5 boolean), (r16v5 boolean) binds: [B:145:0x02e4, B:153:0x030b, B:154:0x030d, B:156:0x0313] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        while (zAddChildrenToSolver) {
            ...
            if (z5 && i8 < 8 && Optimizer.sFlags[2]) {
                ...
                while (i11 < size) {
                    ...
                    iMax3 = Math.max(iMax3, constraintWidget3.mY + constraintWidget3.getHeight());
                    i11++;
            ...
            if (r14 == 0) {
                r14 = r18;
                if (this.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT && i2 > 0) {
                    r14 = r14;
                    if (getWidth() > i2) {
