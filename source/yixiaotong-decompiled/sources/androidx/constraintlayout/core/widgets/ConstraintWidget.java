...
public class ConstraintWidget {
    ...
    private void serializeSize(StringBuilder sb, String str, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2) {
        sb.append(str);
        sb.append(" :  {\n");
        serializeAttribute(sb, OapsKey.KEY_SIZE, i, Integer.MIN_VALUE);
    ...
    public StringBuilder serialize(StringBuilder sb) {
        ...
        serializeAnchor(sb, Constant.MAP_KEY_TOP, this.mTop);
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + PPSLabelView.Code : "") + (this.mDebugName != null ? "id: " + this.mDebugName + PPSLabelView.Code : "") + "(" + this.mX + ", " + this.mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }
  ...
  0x0086: PHI (r0v2 int) = (r0v1 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int) binds: [B:46:0x0086, B:36:0x007f, B:24:0x0051, B:26:0x0057, B:28:0x0063, B:30:0x0067] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Code duplicated, block: B:251:0x045f  */
    /* JADX WARN: Code duplicated, block: B:267:0x04ba  */
    /* JADX WARN: Code duplicated, block: B:271:0x04ce A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:276:0x04dc  */
    /* JADX WARN: Code duplicated, block: B:279:0x04e2  */
    /* JADX WARN: Code duplicated, block: B:281:0x04e5  */
    /* JADX WARN: Code duplicated, block: B:284:0x04eb  */
    /* JADX WARN: Code duplicated, block: B:285:0x04f3  */
    /* JADX WARN: Code duplicated, block: B:288:0x04f9  */
    /* JADX WARN: Code duplicated, block: B:289:0x0501  */
    /* JADX WARN: Code duplicated, block: B:292:0x0507  */
    /* JADX WARN: Code duplicated, block: B:294:0x050b  */
    /* JADX WARN: Code duplicated, block: B:296:0x0511  */
    /* JADX WARN: Code duplicated, block: B:298:0x052b  */
    /* JADX WARN: Code duplicated, block: B:300:0x0538  */
    /* JADX WARN: Code duplicated, block: B:302:0x053c  */
    /* JADX WARN: Code duplicated, block: B:303:0x0546  */
    /* JADX WARN: Code duplicated, block: B:307:0x056d  */
    /* JADX WARN: Code duplicated, block: B:308:0x0570  */
    /* JADX WARN: Code duplicated, block: B:310:0x05b0  */
    /* JADX WARN: Code duplicated, block: B:312:0x05b6  */
    /* JADX WARN: Code duplicated, block: B:314:0x05bf  */
    /* JADX WARN: Code duplicated, block: B:315:0x05cf  */
    /* JADX WARN: Code duplicated, block: B:316:0x05df  */
    /* JADX WARN: Code duplicated, block: B:319:0x05e9  */
    /* JADX WARN: Code duplicated, block: B:320:0x060a  */
    /* JADX WARN: Code duplicated, block: B:323:0x0615  */
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (constraintWidget7 == null) {
            ...
            boolean z14 = constraintWidget7 != null && constraintWidget7.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            ConstraintWidget constraintWidget8 = this.mParent;
            boolean z15 = constraintWidget8 != null && constraintWidget8.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
        ...
        if (f > 0.0f && this.mVisibility != 8) {
            ...
            if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && this.mListDimensionBehaviors[1] == DimensionBehaviour.MATCH_CONSTRAINT && i16 == 3 && i17 == 3) {
                ...
                if (this.mListDimensionBehaviors[0] == DimensionBehaviour.MATCH_CONSTRAINT && i16 == 3) {
                ...
                if (z6) {
                    ...
                    if (this.mHorizontalResolution == 2 && !this.mResolvedHorizontal) {
                        if (!z || (horizontalWidgetRun = this.mHorizontalRun) == null || !horizontalWidgetRun.start.resolved || !this.mHorizontalRun.end.resolved) {
                            ...
                            SolverVariable solverVariableCreateObjectVariable8 = constraintWidget9 != null ? linearSystem.createObjectVariable(constraintWidget9.mRight) : null;
                            ConstraintWidget constraintWidget10 = this.mParent;
                            SolverVariable solverVariableCreateObjectVariable9 = constraintWidget10 != null ? linearSystem.createObjectVariable(constraintWidget10.mLeft) : null;
                            boolean z21 = this.isTerminalWidget[0];
                            DimensionBehaviour[] dimensionBehaviourArr2 = this.mListDimensionBehaviors;
                            applyConstraints(linearSystem, true, z2, z3, z21, solverVariableCreateObjectVariable9, solverVariableCreateObjectVariable8, dimensionBehaviourArr2[0], z8, this.mLeft, this.mRight, this.mX, i6, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, z19, dimensionBehaviourArr2[1] == DimensionBehaviour.MATCH_CONSTRAINT, z5, z4, z20, i3, i2, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z9);
                        } else if (z) {
                            linearSystem.addEquality(solverVariableCreateObjectVariable3, this.mHorizontalRun.start.value);
                            linearSystem.addEquality(solverVariableCreateObjectVariable4, this.mHorizontalRun.end.value);
                    ...
                    if (z || (verticalWidgetRun = this.mVerticalRun) == null || !verticalWidgetRun.start.resolved || !this.mVerticalRun.end.resolved) {
                        ...
                        solverVariable3 = solverVariableCreateObjectVariable5;
                        linearSystem3.addEquality(solverVariable3, this.mVerticalRun.start.value);
                        solverVariable2 = solverVariableCreateObjectVariable6;
                        linearSystem3.addEquality(solverVariable2, this.mVerticalRun.end.value);
                        solverVariable = solverVariableCreateObjectVariable7;
                        linearSystem3.addEquality(solverVariable, this.mVerticalRun.baseline.value);
                        ConstraintWidget constraintWidget11 = this.mParent;
                        if (constraintWidget11 == null || z4 || !z3) {
                            i7 = 8;
                            i8 = 0;
                            c = 1;
                        } else {
                            ...
                            if (this.isTerminalWidget[1]) {
                                i7 = 8;
                                i8 = 0;
                                linearSystem3.addGreaterThan(linearSystem3.createObjectVariable(constraintWidget11.mBottom), solverVariable2, 0, 8);
                            } else {
                                i7 = 8;
                                i8 = 0;
                            }
                    ...
                    if (this.mVerticalResolution != 2 && i9 != 0 && !this.mResolvedVertical) {
                        ...
                        if (constraintWidget5 != null) {
                            solverVariableCreateObjectVariable = linearSystem2.createObjectVariable(constraintWidget5.mBottom);
                        } else {
                            solverVariableCreateObjectVariable = null;
                        }
                        constraintWidget6 = this.mParent;
                        if (constraintWidget6 != null) {
                            solverVariableCreateObjectVariable2 = linearSystem2.createObjectVariable(constraintWidget6.mTop);
                        } else {
                        ...
                        applyConstraints(linearSystem, false, z3, z2, z22, solverVariableCreateObjectVariable2, solverVariableCreateObjectVariable, dimensionBehaviour, z11, constraintAnchor, constraintAnchor2, i20, i, i21, i22, f2, z7, z13, z4, z5, z10, i2, i3, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, z12);
                    }
                    if (z6) {
                        constraintWidget4 = this;
                        if (constraintWidget4.mResolvedDimensionRatioSide == 1) {
                            linearSystem.addRatio(solverVariable2, solverVariable3, solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, constraintWidget4.mResolvedDimensionRatio, 8);
                            constraintWidget3 = constraintWidget4;
                        } else {
                            linearSystem.addRatio(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, solverVariable2, solverVariable3, constraintWidget4.mResolvedDimensionRatio, 8);
                            constraintWidget3 = constraintWidget4;
                        }
                    } else {
                ...
                if (this.mVerticalResolution != 2) {
                    ...
                    applyConstraints(linearSystem, false, z3, z2, z24, solverVariableCreateObjectVariable2, solverVariableCreateObjectVariable, dimensionBehaviour2, z11, constraintAnchor3, constraintAnchor4, i23, i, i24, i25, f3, z7, z13, z4, z5, z10, i2, i3, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, z12);
                }
                if (z6) {
                    constraintWidget4 = this;
                    if (constraintWidget4.mResolvedDimensionRatioSide == 1) {
            ...
            this.mResolvedHasRatio = z6;
            if (z6) {
                int i110 = this.mResolvedDimensionRatioSide;
                i5 = -1;
                if (i110 != 0) {
                }
                if (z6) {
                ...
                if (this.mVerticalResolution != 2) {
                    ...
                    boolean z26 = this.isTerminalWidget[c];
                    dimensionBehaviourArr = this.mListDimensionBehaviors;
                    DimensionBehaviour dimensionBehaviour3 = dimensionBehaviourArr[c];
                    ConstraintAnchor constraintAnchor5 = this.mTop;
                    ConstraintAnchor constraintAnchor6 = this.mBottom;
                    int i26 = this.mY;
                    int i27 = this.mMinHeight;
                    int i28 = this.mMaxDimension[c];
                    float f4 = this.mVerticalBiasPercent;
                    if (dimensionBehaviourArr[0] == DimensionBehaviour.MATCH_CONSTRAINT) {
                        z13 = true;
                    } else {
                        z13 = false;
                    }
                    applyConstraints(linearSystem, false, z3, z2, z26, solverVariableCreateObjectVariable2, solverVariableCreateObjectVariable, dimensionBehaviour3, z11, constraintAnchor5, constraintAnchor6, i26, i, i27, i28, f4, z7, z13, z4, z5, z10, i2, i3, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, z12);
                }
                if (z6) {
                    constraintWidget4 = this;
                    if (constraintWidget4.mResolvedDimensionRatioSide == 1) {
            ...
            if (this.mVerticalResolution != 2) {
                ...
                boolean z28 = this.isTerminalWidget[c];
                dimensionBehaviourArr = this.mListDimensionBehaviors;
                DimensionBehaviour dimensionBehaviour4 = dimensionBehaviourArr[c];
                ConstraintAnchor constraintAnchor7 = this.mTop;
                ConstraintAnchor constraintAnchor8 = this.mBottom;
                int i29 = this.mY;
                int i210 = this.mMinHeight;
                int i211 = this.mMaxDimension[c];
                float f5 = this.mVerticalBiasPercent;
                if (dimensionBehaviourArr[0] == DimensionBehaviour.MATCH_CONSTRAINT) {
                    z13 = true;
                } else {
                    z13 = false;
                }
                applyConstraints(linearSystem, false, z3, z2, z28, solverVariableCreateObjectVariable2, solverVariableCreateObjectVariable, dimensionBehaviour4, z11, constraintAnchor7, constraintAnchor8, i29, i, i210, i211, f5, z7, z13, z4, z5, z10, i2, i3, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, z12);
            }
            if (z6) {
                constraintWidget4 = this;
                if (constraintWidget4.mResolvedDimensionRatioSide == 1) {
        ...
        if (z6) {
            ...
            if (this.mVerticalResolution != 2) {
                ...
                boolean z210 = this.isTerminalWidget[c];
                dimensionBehaviourArr = this.mListDimensionBehaviors;
                DimensionBehaviour dimensionBehaviour5 = dimensionBehaviourArr[c];
                ConstraintAnchor constraintAnchor9 = this.mTop;
                ConstraintAnchor constraintAnchor10 = this.mBottom;
                int i212 = this.mY;
                int i213 = this.mMinHeight;
                int i214 = this.mMaxDimension[c];
                float f6 = this.mVerticalBiasPercent;
                if (dimensionBehaviourArr[0] == DimensionBehaviour.MATCH_CONSTRAINT) {
                    z13 = true;
                } else {
                    z13 = false;
                }
                applyConstraints(linearSystem, false, z3, z2, z210, solverVariableCreateObjectVariable2, solverVariableCreateObjectVariable, dimensionBehaviour5, z11, constraintAnchor9, constraintAnchor10, i212, i, i213, i214, f6, z7, z13, z4, z5, z10, i2, i3, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, z12);
            }
            if (z6) {
                constraintWidget4 = this;
                if (constraintWidget4.mResolvedDimensionRatioSide == 1) {
        ...
        if (this.mVerticalResolution != 2) {
            ...
            boolean z212 = this.isTerminalWidget[c];
            dimensionBehaviourArr = this.mListDimensionBehaviors;
            DimensionBehaviour dimensionBehaviour6 = dimensionBehaviourArr[c];
            ConstraintAnchor constraintAnchor11 = this.mTop;
            ConstraintAnchor constraintAnchor12 = this.mBottom;
            int i215 = this.mY;
            int i216 = this.mMinHeight;
            int i217 = this.mMaxDimension[c];
            float f7 = this.mVerticalBiasPercent;
            if (dimensionBehaviourArr[0] == DimensionBehaviour.MATCH_CONSTRAINT) {
                z13 = true;
            } else {
                z13 = false;
            }
            applyConstraints(linearSystem, false, z3, z2, z212, solverVariableCreateObjectVariable2, solverVariableCreateObjectVariable, dimensionBehaviour6, z11, constraintAnchor11, constraintAnchor12, i215, i, i216, i217, f7, z7, z13, z4, z5, z10, i2, i3, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, z12);
        }
        if (z6) {
            constraintWidget4 = this;
            if (constraintWidget4.mResolvedDimensionRatioSide == 1) {
    ...
    /* JADX WARN: Code duplicated, block: B:238:0x03da  */
    /* JADX WARN: Code duplicated, block: B:244:0x03ed  */
    /* JADX WARN: Code duplicated, block: B:246:0x041c  */
    /* JADX WARN: Code duplicated, block: B:253:0x0435  */
    /* JADX WARN: Code duplicated, block: B:262:0x0457  */
    /* JADX WARN: Code duplicated, block: B:272:0x046f  */
    /* JADX WARN: Code duplicated, block: B:275:0x0475  */
    /* JADX WARN: Code duplicated, block: B:276:0x0477 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:279:0x047d A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:284:0x0486  */
    /* JADX WARN: Code duplicated, block: B:286:0x048a  */
    /* JADX WARN: Code duplicated, block: B:289:0x0490  */
    /* JADX WARN: Code duplicated, block: B:291:0x0494  */
    /* JADX WARN: Code duplicated, block: B:293:0x0498  */
    /* JADX WARN: Code duplicated, block: B:294:0x049a  */
    /* JADX WARN: Code duplicated, block: B:297:0x04a2  */
    /* JADX WARN: Code duplicated, block: B:299:0x04a8 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:303:0x04b0  */
    /* JADX WARN: Code duplicated, block: B:306:0x04c2  */
    /* JADX WARN: Code duplicated, block: B:308:0x04c6  */
    /* JADX WARN: Code duplicated, block: B:309:0x04cb  */
    /* JADX WARN: Code duplicated, block: B:311:0x04ce  */
    /* JADX WARN: Code duplicated, block: B:313:0x04d4 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:321:0x04ef  */
    private void applyConstraints(LinearSystem linearSystem, boolean z, boolean z2, boolean z3, boolean z4, SolverVariable solverVariable, SolverVariable solverVariable2, DimensionBehaviour dimensionBehaviour, boolean z5, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i, int i2, int i3, int i4, float f, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, int i5, int i6, int i7, int i8, float f2, boolean z11) {
        ...
        int i23 = zIsConnected2 ? (zIsConnected ? 1 : 0) + 1 : zIsConnected ? 1 : 0;
        if (zIsConnected3) {
            i23++;
        }
        int i24 = z6 ? 3 : i5;
        int iOrdinal = dimensionBehaviour.ordinal();
        boolean z25 = (iOrdinal == 0 || iOrdinal == 1 || iOrdinal != 2 || i24 == 4) ? false : true;
        int i25 = this.mWidthOverride;
        if (i25 == -1 || !z) {
            i25 = i2;
            z12 = z25;
        } else {
        ...
        if (!z14) {
            ...
            if (i28 > 0) {
                linearSystem.addGreaterThan(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, i28, 8);
        ...
        if (!z11 || z8) {
            int i30 = 0;
            if (i11 < c && z2 && z16) {
                linearSystem.addGreaterThan(solverVariableCreateObjectVariable3, solverVariable, i30, 8);
                int i31 = (z || this.mBaseline.mTarget == null) ? 1 : i30;
                if (!z && this.mBaseline.mTarget != null) {
                    ConstraintWidget constraintWidget5 = this.mBaseline.mTarget.mOwner;
                    if (constraintWidget5.mDimensionRatio == 0.0f || constraintWidget5.mListDimensionBehaviors[i30] != DimensionBehaviour.MATCH_CONSTRAINT || constraintWidget5.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT) {
                        return;
                    }
                } else if (i31 == 0) {
                    return;
                }
                linearSystem.addGreaterThan(solverVariable2, solverVariableCreateObjectVariable4, i30, 8);
                return;
            }
            return;
        }
        if (zIsConnected || zIsConnected2 || zIsConnected3) {
            if (zIsConnected && zIsConnected2 == 0) {
                i22 = (z2 && (constraintAnchor.mTarget.mOwner instanceof Barrier)) ? 8 : 5;
                z21 = z2;
                margin = 0;
                    ...
                    if (zIsConnected && zIsConnected2 != 0) {
                        ...
                        if (!z15) {
                                ...
                                if (this.mResolvedDimensionRatioSide == -1) {
                                    ...
                                    if (i10 > 0) {
                                        ...
                                        if (i10 != 0 || i12 != 0) {
                                            ...
                                            i13 = (constraintWidget6 == parent || constraintWidget7 == parent) ? 5 : 4;
                                        } else {
                                            solverVariable2 = solverVariable2;
                                            i32 = 6;
                                            i13 = 5;
                            ...
                            if (z18) {
                                ...
                                linearSystem.addCentering(solverVariableCreateObjectVariable3, solverVariableCreateObjectVariable5, constraintAnchor.getMargin(), f, solverVariableCreateObjectVariable6, solverVariableCreateObjectVariable4, constraintAnchor2.getMargin(), i17);
                                i13 = i18;
                                z20 = z22;
                            } else {
                                constraintWidget = parent;
                            ...
                            if (z17) {
                                ...
                                linearSystem.addGreaterThan(solverVariableCreateObjectVariable3, solverVariableCreateObjectVariable5, constraintAnchor.getMargin(), i13);
                                solverVariableCreateObjectVariable4 = solverVariableCreateObjectVariable4;
                                linearSystem.addLowerThan(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable6, -constraintAnchor2.getMargin(), i13);
                            } else {
                                solverVariableCreateObjectVariable4 = solverVariableCreateObjectVariable4;
                            }
            ...
            if (solverVariableCreateObjectVariable6 != solverVariable2) {
                ...
                linearSystem.addGreaterThan(solverVariable2, solverVariableCreateObjectVariable4, margin, i22);
                return;
            }
            return;
        }
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        getSceneString(sb, Constant.MAP_KEY_TOP, this.mTop);
