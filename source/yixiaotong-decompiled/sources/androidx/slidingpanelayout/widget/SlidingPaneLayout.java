...
public class SlidingPaneLayout extends ViewGroup {
    ...
    /* JADX WARN: Code duplicated, block: B:131:0x011f A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:40:0x00af A[PHI: r13
                        ...
                        if (!z3 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z3) {
                                    ...
                                    i4 = i9;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth3 + ((int) ((layoutParams2.weight * Math.max(0, i8)) / f)), 1073741824), iMakeMeasureSpec);
                                }
                            }
