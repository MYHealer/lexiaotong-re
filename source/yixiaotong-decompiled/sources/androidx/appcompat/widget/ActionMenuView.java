...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (true) {
            ...
            while (i22 < childCount) {
                ...
                if ((j2 & j3) == 0) {
                    ...
                    if (z5 && layoutParams3.preventEdgeOffset && i7 == 1) {
                        int i25 = this.mGeneratedItemPadding;
                        childAt2.setPadding(i25 + i9, 0, i25, 0);
                    }
        ...
        if (i7 <= 0 || j == 0 || (i7 >= i11 - 1 && !z8 && iMax2 <= 1)) {
            ...
            int i27 = fBitCount > 0.0f ? (int) ((i7 * i9) / fBitCount) : i4;
            z2 = z;
            for (int i28 = i4; i28 < childCount; i28++) {
                if ((j & ((long) (1 << i28))) != 0) {
