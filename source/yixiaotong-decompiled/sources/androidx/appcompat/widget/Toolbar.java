...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    /* JADX WARN: Code duplicated, block: B:104:0x029e A[LOOP:0: B:103:0x029c->B:104:0x029e, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:107:0x02c0 A[LOOP:1: B:106:0x02be->B:107:0x02c0, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:111:0x02ea A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:112:0x02ec  */
    /* JADX WARN: Code duplicated, block: B:113:0x02f0  */
    /* JADX WARN: Code duplicated, block: B:116:0x02f9 A[LOOP:2: B:115:0x02f7->B:116:0x02f9, LOOP_END] */
    ...
    /* JADX WARN: Code duplicated, block: B:49:0x0129 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:59:0x014d A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Code duplicated, block: B:78:0x01b4 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:90:0x0224 A[DONT_INVERT] */
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            if (zShouldLayout) {
                ...
                measuredHeight = layoutParams3.topMargin + this.mTitleTextView.getMeasuredHeight() + layoutParams3.bottomMargin;
            } else {
                measuredHeight = 0;
            }
            if (zShouldLayout2) {
            ...
            if (!zShouldLayout || zShouldLayout2) {
                ...
                for (i15 = i7; i15 < size; i15++) {
                    iLayoutChildLeft2 = layoutChildLeft(this.mTempViews.get(i15), iLayoutChildLeft2, iArr, iMin2);
                }
                i16 = iMin2;
        ...
        if (zShouldLayout) {
            ...
            measuredHeight = layoutParams9.topMargin + this.mTitleTextView.getMeasuredHeight() + layoutParams9.bottomMargin;
        } else {
            measuredHeight = 0;
        }
        if (zShouldLayout2) {
