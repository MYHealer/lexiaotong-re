        ...
        while (i14 < size3) {
            ...
            if (view.getVisibility() == 8) {
                ...
                if (layoutParams2.keyline < 0 || mode == 0) {
                    ...
                    int iMax5 = Math.max(i4, i11 + view.getMeasuredHeight() + layoutParams4.topMargin + layoutParams4.bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i7, view.getMeasuredState());
                    i12 = iMax4;
                    i13 = iMax5;
                }
                ...
                if (behavior != null) {
                    ...
                    int iMax7 = Math.max(i4, i11 + view.getMeasuredHeight() + layoutParams5.topMargin + layoutParams5.bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i7, view.getMeasuredState());
                    i12 = iMax6;
                    i13 = iMax7;
                } else {
                ...
                int iMax9 = Math.max(i4, i11 + view.getMeasuredHeight() + layoutParams6.topMargin + layoutParams6.bottomMargin);
                iCombineMeasuredStates = View.combineMeasuredStates(i7, view.getMeasuredState());
                i12 = iMax8;
                i13 = iMax9;
            }
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i5) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    if (i3 > 0) {
                        iMin = Math.max(i6, iArr3[0]);
                    } else {
                        iMin = Math.min(i6, iArr3[0]);
                    }
                    i6 = iMin;
                    if (i4 > 0) {
                        z = true;
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i3) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    int[] iArr3 = this.mBehaviorConsumed;
                    if (i > 0) {
                        iMin = Math.max(i4, iArr3[0]);
                    } else {
                        iMin = Math.min(i4, iArr3[0]);
                    }
                    i4 = iMin;
                    int[] iArr4 = this.mBehaviorConsumed;
                    if (i2 > 0) {
                        iMin2 = Math.max(i5, iArr4[1]);
                    } else {
                        iMin2 = Math.min(i5, iArr4[1]);
                    }
                    i5 = iMin2;
                    z = true;
                }
