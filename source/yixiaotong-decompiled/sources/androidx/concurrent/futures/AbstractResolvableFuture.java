...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    static final boolean GENERATE_CANCELLATION_CAUSES = Boolean.parseBoolean(System.getProperty("guava.concurrent.generate_cancellation_cause", ez.V));
    ...
    public final V get(long j, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        String str = "Waited " + j + PPSLabelView.Code + timeUnit.toString().toLowerCase(Locale.ROOT);
        if (nanos + 1000 < 0) {
            ...
            if (jConvert > 0) {
                String str3 = str2 + jConvert + PPSLabelView.Code + lowerCase;
                if (z) {
                    str3 = str3 + ",";
                }
