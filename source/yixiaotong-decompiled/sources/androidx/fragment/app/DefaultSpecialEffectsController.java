    ...
    private final Map<SpecialEffectsController.Operation, Boolean> startTransitions(List<TransitionInfo> transitionInfos, List<SpecialEffectsController.Operation> awaitingContainerChanges, boolean isPop, final SpecialEffectsController.Operation firstOut, final SpecialEffectsController.Operation lastIn) {
            ...
            while (true) {
                ...
                if (!next.hasSharedElementTransition() || firstOut == null || lastIn == null) {
                    ...
                    if (sharedElementCallback != null) {
                        ...
                        if (size3 >= 0) {
                            while (true) {
                                ...
                                View view9 = arrayMap2.get(str);
                                if (view9 == null) {
                                    arrayMap.remove(str);
                                } else if (!Intrinsics.areEqual(str, ViewCompat.getTransitionName(view9))) {
                                    arrayMap.put(ViewCompat.getTransitionName(view9), (String) arrayMap.remove(str));
                                }
                                if (i4 < 0) {
                                    break;
                                }
                    ...
                    if (sharedElementCallback2 != null) {
                        ...
                        if (size4 >= 0) {
                            while (true) {
                                ...
                                View view11 = arrayMap4.get(name);
                                if (view11 == null) {
                                ...
                                } else if (!Intrinsics.areEqual(name, ViewCompat.getTransitionName(view11))) {
                                    Intrinsics.checkNotNullExpressionValue(name, "name");
                    ...
                    OneShotPreDrawListener.add(getContainer(), new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            DefaultSpecialEffectsController.startTransitions$lambda$9(lastIn, firstOut, z, arrayMap4);
                        }
                    });
                    arrayList7.addAll(arrayMap2.values());
                    if (!arrayList9.isEmpty()) {
                        View view12 = arrayMap2.get(sharedElementSourceNames.get(0));
                        fragmentTransitionImpl = fragmentTransitionImpl2;
                        obj5 = obj8;
                        fragmentTransitionImpl.setEpicenter(obj5, view12);
                        view3 = view12;
                    } else {
                        fragmentTransitionImpl = fragmentTransitionImpl2;
                        obj5 = obj8;
                    ...
                    if (!(!arrayList10.isEmpty()) || (view5 = arrayMap4.get(sharedElementTargetNames2.get(0))) == null) {
                        rect2 = rect;
                    } else {
                        rect2 = rect;
                    ...
                    fragmentTransitionImpl.setSharedElementTargets(obj5, view4, arrayList7);
                    ArrayList<View> arrayList11 = arrayList8;
                    arrayList4 = arrayList7;
                    fragmentTransitionImpl.scheduleRemoveTargets(obj5, null, null, null, null, obj5, arrayList11);
                    linkedHashMap = linkedHashMap2;
                    linkedHashMap.put(firstOut, true);
                    linkedHashMap.put(lastIn, true);
                    rect3 = rect2;
                    view6 = view4;
        ...
        for (TransitionInfo transitionInfo3 : transitionInfos) {
            if (transitionInfo3.isVisibilityUnchanged()) {
                linkedHashMap4.put(transitionInfo3.getOperation(), false);
                transitionInfo3.completeSpecialEffect();
            } else {
                Object objCloneTransition = fragmentTransitionImpl4.cloneTransition(transitionInfo3.getTransition());
                ...
                if (objCloneTransition != null) {
                    ...
                    defaultSpecialEffectsController.captureTransitioningViews(arrayList15, view15);
                    if (!z3) {
                        arrayList = arrayList13;
                    } else if (operation2 == firstOut) {
                        arrayList = arrayList13;
                        arrayList15.removeAll(CollectionsKt.toSet(arrayList));
                    } else {
                        arrayList = arrayList13;
                        arrayList15.removeAll(CollectionsKt.toSet(arrayList12));
                    }
                    if (arrayList15.isEmpty()) {
                        fragmentTransitionImpl4.addTarget(objCloneTransition, view14);
                        obj2 = obj10;
                        ...
                        if (operation2.getFinalState() == SpecialEffectsController.Operation.State.GONE) {
                            ...
                            obj4 = objCloneTransition;
                            fragmentTransitionImpl4.scheduleHideFragmentView(obj4, operation.getFragment().mView, arrayList16);
                    ...
                    if (operation.getFinalState() == SpecialEffectsController.Operation.State.VISIBLE) {
                        ...
                        if (z2) {
                            fragmentTransitionImpl4.setEpicenter(obj4, rect4);
                        }
                        view2 = view;
                    } else {
                        view2 = view;
                        arrayList14 = arrayList2;
                        fragmentTransitionImpl4.setEpicenter(obj4, view2);
                    }
                    linkedHashMap4.put(operation, true);
                    if (transitionInfo3.getIsOverlapAllowed()) {
                        objMergeTransitionsTogether2 = fragmentTransitionImpl4.mergeTransitionsTogether(obj3, obj4, null);
                        objMergeTransitionsTogether = obj2;
                    } else {
                        objMergeTransitionsTogether = fragmentTransitionImpl4.mergeTransitionsTogether(obj2, obj4, null);
                        objMergeTransitionsTogether2 = obj3;
                    }
                    defaultSpecialEffectsController = this;
                    view13 = view2;
                } else if (!z3) {
                    linkedHashMap4.put(operation2, false);
                    transitionInfo3.completeSpecialEffect();
                }
            }
        }
        ...
        Object obj11 = obj;
        Object objMergeTransitionsInSequence = fragmentTransitionImpl4.mergeTransitionsInSequence(objMergeTransitionsTogether2, objMergeTransitionsTogether, obj11);
        ...
        for (final TransitionInfo transitionInfo4 : arrayList19) {
            ...
            boolean z4 = obj11 != null && (operation3 == firstOut || operation3 == lastIn);
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            ...
            for (View sharedElementFirstOutViews : arrayList13) {
                Intrinsics.checkNotNullExpressionValue(sharedElementFirstOutViews, "sharedElementFirstOutViews");
                View view16 = sharedElementFirstOutViews;
                Log.v(FragmentManager.TAG, "View: " + view16 + " Name: " + ViewCompat.getTransitionName(view16));
            }
        ...
        fragmentTransitionImpl4.setNameOverridesReordered(getContainer(), arrayList13, arrayList12, arrayListPrepareSetNameOverridesReordered, arrayMap6);
        FragmentTransition.setViewVisibility(arrayList20, 0);
        fragmentTransitionImpl4.swapSharedElementTargets(obj11, arrayList13, arrayList12);
        return linkedHashMap6;
    }
