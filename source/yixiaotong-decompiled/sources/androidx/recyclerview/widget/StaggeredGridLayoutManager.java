...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    int findFirstVisibleItemPositionInt() {
        View viewFindFirstVisibleItemClosestToStart;
        if (this.mShouldReverseLayout) {
            viewFindFirstVisibleItemClosestToStart = findFirstVisibleItemClosestToEnd(true);
        } else {
            viewFindFirstVisibleItemClosestToStart = findFirstVisibleItemClosestToStart(true);
        }
        if (viewFindFirstVisibleItemClosestToStart == null) {
            return -1;
        }
    ...
    /* JADX WARN: Type inference failed for: r16v0, types: [androidx.recyclerview.widget.StaggeredGridLayoutManager] */
