...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo87clone = transition.mo87clone();
        transitionMo87clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo87clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo87clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo87clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo87clone = transition.mo87clone();
        sceneChangeSetup(viewGroup, transitionMo87clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo87clone);
    }
