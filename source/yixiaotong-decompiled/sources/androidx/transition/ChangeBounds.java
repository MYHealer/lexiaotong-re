...
public class ChangeBounds extends Transition {
    ...
    static {
        String str = INativeAdvanceData.POSITION_TOP_LEFT;
        ...
        String str2 = INativeAdvanceData.POSITION_BOTTOM_RIGHT;
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (!this.mResizeClip) {
                ...
                if (i3 == i4 && i5 == i6) {
                    ...
                    view = view2;
                    objectAnimatorOfPointF = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i3, i5, i4, i6));
                }
                if (rect3 == null) {
                    i2 = 0;
