        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (actionMasked == 3) {
                    ...
                    } else if (i == 2 && (viewFindTopChildUnder = findTopChildUnder((int) x, (int) y)) == this.mCapturedView) {
                ...
                for (int i4 = 0; i4 < pointerCount; i4++) {
                    ...
                    if (isValidPointerForActionMove(pointerId2)) {
                        ...
                        boolean z2 = viewFindTopChildUnder2 != null && checkTouchSlop(viewFindTopChildUnder2, f, f2);
                        if (z2) {
                            int left = viewFindTopChildUnder2.getLeft();
                            int i5 = (int) f;
                            int iClampViewPositionHorizontal = this.mCallback.clampViewPositionHorizontal(viewFindTopChildUnder2, left + i5, i5);
                            int top = viewFindTopChildUnder2.getTop();
                            int i6 = (int) f2;
                            int iClampViewPositionVertical = this.mCallback.clampViewPositionVertical(viewFindTopChildUnder2, top + i6, i6);
                            ...
                            if (this.mDragState != 1 || (z2 && tryCaptureViewForDrag(viewFindTopChildUnder2, pointerId2))) {
                                break;
                            }
                        } else {
                            reportNewEdgeDrags(f, f2, pointerId2);
