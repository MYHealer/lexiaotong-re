...
public final class ContentInfoCompat {
    ...
    private static final class CompatImpl implements Compat {
        ...
        CompatImpl(BuilderCompatImpl builderCompatImpl) {
            ...
            this.mSource = Preconditions.checkArgumentInRange(builderCompatImpl.mSource, 0, 5, ba.at);
        ...
        public String toString() {
            return "ContentInfoCompat{clip=" + this.mClip.getDescription() + ", source=" + ContentInfoCompat.sourceToString(this.mSource) + ", flags=" + ContentInfoCompat.flagsToString(this.mFlags) + (this.mLinkUri == null ? "" : ", hasLinkUri(" + this.mLinkUri.toString().length() + ")") + (this.mExtras != null ? ", hasExtras" : "") + i.d;
        }
    }
    ...
    private static final class Compat31Impl implements Compat {
        ...
        public String toString() {
            return "ContentInfoCompat{" + this.mWrapped + i.d;
        }
    }
