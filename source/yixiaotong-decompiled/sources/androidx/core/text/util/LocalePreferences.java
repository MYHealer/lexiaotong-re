...
public final class LocalePreferences {
    ...
    private static String getStringOfFirstDayOfWeek(int i) {
        return (i < 1 || i > 7) ? "" : new String[]{FirstDayOfWeek.SUNDAY, FirstDayOfWeek.MONDAY, FirstDayOfWeek.TUESDAY, FirstDayOfWeek.WEDNESDAY, FirstDayOfWeek.THURSDAY, FirstDayOfWeek.FRIDAY, "sat"}[i - 1];
    }
    ...
    private static class Api33Impl {
        ...
        private static String getHourCycleType(android.icu.text.DateFormat.HourCycle hourCycle) {
