...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    /* JADX WARN: Code duplicated, block: B:9:0x001a A[Catch: IOException -> 0x005a, Exception -> 0x007a, PHI: r3
    ...
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, FontsContractCompat.FontInfo[] fontInfoArr, int i) {
        ...
        try {
            ...
            for (FontsContractCompat.FontInfo fontInfo : fontInfoArr) {
                try {
                    ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = contentResolver.openFileDescriptor(fontInfo.getUri(), t.k, cancellationSignal);
