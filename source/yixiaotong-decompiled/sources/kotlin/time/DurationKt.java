...
public final class DurationKt {
    ...
    private static final long m2733timesmvk6XK0(int i, long j) {
        return Duration.m2645timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2732timeskIfJnKk(double d, long j) {
        return Duration.m2644timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM2709getZEROUwyO8pc = Duration.INSTANCE.m2709getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    while (true) {
                        ...
                        z3 = z6;
                        if (!new CharRange(c, '9').contains(cCharAt2)) {
                            i2 = length;
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM2643plusLRDsOJo = Duration.m2643plusLRDsOJo(jM2709getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2709getZEROUwyO8pc = Duration.m2643plusLRDsOJo(jM2643plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM2709getZEROUwyO8pc = Duration.m2643plusLRDsOJo(jM2709getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM2709getZEROUwyO8pc = Duration.INSTANCE.m2707getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (length2 < i) {
                    ...
                    int i7 = length4;
                    while (i7 < str.length()) {
                        if (!new CharRange('a', 'z').contains(str.charAt(i7))) {
                            break;
                        }
                        i7++;
                    }
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM2643plusLRDsOJo2 = Duration.m2643plusLRDsOJo(jM2709getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring7 = strSubstring4.substring(iIndexOf$default2);
                        String str6 = str4;
                        Intrinsics.checkNotNullExpressionValue(strSubstring7, str6);
                        jM2709getZEROUwyO8pc = Duration.m2643plusLRDsOJo(jM2643plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                        str4 = str6;
                    } else {
                        jM2709getZEROUwyO8pc = Duration.m2643plusLRDsOJo(jM2709getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m2659unaryMinusUwyO8pc(jM2709getZEROUwyO8pc) : jM2709getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2607constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m2607constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m2607constructorimpl((j << 1) + ((long) i));
    }
