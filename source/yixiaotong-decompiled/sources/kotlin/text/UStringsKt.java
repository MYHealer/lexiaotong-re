...
public final class UStringsKt {
    ...
    public static final String m2593toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2595toStringolVBNx4(short s, int i) {
    ...
    public static final String m2594toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2592toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m1376constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m1293boximpl(UByte.m1299constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m1376constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m1556boximpl(UShort.m1562constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM1376constructorimpl = UInt.m1376constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM1376constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM1376constructorimpl2 = UInt.m1376constructorimpl(i3 * iM1376constructorimpl);
            int iM1376constructorimpl3 = UInt.m1376constructorimpl(UInt.m1376constructorimpl(iDigitOf) + iM1376constructorimpl2);
            if (Integer.compareUnsigned(iM1376constructorimpl3, iM1376constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM1376constructorimpl3;
        }
        return UInt.m1370boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM1455constructorimpl = ULong.m1455constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM1455constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM1455constructorimpl2 = ULong.m1455constructorimpl(j * jM1455constructorimpl);
            long jM1455constructorimpl3 = ULong.m1455constructorimpl(ULong.m1455constructorimpl(((long) UInt.m1376constructorimpl(iDigitOf)) & 4294967295L) + jM1455constructorimpl2);
            if (Long.compareUnsigned(jM1455constructorimpl3, jM1455constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM1455constructorimpl3;
        }
        return ULong.m1449boximpl(j);
    }
}
