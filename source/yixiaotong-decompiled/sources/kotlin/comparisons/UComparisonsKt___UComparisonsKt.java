...
public class UComparisonsKt___UComparisonsKt {
    ...
    public static final int m2477maxOfMd2H83M(int i, int... other) {
        ...
        int iM1437getSizeimpl = UIntArray.m1437getSizeimpl(other);
        for (int i2 = 0; i2 < iM1437getSizeimpl; i2++) {
            i = UComparisonsKt.m2475maxOfJ1ME1BU(i, UIntArray.m1436getpVg5ArA(other, i2));
        }
        return i;
    }
    ...
    public static final long m2478maxOfR03FKyM(long j, long... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int iM1516getSizeimpl = ULongArray.m1516getSizeimpl(other);
        for (int i = 0; i < iM1516getSizeimpl; i++) {
            j = UComparisonsKt.m2483maxOfeb3DHEI(j, ULongArray.m1515getsVKNKU(other, i));
        }
        return j;
    }
    ...
    public static final byte m2481maxOfWr6uiD8(byte b, byte... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int iM1358getSizeimpl = UByteArray.m1358getSizeimpl(other);
        for (int i = 0; i < iM1358getSizeimpl; i++) {
            b = UComparisonsKt.m2476maxOfKr8caGY(b, UByteArray.m1357getw2LRezQ(other, i));
        }
        return b;
    }
    ...
    public static final short m2485maxOft1qELG4(short s, short... other) {
        Intrinsics.checkNotNullParameter(other, "other");
        int iM1621getSizeimpl = UShortArray.m1621getSizeimpl(other);
        for (int i = 0; i < iM1621getSizeimpl; i++) {
            s = UComparisonsKt.m2474maxOf5PvTz6A(s, UShortArray.m1620getMh2AYeg(other, i));
        }
        return s;
    }
    ...
    public static final int m2489minOfMd2H83M(int i, int... other) {
        ...
        int iM1437getSizeimpl = UIntArray.m1437getSizeimpl(other);
        for (int i2 = 0; i2 < iM1437getSizeimpl; i2++) {
            i = UComparisonsKt.m2487minOfJ1ME1BU(i, UIntArray.m1436getpVg5ArA(other, i2));
        }
        return i;
    }
    ...
    public static final long m2490minOfR03FKyM(long j, long... other) {
        ...
        int iM1516getSizeimpl = ULongArray.m1516getSizeimpl(other);
        for (int i = 0; i < iM1516getSizeimpl; i++) {
            j = UComparisonsKt.m2495minOfeb3DHEI(j, ULongArray.m1515getsVKNKU(other, i));
        }
        return j;
    }
    ...
    public static final byte m2493minOfWr6uiD8(byte b, byte... other) {
        ...
        int iM1358getSizeimpl = UByteArray.m1358getSizeimpl(other);
        for (int i = 0; i < iM1358getSizeimpl; i++) {
            b = UComparisonsKt.m2488minOfKr8caGY(b, UByteArray.m1357getw2LRezQ(other, i));
        }
        return b;
    }
    ...
    public static final short m2497minOft1qELG4(short s, short... other) {
        ...
        int iM1621getSizeimpl = UShortArray.m1621getSizeimpl(other);
        for (int i = 0; i < iM1621getSizeimpl; i++) {
            s = UComparisonsKt.m2486minOf5PvTz6A(s, UShortArray.m1620getMh2AYeg(other, i));
        }
        return s;
    }
}
