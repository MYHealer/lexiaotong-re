...
public interface SendChannel<E> {
    ...
    Object mo2788trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2803isSuccessimpl(objMo2788trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2797exceptionOrNullimpl = ChannelResult.m2797exceptionOrNullimpl(objMo2788trySendJP2dKIU);
