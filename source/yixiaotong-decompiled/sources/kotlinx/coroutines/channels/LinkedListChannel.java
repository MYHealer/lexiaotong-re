            ...
            if (!(list instanceof ArrayList)) {
                ...
                for (int size = arrayList.size() - 1; -1 < size; size--) {
                    ...
                    if (send2 instanceof AbstractSendChannel.SendBuffered) {
                        ...
                        undeliveredElementExceptionCallUndeliveredElementCatchingException2 = function2 != null ? OnUndeliveredElementKt.callUndeliveredElementCatchingException(function2, ((AbstractSendChannel.SendBuffered) send2).element, undeliveredElementExceptionCallUndeliveredElementCatchingException2) : null;
                    } else {
