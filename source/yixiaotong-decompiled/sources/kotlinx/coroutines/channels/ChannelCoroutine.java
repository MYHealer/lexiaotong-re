...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2786receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2786receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2787tryReceivePtdJZtk() {
        return this._channel.mo2787tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2788trySendJP2dKIU(E element) {
        return this._channel.mo2788trySendJP2dKIU(element);
    }
