...
public interface ReceiveChannel<E> {
    ...
    Object mo2786receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2787tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2787tryReceivePtdJZtk = receiveChannel.mo2787tryReceivePtdJZtk();
            if (ChannelResult.m2803isSuccessimpl(objMo2787tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2799getOrThrowimpl(objMo2787tryReceivePtdJZtk);
            }
            Throwable thM2797exceptionOrNullimpl = ChannelResult.m2797exceptionOrNullimpl(objMo2787tryReceivePtdJZtk);
            if (thM2797exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2797exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo2786receiveCatchingJP2dKIU = receiveChannel.mo2786receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m2798getOrNullimpl(objMo2786receiveCatchingJP2dKIU);
        }
