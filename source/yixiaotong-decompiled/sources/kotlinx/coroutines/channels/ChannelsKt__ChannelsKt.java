...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            return ChannelResult.m2793boximpl(Result.m1288isSuccessimpl(objM1281constructorimpl) ? ChannelResult.INSTANCE.m2808successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2806closedJP2dKIU(Result.m1284exceptionOrNullimpl(objM1281constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2788trySendJP2dKIU = sendChannel.mo2788trySendJP2dKIU(e);
        if (objMo2788trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m2803isSuccessimpl(sendChannel.mo2788trySendJP2dKIU(e))) {
            return;
        }
