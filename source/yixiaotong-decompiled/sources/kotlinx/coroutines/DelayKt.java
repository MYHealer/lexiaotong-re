...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2834scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m2770delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2771toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2771toDelayMillisLRDsOJo(long j) {
        if (Duration.m2606compareToLRDsOJo(j, Duration.INSTANCE.m2709getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2625getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
