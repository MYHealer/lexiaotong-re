...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM1281constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM1281constructorimpl = Result.m1281constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM1281constructorimpl = Result.m1281constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m1287isFailureimpl(objM1281constructorimpl)) {
                objM1281constructorimpl = null;
            }
            return (E) objM1281constructorimpl;
        }
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    try {
                        ...
                        if (objNewInstance != null) {
                            ...
                            th2.initCause(th);
                            objM1281constructorimpl = Result.m1281constructorimpl(th2);
                            if (Result.m1287isFailureimpl(objM1281constructorimpl)) {
                                objM1281constructorimpl = null;
                            }
                            return (Throwable) objM1281constructorimpl;
                        }
                        throw new NullPointerException("null cannot be cast to non-null type kotlin.Throwable");
                    } catch (Throwable th3) {
                        Result.Companion companion2 = Result.INSTANCE;
                        objM1281constructorimpl = Result.m1281constructorimpl(ResultKt.createFailure(th3));
                    }
                }
            };
        }
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        try {
                            ...
                            if (objNewInstance != null) {
                                objM1281constructorimpl = Result.m1281constructorimpl((Throwable) objNewInstance);
                                if (Result.m1287isFailureimpl(objM1281constructorimpl)) {
                                    objM1281constructorimpl = null;
                                }
                                return (Throwable) objM1281constructorimpl;
                            ...
                            Result.Companion companion2 = Result.INSTANCE;
                            objM1281constructorimpl = Result.m1281constructorimpl(ResultKt.createFailure(th2));
                        }
                    }
                };
            }
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM1281constructorimpl = Result.m1281constructorimpl(function2.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM1281constructorimpl = Result.m1281constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM1281constructorimpl = Result.m1281constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1281constructorimpl = Result.m1281constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m1287isFailureimpl(objM1281constructorimpl)) {
            objM1281constructorimpl = numValueOf;
        }
        return ((Number) objM1281constructorimpl).intValue();
    }
