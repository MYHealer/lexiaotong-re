...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2834scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2834scheduleResumeAfterDelay(timeMillis, continuation);
    }
                ...
                if (runnableRemoveFirstOrNull != null) {
                    ...
                    if (i >= 16) {
                        ...
                        if (this.dispatcher.isDispatchNeeded(limitedDispatcher)) {
                            this.dispatcher.mo2833dispatch(limitedDispatcher, this);
                            return;
                        }
                    }
                }
    ...
    public void mo2833dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo2833dispatch(this, this);
    }
