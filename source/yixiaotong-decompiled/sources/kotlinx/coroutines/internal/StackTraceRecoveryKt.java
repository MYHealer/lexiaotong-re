...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM1281constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM1281constructorimpl = Result.m1281constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM1281constructorimpl = Result.m1281constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1284exceptionOrNullimpl(objM1281constructorimpl) == null) {
            obj2 = objM1281constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM1281constructorimpl2 = Result.m1281constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM1281constructorimpl2 = Result.m1281constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m1284exceptionOrNullimpl(objM1281constructorimpl2) == null) {
            obj = objM1281constructorimpl2;
        }
