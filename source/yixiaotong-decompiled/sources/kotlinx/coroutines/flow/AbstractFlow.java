...
public abstract class AbstractFlow<T> implements Flow<T>, CancellableFlow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.AbstractFlow", f = "Flow.kt", i = {0}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_NETWORK_TRY_COUNT}, m = "collect", n = {"safeCollector"}, s = {"L$0"})
