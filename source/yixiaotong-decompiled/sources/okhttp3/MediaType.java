...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType get(String toMediaType) {
            ...
            while (iEnd < toMediaType.length()) {
                ...
                if (!matcher2.lookingAt()) {
                    ...
                    throw new IllegalArgumentException(sb.append(strSubstring).append("\" for: \"").append(toMediaType).append(Typography.quote).toString().toString());
                }
        ...
        public final MediaType m2922deprecated_get(String mediaType) {
        ...
        public final MediaType m2923deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
