                    ...
                    try {
                        try {
                            ...
                            if (!recover(e.getLastConnectException(), call, request, false)) {
                                throw Util.withSuppressed(e.getFirstConnectException(), listEmptyList);
                            }
                            listEmptyList = CollectionsKt.plus((Collection<? extends IOException>) listEmptyList, e.getFirstConnectException());
