...
public final class RealCall implements Call {
    ...
    public RealCall(OkHttpClient client2, Request originalRequest, boolean z) {
        Intrinsics.checkNotNullParameter(client2, "client");
        Intrinsics.checkNotNullParameter(originalRequest, "originalRequest");
        this.client = client2;
        this.originalRequest = originalRequest;
        this.forWebSocket = z;
        this.connectionPool = client2.connectionPool().getDelegate();
        ...
        r4.timeout(client2.callTimeoutMillis(), TimeUnit.MILLISECONDS);
    ...
    public final Socket releaseConnectionNoEvents$okhttp() {
        ...
        throw new AssertionError(sb.append(threadCurrentThread.getName()).append(" MUST hold lock on ").append(realConnection).toString());
    }
    ...
    public final class AsyncCall implements Runnable {
        ...
        public final void executeOn(ExecutorService executorService) {
            ...
            Thread threadCurrentThread = Thread.currentThread();
            Intrinsics.checkNotNullExpressionValue(threadCurrentThread, "Thread.currentThread()");
            throw new AssertionError(sb.append(threadCurrentThread.getName()).append(" MUST NOT hold lock on ").append(dispatcher).toString());
        }
    ...
    public final void acquireConnectionNoEvents(RealConnection connection) {
        ...
        if (Util.assertionsEnabled && !Thread.holdsLock(connection)) {
            ...
            Thread threadCurrentThread = Thread.currentThread();
            Intrinsics.checkNotNullExpressionValue(threadCurrentThread, "Thread.currentThread()");
            throw new AssertionError(sb.append(threadCurrentThread.getName()).append(" MUST hold lock on ").append(connection).toString());
        }
    ...
    private final <E extends IOException> E callDone(E e) {
        ...
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            ...
            if (realConnection != null) {
                if (!Util.assertionsEnabled || !Thread.holdsLock(realConnection)) {
                    ...
                    Thread threadCurrentThread = Thread.currentThread();
                    Intrinsics.checkNotNullExpressionValue(threadCurrentThread, "Thread.currentThread()");
                    throw new AssertionError(sb.append(threadCurrentThread.getName()).append(" MUST NOT hold lock on ").append(realConnection).toString());
                }
            }
        ...
        throw new AssertionError(sb2.append(threadCurrentThread2.getName()).append(" MUST NOT hold lock on ").append(this).toString());
    }
}
