...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    public final ExchangeCodec newCodec$okhttp(OkHttpClient client2, RealInterceptorChain chain) throws SocketException {
        ...
        if (http2Connection != null) {
            return new Http2ExchangeCodec(client2, this, chain, http2Connection);
        }
        ...
        return new Http1ExchangeCodec(client2, this, bufferedSource, bufferedSink);
    }
    ...
    public final void connectFailed$okhttp(OkHttpClient client2, Route failedRoute, IOException failure) {
        Intrinsics.checkNotNullParameter(client2, "client");
        ...
        client2.getRouteDatabase().failed(failedRoute);
    }
