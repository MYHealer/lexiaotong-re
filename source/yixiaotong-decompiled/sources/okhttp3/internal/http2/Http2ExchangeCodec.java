...
public final class Http2ExchangeCodec implements ExchangeCodec {
    ...
    public Http2ExchangeCodec(OkHttpClient client2, RealConnection connection, RealInterceptorChain chain, Http2Connection http2Connection) {
        Protocol protocol;
        ...
        if (client2.protocols().contains(Protocol.H2_PRIOR_KNOWLEDGE)) {
