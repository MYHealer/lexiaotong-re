...
public final class Address {
    ...
    public final List<ConnectionSpec> m2847deprecated_connectionSpecs() {
    ...
    public final List<Protocol> m2850deprecated_protocols() {
    ...
    public String toString() {
        StringBuilder sb;
        Object obj;
        StringBuilder sbAppend = new StringBuilder("Address{").append(this.url.host()).append(':').append(this.url.port()).append(", ");
        if (this.proxy != null) {
        ...
        return sbAppend.append(sb.append(obj).toString()).append(i.d).toString();
    }
}
