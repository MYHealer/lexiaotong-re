...
import client.android.yixiaotong.ui.scancode.ZxingScanActivityHandler;
...
public class ZxingScanV3Activity extends BaseActivity implements SurfaceHolder.Callback, IActivityHandler {
    private static final String TAG = "ZxingScanV3Activity";
    ...
    public static void launch(Activity activity, int i) {
        if (activity != null) {
            activity.startActivity(new Intent(activity, (Class<?>) ZxingScanV3Activity.class).putExtra("mode", i));
        }
    }
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() { // from class: client.android.yixiaotong.v3.ui.scan.ZxingScanV3Activity.1
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
            }
        });
        builder.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: client.android.yixiaotong.v3.ui.scan.ZxingScanV3Activity.2
