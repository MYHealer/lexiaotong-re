...
public class WashControlActivity extends BaseActivity {
    private static final String TAG = "WashControlActivity";
    ...
    private PermissionUtil.PermissionGrant permissionGrant = new PermissionUtil.PermissionGrant() { // from class: client.android.yixiaotong.v3.ui.appcontrol.wash.WashControlActivity.3
        @Override // client.android.yixiaotong.util.permission.PermissionUtil.PermissionGrant
        public void onPermissionGranted(int i) {
            if (i == 0) {
                WashControlActivity.this.checkIsOpenBluetooth();
            } else {
                if (i != 1) {
                    return;
                }
                PermissionUtil.requestPerssion(WashControlActivity.this.getActivity(), 0, WashControlActivity.this.permissionGrant);
            }
        }
    };
    ...
    public static void launch(Activity activity, TypeInfoBean typeInfoBean) {
        if (activity != null) {
            activity.startActivity(new Intent(activity, (Class<?>) WashControlActivity.class).putExtra("bean", typeInfoBean));
        }
    }
    ...
    private void initClickListeners() {
        findViewById(R.id.iv_scan).setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.v3.ui.appcontrol.wash.WashControlActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m314xc417369(view);
            }
        });
        findViewById(R.id.rel_pswopen).setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.v3.ui.appcontrol.wash.WashControlActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m315xfd9302ea(view);
            }
        });
        findViewById(R.id.rel_myorder).setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.v3.ui.appcontrol.wash.WashControlActivity$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m316xeee4926b(view);
            }
        });
        findViewById(R.id.rel_mywallet).setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.v3.ui.appcontrol.wash.WashControlActivity$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m317xe03621ec(view);
            }
        });
        findViewById(R.id.iv_drinkwaterhelp).setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.v3.ui.appcontrol.wash.WashControlActivity$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m318xd187b16d(view);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$initClickListeners$0$client-android-yixiaotong-v3-ui-appcontrol-wash-WashControlActivity, reason: not valid java name */
    /* synthetic */ void m314xc417369(View view) {
        checkPre(0);
    }

    /* JADX INFO: renamed from: lambda$initClickListeners$1$client-android-yixiaotong-v3-ui-appcontrol-wash-WashControlActivity, reason: not valid java name */
    /* synthetic */ void m315xfd9302ea(View view) {
    ...
    /* JADX INFO: renamed from: lambda$initClickListeners$2$client-android-yixiaotong-v3-ui-appcontrol-wash-WashControlActivity, reason: not valid java name */
    /* synthetic */ void m316xeee4926b(View view) {
        if (LocalDataUtil.getAlarmSwitch(getActivity())) {
            ToastUtils.show(getActivity(), getString(R.string.alarmswitch));
        } else {
    ...
    /* JADX INFO: renamed from: lambda$initClickListeners$3$client-android-yixiaotong-v3-ui-appcontrol-wash-WashControlActivity, reason: not valid java name */
    /* synthetic */ void m317xe03621ec(View view) {
        if (LocalDataUtil.getAlarmSwitch(getActivity())) {
            ToastUtils.show(getActivity(), getString(R.string.alarmswitch));
        } else {
            getWalletInfo();
    ...
    /* JADX INFO: renamed from: lambda$initClickListeners$4$client-android-yixiaotong-v3-ui-appcontrol-wash-WashControlActivity, reason: not valid java name */
    /* synthetic */ void m318xd187b16d(View view) {
    ...
    private void getWalletInfo() {
        ...
        if (i == 1) {
            V3BusinessControllers.getInstance().postGetWalletInfoByInvestorid(getLoginAccount(), this.mInvestorInfoBean.investorId, new Listener<WalletInfoBean>() { // from class: client.android.yixiaotong.v3.ui.appcontrol.wash.WashControlActivity.1
                @Override // client.android.yixiaotong.controller.core.Listener
                public void onStart(Controller controller) {
                    BaseMaterialDialog.showMaterialDialog(WashControlActivity.this.getActivity(), "正在获取钱包信息..", false);
                }

                @Override // client.android.yixiaotong.controller.core.Listener
                public void onComplete(Controller controller, WalletInfoBean walletInfoBean, Object... objArr) {
                    if (WashControlActivity.this.mIsEnable) {
                        BaseMaterialDialog.dissmisMaterialDialog();
                        WashControlActivity.this.showError50XTip();
                        WashControlActivity.this.mWalletInfoBean = walletInfoBean;
                        WalletDetailActivity.launch(WashControlActivity.this.getActivity(), WashControlActivity.this.mWalletInfoBean);
                    }
                }
                ...
                public void onFail(Controller controller, ClientException clientException) {
                    if (WashControlActivity.this.mIsEnable) {
                        WashControlActivity.this.onError(clientException);
                    }
                }
            });
        } else if (i == 2) {
    ...
    private void findPsw() {
        V3BusinessControllers.getInstance().getFindMachiniePWD(getLoginAccount(), UserInfoUtil.getInstance().getLoginAccountV3().schoolInfoList.get(UserInfoUtil.getInstance().getSchoolInfosIndex()).id + "", new Listener<PswBean>() { // from class: client.android.yixiaotong.v3.ui.appcontrol.wash.WashControlActivity.2
            @Override // client.android.yixiaotong.controller.core.Listener
            public void onStart(Controller controller) {
                BaseMaterialDialog.showMaterialDialog(WashControlActivity.this.getActivity(), "加载中.", false);
            }
                ...
                if (WashControlActivity.this.mIsEnable) {
                    ...
                    if (pswBean != null) {
                        if (pswBean.statusFlag == 0) {
                            ResetDevicePswActivity.launch(WashControlActivity.this.getActivity(), 0, "");
                        } else if (pswBean.statusFlag == 1) {
                            MachinePSWActivity.launch(WashControlActivity.this.getActivity(), pswBean.password);
                        } else if (pswBean.statusFlag == 2) {
                            ToastUtils.show(WashControlActivity.this.getContext(), "密码已停用");
                        }
                    }
                }
            }
    ...
    public void checkIsOpenBluetooth() {
        if (BluetoothAdapter.getDefaultAdapter().isEnabled()) {
            if (AppUtils.isUserHuaWeiScan()) {
                ScanQrcodeActivity.launch(getActivity(), 7);
                return;
            } else {
                ZxingScanV3Activity.launch(getActivity(), 7);
                return;
            }
        }
    ...
    private void getAdv() {
        ...
        this.mAdvListener = new AdvControlUtil.AdvListener() { // from class: client.android.yixiaotong.v3.ui.appcontrol.wash.WashControlActivity.4
            ...
            public void isOpen(int i, int i2, int i3, int i4, int i5) {
                if (i5 == 1) {
                    WashControlActivity.this.mNativeUtil.initNative(WashControlActivity.this.getActivity(), WashControlActivity.this.mAdvListener, 1);
                    WashControlActivity.this.mNativeUtil.onNative(WashControlActivity.this.flContainer);
                }
            }

            @Override // client.android.yixiaotong.v3.ui.adv.AdvControlUtil.AdvListener
            public void onAdShow(String str, Common.AdvType advType) {
                WashControlActivity.this.mIsShowAdv = true;
            }
        };
