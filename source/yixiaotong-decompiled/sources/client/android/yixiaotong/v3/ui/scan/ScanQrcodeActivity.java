...
public class ScanQrcodeActivity extends BaseActivity {
    ...
    private int mMode;
    private ScanResultControlUtil mScanResultControlUtil;
    int mScreenHeight;
    int mScreenWidth;
    ...
    public static void launch(Activity activity, int i) {
        if (activity != null) {
            activity.startActivityForResult(new Intent(activity, (Class<?>) ScanQrcodeActivity.class).putExtra("mode", i), 1);
        }
    }

    public static void launch1(Activity activity, int i) {
        if (activity != null) {
            activity.startActivity(new Intent(activity, (Class<?>) ScanQrcodeActivity.class).putExtra("mode", i));
        }
    }
    ...
    /* JADX INFO: renamed from: client.android.yixiaotong.v3.ui.scan.ScanQrcodeActivity$1, reason: invalid class name */
    class AnonymousClass1 implements OnResultCallback {
        ...
        public void onResult(HmsScan[] hmsScanArr) {
            ...
            ScanQrcodeActivity.this.scanSuccess(hmsScanArr[0].getOriginalValue());
        }
    }

    /* JADX INFO: renamed from: client.android.yixiaotong.v3.ui.scan.ScanQrcodeActivity$2, reason: invalid class name */
    class AnonymousClass2 implements Runnable {
        ...
        public void run() {
            if (ScanQrcodeActivity.this.mIsScanSuccess) {
                return;
            }
            ScanQrcodeActivity.this.scantip.setVisibility(0);
        }
    }
    ...
    private void setPictureScanOperation() {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.v3.ui.scan.ScanQrcodeActivity.3
    ...
    private void setFlashOperation() {
        this.flushBtn.setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.v3.ui.scan.ScanQrcodeActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
