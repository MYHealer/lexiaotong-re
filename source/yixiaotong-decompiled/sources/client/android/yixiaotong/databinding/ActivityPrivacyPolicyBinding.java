...
public final class ActivityPrivacyPolicyBinding implements ViewBinding {
    ...
    private ActivityPrivacyPolicyBinding(LinearLayout linearLayout, TitleBar titleBar, WebView webView) {
    ...
    public static ActivityPrivacyPolicyBinding bind(View view) {
        ...
        if (titleBar != null) {
            ...
            if (webView != null) {
                return new ActivityPrivacyPolicyBinding((LinearLayout) view, titleBar, webView);
            }
        }
