...
public final class FragmentDryMainBinding implements ViewBinding {
    ...
    private FragmentDryMainBinding(RelativeLayout relativeLayout, TextView textView, TextView textView2, ImageView imageView, ImageView imageView2, SimpleDraweeView simpleDraweeView, LinearLayout linearLayout, LinearLayout linearLayout2, ImageView imageView3, RelativeLayout relativeLayout2, TitleBar titleBar, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8, TextView textView9) {
    ...
    public static FragmentDryMainBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentDryMainBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_dry_main, viewGroup, false);
        if (z) {
    ...
    public static FragmentDryMainBinding bind(View view) {
        int i = R.id.id1;
                                                            ...
                                                            if (textView6 != null) {
                                                                ...
                                                                if (textView7 != null) {
                                                                    ...
                                                                    if (textView8 != null) {
                                                                        ...
                                                                        if (textView9 != null) {
                                                                            return new FragmentDryMainBinding((RelativeLayout) view, textView, textView2, imageView, imageView2, simpleDraweeView, linearLayout, linearLayout2, imageView3, relativeLayout, titleBar, textView3, textView4, textView5, textView6, textView7, textView8, textView9);
                                                                        }
                                                                    }
                                                                }
                                                            }
