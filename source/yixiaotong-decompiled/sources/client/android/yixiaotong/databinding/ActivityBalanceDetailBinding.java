...
public final class ActivityBalanceDetailBinding implements ViewBinding {
    ...
    private ActivityBalanceDetailBinding(LinearLayout linearLayout, RelativeLayout relativeLayout, RelativeLayout relativeLayout2, TextView textView, TextView textView2, TextView textView3, TitleBar titleBar, TextView textView4, TextView textView5, TextView textView6, TextView textView7) {
    ...
    public static ActivityBalanceDetailBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_balance_detail, viewGroup, false);
        if (z) {
                                ...
                                if (textView4 != null) {
                                    ...
                                    if (textView5 != null) {
                                        ...
                                        if (textView6 != null) {
                                            ...
                                            if (textView7 != null) {
                                                return new ActivityBalanceDetailBinding((LinearLayout) view, relativeLayout, relativeLayout2, textView, textView2, textView3, titleBar, textView4, textView5, textView6, textView7);
                                            }
                                        }
                                    }
                                }
