...
public final class FragmentV4ServerBinding implements ViewBinding {
    ...
    private FragmentV4ServerBinding(LinearLayout linearLayout, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, ImageView imageView5, ImageView imageView6, ImageView imageView7, ImageView imageView8, ImageView imageView9, RelativeLayout relativeLayout, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, RelativeLayout relativeLayout5, PullRefreshLayout pullRefreshLayout, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8, TextView textView9, TextView textView10, TextView textView11, TextView textView12, TextView textView13, TextView textView14, TextView textView15) {
        this.rootView = linearLayout;
        this.imgServerphone = imageView;
        this.imgServertime = imageView2;
        this.ivNext1 = imageView3;
        this.ivNextcash = imageView4;
        this.ivNextzkt = imageView5;
        this.ivServerimg = imageView6;
        this.ivYeicon = imageView7;
        this.ivYeiconcash = imageView8;
        this.ivZkticon = imageView9;
        this.relBalance = relativeLayout;
        this.relCashbalance = relativeLayout2;
        this.relError = relativeLayout3;
        this.relServerinfo = relativeLayout4;
        this.relZhikatong = relativeLayout5;
    ...
    public static FragmentV4ServerBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentV4ServerBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
    ...
    public static FragmentV4ServerBinding bind(View view) {
                                                                                                                ...
                                                                                                                if (textView12 != null) {
                                                                                                                    ...
                                                                                                                    if (textView13 != null) {
                                                                                                                        ...
                                                                                                                        if (textView14 != null) {
                                                                                                                            ...
                                                                                                                            if (textView15 != null) {
                                                                                                                                return new FragmentV4ServerBinding((LinearLayout) view, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, imageView8, imageView9, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, relativeLayout5, pullRefreshLayout, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14, textView15);
                                                                                                                            }
                                                                                                                        }
                                                                                                                    }
                                                                                                                }
