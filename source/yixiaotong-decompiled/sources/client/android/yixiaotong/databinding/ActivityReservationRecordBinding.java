...
public final class ActivityReservationRecordBinding implements ViewBinding {
    ...
    private ActivityReservationRecordBinding(LinearLayout linearLayout, ListView listView, MultiStateView multiStateView, PullRefreshLayout pullRefreshLayout, TitleBar titleBar) {
    ...
    public static ActivityReservationRecordBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_reservation_record, viewGroup, false);
        if (z) {
        ...
        if (listView != null) {
            ...
            if (multiStateView != null) {
                ...
                if (pullRefreshLayout != null) {
                    ...
                    if (titleBar != null) {
                        return new ActivityReservationRecordBinding((LinearLayout) view, listView, multiStateView, pullRefreshLayout, titleBar);
                    }
                }
            }
        }
