...
public final class FragmentV3ApplicationDemoBinding implements ViewBinding {
    ...
    public final RelativeLayout relTopschool;
    ...
    private FragmentV3ApplicationDemoBinding(RelativeLayout relativeLayout, MyPagerGalleryView myPagerGalleryView, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, ImageView imageView5, LinearLayout linearLayout, LinearLayout linearLayout2, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, RelativeLayout relativeLayout5, PullRefreshLayout pullRefreshLayout, TextView textView, MyViewPager myViewPager) {
        ...
        this.relTopschool = relativeLayout5;
        this.swipeRefreshLayout = pullRefreshLayout;
        this.tvSchoolname = textView;
        this.viewpager = myViewPager;
    }

    public static FragmentV3ApplicationDemoBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentV3ApplicationDemoBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.fragment_v3_application_demo, viewGroup, false);
        if (z) {
    ...
    public static FragmentV3ApplicationDemoBinding bind(View view) {
                                                    ...
                                                    if (relativeLayout4 != null) {
                                                        ...
                                                        if (pullRefreshLayout != null) {
                                                            ...
                                                            if (textView != null) {
                                                                ...
                                                                if (myViewPager != null) {
                                                                    return new FragmentV3ApplicationDemoBinding((RelativeLayout) view, myPagerGalleryView, imageView, imageView2, imageView3, imageView4, imageView5, linearLayout, linearLayout2, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, pullRefreshLayout, textView, myViewPager);
                                                                }
                                                            }
                                                        }
                                                    }
