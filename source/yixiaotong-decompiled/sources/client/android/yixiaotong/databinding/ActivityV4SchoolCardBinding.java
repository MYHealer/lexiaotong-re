...
public final class ActivityV4SchoolCardBinding implements ViewBinding {
    ...
    public static ActivityV4SchoolCardBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityV4SchoolCardBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_v4_school_card, viewGroup, false);
        if (z) {
    ...
    public static ActivityV4SchoolCardBinding bind(View view) {
                                                                ...
                                                                if (textView5 != null) {
                                                                    ...
                                                                    if (textView6 != null) {
                                                                        ...
                                                                        if (textView7 != null) {
                                                                            ...
                                                                            if (textView8 != null) {
                                                                                return new ActivityV4SchoolCardBinding((LinearLayout) view, button, relativeLayout, imageButton, imageView, imageView2, relativeLayout2, relativeLayout3, relativeLayout4, scrollView, titleBar, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8);
                                                                            }
                                                                        }
                                                                    }
                                                                }
