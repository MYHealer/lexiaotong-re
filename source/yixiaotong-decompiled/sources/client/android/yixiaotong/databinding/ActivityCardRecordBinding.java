...
public final class ActivityCardRecordBinding implements ViewBinding {
    ...
    private ActivityCardRecordBinding(LinearLayout linearLayout, ListView listView, MultiStateView multiStateView, PullRefreshLayout pullRefreshLayout, TitleBar titleBar) {
    ...
    public static ActivityCardRecordBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_card_record, viewGroup, false);
        if (z) {
        ...
        if (listView != null) {
            ...
            if (multiStateView != null) {
                ...
                if (pullRefreshLayout != null) {
                    ...
                    if (titleBar != null) {
                        return new ActivityCardRecordBinding((LinearLayout) view, listView, multiStateView, pullRefreshLayout, titleBar);
                    }
                }
            }
        }
