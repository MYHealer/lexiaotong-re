...
public final class ActivityV3ErrorTipBinding implements ViewBinding {
    ...
    private ActivityV3ErrorTipBinding(RelativeLayout relativeLayout, Button button, Button button2, ImageView imageView, ImageView imageView2, ImageView imageView3, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, TitleBar titleBar, TextView textView, TextView textView2, EditText editText, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8, TextView textView9) {
    ...
    public static ActivityV3ErrorTipBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityV3ErrorTipBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_v3_error_tip, viewGroup, false);
        if (z) {
    ...
    public static ActivityV3ErrorTipBinding bind(View view) {
        int i = R.id.btn_know;
                                                                    ...
                                                                    if (textView6 != null) {
                                                                        ...
                                                                        if (textView7 != null) {
                                                                            ...
                                                                            if (textView8 != null) {
                                                                                ...
                                                                                if (textView9 != null) {
                                                                                    return new ActivityV3ErrorTipBinding((RelativeLayout) view, button, button2, imageView, imageView2, imageView3, relativeLayout, relativeLayout2, relativeLayout3, titleBar, textView, textView2, editText, textView3, textView4, textView5, textView6, textView7, textView8, textView9);
                                                                                }
                                                                            }
                                                                        }
                                                                    }
