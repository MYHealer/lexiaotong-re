...
public final class ActivityRechargeRefundRecordBinding implements ViewBinding {
    ...
    private ActivityRechargeRefundRecordBinding(LinearLayout linearLayout, ListView listView, MultiStateView multiStateView, RelativeLayout relativeLayout, RelativeLayout relativeLayout2, PullRefreshLayout pullRefreshLayout, TitleBar titleBar, TextView textView, TextView textView2, View view, View view2, View view3) {
    ...
    public static ActivityRechargeRefundRecordBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityRechargeRefundRecordBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_recharge_refund_record, viewGroup, false);
        if (z) {
    ...
    public static ActivityRechargeRefundRecordBinding bind(View view) {
                            ...
                            if (titleBar != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (textView2 != null && (viewFindChildViewById = ViewBindings.findChildViewById(view, (i = R.id.v_lineleft))) != null && (viewFindChildViewById2 = ViewBindings.findChildViewById(view, (i = R.id.v_lineright))) != null && (viewFindChildViewById3 = ViewBindings.findChildViewById(view, (i = R.id.v_popbg))) != null) {
                                        return new ActivityRechargeRefundRecordBinding((LinearLayout) view, listView, multiStateView, relativeLayout, relativeLayout2, pullRefreshLayout, titleBar, textView, textView2, viewFindChildViewById, viewFindChildViewById2, viewFindChildViewById3);
                                    }
                                }
                            }
                        }
