...
public final class ActivityWashDetailBinding implements ViewBinding {
    ...
    private ActivityWashDetailBinding(RelativeLayout relativeLayout, Button button, TextView textView, FrameLayout frameLayout, WrapGridView wrapGridView, ImageView imageView, ImageView imageView2, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, RelativeLayout relativeLayout5, TitleBar titleBar, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8) {
    ...
    public static ActivityWashDetailBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_wash_detail, viewGroup, false);
        if (z) {
                                                                ...
                                                                if (textView5 != null) {
                                                                    ...
                                                                    if (textView6 != null) {
                                                                        ...
                                                                        if (textView7 != null) {
                                                                            ...
                                                                            if (textView8 != null) {
                                                                                return new ActivityWashDetailBinding((RelativeLayout) view, button, textView, frameLayout, wrapGridView, imageView, imageView2, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, titleBar, textView2, textView3, textView4, textView5, textView6, textView7, textView8);
                                                                            }
                                                                        }
                                                                    }
                                                                }
