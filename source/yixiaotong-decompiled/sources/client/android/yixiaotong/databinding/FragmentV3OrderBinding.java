...
public final class FragmentV3OrderBinding implements ViewBinding {
    ...
    private FragmentV3OrderBinding(LinearLayout linearLayout, Button button, ImageView imageView, ImageView imageView2, ImageView imageView3, LinearLayout linearLayout2, LinearLayout linearLayout3, WrapListView wrapListView, ListView listView, MultiStateView multiStateView, RelativeLayout relativeLayout, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, PullRefreshLayout pullRefreshLayout, TextView textView, TitleBar titleBar, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, View view, View view2) {
    ...
    public static FragmentV3OrderBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentV3OrderBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
    ...
    public static FragmentV3OrderBinding bind(View view) {
                                                                                ...
                                                                                if (textView4 != null) {
                                                                                    ...
                                                                                    if (textView5 != null) {
                                                                                        ...
                                                                                        if (textView6 != null && (viewFindChildViewById = ViewBindings.findChildViewById(view, (i = R.id.v_line))) != null && (viewFindChildViewById2 = ViewBindings.findChildViewById(view, (i = R.id.v_popbg))) != null) {
                                                                                            return new FragmentV3OrderBinding((LinearLayout) view, button, imageView, imageView2, imageView3, linearLayout, linearLayout2, wrapListView, listView, multiStateView, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, pullRefreshLayout, textView, titleBar, textView2, textView3, textView4, textView5, textView6, viewFindChildViewById, viewFindChildViewById2);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
