...
public final class ActivityLicenseBinding implements ViewBinding {
    ...
    private ActivityLicenseBinding(LinearLayout linearLayout, TitleBar titleBar) {
    ...
    public static ActivityLicenseBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_license, viewGroup, false);
        if (z) {
    ...
    public static ActivityLicenseBinding bind(View view) {
        ...
        if (titleBar != null) {
            return new ActivityLicenseBinding((LinearLayout) view, titleBar);
        }
