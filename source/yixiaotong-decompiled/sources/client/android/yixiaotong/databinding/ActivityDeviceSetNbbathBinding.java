...
public final class ActivityDeviceSetNbbathBinding implements ViewBinding {
    ...
    private ActivityDeviceSetNbbathBinding(RelativeLayout relativeLayout, Button button, EditText editText, EditText editText2, EditText editText3, EditText editText4, EditText editText5, EditText editText6, EditText editText7, EditText editText8, View view, View view2, View view3, View view4, View view5, TextView textView, TitleBar titleBar, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8, TextView textView9, TextView textView10, TextView textView11, TextView textView12) {
    ...
    public static ActivityDeviceSetNbbathBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityDeviceSetNbbathBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_device_set_nbbath, viewGroup, false);
        if (z) {
    ...
    public static ActivityDeviceSetNbbathBinding bind(View view) {
