...
public final class ActivityChangeSchoolBinding implements ViewBinding {
    ...
    private ActivityChangeSchoolBinding(LinearLayout linearLayout, RelativeLayout relativeLayout, ImageView imageView, ImageView imageView2, LinearLayout linearLayout2, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, TitleBar titleBar, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5) {
    ...
    public static ActivityChangeSchoolBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityChangeSchoolBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_change_school, viewGroup, false);
        if (z) {
    ...
    public static ActivityChangeSchoolBinding bind(View view) {
                                    ...
                                    if (textView2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            ...
                                            if (textView4 != null) {
                                                ...
                                                if (textView5 != null) {
                                                    return new ActivityChangeSchoolBinding(linearLayout, relativeLayout, imageView, imageView2, linearLayout, relativeLayout2, relativeLayout3, titleBar, textView, textView2, textView3, textView4, textView5);
                                                }
                                            }
                                        }
                                    }
