...
public final class ActivityV4WalletDetailBinding implements ViewBinding {
    ...
    public final RelativeLayout relNopay;
    ...
    private ActivityV4WalletDetailBinding(RelativeLayout relativeLayout, Button button, EditText editText, ImageView imageView, LinearLayout linearLayout, LinearLayout linearLayout2, WrapListView wrapListView, WrapGridView wrapGridView, TextView textView, RelativeLayout relativeLayout2, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4, RelativeLayout relativeLayout5, RelativeLayout relativeLayout6, RelativeLayout relativeLayout7, RelativeLayout relativeLayout8, RelativeLayout relativeLayout9, ScrollView scrollView, PullRefreshLayout pullRefreshLayout, TextView textView2, TitleBar titleBar, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8, TextView textView9, TextView textView10, TextView textView11, TextView textView12, TextView textView13, TextView textView14, TextView textView15) {
        ...
        this.relNopay = relativeLayout4;
        this.relPay = relativeLayout5;
        this.relRechargerecord = relativeLayout6;
        this.relRefund = relativeLayout7;
        this.relWallet = relativeLayout8;
        this.relWallet2 = relativeLayout9;
    ...
    public static ActivityV4WalletDetailBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityV4WalletDetailBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_v4_wallet_detail, viewGroup, false);
        if (z) {
    ...
    public static ActivityV4WalletDetailBinding bind(View view) {
        int i = R.id.btn_pay;
                                                                                                                            ...
                                                                                                                            if (textView12 != null) {
                                                                                                                                ...
                                                                                                                                if (textView13 != null) {
                                                                                                                                    ...
                                                                                                                                    if (textView14 != null) {
                                                                                                                                        ...
                                                                                                                                        if (textView15 != null) {
                                                                                                                                            return new ActivityV4WalletDetailBinding((RelativeLayout) view, button, editText, imageView, linearLayout, linearLayout2, wrapListView, wrapGridView, textView, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, relativeLayout5, relativeLayout6, relativeLayout7, relativeLayout8, scrollView, pullRefreshLayout, textView2, titleBar, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14, textView15);
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                }
                                                                                                                            }
