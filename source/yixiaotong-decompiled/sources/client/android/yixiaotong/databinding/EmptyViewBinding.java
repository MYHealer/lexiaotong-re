...
public final class EmptyViewBinding implements ViewBinding {
    ...
    private EmptyViewBinding(LinearLayout linearLayout, TextView textView, LinearLayout linearLayout2) {
    ...
    public static EmptyViewBinding bind(View view) {
        ...
        if (textView != null) {
            ...
            if (linearLayout != null) {
                return new EmptyViewBinding((LinearLayout) view, textView, linearLayout);
            }
        }
