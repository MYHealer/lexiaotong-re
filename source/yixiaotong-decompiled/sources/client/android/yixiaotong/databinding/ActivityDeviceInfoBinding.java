...
public final class ActivityDeviceInfoBinding implements ViewBinding {
    ...
    private ActivityDeviceInfoBinding(LinearLayout linearLayout, TitleBar titleBar, TextView textView) {
    ...
    public static ActivityDeviceInfoBinding bind(View view) {
        ...
        if (titleBar != null) {
            ...
            if (textView != null) {
                return new ActivityDeviceInfoBinding((LinearLayout) view, titleBar, textView);
            }
        }
