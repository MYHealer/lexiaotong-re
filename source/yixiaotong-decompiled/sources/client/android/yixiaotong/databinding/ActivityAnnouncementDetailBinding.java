...
public final class ActivityAnnouncementDetailBinding implements ViewBinding {
    ...
    private ActivityAnnouncementDetailBinding(LinearLayout linearLayout, MultiStateView multiStateView, PullRefreshLayout pullRefreshLayout, TitleBar titleBar, WebView webView) {
    ...
    public static ActivityAnnouncementDetailBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_announcement_detail, viewGroup, false);
        if (z) {
        ...
        if (multiStateView != null) {
            ...
            if (pullRefreshLayout != null) {
                ...
                if (titleBar != null) {
                    ...
                    if (webView != null) {
                        return new ActivityAnnouncementDetailBinding((LinearLayout) view, multiStateView, pullRefreshLayout, titleBar, webView);
                    }
                }
            }
        }
