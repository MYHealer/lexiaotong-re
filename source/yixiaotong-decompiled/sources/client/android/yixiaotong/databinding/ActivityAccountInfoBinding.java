...
public final class ActivityAccountInfoBinding implements ViewBinding {
    ...
    private ActivityAccountInfoBinding(LinearLayout linearLayout, TitleBar titleBar) {
    ...
    public static ActivityAccountInfoBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_account_info, viewGroup, false);
        if (z) {
    ...
    public static ActivityAccountInfoBinding bind(View view) {
        ...
        if (titleBar != null) {
            return new ActivityAccountInfoBinding((LinearLayout) view, titleBar);
        }
