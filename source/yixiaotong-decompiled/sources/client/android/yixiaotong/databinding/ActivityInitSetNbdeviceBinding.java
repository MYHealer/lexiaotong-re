...
public final class ActivityInitSetNbdeviceBinding implements ViewBinding {
    ...
    public static ActivityInitSetNbdeviceBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ActivityInitSetNbdeviceBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_init_set_nbdevice, viewGroup, false);
        if (z) {
    ...
    public static ActivityInitSetNbdeviceBinding bind(View view) {
