...
public final class ActivityRecordDetailBinding implements ViewBinding {
    ...
    private ActivityRecordDetailBinding(LinearLayout linearLayout, Button button, ImageView imageView, ImageView imageView2, TitleBar titleBar, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7, TextView textView8, TextView textView9, TextView textView10, TextView textView11, TextView textView12, TextView textView13, TextView textView14, TextView textView15, TextView textView16, TextView textView17, TextView textView18, View view) {
    ...
    public static ActivityRecordDetailBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.activity_record_detail, viewGroup, false);
        if (z) {
                                                                            ...
                                                                            if (textView14 != null) {
                                                                                ...
                                                                                if (textView15 != null) {
                                                                                    ...
                                                                                    if (textView16 != null) {
                                                                                        ...
                                                                                        if (textView17 != null) {
                                                                                            i = R.id.tv_usernametext;
                                                                                            TextView textView18 = (TextView) ViewBindings.findChildViewById(view, i);
                                                                                            if (textView18 != null && (viewFindChildViewById = ViewBindings.findChildViewById(view, (i = R.id.v_line))) != null) {
                                                                                                return new ActivityRecordDetailBinding((LinearLayout) view, button, imageView, imageView2, titleBar, textView, textView2, textView3, textView4, textView5, textView6, textView7, textView8, textView9, textView10, textView11, textView12, textView13, textView14, textView15, textView16, textView17, textView18, viewFindChildViewById);
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
