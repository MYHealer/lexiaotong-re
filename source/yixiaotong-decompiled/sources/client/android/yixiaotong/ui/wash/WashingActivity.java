...
public class WashingActivity extends BaseActivity {
    ...
    private SystemErrorTip.SystemErrorDialogListener systemErrorDialogListener = new SystemErrorTip.SystemErrorDialogListener() { // from class: client.android.yixiaotong.ui.wash.WashingActivity.1
        @Override // client.android.yixiaotong.ui.dialog.SystemErrorTip.SystemErrorDialogListener
        public void onConfirm() {
            WashingActivity.this.finish();
        }
    };
    private PermissionUtil.PermissionGrant permissionGrant = new PermissionUtil.PermissionGrant() { // from class: client.android.yixiaotong.ui.wash.WashingActivity.4
    ...
    /* JADX INFO: renamed from: client.android.yixiaotong.ui.wash.WashingActivity$2, reason: invalid class name */
    class AnonymousClass2 implements SoundWaveDataListener {
        ...
        public void onGetQrcodeData(String str) {
            if (!StringUtils.isNotEmpty(str)) {
                ToastUtils.show(WashingActivity.this.getActivity(), "数据为空");
            } else {
                Log.e("test", "发送数据:" + str);
    ...
    /* JADX INFO: renamed from: client.android.yixiaotong.ui.wash.WashingActivity$3, reason: invalid class name */
    class AnonymousClass3 implements Runnable {
        ...
        public void run() {
            WashingActivity.this.getAdv();
        }
    }

    private void initTitleBar() {
        this.mVTitleBar.setTitleView("洗衣");
    ...
    class TimeCount extends CountDownTimer {
        ...
        public void onTick(long j) {
            WashingActivity.this.mTime.setTextColor(-10066330);
            WashingActivity.this.mTime.setClickable(false);
            WashingActivity.this.mTime.setText(Html.fromHtml("该页面将在" + (j / 1000) + "后自动关闭"));
            WashingActivity.this.mTime.setTextSize(12.0f);
            WashingActivity.this.mTime.setPadding(5, 5, 5, 5);
        }
    }
    ...
    public void getAdv() {
        ...
        this.mAdvListener = new AdvControlUtil.AdvListener() { // from class: client.android.yixiaotong.ui.wash.WashingActivity.5
            ...
            public void isOpen(int i, int i2, int i3, int i4, int i5) {
                if (i == 1) {
                    WashingActivity.this.mIsOpenPopAdv = true;
                    WashingActivity.this.mInsertUtil.onCreate(WashingActivity.this.getActivity());
                    WashingActivity.this.requestInteraction();
                }
                if (i2 == 1) {
                    MainThreadExecutor.getInstance().execute(new Runnable() { // from class: client.android.yixiaotong.ui.wash.WashingActivity.5.1
                        @Override // java.lang.Runnable
                        public void run() {
                            AdvControlUtil.getInstance().requestBanner(WashingActivity.this.flContainer);
                        }
                    });
                }
            }
        };
        AdvControlUtil.getInstance().init(getActivity(), this.mAdvListener, 3, false, getLoginAccount().getAccountManagetStore().getUserInfo().AreaId + "");
