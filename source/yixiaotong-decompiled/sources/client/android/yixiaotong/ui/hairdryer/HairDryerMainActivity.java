...
public class HairDryerMainActivity extends BaseActivity {
    ...
    private HairDryerMainFragment mWashMainFragment;
    private HairDryerMeFragment mWashMeFragment;

    static {
        StubApp.interface11(AVMDLDataLoader.KeyIsPlayInfoCurrentBuffer);
    }
    ...
    private void initClickListeners() {
        findViewById(R.id.rbtn_account).setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.ui.hairdryer.HairDryerMainActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m133x478578c(view);
            }
        });
        findViewById(R.id.rbtn_me).setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.ui.hairdryer.HairDryerMainActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m134x98b6c72b(view);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$initClickListeners$0$client-android-yixiaotong-ui-hairdryer-HairDryerMainActivity, reason: not valid java name */
    /* synthetic */ void m133x478578c(View view) {
        chooseRadioBtn(view);
        showAccountFragment();
    }

    /* JADX INFO: renamed from: lambda$initClickListeners$1$client-android-yixiaotong-ui-hairdryer-HairDryerMainActivity, reason: not valid java name */
    /* synthetic */ void m134x98b6c72b(View view) {
        chooseRadioBtn(view);
        showMeFragment();
    }
    ...
    public static void launch(Activity activity, WalletModel walletModel) {
        if (activity != null) {
            activity.startActivity(new Intent(activity, (Class<?>) HairDryerMainActivity.class).putExtra("extra_wallet", walletModel));
        }
    }
    ...
    private void showAccountFragment() {
        if (this.mMainSwitcher.getDisplayedChild() != 0 || this.mWashMainFragment == null) {
            if (this.mWashMainFragment == null) {
                ...
                this.mWashMainFragment = HairDryerMainFragment.newInstance();
    ...
    private void showMeFragment() {
        if (this.mMainSwitcher.getDisplayedChild() != 1 || this.mWashMeFragment == null) {
            if (this.mWashMeFragment == null) {
                ...
                this.mWashMeFragment = HairDryerMeFragment.newInstance();
