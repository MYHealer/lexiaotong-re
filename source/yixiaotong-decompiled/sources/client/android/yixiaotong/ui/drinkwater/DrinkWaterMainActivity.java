...
public class DrinkWaterMainActivity extends BaseActivity {
    ...
    private DrinkWaterMainFragment mWashMainFragment;
    private DrinkWaterMeFragment mWashMeFragment;

    static {
        StubApp.interface11(7077);
    }
    ...
    private void initClickListeners() {
        findViewById(R.id.rbtn_account).setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.ui.drinkwater.DrinkWaterMainActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m123xe59a673a(view);
            }
        });
        findViewById(R.id.rbtn_me).setOnClickListener(new View.OnClickListener() { // from class: client.android.yixiaotong.ui.drinkwater.DrinkWaterMainActivity$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m124x63fb6b19(view);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$initClickListeners$0$client-android-yixiaotong-ui-drinkwater-DrinkWaterMainActivity, reason: not valid java name */
    /* synthetic */ void m123xe59a673a(View view) {
        chooseRadioBtn(view);
        showAccountFragment();
    }

    /* JADX INFO: renamed from: lambda$initClickListeners$1$client-android-yixiaotong-ui-drinkwater-DrinkWaterMainActivity, reason: not valid java name */
    /* synthetic */ void m124x63fb6b19(View view) {
        chooseRadioBtn(view);
        showMeFragment();
    }
    ...
    public static void launch(Activity activity, WalletModel walletModel) {
        if (activity != null) {
            activity.startActivity(new Intent(activity, (Class<?>) DrinkWaterMainActivity.class).putExtra("extra_wallet", walletModel));
        }
    }
    ...
    private void showAccountFragment() {
        if (this.mMainSwitcher.getDisplayedChild() != 0 || this.mWashMainFragment == null) {
            if (this.mWashMainFragment == null) {
                ...
                this.mWashMainFragment = DrinkWaterMainFragment.newInstance();
    ...
    private void showMeFragment() {
        if (this.mMainSwitcher.getDisplayedChild() != 1 || this.mWashMeFragment == null) {
            if (this.mWashMeFragment == null) {
                ...
                this.mWashMeFragment = DrinkWaterMeFragment.newInstance();
