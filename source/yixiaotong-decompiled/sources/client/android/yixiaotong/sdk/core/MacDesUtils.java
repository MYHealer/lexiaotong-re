...
class MacDesUtils {
    ...
    String PBOC_3DES_MAC(String str, String str2, int i) {
        String str3;
        if (str2.length() != 32) {
            return null;
        }
    ...
    String PBOC_3DES(String str, String str2, int i) {
        String str3;
        if (str2.length() != 32) {
            return null;
        }
    ...
    String PBOC_1DES(String str, String str2, int i) {
        if (str2.length() != 16) {
            return null;
        }
        if (i == 1) {
    ...
    String DES_3(String str, String str2, int i) {
    ...
    String DES_1(String str, String str2, int i) {
    ...
    String discryption(String str, String str2) {
    ...
    int[] keyLeftMove(int[] iArr, int i) {
        int i2;
        int length = iArr.length;
        int i3 = this.LS[i];
    ...
    int getIntByChar(char c) throws Exception {
