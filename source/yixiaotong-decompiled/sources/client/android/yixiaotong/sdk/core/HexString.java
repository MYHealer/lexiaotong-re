...
class HexString {
    ...
    static String bufferToHex(byte[] bArr) {
        return bufferToHex(bArr, 0, bArr.length);
    }

    static String bufferToHex(byte[] bArr, int i, int i2) {
    ...
    static String hexToString(String str) throws NumberFormatException {
        return new String(hexToBuffer(str));
    }

    static byte[] hexToBuffer(String str) throws NumberFormatException {
        int i;
