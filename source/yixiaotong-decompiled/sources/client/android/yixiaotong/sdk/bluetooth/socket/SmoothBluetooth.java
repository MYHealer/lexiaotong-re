...
public class SmoothBluetooth {
    ...
    public SmoothBluetooth(Context context, ConnectionTo connectionTo, Connection connection, Listener listener) {
        ...
        this.mReceiver = new BroadcastReceiver() { // from class: client.android.yixiaotong.sdk.bluetooth.socket.SmoothBluetooth.1
        ...
        this.mHandler = new Handler() { // from class: client.android.yixiaotong.sdk.bluetooth.socket.SmoothBluetooth.3
    ...
    public void stop() {
        ...
        new Handler().postDelayed(new Runnable() { // from class: client.android.yixiaotong.sdk.bluetooth.socket.SmoothBluetooth.2
