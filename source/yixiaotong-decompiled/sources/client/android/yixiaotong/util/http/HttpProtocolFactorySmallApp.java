...
public class HttpProtocolFactorySmallApp {
    private final OkClient mOkClient;
    private final OkHttpClient mOkHttpClient;
    private final Map<String, Object> sHttpProtocolMap;

    /* JADX INFO: renamed from: client.android.yixiaotong.util.http.HttpProtocolFactorySmallApp$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
    }

    /* synthetic */ HttpProtocolFactorySmallApp(AnonymousClass1 anonymousClass1) {
        this();
    }

    private HttpProtocolFactorySmallApp() {
        ...
        okHttpClient.setWriteTimeout(ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT, TimeUnit.MILLISECONDS);
        okHttpClient.setProxy(Proxy.NO_PROXY);
        this.mOkClient = new OkClient(okHttpClient);
    }

    private static class SingletonHolder {
        public static final HttpProtocolFactorySmallApp INSTANCE = new HttpProtocolFactorySmallApp(null);

        private SingletonHolder() {
        }
    }

    public static HttpProtocolFactorySmallApp getInstance() {
