...
public class AsyncExecutor implements IExecutor {
    ...
    public void reset() {
        ...
        this.mExecutor = Executors.newCachedThreadPool(new ThreadFactory() { // from class: client.android.yixiaotong.util.executor.AsyncExecutor.1
            @Override // java.util.concurrent.ThreadFactory
            public Thread newThread(final Runnable runnable) {
                return new Thread(new Runnable() { // from class: client.android.yixiaotong.util.executor.AsyncExecutor.1.1
    ...
    public void executeDelayed(final Runnable runnable, long j) {
        MainThreadExecutor.getInstance().executeDelayed(new Runnable() { // from class: client.android.yixiaotong.util.executor.AsyncExecutor.2
            @Override // java.lang.Runnable
            public void run() {
