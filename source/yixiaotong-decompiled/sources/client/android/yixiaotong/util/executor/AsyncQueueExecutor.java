...
public class AsyncQueueExecutor implements IExecutor {
    ...
    public void reset() {
        ...
        this.mExecutor = Executors.newSingleThreadExecutor(new ThreadFactory() { // from class: client.android.yixiaotong.util.executor.AsyncQueueExecutor.1
            @Override // java.util.concurrent.ThreadFactory
            public Thread newThread(final Runnable runnable) {
                return new Thread(new Runnable() { // from class: client.android.yixiaotong.util.executor.AsyncQueueExecutor.1.1
    ...
    public void executeDelayed(final Runnable runnable, long j) {
        MainThreadExecutor.getInstance().executeDelayed(new Runnable() { // from class: client.android.yixiaotong.util.executor.AsyncQueueExecutor.2
            @Override // java.lang.Runnable
            public void run() {
