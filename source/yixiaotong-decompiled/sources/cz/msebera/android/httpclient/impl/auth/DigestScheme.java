...
public class DigestScheme extends RFC2617Scheme {
    ...
    public boolean isComplete() {
        if (ez.Code.equalsIgnoreCase(getParameter("stale"))) {
            return false;
        }
    ...
    public Header authenticate(Credentials credentials, HttpRequest httpRequest, HttpContext httpContext) throws AuthenticationException {
        ...
        getParameters().put(ContentProviderManager.PROVIDER_URI, httpRequest.getRequestLine().getUri());
    ...
    private Header createDigestHeader(Credentials credentials, HttpRequest httpRequest) throws AuthenticationException {
        ...
        String string;
        String str4;
        String parameter = getParameter(ContentProviderManager.PROVIDER_URI);
        ...
        if (parameter7 != null) {
            ...
            if ((httpRequest instanceof HttpEntityEnclosingRequest) && hashSet.contains("auth-int")) {
                ...
                b = hashSet.contains(c.d) ? (byte) 2 : (byte) -1;
            }
        } else {
            str = "qop";
            b = 0;
        ...
        try {
            ...
            if (b == 2) {
                ...
                if (b == 1) {
                    ...
                    if (entity != null && !entity.isRepeatable()) {
                        ...
                        this.a2 = parameter5 + ':' + str2 + ':' + encode(httpEntityDigester.getDigest());
                        b2 = b;
                    }
                    b = b2;
                } else {
            ...
            if (b == 0) {
                ...
                i = 0;
                sb.setLength(0);
                sb.append(strEncode2).append(':').append(parameter3).append(':').append(string2).append(':').append(this.cnonce).append(':').append(b == 1 ? r8 : str3).append(':').append(strEncode3);
                string = sb.toString();
            }
            ...
            arrayList.add(new BasicNameValuePair(ContentProviderManager.PROVIDER_URI, str2));
