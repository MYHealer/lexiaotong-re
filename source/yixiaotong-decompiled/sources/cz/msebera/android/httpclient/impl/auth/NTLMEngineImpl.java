...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    protected static class CipherGen {
        ...
        public byte[] getTimestamp() {
            if (this.timestamp == null) {
                long jCurrentTimeMillis = (System.currentTimeMillis() + 11644473600000L) * ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT;
    ...
    static class NTLMMessage {
        ...
        NTLMMessage(String str, int i) throws NTLMEngineException {
            this.messageContents = null;
            this.currentOutputPosition = 0;
            byte[] bArrDecode = Base64.decode(EncodingUtils.getBytes(str, "ASCII"), 2);
    ...
    static class Type1Message extends NTLMMessage {
        ...
        Type1Message(String str, String str2) throws NTLMEngineException {
            try {
                ...
                this.domainBytes = strConvertDomain != null ? strConvertDomain.toUpperCase(Locale.ENGLISH).getBytes("ASCII") : null;
            } catch (UnsupportedEncodingException e) {
    ...
    static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i, String str5, byte[] bArr2) throws NTLMEngineException {
            ...
            this.domainBytes = strConvertDomain != null ? strConvertDomain.toUpperCase(Locale.ENGLISH).getBytes("UnicodeLittleUnmarked") : null;
