...
public class VersionInfo {
    ...
    public static VersionInfo loadVersionInfo(String str, ClassLoader classLoader) {
        ...
        try {
            InputStream resourceAsStream = classLoader.getResourceAsStream(str.replace(FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX) + "/version.properties");
    ...
    public static String getUserAgent(String str, String str2, Class<?> cls) {
        ...
        return str + "/" + (versionInfoLoadVersionInfo != null ? versionInfoLoadVersionInfo.getRelease() : UNAVAILABLE) + " (Java 1.5 minimum; Java/" + System.getProperty("java.version") + ")";
    }
}
