                    ...
                    if (i2 <= i15) {
                        ...
                        if ((b6 & 192) == 128) {
                            ...
                            if ((b7 & 192) == 128) {
                                ...
                                if ((b8 & 192) == 128) {
                                    int i18 = (b << Ascii.DC2) ^ (((b8 ^ 3678080) ^ (b7 << 6)) ^ (b6 << 12));
                                    if (i18 > 1114111) {
                                        i5 = i9 + 1;
                                        cArr[i9] = Utf8.REPLACEMENT_CHARACTER;
                                    } else {
                                        if ((55296 <= i18 && 57343 >= i18) || i18 < 65536) {
                                            i5 = i9 + 1;
                                            cArr[i9] = Utf8.REPLACEMENT_CHARACTER;
                                        } else {
                                            if (i18 != 65533) {
                                                ...
                                                i6 = i9 + 2;
                                                cArr[i9 + 1] = (char) ((i18 & AnalyticsListener.EVENT_DRM_KEYS_LOADED) + Utf8.LOG_SURROGATE_HEADER);
                                            } else {
                                                cArr[i9] = Utf8.REPLACEMENT_CHARACTER;
                                                i6 = i9 + 1;
                                            }
