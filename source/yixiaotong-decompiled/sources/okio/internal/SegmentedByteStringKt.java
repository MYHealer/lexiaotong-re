...
public final class SegmentedByteStringKt {
    ...
    public static final int segment(SegmentedByteString segment, int i) {
        ...
        int iBinarySearch = binarySearch(segment.getDirectory(), i + 1, 0, segment.getSegments().length);
    ...
    public static final ByteString commonSubstring(SegmentedByteString commonSubstring, int i, int i2) {
        ...
        byte[][] bArr = (byte[][]) ArraysKt.copyOfRange(commonSubstring.getSegments(), iSegment, iSegment2 + 1);
        byte[][] bArr2 = bArr;
        ...
        int i7 = iSegment != 0 ? commonSubstring.getDirectory()[iSegment - 1] : 0;
    ...
    public static final byte commonInternalGet(SegmentedByteString commonInternalGet, int i) {
        ...
        return commonInternalGet.getSegments()[iSegment][(i - (iSegment == 0 ? 0 : commonInternalGet.getDirectory()[iSegment - 1])) + commonInternalGet.getDirectory()[commonInternalGet.getSegments().length + iSegment]];
    }
    ...
    public static final boolean commonRangeEquals(SegmentedByteString commonRangeEquals, int i, ByteString other, int i2, int i3) {
        ...
        while (i < i4) {
            int i5 = iSegment == 0 ? 0 : commonRangeEquals.getDirectory()[iSegment - 1];
            int i6 = commonRangeEquals.getDirectory()[iSegment] - i5;
            int i7 = commonRangeEquals.getDirectory()[commonRangeEquals.getSegments().length + iSegment];
            int iMin = Math.min(i4, i6 + i5) - i;
            if (!other.rangeEquals(i2, commonRangeEquals.getSegments()[iSegment], i7 + (i - i5), iMin)) {
                return false;
            }
            i2 += iMin;
            i += iMin;
    ...
    public static final boolean commonRangeEquals(SegmentedByteString commonRangeEquals, int i, byte[] other, int i2, int i3) {
        ...
        while (i < i4) {
            ...
            int i7 = commonRangeEquals.getDirectory()[commonRangeEquals.getSegments().length + iSegment];
            int iMin = Math.min(i4, i6 + i5) - i;
            if (!Util.arrayRangeEquals(commonRangeEquals.getSegments()[iSegment], i7 + (i - i5), other, i2, iMin)) {
                return false;
            }
            i2 += iMin;
            i += iMin;
    ...
    public static final void commonWrite(SegmentedByteString commonWrite, Buffer buffer, int i, int i2) {
        ...
        while (i < i3) {
            int i4 = iSegment == 0 ? 0 : commonWrite.getDirectory()[iSegment - 1];
            int i5 = commonWrite.getDirectory()[iSegment] - i4;
            int i6 = commonWrite.getDirectory()[commonWrite.getSegments().length + iSegment];
            int iMin = Math.min(i3, i5 + i4) - i;
            int i7 = i6 + (i - i4);
            Segment segment = new Segment(commonWrite.getSegments()[iSegment], i7, i7 + iMin, true, false);
            if (buffer.head == null) {
