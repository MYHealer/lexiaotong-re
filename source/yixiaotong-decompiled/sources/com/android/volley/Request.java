...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public String getCacheKey() {
        return this.mMethod + x.bQ + this.mUrl;
    }
    ...
    public String toString() {
        return (this.mCanceled ? "[X] " : "[ ] ") + getUrl() + PPSLabelView.Code + ("0x" + Integer.toHexString(getTrafficStatsTag())) + PPSLabelView.Code + getPriority() + PPSLabelView.Code + this.mSequence;
    }

    private static String createIdentifier(int i, String str) {
        StringBuilder sbAppend = new StringBuilder("Request:").append(i).append(x.bQ).append(str).append(x.bQ).append(System.currentTimeMillis()).append(x.bQ);
        long j = sCounter;
        sCounter = 1 + j;
