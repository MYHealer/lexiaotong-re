...
public class DiskBasedCache implements Cache {
    ...
    /* JADX INFO: renamed from: com.android.volley.toolbox.DiskBasedCache$1, reason: invalid class name */
    ...
    /* JADX WARN: Code duplicated, block: B:57:0x008f A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    public synchronized Cache.Entry get(String str) {
        ...
        try {
            try {
                countingInputStream = new CountingInputStream(new BufferedInputStream(new FileInputStream(fileForKey)), objArr == true ? 1 : 0);
                try {
    ...
    private static class CountingInputStream extends FilterInputStream {
        ...
        /* synthetic */ CountingInputStream(InputStream inputStream, AnonymousClass1 anonymousClass1) {
            this(inputStream);
        }
