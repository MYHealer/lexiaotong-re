...
public class e extends MediationNativeAd {
    ...
    private NativeExpressADView f3175a;
    ...
    public e(k kVar, GdtNativeLoader gdtNativeLoader, Function<SparseArray<Object>, Object> function, NativeExpressADView nativeExpressADView, boolean z) {
        ...
        this.f3175a = nativeExpressADView;
        this.c = kVar;
        this.d = z;
        b();
    }
    ...
    private void a(Object obj) {
        ...
        if (this.d) {
            n.a(new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.e.6
                ...
                public void run() {
                    e.this.f3175a.sendLossNotification(0, iA, null);
                }
            });
        } else {
            this.f3175a.sendLossNotification(0, iA, null);
        }
    }
    ...
    private void b() {
        ...
        AdData boundData = this.f3175a.getBoundData();
        ...
        this.f3175a.setMediaListener(this.e);
        i = 5;
    ...
    public String e() {
        Object obj;
        try {
            NativeExpressADView nativeExpressADView = this.f3175a;
        ...
        if (i == 6083) {
            if (this.d) {
                n.b(new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.e.3
                    @Override // java.lang.Runnable
                    public void run() {
                        if (e.this.f3175a != null) {
                            e.this.f3175a.render();
                        }
                    }
                });
            } else {
            ...
            if (i == 6081) {
                if (isServerBidding()) {
                    NativeExpressADView nativeExpressADView2 = this.f3175a;
                    nativeExpressADView2.setBidECPM(nativeExpressADView2.getECPM());
                }
                return (T) this.f3175a;
            }
            if (i == 8135) {
                return (T) true;
            }
            if (i == 8109) {
                ...
                try {
                    if (i == 8142) {
                        NativeExpressADView nativeExpressADView3 = this.f3175a;
                        if (nativeExpressADView3 != null) {
                            if (this.d) {
                                n.a(new Runnable() { // from class: com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.e.5
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        e.this.f3175a.sendWinNotification((int) e.this.getCpm());
                                    }
                                });
                            } else {
