        ...
        try {
            try {
                ...
                if (mediationInitConfigCreate.isCustom() && mediationInitConfigCreate.getCustomInitConfigValueSet() != null) {
                    ...
                    Function<SparseArray<Object>, Object> adapterManager = (adapterManagerClassName == null || aDNName == null || !AdnManagerConfig.initAdnManager(adapterManagerClassName, aDNName)) ? null : AdnManagerConfig.getAdapterManager(aDNName);
