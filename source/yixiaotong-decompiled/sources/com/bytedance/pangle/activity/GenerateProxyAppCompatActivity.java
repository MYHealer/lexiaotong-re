...
public abstract class GenerateProxyAppCompatActivity extends AppCompatActivity implements tt {
    public Plugin mPlugin;
    public GeneratePluginAppCompatActivity mTargetActivity;

    @Override // com.byazt.euv.tt
    ...
    @Override // android.app.Activity, com.byazt.euv.tt
    public void finish() {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
