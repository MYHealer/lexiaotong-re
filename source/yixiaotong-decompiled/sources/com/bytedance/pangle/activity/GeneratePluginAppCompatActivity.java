...
import com.byazt.euv.ve;
import com.byazt.uq.c;
...
public abstract class GeneratePluginAppCompatActivity extends AppCompatActivity implements IPluginActivity {
    ...
    public void setContentView(int i) {
        ...
        ZeusTransformUtils.clearConstructorCache();
        ve.c(this, findViewById(R.id.content));
    }
    ...
    public void setPluginProxyActivity(com.byazt.euv.tt ttVar, Plugin plugin) {
        this.mProxyActivity = (GenerateProxyAppCompatActivity) ttVar;
        this.mPlugin = plugin;
    }
