...
public class MediationAdSlotValueSet {
    ...
    private SparseArray<Object> f3068a;
  ...
  0x0046: PHI (r4v8 android.util.SparseArray<java.lang.Object>) = (r4v7 android.util.SparseArray<java.lang.Object>), (r4v14 android.util.SparseArray<java.lang.Object>) binds: [B:11:0x0044, B:8:0x002f] A[DONT_GENERATE, DONT_INLINE]] */
    private MediationAdSlotValueSet(SparseArray<Object> sparseArray) {
        ...
        if (sparseArrayConverToSparseArray2 != null) {
            ...
            sparseArrayConverToSparseArray = AdnAdapterValueSetBuilder.converToSparseArray(MediationValueUtil.objectValue(this.f3068a.get(8089), Object.class, null));
            this.b = sparseArrayConverToSparseArray;
            if (sparseArrayConverToSparseArray != null) {
                this.c = AdnAdapterValueSetBuilder.converToSparseArray(MediationValueUtil.objectValue(sparseArrayConverToSparseArray.get(8443), Object.class, null));
            }
    ...
    private boolean b() {
        SparseArray<Object> sparseArray = this.f3068a;
    ...
    public String getADNId() {
        if (b()) {
            return (String) MediationValueUtil.objectValue(this.f3068a.get(AVMDLDataLoader.KeyIsLiveCacheThresholdP2pToHttp), String.class, null);
        }
        return null;
    }
    ...
    public Object getAdLoaderCallback() {
        if (b()) {
            return MediationValueUtil.objectValue(this.f3068a.get(AVMDLDataLoader.KeyIsLiveMobileDownloadAllow), Object.class, null);
        }
        return null;
    }
    ...
    public int getAdSubType() {
        if (b()) {
            return ((Integer) MediationValueUtil.objectValue(this.f3068a.get(8094), Integer.class, 0)).intValue();
        }
        return 0;
    }
    ...
    public int getAdloadSeq() {
        ...
        if (b()) {
            return ((Integer) MediationValueUtil.objectValue(this.f3068a.get(20), Integer.class, 0)).intValue();
        }
        return 0;
    }
    ...
    public String getClientReqId() {
        return b() ? (String) MediationValueUtil.objectValue(this.f3068a.get(8430), String.class, null) : "";
    }

    public String getContentUrl() {
        return b() ? (String) MediationValueUtil.objectValue(this.f3068a.get(8083), String.class, null) : "";
    }

    public String getDevices() {
        return b() ? (String) MediationValueUtil.objectValue(this.f3068a.get(8084), String.class, null) : "";
    }
    ...
    public int getOriginType() {
        if (b()) {
            return ((Integer) MediationValueUtil.objectValue(this.f3068a.get(8085), Integer.class, 0)).intValue();
        }
        return 0;
    }

    public Map<String, Object> getParams() {
        return b() ? (Map) MediationValueUtil.objectValue(this.f3068a.get(8044), Map.class, null) : new HashMap();
    }

    public int getRenderControl() {
        if (b()) {
            return ((Integer) MediationValueUtil.objectValue(this.f3068a.get(8553), Integer.class, 0)).intValue();
        }
        return 0;
    }
    ...
    public String getRitId() {
        if (b()) {
            return (String) MediationValueUtil.objectValue(this.f3068a.get(4), String.class, null);
        }
        return null;
    }
    ...
    public String getWaterfallABTest() {
        return b() ? (String) MediationValueUtil.objectValue(this.f3068a.get(8429), String.class, null) : "";
    }
    ...
    public boolean isExpress() {
        return b() && ((Boolean) MediationValueUtil.objectValue(this.f3068a.get(8033), Boolean.class, false)).booleanValue();
    }
    ...
    public boolean isSupportDeepLink() {
        if (b()) {
            return ((Boolean) MediationValueUtil.objectValue(this.f3068a.get(11), Boolean.class, false)).booleanValue();
        }
        return false;
    }
