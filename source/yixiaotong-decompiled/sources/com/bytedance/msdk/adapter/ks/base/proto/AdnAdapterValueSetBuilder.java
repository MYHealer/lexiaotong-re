...
public class AdnAdapterValueSetBuilder {
    ...
    private final SparseArray<Object> f3087a;

    /* JADX INFO: renamed from: com.bytedance.msdk.adapter.ks.base.proto.AdnAdapterValueSetBuilder$1, reason: invalid class name */
    ...
    private static final class ValueSetImpl implements ValueSet {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final SparseArray<Object> f3088a;
        private int b;

        private ValueSetImpl(SparseArray<Object> sparseArray) {
            this.b = -1;
            this.f3088a = sparseArray;
        }
        ...
        public boolean containsKey(int i) {
            return this.f3088a.indexOfKey(i) >= 0;
        }
        ...
        public Set<Integer> keys() {
            ...
            for (int i = 0; i < size; i++) {
                hashSet.add(Integer.valueOf(this.f3088a.keyAt(i)));
            }
            this.b = hashSet.size();
            return hashSet;
        }
        ...
        public SparseArray<Object> sparseArray() {
            SparseArray<Object> sparseArray = this.f3088a;
    ...
    private AdnAdapterValueSetBuilder(SparseArray<Object> sparseArray) {
        this.f3087a = sparseArray == null ? new SparseArray<>() : sparseArray;
    }
