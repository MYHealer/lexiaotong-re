...
public class MApiIMediationViewBinderReversal {
    ...
    public int getCallToActionId() {
        ...
        if (this.f3081a != null) {
            ...
            num = (Integer) this.f3081a.apply(sparseArray);
        } else {
            num = null;
        }
        if (num != null) {
    ...
    public Map<String, Integer> getExtras() {
        ...
        return (Map) this.f3081a.apply(sparseArray);
    }
