package com.bytedance.msdk.adapter.baidu.base.ad;
...
public abstract class MediationNativeAd extends AdnAdapterBaseFunction implements Bridge {
    ...
    private MediationAdLoaderBaseFunction f3043a;
    ...
    public MediationNativeAd(MediationAdLoaderBaseFunction mediationAdLoaderBaseFunction, Function<SparseArray<Object>, Object> function) {
        this.f3043a = mediationAdLoaderBaseFunction;
        this.mGMAd = function;
        a();
    }
    ...
    public String getAdm() {
        MediationAdLoaderBaseFunction mediationAdLoaderBaseFunction = this.f3043a;
    ...
    public boolean isClientBidding() {
        return this.f3043a.isClientBidding();
    }
    ...
    public boolean isExpress() {
        ...
        SparseArray<Object> sparseArray = new SparseArray<>();
        sparseArray.put(-99999987, Integer.valueOf(o.a.s));
    ...
    public boolean isMultiBidding() {
        return this.f3043a.isMultiBidding();
    }

    public boolean isServerBidding() {
        return this.f3043a.isServerBidding();
    }
