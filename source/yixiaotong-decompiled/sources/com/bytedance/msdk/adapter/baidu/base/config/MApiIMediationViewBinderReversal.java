...
public class MApiIMediationViewBinderReversal {
    ...
    public int getCallToActionId() {
        ...
        if (this.f3046a != null) {
            ...
            num = (Integer) this.f3046a.apply(sparseArray);
        } else {
            num = null;
        }
        if (num != null) {
    ...
    public Map<String, Integer> getExtras() {
        ...
        return (Map) this.f3046a.apply(sparseArray);
    }
