...
public class AdnAdapterBridgeWrapper extends AdnAdapterBaseFunction {
    ...
    private final Bridge f3051a;

    public AdnAdapterBridgeWrapper(Bridge bridge) {
        this.f3051a = bridge == null ? AdnAdapterValueSetBuilder.EMPTY_BRIDGE : bridge;
    }
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        return (T) this.f3051a.call(i, AdnAdapterValueSetBuilder.create(sparseArray).build(), cls);
    }

    @Override // com.bytedance.msdk.adapter.baidu.base.proto.AdnAdapterBaseFunction
    public SparseArray<Object> get() {
        return AdnAdapterValueSetBuilder.converToSparseArray(this.f3051a.values());
    }
