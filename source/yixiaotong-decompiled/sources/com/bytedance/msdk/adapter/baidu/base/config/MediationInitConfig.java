...
public class MediationInitConfig {
    ...
    private SparseArray<Object> f3048a;
    ...
    private boolean e() {
        SparseArray<Object> sparseArray = this.f3048a;
    ...
    public String getADNName() {
        return e() ? (String) MediationValueUtil.objectValue(this.f3048a.get(8003), String.class, null) : "";
    }

    public int getAgeGroup() {
        if (e()) {
            return ((Integer) MediationValueUtil.objectValue(this.f3048a.get(7), Integer.class, 0)).intValue();
        }
        return 0;
    }
    ...
    public String getAppId() {
        if (e()) {
            return (String) MediationValueUtil.objectValue(this.f3048a.get(3), String.class, null);
        }
        return null;
    }

    public String getAppKey() {
        return e() ? (String) MediationValueUtil.objectValue(this.f3048a.get(AVMDLDataLoader.KeyIsLiveWatchDurationThreshold), String.class, null) : "";
    }
    ...
    public String getAppName() {
        return e() ? (String) MediationValueUtil.objectValue(this.f3048a.get(8), String.class, null) : "";
    }
    ...
    public Object getBaiduCloseShake() {
        Object objObjectValue = e() ? MediationValueUtil.objectValue(this.f3048a.get(8425), Object.class, null) : "";
        if (objObjectValue instanceof Map) {
            return ((Map) objObjectValue).get(MediationConstant.GM_EXTRA_KEY_CLOSE_SHAKE);
        }
        return null;
    }

    public String getClassName() {
        return e() ? (String) MediationValueUtil.objectValue(this.f3048a.get(AVMDLDataLoader.KeyIsLiveMobileUploadAllow), String.class, null) : "";
    }
    ...
    public Function<SparseArray<Object>, Object> getInitCallback() {
        if (e()) {
            return AdnAdapterBridgeWrapper.covertToFunction(MediationValueUtil.objectValue(this.f3048a.get(8300), Object.class, null));
        }
        return null;
    }
    ...
    public IMediationLocation getLocation() {
        ...
        if (sparseArray != null && (functionCovertToFunction = AdnAdapterBridgeWrapper.covertToFunction(MediationValueUtil.objectValue(sparseArray.get(8312), Object.class, null))) != null) {
            ...
            if (objApply instanceof SparseArray) {
                ...
                return new IMediationLocation() { // from class: com.bytedance.msdk.adapter.baidu.base.config.MediationInitConfig.1
                    @Override // com.bytedance.msdk.adapter.baidu.base.config.IMediationLocation
