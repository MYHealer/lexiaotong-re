...
public final class _ah extends _aq {
    public TextView _s;
    public ImageView _t;

    public _ah(Context context) {
        super(context);
    }
    ...
    public final void _a(Context context) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.fancy_banner_view_text_float, (ViewGroup) null);
    ...
    public class _a implements _d0 {
        ...
        public final void _a(Exception exc) {
            ...
            _v _vVar = _ahVar._a;
            if (_vVar != null) {
                _vVar._a(_ahVar, PtgErrorCode.SDK_RESOURCE_ERROR, exc);
            }
        }

        @Override // com.fancy._d0
        public final void _a() {
            _ah.this.setVisibility(0);
            _v _vVar = _ah.this._a;
            if (_vVar != null) {
                _vVar._a();
            }
        }
