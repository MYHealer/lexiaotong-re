...
public final class _e implements Runnable {
    ...
    public _e(ActionTrackManager actionTrackManager) {
    ...
    public final void run() {
        ...
        String str_a = _hr._a(str.replace("__ACTION__", "exitApp").replace("__DATA__", com.fancy.adsdk.lib.utils._a._b("{}")), ActionTrackManager._a(this._a));
        _ou _ouVar_a = _ou._a();
