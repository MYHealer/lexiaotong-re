...
public final class _na extends _n8 implements PtgAdNative.NativeExpressAdListener {
    public _jt _a;
    public PtgAdNative.NativeExpressAdListener _b;
    public WeakReference<Context> _c;
    public PtgAdNative _d;
    public PtgNativeExpressAd _e;
    public AdSlot _f;
    public AtomicBoolean _g = new AtomicBoolean();
    public _ci _h;

    public _na(_jt _jtVar, _ci _ciVar, PtgAdNative ptgAdNative, Context context, AdSlot adSlot, PtgAdNative.NativeExpressAdListener nativeExpressAdListener) {
        this._a = _jtVar;
        this._d = ptgAdNative;
        this._h = _ciVar;
    ...
    public final void _a() {
        ...
        if (nativeExpressAdListener == null || (ptgNativeExpressAd = this._e) == null) {
            return;
        }
    ...
    public final boolean _b() {
        ...
        if (context == null || (adSlot = this._f) == null) {
            Logger.d("err drawFeed ad serial request, ");
            onError(new AdErrorImpl(10010, "params miss, request is interrupted", (Object) null));
            return false;
        }
        this._d.loadDrawExpressAd(context, adSlot, this);
        Logger.d("do drawFeed ad serial request, ");
        return true;
    }
