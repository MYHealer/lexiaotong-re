...
public final class _go extends _aq {
    public TextView _s;
    public ImageView _t;
    ...
    public class _a implements _d0 {
        ...
        public final void _a() {
            _go.this.setVisibility(0);
            _v _vVar = _go.this._a;
            if (_vVar != null) {
                _vVar._a();
            }
        }
        ...
        public final void _a(Exception exc) {
            ...
            _v _vVar = _goVar._a;
            if (_vVar != null) {
                _vVar._a(_goVar, PtgErrorCode.SDK_RESOURCE_ERROR, exc);
            }
        }
    }

    public _go(Context context) {
        super(context);
    }
    ...
    public final void _a(int i) {
        ...
        if (advertRatioLayout != null) {
            advertRatioLayout.setLayoutParams(new LinearLayout.LayoutParams(((i - ScreenUtils.dp2px(20.0f)) * 3) / 8, -2));
        }
    }

    @Override // com.fancy._ap
    public final void _a(Context context) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.fancy_native_view_left_image, (ViewGroup) null);
