...
public final class _gp extends _aq {
    public TextView _s;
    public ImageView _t;
    ...
    public class _a implements _d0 {
        ...
        public final void _a() {
            _gp.this.setVisibility(0);
            _v _vVar = _gp.this._a;
            if (_vVar != null) {
                _vVar._a();
            }
        }
        ...
        public final void _a(Exception exc) {
            ...
            _v _vVar = _gpVar._a;
            if (_vVar != null) {
                _vVar._a(_gpVar, PtgErrorCode.SDK_RESOURCE_ERROR, exc);
            }
        }
    }

    public _gp(Context context) {
        super(context);
    }
    ...
    public final void _a(Context context) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.fancy_native_view_left_text, (ViewGroup) null);
