...
public final class _nc extends _n8 implements PtgAdNative.NativeExpressAdListener {
    public _jt _a;
    ...
    public _nc(_jt _jtVar, _ci _ciVar, PtgAdNative ptgAdNative, Context context, AdSlot adSlot, PtgAdNative.NativeExpressAdListener nativeExpressAdListener) {
        this._a = _jtVar;
        this._d = ptgAdNative;
        this._h = _ciVar;
    ...
    public final boolean _b() {
        ...
        if (context == null || (adSlot = this._f) == null) {
            Logger.d("err native ad serial request, ");
            onError(new AdErrorImpl(10010, "params miss, request is interrupted", (Object) null));
            return false;
        }
        this._d.loadNativeExpressAd(context, adSlot, this);
        Logger.d("do native ad serial request, ");
        return true;
    }
