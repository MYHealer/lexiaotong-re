...
public final class _n9 extends _n8 implements PtgAdNative.NativeExpressAdListener {
    public _jt _a;
    ...
    public _n9(_jt _jtVar, _ci _ciVar, PtgAdNative ptgAdNative, Context context, AdSlot adSlot, PtgAdNative.NativeExpressAdListener nativeExpressAdListener) {
        this._a = _jtVar;
        this._d = ptgAdNative;
        this._h = _ciVar;
    ...
    public final boolean _b() {
        ...
        this._d.loadBannerExpressAd(context, adSlot, this);
