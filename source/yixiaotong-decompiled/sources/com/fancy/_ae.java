...
public final class _ae implements PtgAdNative.NativeExpressAdListener {
    ...
    public _ae(_cf _cfVar, AdSlot adSlot, PtgAdNative.NativeExpressAdListener nativeExpressAdListener, _em _emVar) {
        this._a = adSlot;
        this._b = _cfVar;
    ...
    public final void onError(AdError adError) {
        ...
        _em _emVar = this._d;
        _gf _gfVar = new _gf(new _ae(_cfVar, adSlot, nativeExpressAdListener, _emVar));
