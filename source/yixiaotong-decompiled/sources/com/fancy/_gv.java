...
public final class _gv extends _aq {
    public TextView _s;
    public ImageView _t;
    ...
    public class _a implements _d0 {
        ...
        public final void _a() {
            _gv.this.setVisibility(0);
            _v _vVar = _gv.this._a;
            if (_vVar != null) {
                _vVar._a();
            }
        }
        ...
        public final void _a(Exception exc) {
            ...
            _v _vVar = _gvVar._a;
            if (_vVar != null) {
                _vVar._a(_gvVar, PtgErrorCode.SDK_RESOURCE_ERROR, exc);
            }
        }
    }
    ...
    public final void _a(Context context) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.fancy_native_view_top_text, (ViewGroup) null);
