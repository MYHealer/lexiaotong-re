...
public class _d8 implements PtgAdNative.NativeExpressAdListener {
    public final PtgAdNative.NativeExpressAdListener _a;
    ...
    public class _b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public final void run() {
            _d8.this._a.onNativeExpressAdLoad(this._a);
        }
    }

    public _d8(PtgAdNative.NativeExpressAdListener nativeExpressAdListener) {
