...
public final class _gt extends _aq {
    public TextView _s;
    public ImageView _t;
    public ImageView _u;
    public ImageView _v;
    ...
    public class _a implements _d0 {
        ...
        public final void _a() {
            _gt.this.setVisibility(0);
            _v _vVar = _gt.this._a;
            if (_vVar != null) {
                _vVar._a();
            }
        }
        ...
        public final void _a(Exception exc) {
            ...
            _v _vVar = _gtVar._a;
            if (_vVar != null) {
                _vVar._a(_gtVar, PtgErrorCode.SDK_RESOURCE_ERROR, exc);
            }
        }
    }

    public _gt(Context context) {
        super(context);
    }
    ...
    public final void _a(Context context) {
        View viewInflate = LayoutInflater.from(context).inflate(R.layout.fancy_native_view_three_image, (ViewGroup) null);
