...
public final class HttpEngine {
    ...
    final OkHttpClient f8523client;
    ...
    public void sendRequest() throws RouteException, IOException, RequestException {
        ...
        InternalCache internalCache = Internal.instance.internalCache(this.f8523client);
    ...
    private HttpStream connect() throws RouteException, RequestException, IOException {
        return this.streamAllocation.newStream(this.f8523client.getConnectTimeout(), this.f8523client.getReadTimeout(), this.f8523client.getWriteTimeout(), this.f8523client.getRetryOnConnectionFailure(), !this.networkRequest.method().equals("GET"));
    }
    ...
    public HttpEngine recover(RouteException routeException) {
        if (!this.streamAllocation.recover(routeException) || !this.f8523client.getRetryOnConnectionFailure()) {
            return null;
        }
        return new HttpEngine(this.f8523client, this.userRequest, this.bufferRequestBody, this.callerWritesRequestBody, this.forWebSocket, close(), (RetryableSink) this.requestBodyOut, this.priorResponse);
    }

    public HttpEngine recover(IOException iOException, Sink sink) {
        if (!this.streamAllocation.recover(iOException, sink) || !this.f8523client.getRetryOnConnectionFailure()) {
            return null;
        }
        return new HttpEngine(this.f8523client, this.userRequest, this.bufferRequestBody, this.callerWritesRequestBody, this.forWebSocket, close(), (RetryableSink) sink, this.priorResponse);
    }
    ...
    private Request networkRequest(Request request) throws IOException {
        ...
        CookieHandler cookieHandler = this.f8523client.getCookieHandler();
    ...
    class NetworkInterceptorChain implements Interceptor.Chain {
        ...
        public Response proceed(Request request) throws IOException {
            this.calls++;
            if (this.index > 0) {
                Interceptor interceptor = HttpEngine.this.f8523client.networkInterceptors().get(this.index - 1);
            ...
            if (this.index >= HttpEngine.this.f8523client.networkInterceptors().size()) {
            ...
            Interceptor interceptor2 = HttpEngine.this.f8523client.networkInterceptors().get(this.index);
        ...
        return response.newBuilder().body(new RealResponseBody(response.headers(), Okio.buffer(new Source() { // from class: com.squareup.okhttp.internal.http.HttpEngine.2
            ...
            public long read(Buffer buffer, long j) throws IOException {
                try {
                    ...
                    if (j2 != -1) {
                        buffer.copyTo(bufferedSinkBuffer.getBufferField(), buffer.size() - j2, j2);
            ...
            public Timeout getThis$0() {
                return bufferedSourceSource.getThis$0();
            }
    ...
    public Request followUpRequest() throws IOException {
        ...
        if (route != null) {
            ...
            proxy = this.f8523client.getProxy();
        }
        ...
        if (iCode != 307 && iCode != 308) {
            ...
            return OkHeaders.processAuthHeader(this.f8523client.getAuthenticator(), this.userResponse, proxy);
        }
        if (!strMethod.equals("GET") && !strMethod.equals("HEAD")) {
            return null;
        }
        if (!this.f8523client.getFollowRedirects() || (strHeader = this.userResponse.header("Location")) == null || (httpUrlResolve = this.userRequest.httpUrl().resolve(strHeader)) == null) {
            return null;
        }
        if (!httpUrlResolve.scheme().equals(this.userRequest.httpUrl().scheme()) && !this.f8523client.getFollowSslRedirects()) {
            return null;
        }
