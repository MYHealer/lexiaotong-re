...
public final class AuthenticatorAdapter implements Authenticator {
    ...
    public Request authenticate(Proxy proxy, Response response) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ("Basic".equalsIgnoreCase(challenge.getScheme()) && (passwordAuthenticationRequestPasswordAuthentication = java.net.Authenticator.requestPasswordAuthentication(httpUrl.host(), getConnectToInetAddress(proxy, httpUrl), httpUrl.port(), httpUrl.scheme(), challenge.getRealm(), challenge.getScheme(), httpUrl.url(), java.net.Authenticator.RequestorType.SERVER)) != null) {
