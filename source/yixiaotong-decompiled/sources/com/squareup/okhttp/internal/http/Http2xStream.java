...
public final class Http2xStream implements HttpStream {
    ...
    static {
        ...
        ByteString byteStringEncodeUtf9 = ByteString.encodeUtf8("host");
        HOST = byteStringEncodeUtf9;
        ByteString byteStringEncodeUtf10 = ByteString.encodeUtf8("keep-alive");
        KEEP_ALIVE = byteStringEncodeUtf10;
        ByteString byteStringEncodeUtf11 = ByteString.encodeUtf8("proxy-connection");
        PROXY_CONNECTION = byteStringEncodeUtf11;
        ByteString byteStringEncodeUtf12 = ByteString.encodeUtf8("transfer-encoding");
        TRANSFER_ENCODING = byteStringEncodeUtf12;
        ByteString byteStringEncodeUtf13 = ByteString.encodeUtf8("te");
        TE = byteStringEncodeUtf13;
        ByteString byteStringEncodeUtf14 = ByteString.encodeUtf8("encoding");
        ENCODING = byteStringEncodeUtf14;
        ByteString byteStringEncodeUtf15 = ByteString.encodeUtf8("upgrade");
        UPGRADE = byteStringEncodeUtf15;
        SPDY_3_SKIPPED_REQUEST_HEADERS = Util.immutableList(byteStringEncodeUtf8, byteStringEncodeUtf9, byteStringEncodeUtf10, byteStringEncodeUtf11, byteStringEncodeUtf12, Header.TARGET_METHOD, Header.TARGET_PATH, Header.TARGET_SCHEME, Header.TARGET_AUTHORITY, Header.TARGET_HOST, Header.VERSION);
        SPDY_3_SKIPPED_RESPONSE_HEADERS = Util.immutableList(byteStringEncodeUtf8, byteStringEncodeUtf9, byteStringEncodeUtf10, byteStringEncodeUtf11, byteStringEncodeUtf12);
        HTTP_2_SKIPPED_REQUEST_HEADERS = Util.immutableList(byteStringEncodeUtf8, byteStringEncodeUtf9, byteStringEncodeUtf10, byteStringEncodeUtf11, byteStringEncodeUtf13, byteStringEncodeUtf12, byteStringEncodeUtf14, byteStringEncodeUtf15, Header.TARGET_METHOD, Header.TARGET_PATH, Header.TARGET_SCHEME, Header.TARGET_AUTHORITY, Header.TARGET_HOST, Header.VERSION);
        HTTP_2_SKIPPED_RESPONSE_HEADERS = Util.immutableList(byteStringEncodeUtf8, byteStringEncodeUtf9, byteStringEncodeUtf10, byteStringEncodeUtf11, byteStringEncodeUtf13, byteStringEncodeUtf12, byteStringEncodeUtf14, byteStringEncodeUtf15);
    }
    ...
    public void writeRequestHeaders(Request request) throws IOException {
        ...
        framedStreamNewStream.readTimeout().timeout(this.httpEngine.f8523client.getReadTimeout(), TimeUnit.MILLISECONDS);
        this.stream.writeTimeout().timeout(this.httpEngine.f8523client.getWriteTimeout(), TimeUnit.MILLISECONDS);
    }
    ...
    public static Response.Builder readSpdy3HeadersList(List<Header> list) throws IOException {
        ...
        StatusLine statusLine = StatusLine.parse(str2 + PPSLabelView.Code + str);
