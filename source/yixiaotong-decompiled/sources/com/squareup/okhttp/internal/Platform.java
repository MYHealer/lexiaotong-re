...
public class Platform {
    ...
    private static Platform findPlatform() {
        ...
        try {
            try {
                try {
                    ...
                    try {
                        ...
                        return new JdkWithJettyBootPlatform(cls2, cls3.getMethod("put", SSLSocket.class, Class.forName("org.eclipse.jetty.alpn.ALPN$Provider")), cls3.getMethod("get", SSLSocket.class), cls3.getMethod("remove", SSLSocket.class), Class.forName("org.eclipse.jetty.alpn.ALPN$ClientProvider"), Class.forName("org.eclipse.jetty.alpn.ALPN$ServerProvider"));
            ...
            return new Android(cls4, optionalMethod3, optionalMethod4, method2, method, optionalMethod, optionalMethod2);
    ...
    private static class JdkPlatform extends Platform {
        ...
        @Override // com.squareup.okhttp.internal.Platform
        public X509TrustManager trustManager(SSLSocketFactory sSLSocketFactory) {
            Object fieldOrNull = readFieldOrNull(sSLSocketFactory, this.sslContextClass, "context");
            if (fieldOrNull == null) {
                return null;
            }
