...
public final class FramedStream {
    ...
    /* JADX INFO: renamed from: com.squareup.okhttp.internal.framed.FramedStream$1, reason: invalid class name */
    ...
    FramedStream(int i, FramedConnection framedConnection, boolean z, boolean z2, List<Header> list) {
        ...
        FramedDataSource framedDataSource = new FramedDataSource(this, framedConnection.okHttpSettings.getInitialWindowSize(65536), anonymousClass1);
    ...
    public boolean isLocallyInitiated() {
        return this.connection.f8517client == ((this.id & 1) == 1);
    }
