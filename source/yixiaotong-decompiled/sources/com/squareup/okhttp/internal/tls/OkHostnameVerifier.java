...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private boolean verifyHostName(String str, X509Certificate x509Certificate) {
        ...
        if (z || (strFindMostSpecific = new DistinguishedNameParser(x509Certificate.getSubjectX500Principal()).findMostSpecific(CountryCodeBean.SPECIAL_COUNTRYCODE_CN)) == null) {
            return false;
        }
