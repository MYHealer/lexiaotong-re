...
public class c implements com.baidu.mobads.sdk.internal.a.a {
    ...
    public static final String f1706a = "ViewPager2";
    ...
    public static c a(IAdInterListener iAdInterListener, com.baidu.mobads.sdk.internal.a.a aVar) {
        return new c(iAdInterListener, aVar);
    }

    private c(IAdInterListener iAdInterListener, com.baidu.mobads.sdk.internal.a.a aVar) {
    ...
    public static class a implements IOAdEventListener {
                    ...
                    if (c.h.equals(iOAdEvent.getType()) && (data = iOAdEvent.getData()) != null && !data.isEmpty()) {
                        ...
                        if ((obj2 instanceof String) && (obj instanceof String)) {
                            ...
                            if (c.j.equals((String) obj2) && (obj3 instanceof Map)) {
                                Map map = (Map) obj3;
                                map.put(c.f1706a, ViewPager2.class);
        ...
        private com.baidu.mobads.sdk.internal.a.a a(String str, IAdInterListener iAdInterListener, Object[] objArr) {
            if (c.f1706a.equals(str) && c.a(objArr, (Class<?>[]) new Class[]{Context.class})) {
