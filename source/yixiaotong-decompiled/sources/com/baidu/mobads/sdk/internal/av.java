...
public class av {
    ...
    static bv f1732a = bv.a();
    private static final String b = "com.baidu.mobads.sdk.internal.av";
    ...
    public static Class<?> a(String str, ClassLoader classLoader) {
        if (classLoader != null) {
            try {
                ...
                f1732a.a(b, Log.getStackTraceString(e));
            }
        }
        return null;
    }
    ...
    public static Class<?> a(String str) {
        try {
            ...
            f1732a.b(b, Log.getStackTraceString(e));
            return null;
        }
    }
