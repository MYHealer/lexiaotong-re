...
public class az {
    ...
    public static final String f1735a = "bqt_ad_tag";
    static volatile a[] b;
    ...
    public static abstract class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final ThreadLocal<String> f1736a = new ThreadLocal<>();
        ...
        private void b(int i, Throwable th, String str) {
            ...
            if (a(strB, i)) {
                ...
                if (str == null) {
                    ...
                    str = str + IOUtils.LINE_SEPARATOR_UNIX + g(th);
                }
                a(i, strB, str, th);
            }
        }
