...
public class i {
    ...
    private static final byte[] f1814a = {48, 75, 97, 106, 68, 55, 65, 90, 99, 70, 50, 81, 110, 80, 114, 53, 102, 119, 105, 72, 82, 78, 121, 103, 109, 117, 112, 85, 84, 73, 88, 120, 54, 57, 66, 87, 98, 45, 104, 77, 67, 71, 74, 111, 95, 86, 56, 69, 115, 107, 122, 49, 89, 100, 118, 76, 51, 52, 108, 101, 116, 113, 83, 79};
    ...
    public String a(String str) {
        ...
        while (i < bytes.length) {
            byte[] bArr2 = f1814a;
            bArr[i2] = bArr2[(bytes[i] & FileDownloadStatus.warn) >> 2];
            int i3 = i + 1;
