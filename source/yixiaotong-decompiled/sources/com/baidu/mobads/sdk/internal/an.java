...
public class an {
    ...
    public static final String f1723a = "OAdURLConnection";
    ...
    public void e() throws Throwable {
        ...
        try {
            ...
            this.f.setRequestProperty("Cache-Control", HeaderConstants.CACHE_CONTROL_NO_CACHE);
    ...
    public void f() {
        ...
        try {
            try {
                this.f.connect();
                this.g.a(f1723a, this.f.getRequestMethod() + " connect code :" + this.f.getResponseCode());
