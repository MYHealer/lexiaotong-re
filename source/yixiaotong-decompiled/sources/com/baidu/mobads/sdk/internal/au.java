...
public class au {
    ...
    private Class<?> f1731a;
    private Method[] b;

    public static au a(Context context, String str) {
        if (!c.containsKey(str) || c.get(str).f1731a == null) {
    ...
    public Object a(Class<?>[] clsArr, Object... objArr) {
        ...
        if (objArr != null) {
            try {
                if (objArr.length == 0) {
                    constructor = this.f1731a.getConstructor(new Class[0]);
                } else {
                    constructor = this.f1731a.getConstructor(clsArr);
                }
            } catch (Throwable th) {
                bv.a().a(th);
                return null;
