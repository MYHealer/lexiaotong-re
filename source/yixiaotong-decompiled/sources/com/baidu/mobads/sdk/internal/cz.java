...
public class cz extends bj {
    ...
    private static final String J = "cz";

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final String f1798a = "enter_refresh_bookstore";
    ...
    public void a() {
        ...
        try {
            ...
            m();
            this.m.addEventListener("Update_fbReader_Setting", new da(this));
            this.m.addEventListener("closeInterstitialAd", new db(this));
            JSONObject jSONObject2 = new JSONObject();
            if (!TextUtils.isEmpty(this.D)) {
                jSONObject2.put("appid", this.D);
            }
            jSONObject2.put(IAdInterListener.AdReqParam.PROD, "novel");
            this.m.loadAd(jSONObject2, m.a(this.C));
        } catch (Throwable th) {
            this.k.c(J, th);
        }
    }
    ...
    @Override // com.baidu.mobads.sdk.internal.bj
    public View w() {
        View viewA = ao.a(this.i);
        if (viewA instanceof FrameLayout) {
            RelativeLayout relativeLayout = new RelativeLayout(this.i);
            this.L = new SoftReference<>(relativeLayout);
            relativeLayout.setId(33);
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, bb.a(this.i, 53.0f));
