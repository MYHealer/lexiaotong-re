                ...
                if (!map.isEmpty()) {
                    ...
                    if (!map2.isEmpty()) {
                        ...
                        for (String str5 : setKeySet) {
                            if (!TextUtils.isEmpty(str5)) {
                                ...
                                if (!TextUtils.isEmpty(str6)) {
                                    ...
                                    jSONObject.put(com.kuaishou.weapon.p0.t.f4727a, str5);
                        ...
                        if (jSONArray.length() > 0) {
                            ...
                            jSONObject2.put(o0OO000o.o00O0O0O, jSONArray.toString());
                            if (jSONObject2.toString().length() < 3000) {
                                map3.put(o0OO000o.o00O0O0O, jSONObject2.toString());
                            }
                        }
                    }
                    return map3;
