...
public class BDMarketingTextView extends RelativeLayout {
    ...
    public void setAdData(NativeResponse nativeResponse, String str) {
        if (this.mAdView != null) {
            av.a(z.g, this.mAdView, this.mLoader, "setAdData", new Class[]{Object.class, String.class}, nativeResponse, str);
        }
    }
    ...
    public void setTextFontSizeSp(int i) {
        if (this.mAdView != null) {
            av.a(z.g, this.mAdView, this.mLoader, "setTextFontSizeSp", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }

    public void setTextFontTypeFace(Typeface typeface) {
        if (this.mAdView != null) {
            av.a(z.g, this.mAdView, this.mLoader, "setTextFontTypeFace", new Class[]{Typeface.class}, typeface);
        }
    }

    public void setTextFontColor(int i) {
        if (this.mAdView != null) {
            av.a(z.g, this.mAdView, this.mLoader, "setTextFontColor", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }

    public void setTextMaxLines(int i) {
        if (this.mAdView != null) {
            av.a(z.g, this.mAdView, this.mLoader, "setTextMaxLines", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }

    public void setEllipsize(TextUtils.TruncateAt truncateAt) {
        if (this.mAdView != null) {
            av.a(z.g, this.mAdView, this.mLoader, "setEllipsize", new Class[]{TextUtils.TruncateAt.class}, truncateAt);
        }
    }

    public void setLineSpacingExtra(int i) {
        if (this.mAdView != null) {
            av.a(z.g, this.mAdView, this.mLoader, "setLineSpacingExtra", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }

    public void setLabelVisibility(int i) {
        if (this.mAdView != null) {
            av.a(z.g, this.mAdView, this.mLoader, "setLabelVisibility", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }
