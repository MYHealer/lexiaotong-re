...
public class SplashAd {
    ...
    public final void load() {
        ...
        if (i2 < 200.0f * fE || i < fE * 150.0f) {
            bv.a().c(de.a().a(br.SHOW_STANDARD_UNFIT, "开屏显示区域太小,宽度至少200dp,高度至少150dp"));
        ...
        dk dkVar2 = new dk(this.mContext, this.mAdPlaceId, i2, i, this.mTipStyle, this.mTimeout, this.mDisplayDownInfo, this.mPopDialogIfDL.booleanValue(), this.mDisplayClickRegion.booleanValue(), this.mLimitRegionClick.booleanValue());
        this.mAdProd = dkVar2;
        dkVar2.d(this.mShakeLogoSize);
    ...
    public String getECPMLevel() {
        a aVarG;
        dk dkVar = this.mAdProd;
        return (dkVar == null || (aVarG = dkVar.g()) == null) ? "" : aVarG.A();
    }

    public String getPECPM() {
        a aVarG;
        dk dkVar = this.mAdProd;
        return (dkVar == null || (aVarG = dkVar.g()) == null) ? "" : aVarG.B();
    }

    public void biddingSuccess(LinkedHashMap<String, Object> linkedHashMap, BiddingListener biddingListener) {
        dk dkVar = this.mAdProd;
        if (dkVar != null) {
            dkVar.a(true, linkedHashMap, biddingListener);
        }
    }
    ...
    public void biddingFail(LinkedHashMap<String, Object> linkedHashMap, BiddingListener biddingListener) {
        dk dkVar = this.mAdProd;
        if (dkVar != null) {
            dkVar.a(false, linkedHashMap, biddingListener);
        }
    }
        ...
        ctVar.a(new ct.a() { // from class: com.baidu.mobads.sdk.api.SplashAd.3
            ...
            public void onLayoutComplete(int i, int i2) {
                ...
                if (i3 >= 200.0f * fE && i4 >= fE * 150.0f) {
                    SplashAd.this.mAdProd = new dk(SplashAd.this.mContext, SplashAd.this.mAdPlaceId, i3, i4, SplashAd.this.mTipStyle, SplashAd.this.mTimeout, SplashAd.this.mDisplayDownInfo, SplashAd.this.mPopDialogIfDL.booleanValue(), SplashAd.this.mDisplayClickRegion.booleanValue(), SplashAd.this.mLimitRegionClick.booleanValue());
                    SplashAd.this.mAdProd.a(ctVar);
    ...
    public static void registerEnterTransition(Activity activity, SplashFocusParams splashFocusParams, SplashFocusAdListener splashFocusAdListener) {
        dk.a(activity, splashFocusParams != null ? splashFocusParams.getFocusParams() : null, splashFocusAdListener);
    }
    ...
    public static void registerEnterTransition(Activity activity, int i, int i2, SplashFocusAdListener splashFocusAdListener) {
        ...
        dk.a(activity, jSONObject, splashFocusAdListener);
    }
    ...
    public void setDownloadDialogListener(SplashAdDownloadDialogListener splashAdDownloadDialogListener) {
        ...
        dk dkVar = this.mAdProd;
        if (dkVar != null) {
            dkVar.a(splashAdDownloadDialogListener);
        }
    }
