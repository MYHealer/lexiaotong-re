...
public class Registry {
    ...
    public Registry() {
        Pools.Pool<List<Throwable>> poolThreadSafeList = FactoryPools.threadSafeList();
        this.throwableListPool = poolThreadSafeList;
        this.modelLoaderRegistry = new ModelLoaderRegistry(poolThreadSafeList);
    ...
    public <Model, TResource, Transcode> List<Class<?>> getRegisteredResourceClasses(Class<Model> cls, Class<TResource> cls2, Class<Transcode> cls3) {
        List<Class<?>> arrayList = this.modelToResourceClassCache.get(cls, cls2, cls3);
        if (arrayList == null) {
