...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private RequestManager getApplicationManager(Context context) {
        if (this.applicationManager == null) {
            synchronized (this) {
                if (this.applicationManager == null) {
                    this.applicationManager = this.factory.build(Glide.get(StubApp.getOrigApplicationContext(context.getApplicationContext())), new ApplicationLifecycle(), new EmptyRequestManagerTreeNode(), StubApp.getOrigApplicationContext(context.getApplicationContext()));
                }
            }
        }
    ...
    public RequestManager get(Fragment fragment) {
        ...
        if (Util.isOnBackgroundThread()) {
            return get(StubApp.getOrigApplicationContext(fragment.getContext().getApplicationContext()));
        }
    ...
    public RequestManager get(View view) {
        if (Util.isOnBackgroundThread()) {
            return get(StubApp.getOrigApplicationContext(view.getContext().getApplicationContext()));
        }
    ...
    public boolean handleMessage(Message message) {
        ...
        if (Log.isLoggable(TAG, 5) && z && objRemove == null) {
