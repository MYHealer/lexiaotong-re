...
public final class GlideBuilder {
    ...
    Glide build(Context context) {
        ...
        GlideExperiments glideExperimentsBuild = this.glideExperimentsBuilder.build();
        return new Glide(context, this.engine, this.memoryCache, this.bitmapPool, this.arrayPool, new RequestManagerRetriever(this.requestManagerFactory, glideExperimentsBuild), this.connectivityMonitorFactory, this.logLevel, this.defaultRequestOptionsFactory, this.defaultTransitionOptions, this.defaultRequestListeners, glideExperimentsBuild);
    }
