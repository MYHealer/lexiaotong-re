...
public class OpenHelperManager {
    ...
    public static synchronized OrmLiteSqliteOpenHelper getHelper(Context context) {
        if (helperClass == null) {
            ...
            innerSetHelperClass(lookupHelperClass(StubApp.getOrigApplicationContext(context.getApplicationContext()), context.getClass()));
        }
    ...
    private static <T extends OrmLiteSqliteOpenHelper> T loadHelper(Context context, Class<T> cls) {
        if (helper == null) {
            ...
            helper = constructHelper(StubApp.getOrigApplicationContext(context.getApplicationContext()), cls);
