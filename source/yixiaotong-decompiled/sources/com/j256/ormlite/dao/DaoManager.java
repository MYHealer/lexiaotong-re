    ...
    public static synchronized <D extends Dao<T, ?>, T> D createDao(ConnectionSource connectionSource, Class<T> cls) throws SQLException {
        ...
        if (databaseTable == null || databaseTable.daoClass() == Void.class || databaseTable.daoClass() == BaseDaoImpl.class) {
            ...
            if (databaseTableConfigExtractDatabaseTableConfig == null) {
                dCreateDao = (D) BaseDaoImpl.createDao(connectionSource, cls);
            } else {
                dCreateDao = BaseDaoImpl.createDao(connectionSource, databaseTableConfigExtractDatabaseTableConfig);
            }
            ...
            try {
                dCreateDao = (D) constructorFindConstructor.newInstance(objArr);
        ...
        registerDao(connectionSource, dCreateDao);
        return (D) dCreateDao;
    }
