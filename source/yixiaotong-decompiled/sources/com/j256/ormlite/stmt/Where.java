...
public class Where<T, ID> {
    ...
    public <OD> Where<T, ID> idEq(Dao<OD, ?> dao, OD od) throws SQLException {
        ...
        addClause(new SimpleComparison(this.idColumnName, this.idFieldType, dao.extractId(od), "="));
        return this;
    }
    ...
    void appendSql(String str, StringBuilder sb, List<ArgumentHolder> list) throws SQLException {
    ...
    private Where<T, ID> in(boolean z, String str, Object... objArr) throws SQLException {
        if (objArr.length == 1) {
            boolean zIsArray = objArr[0].getClass().isArray();
            ...
            if (zIsArray) {
                ...
                throw new IllegalArgumentException(sb.append(str2).append(" seems to be an array within an array").toString());
            }
            Object obj = objArr[0];
            if (obj instanceof Where) {
                ...
                throw new IllegalArgumentException(sb2.append(str2).append(" seems to be a Where object, did you mean the QueryBuilder?").toString());
            }
            if (obj instanceof PreparedStmt) {
                ...
                throw new IllegalArgumentException(sb3.append(str2).append(" seems to be a prepared statement, did you mean the QueryBuilder?").toString());
            }
        }
