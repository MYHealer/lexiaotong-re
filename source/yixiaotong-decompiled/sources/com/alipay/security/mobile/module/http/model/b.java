...
public class b {
    public static c a(DataReportResult dataReportResult) {
        ...
        cVar.f1702a = dataReportResult.success;
        ...
        if (map != null) {
            ...
            if (com.alipay.security.mobile.module.a.a.b(str)) {
                if (str.length() > 0) {
                    cVar.j = new StringBuilder().append(str.charAt(0)).toString();
                }
                if (str.length() >= 3) {
                    cVar.k = new StringBuilder().append(str.charAt(2)).toString();
                }
            }
    ...
    public static DataReportRequest a(d dVar) {
        ...
        dataReportRequest.os = dVar.f1703a;
