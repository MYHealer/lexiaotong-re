...
public final class k {
    ...
    private static final Pattern f1580a = Pattern.compile("([0-9]{1,2})[- ]([A-Za-z]{3,9})[- ]([0-9]{2,4})[ ]([0-9]{1,2}:[0-9][0-9]:[0-9][0-9])");
    ...
    public static long a(String str) {
        ...
        int i2;
        int i3;
        Matcher matcher = f1580a.matcher(str);
        if (matcher.find()) {
        ...
        time.set(aVarE.c, aVarE.b, aVarE.f1581a, i, i2, i3);
    ...
    private static a e(String str) {
        ...
        return new a(iCharAt, ((str.charAt(i + 1) - '0') * 10) + (str.charAt(i + 2) - '0'), ((str.charAt(i + 4) - '0') * 10) + (str.charAt(i + 5) - '0'));
    }
}
