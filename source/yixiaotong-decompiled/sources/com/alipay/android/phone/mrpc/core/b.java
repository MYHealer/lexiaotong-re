...
public final class b implements HttpClient {
    ...
    class a implements HttpRequestInterceptor {
        ...
        public final void process(HttpRequest httpRequest, HttpContext httpContext) {
            C0081b c0081b = b.this.f;
            if (c0081b != null && C0081b.a(c0081b) && (httpRequest instanceof HttpUriRequest)) {
                C0081b.a(c0081b, b.a((HttpUriRequest) httpRequest));
            }
        }
    }
    ...
    private static class C0081b {
        ...
        static /* synthetic */ void a(C0081b c0081b, String str) {
            Log.println(c0081b.b, c0081b.f1574a, str);
        }

        static /* synthetic */ boolean a(C0081b c0081b) {
            return Log.isLoggable(c0081b.f1574a, c0081b.b);
        }
    }
    ...
    public static b a(String str) {
        ...
        HttpConnectionParams.setSoTimeout(basicHttpParams, KSImageLoader.InnerImageLoadingListener.MAX_DURATION);
        ...
        schemeRegistry.register(new Scheme("https", SSLCertificateSocketFactory.getHttpSocketFactory(KSImageLoader.InnerImageLoadingListener.MAX_DURATION, null), 443));
