...
public class a {
    ...
    private static final String f1654a = "00:00:00:00:00:00";
    private static a e;
    private String b;
    private String c;
    private String d;
    ...
    private a(Context context) {
        try {
            try {
                ...
                String macAddress = ((WifiManager) StubApp.getOrigApplicationContext(context.getApplicationContext()).getSystemService("wifi")).getConnectionInfo().getMacAddress();
                this.d = macAddress;
