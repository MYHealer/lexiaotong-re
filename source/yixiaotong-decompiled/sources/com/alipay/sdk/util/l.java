...
public class l {
    ...
    public static final String f1664a = "resultStatus";
    ...
    private static Map<String, String> a() {
        com.alipay.sdk.app.k kVarB = com.alipay.sdk.app.k.b(com.alipay.sdk.app.k.CANCELED.a());
        HashMap map = new HashMap();
        map.put(f1664a, Integer.toString(kVarB.a()));
        map.put(b, kVarB.b());
        map.put("result", "");
        return map;
    }
