...
public class c {
    ...
    private static final String f1636a = "virtualImeiAndImsi";
    ...
    public String a(com.alipay.sdk.tid.b bVar) {
        ...
        if (TextUtils.isEmpty(this.e)) {
            this.e = "Msp/15.6.8 (" + n.b() + ";" + n.c() + ";" + n.d(contextB) + ";" + n.f(contextB) + ";" + n.e(contextB) + ";" + b(contextB);
        }
        ...
        String strReplace = Build.MANUFACTURER.replace(";", PPSLabelView.Code);
        String strReplace2 = Build.MODEL.replace(";", PPSLabelView.Code);
        boolean zD = com.alipay.sdk.sys.b.d();
        String strD2 = aVarA.d();
        String strC2 = c(contextB);
        String strD3 = d(contextB);
        StringBuilder sb = new StringBuilder();
        sb.append(this.e).append(";").append(strB).append(";").append(strG).append(";").append(strE).append(";").append(strA).append(";").append(strB2).append(";").append(this.g).append(";").append(strReplace).append(";").append(strReplace2).append(";").append(zD).append(";").append(strD2).append(";").append(f()).append(";").append(this.f).append(";").append(strD).append(";").append(strC).append(";").append(strC2).append(";").append(strD3);
        if (bVar != null) {
    ...
    public String c() {
        String strB;
        Context contextB = com.alipay.sdk.sys.b.a().b();
        SharedPreferences sharedPreferences = contextB.getSharedPreferences(f1636a, 0);
