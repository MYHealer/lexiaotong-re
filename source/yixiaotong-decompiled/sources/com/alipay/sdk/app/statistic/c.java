...
public class c {
    ...
    public static final String f1629a = "net";
    ...
    private String b(String str) {
        return TextUtils.isEmpty(str) ? "" : str.replace("[", "【").replace("]", "】").replace("(", "（").replace(")", "）").replace(",", "，").replace(x.A, "=").replace("^", "~");
    }
    ...
    private String a(Throwable th) {
        ...
        try {
            stringBuffer.append(th.getClass().getName()).append(x.bQ);
    ...
    private String a(Context context) {
        ...
        if (context != null) {
            try {
                ...
                packageName = origApplicationContext.getPackageName();
                try {
    ...
    private String b(Context context) {
        return String.format("%s,%s,%s,%s,%s,%s,%s,%s,%s,-", b(com.alipay.sdk.util.a.d(context)), "android", b(Build.VERSION.RELEASE), b(Build.MODEL), x.A, b(com.alipay.sdk.util.a.a(context).a()), b(com.alipay.sdk.util.a.b(context).b()), "gw", b(com.alipay.sdk.util.a.a(context).b()));
    }
}
