...
public class WebViewWindow extends LinearLayout {
    ...
    public WebViewWindow(Context context, AttributeSet attributeSet) throws PackageManager.NameNotFoundException {
    ...
    private void a(Context context) {
        ...
        this.f1669a.setImageDrawable(com.alipay.sdk.util.k.a(com.alipay.sdk.util.k.f1663a, context));
        this.f1669a.setPadding(a(12), 0, a(12), 0);
        linearLayout.addView(this.f1669a, new LinearLayout.LayoutParams(-2, -2));
    ...
    private void c(Context context) throws PackageManager.NameNotFoundException {
    ...
    protected void a(WebView webView, Context context) throws PackageManager.NameNotFoundException {
