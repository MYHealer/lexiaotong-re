...
public class j extends g implements WebViewWindow.a, WebViewWindow.b, WebViewWindow.c {
    ...
    private boolean c() {
        try {
            WebViewWindow webViewWindow = new WebViewWindow(this.f1676a);
    ...
    private boolean b(String str, String str2) {
        WebViewWindow webViewWindow = this.x;
        try {
            WebViewWindow webViewWindow2 = new WebViewWindow(this.f1676a);
    ...
    public boolean b(WebViewWindow webViewWindow, String str) {
        ...
        if (TextUtils.equals(str, com.alipay.sdk.cons.a.m)) {
            a(false);
            return true;
        }
    ...
    public boolean a(WebViewWindow webViewWindow, SslErrorHandler sslErrorHandler, SslError sslError) {
        ...
        this.f1676a.runOnUiThread(new n(this, sslErrorHandler));
        return true;
    }

    private void b(String str) {
        Map<String, String> mapC = com.alipay.sdk.util.n.c(str);
        if (str.startsWith(i)) {
            a(mapC.get(ICBCWebChromeClient.JAVASCRIPT_COMMON_VALUE_FUNCTION), mapC.get("cbId"), mapC.get("data"));
            return;
        }
        if (str.startsWith(c)) {
            e();
        ...
        if (str.startsWith(d) && mapC.containsKey("title")) {
            this.x.getTitle().setText(mapC.get("title"));
            return;
        }
        if (str.startsWith(e)) {
        ...
        if (str.startsWith(f) && mapC.containsKey("bshow")) {
            this.x.getBackButton().setVisibility(TextUtils.equals(ez.Code, mapC.get("bshow")) ? 0 : 4);
        } else if (str.startsWith(g)) {
            com.alipay.sdk.app.j.a(mapC.get("result"));
            a(TextUtils.equals(ez.Code, mapC.get("bsucc")));
    ...
    private void a(String str, String str2, String str3) {
        JSONObject jSONObjectD = com.alipay.sdk.util.n.d(str3);
        if ("title".equals(str) && jSONObjectD.has("title")) {
            this.x.getTitle().setText(jSONObjectD.optString("title", ""));
            return;
        }
        if (l.equals(str)) {
            this.x.getWebView().reload();
        ...
        if (o.equals(str)) {
            com.alipay.sdk.app.j.a(jSONObjectD.optString("result", null));
            a(jSONObjectD.optBoolean("success", false));
            return;
        }
        if (m.equals(str)) {
            this.x.getBackButton().setVisibility(jSONObjectD.optBoolean(br.b.V, true) ? 0 : 4);
            return;
        }
        if (n.equals(str)) {
            this.x.getRefreshButton().setVisibility(jSONObjectD.optBoolean(br.b.V, true) ? 0 : 4);
        } else {
            if (!q.equals(str) || jSONObjectD.optString("url", null) == null) {
                return;
            }
            b(jSONObjectD.optString("url"), jSONObjectD.optString("title", ""));
        }
    }
