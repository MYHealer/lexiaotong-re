...
public class a {
    ...
    public static final String f1670a = "正在加载";
    ...
    private AlertDialogC0084a e;
    private Activity f;
    private String g;
    private long h = -1;
    private final int i = 1;
    private final long j = C.DEFAULT_SEEK_FORWARD_INCREMENT_MS;
    ...
    /* JADX INFO: renamed from: com.alipay.sdk.widget.a$a, reason: collision with other inner class name */
    public class AlertDialogC0084a extends AlertDialog {
        protected AlertDialogC0084a(Context context) {
            super(context);
        }
        ...
        private View a(Context context) {
            ...
            textView.setText(TextUtils.isEmpty(a.this.g) ? a.f1670a : a.this.g);
