...
public class ParseException extends Exception {
    ...
    public ParseException(ParseCharStream parseCharStream, char c, char c2) {
        this(parseCharStream, new StringBuffer("got '").append(c).append("' instead of expected '").append(c2).append("'").toString());
    }

    public ParseException(ParseCharStream parseCharStream, char c, String str) {
        this(parseCharStream, new StringBuffer("got '").append(c).append("' instead of ").append(str).append(" as expected").toString());
    }

    public ParseException(ParseCharStream parseCharStream, char c, char[] cArr) {
        this(parseCharStream, new StringBuffer("got '").append(c).append("' instead of ").append(toString(cArr)).toString());
    }
    ...
    public ParseException(ParseCharStream parseCharStream, String str, String str2) {
        this(parseCharStream, new StringBuffer("got \"").append(str).append("\" instead of \"").append(str2).append("\" as expected").toString());
    }
    ...
    public ParseException(String str, Throwable th) {
        super(new StringBuffer().append(str).append(PPSLabelView.Code).append(th).toString());
        this.lineNumber_ = -1;
        this.cause_ = th;
    }
