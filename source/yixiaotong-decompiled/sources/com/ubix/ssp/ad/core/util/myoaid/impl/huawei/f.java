...
public abstract class f {
    ...
    public static final ThreadPoolExecutor f8603a = new ThreadPoolExecutor(0, 3, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(2048), new ThreadPoolExecutor.DiscardPolicy());
    ...
    public static Integer b(Context context) {
        ...
        try {
            ApplicationInfo applicationInfo = context.getPackageManager().getApplicationInfo(d.a(context), 128);
            if (applicationInfo != null && (bundle = applicationInfo.metaData) != null && (obj = bundle.get("ppskit_ver_code")) != null) {
                return Integer.valueOf(obj.toString());
            }
        } catch (Throwable th) {
            u.e("StmUt", "getPpsKitVerCode ex: " + th.getClass().getSimpleName());
        }
        return null;
    }
}
