...
public final class g {
    ...
    public static <T extends f> String a(T t) {
        StringBuilder sb;
        String message;
        if (t == null) {
            return "";
        ...
        if (!(obj instanceof f)) {
            if (!(obj instanceof Map)) {
                ...
                if (obj instanceof String) {
                    stringBuffer2.append("\"").append(c((String) obj)).append("\"");
            ...
            for (Map.Entry entry : ((Map) obj).entrySet()) {
                stringBuffer2.append(stringBuffer).append(strA).append(" <\n");
                int length = stringBuffer.length();
                stringBuffer.append("  ");
                a("key", entry.getKey(), stringBuffer, stringBuffer2);
                a(oOOOoo00.OooOo0o, entry.getValue(), stringBuffer, stringBuffer2);
