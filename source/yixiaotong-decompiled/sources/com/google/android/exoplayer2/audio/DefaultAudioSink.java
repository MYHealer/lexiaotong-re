...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (i != 0) {
            ...
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i2, iIntValue, encoding), encoding, i5, pcmFrameSize, i2, this.enableAudioTrackPlaybackParams ? 8.0d : 1.0d);
        }
        if (encoding == 0) {
        ...
        Configuration configuration = new Configuration(format, i4, i5, pcmFrameSize, i2, iIntValue, encoding, bufferSizeInBytes, audioProcessorArr);
