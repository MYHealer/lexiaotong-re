...
public final class AacUtil {
    ...
    private static final int[] AUDIO_SPECIFIC_CONFIG_SAMPLING_RATE_TABLE = {96000, 88200, 64000, OpusUtil.SAMPLE_RATE, SWCommandUtil.SampleRate, 32000, 24000, 22050, AAC_HE_V1_MAX_RATE_BYTES_PER_SECOND, 12000, 11025, 8000, 7350};
    private static final int[] AUDIO_SPECIFIC_CONFIG_CHANNEL_COUNT_TABLE = {0, 1, 2, 3, 4, 5, 6, 8, -1, -1, -1, 7, 8, -1, 8, -1};

    /* JADX INFO: renamed from: com.google.android.exoplayer2.audio.AacUtil$1, reason: invalid class name */
    ...
    public static final class Config {
        ...
        /* synthetic */ Config(int i, int i2, String str, AnonymousClass1 anonymousClass1) {
            this(i, i2, str);
        }
    ...
    public static Config parseAudioSpecificConfig(ParsableBitArray parsableBitArray, boolean z) throws ParserException {
        ...
        return new Config(samplingFrequency, i, str, anonymousClass1);
    }
