...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.audio.MediaCodecAudioRenderer$1, reason: invalid class name */
    ...
    protected void onOutputFormatChanged(Format format, MediaFormat mediaFormat) throws ExoPlaybackException {
        ...
        if (format2 != null) {
            ...
            Format formatBuild = new Format.Builder().setSampleMimeType(MimeTypes.AUDIO_RAW).setPcmEncoding(pcmEncoding).setEncoderDelay(format.encoderDelay).setEncoderPadding(format.encoderPadding).setChannelCount(mediaFormat.getInteger(com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_CHANNEL_COUNT)).setSampleRate(mediaFormat.getInteger(com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_SAMPLE_RATE)).build();
