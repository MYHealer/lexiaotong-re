...
public final class MpegAudioUtil {
    ...
    private static final int[] SAMPLING_RATE_V1 = {SWCommandUtil.SampleRate, OpusUtil.SAMPLE_RATE, 32000};
    ...
    private static final int[] BITRATE_V2_L1 = {32000, OpusUtil.SAMPLE_RATE, 56000, 64000, 80000, 96000, 112000, 128000, 144000, 160000, 176000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 224000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND};
    private static final int[] BITRATE_V1_L2 = {32000, OpusUtil.SAMPLE_RATE, 56000, 64000, 80000, 96000, 112000, 128000, 160000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 224000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND, 320000, 384000};
    public static final int MAX_RATE_BYTES_PER_SECOND = 40000;
    private static final int[] BITRATE_V1_L3 = {32000, MAX_RATE_BYTES_PER_SECOND, OpusUtil.SAMPLE_RATE, 56000, 64000, 80000, 96000, 112000, 128000, 160000, DtsUtil.DTS_MAX_RATE_BYTES_PER_SECOND, 224000, AacUtil.AAC_XHE_MAX_RATE_BYTES_PER_SECOND, 320000};
    private static final int[] BITRATE_V2 = {8000, AacUtil.AAC_HE_V1_MAX_RATE_BYTES_PER_SECOND, 24000, 32000, MAX_RATE_BYTES_PER_SECOND, OpusUtil.SAMPLE_RATE, 56000, 64000, 80000, 96000, 112000, 128000, 144000, 160000};
    ...
    public static final class Header {
        ...
        public boolean setForHeaderData(int i) {
            ...
            if (i3 == 3) {
                ...
                int i9 = MediaPlayer.MEDIA_PLAYER_OPTION_SPADE;
                if (i2 == 3) {
                    int i10 = i3 == 2 ? MpegAudioUtil.BITRATE_V1_L2[i4 - 1] : MpegAudioUtil.BITRATE_V1_L3[i4 - 1];
                    this.bitrate = i10;
                    this.frameSize = ((i10 * MediaPlayer.MEDIA_PLAYER_OPTION_SPADE) / this.sampleRate) + i7;
                } else {
    ...
    public static int getFrameSize(int i) {
        ...
        int i9 = MediaPlayer.MEDIA_PLAYER_OPTION_SPADE;
        if (i2 == 3) {
            return ((i6 * MediaPlayer.MEDIA_PLAYER_OPTION_SPADE) / i7) + i8;
        }
        if (i3 == 1) {
            i9 = 72;
        }
