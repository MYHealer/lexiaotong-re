...
public final class Ac4Util {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.audio.Ac4Util$1, reason: invalid class name */
    ...
    public static final class SyncFrameInfo {
        ...
        /* synthetic */ SyncFrameInfo(int i, int i2, int i3, int i4, int i5, AnonymousClass1 anonymousClass1) {
            this(i, i2, i3, i4, i5);
        }
    ...
    public static Format parseAc4AnnexEFormat(ParsableByteArray parsableByteArray, String str, String str2, DrmInitData drmInitData) {
        ...
        return new Format.Builder().setId(str).setSampleMimeType(MimeTypes.AUDIO_AC4).setChannelCount(2).setSampleRate(((parsableByteArray.readUnsignedByte() & 32) >> 5) == 1 ? OpusUtil.SAMPLE_RATE : SWCommandUtil.SampleRate).setDrmInitData(drmInitData).setLanguage(str2).build();
    }
    ...
    public static SyncFrameInfo parseAc4SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        return new SyncFrameInfo(i5, 2, i6, i4, i2, null);
    }
