...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$1, reason: invalid class name */
        ...
        static {
            ...
            CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$Parameters$$ExternalSyntheticLambda0
                ...
                public final Bundleable fromBundle(Bundle bundle) {
                    return new DefaultTrackSelector.Parameters.Builder(bundle, (DefaultTrackSelector.AnonymousClass1) null).build();
                }
            };
        }
    ...
    private DefaultTrackSelector(TrackSelectionParameters trackSelectionParameters, ExoTrackSelection.Factory factory, Context context) {
        ...
        this.context = context != null ? StubApp.getOrigApplicationContext(context.getApplicationContext()) : null;
    ...
    public void setParameters(TrackSelectionParameters trackSelectionParameters) {
        ...
        setParametersInternal(new Parameters.Builder(getParameters(), (AnonymousClass1) null).set(trackSelectionParameters).build());
    }
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda7
            ...
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return this.f$0.m846xc9e179dc(parameters, z, i2, trackGroup, iArr3);
            }
    ...
    /* synthetic */ List m846xc9e179dc(Parameters parameters, boolean z, int i, TrackGroup trackGroup, int[] iArr) {
    ...
    protected static int getFormatLanguageScore(Format format, String str, boolean z) {
        ...
        return Util.splitAtFirst(strNormalizeUndeterminedLanguageToNull2, x.A)[0].equals(Util.splitAtFirst(strNormalizeUndeterminedLanguageToNull, x.A)[0]) ? 2 : 0;
    }
    ...
    static final class VideoTrackInfo extends TrackInfo<VideoTrackInfo> {
        ...
        public static int compareQualityPreferences(VideoTrackInfo videoTrackInfo, VideoTrackInfo videoTrackInfo2) {
            Ordering orderingReverse;
            if (videoTrackInfo.isWithinMaxConstraints && videoTrackInfo.isWithinRendererCapabilities) {
                orderingReverse = DefaultTrackSelector.FORMAT_VALUE_ORDERING;
            } else {
                orderingReverse = DefaultTrackSelector.FORMAT_VALUE_ORDERING.reverse();
            }
    ...
    static final class AudioTrackInfo extends TrackInfo<AudioTrackInfo> implements Comparable<AudioTrackInfo> {
        ...
        public AudioTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, boolean z, Predicate<Format> predicate) {
            ...
            for (int i7 = 0; i7 < parameters.preferredAudioMimeTypes.size(); i7++) {
