...
public final class TrackSelectionOverride implements Bundleable {
    ...
    static /* synthetic */ TrackSelectionOverride lambda$static$0(Bundle bundle) {
        return new TrackSelectionOverride((TrackGroup) TrackGroup.CREATOR.fromBundle((Bundle) Assertions.checkNotNull(bundle.getBundle(keyForField(0)))), Ints.asList((int[]) Assertions.checkNotNull(bundle.getIntArray(keyForField(1)))));
    }
