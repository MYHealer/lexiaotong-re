...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_CHARACTER_SET = {MediaPlayer.MEDIA_PLAYER_OPTION_ABR_AVERAGE_BITRATE, 176, 189, MediaPlayer.MEDIA_PLAYER_OPTION_SLOW_PLAY_SPEED, 8482, 162, 163, 9834, 224, 32, 232, 226, 234, 238, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_RANGE_SIZE, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_PROCESSOR_ADDR};
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = {193, 201, 211, JfifUtil.MARKER_SOS, 220, MediaPlayer.MEDIA_PLAYER_OPTION_HW_DEC_DROP_NON_REF, AVMDLDataLoader.KeyIsLoaderFactoryP2PLevel, 161, 42, 39, o.a.B, Opcodes.RET, 8480, 8226, 8220, 8221, 192, MediaPlayer.MEDIA_PLAYER_OPTION_JX_CODEC_LOW_LATENCY, 199, 200, 202, 203, 235, 206, 207, 239, 212, JfifUtil.MARKER_EOI, MediaPlayer.MEDIA_PLAYER_OPTION_TT_HLS_DRM_TOKEN, 219, MediaPlayer.MEDIA_PLAYER_OPTION_BIT_RATE, 187};
    ...
    protected void decode(SubtitleInputBuffer subtitleInputBuffer) {
        ...
        while (true) {
            ...
            byte unsignedByte = i == 2 ? (byte) -4 : (byte) this.ccData.readUnsignedByte();
