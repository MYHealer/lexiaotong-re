...
final class DvbParser {
    ...
    public List<Cue> decode(byte[] bArr, int i) {
        ...
        for (int i3 = 0; i3 < sparseArray.size(); i3++) {
            this.canvas.save();
            PageRegion pageRegionValueAt = sparseArray.valueAt(i3);
            ...
            int i6 = 0;
            for (SparseArray<RegionObject> sparseArray2 = regionComposition.regionObjects; i6 < sparseArray2.size(); sparseArray2 = sparseArray2) {
                int iKeyAt = sparseArray2.keyAt(i6);
                RegionObject regionObjectValueAt = sparseArray2.valueAt(i6);
