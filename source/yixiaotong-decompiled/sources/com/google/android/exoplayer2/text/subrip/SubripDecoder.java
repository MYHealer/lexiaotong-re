...
public final class SubripDecoder extends SimpleSubtitleDecoder {
    ...
    private static long parseTimecode(Matcher matcher, int i) {
        ...
        long j = (strGroup != null ? Long.parseLong(strGroup) * bg.s : 0L) + (Long.parseLong((String) Assertions.checkNotNull(matcher.group(i + 2))) * 60000) + (Long.parseLong((String) Assertions.checkNotNull(matcher.group(i + 3))) * 1000);
