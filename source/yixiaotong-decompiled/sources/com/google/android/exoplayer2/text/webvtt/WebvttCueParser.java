...
public final class WebvttCueParser {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.text.webvtt.WebvttCueParser$1, reason: invalid class name */
    ...
    private static void parseCueSettingsList(String str, WebvttCueInfoBuilder webvttCueInfoBuilder) {
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                ...
                } else if (OapsKey.KEY_SIZE.equals(str2)) {
                    ...
                    Log.w(TAG, "Unknown cue setting " + str2 + x.bQ + str3);
                }
            } catch (NumberFormatException unused) {
