...
public final class ExoplayerCuesDecoder implements SubtitleDecoder {
    ...
    public SubtitleOutputBuffer dequeueOutputBuffer() throws SubtitleDecoderException {
        ...
        if (this.inputBuffer.isEndOfStream()) {
            ...
            subtitleOutputBufferRemoveFirst.setContent(this.inputBuffer.timeUs, new SingleEventSubtitle(this.inputBuffer.timeUs, this.cueDecoder.decode(((ByteBuffer) Assertions.checkNotNull(this.inputBuffer.data)).array())), 0L);
        }
