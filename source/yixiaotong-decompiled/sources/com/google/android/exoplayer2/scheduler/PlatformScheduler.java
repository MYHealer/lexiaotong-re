...
public final class PlatformScheduler implements Scheduler {
    ...
    public PlatformScheduler(Context context, int i) {
        ...
        this.jobId = i;
        this.jobServiceComponentName = new ComponentName(origApplicationContext, (Class<?>) PlatformSchedulerService.class);
        this.jobScheduler = (JobScheduler) Assertions.checkNotNull((JobScheduler) origApplicationContext.getSystemService("jobscheduler"));
    }
