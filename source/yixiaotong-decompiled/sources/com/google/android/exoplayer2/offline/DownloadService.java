...
public abstract class DownloadService extends Service {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.offline.DownloadService$1, reason: invalid class name */
    ...
    public void onCreate() {
        ...
        if (downloadManagerHelper == null) {
            ...
            downloadManagerHelper = new DownloadManagerHelper(StubApp.getOrigApplicationContext(getApplicationContext()), downloadManager, z, scheduler, cls, null);
    ...
    static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadService$DownloadManagerHelper$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m822x5d17c8bb(downloadService);
                    }
                });
            }
        }
        ...
        /* synthetic */ void m822x5d17c8bb(DownloadService downloadService) {
