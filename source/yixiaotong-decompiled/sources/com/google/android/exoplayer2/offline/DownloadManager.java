...
public final class DownloadManager {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.offline.DownloadManager$1, reason: invalid class name */
    ...
    public DownloadManager(Context context, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context, databaseProvider, cache, factory, new ProfileInstallReceiver$$ExternalSyntheticLambda0());
    }
    ...
    static final class InternalHandler extends Handler {
        ...
        private Task syncQueuedDownload(Task task, Download download) {
            if (task == null) {
                ...
                Task task2 = new Task(downloadPutDownloadWithState.request, this.downloaderFactory.createDownloader(downloadPutDownloadWithState.request), downloadPutDownloadWithState.progress, false, this.minRetryCount, this, null);
        ...
        private void syncRemovingDownload(Task task, Download download) {
            if (task == null) {
                Task task2 = new Task(download.request, this.downloaderFactory.createDownloader(download.request), download.progress, true, this.minRetryCount, this, null);
