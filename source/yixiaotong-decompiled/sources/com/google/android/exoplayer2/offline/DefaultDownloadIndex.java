...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    private static final String[] COLUMNS = {"id", COLUMN_MIME_TYPE, "uri", COLUMN_STREAM_KEYS, COLUMN_CUSTOM_CACHE_KEY, "data", COLUMN_STATE, COLUMN_START_TIME_MS, COLUMN_UPDATE_TIME_MS, COLUMN_CONTENT_LENGTH, "stop_reason", COLUMN_FAILURE_REASON, COLUMN_PERCENT_DOWNLOADED, COLUMN_BYTES_DOWNLOADED, COLUMN_KEY_SET_ID};

    /* JADX INFO: renamed from: com.google.android.exoplayer2.offline.DefaultDownloadIndex$1, reason: invalid class name */
    ...
    public DownloadCursor getDownloads(int... iArr) throws DatabaseIOException {
        ensureInitialized();
        return new DownloadCursorImpl(getCursor(getStateQuery(iArr), null), null);
    }
    ...
    private static String inferMimeType(String str) {
        ...
        if (LiveConfigKey.HLS.equals(str)) {
