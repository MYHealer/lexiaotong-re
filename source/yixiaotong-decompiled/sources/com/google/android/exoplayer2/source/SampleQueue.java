...
public class SampleQueue implements TrackOutput {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.source.SampleQueue$1, reason: invalid class name */
    ...
    private synchronized void commitSample(long j, int i, long j2, int i2, TrackOutput.CryptoData cryptoData) {
        ...
        if (this.sharedSampleMetadata.isEmpty() || !this.sharedSampleMetadata.getEndValue().format.equals(this.upstreamFormat)) {
            ...
            this.sharedSampleMetadata.appendSpan(getWriteIndex(), new SharedSampleMetadata((Format) Assertions.checkNotNull(this.upstreamFormat), drmSessionReferencePreacquireSession, null));
        }
