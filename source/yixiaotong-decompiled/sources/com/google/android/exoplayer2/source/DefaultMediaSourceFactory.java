...
public final class DefaultMediaSourceFactory implements MediaSourceFactory {
    ...
    static final class DelegateFactoryLoader {
        ...
        private Supplier<MediaSource.Factory> maybeLoadSupplier(int i) {
            ...
            try {
                if (i == 0) {
                    ...
                    if (i != 2) {
                        if (i == 3) {
                            final Class<? extends U> clsAsSubclass3 = Class.forName("com.google.android.exoplayer2.source.rtsp.RtspMediaSource$Factory").asSubclass(MediaSource.Factory.class);
                            ...
                            supplier2 = new Supplier() { // from class: com.google.android.exoplayer2.source.DefaultMediaSourceFactory$DelegateFactoryLoader$$ExternalSyntheticLambda4
                                @Override // com.google.common.base.Supplier
                                public final Object get() {
                                    return this.f$0.m828x654ff537(factory);
                                }
                            };
                        }
                        supplier3 = supplier2;
                    } else {
                        final Class<? extends U> clsAsSubclass4 = Class.forName("com.google.android.exoplayer2.source.hls.HlsMediaSource$Factory").asSubclass(MediaSource.Factory.class);
        ...
        /* synthetic */ MediaSource.Factory m828x654ff537(DataSource.Factory factory) {
