...
public final class AdPlaybackState implements Bundleable {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.source.ads.AdPlaybackState$1, reason: invalid class name */
    ...
    public static final class AdGroup implements Bundleable {
        ...
        /* synthetic */ AdGroup(long j, int i, int[] iArr, Uri[] uriArr, long[] jArr, long j2, boolean z, AnonymousClass1 anonymousClass1) {
            this(j, i, iArr, uriArr, jArr, j2, z);
        }
        ...
        public AdGroup withAdCount(int i) {
            ...
            return new AdGroup(this.timeUs, i, iArrCopyStatesWithSpaceForAdCount, (Uri[]) Arrays.copyOf(this.uris, i), jArrCopyDurationsUsWithSpaceForAdCount, this.contentResumeOffsetUs, this.isServerSideInserted);
        }
    ...
    public static AdPlaybackState fromAdPlaybackState(Object obj, AdPlaybackState adPlaybackState) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            adGroupArr[i2] = new AdGroup(adGroup.timeUs, adGroup.count, Arrays.copyOf(adGroup.states, adGroup.states.length), (Uri[]) Arrays.copyOf(adGroup.uris, adGroup.uris.length), Arrays.copyOf(adGroup.durationsUs, adGroup.durationsUs.length), adGroup.contentResumeOffsetUs, adGroup.isServerSideInserted, null);
        }
