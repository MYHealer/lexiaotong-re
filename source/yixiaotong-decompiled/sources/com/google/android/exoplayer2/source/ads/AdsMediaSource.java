...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    protected void prepareSourceInternal(TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m839x4dfad2b6(componentListener);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$prepareSourceInternal$0$com-google-android-exoplayer2-source-ads-AdsMediaSource, reason: not valid java name */
    /* synthetic */ void m839x4dfad2b6(ComponentListener componentListener) {
    ...
    protected void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m840x85e6f6b7(componentListener);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$releaseSourceInternal$1$com-google-android-exoplayer2-source-ads-AdsMediaSource, reason: not valid java name */
    /* synthetic */ void m840x85e6f6b7(ComponentListener componentListener) {
    ...
    public void m826x365769cd(MediaSource.MediaPeriodId mediaPeriodId, MediaSource mediaSource, Timeline timeline) {
        if (mediaPeriodId.isAd()) {
    ...
    final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$ComponentListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m843x9c1f3358(adPlaybackState);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onAdPlaybackState$0$com-google-android-exoplayer2-source-ads-AdsMediaSource$ComponentListener, reason: not valid java name */
        /* synthetic */ void m843x9c1f3358(AdPlaybackState adPlaybackState) {
            if (this.stopped) {
                return;
            }
    ...
    final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m841x605e06cc(mediaPeriodId);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onPrepareComplete$0$com-google-android-exoplayer2-source-ads-AdsMediaSource$AdPrepareListener, reason: not valid java name */
        /* synthetic */ void m841x605e06cc(MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m842x1f837766(mediaPeriodId, iOException);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onPrepareError$1$com-google-android-exoplayer2-source-ads-AdsMediaSource$AdPrepareListener, reason: not valid java name */
        /* synthetic */ void m842x1f837766(MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
