...
public final class CacheDataSource implements DataSource {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.upstream.cache.CacheDataSource$1, reason: invalid class name */
    ...
    public static final class Factory implements DataSource.Factory {
        ...
        private CacheDataSource createDataSourceInternal(DataSource dataSource, int i, int i2) {
            ...
            return new CacheDataSource(cache, dataSource, this.cacheReadDataSourceFactory.createDataSource(), dataSinkCreateDataSink, this.cacheKeyFactory, i, this.upstreamPriorityTaskManager, i2, this.eventListener, null);
        }
    }
