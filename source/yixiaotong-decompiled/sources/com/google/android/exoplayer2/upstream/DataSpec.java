...
public final class DataSpec {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.upstream.DataSpec$1, reason: invalid class name */
    ...
    public static final class Builder {
        ...
        public DataSpec build() {
            ...
            return new DataSpec(this.uri, this.uriPositionOffset, this.httpMethod, this.httpBody, this.httpRequestHeaders, this.position, this.length, this.key, this.flags, this.customData, null);
        }
    }
    ...
    public String toString() {
        return "DataSpec[" + getHttpMethodString() + PPSLabelView.Code + this.uri + ", " + this.position + ", " + this.length + ", " + this.key + ", " + this.flags + "]";
    }
}
