...
public final class MediaCodecUtil {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.mediacodec.MediaCodecUtil$1, reason: invalid class name */
    ...
    /* JADX WARN: Code duplicated, block: B:60:0x0108 A[Catch: Exception -> 0x015e, TRY_ENTER, TryCatch #0 {Exception -> 0x015e, blocks: (B:3:0x0008, B:5:0x001b, B:63:0x012a, B:8:0x002d, B:11:0x0038, B:57:0x0100, B:60:0x0108, B:62:0x010e, B:64:0x0134, B:65:0x015c), top: B:70:0x0008 }] */
    /* JADX WARN: Code duplicated, block: B:7:0x0025  */
    /* JADX WARN: Code duplicated, block: B:84:0x0134 A[ADDED_TO_REGION, REMOVE, SYNTHETIC] */
                                    ...
                                    if (zSecureDecodersExplicit && codecKey2.secure == zIsFeatureSupported2) {
                                        ...
                                        if (!z && zIsFeatureSupported2) {
                                            try {
                                                str2 = str3;
                                                try {
                                                    arrayList.add(MediaCodecInfo.newInstance(str3 + ".secure", str4, str, capabilitiesForType, zIsHardwareAccelerated, zIsSoftwareOnly, zIsVendor, false, true));
                                                    return arrayList;
                                                } catch (Exception e3) {
                                                    e = e3;
                                                    if (Util.SDK_INT > 23) {
