...
public final class MediaFormatUtil {
    ...
    public static MediaFormat createMediaFormatFromFormat(Format format) {
        ...
        maybeSetInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_BIT_RATE, format.bitrate);
        maybeSetInteger(mediaFormat, KEY_MAX_BIT_RATE, format.peakBitrate);
        maybeSetInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_CHANNEL_COUNT, format.channelCount);
        ...
        maybeSetInteger(mediaFormat, com.bykv.vk.component.ttvideo.player.MediaFormat.KEY_SAMPLE_RATE, format.sampleRate);
