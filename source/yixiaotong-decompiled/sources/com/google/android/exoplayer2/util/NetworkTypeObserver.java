...
public final class NetworkTypeObserver {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.util.NetworkTypeObserver$1, reason: invalid class name */
    ...
    private NetworkTypeObserver(Context context) {
        ...
        context.registerReceiver(new Receiver(this, null), intentFilter);
    }
    ...
    public void register(final Listener listener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.util.NetworkTypeObserver$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m850x43b1341d(listener);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$register$0$com-google-android-exoplayer2-util-NetworkTypeObserver, reason: not valid java name */
    /* synthetic */ void m850x43b1341d(Listener listener) {
    ...
    private final class Receiver extends BroadcastReceiver {
        ...
        /* synthetic */ Receiver(NetworkTypeObserver networkTypeObserver, AnonymousClass1 anonymousClass1) {
            this();
        }
