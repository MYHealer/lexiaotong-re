...
public final class SntpClient {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.util.SntpClient$1, reason: invalid class name */
    ...
    public static void initialize(Loader loader, InitializationCallback initializationCallback) {
        if (isInitialized()) {
            ...
            loader.startLoading(new NtpTimeLoadable(null), new NtpTimeCallback(initializationCallback), 1);
        }
    }
    ...
    private static final class NtpTimeLoadable implements Loader.Loadable {
        ...
        /* synthetic */ NtpTimeLoadable(AnonymousClass1 anonymousClass1) {
            this();
        }
