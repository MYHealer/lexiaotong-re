    ...
    public static SpsData parseSpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            if (unsignedExpGolombCodedInt == 0) {
                ...
                int i11 = unsignedExpGolombCodedInt;
                i4 = i11 == 3 ? 1 : 2;
                i3 = (2 - (bit3 ? 1 : 0)) * (i11 == 1 ? 2 : 1);
            }
            i9 -= (unsignedExpGolombCodedInt10 + unsignedExpGolombCodedInt11) * i4;
            i10 -= (unsignedExpGolombCodedInt12 + unsignedExpGolombCodedInt13) * i3;
        }
        int i12 = i9;
        int i13 = i10;
        float f2 = 1.0f;
        ...
        return new SpsData(bits, bits2, bits3, unsignedExpGolombCodedInt3, unsignedExpGolombCodedInt7, i12, i13, f, bit, bit3, unsignedExpGolombCodedInt4, unsignedExpGolombCodedInt5, unsignedExpGolombCodedInt2, z);
    }
