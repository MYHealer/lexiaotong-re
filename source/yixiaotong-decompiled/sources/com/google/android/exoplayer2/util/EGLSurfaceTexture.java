...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.util.EGLSurfaceTexture$1, reason: invalid class name */
    ...
    private static EGLConfig chooseEGLConfig(EGLDisplay eGLDisplay) {
        ...
        if (!zEglChooseConfig || iArr[0] <= 0 || (eGLConfig = eGLConfigArr[0]) == null) {
            throw new GlException(Util.formatInvariant("eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(zEglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]), null);
        }
        return eGLConfig;
    }
