...
final class StreamVolumeManager {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.StreamVolumeManager$1, reason: invalid class name */
    ...
    public StreamVolumeManager(Context context, Handler handler, Listener listener) {
        ...
        AudioManager audioManager = (AudioManager) Assertions.checkStateNotNull((AudioManager) origApplicationContext.getSystemService("audio"));
        ...
        try {
            origApplicationContext.registerReceiver(volumeChangeReceiver, new IntentFilter("android.media.VOLUME_CHANGED_ACTION"));
