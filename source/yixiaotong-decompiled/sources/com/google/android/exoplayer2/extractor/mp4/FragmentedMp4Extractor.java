...
public class FragmentedMp4Extractor implements Extractor {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), mehd, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda0
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, int i2, ParsableByteArray parsableByteArray, int i3) throws ParserException {
        ...
        while (i8 < i7) {
            ...
            jArr2[i8] = Util.scaleLargeTimestamp((((long) (z5 ? parsableByteArray.readInt() : 0)) + j3) - j, 1000000L, j2);
            if (!trackFragment.nextFragmentDecodeTimeIncludesMoov) {
                jArr2[i8] = jArr2[i8] + trackBundle2.moovSampleTable.durationUs;
            }
