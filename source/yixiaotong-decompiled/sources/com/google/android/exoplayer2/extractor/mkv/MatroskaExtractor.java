...
public class MatroskaExtractor implements Extractor {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.extractor.mkv.MatroskaExtractor$1, reason: invalid class name */
    ...
    protected void binaryElement(int i, int i2, ExtractorInput extractorInput) throws IOException {
                    ...
                    if (i10 == 1) {
                        ...
                        while (true) {
                            ...
                            while (true) {
                                ...
                                int i17 = this.scratch.getData()[i11] & 255;
                        ...
                        while (true) {
                            ...
                            if (i18 < i20 - 1) {
                                ...
                                while (true) {
                                    ...
                                    int i23 = i9 << (7 - i22);
                                    if ((this.scratch.getData()[i11] & i23) != 0) {
                                        i21 += i22;
                                        readScratch(extractorInput, i21);
                                        track3 = track4;
                                        j = (~i23) & this.scratch.getData()[i11] & b;
                                        int i24 = i11 + 1;
                                        while (i24 < i21) {
        ...
        if (i == i3) {
            while (true) {
                ...
                commitSampleToOutput(track, ((long) ((this.blockSampleIndex * track.defaultSampleDurationNs) / 1000)) + this.blockTimeUs, this.blockFlags, writeSampleData(extractorInput, track, this.blockSampleSizes[i26], false), 0);
    ...
    protected static final class Track {
        ...
        /* JADX WARN: Code duplicated, block: B:219:0x0442  */
        /* JADX WARN: Code duplicated, block: B:221:0x0446  */
        /* JADX WARN: Code duplicated, block: B:223:0x044b  */
        /* JADX WARN: Code duplicated, block: B:226:0x0453  */
        /* JADX WARN: Code duplicated, block: B:228:0x0458  */
        ...
        /* JADX WARN: Code duplicated, block: B:238:0x0481  */
        /* JADX WARN: Code duplicated, block: B:241:0x0486  */
        /* JADX WARN: Code duplicated, block: B:246:0x04a6  */
        /* JADX WARN: Code duplicated, block: B:265:0x04f2  */
        /* JADX WARN: Code duplicated, block: B:267:0x0518  */
        /* JADX WARN: Code duplicated, block: B:269:0x051e  */
        /* JADX WARN: Code duplicated, block: B:285:0x054a  */
