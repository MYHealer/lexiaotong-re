...
final class DefaultEbmlReader implements EbmlReader {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.extractor.mkv.DefaultEbmlReader$1, reason: invalid class name */
            ...
            if (masterElementPeek == null || extractorInput.getPosition() < masterElementPeek.elementEndPosition) {
                ...
                if (elementType != 0) {
                    ...
                    if (elementType == 1) {
                        ...
                        this.masterElementsStack.push(new MasterElement(this.elementId, this.elementContentSize + position, anonymousClass1));
