...
final class FixedSampleSizeRechunker {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.extractor.mp4.FixedSampleSizeRechunker$1, reason: invalid class name */
    ...
    public static final class Results {
        ...
        /* synthetic */ Results(long[] jArr, int[] iArr, int i, long[] jArr2, int[] iArr2, long j, AnonymousClass1 anonymousClass1) {
    ...
    public static Results rechunk(int i, long[] jArr, int[] iArr, long j) {
        ...
        return new Results(jArr2, iArr2, iMax, jArr3, iArr3, j * ((long) i4), null);
    }
