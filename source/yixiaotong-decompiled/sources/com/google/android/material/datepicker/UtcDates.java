...
class UtcDates {
    ...
    static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        return localizedPattern.replaceAll(t.t, resources.getString(R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", resources.getString(R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", resources.getString(R.string.mtrl_picker_text_input_year_abbr));
    }
    ...
    private static String removeYearFromDateFormatPattern(String str) {
        ...
        return str.replace(str.substring(findCharactersInDateFormatPattern(str, iFindCharactersInDateFormatPattern2 < str.length() ? "EMd," : "EMd", -1, iFindCharactersInDateFormatPattern) + 1, iFindCharactersInDateFormatPattern2), PPSLabelView.Code).trim();
    }
