...
public final class InetAddresses {
    ...
    private static String convertDottedQuadToHex(String str) {
        ...
        return new StringBuilder(String.valueOf(strSubstring).length() + 1 + String.valueOf(hexString).length() + String.valueOf(hexString2).length()).append(strSubstring).append(hexString).append(x.bQ).append(hexString2).toString();
    }
    ...
    public static final class TeredoInfo {
        ...
        private final Inet4Address f3305client;
        private final int flags;
        private final int port;
        private final Inet4Address server;

        public Inet4Address getClient() {
            return this.f3305client;
        }
        ...
        public TeredoInfo(@CheckForNull Inet4Address inet4Address, @CheckForNull Inet4Address inet4Address2, int i, int i2) {
            ...
            this.f3305client = (Inet4Address) MoreObjects.firstNonNull(inet4Address2, InetAddresses.ANY4);
            this.port = i;
            this.flags = i2;
        }
    }
