...
public final class MediaType {
    ...
    public static final MediaType JSON_UTF_8 = createConstantUtf8("application", AppConfig.FORMAT);
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sbAppend.append("; ");
            PARAMETER_JOINER.appendTo(sbAppend, Multimaps.transformValues((ListMultimap) this.parameters, (Function) new Function<String, String>(this) { // from class: com.google.common.net.MediaType.2
                @Override // com.google.common.base.Function
