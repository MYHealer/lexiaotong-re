...
final class ListenerCallQueue<L> {
    ...
    public void addListener(L l, Executor executor) {
        Preconditions.checkNotNull(l, br.f.s);
    ...
    private static final class PerListenerQueue<L> implements Runnable {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:15:0x0027, code lost:
            ...
            r4.log(r5, new java.lang.StringBuilder((java.lang.String.valueOf(r6).length() + 37) + java.lang.String.valueOf(r3).length()).append("Exception while executing callback: ").append(r6).append(com.huawei.openalliance.ad.views.PPSLabelView.Code).append(r3).toString(), (java.lang.Throwable) r2);
         */
