...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    /* JADX INFO: renamed from: com.google.common.util.concurrent.AbstractFuture$1, reason: invalid class name */
    ...
    static {
        ...
        try {
            z = Boolean.parseBoolean(System.getProperty("guava.concurrent.generate_cancellation_cause", ez.V));
        ...
        r1 = 0;
        try {
            synchronizedHelper = new UnsafeAtomicHelper(r1);
            th = null;
        } catch (Throwable th) {
            th = th;
            try {
                synchronizedHelper = new SafeAtomicHelper(AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Thread.class, "thread"), AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Waiter.class, "next"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Waiter.class, "waiters"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Listener.class, "listeners"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Object.class, oOOOoo00.OooOo0o));
            } catch (Throwable th2) {
                synchronizedHelper = new SynchronizedHelper(r1);
                r1 = th2;
            }
        }
    ...
    public V get(long j, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        String string2 = new StringBuilder(String.valueOf(lowerCase2).length() + 28).append("Waited ").append(j).append(PPSLabelView.Code).append(lowerCase2).toString();
        if (nanos + 1000 < 0) {
            ...
            if (jConvert > 0) {
                ...
                String string3 = new StringBuilder(String.valueOf(strValueOf).length() + 21 + String.valueOf(lowerCase).length()).append(strValueOf).append(jConvert).append(PPSLabelView.Code).append(lowerCase).toString();
                if (z) {
                    string3 = String.valueOf(string3).concat(",");
                }
                strConcat = String.valueOf(string3).concat(PPSLabelView.Code);
            }
            if (z) {
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        static {
            ...
            try {
                ...
                VALUE_OFFSET = unsafe.objectFieldOffset(AbstractFuture.class.getDeclaredField(oOOOoo00.OooOo0o));
