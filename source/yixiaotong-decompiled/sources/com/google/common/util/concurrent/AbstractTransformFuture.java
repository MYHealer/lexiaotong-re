...
abstract class AbstractTransformFuture<I, O, F, T> extends FluentFuture.TrustedFuture<O> implements Runnable {
    ...
    protected String pendingToString() {
        ...
        if (f != null) {
            ...
            return new StringBuilder(String.valueOf(string).length() + 11 + String.valueOf(strValueOf2).length()).append(string).append("function=[").append(strValueOf2).append("]").toString();
        }
        if (strPendingToString == null) {
            return null;
        }
        String strValueOf3 = String.valueOf(string);
        String strValueOf4 = String.valueOf(strPendingToString);
        return strValueOf4.length() != 0 ? strValueOf3.concat(strValueOf4) : new String(strValueOf3);
    }
