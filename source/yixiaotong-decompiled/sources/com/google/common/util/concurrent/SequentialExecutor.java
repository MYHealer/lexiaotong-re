...
final class SequentialExecutor implements Executor {
        ...
        */
        ...
        public String toString() {
            ...
            if (runnable == null) {
                ...
                return new StringBuilder(String.valueOf(strValueOf).length() + 32).append("SequentialExecutorWorker{state=").append(strValueOf).append(i.d).toString();
            }
            String strValueOf2 = String.valueOf(runnable);
            return new StringBuilder(String.valueOf(strValueOf2).length() + 34).append("SequentialExecutorWorker{running=").append(strValueOf2).append(i.d).toString();
        }
    }
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(strValueOf).length() + 32).append("SequentialExecutor@").append(iIdentityHashCode).append("{").append(strValueOf).append(i.d).toString();
    }
}
