...
final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    /* JADX INFO: renamed from: com.google.common.graph.DirectedGraphConnections$8, reason: invalid class name */
    ...
    public Iterator<EndpointPair<N>> incidentEdgeIterator(final N n) {
        ...
        if (list == null) {
            itTransform = Iterators.concat(Iterators.transform(predecessors().iterator(), new Function<N, EndpointPair<N>>(this) { // from class: com.google.common.graph.DirectedGraphConnections.4
            ...
            itTransform = Iterators.transform(list.iterator(), new Function<NodeConnection<N>, EndpointPair<N>>(this) { // from class: com.google.common.graph.DirectedGraphConnections.6
                @Override // com.google.common.base.Function
