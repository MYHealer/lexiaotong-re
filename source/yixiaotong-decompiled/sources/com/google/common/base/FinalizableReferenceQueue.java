...
public class FinalizableReferenceQueue implements Closeable {
    ...
    static class DecoupledLoader implements FinalizerLoader {
        ...
        URL getBaseUrl() throws IOException {
            String strConcat = String.valueOf(FinalizableReferenceQueue.FINALIZER_CLASS_NAME.replace(FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX)).concat(".class");
