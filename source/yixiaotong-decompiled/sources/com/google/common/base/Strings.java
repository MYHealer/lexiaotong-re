...
public final class Strings {
    ...
    private static String lenientToString(@CheckForNull Object obj) {
        ...
        try {
            ...
            return new StringBuilder(String.valueOf(string).length() + 9 + String.valueOf(name2).length()).append(SimpleComparison.LESS_THAN_OPERATION).append(string).append(" threw ").append(name2).append(SimpleComparison.GREATER_THAN_OPERATION).toString();
        }
    }
}
