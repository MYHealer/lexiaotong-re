...
public final class Stopwatch {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(compact4Digits).length() + 1 + String.valueOf(strAbbreviate).length()).append(compact4Digits).append(PPSLabelView.Code).append(strAbbreviate).toString();
    }
