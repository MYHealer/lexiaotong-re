...
public final class Predicates {
    ...
    /* JADX INFO: renamed from: com.google.common.base.Predicates$1, reason: invalid class name */
    ...
    public static <T> Predicate<T> and(Predicate<? super T>... predicateArr) {
        return new AndPredicate(defensiveCopy(predicateArr), null);
    }
    ...
    public static <T> Predicate<T> or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy(predicateArr), null);
    }
    ...
    public static <T> Predicate<T> equalTo(@ParametricNullness T t) {
        ...
        return new IsEqualToPredicate(t, null).withNarrowedType();
    }
