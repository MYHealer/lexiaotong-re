...
public final class Quantiles {
    ...
    /* JADX INFO: renamed from: com.google.common.math.Quantiles$1, reason: invalid class name */
    ...
    public static final class Scale {
        ...
        /* synthetic */ Scale(int i, AnonymousClass1 anonymousClass1) {
            this(i);
        }
        ...
        public ScaleAndIndex index(int i) {
            return new ScaleAndIndex(this.scale, i, null);
        }

        public ScaleAndIndexes indexes(int... iArr) {
            return new ScaleAndIndexes(this.scale, (int[]) iArr.clone(), null);
        }
    ...
    public static final class ScaleAndIndex {
        ...
        /* synthetic */ ScaleAndIndex(int i, int i2, AnonymousClass1 anonymousClass1) {
            this(i, i2);
        }
    ...
    public static final class ScaleAndIndexes {
        ...
        /* synthetic */ ScaleAndIndexes(int i, int[] iArr, AnonymousClass1 anonymousClass1) {
            this(i, iArr);
        }
