...
public final class Stats implements Serializable {
    ...
    public String toString() {
        if (count() > 0) {
            return MoreObjects.toStringHelper(this).add(a.Q0, this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add("min", this.min).add("max", this.max).toString();
        }
        return MoreObjects.toStringHelper(this).add(a.Q0, this.count).toString();
    }
