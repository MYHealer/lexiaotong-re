...
final class GeneralRange<T> implements Serializable {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(strValueOf).length() + 4 + String.valueOf(strValueOf2).length() + String.valueOf(strValueOf3).length()).append(strValueOf).append(x.bQ).append(c).append(strValueOf2).append(',').append(strValueOf3).append(this.upperBoundType == BoundType.CLOSED ? ']' : ')').toString();
    }
}
