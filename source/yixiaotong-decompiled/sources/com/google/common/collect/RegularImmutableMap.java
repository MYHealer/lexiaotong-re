...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    static Object createHashTable(Object[] objArr, int i, int i2, int i3) {
            ...
            while (i8 < i) {
                ...
                while (true) {
                    ...
                    if (objRequireNonNull.equals(objArr[i10])) {
                        throw duplicateKeyException(objRequireNonNull, objRequireNonNull2, objArr, i10);
                    }
                    iSmear = i6 + 1;
                }
                bArr[i6] = (byte) i9;
        ...
        if (i2 <= 32768) {
            ...
            while (i8 < i) {
                int i11 = (i8 * 2) + i3;
                Object objRequireNonNull3 = Objects.requireNonNull(objArr[i11]);
                Object objRequireNonNull4 = Objects.requireNonNull(objArr[i11 ^ 1]);
                ...
                while (true) {
                    ...
                    if (objRequireNonNull3.equals(objArr[i12])) {
                        throw duplicateKeyException(objRequireNonNull3, objRequireNonNull4, objArr, i12);
                    }
                    iSmear2 = i5 + 1;
                }
                sArr[i5] = (short) i11;
        ...
        while (i8 < i) {
            int i13 = (i8 * 2) + i3;
            Object objRequireNonNull5 = Objects.requireNonNull(objArr[i13]);
            Object objRequireNonNull6 = Objects.requireNonNull(objArr[i13 ^ 1]);
            ...
            while (true) {
                ...
                if (objRequireNonNull5.equals(objArr[i14])) {
                    throw duplicateKeyException(objRequireNonNull5, objRequireNonNull6, objArr, i14);
                }
                iSmear3 = i4 + 1;
            }
            iArr[i4] = i13;
