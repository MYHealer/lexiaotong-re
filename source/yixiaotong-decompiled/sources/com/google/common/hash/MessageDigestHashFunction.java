...
final class MessageDigestHashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* JADX INFO: renamed from: com.google.common.hash.MessageDigestHashFunction$1, reason: invalid class name */
    ...
    public Hasher newHasher() {
        ...
        if (this.supportsClone) {
            try {
                return new MessageDigestHasher((MessageDigest) this.prototype.clone(), this.bytes, anonymousClass1);
            } catch (CloneNotSupportedException unused) {
            }
        }
        return new MessageDigestHasher(getMessageDigest(this.prototype.getAlgorithm()), this.bytes, anonymousClass1);
    }
    ...
    private static final class SerializedForm implements Serializable {
        ...
        /* synthetic */ SerializedForm(String str, int i, String str2, AnonymousClass1 anonymousClass1) {
            this(str, i, str2);
        }
    ...
    private static final class MessageDigestHasher extends AbstractByteHasher {
        ...
        /* synthetic */ MessageDigestHasher(MessageDigest messageDigest, int i, AnonymousClass1 anonymousClass1) {
