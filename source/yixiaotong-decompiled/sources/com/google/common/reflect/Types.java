    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            if (this.ownerType != null && JavaVersion.CURRENT.jdkTypeDuplicatesOwnerName()) {
                sb.append(JavaVersion.CURRENT.typeName(this.ownerType)).append(FilenameUtils.EXTENSION_SEPARATOR);
            }
            return sb.append(this.rawType.getName()).append(Typography.less).append(Types.COMMA_JOINER.join(Iterables.transform(this.argumentsList, Types.TYPE_NAME))).append(Typography.greater).toString();
        }
