...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    private int modifiers = MediaPlayer.MEDIA_PLAYER_OPTION_SET_PIPE_DECLARE_LENGTH;
    ...
    public Excluder withVersion(double d) {
        Excluder excluderM864clone = m864clone();
        excluderM864clone.version = d;
        return excluderM864clone;
    }

    public Excluder withModifiers(int... iArr) {
        Excluder excluderM864clone = m864clone();
        excluderM864clone.modifiers = 0;
        for (int i : iArr) {
            excluderM864clone.modifiers = i | excluderM864clone.modifiers;
        }
        return excluderM864clone;
    }
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM864clone = m864clone();
        excluderM864clone.serializeInnerClasses = false;
        return excluderM864clone;
    }

    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM864clone = m864clone();
        excluderM864clone.requireExpose = true;
        return excluderM864clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            excluderM864clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM864clone.deserializationStrategies = arrayList2;
