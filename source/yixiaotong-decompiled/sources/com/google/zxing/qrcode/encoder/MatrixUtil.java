...
final class MatrixUtil {
    ...
    static {
        ...
        iArr2[0] = 1;
        iArr2[6] = 1;
        POSITION_DETECTION_PATTERN = new int[][]{new int[]{1, 1, 1, 1, 1, 1, 1}, iArr, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, new int[]{1, 0, 1, 1, 1, 0, 1}, iArr2, new int[]{1, 1, 1, 1, 1, 1, 1}};
