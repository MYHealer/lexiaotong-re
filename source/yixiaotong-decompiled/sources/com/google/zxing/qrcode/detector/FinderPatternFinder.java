...
public class FinderPatternFinder {
        ...
        while (i2 < height && !zHaveMultiplyConfirmedCenters) {
            ...
            while (i3 < width) {
                if (this.image.get(i3, i2)) {
                    ...
                    if (foundPatternCross(iArr) && handlePossibleCenter(iArr, i2, i3, z2)) {
                        if (this.hasSkipped) {
    ...
    private FinderPattern[] selectBestPatterns() throws NotFoundException {
        ...
        if (size > 3) {
            ...
            Collections.sort(this.possibleCenters, new FurthestFromAverageComparator(f4, furthestFromAverageComparator));
        ...
        if (this.possibleCenters.size() > 3) {
            ...
            Collections.sort(this.possibleCenters, new CenterComparator(estimatedModuleSize / this.possibleCenters.size(), objArr == true ? 1 : 0));
