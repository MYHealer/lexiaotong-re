...
final class DecodedBitStreamParser {
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        String postCode3;
        StringBuilder sb = new StringBuilder(MediaPlayer.MEDIA_PLAYER_OPTION_SPADE);
        if (i == 2 || i == 3) {
            if (i == 2) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, String.valueOf(postCode3) + GS + str + GS + str2 + GS);
            } else {
                sb.insert(0, String.valueOf(postCode3) + GS + str + GS + str2 + GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.EM, 26, Ascii.ESC, Ascii.FS, Ascii.GS, Ascii.RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, 13, 14, 15, 16, 17, Ascii.DC2, 7, 8, 9, 10, 11, 12, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        String[] strArr = SETS;
        return String.valueOf(new char[]{strArr[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.US, 32})), strArr[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.EM, 26})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.FS, Ascii.GS, Ascii.RS, 19, Ascii.DC4})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, 13, 14})), strArr[0].charAt(getInt(bArr, new byte[]{15, 16, 17, Ascii.DC2, 7, 8})), strArr[0].charAt(getInt(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
        ...
        while (i3 < i + i2) {
            ...
            switch (cCharAt) {
                ...
                case 65531:
                    ...
                    i3 += 5;
                    sb.append(NINE_DIGITS.format(i7 + bArr[i3]));
                    break;
            }
            int i8 = i4 - 1;
            if (i4 == 0) {
