...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        Collections.sort(arrayList, new ResultPointsAndTransitionsComparator(0 == true ? 1 : 0));
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            int iMax = Math.max(transitionsBetween(resultPoint13, resultPoint).getTransitions(), transitionsBetween(resultPoint11, resultPoint).getTransitions());
            int i4 = iMax + 1;
            int i5 = (i4 & 1) == 1 ? iMax + 2 : i4;
            bitMatrixSampleGrid = sampleGrid(this.image, resultPoint13, resultPoint12, resultPoint11, resultPoint, i5, i5);
            resultPoint2 = resultPoint13;
        }
