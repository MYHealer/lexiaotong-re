...
public enum CharacterSetECI {
    ...
    public static CharacterSetECI[] valuesCustom() {
        CharacterSetECI[] characterSetECIArrValuesCustom = values();
        int length = characterSetECIArrValuesCustom.length;
        CharacterSetECI[] characterSetECIArr = new CharacterSetECI[length];
        System.arraycopy(characterSetECIArrValuesCustom, 0, characterSetECIArr, 0, length);
