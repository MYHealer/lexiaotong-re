...
public class GradientStrokeContent extends BaseStrokeContent {
    ...
    private RadialGradient getRadialGradient() {
        ...
        float f = value.x;
        float f2 = value.y;
        RadialGradient radialGradient2 = new RadialGradient(f, f2, (float) Math.hypot(value2.x - f, value2.y - f2), iArrApplyDynamicColorsIfNeeded, positions, Shader.TileMode.CLAMP);
