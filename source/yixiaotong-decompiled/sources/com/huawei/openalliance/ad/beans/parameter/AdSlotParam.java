...
public class AdSlotParam {
    ...
    /* JADX INFO: renamed from: com.huawei.openalliance.ad.beans.parameter.AdSlotParam$1, reason: invalid class name */
    ...
    public static final class a {
        ...
        private android.location.Location f4433a;
        ...
        public a C(String str) {
            Map<String, String> map = (Map) ad.V(str, Map.class, new Class[0]);
            if (al.Code(map)) {
                fh.I(AdSlotParam.TAG, "contentBundle info is empty or not json string");
            } else {
                String strV = AdSlotParam.V(map);
                this.x = map;
                this.w = strV;
            }
            return this;
        ...
        public Location Code() {
            ...
            return new Location(Double.valueOf(this.f4433a.getLongitude()), Double.valueOf(this.f4433a.getLatitude()));
        }
    ...
    /* synthetic */ AdSlotParam(a aVar, AnonymousClass1 anonymousClass1) {
        this(aVar);
    }
    ...
    public static String V(Map<String, String> map) {
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            arrayList.add(new ImpEX(entry.getKey(), bc.S(entry.getValue())));
        }
    ...
    public void B(String str) {
        ...
        Map map2 = (Map) ad.V(str, Map.class, new Class[0]);
        if (al.Code(map2) || al.Code(this.contentBundleMap)) {
            if (al.Code(map2)) {
                return;
            }
            fh.V(TAG, "set auto content Bundle");
            map = (Map) ad.V(str, Map.class, new Class[0]);
            if (al.Code(map)) {
                fh.I(TAG, "auto contentBundle info is empty or not json string");
                return;
            }
        } else {
            fh.V(TAG, "merge auto content Bundle");
            for (Map.Entry entry : map2.entrySet()) {
                String str2 = (String) entry.getKey();
                String str3 = (String) entry.getValue();
                if (!this.contentBundleMap.containsKey(str2) && !bc.Code(str3)) {
                    this.contentBundleMap.put(str2, (String) map2.get(str2));
                }
            }
            if (this.contentBundleMap.containsKey("content") && this.contentBundleMap.containsKey(x.cu)) {
                this.contentBundleMap.remove(x.cu);
            }
