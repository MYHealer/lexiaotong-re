...
public class SafeIntent extends Intent {
    ...
    public String I() {
        ...
        try {
            ...
            fh.I(Code, "toURI: exception " + th.getClass().getSimpleName());
            uri = "";
        }
    ...
    public String getDataString() {
        try {
            ...
            fh.I(Code, "getDataStr err: %s", th.getClass().getSimpleName());
            return "";
        }
    }
    ...
    public String getScheme() {
        try {
            ...
            fh.I(Code, "getScheme err: %s", th.getClass().getSimpleName());
            return "";
        }
    }
