...
public class LinkedSurfaceView extends RelativeLayout implements md {
    private int B;
    private int I;
    ...
    private void Code(Context context) {
        this.V = new SurfaceVideoView(context);
    ...
    protected void onAttachedToWindow() {
        ...
        fh.V("LinkedSurfaceView", "onAttachedToWindow");
    }

    @Override // android.view.ViewGroup, android.view.View
    protected void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        fh.V("LinkedSurfaceView", "onDetachedFromWindow");
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i6 = this.I;
        int i7 = this.B;
        baseGlVideoView.Code(videoWidth, (i6 * 1.0f) / i7, i6, i7);
    }
