...
public class h extends g {
    ...
    private void B(float f) {
        this.f4506a.reset();
        this.f4506a.addArc(this.b, 90.0f, 180.0f);
        float f2 = this.d.right - this.e;
        if (Float.compare(Code(), V()) != 0) {
            this.f4506a.addRect(this.d.left + this.e, this.d.top, f2, this.d.bottom, Path.Direction.CCW);
        }
        float fV = Float.compare(Code(), 0.0f) != 0 ? ((f - V()) / Code()) * this.e : 0.0f;
        this.c.set(f2 - fV, this.d.top, f2 + fV, this.d.bottom);
        this.f4506a.addArc(this.c, 270.0f, 180.0f);
    }
    ...
    private void I(float f) {
        this.f4506a.reset();
        this.f4506a.addArc(this.b, 90.0f, 180.0f);
        float fCode = Float.compare(Code(), 0.0f) != 0 ? (f / Code()) * this.e : 0.0f;
        this.c.set(this.d.left + fCode, this.d.top, (this.d.left + this.d.height()) - fCode, this.d.bottom);
        this.f4506a.addArc(this.c, 270.0f, -180.0f);
    }
    ...
    private void Z(float f) {
        this.f4506a.reset();
        this.f4506a.addArc(this.b, 90.0f, 180.0f);
        this.f4506a.addRect(this.d.left + this.e, this.d.top, (this.d.width() * f) + this.d.left, this.d.bottom, Path.Direction.CCW);
    }
