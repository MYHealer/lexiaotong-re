...
public interface ba {
    ...
    public static final String f4438a = "adType";
    ...
    public static final String aP = "styleId";
    public static final String aQ = "slotid";
    public static final String aR = "sdkVer";
    public static final String aS = "jssdkVersion";
    public static final String aT = "id";
    public static final String aU = "complianceType";
    public static final String aV = "maxCount";
    public static final String aW = "fbCode";
    public static final String aX = "versionCode";
    public static final String aY = "startShowtime";
    public static final String aZ = "playVideoNoDataSize";
    ...
    public static final String ba = "closeDialogClose";
    public static final String bb = "closeDialogContinue";
    public static final String bc = "videoTime";
    public static final String bd = "cshareUrl";
    public static final String be = "checkContent";
