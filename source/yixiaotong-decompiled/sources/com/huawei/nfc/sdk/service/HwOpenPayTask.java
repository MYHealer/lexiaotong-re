    ...
    public void initNfcService() {
        ...
        synchronized (this.lock) {
            if (this.mOpenService == null) {
                ...
                boolean zBindService = (weakReference == null || (context = (Context) weakReference.get()) == null) ? false : context.bindService(intent, this.mNfcServiceConnection, 1);
                        ...
                        try {
                            try {
                                ...
                                if (iHwResultCallBack2 != null) {
                                    iHwResultCallBack2.onResult(zSupportCapacity ? 1 : 0, new Bundle());
                                }
