...
public class v0 implements g {
    ...
    public void run() {
        ...
        try {
            try {
                Map<String, List<b1>> mapA = c1.a(this.f4113a, this.b, this.c);
                if (mapA.size() == 0) {
                    v.b("hmsSdk", "no have events to report: tag:%s : type:%s", this.b, this.c);
                    if ("alltype".equals(this.c)) {
                        d.a(this.f4113a, "stat_v2_1", new String[0]);
                        d.a(this.f4113a, "cached_v2_1", new String[0]);
                        return;
                    } else {
                        String strA = n1.a(this.b, this.c);
                        d.a(this.f4113a, "stat_v2_1", strA);
                        d.a(this.f4113a, "cached_v2_1", strA);
                        return;
                    }
                }
                ...
                if ("alltype".equals(this.c)) {
                    ...
                    d.a(this.f4113a, "stat_v2_1", strA2);
                    d.a(this.f4113a, "cached_v2_1", strA2);
                }
                if (zA) {
                ...
                if ("alltype".equals(this.c)) {
                    ...
                    d.a(this.f4113a, "stat_v2_1", strA3);
                    d.a(this.f4113a, "cached_v2_1", strA3);
                }
            } catch (Exception e2) {
                ...
                if ("alltype".equals(this.c)) {
                    ...
                    d.a(this.f4113a, "stat_v2_1", strA4);
                    d.a(this.f4113a, "cached_v2_1", strA4);
                }
            }
        } catch (Throwable th) {
            if ("alltype".equals(this.c)) {
                ...
                d.a(this.f4113a, "stat_v2_1", strA5);
                d.a(this.f4113a, "cached_v2_1", strA5);
            }
            throw th;
        }
    }
