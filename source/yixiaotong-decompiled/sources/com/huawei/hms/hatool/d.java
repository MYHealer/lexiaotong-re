...
public class d {
    ...
    public static String c(Context context, String str) {
        ...
        return (TextUtils.isEmpty(strN) ? new StringBuilder("hms_").append(str).append("_").append(packageName) : new StringBuilder("hms_").append(str).append("_").append(packageName).append("_").append(strN)).toString();
    }
}
