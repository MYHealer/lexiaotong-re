...
public class n {
    ...
    public static final Charset f4098a = Charset.forName("UTF-8");
    ...
    public static String a(String str, String str2) {
        ...
        return new String(AesCbc.decrypt(HexUtil.hexStr2ByteArray((String) pairA.second), HexUtil.hexStr2ByteArray(str2), (byte[]) pairA.first), f4098a);
    }
    ...
    public static String b(String str, String str2) {
        return HexUtil.byteArray2HexStr(AesCbc.encrypt(str.getBytes(f4098a), HexUtil.hexStr2ByteArray(str2)));
    }
}
