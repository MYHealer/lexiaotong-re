...
public class l0 {
    ...
    private void b() {
        if (c0.a(q0.i(), "backup_event", AVMDLDataLoaderConfigure.DEFAULT_MAX_FACTORY_MEMORY_SIZE)) {
            v.d("hmsSdk", "backup file reach max limited size, discard new event ");
            return;
        }
        JSONArray jSONArrayC = c();
        String strA = n1.a(this.f4092a, this.b, this.e);
    ...
    private h1 d() {
        return k.a(this.d, this.f4092a, this.b, this.e, this.c);
    }
    ...
    public void a() {
        ...
        b0 b0VarC;
        String str;
        String strA = a(this.f4092a, this.b);
        if (!TextUtils.isEmpty(strA) || "preins".equals(this.b)) {
            if (!"_hms_config_tag".equals(this.f4092a) && !"_openness_config_tag".equals(this.f4092a)) {
                b();
            }
            h1 h1VarD = d();
            if (h1VarD != null) {
                ...
                if (bArrA.length == 0) {
                    ...
                    d1Var = new f(bArrA, strA, this.f4092a, this.b, this.e, this.d);
                    b0VarC = b0.b();
                }
            } else {
                d1Var = new d1(this.d, this.f4092a, this.e, this.b);
                b0VarC = b0.c();
            }
            b0VarC.a(d1Var);
            return;
