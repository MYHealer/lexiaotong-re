...
public abstract class n1 {
    ...
    public static String a(String str, String str2) {
        return "_default_config_tag".equals(str) ? str : str + com.huawei.openalliance.ad.constant.x.A + str2;
    }

    public static String a(String str, String str2, String str3) {
        return ("_default_config_tag".equals(str) ? new StringBuilder("_default_config_tag#") : new StringBuilder().append(str).append(com.huawei.openalliance.ad.constant.x.A).append(str2).append("#")).append(str3).toString();
    }
