...
public class BridgeActivity extends Activity {
    ...
    public IBridgeActivityDelegate f3787a;
        ...
        public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
            try {
                ...
                if (objInvoke == null) {
                    ...
                    ViewGroup viewGroup = this.f3788a;
                    if (viewGroup != null) {
    ...
    public final boolean b() {
        ...
        try {
            ...
            this.f3787a = iBridgeActivityDelegate;
            try {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        IBridgeActivityDelegate iBridgeActivityDelegate = this.f3787a;
