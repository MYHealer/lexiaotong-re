...
public class ForegroundIntentBuilder {
    ...
    public Intent build() {
        String packageName;
        String appId;
        Intent intentStartBridgeActivity = BridgeActivity.getIntentStartBridgeActivity(this.f3791a, ForegroundBusDelegate.class.getName());
        Context context = this.f;
        if (context != null) {
            packageName = context.getPackageName();
            appId = Util.getAppId(this.f);
        } else {
            packageName = this.f3791a.getPackageName();
            appId = Util.getAppId(this.f3791a);
        }
    ...
    public ForegroundIntentBuilder setInnerHms() {
        this.e = this.f3791a.getPackageName();
        return this;
    }
