...
public class a {
    ...
    private final Map<String, Long> f4041a = new ConcurrentHashMap(16);
    private final c b;
    private final c c;
    private final g d;
    ...
    private void a(GrsBaseInfo grsBaseInfo, b bVar, Context context, String str) {
        Long l = this.f4041a.get(grsBaseInfo.getGrsParasKey(true, true, context));
        if (e.a(l)) {
            bVar.a(2);
            return;
        }
        if (e.a(l, 300000L)) {
            this.d.a(new com.huawei.hms.framework.network.grs.g.j.c(grsBaseInfo, context), null, str, this.c);
        }
        bVar.a(1);
    }

    private void a(GrsBaseInfo grsBaseInfo, String str, Context context) {
        if (e.a(this.f4041a.get(str), 300000L)) {
            this.d.a(new com.huawei.hms.framework.network.grs.g.j.c(grsBaseInfo, context), null, null, this.c);
        }
    }
    ...
    public void a(GrsBaseInfo grsBaseInfo, Context context) {
        ...
        this.f4041a.remove(grsParasKey + CrashHianalyticsData.TIME);
        Map<String, Map<String, Map<String, String>>> map = f;
    ...
    public void a(GrsBaseInfo grsBaseInfo, d dVar, Context context, com.huawei.hms.framework.network.grs.g.j.c cVar) {
        ...
        if (cVar.d().size() == 0) {
            ...
            this.f4041a.put(grsParasKey, Long.valueOf(Long.parseLong(dVar.a())));
        } else {
    ...
    public void b(GrsBaseInfo grsBaseInfo, Context context) {
        ...
        Logger.i(e, "Cache size is: " + map.size());
        this.f4041a.put(grsParasKey, Long.valueOf(j));
