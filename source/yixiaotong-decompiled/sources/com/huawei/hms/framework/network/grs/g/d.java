...
public class d {
    ...
    private Map<String, List<String>> f4050a;
    private byte[] b;
    private int c;
    private long d;
    private long e;
    ...
    private void p() {
        ...
        try {
            ...
            if (jSONObject.has("isSuccess")) {
                ...
                i = -1;
            } else if (jSONObject.getInt(Constant.KEY_RESULT_CODE) == 0) {
                i = 1;
            } else {
                i = 2;
            }
    ...
    private Map<String, String> r() {
        ...
        Map<String, List<String>> map2 = this.f4050a;
        if (map2 == null || map2.size() <= 0) {
            Logger.v(o, "parseRespHeaders {respHeaders == null} or {respHeaders.size() <= 0}");
            return map;
        }
        for (Map.Entry<String, List<String>> entry : this.f4050a.entrySet()) {
