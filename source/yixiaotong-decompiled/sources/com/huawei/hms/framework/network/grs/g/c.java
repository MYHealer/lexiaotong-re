...
public class c {
    ...
    private final GrsBaseInfo f4049a;
    ...
    private d a(ExecutorService executorService, List<String> list, String str, com.huawei.hms.framework.network.grs.e.c cVar) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                Future<d> futureSubmit = executorService.submit(new a(str2, i, this, this.b, str, this.f4049a, cVar).g());
    ...
    private void a(String str, String str2) {
        ...
        sb.append(str2);
        sb.append(str);
        String grsReqParamJoint = this.f4049a.getGrsReqParamJoint(false, false, d(), this.b);
    ...
    private void c() {
        this.j = this.c.a().a(this.f4049a.getGrsParasKey(true, true, this.b) + "ETag", "");
    }
    ...
    public synchronized void a(d dVar) {
        ...
        if (dVar.n()) {
            ...
            com.huawei.hms.framework.network.grs.h.d.a(this.f4049a.getGrsParasKey(true, true, this.b), new com.huawei.hms.framework.network.grs.h.d.a(dVar.k(), SystemClock.elapsedRealtime()));
            return;
        }
        if (dVar.m()) {
        ...
        this.d = dVar;
        this.c.a(this.f4049a, dVar, this.b, this.i);
        for (Map.Entry<String, Future<d>> entry : this.e.entrySet()) {
