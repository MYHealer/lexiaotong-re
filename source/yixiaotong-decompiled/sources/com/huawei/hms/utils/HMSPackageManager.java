...
public class HMSPackageManager {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            Iterator<ResolveInfo> it = HMSPackageManager.this.f4421a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128).iterator();
            while (it.hasNext()) {
        ...
        synchronized (n) {
            if (m == null) {
                if (StubApp.getOrigApplicationContext(context.getApplicationContext()) != null) {
                    m = new HMSPackageManager(StubApp.getOrigApplicationContext(context.getApplicationContext()));
                } else {
    ...
    public final Pair<String, String> g() {
        ...
        for (b bVar : arrayListH) {
            ...
            if (a(str + "&" + packageSignature + "&" + str2, str3, str4)) {
                HMSLog.i("HMSPackageManager", "result: " + str + ", " + str2 + ", " + bVar.f);
    ...
    public final Pair<String, String> f() {
        List<ResolveInfo> listQueryIntentServices = this.f4421a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128);
    ...
    public final ArrayList<b> h() {
        List<ResolveInfo> listQueryIntentServices = this.f4421a.getPackageManager().queryIntentServices(new Intent(PackageConstants.GENERAL_SERVICES_ACTION), 128);
    ...
    public final boolean b() {
        String hmsPath = ReadApkFileUtil.getHmsPath(this.f4421a);
        if (hmsPath == null) {
    ...
    public final boolean a(String str, String str2, String str3) {
        if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str3)) {
            ...
            if (!com.huawei.hms.device.a.a(com.huawei.hms.device.a.a(this.f4421a), listB)) {
