...
public class NotInstalledHmsResolution implements IBridgeActivityDelegate {
    ...
    public Dialog f4412a;
    public Activity b;

    public static class a implements DialogInterface.OnClickListener {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final Activity f4413a;
    ...
    public final void a(Activity activity) {
        a();
        this.f4412a = NotInstalledHmsDialogHelper.getDialogBuilder(activity).setPositiveButton(NotInstalledHmsDialogHelper.getConfirmResId(activity), new a(activity)).show();
    }
