...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    /* JADX INFO: renamed from: com.huawei.hms.common.data.DataHolder$1, reason: invalid class name */
    ...
    public static class Builder {
        ...
        /* synthetic */ Builder(String[] strArr, String str, AnonymousClass1 anonymousClass1) {
            this(strArr, str);
        }

        /* JADX WARN: Multi-variable type inference failed */
        public DataHolder build(int i) {
            return new DataHolder(this, i, (Bundle) null, (AnonymousClass1) (0 == true ? 1 : 0));
        }
    ...
    /* synthetic */ DataHolder(Builder builder, int i, Bundle bundle, int i2, AnonymousClass1 anonymousClass1) {
        this(builder, i, bundle, i2);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static Builder builder(String[] strArr) {
        return new Builder(strArr, (String) null, (AnonymousClass1) (0 == true ? 1 : 0));
    }
    ...
    private static ArrayList<CursorWindow> iterCursorWindow(Builder builder, int i, List list) {
        ...
        cursorWindow.setNumColumns(builder.f3963a.length);
        ...
        for (int i2 = 0; i2 < i; i2++) {
            try {
                ...
                for (int i3 = 0; i3 < builder.f3963a.length && (zPutValue = putValue(cursorWindow, map.get(builder.f3963a[i3]), i2, i3)); i3++) {
                }
                if (!zPutValue) {
                    ...
                    cursorWindow2.setNumColumns(builder.f3963a.length);
    ...
    /* synthetic */ DataHolder(Builder builder, int i, Bundle bundle, AnonymousClass1 anonymousClass1) {
    ...
    private DataHolder(Builder builder, int i, Bundle bundle) {
        this(builder.f3963a, getCursorWindows(builder, -1), i, (Bundle) null);
    }

    private DataHolder(Builder builder, int i, Bundle bundle, int i2) {
        this(builder.f3963a, getCursorWindows(builder, -1), i, bundle);
    }

    private static CursorWindow[] getCursorWindows(Builder builder, int i) {
        if (builder.f3963a.length == 0) {
            return new CursorWindow[0];
        }
