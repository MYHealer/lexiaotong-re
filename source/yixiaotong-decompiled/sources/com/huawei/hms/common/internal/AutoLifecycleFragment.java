...
public class AutoLifecycleFragment extends Fragment {
    ...
    private final SparseArray<a> f3964a = new SparseArray<>();
    private boolean b;

    private static class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final HuaweiApiClient f3965a;

        public a(int i, HuaweiApiClient huaweiApiClient) {
            this.f3965a = huaweiApiClient;
        }
    ...
    public void onStart() {
        ...
        for (int i = 0; i < this.f3964a.size(); i++) {
            this.f3964a.valueAt(i).f3965a.connect((Activity) null);
        }
    }
    ...
    public void onStop() {
        ...
        this.b = false;
        for (int i = 0; i < this.f3964a.size(); i++) {
            this.f3964a.valueAt(i).f3965a.disconnect();
        }
    }
    ...
    public void startAutoMange(int i, HuaweiApiClient huaweiApiClient) {
        ...
        Preconditions.checkState(this.f3964a.indexOfKey(i) < 0, "Already managing a HuaweiApiClient with this clientId: " + i);
        this.f3964a.put(i, new a(i, huaweiApiClient));
        if (this.b) {
    ...
    public void stopAutoManage(int i) {
        a aVar = this.f3964a.get(i);
        this.f3964a.remove(i);
        if (aVar != null) {
            aVar.a();
        }
    }
