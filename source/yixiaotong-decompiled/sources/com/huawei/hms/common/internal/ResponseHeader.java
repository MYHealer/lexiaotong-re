...
public class ResponseHeader implements IMessageEntity, ResponseErrorCode {
    ...
    public boolean fromJson(String str) {
        try {
            ...
            this.status_code = JsonUtil.getIntValue(jSONObject, o0OO000o.o000o0oo);
            ...
            this.pkg_name = JsonUtil.getStringValue(jSONObject, a.hnadse);
    ...
    public String getActualAppID() {
        ...
        return strArrSplit.length == 1 ? strArrSplit[0] : strArrSplit[1];
    }
    ...
    public String toJson() {
        ...
        try {
            jSONObject.put(o0OO000o.o000o0oo, this.status_code);
            ...
            jSONObject.put(a.hnadse, this.pkg_name);
