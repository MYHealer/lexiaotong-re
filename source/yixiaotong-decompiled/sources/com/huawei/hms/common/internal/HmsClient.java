    ...
    private static class BaseAdapterCallBack implements BaseAdapter.BaseCallBack {
        ...
        public void onError(String str) {
            ...
            if (!responseWrap.fromJson(str)) {
                this.f3976a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
                return;
            }
            ...
            this.f3976a.onCallback(responseHeader, responseWrap.getBody());
        }
        ...
        private void a(String str, String str2) {
            ...
            if (responseHeader.fromJson(str)) {
                ...
                a(responseHeader.getSessionId());
                this.f3976a.onCallback(responseHeader, str2);
                return;
            }
            this.f3976a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
        }
