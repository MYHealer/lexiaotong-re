...
public class SafeParcelReader {
    ...
    private static void b(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(new StringBuilder(hexString.length() + 46).append("Expected size ").append(i2).append(" got ").append(size).append(" (0x").append(hexString).append(")").toString(), parcel);
    }
