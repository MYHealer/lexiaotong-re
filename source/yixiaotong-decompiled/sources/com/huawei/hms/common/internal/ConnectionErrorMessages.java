...
public class ConnectionErrorMessages {
    ...
    public static String getErrorDialogButtonMessage(Activity activity, int i) {
        if (ResourceLoaderUtil.getmContext() == null) {
            ResourceLoaderUtil.setmContext(StubApp.getOrigApplicationContext(activity.getApplicationContext()));
        }
        if (i == 1) {
        ...
        return a(activity) ? ResourceLoaderUtil.getString("hms_update") : ResourceLoaderUtil.getString("hms_confirm");
    }
