...
import com.huawei.hms.scankit.p.c6;
...
public class HmsScan extends HmsScanBase {
    ...
    public HmsScan(String str, int i, String str2, int i2, byte[] bArr, Point[] pointArr, HmsScanAnalyzerOptions hmsScanAnalyzerOptions, c6 c6Var) {
        super(str, i, str2, i2, bArr, pointArr, hmsScanAnalyzerOptions);
        ...
        if (i2 == EMAIL_CONTENT_FORM) {
            this.emailContent = (EmailContent) c6Var.a();
            return;
        }
        if (i2 == TEL_PHONE_NUMBER_FORM) {
            this.telPhoneNumber = (TelPhoneNumber) c6Var.a();
            return;
        }
        if (i2 == PURE_TEXT_FORM) {
            Log.i("Hms", "PURE_TEXT_FORM");
        ...
        if (i2 == SMS_FORM) {
            this.smsContent = (SmsContent) c6Var.a();
            return;
        }
        if (i2 == URL_FORM) {
            this.linkUrl = (LinkUrl) c6Var.a();
            return;
        }
        if (i2 == WIFI_CONNECT_INFO_FORM) {
            this.wifiConnectionInfo = (WiFiConnectionInfo) c6Var.a();
            return;
        }
        if (i2 == EVENT_INFO_FORM) {
            this.eventInfo = (EventInfo) c6Var.a();
            return;
        }
        if (i2 == CONTACT_DETAIL_FORM) {
            this.contactDetail = (ContactDetail) c6Var.a();
            return;
        }
        if (i2 == DRIVER_INFO_FORM) {
            this.driverInfo = (DriverInfo) c6Var.a();
        } else if (i2 == LOCATION_COORDINATE_FORM) {
            this.locationCoordinate = (LocationCoordinate) c6Var.a();
