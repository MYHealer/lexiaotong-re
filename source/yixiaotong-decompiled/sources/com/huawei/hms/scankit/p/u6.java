...
public final class u6 extends s6 {
    ...
    private int b(r rVar, int[] iArr, int i2, int[][] iArr2) throws a {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            float fA = o4.a(iArr, iArr2[i4], 0.7f);
            if (fA < f) {
                i3 = i4;
                f = fA;
            }
    ...
    boolean a(int[] iArr, int[] iArr2) throws a {
        ...
        int i4 = iArr2[1];
        int i5 = iArr2[0];
        return ((double) Math.abs(((int) Math.round(((double) (i4 - i3)) / (((double) ((i4 - i5) + (i2 - i3))) / 9.0d))) + (-51))) <= 10.200000000000001d && Math.abs(1.0d - (d / (((double) (i4 - i5)) / 6.0d))) < 0.2d;
    }
}
