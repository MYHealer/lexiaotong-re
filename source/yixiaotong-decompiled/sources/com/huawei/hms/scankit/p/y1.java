...
public class y1 implements Comparable<y1> {
    ...
    public y1(boolean z, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10) {
        this.f4377a = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
    ...
    public void a(int i, int i2, float f, float f2) {
        ...
        this.e += f;
        this.f += f2;
        this.f4377a = a(f3, 0, i);
        this.e = a(this.e, 0, i);
        this.b = a(this.b, 0, i2);
        this.f = a(this.f, 0, i2);
        float f5 = this.f4377a;
        float f6 = i - f;
        if (this.c + f5 >= f6) {
            this.c = (f6 - 1.0f) - f5;
        }
