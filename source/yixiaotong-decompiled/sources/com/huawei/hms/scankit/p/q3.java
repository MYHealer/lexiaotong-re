...
public class q3 extends IRemoteFrameDecoderDelegate.Stub {
    private static volatile q3 d = new q3();
    ...
    public w5[] decode(byte[] bArr, int i, int i2, int i3, int i4, IObjectWrapper iObjectWrapper) throws RemoteException {
        if (iObjectWrapper != null && (ObjectWrapper.unwrap(iObjectWrapper) instanceof Bundle)) {
            ...
            this.f4328a = (Point) bundle.getParcelable("Screen");
        ...
        if (this.f4328a == null) {
            this.f4328a = new Point(1080, 1920);
        }
        j5 j5VarA = a(bArr, i, i2, i3);
        byte[] bArrB = j5VarA.b();
        b6 b6Var = new b6(j5VarA.c(), j5VarA.a(), i4);
        int i5 = this.b;
        this.b = i5 + 1;
        return g1.c(bArrB, b6Var.a(i5));
    }

    private j5 a(byte[] bArr, int i, int i2, int i3) {
        if (i3 == 0) {
    ...
    public j5 a(byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        int iMin = (int) (((double) Math.min(i, i2)) * 0.8d);
        int i11 = (i - iMin) / 2;
        int i12 = (i2 - iMin) / 2;
        Rect rect = this.c;
        if (rect == null) {
            ...
            if (rect.left == -1 && rect.right == -1 && rect.top == -1 && rect.bottom == -1) {
                iMin = (int) (((double) i) * 0.85d);
                i11 = (i - iMin) / 2;
                double d2 = i2;
                i10 = (int) (0.8d * d2);
                i12 = (int) (d2 * 0.1d);
            } else {
                iMin = (int) (((double) Math.min(i, i2)) * 0.9d);
                i11 = (i - iMin) / 2;
                Rect rect2 = this.c;
                Rect rect3 = new Rect(rect2.left, rect2.top, rect2.right, rect2.bottom);
                int iMax = Math.max(i, i2);
                Point point = this.f4328a;
                if (point != null) {
                    i9 = point.x;
                    i8 = point.y;
                } else {
        ...
        x3.a("ScanSize", "top:" + i12 + "scanSizeHeight" + iMin + "mHeight:" + i2);
        if (i2 < i12 + iMin) {
            i5 = i2;
            i6 = 0;
        } else {
        ...
        return new j5(bArr, i, i2, i3, i6, i7, i5, false);
    }
}
