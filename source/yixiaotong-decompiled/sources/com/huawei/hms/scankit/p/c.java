...
/* JADX INFO: compiled from: AddressBookDoCoMoResultParser.java */
...
public final class c extends x5 {
    ...
    private static HmsScan.PeopleName a(String str, String str2) {
        ...
        if (iIndexOf < 0) {
            ...
            peopleName.fullName = peopleName.givenName + PPSLabelView.Code + peopleName.familyName;
        }
        return peopleName;
    }
    ...
    public HmsScan b(w5 w5Var) {
        ...
        return new HmsScan(w5Var.k(), x5.a(w5Var.c()), contactDetail.peopleName.fullName, HmsScan.CONTACT_DETAIL_FORM, w5Var.i(), x5.a(w5Var.j()), null, new c6(contactDetail));
    }
    ...
    private static String[] b(String[] strArr, String str) {
        ...
        for (String str2 : strArr) {
            if (str2.startsWith(str)) {
                arrayList.add(x5.b(str2.substring(str.length())));
            }
        }
