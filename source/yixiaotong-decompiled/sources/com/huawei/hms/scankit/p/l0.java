...
public enum l0 {
    ...
    private static final Map<Integer, l0> D = new HashMap();
    private static final Map<String, l0> E = new HashMap();
    ...
    static {
        for (l0 l0Var : values()) {
            for (int i : l0Var.f4298a) {
                D.put(Integer.valueOf(i), l0Var);
            }
            E.put(l0Var.name(), l0Var);
    ...
    l0(int i, String... strArr) {
        this.f4298a = new int[]{i};
        this.b = strArr;
    }

    public static l0 a(int i) throws a {
        if (i < 0 || i >= 900) {
            throw a.a();
        }
