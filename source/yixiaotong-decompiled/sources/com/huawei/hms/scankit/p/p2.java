    ...
    public static String a(String str, g6 g6Var) {
        ...
        if (iD == 1) {
            ...
            for (int i3 = 0; i3 < iD; i3++) {
                ...
                for (int i4 = i3; i4 < g6Var.a(); i4 += iD) {
                    sb2.append(str.charAt(i4));
                }
                String strA = a(sb2.toString(), iArr2[i3]);
                int i5 = i3;
                int i6 = 0;
                while (i5 < iArr2[i3] * iD) {
                    sb.setCharAt(g6Var.a() + i5, strA.charAt(i6));
                    i5 += iD;
                    i6++;
                }
            }
