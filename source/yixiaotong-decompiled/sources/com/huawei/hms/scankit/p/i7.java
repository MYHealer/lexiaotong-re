...
public class i7 {
    public static float a(int i, int i2, y5[] y5VarArr) {
        float fAbs;
        float fAbs2;
        float f = 1.0f;
        if (y5VarArr.length < 3) {
            return 1.0f;
        }
        int i3 = 0;
        ...
        y5 y5VarA = a(fB, fC, fB2, fC2, fB3, fC3);
        float fB4 = y5VarA.b();
        float fC4 = y5VarA.c();
    ...
    public static float b(int i, int i2, y5[] y5VarArr) {
        float fAbs;
        float fAbs2;
        float f = 1.0f;
        if (y5VarArr.length < 3) {
    ...
    private static y5 a(float f, float f2, float f3, float f4, float f5, float f6) {
        return new y5((f + f5) - f3, (f2 + f6) - f4);
    }
}
