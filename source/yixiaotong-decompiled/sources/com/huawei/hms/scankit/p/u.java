...
final class u {
    ...
    u(s sVar) throws a {
        ...
        s sVarA = a(sVar);
        this.f4348a = sVarA;
        this.b = new s(sVarA.e(), sVarA.c());
    }

    private static b7 b(s sVar) throws a {
        return b7.a(sVar.c(), sVar.e());
    }
    ...
    byte[] b() throws a {
        ...
        int iC = this.f4348a.c();
        int iE = this.f4348a.e();
        int i = 0;
        int i2 = 0;
        boolean z = false;
        boolean z2 = false;
        ...
        while (true) {
            if (i3 == iC && i == 0 && !z) {
                ...
                if (i3 == i4 && i == 0 && (iE & 3) != 0 && !z2) {
                    ...
                    int[] iArrA = a(i3, iC, i, iE, bArr, i2);
                    i3 = iArrA[0];
                    int i5 = iArrA[1];
                    i2 = iArrA[2];
                    i = i5;
