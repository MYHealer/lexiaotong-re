...
public class MLFrame {
    ...
    /* JADX INFO: renamed from: com.huawei.hms.mlsdk.common.MLFrame$1, reason: invalid class name */
    ...
    public static class Property {
        ...
        /* synthetic */ Property(int i, int i2, int i3, int i4, int i5, long j, Ext ext, AnonymousClass1 anonymousClass1) {
        ...
        public static class Ext {
            ...
            /* synthetic */ Ext(int i, int i2, int i3, Rect rect, AnonymousClass1 anonymousClass1) {
                this(i, i2, i3, rect);
            }
            ...
            public static class Creator {
                ...
                public Ext build() {
                    return new Ext(this.lensId, this.zoom, this.maxZoom, this.rect, null);
                }
            }
        }
        ...
        public static class Creator {
            ...
            public Property create() {
                return new Property(this.width, this.height, this.quadrant, this.formatType, this.itemIdentity, this.timestamp, this.ext, null);
            }
        }
    }
