...
public final class MLApplicationSetting {
    ...
    /* JADX INFO: renamed from: com.huawei.hms.mlsdk.common.MLApplicationSetting$1, reason: invalid class name */
    ...
    /* synthetic */ MLApplicationSetting(String str, String str2, String str3, String str4, String str5, Boolean bool, String str6, List list, List list2, Map map, String str7, String str8, AnonymousClass1 anonymousClass1) {
        this(str, str2, str3, str4, str5, bool, str6, list, list2, map, str7, str8);
    }
    ...
    public static final class Factory {
        ...
        public MLApplicationSetting create() {
            return new MLApplicationSetting(this.appId, this.apiKey, this.packageName, this.certFingerprint, this.mlSdkVersion, this.acceptHa, this.region, this.mlServiceUrls, this.haCollectorUrls, this.extProperties, this.appMLKitGrsPolicy, this.projectId, null);
        }
    }
