...
public class BinderAdapter implements ServiceConnection {
    ...
    private void c() {
        ...
        synchronized (this.f) {
            if (this.f3802a.bindService(intent, this, 1)) {
                i();
            } else {
                this.g = true;
                g();
    ...
    public void d() {
        BinderCallBack binderCallBackH = h();
        if (binderCallBackH != null) {
            binderCallBackH.onBinderFailed(-1);
        }
    }
    ...
    private void f() {
        Handler handler = new Handler(Looper.getMainLooper(), new Handler.Callback() { // from class: com.huawei.hms.adapter.BinderAdapter.2
            ...
            public boolean handleMessage(Message message) {
                ...
                BinderCallBack binderCallBackH = BinderAdapter.this.h();
                if (binderCallBackH == null) {
                    return true;
                }
                binderCallBackH.onTimedDisconnected();
                return true;
            }
        });
        this.i = handler;
    ...
    private void g() {
        ...
        ComponentName componentName = new ComponentName(this.f3802a.getApplicationInfo().packageName, "com.huawei.hms.activity.BridgeActivity");
        Intent intent = new Intent();
        intent.setComponent(componentName);
        intent.putExtra(BridgeActivity.EXTRA_DELEGATE_CLASS_NAME, BindingFailedResolution.class.getName());
        BinderCallBack binderCallBackH = h();
        if (binderCallBackH != null) {
            binderCallBackH.onBinderFailed(-1, intent);
        }
    }
    ...
    public void onNullBinding(ComponentName componentName) {
        ...
        BinderCallBack binderCallBackH = h();
        if (binderCallBackH != null) {
            binderCallBackH.onNullBinding(componentName);
        }
    }
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        BinderCallBack binderCallBackH = h();
        if (binderCallBackH != null) {
            binderCallBackH.onServiceConnected(componentName, iBinder);
        }
        f();
    }
    ...
    public void onServiceDisconnected(ComponentName componentName) {
        ...
        BinderCallBack binderCallBackH = h();
        if (binderCallBackH != null) {
            binderCallBackH.onServiceDisconnected(componentName);
        }
        j();
    }

    public void unBind() {
        Util.unBindServiceCatchException(this.f3802a, this);
    }
    ...
    private void i() {
        ...
        this.h.sendEmptyMessageDelayed(a(), ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT);
    }
