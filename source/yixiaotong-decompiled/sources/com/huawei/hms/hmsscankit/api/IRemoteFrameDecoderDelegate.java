...
public interface IRemoteFrameDecoderDelegate extends IInterface {
    ...
    w5[] decode(byte[] bArr, int i, int i2, int i3, int i4, IObjectWrapper iObjectWrapper) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IRemoteFrameDecoderDelegate {
        ...
        private static class Proxy implements IRemoteFrameDecoderDelegate {
            ...
            @Override // com.huawei.hms.hmsscankit.api.IRemoteFrameDecoderDelegate
            public w5[] decode(byte[] bArr, int i, int i2, int i3, int i4, IObjectWrapper iObjectWrapper) throws Throwable {
                ...
                try {
                    ...
                    try {
                        if (!this.mRemote.transact(1, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
                            w5[] w5VarArrDecode = Stub.getDefaultImpl().decode(bArr, i, i2, i3, i4, iObjectWrapper);
                            parcelObtain2.recycle();
                            parcelObtain.recycle();
                            return w5VarArrDecode;
                        }
                        parcelObtain2.readException();
                        w5[] w5VarArr = (w5[]) parcelObtain2.createTypedArray(w5.CREATOR);
                        parcelObtain2.recycle();
                        parcelObtain.recycle();
                        return w5VarArr;
                    } catch (Throwable th) {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            w5[] w5VarArrDecode = decode(parcel.createByteArray(), parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt(), IObjectWrapper.Stub.asInterface(parcel.readStrongBinder()));
            parcel2.writeNoException();
            parcel2.writeTypedArray(w5VarArrDecode, 1);
            return true;
        }
    }
}
