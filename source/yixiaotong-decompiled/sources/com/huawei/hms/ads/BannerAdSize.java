...
public class BannerAdSize extends AdSize {
    public static final BannerAdSize BANNER_SIZE_360_57 = new BannerAdSize(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_DEMUXER_STALL, 57);
    public static final BannerAdSize BANNER_SIZE_360_144 = new BannerAdSize(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_DEMUXER_STALL, MediaPlayer.MEDIA_PLAYER_OPTION_SPADE);
    public static final BannerAdSize BANNER_SIZE_320_50 = new BannerAdSize(MediaPlayer.MEDIA_PLAYER_OPTION_LAST_VIDEO_RENDER_TIME, 50);
    ...
    public static final BannerAdSize BANNER_SIZE_320_100 = new BannerAdSize(MediaPlayer.MEDIA_PLAYER_OPTION_LAST_VIDEO_RENDER_TIME, 100);
    ...
    private static BannerAdSize Code(Context context, int i, int i2) {
        int iZ = d.Z(context, i2);
        return iZ == 0 ? BANNER_SIZE_INVALID : new BannerAdSize(i, d.Code(i, iZ), 1);
    }
