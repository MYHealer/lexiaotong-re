...
public class ck extends MediaPlayerAgent implements MediaStateListener, com.huawei.openalliance.ad.media.listener.c {
    ...
    private com.huawei.openalliance.ad.media.listener.c Z;
    ...
    public void Code() {
        try {
            ...
            fh.V(Code, "stop err: %s", th.getClass().getSimpleName());
        }
    }
    ...
    public void Code(MediaPlayerAgent mediaPlayerAgent, int i, int i2, int i3) {
        com.huawei.openalliance.ad.media.listener.c cVar = this.Z;
        if (cVar != null) {
    ...
    public void Code(MediaStateListener mediaStateListener) {
        ...
        try {
            ...
            bundle.putBinder(com.huawei.openalliance.ad.constant.br.f.s, (IBinder) ObjectWrapper.wrap(this));
            this.V.Code(bundle);
        } catch (Throwable th) {
            fh.V(Code, "addMediaStateListener err: %s", th.getClass().getSimpleName());
        }
    }
    ...
    public void Code(com.huawei.openalliance.ad.media.listener.c cVar) {
        ...
        try {
            ...
            fh.V(Code, "addMediaErrorListener err: %s", th.getClass().getSimpleName());
        }
    }
    ...
    public void Code(String str) {
        try {
            ...
            fh.V(Code, "playWhenUrlMatchs err: %s", th.getClass().getSimpleName());
        }
    }
    ...
    public void I(String str) {
        try {
            ...
            fh.V(Code, "pauseWhenUrlMatchs er: %s", th.getClass().getSimpleName());
        }
    }
    ...
    public void V(MediaStateListener mediaStateListener) {
        try {
            ...
            fh.V(Code, "removeMediaErrorListener err: %s", th.getClass().getSimpleName());
        }
    }
    ...
    public void V(String str) {
        try {
            ...
            fh.V(Code, "stopWhenUrlMatchs err: %s", th.getClass().getSimpleName());
        }
    }
