...
public class jz extends jv {
    ...
    public jz(Context context, AdContentData adContentData, StackTraceElement[] stackTraceElementArr, View view) {
        super(context, adContentData);
        this.S = "TouchDetector";
