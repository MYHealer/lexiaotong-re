...
public class b {
    ...
    b(NativeVideoView nativeVideoView, NativeWindowImageView nativeWindowImageView) {
    ...
    private void Code(g gVar) {
        ...
        if (gVar2 instanceof l) {
            NativeAdConfiguration nativeAdConfigurationAt = ((l) gVar2).at();
            this.I = nativeAdConfigurationAt;
            if (nativeAdConfigurationAt != null) {
                this.Z = nativeAdConfigurationAt.getVideoConfiguration();
            }
        }
        if (S()) {
    ...
    private boolean S() {
        return this.C.f() == 13 || this.C.f() == 113;
    }
    ...
    void Code(final VideoOperator.VideoLifecycleListener videoLifecycleListener) {
