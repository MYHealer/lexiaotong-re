...
public class c implements VideoOperator {
    ...
    public MediaContent Code() {
        NativeVideoView nativeVideoViewI;
        b bVar = this.V;
        if (bVar == null || (nativeVideoViewI = bVar.I()) == null) {
            return null;
        }
        return nativeVideoViewI.getMediaContent();
    }
