...
public class CusWhyThisAdView extends RelativeLayout {
    ...
    private HorizontalScrollView f3923a;
    ...
    private void Code(Context context, AttributeSet attributeSet) {
        ...
        this.f3923a = (HorizontalScrollView) findViewById(R.id.hiad_whythisad_horizontal_List);
        this.c = (LinearLayout) findViewById(R.id.hiad_whythisad_horizional_ll_wrapper);
    ...
    public void Code(String str) {
        ...
        HorizontalScrollView horizontalScrollView2 = this.f3923a;
        ...
        this.g.Code(str);
        fh.Code("CusWhyView", "SDK processCloseEvent");
    }
    ...
    public void V() {
        ...
        fh.Code("CusWhyView", "SDK showWhyThisAd end");
    }
    ...
    public void Z() {
        ...
        fh.Code("CusWhyView", "SDK showFeedBackList end");
    }
