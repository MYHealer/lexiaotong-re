...
public class c {
    ...
    public void Code(List<d> list, boolean z) {
        int i;
        int i2;
        fh.Code("ScrollAdapter", "setData and isHorizontal = %s", Boolean.valueOf(z));
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            ...
            if (list.get(i3).V() == a.HIDE_AD) {
                ...
                if (list.get(i3).V() == a.CLOSE_AD) {
                    ...
                    if (list.get(i3).V() == a.NOT_INTEREST) {
                        ...
                        fh.Code("ScrollAdapter", "SDK-banner do-nothing settings.");
                    }
                    textView.setOnClickListener(new View.OnClickListener() { // from class: com.huawei.hms.ads.whythisad.c.1
                        ...
                        public void onClick(View view) {
                            if (view.getTag() == a.HIDE_AD) {
                                fh.Code("ScrollAdapter", "SDK-banner tag is HIDE_AD");
                                c.this.I.B();
                                return;
                            }
                            ...
                            if (view.getTag() == a.CLOSE_AD) {
                                ...
                                c.this.I.Code(c.this.Z.getString(R.string.hiad_choices_ad_no_interest));
                            } else {
                                fh.Code("ScrollAdapter", "sdk onclick do-nothing");
                            }
                        }
                    });
