...
public class ChoicesView extends ImageView {
    ...
    /* JADX INFO: renamed from: com.huawei.hms.ads.ChoicesView$1, reason: invalid class name */
    class AnonymousClass1 implements Runnable {
        final /* synthetic */ String Code;

        /* JADX INFO: renamed from: com.huawei.hms.ads.ChoicesView$1$1, reason: invalid class name and collision with other inner class name */
        class C04851 implements RemoteCallResultCallback<String> {
            C04851() {
            }
            ...
            public void onRemoteCallResult(String str, CallResult<String> callResult) {
                ...
                sourceParam.I(data);
                ac.Code(ChoicesView.this.getContext(), sourceParam, new com.huawei.openalliance.ad.utils.aq() { // from class: com.huawei.hms.ads.ChoicesView.1.1.1
                    @Override // com.huawei.openalliance.ad.utils.aq
                    public void Code() {
                        fh.Code("ChoicesView", "download icon fail, use local icon");
                        com.huawei.openalliance.ad.utils.bj.Code(new Runnable() { // from class: com.huawei.hms.ads.ChoicesView.1.1.1.2
                    ...
                    public void Code(String str2, final Drawable drawable) {
                        if (drawable != null) {
                            com.huawei.openalliance.ad.utils.bj.Code(new Runnable() { // from class: com.huawei.hms.ads.ChoicesView.1.1.1.1
                                @Override // java.lang.Runnable
                                public void run() {
        ...
        public void run() {
            ...
            sourceParam.V(false);
            sourceParam.I(true);
            sourceParam.Code(com.huawei.openalliance.ad.constant.x.k);
            sourceParam.I(this.Code);
            sourceParam.I(true);
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("content", com.huawei.openalliance.ad.utils.ad.V(sourceParam));
                com.huawei.openalliance.ad.ipc.g.V(ChoicesView.this.getContext()).Code(com.huawei.openalliance.ad.constant.s.L, jSONObject.toString(), new C04851(), String.class);
    ...
    public void Code(int i) {
        fh.Code("ChoicesView", "changeChoiceViewSize dp = %s", Integer.valueOf(i));
        Resources resources = getContext().getResources();
    ...
    public void setAdChoiceIcon(String str) {
        ...
        com.huawei.openalliance.ad.utils.i.V(new AnonymousClass1(str));
    }
}
