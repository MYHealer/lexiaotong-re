...
public class e extends a {
    ...
    public e(Context context, String str, int i) {
        ...
        this.f3841a = packageArchiveInfo;
    ...
    private Resources a(String str) {
        this.f3841a.applicationInfo.publicSourceDir = str;
        this.f3841a.applicationInfo.sourceDir = str;
        try {
            return getBaseContext().getPackageManager().getResourcesForApplication(this.f3841a.applicationInfo);
    ...
    public String getPackageName() {
        PackageInfo packageInfo = this.f3841a;
        if (packageInfo != null) {
