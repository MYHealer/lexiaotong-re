...
public class h {
    ...
    private static final String f3842a = "h";
    private static final String[] b = {"b4ec5c5bc95f125d5d586b54a5a40abd38b44201fe8fe3cd295cb3c64f422c3c"};
    private static volatile h c;
    private final Context d;

    private h(Context context) {
        this.d = StubApp.getOrigApplicationContext(context.getApplicationContext()) != null ? StubApp.getOrigApplicationContext(context.getApplicationContext()) : context;
    }

    public static Context a(Context context, Bundle bundle) {
        try {
            if (bundle == null) {
                af.d(f3842a, "Failed to read query result");
                return null;
            }
            String str = f3842a;
            ...
            if (!TextUtils.isEmpty(string) && new File(string).exists()) {
                ...
                try {
                    ...
                    af.b(p.f3910a, "failed to init Module " + e.getClass().getSimpleName());
                }
                return iVar;
            }
            ...
            af.c(f3842a, "createModuleContext err: %s" + th.getClass().getSimpleName());
            return null;
        }
    }
