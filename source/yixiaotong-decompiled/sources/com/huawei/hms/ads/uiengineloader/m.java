...
public final class m implements j {
    ...
    private static final String f3908a = "HMSClassLoaderStrategy";
    ...
    private static boolean a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            af.b(f3908a, "Get pkg name failed: null.");
            return false;
        }
        if (!f.contains(str)) {
            if (!str.startsWith("com.huawei.hwid")) {
                af.b(f3908a, "The pkg does not start with HMS prefix.");
                return false;
            }
            try {
                PackageInfo packageInfo = context.getPackageManager().getPackageInfo(context.getPackageName(), 4);
                if (packageInfo == null) {
                    af.c(f3908a, "Get callPackage packageInfo failed: null.");
                    return false;
                }
                ServiceInfo[] serviceInfoArr = packageInfo.services;
                if (serviceInfoArr == null) {
                    af.c(f3908a, "Get service Info failed: null.");
                    return false;
                }
                ...
                af.b(f3908a, "The calling package is not HMS.");
                return false;
            } catch (PackageManager.NameNotFoundException unused) {
                af.c(f3908a, "Get callPackage packageInfo NameNotFoundException.");
                return false;
            } catch (Throwable th) {
                af.c(f3908a, "Get callPackage packageInfo ex: " + th.getClass().getSimpleName());
                return false;
            }
        }
    ...
    public final ClassLoader a(Context context, String str, int i, PackageInfo packageInfo) {
        ...
        af.b(f3908a, "The api version is:" + Build.VERSION.SDK_INT + ", callingPkg is HMS, use the hmsNativePath.");
