...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        public Builder(Context context) throws NullPointerException {
            ...
            this.f3927a = origApplicationContext;
            this.g = -1;
            ResourceLoaderUtil.setmContext(origApplicationContext);
            a(context);
        }
        ...
        public Builder addApi(Api<? extends Api.ApiOptions.NotRequiredOptions> api) {
            ...
            if (HuaweiApiAvailability.HMS_API_NAME_GAME.equals(api.getApiName())) {
                HiAnalyticsUtil.getInstance().onEvent(StubApp.getOrigApplicationContext(this.f3927a.getApplicationContext()), HiAnalyticsConstant.KeyAndValue.GAME_INIT_KEY, "|" + System.currentTimeMillis());
            }
            return this;
        }
        ...
        public HuaweiApiClient build() {
            ...
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f3927a);
