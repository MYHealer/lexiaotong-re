...
public class BindingFailedResolution implements IBridgeActivityDelegate, ServiceConnection {
    ...
    private void bindCoreService(boolean z) {
        ...
        Intent intent = new Intent(HMSPackageManager.getInstance(StubApp.getOrigApplicationContext(activity.getApplicationContext())).getServiceAction());
        intent.setPackage(HMSPackageManager.getInstance(StubApp.getOrigApplicationContext(activity.getApplicationContext())).getHMSPackageNameForMultiService());
    ...
    private void tryStartHmsActivity(Activity activity) {
        ...
        intent.setClassName(HMSPackageManager.getInstance(StubApp.getOrigApplicationContext(activity.getApplicationContext())).getHMSPackageNameForMultiService(), HuaweiApiAvailability.ACTIVITY_NAME);
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        com.huawei.hms.api.a.b.a(this.curActivity);
        selfDestroyHandle();
