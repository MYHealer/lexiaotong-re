...
public class HuaweiApiClientImpl extends HuaweiApiClient implements InnerApiClient, ServiceConnection {
    ...
    class c extends IAIDLCallback.Stub {
        ...
        public void call(DataBuffer dataBuffer) {
            if (dataBuffer == null) {
                ...
                this.f3931a.onResult(new BundleResult(-1, null));
                return;
            }
            ...
            this.f3931a.onResult(bundleResult);
        }
    }
    ...
    private class e implements ResultCallback<ResolveResult<ConnectResp>> {
        ...
        class a implements Runnable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ ResolveResult f3933a;

            a(ResolveResult resolveResult) {
                this.f3933a = resolveResult;
            }

            @Override // java.lang.Runnable
            public void run() {
                HuaweiApiClientImpl.this.a((ResolveResult<ConnectResp>) this.f3933a);
            }
        }
    ...
    private class f implements ResultCallback<ResolveResult<DisconnectResp>> {
        ...
        class a implements Runnable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ ResolveResult f3935a;

            a(ResolveResult resolveResult) {
                this.f3935a = resolveResult;
            }

            @Override // java.lang.Runnable
            public void run() {
                HuaweiApiClientImpl.this.b((ResolveResult<DisconnectResp>) this.f3935a);
            }
        }
    ...
    private void i() {
        synchronized (B) {
            ...
            HMSLog.d("HuaweiApiClientImpl", "sendEmptyMessageDelayed for onConnectionResult 3 seconds. the result is : " + this.y.sendEmptyMessageDelayed(3, C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS));
        }
    }
    ...
    public void disableLifeCycleManagement(Activity activity) {
        ...
        AutoLifecycleFragment.getInstance(activity).stopAutoManage(this.f3928a);
    }
