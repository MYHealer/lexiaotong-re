...
final class b extends HuaweiApiAvailability {
    ...
    class a implements BusResponseCallback {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ TaskCompletionSource[] f3939a;

        a(b bVar, TaskCompletionSource[] taskCompletionSourceArr) {
            this.f3939a = taskCompletionSourceArr;
        }
        ...
        public BusResponseResult innerError(Activity activity, int i, String str) {
            ...
            this.f3939a[0].setException(new AvailabilityException());
            return null;
        }
    ...
    /* JADX WARN: Code duplicated, block: B:10:0x0017 A[Catch: AvailabilityException -> 0x000f, TRY_LEAVE, TryCatch #0 {AvailabilityException -> 0x000f, blocks: (B:4:0x000b, B:8:0x0013, B:10:0x0017), top: B:14:0x000b }] */
    /* JADX WARN: Code duplicated, block: B:8:0x0013 A[Catch: AvailabilityException -> 0x000f, TryCatch #0 {AvailabilityException -> 0x000f, blocks: (B:4:0x000b, B:8:0x0013, B:10:0x0017), top: B:14:0x000b }] */
    /* JADX WARN: Instruction removed from duplicated block: B:8:0x0013, please report this as an issue */
    ...
    public Task<Void> getHuaweiServicesReady(Activity activity) {
        ...
        int iIsHuaweiMobileServicesAvailable = isHuaweiMobileServicesAvailable(StubApp.getOrigApplicationContext(activity.getApplicationContext()), 30000000);
    ...
    public Intent getResolveErrorIntent(Activity activity, int i) {
        ...
        if (i == 1 || i == 2) {
            return (Util.isAvailableLibExist(activity) && AvailableUtil.isInstallerLibExist(activity)) ? (Intent) UpdateAdapter.invokeMethod("com.huawei.hms.update.manager.UpdateManager", "getStartUpdateIntent", new Object[]{activity, a(StubApp.getOrigApplicationContext(activity.getApplicationContext()))}) : a(activity, NotInstalledHmsResolution.class.getName());
        }
        if (i == 6) {
    ...
    public Intent a(Context context, int i) {
        ...
        if (i == 1 || i == 2) {
            if (Util.isAvailableLibExist(context) && AvailableUtil.isInstallerLibExist(context)) {
                return (Intent) UpdateAdapter.invokeMethod("com.huawei.hms.update.manager.UpdateManager", "getStartUpdateIntent", new Object[]{context, a(StubApp.getOrigApplicationContext(context.getApplicationContext()))});
            }
    ...
    public Task<Void> checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr) {
        ...
        } else if (huaweiApiCallableArr != null) {
            while (i < r4) {
                a(huaweiApiCallable2);
            }
        }
