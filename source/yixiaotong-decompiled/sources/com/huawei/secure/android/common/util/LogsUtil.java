...
public class LogsUtil {
    ...
    private static final Pattern f4566a = Pattern.compile("[0-9]*[a-z|A-Z]*[一-龥]*");
    ...
    private static class a extends Throwable {
        ...
        public String toString() {
            ...
            String str = name + ": ";
            return this.f4567a.startsWith(str) ? this.f4567a : str + this.f4567a;
        }
    }
    ...
    private static String a(String str) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (f4566a.matcher(String.valueOf(cCharAt)).matches()) {
                if (i % 2 == 0) {
                    cCharAt = '*';
                }
                i++;
