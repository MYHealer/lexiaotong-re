...
public class CipherUtil {
    ...
    private static final String f4515a = "CipherUtil";
    ...
    public static Cipher getAesGcmEncryptCipher(byte[] bArr) {
        ...
        b.a(f4515a, "getEncryptCipher: iv is : " + HexUtil.byteArray2HexStr(bArrGenerateSecureRandom));
    ...
    public static int getContent(Cipher cipher, byte[] bArr, byte[] bArr2) {
        if (cipher == null || bArr == null) {
            b.b(f4515a, "getEncryptCOntent: cipher is null or content is null");
            return -1;
        }
        try {
            return cipher.doFinal(bArr, 0, bArr.length, bArr2);
        } catch (BadPaddingException unused) {
            b.b(f4515a, "getContent: BadPaddingException");
            return -1;
        } catch (IllegalBlockSizeException unused2) {
            b.b(f4515a, "getContent: IllegalBlockSizeException");
            return -1;
        } catch (ShortBufferException unused3) {
            b.b(f4515a, "getContent: ShortBufferException");
            return -1;
        }
    }
    ...
    private static Cipher a(byte[] bArr, byte[] bArr2, int i, String str) {
        if (bArr == null || bArr.length < 16 || bArr2 == null || bArr2.length < 12 || !AesGcm.isBuildVersionHigherThan19()) {
            b.b(f4515a, "gcm encrypt param is not right");
            return null;
        }
        try {
            ...
            b.b(f4515a, "GCM encrypt data error" + e2.getMessage());
            return null;
        }
    }
