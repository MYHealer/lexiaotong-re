...
public class EncodeUtil {
    ...
    private static final String f4562a = "EncodeUtil";
    private static final char[] b = {',', FilenameUtils.EXTENSION_SEPARATOR, '-'};
    ...
    public static String decodeForJavaScript(String str) {
        ...
        try {
            ...
            Log.e(f4562a, "decode js: " + e.getMessage());
            return "";
        }
    }
    ...
    public static String encodeForJavaScript(String str, char[] cArr) {
        ...
        try {
            ...
            Log.e(f4562a, "encode js: " + e.getMessage());
            return "";
        }
    }
