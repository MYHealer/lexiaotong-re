...
public class SecureSSLSocketFactory extends SSLSocketFactory {
    ...
    private SecureSSLSocketFactory(Context context) throws IllegalAccessException, NoSuchAlgorithmException, IOException, KeyManagementException, CertificateException, KeyStoreException {
        this.f4509a = null;
        this.b = context;
        this.f4509a = SSLUtil.setSSLContext();
        this.f4509a.init(null, new X509TrustManager[]{new SecureX509TrustManager(this.b)}, null);
    }
    ...
    public Socket createSocket(String str, int i) throws IOException {
        Socket socketCreateSocket = this.f4509a.getSocketFactory().createSocket(str, i);
    ...
    public Socket createSocket(Socket socket, String str, int i, boolean z) throws IOException {
        Socket socketCreateSocket = this.f4509a.getSocketFactory().createSocket(socket, str, i, z);
        if (socketCreateSocket instanceof SSLSocket) {
            a(socketCreateSocket);
        }
        return socketCreateSocket;
    ...
    public SecureSSLSocketFactory(InputStream inputStream, String str) throws NoSuchAlgorithmException, IOException, KeyManagementException, CertificateException, KeyStoreException {
        this.f4509a = null;
        this.f4509a = SSLUtil.setSSLContext();
        this.f4509a.init(null, new X509TrustManager[]{new HiCloudX509TrustManager(inputStream, str)}, null);
    }
}
