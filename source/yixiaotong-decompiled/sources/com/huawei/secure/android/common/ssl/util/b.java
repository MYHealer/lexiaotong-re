...
public class b {
    ...
    private static final String f4553a = "b";
    ...
    public static X509Certificate a(String str) {
        try {
            ...
            g.b(f4553a, "generateX509FromStr: CertificateException" + e.getMessage());
            return null;
        }
    }
    ...
    public static boolean b(X509Certificate[] x509CertificateArr) {
        ...
        for (X509Certificate x509Certificate : x509CertificateArr) {
            try {
                ...
                e = e;
                g.b(f4553a, "verifyCertificateDate: exception : " + e.getMessage());
                return false;
                ...
                g.b(f4553a, "verifyCertificateDate : exception : " + e3.getMessage());
                return false;
            }
        }
        return true;
        ...
        try {
            ...
            while (it.hasNext()) {
                if (arrayList.contains(it.next().getSerialNumber())) {
                    g.b(f4553a, "verify: certificate revoked");
                    return false;
                }
            }
            return true;
        } catch (Exception e) {
            g.b(f4553a, "verify: revoked verify exception : " + e.getMessage());
            return false;
        }
    }
    ...
    public static boolean a(X509Certificate x509Certificate, String str) {
        ...
        g.b(f4553a, "verify: subject name is error");
        return false;
    }
    ...
    public static boolean a(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        try {
            ...
            g.b(f4553a, "verify: date not right");
            return false;
        } catch (InvalidKeyException e) {
            g.b(f4553a, "verify: publickey InvalidKeyException " + e.getMessage());
            return false;
        } catch (NoSuchAlgorithmException e2) {
            g.b(f4553a, "verify: publickey NoSuchAlgorithmException " + e2.getMessage());
            return false;
        } catch (NoSuchProviderException e3) {
            g.b(f4553a, "verify: publickey NoSuchProviderException " + e3.getMessage());
            return false;
        } catch (SignatureException e4) {
            g.b(f4553a, "verify: publickey SignatureException " + e4.getMessage());
            return false;
        } catch (CertificateException e5) {
            g.b(f4553a, "verify: publickey CertificateException " + e5.getMessage());
            return false;
        } catch (Exception e6) {
            g.b(f4553a, "verify: Exception " + e6.getMessage());
            return false;
        }
    }
        ...
        while (i < x509CertificateArr.length) {
            ...
            if (principal != null) {
                if (issuerDN.equals(principal)) {
                    ...
                    g.b(f4553a, "verify: principalIssuer not match");
                    return false;
                }
            }
            i++;
