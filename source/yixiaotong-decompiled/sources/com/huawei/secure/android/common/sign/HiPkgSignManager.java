...
public class HiPkgSignManager {
    ...
    private static final String f4533a = "HiPkgSignManager";
    ...
    private static PackageInfo a(Context context, String str) {
        try {
            ...
            LogsUtil.e(f4533a, "Exception : " + e.getMessage(), true);
            return null;
        }
    }
    ...
    private static String b(byte[] bArr) {
        try {
            ...
            LogsUtil.e(f4533a, "NoSuchAlgorithmException" + e.getMessage());
            return "";
        }
    }
    ...
    public static byte[] getInstalledAPPSignature(Context context, String str) {
        ...
        if (context == null || TextUtils.isEmpty(str)) {
            LogsUtil.e(f4533a, "packageName is null or context is null");
            return new byte[0];
        }
        try {
            PackageManager packageManager = context.getPackageManager();
            ...
            LogsUtil.e(f4533a, "PackageManager.NameNotFoundException : " + e.getMessage(), true);
        } catch (Exception e2) {
            LogsUtil.e(f4533a, "Exception : " + e2.getMessage(), true);
        }
        return new byte[0];
    }
    ...
    public static String getUnInstalledAPPPackageName(Context context, String str) {
        if (context == null || TextUtils.isEmpty(str)) {
            LogsUtil.e(f4533a, "archiveFilePath is null or context is null");
            return "";
        }
    ...
    public static byte[] getUnInstalledAPPSignature(Context context, String str) {
        ...
        if (packageInfoA != null) {
            ...
            LogsUtil.e(f4533a, "PackageInfo is null ");
        }
        return new byte[0];
    }
