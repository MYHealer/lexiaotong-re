...
public class WebViewSSLCheckThread extends Thread {
    ...
    private SSLSocketFactory f4544a;
    ...
    static class a implements okhttp3.Callback {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ Callback f4545a;
    ...
    public void run() throws Throwable {
                ...
                try {
                    if (!TextUtils.isEmpty(this.f)) {
                        try {
                            ...
                            HttpConnectionParams.setConnectionTimeout(basicHttpParams, KSImageLoader.InnerImageLoadingListener.MAX_DURATION);
                            ...
                            g.c(i, "status code is : " + defaultHttpClient.execute(httpGet).getStatusLine().getStatusCode());
                            f.a((Reader) null);
                            c();
                            return;
                        } catch (Exception e) {
        ...
        if (this.f4544a == null || this.b == null) {
            b();
            return;
        }
        try {
            try {
                ...
                if (uRLConnectionOpenConnection instanceof HttpsURLConnection) {
                    ...
                    try {
                        httpsURLConnection2.setSSLSocketFactory(this.f4544a);
