...
public abstract class HMACSHA256 {
    ...
    private static final String f4517a = "HMACSHA256";
    ...
    public static byte[] hmacEncrypt(byte[] bArr, byte[] bArr2) {
        if (bArr == null || bArr2 == null) {
            b.b(f4517a, "content or key is null.");
            return new byte[0];
        }
        if (bArr2.length < 32) {
            b.b(f4517a, "hmac key length is not right");
            return new byte[0];
        }
        try {
            ...
            b.b(f4517a, "hmacsha256 encrypt exception" + e.getMessage());
            return new byte[0];
        }
    }
