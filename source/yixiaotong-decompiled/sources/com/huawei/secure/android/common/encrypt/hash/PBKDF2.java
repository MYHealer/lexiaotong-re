...
public abstract class PBKDF2 {
    ...
    private static final String f4518a = "PBKDF2";
    ...
    private static byte[] a(char[] cArr, byte[] bArr, int i2, int i3, boolean z) {
        try {
            ...
            b.b(f4518a, "pbkdf exception : " + e2.getMessage());
            return new byte[0];
        }
    }
    ...
    public static String pbkdf2Encrypt(String str, byte[] bArr, int i2, int i3) {
        if (TextUtils.isEmpty(str)) {
            b.b(f4518a, "pwd is null.");
            return "";
        }
        if (i2 < 1000) {
            b.b(f4518a, "iterations times is not enough.");
            return "";
        }
        if (bArr == null || bArr.length < 8) {
            b.b(f4518a, "salt parameter is null or length is not enough");
            return "";
        }
        if (i3 < 32) {
            b.b(f4518a, "cipherLen length is not enough");
            return "";
        }
