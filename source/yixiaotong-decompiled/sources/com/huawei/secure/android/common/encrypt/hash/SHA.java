...
public final class SHA {
    ...
    private static final String f4519a = "SHA";
    ...
    public static String shaEncrypt(String str, String str2) {
        ...
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2)) {
            b.b(f4519a, "content or algorithm is null.");
            return "";
        }
        if (!a(str2)) {
            b.b(f4519a, "algorithm is not safe or legal");
            return "";
        }
        try {
            ...
            bytes = new byte[0];
            b.b(f4519a, "Error in generate SHA UnsupportedEncodingException");
        }
    ...
    public static byte[] shaEncryptByte(byte[] bArr, String str) {
        ...
        try {
            ...
            b.b(f4519a, "Error in generate SHA NoSuchAlgorithmException");
            return new byte[0];
        }
    }
