...
public class SSFCompatiableSystemCA extends SSLSocketFactory {
    ...
    private SSFCompatiableSystemCA(Context context) throws NoSuchAlgorithmException, IOException, CertificateException, KeyStoreException, KeyManagementException {
        ...
        this.f4535a.init(null, new X509TrustManager[]{sSFSecureX509SingleInstance}, null);
    }
    ...
    public Socket createSocket(String str, int i2) throws IOException {
        ...
        Socket socketCreateSocket = this.f4535a.getSocketFactory().createSocket(str, i2);
    ...
    public Socket createSocket(Socket socket, String str, int i2, boolean z) throws IOException {
        ...
        Socket socketCreateSocket = this.f4535a.getSocketFactory().createSocket(socket, str, i2, z);
        if (socketCreateSocket instanceof SSLSocket) {
            a(socketCreateSocket);
            SSLSocket sSLSocket = (SSLSocket) socketCreateSocket;
            this.b = sSLSocket;
    ...
    public SSFCompatiableSystemCA(X509TrustManager x509TrustManager) throws NoSuchAlgorithmException, KeyManagementException, IllegalArgumentException {
        this.f4535a = null;
        this.b = null;
        this.f4535a = SSLUtil.setSSLContext();
        setX509TrustManager(x509TrustManager);
        this.f4535a.init(null, new X509TrustManager[]{x509TrustManager}, null);
    }
}
