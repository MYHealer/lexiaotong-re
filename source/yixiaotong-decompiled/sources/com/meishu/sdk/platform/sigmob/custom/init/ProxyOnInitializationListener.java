...
public class ProxyOnInitializationListener implements InvocationHandler {
    private final SigmobCustomInitManager.InitCallback callback;

    public ProxyOnInitializationListener(SigmobCustomInitManager.InitCallback initCallback) {
    ...
    public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
        try {
            ...
            if ("onInitializationSuccess".equals(name)) {
            ...
            if (!"onInitializationFail".equals(name)) {
                return null;
            }
            String str = "";
            try {
