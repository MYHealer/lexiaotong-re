...
public class OPPOTemplateRecyclerAd extends a implements RecyclerAdData {
    private INativeTempletAdView nativeTemplateAdView;
    private RecylcerAdInteractionListener recylcerAdInteractionListener;

    public OPPOTemplateRecyclerAd(INativeTempletAdView iNativeTempletAdView) {
        super(null, BaseConstants.ROM_OPPO_UPPER_CONSTANT);
        this.nativeTemplateAdView = iNativeTempletAdView;
    }
    ...
    public INativeTempletAdView getNativeTemplateAdView() {
        return this.nativeTemplateAdView;
    }
    ...
    @Override // com.meishu.sdk.core.ad.recycler.RecyclerAdData
    public void destroy() {
        INativeTempletAdView iNativeTempletAdView = this.nativeTemplateAdView;
