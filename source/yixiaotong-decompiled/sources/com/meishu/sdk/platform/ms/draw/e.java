...
public class e extends o {
    ...
    public final /* synthetic */ com.meishu.sdk.meishu_ad.nativ.b f5167a;
    ...
    public void safeOnClick(View view) {
        ...
        if (gVar.c) {
            ...
            this.f5167a.setInteractionListener(f.this.f5168a.e.getInteractionListener());
            this.f5167a.a().setClkActType(1);
            com.meishu.sdk.core.utils.f.a((com.meishu.sdk.platform.ms.c) this.f5167a, true);
        }
    }
}
