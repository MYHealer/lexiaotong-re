...
public class l extends com.meishu.sdk.core.safe.o {
    ...
    public final /* synthetic */ com.meishu.sdk.meishu_ad.splash.a f5032a;
    public final /* synthetic */ com.meishu.sdk.meishu_ad.splash.c b;
    public final /* synthetic */ SplashSkipView c;
    public final /* synthetic */ v d;

    public l(v vVar, com.meishu.sdk.meishu_ad.splash.a aVar, com.meishu.sdk.meishu_ad.splash.c cVar, SplashSkipView splashSkipView) {
        this.d = vVar;
        this.f5032a = aVar;
        this.b = cVar;
    ...
    public void safeOnClick(View view) {
        try {
            if (((com.meishu.sdk.platform.ms.splash.g) this.f5032a).e) {
                if (this.b.getInteractionListener() != null && this.b.b.getCbc() == 0) {
                    this.b.getInteractionListener().onAdClicked();
                }
                com.meishu.sdk.meishu_ad.splash.a aVar = this.f5032a;
                if (aVar != null) {
