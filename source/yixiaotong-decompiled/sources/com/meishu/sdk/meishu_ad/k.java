...
public class k extends com.meishu.sdk.core.safe.o {
    ...
    public final /* synthetic */ com.meishu.sdk.meishu_ad.splash.a f5030a;
    ...
    public void safeOnClick(View view) {
        try {
            if (((com.meishu.sdk.platform.ms.splash.g) this.f5030a).e) {
                if (this.b.getInteractionListener() != null && this.b.b.getCbc() == 0) {
                    this.b.getInteractionListener().onAdClicked();
                }
                com.meishu.sdk.meishu_ad.splash.a aVar = this.f5030a;
                if (aVar != null) {
