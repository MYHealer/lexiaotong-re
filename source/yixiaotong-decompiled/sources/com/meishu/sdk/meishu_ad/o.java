...
public class o extends com.meishu.sdk.core.safe.o {
    ...
    public final /* synthetic */ com.meishu.sdk.meishu_ad.splash.a f5060a;
    ...
    public void safeOnClick(View view) {
        com.meishu.sdk.meishu_ad.splash.a aVar = this.f5060a;
        if (aVar == null || !((com.meishu.sdk.platform.ms.splash.g) aVar).e) {
            return;
        }
        if (this.b.getInteractionListener() != null && this.b.b.getCbc() == 0) {
            this.b.getInteractionListener().onAdClicked();
        }
        com.meishu.sdk.meishu_ad.splash.a aVar2 = this.f5060a;
        if (aVar2 != null) {
            ((com.meishu.sdk.platform.ms.splash.g) aVar2).h = true;
        }
