...
public class h implements SwipeView.OnSwipeListener {
    ...
    public final /* synthetic */ com.meishu.sdk.meishu_ad.splash.a f5016a;
    ...
    public void onSwipe() {
        try {
            if (((com.meishu.sdk.platform.ms.splash.g) this.f5016a).e) {
                if (this.b.getInteractionListener() != null) {
                    this.b.getInteractionListener().onAdClicked();
                }
                com.meishu.sdk.meishu_ad.splash.a aVar = this.f5016a;
                if (aVar != null) {
