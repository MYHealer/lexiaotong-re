...
import com.meishu.sdk.platform.ms.draw.g;
import java.util.HashMap;

/* JADX INFO: loaded from: C:\Users\MR\AppData\Local\Temp\yixiaotong-dex\6393804.dex */
public class DrawAdLoader extends com.meishu.sdk.core.loader.c<a> {
    private static final String TAG = "DrawAdLoader";
    private b drawAdListenerAdapter;

    public DrawAdLoader(Context context, MsAdSlot msAdSlot, DrawAdEventListener drawAdEventListener) {
        if (msAdSlot == null) {
        ...
        this.drawAdListenerAdapter = new b(this, drawAdEventListener);
        init(context, msAdSlot.getPid(), this.drawAdListenerAdapter);
    }

    @Override // com.meishu.sdk.core.loader.c
    public d createDelegate(SdkAdInfo sdkAdInfo, MeishuAdInfo meishuAdInfo) {
        if (sdkAdInfo != null) {
            return !TextUtils.isEmpty(sdkAdInfo.getCls()) ? com.meishu.sdk.core.a.a("CUSTOM").drawLoader(this, sdkAdInfo, meishuAdInfo) : com.meishu.sdk.core.a.a(sdkAdInfo.getSdk()).drawLoader(this, sdkAdInfo, meishuAdInfo);
        }
        return null;
    }
    ...
    public void clearErrorState() {
        b bVar = this.drawAdListenerAdapter;
        if (bVar != null) {
            bVar.b = false;
            bVar.c = false;
        }
