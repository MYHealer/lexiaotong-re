...
public class RoundImageView extends GifImageView {
    ...
    public void setBorderWidth(int i) {
        this.borderWidth = (int) m.a(this.context, i);
        calculateRadiiAndRectF(false);
    }

    public void setCornerBottomLeftRadius(int i) {
        this.cornerBottomLeftRadius = (int) m.a(this.context, i);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomRightRadius(int i) {
        this.cornerBottomRightRadius = (int) m.a(this.context, i);
        calculateRadiiAndRectF(true);
    }

    public void setCornerRadius(int i) {
        this.cornerRadius = (int) m.a(this.context, i);
        calculateRadiiAndRectF(false);
    }

    public void setCornerTopLeftRadius(int i) {
        this.cornerTopLeftRadius = (int) m.a(this.context, i);
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopRightRadius(int i) {
        this.cornerTopRightRadius = (int) m.a(this.context, i);
        calculateRadiiAndRectF(true);
    }

    public void setInnerBorderWidth(int i) {
        this.innerBorderWidth = (int) m.a(this.context, i);
