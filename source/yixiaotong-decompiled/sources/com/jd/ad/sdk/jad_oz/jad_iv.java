...
public final class jad_iv {
    ...
    public jad_iv(jad_an jad_anVar) {
        ...
        this.jad_dq = i;
        int iJad_an = jad_an(jad_anVar.jad_bo, 0.4f, 0.33f);
        float fJad_an = ((jad_bo) jad_anVar.jad_cp).jad_an() * ((jad_bo) jad_anVar.jad_cp).jad_bo() * 4;
        int iRound = Math.round(jad_anVar.jad_dq * fJad_an);
        int iRound2 = Math.round(fJad_an * 2.0f);
        int i2 = iJad_an - i;
        ...
        if (Log.isLoggable("MemorySizeCalculator", 3)) {
            ...
            objArr[0] = jad_ly.jad_an("Calculation complete, Calculated memory cache size: ").append(jad_an(this.jad_bo)).append(", pool size: ").append(jad_an(this.jad_an)).append(", byte array size: ").append(jad_an(i)).append(", memory class limited? ").append(i3 > iJad_an).append(", max size: ").append(jad_an(iJad_an)).append(", memoryClass: ").append(jad_anVar.jad_bo.getMemoryClass()).append(", isLowMemoryDevice: ").append(jad_an(jad_anVar.jad_bo)).toString();
            Logger.d("MemorySizeCalculator", objArr);
        }
    }
