...
public class jad_jt {
    ...
    public jad_jt(com.jd.ad.sdk.jad_gr.jad_cp jad_cpVar, com.jd.ad.sdk.jad_it.jad_an jad_anVar, int i, int i2, jad_na<Bitmap> jad_naVar, Bitmap bitmap) {
    ...
    public static com.jd.ad.sdk.jad_gr.jad_iv<Bitmap> jad_an(com.jd.ad.sdk.jad_gr.jad_jw jad_jwVar, int i, int i2) {
        return jad_jwVar.jad_er().jad_bo(new com.jd.ad.sdk.jad_en.jad_hu().jad_an(jad_ly.jad_an).jad_bo(true).jad_an(true).jad_bo(i, i2));
    }
    ...
    public final void jad_an() {
        ...
        this.jad_jt = true;
        long jUptimeMillis = SystemClock.uptimeMillis() + ((long) this.jad_an.jad_dq());
        this.jad_an.jad_jt();
        this.jad_kx = new jad_an(this.jad_bo, this.jad_an.jad_an(), jUptimeMillis);
        this.jad_hu.jad_bo(new com.jd.ad.sdk.jad_en.jad_hu().jad_an(new com.jd.ad.sdk.jad_hq.jad_bo(Double.valueOf(Math.random())))).jad_an(this.jad_an).jad_an(this.jad_kx);
    }
