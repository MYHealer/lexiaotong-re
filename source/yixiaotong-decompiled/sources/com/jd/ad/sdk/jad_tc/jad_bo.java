...
public class jad_bo extends com.jd.ad.sdk.jad_tc.jad_an {
    ...
    public jad_bo(jad_mz jad_mzVar, jad_er jad_erVar, List<jad_er> list, com.jd.ad.sdk.jad_lu.jad_jt jad_jtVar) {
        ...
        com.jd.ad.sdk.jad_ra.jad_bo jad_boVarJad_kx = jad_erVar.jad_kx();
        if (jad_boVarJad_kx != null) {
            com.jd.ad.sdk.jad_ox.jad_an<Float, Float> jad_anVarJad_an = jad_boVarJad_kx.jad_an();
            this.jad_do = jad_anVarJad_an;
        ...
        while (true) {
            ...
            com.jd.ad.sdk.jad_tc.jad_an jad_anVarJad_an2 = com.jd.ad.sdk.jad_tc.jad_an.jad_an(this, jad_erVar2, jad_mzVar, jad_jtVar);
            if (jad_anVarJad_an2 != null) {
                longSparseArray.put(jad_anVarJad_an2.jad_jt().jad_bo(), jad_anVarJad_an2);
                if (jad_anVar2 != null) {
                    jad_anVar2.jad_an(jad_anVarJad_an2);
                    jad_anVar2 = null;
                } else {
                    this.jad_ep.add(0, jad_anVarJad_an2);
                    int i2 = jad_an.jad_an[com.jd.ad.sdk.jad_jt.jad_fs.jad_an(jad_erVar2.jad_dq())];
                    if (i2 == 1 || i2 == 2) {
                        jad_anVar2 = jad_anVarJad_an2;
                    }
                }
            }
            size--;
    ...
    public void jad_bo(Canvas canvas, Matrix matrix, int i) {
        ...
        for (int size = this.jad_ep.size() - 1; size >= 0; size--) {
            if (this.jad_gr.isEmpty() || canvas.clipRect(this.jad_gr)) {
