...
public class jad_hu extends jad_an {
    ...
    public void jad_bo(Canvas canvas, Matrix matrix, int i) {
        int iAlpha = Color.alpha(this.jad_hs.jad_ly);
        if (iAlpha == 0) {
            return;
        }
        com.jd.ad.sdk.jad_ox.jad_an<Integer, Integer> jad_anVar = this.jad_vi.jad_jw;
        int iIntValue = (int) ((((iAlpha / 255.0f) * (jad_anVar == null ? 100 : jad_anVar.jad_fs().intValue())) / 100.0f) * (i / 255.0f) * 255.0f);
        this.jad_ep.setAlpha(iIntValue);
        com.jd.ad.sdk.jad_ox.jad_an<ColorFilter, ColorFilter> jad_anVar2 = this.jad_it;
        if (jad_anVar2 != null) {
