...
public class jad_jt implements jad_er, com.jd.ad.sdk.jad_ox.jad_an.InterfaceC0570jad_an, jad_kx {
    ...
    public jad_jt(com.jd.ad.sdk.jad_lu.jad_mz jad_mzVar, com.jd.ad.sdk.jad_tc.jad_an jad_anVar, com.jd.ad.sdk.jad_sb.jad_ob jad_obVar) {
        ...
        com.jd.ad.sdk.jad_ox.jad_an<Integer, Integer> jad_anVarJad_an2 = jad_obVar.jad_an().jad_an();
        this.jad_jt = jad_anVarJad_an2;
        jad_anVarJad_an2.jad_an(this);
        jad_anVar.jad_an(jad_anVarJad_an2);
        com.jd.ad.sdk.jad_ox.jad_an<Integer, Integer> jad_anVarJad_an3 = jad_obVar.jad_dq().jad_an();
    ...
    public void jad_an(Canvas canvas, Matrix matrix, int i) {
        ...
        int iIntValue = (int) ((((i / 255.0f) * this.jad_hu.jad_fs().intValue()) / 100.0f) * 255.0f);
        Paint paint2 = this.jad_bo;
        PointF pointF = com.jd.ad.sdk.jad_xg.jad_jt.jad_an;
        paint2.setAlpha(Math.max(0, Math.min(255, iIntValue)));
        ...
        if (jad_anVar2 != null) {
            ...
            } else if (fFloatValue != this.jad_ly) {
                this.jad_bo.setMaskFilter(this.jad_cp.jad_an(fFloatValue));
            }
            this.jad_ly = fFloatValue;
        }
