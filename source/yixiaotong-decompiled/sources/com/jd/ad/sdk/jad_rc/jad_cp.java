...
public class jad_cp implements jad_na<Uri, InputStream> {
    ...
    public jad_na.jad_an<InputStream> jad_an(Uri uri, int i, int i2, jad_jw jad_jwVar) {
        Long l;
        Uri uri2 = uri;
        if (!com.jd.ad.sdk.jad_lw.jad_bo.jad_an(i, i2) || (l = (Long) jad_jwVar.jad_an(jad_xk.jad_dq)) == null || l.longValue() != -1) {
            return null;
        }
        com.jd.ad.sdk.jad_hq.jad_bo jad_boVar = new com.jd.ad.sdk.jad_hq.jad_bo(uri2);
        Context context = this.jad_an;
        return new jad_na.jad_an<>(jad_boVar, Collections.emptyList(), com.jd.ad.sdk.jad_lw.jad_cp.jad_an(context, uri2, new com.jd.ad.sdk.jad_lw.jad_cp.jad_bo(context.getContentResolver())));
    }
