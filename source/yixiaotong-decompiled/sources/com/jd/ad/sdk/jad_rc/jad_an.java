...
public class jad_an implements jad_na<jad_jt, InputStream> {
    ...
    /* JADX INFO: renamed from: com.jd.ad.sdk.jad_rc.jad_an$jad_an, reason: collision with other inner class name */
    public static class C0580jad_an implements jad_ob<jad_jt, InputStream> {
    ...
    public jad_an(jad_mz<jad_jt, jad_jt> jad_mzVar) {
        this.jad_an = jad_mzVar;
    }

    @Override // com.jd.ad.sdk.jad_qb.jad_na
    public /* bridge */ /* synthetic */ boolean jad_an(jad_jt jad_jtVar) {
        return true;
    }

    @Override // com.jd.ad.sdk.jad_qb.jad_na
    public jad_na.jad_an<InputStream> jad_an(jad_jt jad_jtVar, int i, int i2, jad_jw jad_jwVar) {
        jad_jt jad_jtVar2 = jad_jtVar;
        jad_mz<jad_jt, jad_jt> jad_mzVar = this.jad_an;
        if (jad_mzVar != null) {
            jad_mz.jad_bo<jad_jt> jad_boVarJad_an = jad_mz.jad_bo.jad_an(jad_jtVar2, 0, 0);
            jad_jt jad_jtVarJad_an = jad_mzVar.jad_an.jad_an(jad_boVarJad_an);
            Queue<jad_mz.jad_bo<?>> queue = jad_mz.jad_bo.jad_dq;
            synchronized (queue) {
                ((ArrayDeque) queue).offer(jad_boVarJad_an);
            }
            jad_jt jad_jtVar3 = jad_jtVarJad_an;
            if (jad_jtVar3 == null) {
