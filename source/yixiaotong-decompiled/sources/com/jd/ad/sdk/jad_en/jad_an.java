...
public abstract class jad_an<T extends jad_an<T>> implements Cloneable {
    ...
    @Override // 
    /* JADX INFO: renamed from: jad_an, reason: merged with bridge method [inline-methods] */
    public T clone() {
        try {
            T t = (T) super.clone();
    ...
    public T jad_an(jad_an<?> jad_anVar) {
        if (this.jad_vi) {
    ...
    public T jad_an(jad_na<Bitmap> jad_naVar, boolean z) {
        if (this.jad_vi) {
            return (T) clone().jad_an(jad_naVar, z);
        }
        com.jd.ad.sdk.jad_te.jad_ly jad_lyVar = new com.jd.ad.sdk.jad_te.jad_ly(jad_naVar, z);
        jad_an(Bitmap.class, jad_naVar, z);
        jad_an(Drawable.class, jad_lyVar, z);
        jad_an(BitmapDrawable.class, jad_lyVar, z);
    ...
    public T jad_an(jad_ly jad_lyVar) {
        if (this.jad_vi) {
    ...
    public T jad_an(com.jd.ad.sdk.jad_gr.jad_jt jad_jtVar) {
        if (this.jad_vi) {
    ...
    public T jad_an(com.jd.ad.sdk.jad_ju.jad_hu jad_huVar) {
        if (this.jad_vi) {
    ...
    public <Y> T jad_an(Class<Y> cls, jad_na<Y> jad_naVar, boolean z) {
        if (this.jad_vi) {
