...
public final class jad_bo implements jad_fs, jad_dq {
    ...
    public jad_bo(Object obj, jad_fs jad_fsVar) {
        this.jad_an = obj;
    ...
    public boolean jad_an(jad_dq jad_dqVar) {
        ...
        synchronized (this.jad_an) {
            ...
            z = (jad_fsVar == null || jad_fsVar.jad_an(this)) && jad_jt(jad_dqVar);
        }
        return z;
    }
    ...
    public boolean jad_bo(jad_dq jad_dqVar) {
        ...
        synchronized (this.jad_an) {
            jad_fs jad_fsVar = this.jad_bo;
            z = (jad_fsVar == null || jad_fsVar.jad_bo(this)) && jad_jt(jad_dqVar);
        }
        return z;
    }
    ...
    public boolean jad_cp(jad_dq jad_dqVar) {
        ...
        synchronized (this.jad_an) {
            jad_fs jad_fsVar = this.jad_bo;
            z = (jad_fsVar == null || jad_fsVar.jad_cp(this)) && jad_jt(jad_dqVar);
        }
        return z;
    }
