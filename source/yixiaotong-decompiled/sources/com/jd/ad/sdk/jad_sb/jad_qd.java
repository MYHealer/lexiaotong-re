...
public class jad_qd implements jad_cp {
    ...
    public jad_qd(String str, int i, com.jd.ad.sdk.jad_ra.jad_hu jad_huVar, boolean z) {
        this.jad_an = str;
        this.jad_bo = i;
    ...
    public String toString() {
        return jad_zm.jad_an("ShapePath{name=").append(this.jad_an).append(", index=").append(this.jad_bo).append('}').toString();
    }
}
