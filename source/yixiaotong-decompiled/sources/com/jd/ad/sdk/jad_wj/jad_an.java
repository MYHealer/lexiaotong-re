...
/* JADX INFO: compiled from: JADCoreError.java */
/* JADX INFO: loaded from: C:\Users\MR\AppData\Local\Temp\yixiaotong-dex\6253208.dex */
public enum jad_an {
    CRASH_ERROR(-100, "error"),
    CACHE_EXEC_SQL_ERROR(11001, "exec sql error"),
    ...
    UTILS_INVALID_MCC_MNC_ERROR(12002, "invalid mcc and mnc value"),
    ...
    AN_REQUEST_JSON_ERROR(ErrorCode.AD_SLOT_NONE, "an request json error"),
    AN_RESULT_BODY_NULL_ERROR(ErrorCode.AD_SLOT_ID_EMPTY, "an response body is null"),
    AN_RESPONSE_BODY_CONTENT_NULL_ERROR(ErrorCode.RESPONSE_DATA_EMPTY, "an response data is null"),
    AN_RESPONSE_DATA_IO_ERROR(ErrorCode.RESPONSE_FAIL, "an response read data io error"),
    AN_RESPONSE_DATA_DES_ERROR(ErrorCode.AD_MEDIA_DISABLE, "an response data decrypt error"),
    AN_RESPONSE_JSON_PARSER_ERROR(ErrorCode.AD_APP_KEY_EMPTY, "an response json parse error"),
    AN_RESPONSE_DATA_PROCESS_ERROR(ErrorCode.HI_AD_VIEW_ADD_TIME_OUT, "an response data error"),
    AN_RESPONSE_DATA_PROCESS_OTHER_ERROR(ErrorCode.HI_AD_TYPE_MISMATCH, "an response data other error"),
    GW_REQUEST_REGISTER_AD_SERVICE_ERROR(ErrorCode.AD_ADAPTER_IS_NULL, "ad load failed"),
    GW_REQUEST_URL_IS_NULL_ERROR(ErrorCode.AD_RENDER_FAIL, "url is null"),
    GW_REQUEST_SLOT_ID_IS_NULL_ERROR(ErrorCode.AD_CREATE_ADAPTER_ERROR, "slot id is null"),
    ...
    GW_REQUEST_PRELOAD_AD_DARA_CACHE_ERROR(31020, "request preload cache data failed"),
