...
public class jad_cp implements jad_fs, com.jd.ad.sdk.jad_kv.jad_dq.jad_an<Object> {
    ...
    public boolean jad_an() {
        while (true) {
            ...
            File fileJad_an = jad_jtVar2.jad_bo().jad_an(new jad_dq(jad_huVar, jad_jtVar2.jad_na));
