...
public class jad_er extends jad_jt<com.jd.ad.sdk.jad_sb.jad_dq> {
    ...
    public jad_er(List<com.jd.ad.sdk.jad_yh.jad_an<com.jd.ad.sdk.jad_sb.jad_dq>> list) {
        ...
        int iJad_an = jad_dqVar != null ? jad_dqVar.jad_an() : 0;
        this.jad_iv = new com.jd.ad.sdk.jad_sb.jad_dq(new float[iJad_an], new int[iJad_an]);
    }
    ...
    public Object jad_an(com.jd.ad.sdk.jad_yh.jad_an jad_anVar, float f) {
        ...
        if (jad_dqVar2.jad_bo.length != jad_dqVar3.jad_bo.length) {
            throw new IllegalArgumentException(jad_zm.jad_an("Cannot interpolate between gradients. Lengths vary (").append(jad_dqVar2.jad_bo.length).append(" vs ").append(jad_dqVar3.jad_bo.length).append(")").toString());
        }
