...
public class jad_mz extends jad_an<com.jd.ad.sdk.jad_sb.jad_na, Path> {
    ...
    public Path jad_an(com.jd.ad.sdk.jad_yh.jad_an<com.jd.ad.sdk.jad_sb.jad_na> jad_anVar, float f) {
        ...
        if (jad_naVar.jad_an.size() != jad_naVar2.jad_an.size()) {
            com.jd.ad.sdk.jad_xg.jad_dq.jad_an(jad_zm.jad_an("Curves must have the same number of control points. Shape 1: ").append(jad_naVar.jad_an.size()).append("\tShape 2: ").append(jad_naVar2.jad_an.size()).toString());
        }
        int iMin = Math.min(jad_naVar.jad_an.size(), jad_naVar2.jad_an.size());
        if (jad_naVar3.jad_an.size() < iMin) {
            for (int size = jad_naVar3.jad_an.size(); size < iMin; size++) {
                jad_naVar3.jad_an.add(new com.jd.ad.sdk.jad_qz.jad_an());
            }
        } else if (jad_naVar3.jad_an.size() > iMin) {
            for (int size2 = jad_naVar3.jad_an.size() - 1; size2 >= iMin; size2--) {
        ...
        float fJad_an = com.jd.ad.sdk.jad_xg.jad_jt.jad_an(pointF.x, pointF2.x, f);
        float fJad_an2 = com.jd.ad.sdk.jad_xg.jad_jt.jad_an(pointF.y, pointF2.y, f);
        if (jad_naVar3.jad_bo == null) {
            jad_naVar3.jad_bo = new PointF();
        }
        jad_naVar3.jad_bo.set(fJad_an, fJad_an2);
