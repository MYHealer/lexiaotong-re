...
public class jad_bo extends jad_jt<Integer> {
    public jad_bo(List<com.jd.ad.sdk.jad_yh.jad_an<Integer>> list) {
        super(list);
    }
    ...
    public int jad_bo(com.jd.ad.sdk.jad_yh.jad_an<Integer> jad_anVar, float f) {
        ...
        return com.jd.ad.sdk.jad_xg.jad_bo.jad_an(Math.max(0.0f, Math.min(1.0f, f)), jad_anVar.jad_bo.intValue(), jad_anVar.jad_cp.intValue());
    }
}
