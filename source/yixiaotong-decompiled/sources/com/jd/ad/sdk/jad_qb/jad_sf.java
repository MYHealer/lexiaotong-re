...
public class jad_sf<Data> implements jad_na<Integer, Data> {
    ...
    public jad_na.jad_an jad_an(Integer num, int i, int i2, com.jd.ad.sdk.jad_ju.jad_jw jad_jwVar) {
        Uri uri;
        Integer num2 = num;
        try {
            ...
            if (Log.isLoggable("ResourceLoader", 5)) {
                Logger.w("ResourceLoader", "Received invalid resource id: " + num2, e);
            }
            uri = null;
        }
        if (uri == null) {
    ...
    @Override // com.jd.ad.sdk.jad_qb.jad_na
    public /* bridge */ /* synthetic */ boolean jad_an(Integer num) {
        return true;
    }
}
