...
public class TKPerformMsg extends BaseOfflineCompoJsonParse<TKPerformMsg> implements Serializable {
    ...
    public void parseJson(TKPerformMsg tKPerformMsg, JSONObject jSONObject) {
        ...
        tKPerformMsg.source = jSONObject.optInt(ba.at);
        ...
        tKPerformMsg.templateId = jSONObject.optString(a.W0);
        if (jSONObject.opt(a.W0) == JSONObject.NULL) {
        ...
        tKPerformMsg.loadTime = jSONObject.optLong(d.b);
        tKPerformMsg.initTime = jSONObject.optLong(d.f1799a);
        tKPerformMsg.tkPublishType = jSONObject.optInt("tk_publish_type");
        tKPerformMsg.renderType = jSONObject.optInt(a.S0);
    ...
    public JSONObject toJson(TKPerformMsg tKPerformMsg, JSONObject jSONObject) {
        ...
        if (i != 0) {
            JsonHelper.putValue(jSONObject, ba.at, i);
        }
        ...
        if (str3 != null && !str3.equals("")) {
            JsonHelper.putValue(jSONObject, a.W0, tKPerformMsg.templateId);
        }
        ...
        if (j2 != 0) {
            JsonHelper.putValue(jSONObject, d.b, j2);
        }
        long j3 = tKPerformMsg.initTime;
        if (j3 != 0) {
            JsonHelper.putValue(jSONObject, d.f1799a, j3);
        }
        ...
        if (i3 != 0) {
            JsonHelper.putValue(jSONObject, a.S0, i3);
        }
