...
public final class NativeAdMonitor {
    private static void c(a aVar) {
        try {
            c.d(d.In().m983do(ILoggerReporter.Category.APM_LOG).g(0.01d).Q("ad_sdk_native_container_monitor", "state").b(BusinessType.AD_NATIVE).A(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.buA));
        } catch (Exception e) {
