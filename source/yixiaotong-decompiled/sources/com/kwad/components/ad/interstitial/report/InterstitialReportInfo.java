...
public class InterstitialReportInfo extends com.kwad.sdk.commercial.c.a implements Serializable {
    ...
    public InterstitialReportInfo() {
        ...
        ac.putValue(jSONObject, "interstitialAdLoadProcessChange", e.Jr());
        ac.putValue(jSONObject, "videoCacheOptType", e.KA());
        ac.putValue(jSONObject, "okHttpSupport", isOkHttpSupported());
        ac.putValue(jSONObject, "insertConfigShowPercent", e.Jx());
    ...
    public InterstitialReportInfo(AdTemplate adTemplate) {
        ...
        ac.putValue(jSONObject, "videoCacheOptType", e.KA());
        ac.putValue(jSONObject, "okHttpSupport", isOkHttpSupported());
        ac.putValue(jSONObject, "downloadStatus", adTemplate.getDownloadStatus());
        ac.putValue(jSONObject, "insertConfigShowPercent", e.Jx());
        this.abParams = jSONObject.toString();
    }
