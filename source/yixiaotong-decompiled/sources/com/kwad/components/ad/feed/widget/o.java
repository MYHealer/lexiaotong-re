...
public final class o extends a implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    private void ct() {
        ...
        com.kwad.sdk.c.a.a.a(this, this.hW, this.iQ, this.ie);
    ...
    private void d(View view, final int i) {
        if (view == this.hY) {
            ...
            com.kwad.components.core.e.d.a.a(new com.kwad.components.core.e.d.a.C0661a(getContext()).aL(5).aM(i).aJ(this.mAdTemplate).b(this.mApkDownloadHelper).aN(view == this.ie ? 1 : 2).as(view == this.ie).a(new com.kwad.components.core.e.d.a.b() { // from class: com.kwad.components.ad.feed.widget.o.1
