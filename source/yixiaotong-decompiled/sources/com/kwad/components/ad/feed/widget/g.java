...
public final class g extends c {
    ...
    public g(Context context) {
        super(context);
        this.iq = new com.kwad.components.core.video.a.InterfaceC0691a() { // from class: com.kwad.components.ad.feed.widget.g.1
            ...
            public final void a(int i, al.a aVar) {
                ...
                g.this.cp();
                com.kwad.components.core.e.d.a.a(new com.kwad.components.core.e.d.a.C0661a(g.this.getContext()).aJ(g.this.mAdTemplate).b(g.this.mApkDownloadHelper).aN(i3).as(z).au(true).aL(5).aM(i2).d(aVar).aw(true).a(new com.kwad.components.core.e.d.a.b() { // from class: com.kwad.components.ad.feed.widget.g.1.1
