...
public final class a extends d<c> implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    public a(Context context, AdTemplate adTemplate, InterfaceC0592a interfaceC0592a) {
        super(context);
    ...
    public final void a(ViewGroup viewGroup) {
        ...
        if (TextUtils.isEmpty(com.kwad.sdk.core.response.helper.a.M(this.mAdInfo)) && TextUtils.isEmpty(com.kwad.sdk.core.response.helper.a.ba(this.mAdInfo).materialUrl)) {
            ...
            if (!TextUtils.isEmpty(materialFeatureBa.materialUrl)) {
                ...
                if (i2 > 0 && i2 < i3) {
                    this.f4748cz.setScaleType(ImageView.ScaleType.CENTER_CROP);
                    KSImageLoader.loadImage(this.f4748cz, com.kwad.sdk.core.response.helper.a.Q(this.mAdInfo), this.mAdTemplate, new DisplayImageOptionsCompat.Builder().setBlurRadius(50).build(), new SimpleImageLoadingListener() { // from class: com.kwad.components.ad.c.b.a.5
                        @Override // com.kwad.sdk.core.imageloader.core.listener.SimpleImageLoadingListener, com.kwad.sdk.core.imageloader.core.listener.ImageLoadingListener
                        public final boolean onDecode(String str, InputStream inputStream, DecodedResult decodedResult) {
                            decodedResult.mBitmap = BlurUtils.stackBlur(BitmapFactory.decodeStream(inputStream), 50, false);
                            return true;
    ...
    public final void a(KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        com.kwad.sdk.core.video.videoview.a.InterfaceC0750a interfaceC0750a = new com.kwad.sdk.core.video.videoview.a.InterfaceC0750a() { // from class: com.kwad.components.ad.c.b.a.6
    ...
    private static Presenter ap() {
        ...
        presenter.a(new com.kwad.components.ad.c.d.b());
        return presenter;
    }
    ...
    public final void onClick(View view) {
        if (view == this.cw || view == this.cx || view == this.cB || view == this.f4748cz) {
