...
public final class a {
    ...
    private static void a(AdTemplate adTemplate, boolean z, com.kwad.sdk.commercial.c.a aVar) {
        ...
        c.d(d.In().m983do(z ? ILoggerReporter.Category.ERROR_LOG : ILoggerReporter.Category.APM_LOG).g(z ? 1.0d : 0.01d).b(e.bA(adTemplate)).Q("ad_sdk_deeplink_performance", "status").A(aVar));
    }

    public static void o(AdTemplate adTemplate, String str) {
        try {
            a(adTemplate, b.It().dB(1).dA(str));
        } catch (Throwable th) {
    ...
    public static void d(AdTemplate adTemplate, String str, String str2) {
        try {
            a(adTemplate, true, b.It().dB(6).dA(str).setErrorCode(ErrorCode.d.hnadsk).setErrorMsg(str2));
        } catch (Throwable th) {
            ServiceProvider.reportSdkCaughtException(th);
        }
    }
