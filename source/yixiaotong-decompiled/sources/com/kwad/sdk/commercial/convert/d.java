...
public final class d {
    private static void B(final com.kwad.sdk.commercial.c.a aVar) {
        GlobalThreadPools.Oi().execute(new bi() { // from class: com.kwad.sdk.commercial.convert.d.1
            @Override // com.kwad.sdk.utils.bi
            public final void doTask() {
                try {
                    com.kwad.sdk.commercial.c.d(com.kwad.sdk.commercial.d.In().m983do(ILoggerReporter.Category.APM_LOG).g(0.001d).b(BusinessType.OTHER).Q("ad_sdk_link_time", "status").A(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.buA));
                } catch (Throwable th) {
