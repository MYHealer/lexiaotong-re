...
public class FrameSequenceDrawable extends Drawable implements Animatable, Runnable {
    ...
    private static Bitmap acquireAndValidateBitmap(a aVar, int i, int i2) {
        Bitmap bitmapG = aVar.G(i, i2);
        if (bitmapG.getWidth() < i || bitmapG.getHeight() < i2 || bitmapG.getConfig() != Bitmap.Config.ARGB_8888) {
    ...
    /* JADX WARN: Code duplicated, block: B:27:0x006e A[Catch: all -> 0x00ea, TryCatch #0 {, blocks: (B:4:0x0003, B:6:0x0009, B:8:0x000b, B:10:0x0013, B:12:0x001e, B:13:0x0020, B:15:0x0026, B:17:0x002a, B:19:0x004c, B:21:0x0055, B:26:0x0063, B:24:0x005b, B:27:0x006e, B:28:0x0071), top: B:38:0x0003 }] */
