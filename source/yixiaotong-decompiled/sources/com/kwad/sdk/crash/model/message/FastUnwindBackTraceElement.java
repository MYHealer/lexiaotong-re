...
public final class FastUnwindBackTraceElement implements Serializable {
    ...
    public final String toString() {
        ...
        if (!this.hasUnwind) {
            return (this.isNative ? new StringBuilder("native:") : new StringBuilder().append(this.artMethod).append(x.bQ)).append(this.pc).toString();
        }
        String str = this.formatString;
        if (str != null && !str.isEmpty()) {
            return this.formatString;
        }
        sb.append(this.declaringClass).append(".").append(this.methodName);
        int i = this.lineNumber;
        if (i == -2) {
            sb.append("(Native Method)");
        } else if (this.fileName != null) {
            if (i >= 0) {
                sb.append("(").append(this.fileName).append(x.bQ).append(this.lineNumber).append(")");
            } else {
    ...
    public final String toTraceString() {
        ...
        sb2.append(this.declaringClass).append(".").append(this.methodName);
        int i = this.lineNumber;
        if (i == -2) {
            sb2.append("(Native Method)");
        } else if (this.fileName != null) {
            if (i >= 0) {
                sb2.append("(").append(this.fileName).append(x.bQ).append(this.lineNumber).append(")");
            } else {
