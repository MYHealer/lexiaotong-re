...
public final class g {
    ...
    public static void F(File file) throws Throwable {
        String[] strArr;
        if (SystemUtil.ge(21)) {
            strArr = new String[]{"logcat", "-v", "threadtime", "-b", "main", "-b", "system", "-b", "events", "-b", "crash", "-d", "-f", file.getPath()};
        } else {
            strArr = new String[]{"logcat", "-v", "threadtime", "-b", "main", "-b", "system", "-b", "events", "-d", "-f", file.getPath()};
        }
        try {
            d.a(strArr, 0);
        } catch (IOException e) {
    ...
    private static String cz(Context context) {
        ...
        try {
            sb.append("BuildConfig Version Name: " + com.kwad.sdk.crash.e.Qd().getSdkVersion() + IOUtils.LINE_SEPARATOR_UNIX);
            sb.append("PackageInfo CodePath: " + context.getPackageCodePath() + IOUtils.LINE_SEPARATOR_UNIX);
            sb.append("PackageInfo ResPath: " + context.getPackageResourcePath() + IOUtils.LINE_SEPARATOR_UNIX);
            sb.append("DexPath: " + cA(context) + IOUtils.LINE_SEPARATOR_UNIX);
        } catch (Exception e) {
            com.kwad.sdk.core.d.c.printStackTraceOnly(e);
        }
        return sb.toString();
    ...
    private static void a(ExceptionMessage exceptionMessage, MemoryInfo memoryInfo, Context context) throws Throwable {
        ...
        memoryInfo.mPssMB = (int) (aVarWF.bqO / 1024);
    ...
    private static void a(MemoryInfo memoryInfo) {
        ...
        for (File file : fileArrListFiles) {
            ...
            if (!TextUtils.isEmpty(threadInfo.mName)) {
                threadInfo.mName = am(threadInfo.mName, IOUtils.LINE_SEPARATOR_UNIX);
    ...
    private static double aS(long j) {
    ...
    public static void I(File file) {
        try {
            ...
            Object field = ab.getField(ab.a(Val.AT, Val.CAT, new Object[0]), "mAppThread");
