...
public class a {
    ...
    private static int p(Activity activity) {
        try {
            ...
            return (display == null || !((Boolean) ab.f(display, "isHdrSdrRatioAvailable", new Object[0])).booleanValue()) ? 2 : 1;
        } catch (Throwable th) {
    ...
    private void report() {
        ...
        this.bgw = Build.VERSION.SDK_INT;
        com.kwad.sdk.commercial.c.d(com.kwad.sdk.commercial.d.In().m983do(ILoggerReporter.Category.APM_LOG).g(1.0d).Q("ad_sdk_hdr", "stats_ranger").A(new com.kwad.sdk.f.a.a.a(this.bgw, this.bgx, this.bgy, this.bgz)).a(com.kwai.adclient.kscommerciallogger.model.a.buA));
    }

    private static int F(int i, int i2) {
        return (Build.VERSION.SDK_INT >= 34 && fa(i) && fa(i2)) ? 1 : 2;
    }
}
