...
public final class p {
    ...
    public static int a(String str, InputStream inputStream, String str2) throws Throwable {
        try {
            ...
            return zA ? IBidding.ECPM_PRICE_STATUS_NULL_CHANNEL_ENTITY : IBidding.ECPM_PRICE_STATUS_NULL_AD;
        } catch (UnsupportedEncodingException unused) {
            return IBidding.ECPM_PRICE_STATUS_BIDDING_OUT_DISABLE;
        }
    }
    ...
    private static byte[] a(InputStream inputStream) {
        try {
            ...
            int i = inputStream.read(bArr2, 0, iK);
            if (i > 0) {
