...
public final class a {
    ...
    public static Point bC(Context context) {
        ...
        if (a(pointBD, pointBE)) {
            return new Point(pointBE.x - pointBD.x, pointBD.y);
        }
        if (b(pointBD, pointBE)) {
            return new Point(pointBD.x, pointBE.y - pointBD.y);
        }
        return new Point();
    }
    ...
    /* JADX WARN: Code duplicated, block: B:16:0x00aa  */
        ...
        if (paint.measureText(str2) > width) {
            ...
            do {
                ...
                if (fMeasureText >= width) {
                    ...
                    if (paint.measureText(PPSLabelView.Code) + f >= width || f + paint.measureText("...") + paint.measureText(PPSLabelView.Code) >= width) {
                        i--;
                        z = true;
                    } else {
                        if (z) {
