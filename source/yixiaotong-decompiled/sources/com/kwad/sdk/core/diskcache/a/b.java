        ...
        synchronized (this.in) {
            ...
            for (int i3 = this.pos; i3 != this.end; i3++) {
                ...
                if (bArr2[i3] == 10) {
                    ...
                    byte[] bArr3 = this.buf;
                    int i4 = this.pos;
                    String str = new String(bArr3, i4, i2 - i4, this.aRS.name());
                    this.pos = i3 + 1;
                    return str;
                }
            }
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream((this.end - this.pos) + 80) { // from class: com.kwad.sdk.core.diskcache.a.b.1
                ...
                public final String toString() {
                    try {
                        return new String(this.buf, 0, (this.count <= 0 || this.buf[this.count + (-1)] != 13) ? this.count : this.count - 1, b.this.aRS.name());
