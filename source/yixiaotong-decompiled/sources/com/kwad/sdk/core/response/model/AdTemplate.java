...
public class AdTemplate extends com.kwad.sdk.core.response.a.a implements Serializable {
    ...
    public void updateLiveDetailRewardFromAdLive(LiveDetailReward liveDetailReward) {
        if (liveDetailReward != null) {
            this.mLiveDetailRewardFromAdLive.hasRewardTime = liveDetailReward.hasRewardTime;
            this.mLiveDetailRewardFromAdLive.countDownSecond = liveDetailReward.countDownSecond;
            this.mLiveDetailRewardFromAdLive.success = liveDetailReward.success;
            this.mLiveDetailRewardFromAdLive.pageDataKey = liveDetailReward.pageDataKey;
        }
    }
