...
public class BlurUtils {
    public static Bitmap stackBlur(Bitmap bitmap, int i, boolean z) {
        ...
        while (i54 < width) {
            ...
            int i75 = 0;
            while (i75 < i74) {
                iArr15[i73] = (iArr15[i73] & (-16777216)) | (iArr14[i66] << 16) | (iArr14[i67] << 8) | iArr14[i57];
                int i76 = i66 - i58;
                int i77 = i67 - i59;
                int i78 = i57 - i60;
                int[] iArr17 = iArr7[((i72 - i2) + i56) % i56];
                int i79 = i58 - iArr17[0];
                int i80 = i59 - iArr17[1];
                int i81 = i60 - iArr17[2];
                if (i54 == 0) {
                    iArr13[i75] = Math.min(i75 + i12, i71) * i70;
                }
                int i82 = iArr13[i75] + i54;
                int i83 = iArr2[i82];
                iArr17[0] = i83;
                int i84 = iArr3[i82];
                iArr17[1] = i84;
