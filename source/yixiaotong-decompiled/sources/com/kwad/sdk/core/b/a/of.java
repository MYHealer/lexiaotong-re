...
public final class of implements com.kwad.sdk.core.d<WarmUpReportMessage> {
    ...
    private static void a(WarmUpReportMessage warmUpReportMessage, JSONObject jSONObject) {
        ...
        if (JSONObject.NULL.toString().equals(warmUpReportMessage.zipFileMd5)) {
    ...
    private static JSONObject b(WarmUpReportMessage warmUpReportMessage, JSONObject jSONObject) {
        ...
        if (warmUpReportMessage.resourceType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "resource_type", warmUpReportMessage.resourceType);
        }
        ...
        if (warmUpReportMessage.freeDisk != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "free_disk", warmUpReportMessage.freeDisk);
        }
        if (warmUpReportMessage.zipFileMd5 != null && !warmUpReportMessage.zipFileMd5.equals("")) {
