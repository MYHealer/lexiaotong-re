...
public final class he implements com.kwad.sdk.core.d<InterstitialReportInfo> {
    ...
    private static void a(InterstitialReportInfo interstitialReportInfo, JSONObject jSONObject) {
        ...
        interstitialReportInfo.renderType = jSONObject.optInt(com.hihonor.adsdk.base.g.j.e.a.S0);
    ...
    private static JSONObject b(InterstitialReportInfo interstitialReportInfo, JSONObject jSONObject) {
        ...
        if (interstitialReportInfo.status != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "status", interstitialReportInfo.status);
        }
        if (interstitialReportInfo.type != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "type", interstitialReportInfo.type);
        }
        if (interstitialReportInfo.loadDataTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_data_duration_ms", interstitialReportInfo.loadDataTime);
        }
        if (interstitialReportInfo.renderDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "render_duration_ms", interstitialReportInfo.renderDuration);
        }
        if (interstitialReportInfo.renderType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.S0, interstitialReportInfo.renderType);
        }
        if (interstitialReportInfo.expectedRenderType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "expected_render_type", interstitialReportInfo.expectedRenderType);
        }
        if (interstitialReportInfo.materialType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "material_type", interstitialReportInfo.materialType);
        }
        if (interstitialReportInfo.downloadDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "download_duration_ms", interstitialReportInfo.downloadDuration);
        }
        if (interstitialReportInfo.downloadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "download_type", interstitialReportInfo.downloadType);
        }
        if (interstitialReportInfo.downloadSize != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "download_size", interstitialReportInfo.downloadSize);
        }
        if (interstitialReportInfo.creativeId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "creative_id", interstitialReportInfo.creativeId);
        }
        if (interstitialReportInfo.videoUrl != null && !interstitialReportInfo.videoUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "video_url", interstitialReportInfo.videoUrl);
        }
        if (interstitialReportInfo.videoDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "video_duration_ms", interstitialReportInfo.videoDuration);
        }
        if (interstitialReportInfo.playStartedDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "play_started_duration_ms", interstitialReportInfo.playStartedDuration);
        }
        ...
        if (interstitialReportInfo.actionType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "action_type", interstitialReportInfo.actionType);
        }
        if (interstitialReportInfo.callbackType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "callback_type", interstitialReportInfo.callbackType);
        }
        if (interstitialReportInfo.clickSceneType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "click_scene_type", interstitialReportInfo.clickSceneType);
        }
        if (interstitialReportInfo.itemClickType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "item_click_type", interstitialReportInfo.itemClickType);
        }
        if (interstitialReportInfo.visiblePercent != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "visible_percent", interstitialReportInfo.visiblePercent);
        }
        return jSONObject;
    }
}
