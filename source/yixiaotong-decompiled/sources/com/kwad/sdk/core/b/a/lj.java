...
public final class lj implements com.kwad.sdk.core.d<SDKInitMsg> {
    ...
    private static JSONObject b(SDKInitMsg sDKInitMsg, JSONObject jSONObject) {
        ...
        if (sDKInitMsg.launchIntervalTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "init_launch_interval_time", sDKInitMsg.launchIntervalTime);
        }
        if (sDKInitMsg.totalDurationTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "init_total_duration_time", sDKInitMsg.totalDurationTime);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, "init_status", sDKInitMsg.initStatus);
        if (sDKInitMsg.errorReason != null && !sDKInitMsg.errorReason.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "error_reason", sDKInitMsg.errorReason);
        }
        if (sDKInitMsg.initCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "init_count", sDKInitMsg.initCount);
        }
        if (sDKInitMsg.initProcess != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "init_process", sDKInitMsg.initProcess);
        }
        if (sDKInitMsg.initThread != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "init_thread", sDKInitMsg.initThread);
        }
        if (sDKInitMsg.intDynamicSDK != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "init_dynamic_sdk", sDKInitMsg.intDynamicSDK);
        }
        if (sDKInitMsg.intBuildNumber != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "init_build_number", sDKInitMsg.intBuildNumber);
        }
        return jSONObject;
    }
}
