...
public final class kx implements com.kwad.sdk.core.d<RewardMonitorInfo> {
    ...
    private static void a(RewardMonitorInfo rewardMonitorInfo, JSONObject jSONObject) {
        ...
        rewardMonitorInfo.loadType = jSONObject.optInt(com.hihonor.adsdk.base.g.j.e.a.hnadsd);
        rewardMonitorInfo.loadStatus = jSONObject.optInt("load_status");
        rewardMonitorInfo.adCount = jSONObject.optInt(com.hihonor.adsdk.base.g.j.e.a.O);
    ...
    private static JSONObject b(RewardMonitorInfo rewardMonitorInfo, JSONObject jSONObject) {
        ...
        if (rewardMonitorInfo.loadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.hnadsd, rewardMonitorInfo.loadType);
        }
        if (rewardMonitorInfo.loadStatus != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_status", rewardMonitorInfo.loadStatus);
        }
        if (rewardMonitorInfo.adCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.O, rewardMonitorInfo.adCount);
        }
        if (rewardMonitorInfo.loadDataDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_data_duration_ms", rewardMonitorInfo.loadDataDuration);
        }
        if (rewardMonitorInfo.downloadDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "download_duration_ms", rewardMonitorInfo.downloadDuration);
        }
        if (rewardMonitorInfo.totalDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "total_duration_ms", rewardMonitorInfo.totalDuration);
        }
        if (rewardMonitorInfo.downloadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "download_type", rewardMonitorInfo.downloadType);
        }
        if (rewardMonitorInfo.downloadSize != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "download_size", rewardMonitorInfo.downloadSize);
        }
        if (rewardMonitorInfo.creativeId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "creative_id", rewardMonitorInfo.creativeId);
        }
        if (rewardMonitorInfo.videoUrl != null && !rewardMonitorInfo.videoUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "video_url", rewardMonitorInfo.videoUrl);
        }
        if (rewardMonitorInfo.videoDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "video_duration_ms", rewardMonitorInfo.videoDuration);
        }
        if (rewardMonitorInfo.dataLoadInterval != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "data_load_interval_duration_ms", rewardMonitorInfo.dataLoadInterval);
        }
        if (rewardMonitorInfo.dataDownloadInterval != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "data_download_interval_duration_ms", rewardMonitorInfo.dataDownloadInterval);
        }
        if (rewardMonitorInfo.adSceneType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "ad_scene_type", rewardMonitorInfo.adSceneType);
        }
        if (rewardMonitorInfo.renderDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "render_duration_ms", rewardMonitorInfo.renderDuration);
        }
        if (rewardMonitorInfo.currentDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "video_duration_ms", rewardMonitorInfo.currentDuration);
        }
        if (rewardMonitorInfo.pageStatus != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "page_status", rewardMonitorInfo.pageStatus);
        }
        if (rewardMonitorInfo.subStage != null && !rewardMonitorInfo.subStage.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "sub_stage", rewardMonitorInfo.subStage);
        }
        if (rewardMonitorInfo.launchFrom != null && !rewardMonitorInfo.launchFrom.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "launch_from", rewardMonitorInfo.launchFrom);
        }
        if (rewardMonitorInfo.rewardType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "reward_type", rewardMonitorInfo.rewardType);
        }
        if (rewardMonitorInfo.taskType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "task_type", rewardMonitorInfo.taskType);
        }
        if (rewardMonitorInfo.taskStep != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "task_step", rewardMonitorInfo.taskStep);
        }
        if (rewardMonitorInfo.posId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "pos_Id", rewardMonitorInfo.posId);
        }
        if (rewardMonitorInfo.materialType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "material_type", rewardMonitorInfo.materialType);
        }
        if (rewardMonitorInfo.materialRenderType != null && !rewardMonitorInfo.materialRenderType.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "material_render_type", rewardMonitorInfo.materialRenderType);
        }
        if (rewardMonitorInfo.operationType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "operation_type", rewardMonitorInfo.operationType);
        }
        if (rewardMonitorInfo.tkRenderType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "tk_render_type", rewardMonitorInfo.tkRenderType);
        }
        if (rewardMonitorInfo.callbackType != null && !rewardMonitorInfo.callbackType.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "callback_type", rewardMonitorInfo.callbackType);
        }
        if (rewardMonitorInfo.enableRewardLayoutOptimise) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "enable_reward_layout_optimise", rewardMonitorInfo.enableRewardLayoutOptimise);
        }
        if (rewardMonitorInfo.enableFullscreenLayoutOptimise) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "enable_fullscreen_layout_optimise", rewardMonitorInfo.enableFullscreenLayoutOptimise);
        }
        if (rewardMonitorInfo.rewardTaskType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "reward_task_type", rewardMonitorInfo.rewardTaskType);
        }
        if (rewardMonitorInfo.fraudVerifyType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "fraud_verify_type", rewardMonitorInfo.fraudVerifyType);
        }
        if (rewardMonitorInfo.fraudVerifyCode != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "fraud_verify_code", rewardMonitorInfo.fraudVerifyCode);
        }
        if (rewardMonitorInfo.interceptReason != null && !rewardMonitorInfo.interceptReason.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "intercept_reason", rewardMonitorInfo.interceptReason);
        }
        return jSONObject;
    }
}
