...
public final class cc implements com.kwad.sdk.core.d<com.kwad.sdk.commercial.c.a> {
    ...
    private static void a(com.kwad.sdk.commercial.c.a aVar, JSONObject jSONObject) {
        ...
        aVar.templateId = jSONObject.optString(com.hihonor.adsdk.base.g.j.e.a.W0);
        ...
        aVar.errorMsg = jSONObject.optString(com.hihonor.adsdk.base.g.j.e.a.hnadst);
    ...
    private static JSONObject b(com.kwad.sdk.commercial.c.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.posId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "pos_Id", aVar.posId);
        }
        if (aVar.templateId != null && !aVar.templateId.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.W0, aVar.templateId);
        }
        ...
        if (aVar.tkPublishType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "tk_publish_type", aVar.tkPublishType);
        }
        if (aVar.errorCode != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "error_code", aVar.errorCode);
        }
        if (aVar.errorMsg != null && !aVar.errorMsg.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.hnadst, aVar.errorMsg);
        }
        if (aVar.campaignType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "campaign_type", aVar.campaignType);
        }
        if (aVar.ocpcActionType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "ocpc_action_type", aVar.ocpcActionType);
        }
        if (aVar.industryFirstLevelId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "industry_first_level_id", aVar.industryFirstLevelId);
        }
        if (aVar.adOperationType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "ad_operation_type", aVar.adOperationType);
        }
        if (aVar.webUriSourceType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "web_uri_source_type", aVar.webUriSourceType);
        }
        return jSONObject;
    }
}
