...
public final class ax implements com.kwad.sdk.core.d<AdTemplate> {
    ...
    private static void l(AdTemplate adTemplate, JSONObject jSONObject) {
        ...
        adTemplate.liveInfo = new LiveInfo();
        adTemplate.liveInfo.parseJson(jSONObject.optJSONObject("liveInfo"));
        ...
        adTemplate.llsid = jSONObject.optLong(KSUtil.REQUEST_ID);
        ...
        adTemplate.mLiveDetailRewardFromAdLive = new LiveDetailReward();
        adTemplate.mLiveDetailRewardFromAdLive.parseJson(jSONObject.optJSONObject("mLiveDetailRewardFromAdLive"));
        ...
        adTemplate.mIsForceJumpLandingPage = jSONObject.optBoolean("mIsForceJumpLandingPage", new Boolean(com.huawei.hms.ads.ez.V).booleanValue());
        ...
        adTemplate.fromCache = jSONObject.optBoolean("fromCache", new Boolean(com.huawei.hms.ads.ez.V).booleanValue());
    ...
    private static JSONObject m(AdTemplate adTemplate, JSONObject jSONObject) {
        ...
        if (adTemplate.posId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "posId", adTemplate.posId);
        }
        if (adTemplate.adStyle != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "adStyle", adTemplate.adStyle);
        }
        if (adTemplate.type != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "type", adTemplate.type);
        }
        if (adTemplate.subType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "subType", adTemplate.subType);
        }
        if (adTemplate.defaultType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "defaultType", adTemplate.defaultType);
        }
        if (adTemplate.contentType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "contentType", adTemplate.contentType);
        }
        ...
        if (adTemplate.llsid != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, KSUtil.REQUEST_ID, adTemplate.llsid);
        }
        if (adTemplate.mIsFromContent) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mIsFromContent", adTemplate.mIsFromContent);
        }
        ...
        if (adTemplate.mBidEcpm != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mBidEcpm", adTemplate.mBidEcpm);
        }
        com.kwad.sdk.utils.ac.a(jSONObject, "mAdScene", adTemplate.mAdScene);
        if (adTemplate.realShowType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "realShowType", adTemplate.realShowType);
        }
        if (adTemplate.mInitVoiceStatus != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mInitVoiceStatus", adTemplate.mInitVoiceStatus);
        }
        if (adTemplate.mMediaPlayerType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mMediaPlayerType", adTemplate.mMediaPlayerType);
        }
        ...
        if (adTemplate.mIsLeftSlipStatus != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mIsLeftSlipStatus", adTemplate.mIsLeftSlipStatus);
        }
        if (adTemplate.mPhotoResponseType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mPhotoResponseType", adTemplate.mPhotoResponseType);
        }
        ...
        if (adTemplate.mIsAudioEnable) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mIsAudioEnable", adTemplate.mIsAudioEnable);
        }
        if (adTemplate.mRewardVerifyCalled) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mRewardVerifyCalled", adTemplate.mRewardVerifyCalled);
        }
        if (adTemplate.isWebViewDownload) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "isWebViewDownload", adTemplate.isWebViewDownload);
        }
        if (adTemplate.watched) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "watched", adTemplate.watched);
        }
        if (adTemplate.swipeAngle != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "swipeAngle", adTemplate.swipeAngle);
        }
        if (adTemplate.converted) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "converted", adTemplate.converted);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, "fromCache", adTemplate.fromCache);
        if (adTemplate.requestStartTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "requestStartTime", adTemplate.requestStartTime);
        }
        if (adTemplate.loadDataTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "loadDataTime", adTemplate.loadDataTime);
        }
        if (adTemplate.showStartTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "showStartTime", adTemplate.showStartTime);
        }
        if (adTemplate.addStartTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "addStartTime", adTemplate.addStartTime);
        }
        if (adTemplate.showTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "showTime", adTemplate.showTime);
        }
        if (adTemplate.notNetworkRequest) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "notNetworkRequest", adTemplate.notNetworkRequest);
        }
        if (adTemplate.downloadDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "downloadDuration", adTemplate.downloadDuration);
        }
        if (adTemplate.adLoadTotalTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "adLoadTotalTime", adTemplate.adLoadTotalTime);
        }
        if (adTemplate.adShowStartTimeStamp != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "adShowStartTimeStamp", adTemplate.adShowStartTimeStamp);
        }
        ...
        if (adTemplate.isNativeRewardPreview) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "isNativeRewardPreview", adTemplate.isNativeRewardPreview);
        }
        if (adTemplate.mInstallApkFromSDK) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mInstallApkFromSDK", adTemplate.mInstallApkFromSDK);
        }
        if (adTemplate.mInstallApkFormUser) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mInstallApkFormUser", adTemplate.mInstallApkFormUser);
        }
        if (adTemplate.mClickOpenAppStore) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mClickOpenAppStore", adTemplate.mClickOpenAppStore);
        }
        ...
        if (adTemplate.hasInnerEcFailed) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "hasInnerEcFailed", adTemplate.hasInnerEcFailed);
        }
        if (adTemplate.isDoAuth) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "isDoAuth", adTemplate.isDoAuth);
        }
        return jSONObject;
    }
}
