...
public final class ef implements com.kwad.sdk.core.d<AdInfo.DownloadSafeInfo> {
    ...
    private static void a(AdInfo.DownloadSafeInfo downloadSafeInfo, JSONObject jSONObject) {
        ...
        downloadSafeInfo.downloadPauseEnable = jSONObject.optBoolean("downloadPauseEnable", new Boolean(com.huawei.hms.ads.ez.V).booleanValue());
        ...
        downloadSafeInfo.webPageTipbarSwitch = jSONObject.optBoolean("webPageTipbarSwitch", new Boolean(com.huawei.hms.ads.ez.V).booleanValue());
    ...
    private static JSONObject b(AdInfo.DownloadSafeInfo downloadSafeInfo, JSONObject jSONObject) {
        ...
        if (downloadSafeInfo.permissionInfo != null && !downloadSafeInfo.permissionInfo.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "permissionInfo", downloadSafeInfo.permissionInfo);
        }
        if (downloadSafeInfo.appName != null && !downloadSafeInfo.appName.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "appName", downloadSafeInfo.appName);
        }
        if (downloadSafeInfo.corporationName != null && !downloadSafeInfo.corporationName.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "corporationName", downloadSafeInfo.corporationName);
        }
        if (downloadSafeInfo.packageSize != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "packageSize", downloadSafeInfo.packageSize);
        }
        if (downloadSafeInfo.appVersion != null && !downloadSafeInfo.appVersion.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "appVersion", downloadSafeInfo.appVersion);
        }
        if (downloadSafeInfo.appPrivacyUrl != null && !downloadSafeInfo.appPrivacyUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "appPrivacyUrl", downloadSafeInfo.appPrivacyUrl);
        }
        if (downloadSafeInfo.appPermissionInfoUrl != null && !downloadSafeInfo.appPermissionInfoUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "appPermissionInfoUrl", downloadSafeInfo.appPermissionInfoUrl);
        }
        if (downloadSafeInfo.introductionInfo != null && !downloadSafeInfo.introductionInfo.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "introductionInfo", downloadSafeInfo.introductionInfo);
        }
        if (downloadSafeInfo.introductionInfoUrl != null && !downloadSafeInfo.introductionInfoUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "introductionInfoUrl", downloadSafeInfo.introductionInfoUrl);
        }
        if (downloadSafeInfo.secWindowPopNoWifiSwitch) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "secWindowPopNoWifiSwitch", downloadSafeInfo.secWindowPopNoWifiSwitch);
        }
        if (downloadSafeInfo.secWindowPopSwitch) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "secWindowPopSwitch", downloadSafeInfo.secWindowPopSwitch);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, "downloadPauseEnable", downloadSafeInfo.downloadPauseEnable);
        if (downloadSafeInfo.windowPopUrl != null && !downloadSafeInfo.windowPopUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "windowPopUrl", downloadSafeInfo.windowPopUrl);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, "webPageTipbarSwitch", downloadSafeInfo.webPageTipbarSwitch);
        if (downloadSafeInfo.webPageTipbarText != null && !downloadSafeInfo.webPageTipbarText.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "webPageTipbarText", downloadSafeInfo.webPageTipbarText);
        }
        if (downloadSafeInfo.autoDownloadUrl != null && !downloadSafeInfo.autoDownloadUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "autoDownloadUrl", downloadSafeInfo.autoDownloadUrl);
        }
        com.kwad.sdk.utils.ac.a(jSONObject, "complianceInfo", downloadSafeInfo.complianceInfo);
        if (downloadSafeInfo.recordNumber != null && !downloadSafeInfo.recordNumber.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "recordNumber", downloadSafeInfo.recordNumber);
        }
        return jSONObject;
    }
}
