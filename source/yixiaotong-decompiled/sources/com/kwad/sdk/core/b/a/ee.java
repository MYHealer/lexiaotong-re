...
public final class ee implements com.kwad.sdk.core.d<DownloadParams> {
    ...
    private static JSONObject b(DownloadParams downloadParams, JSONObject jSONObject) {
        ...
        if (downloadParams.mAppSize != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mAppSize", downloadParams.mAppSize);
        }
        ...
        if (downloadParams.mTaskId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mTaskId", downloadParams.mTaskId);
        }
        ...
        if (downloadParams.requestInstallPermission) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "requestInstallPermission", downloadParams.requestInstallPermission);
        }
        if (downloadParams.downloadEnablePause) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "downloadEnablePause", downloadParams.downloadEnablePause);
        }
        if (downloadParams.downloadPlace != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "downloadPlace", downloadParams.downloadPlace);
        }
        return jSONObject;
    }
}
