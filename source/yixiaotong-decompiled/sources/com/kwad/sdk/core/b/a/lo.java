...
public final class lo implements com.kwad.sdk.core.d<AdMatrixInfo.ShakeInfo> {
    ...
    private static JSONObject b(AdMatrixInfo.ShakeInfo shakeInfo, JSONObject jSONObject) {
        ...
        if (shakeInfo.title != null && !shakeInfo.title.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "title", shakeInfo.title);
        }
        ...
        if (shakeInfo.acceleration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "acceleration", shakeInfo.acceleration);
        }
        if (shakeInfo.clickDisabled) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "clickDisabled", shakeInfo.clickDisabled);
        }
        if (shakeInfo.componentIndex != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "componentIndex", shakeInfo.componentIndex);
        }
        if (shakeInfo.enable) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "enable", shakeInfo.enable);
        }
        if (shakeInfo.bidirectionalSwitch) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "bidirectionalSwitch", shakeInfo.bidirectionalSwitch);
        }
        return jSONObject;
    }
}
