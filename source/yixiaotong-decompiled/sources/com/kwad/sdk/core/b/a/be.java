...
public final class be implements com.kwad.sdk.core.d<AdMatrixInfo.AggregationCardInfo> {
    ...
    private static JSONObject b(AdMatrixInfo.AggregationCardInfo aggregationCardInfo, JSONObject jSONObject) {
        ...
        if (aggregationCardInfo.changeTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "changeTime", aggregationCardInfo.changeTime);
        }
        if (aggregationCardInfo.maxTimesPerDay != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "maxTimesPerDay", aggregationCardInfo.maxTimesPerDay);
        }
