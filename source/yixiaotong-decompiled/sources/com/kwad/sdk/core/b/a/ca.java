...
public final class ca implements com.kwad.sdk.core.d<PhotoInfo.BaseInfo> {
    ...
    private static JSONObject b(PhotoInfo.BaseInfo baseInfo, JSONObject jSONObject) {
        ...
        if (baseInfo.photoId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "photoId", baseInfo.photoId);
        }
        ...
        if (baseInfo.title != null && !baseInfo.title.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "title", baseInfo.title);
        }
        if (baseInfo.photoDescribeSize != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "photoDescribeSize", baseInfo.photoDescribeSize);
        }
        if (baseInfo.photoTitleSize != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "photoTitleSize", baseInfo.photoTitleSize);
        }
        ...
        if (baseInfo.likeCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "likeCount", baseInfo.likeCount);
        }
        if (baseInfo.commentCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "commentCount", baseInfo.commentCount);
        }
        if (baseInfo.viewCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "viewCount", baseInfo.viewCount);
        }
        if (baseInfo.createTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "createTime", baseInfo.createTime);
        }
        ...
        if (baseInfo.playTimes != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "playTimes", baseInfo.playTimes);
        }
        if (baseInfo.videoUrlCacheTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoUrlCacheTime", baseInfo.videoUrlCacheTime);
        }
        if (baseInfo.contentSourceType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "contentSourceType", baseInfo.contentSourceType);
        }
        if (baseInfo.toolbarDisable) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "toolbarDisable", baseInfo.toolbarDisable);
        }
        return jSONObject;
    }
}
