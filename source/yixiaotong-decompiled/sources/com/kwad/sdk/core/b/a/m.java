...
public final class m implements com.kwad.sdk.core.d<AdInfo.AdConversionInfo> {
    ...
    private static void a(AdInfo.AdConversionInfo adConversionInfo, JSONObject jSONObject) {
        ...
        adConversionInfo.interceptH5JumpTimeOut = jSONObject.optInt("interceptH5JumpTimeOut", new Integer(AdnConfig.b.hnadsa).intValue());
        ...
        adConversionInfo.keepPlayingBackOffTime = jSONObject.optLong("keepPlayingBackOffTime", new Long(com.huawei.openalliance.ad.constant.x.dB).longValue());
    }
    ...
    private static JSONObject b(AdInfo.AdConversionInfo adConversionInfo, JSONObject jSONObject) {
        ...
        if (adConversionInfo.h5Url != null && !adConversionInfo.h5Url.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "h5Url", adConversionInfo.h5Url);
        }
        if (adConversionInfo.h5Type != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "h5Type", adConversionInfo.h5Type);
        }
        if (adConversionInfo.deeplinkUrl != null && !adConversionInfo.deeplinkUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "deeplinkUrl", adConversionInfo.deeplinkUrl);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, "deeplinkConf", adConversionInfo.deeplinkConf);
        if (adConversionInfo.deeplinkExtra != null && !adConversionInfo.deeplinkExtra.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "deeplinkExtra", adConversionInfo.deeplinkExtra);
        }
        if (adConversionInfo.adExt != null && !adConversionInfo.adExt.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "adExt", adConversionInfo.adExt);
        }
        if (adConversionInfo.appSecondConfirmationSwitch) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "appSecondConfirmationSwitch", adConversionInfo.appSecondConfirmationSwitch);
        }
        if (adConversionInfo.h5SecondConfirmationSwitch) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "h5SecondConfirmationSwitch", adConversionInfo.h5SecondConfirmationSwitch);
        }
        if (adConversionInfo.appDownloadUrl != null && !adConversionInfo.appDownloadUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "appDownloadUrl", adConversionInfo.appDownloadUrl);
        }
        if (adConversionInfo.marketUrl != null && !adConversionInfo.marketUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "marketUrl", adConversionInfo.marketUrl);
        }
        if (adConversionInfo.supportThirdDownload != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "supportThirdDownload", adConversionInfo.supportThirdDownload);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, "retryH5TimeStep", adConversionInfo.retryH5TimeStep);
        if (adConversionInfo.playableUrl != null && !adConversionInfo.playableUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "playableUrl", adConversionInfo.playableUrl);
        }
        com.kwad.sdk.utils.ac.a(jSONObject, "playableStyleInfo", adConversionInfo.playableStyleInfo);
        if (adConversionInfo.liveServiceToken != null && !adConversionInfo.liveServiceToken.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "liveServiceToken", adConversionInfo.liveServiceToken);
        }
        if (adConversionInfo.liveVisitorId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "liveVisitorId", adConversionInfo.liveVisitorId);
        }
        com.kwad.sdk.utils.ac.a(jSONObject, "smallAppJumpInfo", adConversionInfo.smallAppJumpInfo);
        if (adConversionInfo.webUriSourceType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "webUriSourceType", adConversionInfo.webUriSourceType);
        }
        if (adConversionInfo.callbackUrl != null && !adConversionInfo.callbackUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "callbackUrl", adConversionInfo.callbackUrl);
        }
        if (adConversionInfo.callbackUrlInfo != null && !adConversionInfo.callbackUrlInfo.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "callbackUrlInfo", adConversionInfo.callbackUrlInfo);
        }
        if (adConversionInfo.blockCallbackIfSpam) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "blockCallbackIfSpam", adConversionInfo.blockCallbackIfSpam);
        }
        if (adConversionInfo.needDeeplinkReplaceAdapta) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "needDeeplinkReplaceAdapta", adConversionInfo.needDeeplinkReplaceAdapta);
        }
        if (adConversionInfo.interceptH5JumpAppMkt) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "interceptH5JumpAppMkt", adConversionInfo.interceptH5JumpAppMkt);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, "interceptH5JumpTimeOut", adConversionInfo.interceptH5JumpTimeOut);
        com.kwad.sdk.utils.ac.putValue(jSONObject, "h5DeeplinkLimitedTimeMs", adConversionInfo.h5DeeplinkLimitedTimeMs);
        com.kwad.sdk.utils.ac.putValue(jSONObject, "playableDeeplinkLimitedTimeMs", adConversionInfo.playableDeeplinkLimitedTimeMs);
        if (adConversionInfo.isSupportKeepPlaying) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "isSupportKeepPlaying", adConversionInfo.isSupportKeepPlaying);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, "keepPlayingBackOffTime", adConversionInfo.keepPlayingBackOffTime);
        return jSONObject;
    }
}
