...
public final class gl implements com.kwad.sdk.core.d<ImageLoaderInfo> {
    ...
    private static JSONObject b(ImageLoaderInfo imageLoaderInfo, JSONObject jSONObject) {
        ...
        if (imageLoaderInfo.totalCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "total_count", imageLoaderInfo.totalCount);
        }
        if (imageLoaderInfo.failedCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "failed_count", imageLoaderInfo.failedCount);
        }
        if (imageLoaderInfo.successCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "success_count", imageLoaderInfo.successCount);
        }
        if (imageLoaderInfo.duration != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "duration", imageLoaderInfo.duration);
        }
        return jSONObject;
    }
}
