...
public final class u implements com.kwad.sdk.core.d<AdInfo.AdFeedInfo> {
    ...
    private static JSONObject b(AdInfo.AdFeedInfo adFeedInfo, JSONObject jSONObject) {
        ...
        if (adFeedInfo.videoSoundType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoSoundType", adFeedInfo.videoSoundType);
        }
        if (adFeedInfo.videoAutoPlayType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoAutoPlayType", adFeedInfo.videoAutoPlayType);
        }
        return jSONObject;
    }
}
