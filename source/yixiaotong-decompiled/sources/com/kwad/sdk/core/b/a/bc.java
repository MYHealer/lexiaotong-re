...
public final class bc implements com.kwad.sdk.core.d<AdStyleInfo.PlayEndInfo.AdWebCardInfo> {
    ...
    private static JSONObject b(AdStyleInfo.PlayEndInfo.AdWebCardInfo adWebCardInfo, JSONObject jSONObject) {
        ...
        if (adWebCardInfo.typeLandscape != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "typeLandscape", adWebCardInfo.typeLandscape);
        }
        if (adWebCardInfo.typePortrait != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "typePortrait", adWebCardInfo.typePortrait);
        }
        ...
        if (adWebCardInfo.cardShowPlayCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "cardShowPlayCount", adWebCardInfo.cardShowPlayCount);
        }
        if (adWebCardInfo.cardShowTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "cardShowTime", adWebCardInfo.cardShowTime);
        }
        if (adWebCardInfo.cardDelayTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "cardDelayTime", adWebCardInfo.cardDelayTime);
        }
        return jSONObject;
    }
}
