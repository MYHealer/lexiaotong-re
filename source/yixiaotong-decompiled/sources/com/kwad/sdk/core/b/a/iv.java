...
public final class iv implements com.kwad.sdk.core.d<AdMatrixInfo.MerchantLiveReservationInfo> {
    ...
    private static JSONObject b(AdMatrixInfo.MerchantLiveReservationInfo merchantLiveReservationInfo, JSONObject jSONObject) {
        ...
        if (merchantLiveReservationInfo.title != null && !merchantLiveReservationInfo.title.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "title", merchantLiveReservationInfo.title);
        }
        ...
        if (merchantLiveReservationInfo.bookUserCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "bookUserCount", merchantLiveReservationInfo.bookUserCount);
        }
        ...
        if (merchantLiveReservationInfo.displayWeakCard) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "displayWeakCard", merchantLiveReservationInfo.displayWeakCard);
        }
        ...
        if (merchantLiveReservationInfo.displayBookCount) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "displayBookCount", merchantLiveReservationInfo.displayBookCount);
        }
