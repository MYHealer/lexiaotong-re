...
public final class a implements com.kwad.sdk.core.d<ABParams> {
    ...
    private static JSONObject b(ABParams aBParams, JSONObject jSONObject) {
        ...
        if (aBParams.videoBlackAreaClick != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoBlackAreaClick", aBParams.videoBlackAreaClick);
        }
        if (aBParams.videoBlackAreaNewStyle != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoBlackAreaNewStyle", aBParams.videoBlackAreaNewStyle);
        }
        if (aBParams.drawActionBarTimes != null && !aBParams.drawActionBarTimes.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "drawActionBarTimes", aBParams.drawActionBarTimes);
        }
        if (aBParams.showVideoAtH5 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "showVideoAtH5", aBParams.showVideoAtH5);
        }
        if (aBParams.playableStyle != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "playableStyle", aBParams.playableStyle);
        }
        return jSONObject;
    }
}
