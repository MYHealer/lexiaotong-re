...
public final class ao implements com.kwad.sdk.core.d<AdInfo.AdPreloadInfo> {
    ...
    private static JSONObject b(AdInfo.AdPreloadInfo adPreloadInfo, JSONObject jSONObject) {
        ...
        if (adPreloadInfo.preloadId != null && !adPreloadInfo.preloadId.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "preloadId", adPreloadInfo.preloadId);
        }
        if (adPreloadInfo.preloadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "preloadType", adPreloadInfo.preloadType);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, "preloadTips", adPreloadInfo.preloadTips);
        com.kwad.sdk.utils.ac.putValue(jSONObject, "validityPeriod", adPreloadInfo.validityPeriod);
        return jSONObject;
    }
}
