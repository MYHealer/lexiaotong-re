...
public final class j implements com.kwad.sdk.core.d<AdInfo.AdBaseInfo> {
    ...
    private static JSONObject b(AdInfo.AdBaseInfo adBaseInfo, JSONObject jSONObject) {
        ...
        if (adBaseInfo.creativeId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "creativeId", adBaseInfo.creativeId);
        }
        if (adBaseInfo.adSourceType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "adSourceType", adBaseInfo.adSourceType);
        }
        ...
        if (adBaseInfo.roiType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "roiType", adBaseInfo.roiType);
        }
        if (adBaseInfo.liveDisplayWatchingCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "liveDisplayWatchingCount", adBaseInfo.liveDisplayWatchingCount);
        }
        if (adBaseInfo.universeLiveType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "universeLiveType", adBaseInfo.universeLiveType);
        }
        if (adBaseInfo.viewCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "viewCount", adBaseInfo.viewCount);
        }
        ...
        if (adBaseInfo.adOperationType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "adOperationType", adBaseInfo.adOperationType);
        }
        ...
        if (adBaseInfo.adShowDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "adShowDuration", adBaseInfo.adShowDuration);
        }
        if (adBaseInfo.appName != null && !adBaseInfo.appName.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "appName", adBaseInfo.appName);
        }
        ...
        if (adBaseInfo.appScore != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "appScore", adBaseInfo.appScore);
        }
        ...
        if (adBaseInfo.packageSize != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "packageSize", adBaseInfo.packageSize);
        }
        ...
        if (adBaseInfo.enableSkipAd != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "enableSkipAd", adBaseInfo.enableSkipAd);
        }
        ...
        if (adBaseInfo.adRolloutSize != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "adRolloutSize", adBaseInfo.adRolloutSize);
        }
        if (adBaseInfo.skipSecond != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "skipSecond", adBaseInfo.skipSecond);
        }
        if (adBaseInfo.ecpm != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "ecpm", adBaseInfo.ecpm);
        }
        ...
        if (adBaseInfo.clickUrl != null && !adBaseInfo.clickUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "clickUrl", adBaseInfo.clickUrl);
        }
        ...
        if (adBaseInfo.adAttributeType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "adAttributeType", adBaseInfo.adAttributeType);
        }
        com.kwad.sdk.utils.ac.a(jSONObject, "apiExpParam", adBaseInfo.apiExpParam);
        if (adBaseInfo.taskType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "taskType", adBaseInfo.taskType);
        }
        if (adBaseInfo.campaignType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "campaignType", adBaseInfo.campaignType);
        }
        if (adBaseInfo.itemType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "itemType", adBaseInfo.itemType);
        }
        if (adBaseInfo.industryFirstLevelId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "industryFirstLevelId", adBaseInfo.industryFirstLevelId);
        }
        if (adBaseInfo.extraClickReward) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "extraClickReward", adBaseInfo.extraClickReward);
        }
        if (adBaseInfo.enableClientProofreadTime) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "enableClientProofreadTime", adBaseInfo.enableClientProofreadTime);
        }
        if (adBaseInfo.isClosure) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "isClosure", adBaseInfo.isClosure);
        }
        return jSONObject;
    }
}
