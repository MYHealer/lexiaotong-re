...
public final class lm implements com.kwad.sdk.core.d<com.kwad.components.core.webview.jshandler.a.e.a> {
    ...
    private static void a(com.kwad.components.core.webview.jshandler.a.e.a aVar, JSONObject jSONObject) {
        ...
        aVar.asc = jSONObject.optString("base64String");
        if (JSONObject.NULL.toString().equals(aVar.asc)) {
            aVar.asc = "";
        }
    }
    ...
    private static JSONObject b(com.kwad.components.core.webview.jshandler.a.e.a aVar, JSONObject jSONObject) {
        ...
        if (aVar.asc != null && !aVar.asc.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "base64String", aVar.asc);
        }
        return jSONObject;
    }
}
