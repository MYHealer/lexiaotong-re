...
public final class mh implements com.kwad.sdk.core.d<SplashMonitorInfo> {
    ...
    private static void a(SplashMonitorInfo splashMonitorInfo, JSONObject jSONObject) {
        ...
        JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(OapsKey.KEY_IDS);
        if (jSONArrayOptJSONArray != null) {
            for (int i = 0; i < jSONArrayOptJSONArray.length(); i++) {
                splashMonitorInfo.ids.add((String) jSONArrayOptJSONArray.opt(i));
            }
        }
        splashMonitorInfo.count = jSONObject.optInt(com.hihonor.adsdk.base.g.j.e.a.Q0);
        ...
        splashMonitorInfo.loadType = jSONObject.optInt(com.hihonor.adsdk.base.g.j.e.a.hnadsd);
        ...
        splashMonitorInfo.templateId = jSONObject.optString(com.hihonor.adsdk.base.g.j.e.a.W0);
    ...
    private static JSONObject b(SplashMonitorInfo splashMonitorInfo, JSONObject jSONObject) {
        ...
        if (splashMonitorInfo.status != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "status", splashMonitorInfo.status);
        }
        if (splashMonitorInfo.type != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "type", splashMonitorInfo.type);
        }
        ...
        if (splashMonitorInfo.checkStatus != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "check_status", splashMonitorInfo.checkStatus);
        }
        if (splashMonitorInfo.loadDataTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_data_duration_ms", splashMonitorInfo.loadDataTime);
        }
        if (splashMonitorInfo.beforeLoadDataTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "before_load_data_duration_ms", splashMonitorInfo.beforeLoadDataTime);
        }
        if (splashMonitorInfo.checkDataTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "check_data_duration_ms", splashMonitorInfo.checkDataTime);
        }
        if (splashMonitorInfo.loadAndCheckDataTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_and_check_data_duration_ms", splashMonitorInfo.loadAndCheckDataTime);
        }
        if (splashMonitorInfo.costTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "duration_ms", splashMonitorInfo.costTime);
        }
        com.kwad.sdk.utils.ac.putValue(jSONObject, OapsKey.KEY_IDS, splashMonitorInfo.ids);
        if (splashMonitorInfo.count != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.Q0, splashMonitorInfo.count);
        }
        if (splashMonitorInfo.cacheValidTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "validity_period_ms", splashMonitorInfo.cacheValidTime);
        }
        if (splashMonitorInfo.size != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, OapsKey.KEY_SIZE, splashMonitorInfo.size);
        }
        ...
        if (splashMonitorInfo.creativeId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "creative_id", splashMonitorInfo.creativeId);
        }
        if (splashMonitorInfo.materialType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "material_type", splashMonitorInfo.materialType);
        }
        if (splashMonitorInfo.totalCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "total_count", splashMonitorInfo.totalCount);
        }
        ...
        if (splashMonitorInfo.updateType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, HiAnalyticsConstant.BI_KEY_UPDATE_TYPE, splashMonitorInfo.updateType);
        }
        if (splashMonitorInfo.clearCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "clear_count", splashMonitorInfo.clearCount);
        }
        if (splashMonitorInfo.clearImageCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "clear_image_count", splashMonitorInfo.clearImageCount);
        }
        if (splashMonitorInfo.clearVideoCount != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "clear_video_count", splashMonitorInfo.clearVideoCount);
        }
        if (splashMonitorInfo.requestType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "request_type", splashMonitorInfo.requestType);
        }
        if (splashMonitorInfo.loadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.hnadsd, splashMonitorInfo.loadType);
        }
        if (splashMonitorInfo.posId != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "pos_Id", splashMonitorInfo.posId);
        }
        if (splashMonitorInfo.viewSource != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "view_source", splashMonitorInfo.viewSource);
        }
        ...
        if (splashMonitorInfo.showEndTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "show_end_time", splashMonitorInfo.showEndTime);
        }
        if (splashMonitorInfo.isRotateComposeTimeout) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "is_rotate_compose_timeout", splashMonitorInfo.isRotateComposeTimeout);
        }
        if (splashMonitorInfo.tkDefaultTimeout != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "tk_default_timeout", splashMonitorInfo.tkDefaultTimeout);
        }
        if (splashMonitorInfo.soSource != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "so_source", splashMonitorInfo.soSource);
        }
        if (splashMonitorInfo.soLoadTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "so_load_time", splashMonitorInfo.soLoadTime);
        }
        if (splashMonitorInfo.offlineSource != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "offline_source", splashMonitorInfo.offlineSource);
        }
        if (splashMonitorInfo.offlineLoadTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "offline_load_time", splashMonitorInfo.offlineLoadTime);
        }
        if (splashMonitorInfo.tkFileLoadTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "tk_file_load_time", splashMonitorInfo.tkFileLoadTime);
        }
        if (splashMonitorInfo.tkInitTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "tk_init_time", splashMonitorInfo.tkInitTime);
        }
        if (splashMonitorInfo.tkRenderTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "tk_render_time", splashMonitorInfo.tkRenderTime);
        }
        if (splashMonitorInfo.nativeLoadTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "native_load_time", splashMonitorInfo.nativeLoadTime);
        }
        if (splashMonitorInfo.isWebTimeout) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "is_web_timeout", splashMonitorInfo.isWebTimeout);
        }
        if (splashMonitorInfo.webLoadTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "web_load_time", splashMonitorInfo.webLoadTime);
        }
        if (splashMonitorInfo.templateId != null && !splashMonitorInfo.templateId.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.W0, splashMonitorInfo.templateId);
        }
        if (splashMonitorInfo.templateVersionCode != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "template_version_code", splashMonitorInfo.templateVersionCode);
        }
        if (splashMonitorInfo.tkTotalTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "tk_total_time", splashMonitorInfo.tkTotalTime);
        }
        if (splashMonitorInfo.actionType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "action_type", splashMonitorInfo.actionType);
        }
        if (splashMonitorInfo.callbackType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "callback_type", splashMonitorInfo.callbackType);
        }
        if (splashMonitorInfo.tkRenderType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "tk_render_type", splashMonitorInfo.tkRenderType);
        }
        if (splashMonitorInfo.loadProcessType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_process_type", splashMonitorInfo.loadProcessType);
        }
        if (splashMonitorInfo.rootVisible) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "root_visible", splashMonitorInfo.rootVisible);
        }
        if (splashMonitorInfo.parentVisible) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "parent_visible", splashMonitorInfo.parentVisible);
        }
        if (splashMonitorInfo.addLoadTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "add_load_time", splashMonitorInfo.addLoadTime);
        }
        if (splashMonitorInfo.buriedPointOptimizeType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "buried_point_optimize_type", splashMonitorInfo.buriedPointOptimizeType);
        }
        if (splashMonitorInfo.visibleCheckDelayTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "visible_check_delay_time", splashMonitorInfo.visibleCheckDelayTime);
        }
        if (splashMonitorInfo.requestLoadTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "request_load_Time", splashMonitorInfo.requestLoadTime);
        }
        if (splashMonitorInfo.showType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "show_type", splashMonitorInfo.showType);
        }
        if (splashMonitorInfo.showDurationMs != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "show_duration_ms", splashMonitorInfo.showDurationMs);
        }
        if (splashMonitorInfo.hasUnbind) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "has_unbind", splashMonitorInfo.hasUnbind);
        }
        return jSONObject;
    }
}
