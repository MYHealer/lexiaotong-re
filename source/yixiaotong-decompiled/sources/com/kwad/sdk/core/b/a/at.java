...
public final class at implements com.kwad.sdk.core.d<AdStatusInfo> {
    ...
    private static JSONObject b(AdStatusInfo adStatusInfo, JSONObject jSONObject) {
        ...
        if (adStatusInfo.loadFromCache) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "loadFromCache", adStatusInfo.loadFromCache);
        }
        if (adStatusInfo.loadDataTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "loadDataTime", adStatusInfo.loadDataTime);
        }
        if (adStatusInfo.downloadFinishTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "downloadFinishTime", adStatusInfo.downloadFinishTime);
        }
        if (adStatusInfo.downloadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "downloadType", adStatusInfo.downloadType);
        }
        if (adStatusInfo.downloadSize != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "downloadSize", adStatusInfo.downloadSize);
        }
        if (adStatusInfo.downloadStatus != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "downloadStatus", adStatusInfo.downloadStatus);
        }
        return jSONObject;
    }
}
