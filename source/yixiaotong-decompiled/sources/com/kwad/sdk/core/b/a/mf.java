...
public final class mf implements com.kwad.sdk.core.d<AdMatrixInfo.SplashInfo> {
    ...
    private static JSONObject b(AdMatrixInfo.SplashInfo splashInfo, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.ac.a(jSONObject, "interactionInfo", splashInfo.interactionInfo);
        return jSONObject;
    }
}
