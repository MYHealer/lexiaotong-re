...
public final class cm implements com.kwad.sdk.core.d<com.kwad.sdk.core.webview.d.b.c> {
    ...
    private static JSONObject b(com.kwad.sdk.core.webview.d.b.c cVar, JSONObject jSONObject) {
        ...
        if (cVar.x != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "x", cVar.x);
        }
        if (cVar.y != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "y", cVar.y);
        }
        if (cVar.width != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "width", cVar.width);
        }
        if (cVar.height != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "height", cVar.height);
        }
        return jSONObject;
    }
}
