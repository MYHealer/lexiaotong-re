...
public final class jz implements com.kwad.sdk.core.d<AdStyleInfo.PlayDetailInfo.PatchAdInfo> {
    ...
    private static void a(AdStyleInfo.PlayDetailInfo.PatchAdInfo patchAdInfo, JSONObject jSONObject) {
        ...
        patchAdInfo.weakStyleEnableClose = jSONObject.optBoolean("weakStyleEnableClose", new Boolean(com.huawei.hms.ads.ez.Code).booleanValue());
        ...
        patchAdInfo.strongStyleEnableClose = jSONObject.optBoolean("strongStyleEnableClose", new Boolean(com.huawei.hms.ads.ez.Code).booleanValue());
    ...
    private static JSONObject b(AdStyleInfo.PlayDetailInfo.PatchAdInfo patchAdInfo, JSONObject jSONObject) {
        ...
        if (patchAdInfo.weakStyleAppearTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "weakStyleAppearTime", patchAdInfo.weakStyleAppearTime);
        }
        ...
        if (patchAdInfo.typePortrait != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "typePortrait", patchAdInfo.typePortrait);
        }
        ...
        if (patchAdInfo.strongStyleAppearTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "strongStyleAppearTime", patchAdInfo.strongStyleAppearTime);
        }
        ...
        if (patchAdInfo.weakStyleShowTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "weakStyleShowTime", patchAdInfo.weakStyleShowTime);
        }
        if (patchAdInfo.strongStyleShowTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "strongStyleShowTime", patchAdInfo.strongStyleShowTime);
        }
        return jSONObject;
    }
}
