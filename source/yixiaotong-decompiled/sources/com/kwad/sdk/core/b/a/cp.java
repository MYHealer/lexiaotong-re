...
public final class cp implements com.kwad.sdk.core.d<com.kwad.sdk.core.report.h> {
    ...
    private static void a(com.kwad.sdk.core.report.h hVar, JSONObject jSONObject) {
        ...
        hVar.llsid = jSONObject.optLong(KSUtil.REQUEST_ID);
        hVar.creativeId = jSONObject.optLong("creative_id");
        hVar.score = jSONObject.optInt("score");
        hVar.aVp = jSONObject.optInt("is_bidding");
        hVar.source = jSONObject.optString(com.huawei.openalliance.ad.constant.ba.at);
    ...
    private static JSONObject b(com.kwad.sdk.core.report.h hVar, JSONObject jSONObject) {
        ...
        if (hVar.llsid != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, KSUtil.REQUEST_ID, hVar.llsid);
        }
        ...
        if (hVar.source != null && !hVar.source.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.huawei.openalliance.ad.constant.ba.at, hVar.source);
        }
        return jSONObject;
    }
}
