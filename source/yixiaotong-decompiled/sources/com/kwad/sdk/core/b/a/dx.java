...
public final class dx implements com.kwad.sdk.core.d<AdStyleInfo.PlayDetailInfo.DetailWebCardInfo> {
    ...
    private static JSONObject b(AdStyleInfo.PlayDetailInfo.DetailWebCardInfo detailWebCardInfo, JSONObject jSONObject) {
        ...
        if (detailWebCardInfo.style != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "style", detailWebCardInfo.style);
        }
        if (detailWebCardInfo.maxTimeOut != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "maxTimeOut", detailWebCardInfo.maxTimeOut);
        }
        if (detailWebCardInfo.typeLandscape != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "typeLandscape", detailWebCardInfo.typeLandscape);
        }
        if (detailWebCardInfo.typePortrait != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "typePortrait", detailWebCardInfo.typePortrait);
        }
        if (detailWebCardInfo.cardUrl != null && !detailWebCardInfo.cardUrl.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "cardUrl", detailWebCardInfo.cardUrl);
        }
        if (detailWebCardInfo.cardData != null && !detailWebCardInfo.cardData.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "cardData", detailWebCardInfo.cardData);
        }
        if (detailWebCardInfo.cardShowTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "cardShowTime", detailWebCardInfo.cardShowTime);
        }
        if (detailWebCardInfo.cardType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "cardType", detailWebCardInfo.cardType);
        }
        return jSONObject;
    }
}
