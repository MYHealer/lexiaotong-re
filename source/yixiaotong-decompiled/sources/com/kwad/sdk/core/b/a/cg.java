...
public final class cg implements com.kwad.sdk.core.d<BlockEvent> {
    ...
    private static void a(BlockEvent blockEvent, JSONObject jSONObject) {
        ...
        blockEvent.blockTimeThreshold = jSONObject.optLong("blockTimeThreshold", new Long(AdnConfig.b.hnadsa).longValue());
    ...
    private static JSONObject b(BlockEvent blockEvent, JSONObject jSONObject) {
        ...
        if (blockEvent.blockDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "blockDuration", blockEvent.blockDuration);
        }
        ...
        if (blockEvent.calcBlockOverhead != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "calcBlockOverhead", blockEvent.calcBlockOverhead);
        }
