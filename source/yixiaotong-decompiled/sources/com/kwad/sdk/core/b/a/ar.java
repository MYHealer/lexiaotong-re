...
public final class ar implements com.kwad.sdk.core.d<AdInfo.AdShowVideoH5Info> {
    ...
    private static JSONObject b(AdInfo.AdShowVideoH5Info adShowVideoH5Info, JSONObject jSONObject) {
        ...
        if (adShowVideoH5Info.showPageType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "showPageType", adShowVideoH5Info.showPageType);
        }
        if (adShowVideoH5Info.videoAutoLoopAtH5) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoAutoLoopAtH5", adShowVideoH5Info.videoAutoLoopAtH5);
        }
        if (adShowVideoH5Info.videoMutedAtH5) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoMutedAtH5", adShowVideoH5Info.videoMutedAtH5);
        }
        if (adShowVideoH5Info.videoClickAtH5) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoClickAtH5", adShowVideoH5Info.videoClickAtH5);
        }
        return jSONObject;
    }
}
