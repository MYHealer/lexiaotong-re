...
public final class bw implements com.kwad.sdk.core.d<BackTraceElement> {
    ...
    private static JSONObject b(BackTraceElement backTraceElement, JSONObject jSONObject) {
        ...
        if (backTraceElement.mLine != null && !backTraceElement.mLine.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mLine", backTraceElement.mLine);
        }
        if (backTraceElement.mMethodName != null && !backTraceElement.mMethodName.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mMethodName", backTraceElement.mMethodName);
        }
        if (backTraceElement.mFileName != null && !backTraceElement.mFileName.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mFileName", backTraceElement.mFileName);
        }
        if (backTraceElement.mLineNumber != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mLineNumber", backTraceElement.mLineNumber);
        }
        if (backTraceElement.mIndex != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mIndex", backTraceElement.mIndex);
        }
        if (backTraceElement.mNeedClustering) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mNeedClustering", backTraceElement.mNeedClustering);
        }
        return jSONObject;
    }
}
