...
public final class kl implements com.kwad.sdk.core.d<SplashPreloadManager.PreLoadItem> {
    ...
    private static JSONObject b(SplashPreloadManager.PreLoadItem preLoadItem, JSONObject jSONObject) {
        ...
        if (preLoadItem.cacheTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "cacheTime", preLoadItem.cacheTime);
        }
        if (preLoadItem.expiredTime != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "expiredTime", preLoadItem.expiredTime);
        }
        ...
        if (preLoadItem.materialType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "materialType", preLoadItem.materialType);
        }
        return jSONObject;
    }
}
