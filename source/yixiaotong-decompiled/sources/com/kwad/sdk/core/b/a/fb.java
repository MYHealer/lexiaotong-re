...
public final class fb implements com.kwad.sdk.core.d<FeedPageInfo> {
    ...
    private static void a(FeedPageInfo feedPageInfo, JSONObject jSONObject) {
        ...
        feedPageInfo.loadType = jSONObject.optLong(com.hihonor.adsdk.base.g.j.e.a.hnadsd);
        ...
        feedPageInfo.renderType = jSONObject.optInt(com.hihonor.adsdk.base.g.j.e.a.S0);
    ...
    private static JSONObject b(FeedPageInfo feedPageInfo, JSONObject jSONObject) {
        ...
        if (feedPageInfo.status != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "status", feedPageInfo.status);
        }
        if (feedPageInfo.loadStatus != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_status", feedPageInfo.loadStatus);
        }
        if (feedPageInfo.adNum != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "ad_num", feedPageInfo.adNum);
        }
        if (feedPageInfo.type != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "type", feedPageInfo.type);
        }
        if (feedPageInfo.loadType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.hnadsd, feedPageInfo.loadType);
        }
        if (feedPageInfo.loadDataDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "load_data_duration_ms", feedPageInfo.loadDataDuration);
        }
        if (feedPageInfo.resourceLoadDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "resource_load_duration_ms", feedPageInfo.resourceLoadDuration);
        }
        if (feedPageInfo.materialType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "material_type", feedPageInfo.materialType);
        }
        ...
        if (feedPageInfo.renderDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "render_duration_ms", feedPageInfo.renderDuration);
        }
        if (feedPageInfo.renderType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.hihonor.adsdk.base.g.j.e.a.S0, feedPageInfo.renderType);
        }
        if (feedPageInfo.expectedRenderType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "expected_render_type", feedPageInfo.expectedRenderType);
        }
        if (feedPageInfo.convertDuration != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "convert_duartion_ms", feedPageInfo.convertDuration);
        }
        ...
        if (feedPageInfo.callbackType != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "callback_type", feedPageInfo.callbackType);
        }
