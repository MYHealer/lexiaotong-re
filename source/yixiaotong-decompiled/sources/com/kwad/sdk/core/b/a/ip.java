...
public final class ip implements com.kwad.sdk.core.d<AdInfo.MaterialSize> {
    ...
    private static JSONObject b(AdInfo.MaterialSize materialSize, JSONObject jSONObject) {
        ...
        if (materialSize.width != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "width", materialSize.width);
        }
        if (materialSize.height != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "height", materialSize.height);
        }
        return jSONObject;
    }
}
