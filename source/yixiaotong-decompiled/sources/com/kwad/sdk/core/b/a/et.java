...
public final class et implements com.kwad.sdk.core.d<com.kwad.components.core.innerEc.live.config.net.a> {
    ...
    private static void a(com.kwad.components.core.innerEc.live.config.net.a aVar, JSONObject jSONObject) {
        ...
        aVar.Uf = new com.kwad.components.core.innerEc.live.config.net.c();
        aVar.Uf.parseJson(jSONObject.optJSONObject("authorInfo"));
    }
    ...
    private static JSONObject b(com.kwad.components.core.innerEc.live.config.net.a aVar, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.ac.a(jSONObject, "authorInfo", aVar.Uf);
        return jSONObject;
    }
}
