...
public class NewOAIDSDKHelper {
    ...
    public static void a(Context context, a aVar) {
        ...
        try {
            ...
            Log.d("KSAdSDK", "OADIDSDKHelper:sdk init time=" + (System.currentTimeMillis() - jCurrentTimeMillis) + "--result=" + MdidSdkHelper.InitSdk(StubApp.getOrigApplicationContext(context.getApplicationContext()), true, new IIdentifierListenerImpl(jCurrentTimeMillis, aVar)));
