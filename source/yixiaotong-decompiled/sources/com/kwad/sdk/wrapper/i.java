...
public final class i extends Resources {
    ...
    public final int getIdentifier(String str, String str2, String str3) {
        ...
        if (aF(str, str3)) {
            return this.aDN.getIdentifier(str, str2, str3);
        }
    ...
    public final String getResourcePackageName(int i) {
        ...
        if (gr(i)) {
            return this.aDN.getResourcePackageName(i);
        }
    ...
    public final String getResourceTypeName(int i) {
        ...
        if (gr(i)) {
            return this.aDN.getResourceTypeName(i);
        }
    ...
    public final String getResourceEntryName(int i) {
        ...
        if (gr(i)) {
            return this.aDN.getResourceEntryName(i);
        }
