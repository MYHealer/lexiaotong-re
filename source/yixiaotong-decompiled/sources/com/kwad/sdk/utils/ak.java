...
public final class ak {
    public static String a(Context context, String str, al.a aVar, boolean z) {
        ...
        if (!TextUtils.isEmpty(strDQ)) {
            strAv = strAv.replace("__MAC__", strDQ).replace("__MAC2__", an.md5(strDQ)).replace("__MAC3__", an.md5(strDQ.replace(com.huawei.openalliance.ad.constant.x.bQ, "")));
        }
        ...
        if (!TextUtils.isEmpty(oaid)) {
            strAv = strAv.replace(com.hihonor.adsdk.base.g.j.e.c.hnadsk, oaid).replace("__OAID2__", an.md5(oaid));
        }
    ...
    public static void f(AdTemplate adTemplate, String str, String str2) {
        ...
        if (!TextUtils.isEmpty(bf.getOaid())) {
            if (str2.contains(com.hihonor.adsdk.base.g.j.e.c.hnadsk)) {
                arrayList.add(com.hihonor.adsdk.base.g.j.e.c.hnadsk);
            }
