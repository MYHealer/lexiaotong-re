...
public class KSCoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public KSCoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ksad_KSCoordinatorLayout, i, R.style.ksad_Widget_Design_KSADCoordinatorLayout);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.ksad_KSCoordinatorLayout_ksad_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = typedArrayObtainStyledAttributes.getDrawable(R.styleable.ksad_KSCoordinatorLayout_ksad_statusBarBackground);
  ...
  0x002b: PHI (r3v4 boolean) = (r3v2 boolean), (r3v5 boolean) binds: [B:9:0x0022, B:5:0x0012] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    private int getKeyline(int i) {
        int[] iArr = this.mKeylines;
        if (iArr == null) {
            com.kwad.sdk.core.d.c.e(TAG, "No keylines defined for " + this + " - attempted index lookup " + i);
            return 0;
        }
        if (i < 0 || i >= iArr.length) {
            com.kwad.sdk.core.d.c.e(TAG, "Keyline index " + i + " out of range for " + this);
            return 0;
        }
        return iArr[i];
    }
    ...
    LayoutParams getResolvedLayoutParams(View view) {
        ...
        if (!layoutParams.mBehaviorResolved) {
            ...
            if (aVar != null) {
                try {
                    layoutParams.setBehavior(aVar.value().getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
                } catch (Exception e2) {
                    com.kwad.sdk.core.d.c.e(TAG, "Default behavior class " + aVar.value().getName() + " could not be instantiated. Did you forget a default constructor?", e2);
                }
            }
            ...
            if (view.getVisibility() != 8) {
                ...
                if (layoutParams2.keyline < 0 || mode == 0) {
                    ...
                    if (behavior != null) {
                        ...
                        int iMax3 = Math.max(i7, i11 + view.getMeasuredHeight() + layoutParams3.topMargin + layoutParams3.bottomMargin);
                    ...
                    int iMax4 = Math.max(i9, i10 + view.getMeasuredWidth() + layoutParams4.leftMargin + layoutParams4.rightMargin);
                    int iMax5 = Math.max(i7, i11 + view.getMeasuredHeight() + layoutParams4.topMargin + layoutParams4.bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i8, view.getMeasuredState());
                    i12 = iMax4;
                    i13 = iMax5;
                }
                ...
                if (behavior != null) {
                    ...
                    int iMax6 = Math.max(i9, i10 + view.getMeasuredWidth() + layoutParams5.leftMargin + layoutParams5.rightMargin);
                    int iMax7 = Math.max(i7, i11 + view.getMeasuredHeight() + layoutParams5.topMargin + layoutParams5.bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i8, view.getMeasuredState());
                    i12 = iMax6;
                    i13 = iMax7;
                } else {
                ...
                int iMax8 = Math.max(i9, i10 + view.getMeasuredWidth() + layoutParams6.leftMargin + layoutParams6.rightMargin);
                int iMax9 = Math.max(i7, i11 + view.getMeasuredHeight() + layoutParams6.topMargin + layoutParams6.bottomMargin);
                iCombineMeasuredStates = View.combineMeasuredStates(i8, view.getMeasuredState());
                i12 = iMax8;
                i13 = iMax9;
            } else {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.dodgeInsetEdges = 0;
            this.mLastChildRect = new Rect();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ksad_CoordinatorLayout_Layout);
            this.gravity = typedArrayObtainStyledAttributes.getInteger(R.styleable.ksad_CoordinatorLayout_Layout_ksad_layout_gravity, 0);
            this.mAnchorId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.ksad_CoordinatorLayout_Layout_ksad_layout_anchor, -1);
            this.anchorGravity = typedArrayObtainStyledAttributes.getInteger(R.styleable.ksad_CoordinatorLayout_Layout_ksad_layout_anchorGravity, 0);
            this.keyline = typedArrayObtainStyledAttributes.getInteger(R.styleable.ksad_CoordinatorLayout_Layout_ksad_layout_keyline, -1);
            this.insetEdge = typedArrayObtainStyledAttributes.getInt(R.styleable.ksad_CoordinatorLayout_Layout_ksad_layout_insetEdge, 0);
            this.dodgeInsetEdges = typedArrayObtainStyledAttributes.getInt(R.styleable.ksad_CoordinatorLayout_Layout_ksad_layout_dodgeInsetEdges, 0);
            boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(R.styleable.ksad_CoordinatorLayout_Layout_ksad_layout_behavior);
            this.mBehaviorResolved = zHasValue;
            if (zHasValue) {
                this.mBehavior = KSCoordinatorLayout.parseBehavior(context, attributeSet, typedArrayObtainStyledAttributes.getString(R.styleable.ksad_CoordinatorLayout_Layout_ksad_layout_behavior));
            }
            typedArrayObtainStyledAttributes.recycle();
        ...
        boolean isBlockingInteractionBelow(KSCoordinatorLayout kSCoordinatorLayout, View view) {
            ...
            Behavior behavior = this.mBehavior;
            boolean zBlocksInteractionBelow = (behavior != null ? behavior.blocksInteractionBelow(kSCoordinatorLayout, view) : false) | z;
        ...
        boolean dependsOn(KSCoordinatorLayout kSCoordinatorLayout, View view, View view2) {
            if (view2 == this.mAnchorDirectChild || shouldDodge(view2, ViewCompat.getLayoutDirection(kSCoordinatorLayout))) {
                return true;
            }
            Behavior behavior = this.mBehavior;
            return behavior != null && behavior.layoutDependsOn(kSCoordinatorLayout, view, view2);
        }
        ...
        private void resolveAnchorView(View view, KSCoordinatorLayout kSCoordinatorLayout) {
            View viewFindViewById = kSCoordinatorLayout.findViewById(this.mAnchorId);
            this.mAnchorView = viewFindViewById;
            if (viewFindViewById == null) {
                if (!kSCoordinatorLayout.isInEditMode()) {
            ...
            if (viewFindViewById == kSCoordinatorLayout) {
                if (!kSCoordinatorLayout.isInEditMode()) {
            ...
            for (ViewParent parent = viewFindViewById.getParent(); parent != kSCoordinatorLayout && parent != null; parent = parent.getParent()) {
                if (parent == view) {
                    if (!kSCoordinatorLayout.isInEditMode()) {
    ...
    class b implements ViewGroup.OnHierarchyChangeListener {
        ...
        public final void onChildViewAdded(View view, View view2) {
            if (KSCoordinatorLayout.this.mOnHierarchyChangeListener != null) {
                KSCoordinatorLayout.this.mOnHierarchyChangeListener.onChildViewAdded(view, view2);
            }
        }
        ...
        public final void onChildViewRemoved(View view, View view2) {
            ...
            if (KSCoordinatorLayout.this.mOnHierarchyChangeListener != null) {
                KSCoordinatorLayout.this.mOnHierarchyChangeListener.onChildViewRemoved(view, view2);
            }
        }
    }
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        SparseArray<Parcelable> sparseArray = dVar.bhR;
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            View childAt = getChildAt(i);
    ...
    private void setupForInsets() {
        if (ViewCompat.getFitsSystemWindows(this)) {
            if (this.mApplyWindowInsetsListener == null) {
                this.mApplyWindowInsetsListener = new OnApplyWindowInsetsListener() { // from class: com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.1
    ...
    protected static class d extends AbsSavedState {
        public static final Parcelable.Creator<d> CREATOR = new Parcelable.ClassLoaderCreator<d>() { // from class: com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.d.1
            ...
            private static d c(Parcel parcel, ClassLoader classLoader) {
            ...
            private static d[] fe(int i) {
                return new d[i];
            }
        };
        SparseArray<Parcelable> bhR;
        ...
        public d(Parcel parcel, ClassLoader classLoader) {
            ...
            this.bhR = new SparseArray<>(i);
            for (int i2 = 0; i2 < i; i2++) {
                this.bhR.append(iArr[i2], parcelableArray[i2]);
            }
        }
        ...
        public final void writeToParcel(Parcel parcel, int i) {
            ...
            SparseArray<Parcelable> sparseArray = this.bhR;
            int size = sparseArray != null ? sparseArray.size() : 0;
            parcel.writeInt(size);
            int[] iArr = new int[size];
            Parcelable[] parcelableArr = new Parcelable[size];
            for (int i2 = 0; i2 < size; i2++) {
                iArr[i2] = this.bhR.keyAt(i2);
                parcelableArr[i2] = this.bhR.valueAt(i2);
            }
