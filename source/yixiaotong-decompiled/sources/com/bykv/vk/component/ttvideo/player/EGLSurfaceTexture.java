...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    /* JADX INFO: renamed from: com.bykv.vk.component.ttvideo.player.EGLSurfaceTexture$1, reason: invalid class name */
    ...
    public static final class GlException extends RuntimeException {
        /* synthetic */ GlException(String str, AnonymousClass1 anonymousClass1) {
            this(str);
        }
    ...
    private static EGLDisplay getDefaultDisplay() {
        ...
        if (eGLDisplayEglGetDisplay == null) {
            throw new GlException("eglGetDisplay failed", anonymousClass1);
        }
        int[] iArr = new int[2];
        if (EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1)) {
            return eGLDisplayEglGetDisplay;
        }
        throw new GlException("eglInitialize failed", anonymousClass1);
    }
    ...
    private static EGLConfig chooseEGLConfig(EGLDisplay eGLDisplay) {
        ...
        if (!zEglChooseConfig || iArr[0] <= 0 || (eGLConfig = eGLConfigArr[0]) == null) {
            throw new GlException(String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(zEglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]), null);
        }
        return eGLConfig;
    }
    ...
    private static EGLSurface createEGLSurface(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i) {
        ...
        if (i == 1) {
            ...
            if (eGLSurfaceEglCreatePbufferSurface == null) {
                throw new GlException("eglCreatePbufferSurface failed", anonymousClass1);
            }
        }
        ...
        throw new GlException("eglMakeCurrent failed", anonymousClass1);
    }
    ...
    private static void generateTextureIds(int[] iArr) {
        ...
        if (iGlGetError != 0) {
            throw new GlException("glGenTextures failed. Error: " + Integer.toHexString(iGlGetError), null);
        }
    }
}
