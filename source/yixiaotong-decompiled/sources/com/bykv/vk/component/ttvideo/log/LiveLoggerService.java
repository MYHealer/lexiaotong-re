...
public class LiveLoggerService implements Handler.Callback {
    ...
    private com.byazt.f.c mNTPClient = null;
            ...
            if (map != null) {
                for (Map.Entry<String, String> entry : map.entrySet()) {
                    if (entry.getKey().equals("Host")) {
                        jSONObjectPut10.put("headers_host", entry.getValue().replace(PPSLabelView.Code, ""));
                        break;
                    }
                }
            }
    ...
    public void onUpdateSeiInfo(String str) {
        ...
        try {
            ...
            if (jSONObject2.has(ba.at)) {
                this.mLogBundle.seiSource = jSONObject2.getString(ba.at);
            ...
            if (jSONObject2.has("trans_info") || jSONObject2.has("tans_info")) {
                ...
                if (jSONObject != null) {
                    checkVideoFrame(jSONObject.getInt(com.hihonor.adsdk.base.g.j.e.a.L0), jSONObject.getInt("sent_frames"), jSONObject.getInt("checked_dts"));
                }
            }
    ...
    public void onSwitch(String str, String str2, String str3, int i) {
        ...
        try {
            ...
            jSONObjectPut2.put("next_cdn_play_url", str2).put("res_bitrate", this.mResBitrate).put("last_res", this.mLastResolution).put("code", i).put("reason", str3);
            this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
    ...
    public void onFirstFrameFail(int i) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "first_frame_failed").put(com.umeng.analytics.pro.d.p, System.currentTimeMillis()).put("reason", i);
    ...
    public void onRetry(int i) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "retry").put("reason", this.mErrorCode).put("code", i).put("render_fail_type", this.mRenderFailType);
                reportQuicOpenResult(jSONObjectCreateCommonLog);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
    ...
    public void onSDKDNSError(LiveError liveError) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                JSONObject jSONObjectPut = jSONObjectCreateCommonLog.put("event_key", "prepare_result").put(com.hihonor.adsdk.base.g.j.e.a.hnadst, liveError.getInfoJSON()).put("result", liveError.code);
    ...
    public void onPrepare(int i) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                long j = this.mFirstAudioPacketDTS;
                if (j > 0) {
                    long j2 = this.mPreviousAudioPacketDTS;
                    if (j2 <= 0 || j >= j2) {
                        i2 = 0;
                    } else {
                        i2 = 1;
                ...
                JSONObject jSONObjectPut = jSONObjectCreateCommonLog.put("event_key", "prepare_result").put(com.hihonor.adsdk.base.g.j.e.a.hnadst, i != 0 ? this.mLiveEngine.getPlayerErrorInfo() : "none").put("result", i);
                String str2 = this.mSdkParams;
                if (str2 != null) {
                    str = str2;
                }
                JSONObject jSONObjectPut2 = jSONObjectPut.put("sdk_params", str).put("first_audio_packet_dts_rollback", i2).put("first_audio_packet_dts", this.mFirstAudioPacketDTS).put("previous_audio_packet_dts", this.mPreviousAudioPacketDTS).put("stream_type", this.mLogBundle.mStreamType).put("suggest_format", this.mSuggestFormat).put("suggest_protocol", this.mSuggestProtocol);
                if (!this.mLiveEngine.getSRState() && !this.mLiveEngine.getSharpenState()) {
                    i3 = 0;
                }
                jSONObjectPut2.put("nnsr_enabled", i3);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j3 = this.mLogTotalCount;
                if (j3 > 0) {
                    this.mLogTotalCount = j3 + 1;
    ...
    public void onLoaderSwitch(int i, String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                ...
                jSONObjectPut.put("switch_info", str).put("p2p_vendor", "none").put("reason", i);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
                    this.mLogTotalCount = j + 1;
    ...
    public void onLoaderError(int i, String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "p2p_error").put(com.hihonor.adsdk.base.g.j.e.a.hnadst, str).put("code", i);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
                    this.mLogTotalCount = j + 1;
    ...
    private void onLink(boolean z) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "link").put("info", z ? "start" : TtmlNode.END);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j = this.mLogTotalCount;
                if (j > 0) {
                    this.mLogTotalCount = j + 1;
    ...
    public void onStop(String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                ...
                long j3 = this.mFirstStallStartTime;
                if (j3 > 0) {
                    j = j3 - this.mLogBundle.videoRenderTimestamp;
                ...
                long j5 = this.mLogTotalCount + 1;
                this.mLogTotalCount = j5;
                jSONObjectCreateCommonLog.put("log_total_count_when_playing", j5);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                this.mLogTotalCount = 0L;
            } catch (JSONException e) {
                m.c(e);
    ...
    public void ntp() {
        com.byazt.f.c cVar = this.mNTPClient;
        if (cVar == null) {
            return;
        }
        uj ujVarC = null;
        try {
            ...
            if (inetAddress != null) {
                ujVarC = this.mNTPClient.c(inetAddress);
            }
        ...
        long jTt = ujVarC.tt().t().tt();
        this.mTimeDiff = ((ujVarC.tt().u().tt() - jTt) + (ujVarC.tt().sl().tt() - System.currentTimeMillis())) / 2;
    }
    ...
    public void onErrorRecovered() {
        this.mIsInErrorRecovering = false;
        m.c(TAG, "recover from error time ".concat(String.valueOf(System.currentTimeMillis() - this.mErrorStartTime)));
