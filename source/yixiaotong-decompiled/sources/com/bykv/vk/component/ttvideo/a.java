...
public class a implements MediaPlayer {
    ...
    private MediaPlayerClient f2967a;
    ...
    public static MediaPlayer a(Context context, int i) {
        ...
        synchronized (a.class) {
            try {
                if (i == 1) {
                    aVar.f2967a = OSPlayerClient.create(aVar, context);
                    str = "MediaPlayerWrapper";
                    str2 = "create player type OS";
                } else {
                    aVar.f2967a = TTPlayerClient.create(aVar, context);
                    str = "MediaPlayerWrapper";
    ...
    public int getCurrentPosition() {
        MediaPlayerClient mediaPlayerClient = this.f2967a;
    ...
    public boolean isOSPlayer() {
        return this.f2967a instanceof OSPlayerClient;
    }
    ...
    public void setIsMute(boolean z) {
        ...
        if (!isOSPlayer()) {
            this.f2967a.setIsMute(z);
            return;
        }
        float f = z ? 0.0f : 1.0f;
        try {
            this.f2967a.setVolume(f, f);
    ...
    public void setSurface(Surface surface) {
        ...
        if ((surface == null || surface.isValid()) && (mediaPlayerClient = this.f2967a) != null) {
