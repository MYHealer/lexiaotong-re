...
public class DataLoaderHelper implements AVMDLDataLoaderListener, AVMDLStartCompleteListener {
    ...
    public class c {
        ...
        public class a {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            public String f2958a = null;
            public long b = 0;
            public long c = 0;
            public List<C0352a> d = null;
            public Error f = null;
            ...
            void a(long j) {
                ...
                if (this.d.size() == 0) {
                    this.d.add(new C0352a(this));
                }
                this.d.get(0).f2959a = 0L;
                this.d.get(0).b = j;
            }
            ...
            public boolean a() {
                ...
                List<C0352a> list = this.d;
                C0352a c0352a = list != null ? list.get(list.size() - 1) : null;
                if (this.f == null) {
                    return c0352a != null && this.b > 0 && c0352a.f2959a + c0352a.b >= jMin;
                }
                return true;
            }
    ...
    private class d {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final ReentrantLock f2960a;
        private final ArrayList<b> b;
        private long c;

        private d(DataLoaderHelper dataLoaderHelper) {
            this.f2960a = new ReentrantLock();
            this.b = new ArrayList<>();
            this.c = 0L;
        }

        /* synthetic */ d(DataLoaderHelper dataLoaderHelper, a aVar) {
            this(dataLoaderHelper);
        }
        ...
        public b b(b bVar) {
            b bVarC;
            if (TextUtils.isEmpty(bVar.f2955a)) {
                bVarC = null;
            } else {
                bVarC = d(bVar.f2955a);
                if (bVarC != null) {
            ...
            while (it.hasNext() && (bVarC = c(it.next().f2956a)) == null) {
            }
            return bVarC;
        }
        ...
        public b d(String str) {
            ...
            for (int i = 0; i < this.b.size(); i++) {
                b bVar2 = this.b.get(i);
                if (!TextUtils.isEmpty(bVar2.f2955a) && bVar2.f2955a.equals(str)) {
                    bVar = bVar2;
                    break;
                }
            }
    ...
    private void a(b bVar) {
        ...
        for (int i = 0; i < arrayListD.size(); i++) {
            ...
            if (!TextUtils.isEmpty(bVar2.f2955a) && !TextUtils.isEmpty(bVar.f2955a) && bVar2.f2955a.equals(bVar.f2955a)) {
                return;
            }
        }
        ArrayList<TTVideoEngine> arrayListA = a(bVar.f2955a);
    ...
    private void a(b bVar, b.a aVar) {
        ...
        TTVideoEngineLog.i("DataLoaderHelper", "[preload] start mdl preload task.  key = " + aVar.f2956a);
        String str = aVar.f2956a;
        String[] strArr = aVar.c;
        if (strArr != null) {
            String strA = a(str, bVar.f2955a, aVar.f, 0L, strArr, aVar.d);
            aVar.b = strA;
            if (!TextUtils.isEmpty(strA)) {
                ...
                TTVideoEngineLog.i("DataLoaderHelper", String.format("[preload] exect preload task ,key is %s; videoId = %s", aVar.f2956a, bVar.f2955a));
                return;
            }
        }
        bVar.a(-100001);
    ...
    private void a(AVMDLDataLoaderNotifyInfo aVMDLDataLoaderNotifyInfo, boolean z, boolean z2) {
        ...
        try {
            ...
            if (loadProgressByRawKey.b() || z2) {
                ...
                dataLoaderTaskProgressInfo.mVideoId = bVarB.f2955a;
    ...
    public String _proxyUrl(String str, String str2, long j, String[] strArr, String str3) {
        if (this.f2954a != 0 || TextUtils.isEmpty(str) || strArr == null || strArr.length <= 0) {
            return null;
        }
        String[] strArr2 = (String[]) strArr.clone();
        for (String str4 : strArr2) {
        ...
        if (i != 0 && i != 15) {
            ...
            if ((aVMDLDataLoaderNotifyInfo.logInfo == null || aVMDLDataLoaderNotifyInfo.parameter != 3) && aVMDLDataLoaderNotifyInfo.logInfo != null) {
                ...
                if (strArrSplit2.length > 0 && (bVarB = this.d.b((str = strArrSplit2[0]))) != null) {
                    ...
                    dVar.c(str);
                    TTVideoEngineLog.i("DataLoaderHelper", "pop all task item. videoId = " + bVarB.f2955a + " key = " + str);
                    removeLoadProgressByRawKey(str3);
