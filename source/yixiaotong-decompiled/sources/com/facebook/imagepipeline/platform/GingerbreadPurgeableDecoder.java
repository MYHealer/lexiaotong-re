    ...
    protected Bitmap decodeFileDescriptorAsPurgeable(CloseableReference<PooledByteBuffer> closeableReference, int i, byte[] bArr, BitmapFactory.Options options) throws Throwable {
        ...
        try {
            try {
                ...
                try {
                    Bitmap bitmap = (Bitmap) Preconditions.checkNotNull(BitmapFactory.decodeFileDescriptor(getMemoryFileDescriptor(memoryFileCopyToMemoryFile), null, options), "BitmapFactory returned null");
