    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        public void doDecode(EncodedImage encodedImage, boolean z) {
            ...
            try {
                ...
                QualityInfo qualityInfo = z ? ImmutableQualityInfo.FULL_QUALITY : getQualityInfo();
        ...
        private Map<String, String> getExtraMap(@Nullable CloseableImage closeableImage, long j, QualityInfo qualityInfo, boolean z) {
            ...
            if (closeableImage instanceof CloseableStaticBitmap) {
                ...
                return ImmutableMap.of(DecodeProducer.BITMAP_SIZE_KEY, underlyingBitmap.getWidth() + "x" + underlyingBitmap.getHeight(), "queueTime", strValueOf, DecodeProducer.HAS_GOOD_QUALITY_KEY, strValueOf2, DecodeProducer.IS_FINAL_KEY, strValueOf3);
            }
            return ImmutableMap.of("queueTime", strValueOf, DecodeProducer.HAS_GOOD_QUALITY_KEY, strValueOf2, DecodeProducer.IS_FINAL_KEY, strValueOf3);
        }
