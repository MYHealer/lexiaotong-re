...
public class ImagePipelineConfig {
    ...
    private ImagePipelineConfig(Builder builder) {
        ...
        this.mBitmapMemoryCacheParamsSupplier = builder.mBitmapMemoryCacheParamsSupplier == null ? new DefaultBitmapMemoryCacheParamsSupplier((ActivityManager) builder.mContext.getSystemService(TTDownloadField.TT_ACTIVITY)) : builder.mBitmapMemoryCacheParamsSupplier;
    ...
    private static DiskCacheConfig getDefaultMainDiskCacheConfig(final Context context) {
        return DiskCacheConfig.newBuilder().setBaseDirectoryPathSupplier(new Supplier<File>() { // from class: com.facebook.imagepipeline.core.ImagePipelineConfig.2
            ...
            @Override // com.facebook.common.internal.Supplier
            public File get() {
                return StubApp.getOrigApplicationContext(context.getApplicationContext()).getCacheDir();
            }
        }).setBaseDirectoryName("image_cache").setMaxCacheSize(41943040L).setMaxCacheSizeOnLowDiskSpace(10485760L).setMaxCacheSizeOnVeryLowDiskSpace(PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE).build();
    }
