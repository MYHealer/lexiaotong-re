...
public class DefaultDiskStorage implements DiskStorage {
    ...
    /* JADX INFO: renamed from: com.facebook.cache.disk.DefaultDiskStorage$1, reason: invalid class name */
    ...
    private class EntriesCollector implements FileTreeVisitor {
        ...
        public void visitFile(File file) {
            ...
            this.result.add(new EntryImpl(DefaultDiskStorage.this, file, null));
        }
    ...
    private String typeOfBytes(byte[] bArr) {
        ...
        return (b == 71 && bArr[1] == 73) ? "gif" : "undefined";
    }
