...
public class SoftDecTool {
    ...
    public static volatile boolean f1954a = false;
    public static volatile double acs = -1.0d;
    public static volatile long act;
    ...
    public static JSONObject gdh() {
        try {
            ...
            jSONObject.put(com.hihonor.adsdk.base.g.j.e.a.k, a.c("ro.build.display.id", ""));
    ...
    public static JSONObject t() {
        try {
            if (System.currentTimeMillis() - LastReportTooltypeTime <= C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS || codeIdCountMap.isEmpty()) {
                return null;
            }
            JSONObject jSONObject = new JSONObject();
