...
public class PangleNativeAdapter extends UMNCustomNativeAdapter {
    private final String OooO00o = this.customTag + "PangleNativeAdapter";
    public WeakReference<Context> OooO0O0;

    private void OooO00o(UMNNativeParams uMNNativeParams, o00O000 o00o000) {
        PangleNativeExpressAd pangleNativeExpressAd = new PangleNativeExpressAd(this.OooO0O0.get(), uMNNativeParams, o00o000.OooO00o.OooO0o0);
    ...
    private void OooO0O0(UMNNativeParams uMNNativeParams, o00O000 o00o000) {
        PangleNativeAd pangleNativeAd = new PangleNativeAd(this.OooO0O0.get(), uMNNativeParams, o00o000.OooO00o.OooO0o0, this.nativeInfo);
    ...
    public void loadCustomAd(Context context, final o00O000 o00o000, Object... objArr) {
        ...
        if (!TextUtils.isEmpty(o00o000.OooO00o.OooO0Oo) && !TextUtils.isEmpty(o00o000.OooO00o.OooO0o0) && objArr != null) {
            PangleInitManager.getInstance().initSDK(context, o00o000, new o00O0OO0() { // from class: com.ubixnow.network.pangle.PangleNativeAdapter.1
                @Override // com.ubixnow.ooooo.o00O0OO0
                public void onError(Throwable th) {
                    o00O00o0 o00o00o0 = PangleNativeAdapter.this.loadListener;
                    if (o00o00o0 != null) {
                        o00o00o0.onNoAdError(new ErrorInfo("500041", PangleInitManager.getInstance().getName() + oOO00O0.ubix_initError_msg + th.getMessage()).setInfo((Object) PangleNativeAdapter.this.nativeInfo));
                    }
                }

                @Override // com.ubixnow.ooooo.o00O0OO0
                public void onSuccess() {
                    PangleNativeAdapter.this.loadAd(o00o000);
                }
            });
            return;
        }
        ...
        if (o00o00o0 != null) {
            o00o00o0.onNoAdError(new ErrorInfo(oOO00O0.ubix_appIdorPlaceIdNull, PangleInitManager.getInstance().getName() + oOO00O0.ubix_appIdorPlaceIdNull_msg).setInfo((Object) this.nativeInfo));
        }
    }
}
