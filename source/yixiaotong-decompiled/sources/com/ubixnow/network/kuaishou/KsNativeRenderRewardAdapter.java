...
public class KsNativeRenderRewardAdapter extends o0000Ooo {
    /* JADX INFO: Access modifiers changed from: private */
    public void loadAd(Context context) {
        o00O000 o00o000 = this.mBaseAdConfig;
        oO0O0OoO oo0o0ooo = o00o000.OooO00o;
        new KsNativeAd(context, oo0o0ooo.OooO0o0, o00o000.OooOOOO, o00o000.OooOOO0, oo0o0ooo).loadAd("12", this.OooO0o, this.OooOOo);
    }
    ...
    public void loadRewardAd(final Context context, o00O000 o00o000) {
        ...
        if (TextUtils.isEmpty(o00o000.OooO00o.OooO0Oo) || TextUtils.isEmpty(o00o000.OooO00o.OooO0o0)) {
            ...
            KsInitManager.getInstance().initSDK(BaseUtils.getContext(), o00o000, new o00O0OO0() { // from class: com.ubixnow.network.kuaishou.KsNativeRenderRewardAdapter.1
                @Override // com.ubixnow.ooooo.o00O0OO0
                public void onError(Throwable th) {
                    KsNativeRenderRewardAdapter.this.callNoAdError(new ErrorInfo("500041", KsInitManager.getInstance().getName() + oOO00O0.ubix_initError_msg + th.getMessage()).setInfo((Object) KsNativeRenderRewardAdapter.this.absUbixInfo));
                }

                @Override // com.ubixnow.ooooo.o00O0OO0
                public void onSuccess() {
                    KsNativeRenderRewardAdapter.this.loadAd(context);
                }
            });
        }
    }
