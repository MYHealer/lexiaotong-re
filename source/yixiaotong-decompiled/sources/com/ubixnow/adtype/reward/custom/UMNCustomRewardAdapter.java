package com.ubixnow.adtype.reward.custom;
...
public abstract class UMNCustomRewardAdapter extends o00O {
    public o00000 eventListener;
    public String customTag = "----ubixReward_lm_";
    public oo00o<UMNCustomRewardAdapter> absUbixInfo = new oo00o<UMNCustomRewardAdapter>() { // from class: com.ubixnow.adtype.reward.custom.UMNCustomRewardAdapter.1
    };
    ...
    public abstract void loadRewardAd(Context context, o00O000 o00o000);

    public void onAdDataLoadFailed(int i, String str) {
        showLog(this.customTag + getClass().getSimpleName(), "onAdDataLoaded " + str);
    ...
    public void onAdRenderFail(String str, String str2) {
        showLog(this.customTag + getClass().getSimpleName(), "onRenderFail " + str2);
        o00O00o0 o00o00o0 = this.loadListener;
        if (o00o00o0 != null) {
    ...
    public void setEventListener(o00000 o00000Var) {
        this.eventListener = o00000Var;
    }
