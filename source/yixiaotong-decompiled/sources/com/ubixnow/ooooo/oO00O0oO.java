...
public final class oO00O0oO extends oOo0000O {
    private static volatile oO00O0oO[] OooO0O0;
    ...
    public static oO00O0oO OooO00o(byte[] bArr) throws oO0OO00o {
        return (oO00O0oO) oOo0000O.OooO00o(new oO00O0oO(), bArr);
    }

    public static oO00O0oO OooO0OO(oO00o000 oo00o000) throws IOException {
        return new oO00O0oO().OooO00o(oo00o000);
    }

    public static oO00O0oO[] OooO0o() {
        if (OooO0O0 == null) {
            synchronized (oOo00ooO.OooOo0) {
                if (OooO0O0 == null) {
                    OooO0O0 = new oO00O0oO[0];
                }
            }
        }
        return OooO0O0;
    ...
    public oO00O0oO OooO00o(oO00o000 oo00o000) throws IOException {
        while (true) {
