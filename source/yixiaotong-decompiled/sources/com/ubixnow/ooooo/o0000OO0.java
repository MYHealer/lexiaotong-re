...
public class o0000OO0 extends o000OO {
    ...
    public o0000OO0(Activity activity, o000OO.OooO00o oooO00o) {
    ...
    @Override // com.ubixnow.ooooo.o000OO
    public void OooO0O0() {
        float f = this.OooOoo0 / 360.0f;
        this.OooOO0O = f;
        float f2 = this.OooOoo / 800.0f;
        this.OooOO0o = f2;
    ...
    public void OooOOO() {
        ...
        layoutParams.rightMargin = OooO0O0(5);
        layoutParams.topMargin = OooO0O0(50);
        int iOooO0O0 = OooO0O0(27);
        ...
        layoutParams2.rightMargin = OooO0O0(9);
        layoutParams2.width = OooO0O0(135);
        layoutParams2.height = OooO0O0(27);
        this.OooO0oo.setTextSize(2, OooO00o(11));
        this.OooO0oo.setBackground(OooO00o(this.OooO0OO.getContext(), Integer.MIN_VALUE, OooO00o(6), 1.0f, -1));
        if (this.OooOoO != null) {
        ...
        layoutParams4.bottomMargin = OooO0O0(41);
        ...
        layoutParams5.rightMargin = OooO0Oo(8);
