...
public class ooOOO00O {
    ...
    public static Bitmap OooO00o(Bitmap bitmap) {
        try {
            ...
            try {
                return OooO00o(Bitmap.createScaledBitmap(bitmap, bitmap.getWidth() / 50, bitmap.getHeight() / 50, false), 5, false);
            } catch (Exception e) {
                ooooO000.OooO00o(e);
                return null;
            }
    ...
    public static Bitmap OooO00o(Bitmap bitmap, int i, boolean z) {
        Bitmap bitmap2;
        int i2;
        int i3;
        int[] iArr;
        ...
        while (true) {
            ...
            while (true) {
                ...
                int i29 = iArr2[i16 + Math.min(i6, Math.max(i27, 0))];
        ...
        while (i54 < width) {
            ...
            int i73 = 0;
            while (i73 < i72) {
                iArr14[i71] = (iArr14[i71] & (-16777216)) | (iArr13[i57] << 16) | (iArr13[i67] << 8) | iArr13[i66];
                int i74 = i57 - i60;
                int i75 = i67 - i59;
                int i76 = i66 - i58;
