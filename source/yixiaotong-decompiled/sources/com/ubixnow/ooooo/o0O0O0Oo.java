...
public class o0O0O0Oo {
    ...
    public class OooO00o implements Runnable {
        ...
        public void run() {
            try {
                o0O0O0Oo.this.OooO00o(this.OooO00o);
            } catch (Throwable th) {
                ooooO000.OooO00o(th);
            }
        }
    ...
    public class OooO0O0 implements View.OnTouchListener {
        ...
        public class OooO00o implements Runnable {
            ...
            public void run() {
                ...
                o0O0O0Oo.this.OooO00o(oooO0O0.OooO00o);
                o0O0O0Oo.this.OooO0o0();
            }
        }
    ...
    public o0O0O0Oo(o00O000 o00o000, oo00o oo00oVar, ViewGroup viewGroup, View view, int i, int i2) {
    ...
    private void OooO0OO(oOO00O ooo00o) {
        this.OooO0o = new FrameLayout(this.OooO0Oo.getContext());
