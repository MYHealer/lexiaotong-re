...
public final class o {
    ...
    public void a(int i, int i2) {
        ...
        int i8 = i6 + 1;
        while (i7 > 8) {
            this.f6509a[i8] = (byte) (i >>> (i7 - 8));
            i7 -= 8;
            i8++;
        }
        int i9 = 8 - i7;
        byte[] bArr2 = this.f6509a;
    ...
    public void b(byte[] bArr, int i, int i2) {
        a.b(this.c == 0);
        System.arraycopy(this.f6509a, this.b, bArr, i, i2);
        this.b += i2;
        g();
    }
    ...
    public boolean e() {
        boolean z = (this.f6509a[this.b] & (128 >> this.c)) != 0;
        d();
        return z;
    }
