...
public final class i {
    ...
    public static final com.opos.exoplayer.core.metadata.id3.a.InterfaceC0929a f6367a = new a();
    private static final Pattern d = Pattern.compile("^ [0-9a-fA-F]{8} ([0-9a-fA-F]{8}) ([0-9a-fA-F]{8})");
    public int b = -1;
    public int c = -1;

    static class a implements com.opos.exoplayer.core.metadata.id3.a.InterfaceC0929a {
        a() {
        }

        @Override // com.opos.exoplayer.core.metadata.id3.a.InterfaceC0929a
