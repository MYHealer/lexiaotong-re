...
public final class y extends com.heytap.nearx.a.a.b<y, a> {
    ...
    private static final class b extends com.heytap.nearx.a.a.e<y> {
        ...
        public int a(y yVar) {
            return (yVar.d != null ? com.heytap.nearx.a.a.e.p.a(1, yVar.d) : 0) + (yVar.e != null ? com.heytap.nearx.a.a.e.p.a(2, yVar.e) : 0) + (yVar.f != null ? com.heytap.nearx.a.a.e.p.a(3, yVar.f) : 0) + yVar.a().size();
        }

        @Override // com.heytap.nearx.a.a.e
        public void a(com.heytap.nearx.a.a.g gVar, y yVar) throws IOException {
            if (yVar.d != null) {
                com.heytap.nearx.a.a.e.p.a(gVar, 1, yVar.d);
            }
            if (yVar.e != null) {
                com.heytap.nearx.a.a.e.p.a(gVar, 2, yVar.e);
            }
            if (yVar.f != null) {
                com.heytap.nearx.a.a.e.p.a(gVar, 3, yVar.f);
            }
            gVar.a(yVar.a());
        }
    ...
    public String toString() {
        ...
        if (this.d != null) {
            sb.append(", region=").append(this.d);
        }
        if (this.e != null) {
            sb.append(", language=").append(this.e);
        }
        if (this.f != null) {
            sb.append(", country=").append(this.f);
        }
