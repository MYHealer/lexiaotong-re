...
public class s implements d {
    ...
    private com.opos.mobad.template.cmn.baseview.c f8205a;
    ...
    private final View.OnTouchListener w = new View.OnTouchListener() { // from class: com.opos.mobad.template.i.s.1
        @Override // android.view.View.OnTouchListener
        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (motionEvent.getAction() == 0) {
                s.this.i = (int) motionEvent.getX();
                s.this.j = (int) motionEvent.getY();
                s.this.n = false;
            } else if (2 == motionEvent.getAction()) {
                int y = (int) motionEvent.getY();
                int x = (int) motionEvent.getX();
                if (s.this.d == j.SLIDE_UP && y <= 0 && !s.this.n) {
                    s.this.a(x, y);
                }
            } else if (1 == motionEvent.getAction()) {
                s.this.k = (int) motionEvent.getX();
                s.this.l = (int) motionEvent.getY();
                if (s.this.d == j.SLIDE_UP && ((s.this.i == s.this.k && s.this.j == s.this.l) || (s.this.j - s.this.l > ((double) s.this.m) * 0.4d && !s.this.n))) {
                    s sVar = s.this;
                    sVar.a(sVar.k, s.this.l);
                }
            }
            return true;
        }
    };
    private final Runnable x = new Runnable() { // from class: com.opos.mobad.template.i.s.2
        ...
        public void run() {
            ...
            s.this.p.start();
            s.this.o.a(ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
        }
    };
    private final int[] s = {1728053247, ViewCompat.MEASURED_SIZE_MASK};

    public s(Context context, j jVar, int i) {
        ...
        this.m = iA2;
        this.f8205a = new com.opos.mobad.template.cmn.baseview.c(context);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, iA2);
        this.f8205a.setPadding(0, 0, 0, com.opos.cmn.an.h.f.a.a(context, iA));
        layoutParams.addRule(13);
        this.b.addView(this.f8205a, layoutParams);
    ...
    private ValueAnimator a(final View view, int i, int i2) {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.opos.mobad.template.i.s.3
    ...
    private void g() {
        this.f8205a.setOnTouchListener(this.w);
    }
    ...
    private void h() {
        ...
        this.f8205a.addView(this.f, layoutParams);
        a(this.f);
    }
    ...
    private void i() {
        ...
        layoutParams.bottomMargin = com.opos.cmn.an.h.f.a.a(this.c, 4.0f);
        this.f8205a.addView(this.g, layoutParams);
        a(this.g);
    }
    ...
    private void j() {
        ...
        layoutParams4.bottomMargin = com.opos.cmn.an.h.f.a.a(this.c, 7.0f);
        this.f8205a.addView(relativeLayout, layoutParams4);
    }
