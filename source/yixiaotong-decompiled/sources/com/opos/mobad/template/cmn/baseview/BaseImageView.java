...
public class BaseImageView extends ImageView implements e {
    ...
    public boolean callOnClick() {
        return g.a(this, this.f7488a, this.b) && super.callOnClick();
    }

    @Override // android.view.View
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (g.a(this, this.f7488a, motionEvent, this.b)) {
    ...
    public boolean performClick() {
        return g.b(this, this.f7488a, this.b) && super.performClick();
    }
}
