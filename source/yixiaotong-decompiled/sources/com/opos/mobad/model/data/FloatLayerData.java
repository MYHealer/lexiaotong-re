...
public class FloatLayerData extends a implements Parcelable {
    ...
    private MaterialFileData f7192a;
    private String b;
    private String c;
    ...
    public FloatLayerData(t tVar, MaterialFileData materialFileData, List<MaterialFileData> list, List<MaterialFileData> list2) {
        this.f7192a = materialFileData;
        this.d = list;
        this.e = list2;
        this.b = tVar.e != null ? tVar.e : "";
        this.c = tVar.f != null ? tVar.f : "";
    }
    ...
    public String toString() {
        return "FloatLayerData{iconFile='" + this.f7192a + "'title='" + this.b + "'desc='" + this.c + "'imgFileList='" + this.d + "'interactiveFileList='" + this.e + "'}";
    }
