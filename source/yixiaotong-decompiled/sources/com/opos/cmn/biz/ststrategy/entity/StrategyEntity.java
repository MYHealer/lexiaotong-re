...
public class StrategyEntity {
    ...
    /* JADX INFO: renamed from: com.opos.cmn.biz.ststrategy.entity.StrategyEntity$1, reason: invalid class name */
    ...
    public static class Builder {
        ...
        public StrategyEntity build() {
            return new StrategyEntity(this, null);
        }
        ...
        public Builder setPrtflg(int i) {
            this.prtflg = i;
            return this;
        }
        ...
        public Builder setTriggerNums(int i) {
            this.triggerNums = i;
            return this;
        }

        public Builder setWfTime(int i) {
            this.wfTime = i;
            return this;
        }
    }
