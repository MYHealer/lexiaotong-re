...
public abstract class ViewPropertyAnimator {
    ...
    public static ViewPropertyAnimator animate(View view) {
        ...
        ViewPropertyAnimator viewPropertyAnimatorPreHC = weakHashMap.get(view);
        if (viewPropertyAnimatorPreHC == null) {
            int iIntValue = Integer.valueOf(Build.VERSION.SDK).intValue();
            if (iIntValue >= 14) {
                viewPropertyAnimatorPreHC = new ViewPropertyAnimatorICS(view);
            } else if (iIntValue >= 11) {
                viewPropertyAnimatorPreHC = new ViewPropertyAnimatorHC(view);
            } else {
                viewPropertyAnimatorPreHC = new ViewPropertyAnimatorPreHC(view);
            }
