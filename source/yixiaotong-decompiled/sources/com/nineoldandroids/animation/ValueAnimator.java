...
public class ValueAnimator extends Animator {
    ...
    public void setCurrentPlayTime(long j) {
        ...
        animationFrame(jCurrentAnimationTimeMillis);
    }
    ...
    private static class AnimationHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                if (valueAnimator2.delayedAnimationFrame(jCurrentAnimationTimeMillis)) {
            ...
            while (i5 < size4) {
                ...
                if (valueAnimator4.animationFrame(jCurrentAnimationTimeMillis)) {
            ...
            if (z) {
                ...
                sendEmptyMessageDelayed(1, Math.max(0L, ValueAnimator.sFrameDelay - (AnimationUtils.currentAnimationTimeMillis() - jCurrentAnimationTimeMillis)));
            }
        }
    }
    ...
    boolean animationFrame(long j) {
        ...
        float fMin = j3 > 0 ? (j - this.mStartTime) / j3 : 1.0f;
        if (fMin >= 1.0f) {
    ...
    public ValueAnimator mo996clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo996clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo1000clone = propertyValuesHolderArr[i2].mo1000clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo1000clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo1000clone.getPropertyName(), propertyValuesHolderMo1000clone);
            }
        }
        return valueAnimator;
    }
