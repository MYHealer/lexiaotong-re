...
public final class Iconify {
    ...
    public static CharSequence compute(CharSequence charSequence) {
        if (charSequence instanceof Spanned) {
            return Html.fromHtml(Utils.replaceIcons(new StringBuilder(Html.toHtml((Spanned) charSequence))).toString());
        }
        return Utils.replaceIcons(new StringBuilder(charSequence.toString()));
    }
