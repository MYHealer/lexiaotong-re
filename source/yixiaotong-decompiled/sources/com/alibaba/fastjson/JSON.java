...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    public static String DEFFAULT_DATE_FORMAT = TimeUtils.FORMATDATETIME;
    ...
    public static final Object parse(byte[] bArr, int i, int i2, CharsetDecoder charsetDecoder, int i3) {
        ...
        DefaultJSONParser defaultJSONParser = new DefaultJSONParser(chars, charBufferWrap.position(), ParserConfig.getGlobalInstance(), i3);
        Object obj = defaultJSONParser.parse();
        defaultJSONParser.handleResovleTask(obj);
        defaultJSONParser.close();
        return obj;
    ...
    public static final <T> T parseObject(byte[] bArr, Type type, Feature... featureArr) {
        return (T) parseObject(bArr, 0, bArr.length, ThreadLocalCache.getUTF8Decoder(), type, featureArr);
    }
    ...
    public static final <T> T parseObject(byte[] bArr, int i, int i2, CharsetDecoder charsetDecoder, Type type, Feature... featureArr) {
        ...
        CharBuffer charBufferWrap = CharBuffer.wrap(chars);
        IOUtils.decode(charsetDecoder, byteBufferWrap, charBufferWrap);
        return (T) parseObject(chars, charBufferWrap.position(), type, featureArr);
    }
