...
public class DefaultFieldDeserializer extends FieldDeserializer {
    ...
    public void parseField(DefaultJSONParser defaultJSONParser, Object obj, Type type, Map<String, Object> map) {
        ...
        Object objDeserialze = this.fieldValueDeserilizer.deserialze(defaultJSONParser, getFieldType(), this.fieldInfo.getName());
        ...
        if (obj == null) {
            map.put(this.fieldInfo.getName(), objDeserialze);
        } else {
