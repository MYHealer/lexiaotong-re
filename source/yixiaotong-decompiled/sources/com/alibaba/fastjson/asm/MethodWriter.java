...
class MethodWriter implements MethodVisitor {
    ...
    public void visitVarInsn(int i, int i2) {
        if (i2 < 4 && i != 169) {
            ...
            this.code.putByte(MediaPlayer.MEDIA_PLAYER_OPTION_PRE_DECODE_AUTO_PAUSE).put12(i, i2);
        } else {
            this.code.put11(i, i2);
        }
    }
    ...
    final void put(ByteVector byteVector) {
        int i = this.access;
        byteVector.putShort(i & (~(((262144 & i) / 64) | 393216))).putShort(this.name).putShort(this.desc);
