...
public final class b {
    ...
    private static final class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final b f9201a = new b();
    ...
    public static void a(Context context, String str, String str2, String str3) {
        ...
        if (context == null || (sharedPreferences = StubApp.getOrigApplicationContext(context.getApplicationContext()).getSharedPreferences(str, 0)) == null || (editorEdit = sharedPreferences.edit()) == null) {
            return;
        }
    ...
    public static void a(Context context, String str) {
        SharedPreferences.Editor editorEdit = StubApp.getOrigApplicationContext(context.getApplicationContext()).getSharedPreferences(str, 0).edit();
