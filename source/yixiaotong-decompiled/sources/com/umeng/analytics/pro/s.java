...
public class s {
    ...
    private static final String f9177a = "fs_lc_tl_uapp";
    ...
    /* JADX INFO: renamed from: com.umeng.analytics.pro.s$1, reason: invalid class name */
    /* JADX INFO: compiled from: EventTracker.java */
    ...
    private static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final s f9178a = new s(null);
    ...
    private void b(Context context) {
        try {
            String string = PreferenceWrapper.getDefault(context).getString(f9177a, null);
    ...
    private void c(Context context) {
        try {
            if (this.h != null) {
                PreferenceWrapper.getDefault(g).edit().putString(f9177a, this.h.toString()).commit();
            }
        } catch (Throwable unused) {
        }
    }
