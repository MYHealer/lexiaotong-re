...
public final class aw {
    ...
    private static final Comparator f9108a = new a(null);

    /* JADX INFO: renamed from: com.umeng.analytics.pro.aw$1, reason: invalid class name */
    /* JADX INFO: compiled from: TBaseHelper.java */
    ...
    public static int a(List list, List list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            int iCompare = f9108a.compare(list.get(i), list2.get(i));
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int iCompare = f9108a.compare(it.next(), it2.next());
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    private static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            if (obj instanceof List) {
                return aw.a((List) obj, (List) obj2);
            }
            if (obj instanceof Set) {
                return aw.a((Set) obj, (Set) obj2);
            }
            if (obj instanceof Map) {
                return aw.a((Map) obj, (Map) obj2);
            }
            if (obj instanceof byte[]) {
                return aw.a((byte[]) obj, (byte[]) obj2);
            }
            return aw.a((Comparable) obj, (Comparable) obj2);
        }
    }
