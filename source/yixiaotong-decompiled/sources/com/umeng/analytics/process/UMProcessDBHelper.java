...
public class UMProcessDBHelper {
    ...
    /* JADX WARN: Code duplicated, block: B:79:0x018e A[EXC_TOP_SPLITTER, SYNTHETIC] */
        ...
        try {
            try {
                ...
                try {
                    ...
                    cursorQuery = sQLiteDatabaseA.query(com.umeng.analytics.process.a.InterfaceC1148a.f9194a, null, null, null, null, null, null);
                    if (cursorQuery != null) {
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            String string3 = cursorQuery.getString(cursorQuery.getColumnIndex(com.umeng.analytics.process.a.InterfaceC1148a.f));
                            ...
                            if (!TextUtils.isEmpty(string)) {
                                ...
                                if (!TextUtils.isEmpty(string2) && i2 == 2049) {
                                    ...
                                    if (TextUtils.isEmpty(strOptString) || "unknown".equals(strOptString)) {
                                        jSONObject3.put("pn", this.mContext.getPackageName() + x.bQ + string3);
                                    }
    ...
    /* JADX WARN: Code duplicated, block: B:16:0x004a A[DONT_GENERATE, PHI: r1
  0x004a: PHI (r1v5 android.database.sqlite.SQLiteDatabase) = (r1v4 android.database.sqlite.SQLiteDatabase), (r1v6 android.database.sqlite.SQLiteDatabase) binds: [B:15:0x0048, B:8:0x0035] A[DONT_GENERATE, DONT_INLINE]] */
    public void deleteMainProcessEventDatasByIds(List<Integer> list) {
        ...
        try {
            ...
            while (it.hasNext()) {
                sQLiteDatabaseA.delete(com.umeng.analytics.process.a.InterfaceC1148a.f9194a, "id=?", new String[]{String.valueOf(it.next())});
            }
            sQLiteDatabaseA.setTransactionSuccessful();
        } catch (Exception unused) {
        } finally {
    ...
    public void deleteEventDatas(String str, String str2, List<a> list) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                int size = list.size();
                if (list == null || size <= 0) {
                    sQLiteDatabaseA.delete(com.umeng.analytics.process.a.InterfaceC1148a.f9194a, null, null);
                } else {
                    for (int i = 0; i < size; i++) {
                        sQLiteDatabaseA.execSQL("delete from __et_p where rowid=" + list.get(i).f9192a);
                    }
                }
                sQLiteDatabaseA.setTransactionSuccessful();
                if (sQLiteDatabaseA != null) {
                ...
                try {
                    ...
                    for (a aVar : list) {
                        try {
                            ...
                            contentValues.put(com.umeng.analytics.process.a.InterfaceC1148a.f, aVar.f);
                            contentValues.put("__av", aVar.g);
                            contentValues.put("__vc", aVar.h);
                            contentValues.put("__s", aVar.d);
                            sQLiteDatabaseA.insert(com.umeng.analytics.process.a.InterfaceC1148a.f9194a, null, contentValues);
                        } catch (Exception unused) {
                        }
                    }
                    sQLiteDatabaseA.setTransactionSuccessful();
    ...
    /* JADX WARN: Code duplicated, block: B:26:0x006a A[Catch: Exception -> 0x006d, TRY_LEAVE, TryCatch #1 {Exception -> 0x006d, blocks: (B:24:0x0065, B:26:0x006a), top: B:53:0x0065 }] */
    /* JADX WARN: Code duplicated, block: B:38:0x008a A[Catch: Exception -> 0x008d, TRY_LEAVE, TryCatch #2 {Exception -> 0x008d, blocks: (B:36:0x0085, B:38:0x008a), top: B:55:0x0085 }] */
    /* JADX WARN: Code duplicated, block: B:45:0x00a0 A[Catch: Exception -> 0x00a3, TRY_LEAVE, TryCatch #9 {Exception -> 0x00a3, blocks: (B:43:0x009b, B:45:0x00a0), top: B:62:0x009b }] */
    public JSONObject readVersionInfoFromColumId(Integer num) throws Throwable {
        ...
        try {
            ...
            try {
                try {
                    sQLiteDatabaseA.beginTransaction();
                    Cursor cursorQuery = sQLiteDatabaseA.query(com.umeng.analytics.process.a.InterfaceC1148a.f9194a, null, "rowid=?", new String[]{String.valueOf(num)}, null, null, null);
                    if (cursorQuery != null) {
                        try {
                            try {
    ...
    /* JADX WARN: Code duplicated, block: B:28:0x00ae A[Catch: Exception -> 0x00b1, PHI: r2
  0x00ae: PHI (r2v6 android.database.sqlite.SQLiteDatabase) = (r2v5 android.database.sqlite.SQLiteDatabase), (r2v9 android.database.sqlite.SQLiteDatabase) binds: [B:27:0x00ac, B:14:0x0093] A[DONT_GENERATE, DONT_INLINE], TRY_LEAVE, TryCatch #7 {Exception -> 0x00b1, blocks: (B:26:0x00a9, B:28:0x00ae, B:13:0x0090), top: B:46:0x0006 }] */
    /* JADX WARN: Code duplicated, block: B:35:0x00c2 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:36:0x00c4 A[Catch: Exception -> 0x00c7, TRY_LEAVE, TryCatch #4 {Exception -> 0x00c7, blocks: (B:34:0x00bf, B:36:0x00c4), top: B:43:0x00bf }] */
    /* JADX WARN: Code duplicated, block: B:43:0x00bf A[EXC_TOP_SPLITTER, SYNTHETIC] */
                    ...
                    if (cursorQuery != null) {
                        while (cursorQuery.moveToNext()) {
                            try {
                                try {
                                    a aVar = new a();
                                    aVar.f9192a = cursorQuery.getInt(0);
                                    ...
                                    aVar.f = cursorQuery.getString(cursorQuery.getColumnIndex(com.umeng.analytics.process.a.InterfaceC1148a.f));
