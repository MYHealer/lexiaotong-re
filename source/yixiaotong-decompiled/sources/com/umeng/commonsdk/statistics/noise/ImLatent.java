...
public class ImLatent implements d {
    ...
    private final int _DEFAULT_HOURS = MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_DEMUXER_STALL;
    private final int _DEFAULT_MIN_HOURS = 36;
    private final int _DEFAULT_MIN_LATENT = 1;
    private final int _DEFAULT_MAX_LATENT = 1800;
    private final long _ONE_HOURS_IN_MS = bg.s;
    ...
    public void onImprintChanged(ImprintHandler.a aVar) {
        int i = MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_DEMUXER_STALL;
        int iIntValue = Integer.valueOf(aVar.a("latent_hours", String.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_DEMUXER_STALL))).intValue();
        if (iIntValue > 36) {
            i = iIntValue;
        }
        this.latentHour = ((long) i) * bg.s;
        int iIntValue2 = Integer.valueOf(aVar.a(am.aR, "0")).intValue();
