...
public class ImprintHandler implements FileLockCallback {
    ...
    private static final String f9260a = "ImprintHandler";
    ...
    private com.umeng.commonsdk.statistics.proto.d a(com.umeng.commonsdk.statistics.proto.d dVar, com.umeng.commonsdk.statistics.proto.d dVar2, Map<String, String> map) {
        ...
        for (Map.Entry<String, com.umeng.commonsdk.statistics.proto.e> entry : dVar2.c().entrySet()) {
            ...
            if (entry.getValue().d()) {
                String key = entry.getKey();
                String str = entry.getValue().f9289a;
                synchronized (p) {
    ...
    private com.umeng.commonsdk.statistics.proto.d e(com.umeng.commonsdk.statistics.proto.d dVar) {
        ...
        while (true) {
            ...
            if (!next.getValue().d()) {
                ...
                String str = next.getValue().f9289a;
                synchronized (p) {
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private Map<String, String> f9261a = new HashMap();

        a() {
        }

        public synchronized void a(String str) {
            Map<String, String> map = this.f9261a;
            if (map != null && map.size() > 0 && !TextUtils.isEmpty(str) && this.f9261a.containsKey(str)) {
                this.f9261a.remove(str);
            }
        }
                        ...
                        for (String str : mapC.keySet()) {
                            if (!TextUtils.isEmpty(str) && (eVar = mapC.get(str)) != null) {
                                ...
                                if (TextUtils.isEmpty(strB)) {
                                    ...
                                    this.f9261a.put(str, strB);
                                    if (AnalyticsConstants.UM_DEBUG) {
                                        Log.i(ImprintHandler.f9260a, "imKey is " + str + ", imValue is " + strB);
                                    } else {
                                        continue;
                                    }
                                }
        ...
        public synchronized String a(String str, String str2) {
            if (!TextUtils.isEmpty(str) && this.f9261a.size() > 0) {
                String str3 = this.f9261a.get(str);
