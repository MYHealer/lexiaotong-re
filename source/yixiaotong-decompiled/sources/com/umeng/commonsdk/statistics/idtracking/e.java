...
public class e {
    ...
    public static final long f9266a = 86400000;
    ...
    private void a(com.umeng.commonsdk.statistics.proto.c cVar) {
        if (cVar == null || cVar.f9285a == null) {
            return;
        }
        if (cVar.f9285a.containsKey(Constant.KEY_MAC) && !FieldManager.allow(com.umeng.commonsdk.utils.b.h)) {
            cVar.f9285a.remove(Constant.KEY_MAC);
        }
        if (cVar.f9285a.containsKey("imei") && !FieldManager.allow(com.umeng.commonsdk.utils.b.g)) {
            cVar.f9285a.remove("imei");
        }
        if (cVar.f9285a.containsKey("android_id") && !FieldManager.allow(com.umeng.commonsdk.utils.b.i)) {
            cVar.f9285a.remove("android_id");
        }
        if (cVar.f9285a.containsKey("serial") && !FieldManager.allow(com.umeng.commonsdk.utils.b.j)) {
            cVar.f9285a.remove("serial");
        }
        if (cVar.f9285a.containsKey("idfa") && !FieldManager.allow(com.umeng.commonsdk.utils.b.w)) {
            cVar.f9285a.remove("idfa");
        }
        if (!cVar.f9285a.containsKey("oaid") || FieldManager.allow(com.umeng.commonsdk.utils.b.G)) {
            return;
        }
        cVar.f9285a.remove("oaid");
    }
    ...
    public static class a {
        ...
        public synchronized void a() {
            if (!this.b.isEmpty()) {
                ...
                PreferenceWrapper.getDefault(this.f9267a).edit().putString("invld_id", sb.toString()).commit();
            }
        }

        public synchronized void b() {
            String[] strArrSplit;
            String string = PreferenceWrapper.getDefault(this.f9267a).getString("invld_id", null);
