...
/* JADX INFO: compiled from: UMInternalConfig.java */
/* JADX INFO: loaded from: C:\Users\MR\AppData\Local\Temp\yixiaotong-dex\6464928.dex */
public class a {
    public static final int A = 32793;
    public static final int B = 32800;
    public static final int C = 32801;
    public static final String D = "umpx_oplus_lbs";
    public static final String E = "umeng_common_config";
    public static final String F = "umeng_sp_zid";
    public static final String G = "preInitInvoked";
    public static final String H = "policyGrantInvoked";
    public static final String I = "policyGrantResult";

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final String f9223a = "umpx_internal";
    ...
    public static final int o = 32779;
