...
public class j {
    ...
    public static final String f9239a = "UM_PROBE_DATA";
    ...
    public static String a(Context context) {
        try {
            SharedPreferences sharedPreferences = StubApp.getOrigApplicationContext(context.getApplicationContext()).getSharedPreferences(f9239a, 0);
    ...
    public static void b(Context context, String[] strArr) {
        ...
        if (context == null || (sharedPreferences = StubApp.getOrigApplicationContext(context.getApplicationContext()).getSharedPreferences(f9239a, 0)) == null) {
            return;
        }
        synchronized (e) {
    ...
    public static boolean c(Context context) {
        SharedPreferences sharedPreferences;
        return (context == null || (sharedPreferences = StubApp.getOrigApplicationContext(context.getApplicationContext()).getSharedPreferences(f9239a, 0)) == null || TextUtils.isEmpty(sharedPreferences.getString(b, ""))) ? false : true;
    }
