...
public class d {
    ...
    /* JADX WARN: Code duplicated, block: B:42:0x006b A[EXC_TOP_SPLITTER, PHI: r1
  0x006b: PHI (r1v2 java.io.FileOutputStream) = (r1v1 java.io.FileOutputStream), (r1v4 java.io.FileOutputStream) binds: [B:22:0x0069, B:27:0x0073] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
    ...
    */
        ...
        try {
            synchronized (b) {
                ...
                if (context != null && StubApp.getOrigApplicationContext(context.getApplicationContext()) != null) {
                    String str = StubApp.getOrigApplicationContext(context.getApplicationContext()).getFilesDir() + File.separator + a.e;
    ...
    public static File b(Context context) {
        ...
        try {
            synchronized (b) {
                String str = StubApp.getOrigApplicationContext(context.getApplicationContext()).getFilesDir() + File.separator + a.f;
                if (TextUtils.isEmpty(str)) {
                    return null;
                }
    ...
    public static String a(Context context, boolean z) {
        ...
        try {
            if (z) {
                str = StubApp.getOrigApplicationContext(context.getApplicationContext()).getFilesDir() + File.separator + a.e;
            } else {
                str = StubApp.getOrigApplicationContext(context.getApplicationContext()).getFilesDir() + File.separator + a.f;
            }
            str2 = str;
            return str2;
        } catch (Throwable unused) {
