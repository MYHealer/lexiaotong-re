...
import com.lxt.bluetoothsdk.utils.ClsUtils;
...
public class ConnectSppDevice {
    ...
    private ConnectSppDevice() {
        this.TAG = "ConnectSppDevice";
        this.btSocket = null;
        this.bConnect = false;
        this.mHandler = new AnonymousClass1();
        this.mReceiverTag = false;
        this.mReceiver = new BroadcastReceiver() { // from class: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice.4
    ...
    /* JADX INFO: renamed from: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice$1, reason: invalid class name */
    class AnonymousClass1 extends Handler {
        ...
        public void handleMessage(Message message) {
            int i = message.what;
            if (i == 1) {
                ConnectSppDevice.this.mConnectThread = new Thread(new Runnable() { // from class: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice.1.1
                    ...
                    public void run() {
                        ...
                        ConnectSppDevice.this.checkTimeOut(TimeOut.Connect, 15000);
                        ...
                        try {
                            ...
                            MainThreadExecutor.getInstance().execute(new Runnable() { // from class: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice.1.1.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    if (!ConnectSppDevice.this.isRunning || ConnectSppDevice.this.connectListener == null) {
                                        return;
                                    }
                                    ConnectSppDevice.this.connectListener.onConnectFail(ConnectSppDevice.this.mCurrentHardware, "连接异常，请重启手机蓝牙或重启设备蓝牙后再试", 10006);
                                }
                            });
                            e.printStackTrace();
            ...
            if (i == 2) {
                ...
                MainThreadExecutor.getInstance().executeDelayed(new Runnable() { // from class: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice.1.2
                    @Override // java.lang.Runnable
                    public void run() {
                        ConnectSppDevice.this.connectListener.onConnectSuccess(ConnectSppDevice.this.mCurrentHardware);
                    }
                }, 200L);
                ConnectSppDevice.this.mReceivedDataThread = new Thread(new Runnable() { // from class: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice.1.3
                    @Override // java.lang.Runnable
                    public void run() {
                            ...
                            try {
                                ...
                                if (iAvailable > 0) {
                                    ...
                                    if (ConnectSppDevice.this.mmInStream.read(bArr) > 0) {
                                        ...
                                        MainThreadExecutor.getInstance().executeDelayed(new Runnable() { // from class: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice.1.3.1
                                            @Override // java.lang.Runnable
                                            public void run() {
                                ...
                                LogUtil.log_e(ConnectSppDevice.this.TAG, "Recv thread:" + e.getMessage());
                                e.printStackTrace();
                                return;
                            }
                        }
    ...
    public void start(Context context, BluetoothDevice bluetoothDevice) {
        ...
        MainThreadExecutor.getInstance().execute(new Runnable() { // from class: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    private void send(final String str) {
        if (!this.bConnect.booleanValue()) {
            this.receiveDataListener.onSendDataFail(this.mCurrentHardware, "设备蓝牙已断开,请重新连接", 10006);
        } else {
            new Thread(new Runnable() { // from class: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice.3
                @Override // java.lang.Runnable
                public void run() {
                    try {
                        if (ConnectSppDevice.this.mmOutStream == null) {
    ...
    private class CheckRunnable implements Runnable {
        ...
        public void run() {
            ...
            LogUtil.log_i(ConnectSppDevice.this.TAG, this.timeOut + "  " + ConnectSppDevice.this.mCurrentCheckTimeOut + "  " + jCurrentTimeMillis);
            if (ConnectSppDevice.this.isRunning && this.timeOut == ConnectSppDevice.this.mCurrentCheckTimeOut && jCurrentTimeMillis > ConnectSppDevice.this.mTimeOutTime - 1000) {
                ...
                MainThreadExecutor.getInstance().execute(new Runnable() { // from class: com.lxt.bluetoothsdk.bluetooth.ConnectSppDevice.CheckRunnable.1
                    @Override // java.lang.Runnable
                    public void run() {
                        try {
                            if (ConnectSppDevice.this.isRunning && ConnectSppDevice.this.connectListener != null) {
                                ConnectSppDevice.this.connectListener.onConnectFail(ConnectSppDevice.this.mCurrentHardware, CheckRunnable.this.timeOut + "", 10009);
                            }
                        } finally {
                            ConnectSppDevice.this.stopAndRelease();
                        }
