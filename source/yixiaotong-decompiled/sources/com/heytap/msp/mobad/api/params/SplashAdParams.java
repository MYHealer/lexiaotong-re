...
public class SplashAdParams {
    ...
    public String toString() {
        StringBuilder sbAppend = new StringBuilder("SplashAdParams{fetchTimeout=").append(this.fetchTimeout).append(", title='").append(this.title).append("', desc='").append(this.desc).append("', showPreLoadPage=").append(this.showPreLoadPage).append(", bottomArea=");
        Object obj = this.bottomArea;
        if (obj == null) {
            obj = "null";
        }
        return sbAppend.append(obj).append(", isUseSurfaceView=").append(this.isUseSurfaceView).append(", splashSkipView=").append(this.splashSkipView).append(", clickViews=").append(this.clickViews).append('}').toString();
    }
}
