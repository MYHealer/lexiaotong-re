...
public class RefInvoker {
    ...
    public static Object invokeMethodAndThrowsException(Object obj, String str, Class<?>[] clsArr, Object[] objArr) throws NoSuchMethodException {
        if (obj == null) {
        ...
        throw new NoSuchMethodException(obj.getClass().getName() + "." + str + PPSLabelView.Code + Arrays.toString(clsArr));
    }
