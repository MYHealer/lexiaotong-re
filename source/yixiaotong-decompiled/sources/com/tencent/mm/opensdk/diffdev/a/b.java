...
public class b extends AsyncTask<Void, Void, a> {
                ...
                try {
                    try {
                        ...
                        if (i != 0) {
                            ...
                            aVar.f8544a = OAuthErrCode.WechatAuth_Err_NormalErr;
                        ...
                        if (string != null && string.length() != 0) {
                            ...
                            if (bArrDecode != null && bArrDecode.length != 0) {
                                aVar.f8544a = OAuthErrCode.WechatAuth_Err_OK;
                                aVar.e = bArrDecode;
                                aVar.b = jSONObject.getString(Constant.MAP_KEY_UUID);
                            ...
                            aVar.f8544a = OAuthErrCode.WechatAuth_Err_JsonDecodeErr;
                            return aVar;
                        }
    ...
    protected a doInBackground(Void[] voidArr) throws Throwable {
        ...
        String str = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.f8543a, this.c, this.d, this.b, this.e);
