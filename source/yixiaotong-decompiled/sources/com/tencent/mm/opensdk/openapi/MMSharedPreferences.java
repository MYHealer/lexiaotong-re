...
class MMSharedPreferences implements SharedPreferences {
    ...
    private final String[] columns = {"_id", "key", "type", oOOOoo00.OooOo0o};
    ...
    private static class REditor implements SharedPreferences.Editor {
        ...
        /* JADX WARN: Code duplicated, block: B:41:0x0098 A[SYNTHETIC] */
        ...
        public boolean commit() {
            ...
            if (this.clear) {
                this.cr.delete(a.f8548a, null, null);
                this.clear = false;
            }
            Iterator<String> it = this.remove.iterator();
            while (it.hasNext()) {
                this.cr.delete(a.f8548a, "key = ?", new String[]{it.next()});
            }
            ...
            while (true) {
                ...
                if (value == null) {
                    ...
                    if (i == 0) {
                        ...
                        contentValues.put(oOOOoo00.OooOo0o, value.toString());
                        this.cr.update(a.f8548a, contentValues, "key = ?", new String[]{next.getKey()});
                    }
                }
    ...
    private Object getValue(String str) {
        try {
            Cursor cursorQuery = this.cr.query(a.f8548a, this.columns, "key = ?", new String[]{str}, null);
            if (cursorQuery == null) {
                return null;
            }
            Object objA = cursorQuery.moveToFirst() ? com.tencent.mm.opensdk.channel.a.a.a(cursorQuery.getInt(cursorQuery.getColumnIndex("type")), cursorQuery.getString(cursorQuery.getColumnIndex(oOOOoo00.OooOo0o))) : null;
            cursorQuery.close();
            return objA;
        } catch (Exception e) {
    ...
    public Map<String, ?> getAll() {
        try {
            Cursor cursorQuery = this.cr.query(a.f8548a, this.columns, null, null, null);
            if (cursorQuery == null) {
                return null;
            }
            int columnIndex = cursorQuery.getColumnIndex("key");
            int columnIndex2 = cursorQuery.getColumnIndex("type");
            int columnIndex3 = cursorQuery.getColumnIndex(oOOOoo00.OooOo0o);
