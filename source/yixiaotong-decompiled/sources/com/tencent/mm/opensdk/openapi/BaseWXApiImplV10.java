...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    BaseWXApiImplV10(Context context, String str, boolean z, int i) {
        ...
        this.launchMode = i;
        b.f8549a = StubApp.getOrigApplicationContext(context.getApplicationContext());
    }
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        try {
            ...
            if (queryParameter.equals("subscribemessage")) {
                ...
                resp.templateID = uri.getQueryParameter(a.W0);
                resp.scene = b.a(uri.getQueryParameter(a.InterfaceC0437a.hnadsd), 0);
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), C.BUFFER_FLAG_FIRST_SAMPLE).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
    ...
    public boolean registerApp(String str, long j) {
        ...
        com.tencent.mm.opensdk.channel.a.a.C1054a c1054a = new com.tencent.mm.opensdk.channel.a.a.C1054a();
        c1054a.f8539a = "com.tencent.mm";
        c1054a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c1054a.c = "weixin://registerapp?appid=" + this.appId;
        c1054a.d = j;
        return com.tencent.mm.opensdk.channel.a.a.a(this.context, c1054a);
    }
                ...
                if (baseReq.getType() == 2) {
                    ...
                    if (b.a(type)) {
                        if (getWXAppSupportAPI() < 620756993) {
                            ...
                            if (type != 46 || getWXAppSupportAPI() >= 620953856) {
    ...
    public void unregisterApp() {
        ...
        com.tencent.mm.opensdk.channel.a.a.C1054a c1054a = new com.tencent.mm.opensdk.channel.a.a.C1054a();
        c1054a.f8539a = "com.tencent.mm";
        c1054a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c1054a.c = "weixin://unregisterapp?appid=" + this.appId;
        com.tencent.mm.opensdk.channel.a.a.a(this.context, c1054a);
    }
}
