...
public class ForegroundServiceConfig {
    ...
    /* JADX INFO: renamed from: com.yfanads.android.adx.thirdpart.filedownload.services.ForegroundServiceConfig$1, reason: invalid class name */
    ...
    private Notification buildDefaultNotification(Context context) {
        String string = context.getString(R.string.default_filedownload_notification_title);
        String string2 = context.getString(R.string.default_filedownload_notification_content);
