...
public class RemitDatabase implements FileDownloadDatabase {
    ...
    public RemitDatabase() {
        ...
        handlerThread.start();
        this.handler = new Handler(handlerThread.getLooper(), new Handler.Callback() { // from class: com.yfanads.android.adx.thirdpart.filedownload.database.RemitDatabase.1
    ...
    public FileDownloadDatabase.Maintainer maintainer() {
        SqliteDatabaseImpl sqliteDatabaseImpl = this.realDatabase;
        NoDatabaseImpl noDatabaseImpl = this.cachedDatabase;
        return sqliteDatabaseImpl.maintainer(noDatabaseImpl.downloaderModelMap, noDatabaseImpl.connectionModelListMap);
    }
