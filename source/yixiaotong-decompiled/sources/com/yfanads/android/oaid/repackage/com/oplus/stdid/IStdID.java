package com.yfanads.android.oaid.repackage.com.oplus.stdid;
...
public interface IStdID extends IOpenID {
    ...
    public static abstract class Stub extends IOpenID.Stub {
        ...
        public static class Proxy implements IStdID {
            ...
            @Override // com.yfanads.android.oaid.repackage.com.heytap.openid.IOpenID
        ...
        public static IStdID asInterface(IBinder iBinder) {
            ...
            return iInterfaceQueryLocalInterface instanceof IStdID ? (IStdID) iInterfaceQueryLocalInterface : new Proxy(iBinder);
        }
