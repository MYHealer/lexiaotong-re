...
public final class NumberTypeAdapter extends TypeAdapter<Number> {
    ...
    /* JADX INFO: renamed from: com.yfanads.android.libs.thirdpart.gson.internal.bind.NumberTypeAdapter$2, reason: invalid class name */
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$yfanads$android$libs$thirdpart$gson$stream$JsonToken[JsonToken.NUMBER.ordinal()] = 2;
    ...
    private static TypeAdapterFactory newFactory(ToNumberStrategy toNumberStrategy) {
        return new TypeAdapterFactory() { // from class: com.yfanads.android.libs.thirdpart.gson.internal.bind.NumberTypeAdapter.1
    ...
    public Number read(JsonReader jsonReader) throws IOException {
        ...
        int i = AnonymousClass2.$SwitchMap$com$yfanads$android$libs$thirdpart$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
        if (i == 1) {
            jsonReader.nextNull();
            return null;
        }
