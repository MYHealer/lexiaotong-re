package com.yfanads.android.libs.thirdpart.gson.stream;

import com.bykv.vk.component.ttvideo.player.MediaPlayer;
import com.huawei.hms.ads.ez;
import com.yfanads.android.libs.thirdpart.gson.internal.JsonReaderInternalAccess;
...
public class JsonReader implements Closeable {
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() { // from class: com.yfanads.android.libs.thirdpart.gson.stream.JsonReader.1
            @Override // com.yfanads.android.libs.thirdpart.gson.internal.JsonReaderInternalAccess
    ...
    /* JADX WARN: Code duplicated, block: B:110:0x00f4 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:14:0x0030  */
    /* JADX WARN: Code duplicated, block: B:90:0x00dd  */
    /* JADX WARN: Code duplicated, block: B:92:0x00e2  */
    /* JADX WARN: Code duplicated, block: B:97:0x00e9  */
    ...
    public double nextDouble() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            if (iDoPeek == 8 || iDoPeek == 9) {
                strNextQuotedValue = nextQuotedValue(iDoPeek == 8 ? '\'' : Typography.quote);
            } else if (iDoPeek == 10) {
