...
import com.yfanads.android.libs.thirdpart.gson.internal.bind.DefaultDateTypeAdapter;
...
public final class SqlTypesSupport {
    ...
    static {
        ...
        if (z) {
            DATE_DATE_TYPE = new DefaultDateTypeAdapter.DateType<java.sql.Date>(java.sql.Date.class) { // from class: com.yfanads.android.libs.thirdpart.gson.internal.sql.SqlTypesSupport.1
            ...
            TIMESTAMP_DATE_TYPE = new DefaultDateTypeAdapter.DateType<Timestamp>(Timestamp.class) { // from class: com.yfanads.android.libs.thirdpart.gson.internal.sql.SqlTypesSupport.2
                @Override // com.yfanads.android.libs.thirdpart.gson.internal.bind.DefaultDateTypeAdapter.DateType
