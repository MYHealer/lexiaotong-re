...
public class OppoMixBannerAdapter extends MixBannerCustomAdapter implements INativeTempletAdListener {
    private List<INativeTempletAdView> dataList;
    private BannerAd mBannerAd;
    private List<INativeAdvanceData> mINativeAdvanceDataList;
    ...
    public OppoMixBannerAdapter(YFNativeExpressSetting yFNativeExpressSetting) {
    ...
    public void m1208x201b9c1d(final Context context) {
        OppoUtil.initOppo(this.tag, this.sdkSupplier, getContext(), getInitBean(), new InitUtils.InitListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter.1
            @Override // com.yfanads.android.utils.InitUtils.InitListener
            public void success() {
                OppoMixBannerAdapter.this.startLoadAD(context);
            }

            @Override // com.yfanads.android.utils.InitUtils.InitListener
            public void fail(String str, String str2) {
                OppoMixBannerAdapter.this.handleFailed(str, str2);
            }
        });
        sendInterruptMsg();
    }
    ...
    private void loadBannerAdByNative(Context context) {
        NativeAdvanceAd nativeAdvanceAd = new NativeAdvanceAd(context, this.sdkSupplier.getPotId(), new INativeAdvanceLoadListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter.2
            ...
            public void onAdSuccess(List<INativeAdvanceData> list) {
                YFLog.high(OppoMixBannerAdapter.this.tag + "onNativeAdLoad");
                if (list != null) {
                    try {
                        if (!list.isEmpty() && list.get(0) != null) {
                            OppoMixBannerAdapter.this.mINativeAdvanceDataList = list;
                            OppoMixBannerAdapter oppoMixBannerAdapter = OppoMixBannerAdapter.this;
                            oppoMixBannerAdapter.setEcpm(((INativeAdvanceData) oppoMixBannerAdapter.mINativeAdvanceDataList.get(0)).getECPM());
                            OppoMixBannerAdapter.this.handleSucceed();
                        } else {
                            OppoMixBannerAdapter.this.handleFailed(YFAdError.ERROR_DATA_NULL, "");
                        }
                    } catch (Throwable th) {
                        th.printStackTrace();
                        OppoMixBannerAdapter.this.handleFailed(YFAdError.ERROR_EXCEPTION_LOAD, "");
                    }
                } else {
                    OppoMixBannerAdapter.this.handleFailed(YFAdError.ERROR_DATA_NULL, "");
                }
            ...
            public void onAdFailed(int i, String str) {
                YFLog.high(OppoMixBannerAdapter.this.tag + " onError " + i + str);
                OppoMixBannerAdapter.this.handleFailed(i, str);
            }
        });
    ...
    public void loadBannerAd(Context context) {
        if (context instanceof Activity) {
            ...
            bannerAd.setAdListener(new IBannerAdListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter.3
                ...
                public void onAdReady() {
                    if (OppoMixBannerAdapter.this.mBannerAd != null) {
                        OppoMixBannerAdapter oppoMixBannerAdapter = OppoMixBannerAdapter.this;
                        oppoMixBannerAdapter.setEcpm(oppoMixBannerAdapter.mBannerAd.getECPM());
                    }
                    OppoMixBannerAdapter.this.handleSucceed();
                }
                ...
                public void onAdClose() {
                    OppoMixBannerAdapter.this.closeAds(0);
                }

                @Override // com.heytap.msp.mobad.api.listener.IBaseAdListener
                public void onAdShow() {
                    OppoMixBannerAdapter.this.handleExposure(0);
                }
                ...
                public void onAdClick() {
                    OppoMixBannerAdapter.this.handleClick(0, false);
                }
            });
    ...
    private void doShowBannerAd() {
        try {
            if (this.mBannerAd != null) {
                YFExpView yFExpView = new YFExpView(this.mBannerAd.getAdView(), getAdType());
                if (isBidding()) {
        ...
        try {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                for (INativeTempletAdView iNativeTempletAdView : this.dataList) {
                    ...
                    this.viewList.add(new YFExpView(iNativeTempletAdView.getAdView(), getAdType()));
    ...
    public void doDestroy() {
        try {
            ...
            this.mINativeAdvanceDataList = null;
            BannerAd bannerAd = this.mBannerAd;
            if (bannerAd != null) {
                bannerAd.destroyAd();
            }
    ...
    public void bindData(Activity activity, BannerTemplateData bannerTemplateData, int i, AdBannerViewHolder adBannerViewHolder) {
        bindDataNative(activity, bannerTemplateData, i, adBannerViewHolder);
    }

    public void bindDataNative(Activity activity, BannerTemplateData bannerTemplateData, final int i, AdBannerViewHolder adBannerViewHolder) {
        String clickBnText;
        adBannerViewHolder.adLogoIcon.setVisibility(8);
        if (activity != null) {
            final FragmentManager fragmentManager = activity.getFragmentManager();
            adBannerViewHolder.dislikeBtn.setOnClickListener(new View.OnClickListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m1142x4989199d(fragmentManager, view);
                }
            });
        }
        ...
        adBannerViewHolder.getCloseView(bannerTemplateData).setOnClickListener(new View.OnClickListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m1143x3b32bfbc(i, view);
            }
        });
        if (activity != null) {
            this.feedBean.contextName = activity.getLocalClassName();
            final FragmentManager fragmentManager2 = activity.getFragmentManager();
            adBannerViewHolder.dislikeBtn.setOnClickListener(new View.OnClickListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m1144x2cdc65db(fragmentManager2, view);
                }
            });
        }
    ...
    /* JADX INFO: renamed from: lambda$bindDataNative$0$com-yfanads-ads-chanel-oppo-OppoMixBannerAdapter, reason: not valid java name */
    /* synthetic */ void m1142x4989199d(FragmentManager fragmentManager, View view) {
        showFeedBackDialog(fragmentManager, tt.AD_TAG_DISLIKE);
    }

    /* JADX INFO: renamed from: lambda$bindDataNative$1$com-yfanads-ads-chanel-oppo-OppoMixBannerAdapter, reason: not valid java name */
    /* synthetic */ void m1143x3b32bfbc(int i, View view) {
        closeAds(i);
    }

    /* JADX INFO: renamed from: lambda$bindDataNative$2$com-yfanads-ads-chanel-oppo-OppoMixBannerAdapter, reason: not valid java name */
    /* synthetic */ void m1144x2cdc65db(FragmentManager fragmentManager, View view) {
        showFeedBackDialog(fragmentManager, tt.AD_TAG_DISLIKE);
    }
    ...
    private void registerViewForInteraction(AdBannerViewHolder adBannerViewHolder, boolean z, BannerTemplateData bannerTemplateData, INativeAdvanceData iNativeAdvanceData, int i) {
        ...
        if (z) {
            adBannerViewHolder.onClickView.setOnClickListener(new View.OnClickListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    private void bindMediaView(AdBannerViewHolder adBannerViewHolder, List<View> list, List<View> list2, INativeAdvanceData iNativeAdvanceData, final int i) {
        ...
        iNativeAdvanceData.setInteractListener(new INativeAdvanceInteractListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter.4
            @Override // com.heytap.msp.mobad.api.listener.INativeAdvanceInteractListener
            public void onClick() {
                OppoMixBannerAdapter.this.handleClick(i, false);
            }

            @Override // com.heytap.msp.mobad.api.listener.INativeAdvanceInteractListener
            public void onShow() {
                OppoMixBannerAdapter.this.handleExposure(i);
            }

            @Override // com.heytap.msp.mobad.api.listener.INativeAdvanceInteractListener
            public void onError(int i2, String str) {
                OppoMixBannerAdapter.this.handleFailed(i2, str);
            }
        });
        ...
        iNativeAdvanceData.bindMediaView(getContext(), mediaView, new INativeAdvanceMediaListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter.5
            @Override // com.heytap.msp.mobad.api.listener.INativeAdvanceMediaListener
            public void onVideoPlayStart() {
                YFLog.debug(OppoMixBannerAdapter.this.tag + "onVideoPlayStart: ");
            }

            @Override // com.heytap.msp.mobad.api.listener.INativeAdvanceMediaListener
            public void onVideoPlayComplete() {
                YFLog.debug(OppoMixBannerAdapter.this.tag + "onVideoPlayComplete: ");
            }

            @Override // com.heytap.msp.mobad.api.listener.INativeAdvanceMediaListener
            public void onVideoPlayError(int i2, String str) {
                YFLog.debug(OppoMixBannerAdapter.this.tag + "onVideoError: ");
                OppoMixBannerAdapter.this.handleFailed(i2, str);
            }
        });
    }
    ...
    private void bindImageViews(AdBannerViewHolder adBannerViewHolder, List<View> list, List<View> list2, INativeAdvanceData iNativeAdvanceData, final int i) {
        ...
        iNativeAdvanceData.setInteractListener(new INativeAdvanceInteractListener() { // from class: com.yfanads.ads.chanel.oppo.OppoMixBannerAdapter.6
            @Override // com.heytap.msp.mobad.api.listener.INativeAdvanceInteractListener
            public void onClick() {
                OppoMixBannerAdapter.this.handleClick(i, false);
            }
    ...
    public void onRenderFailed(NativeAdError nativeAdError, INativeTempletAdView iNativeTempletAdView) {
        YFLog.high(" onRenderFailed msg:" + nativeAdError.msg + "_" + nativeAdError.code);
