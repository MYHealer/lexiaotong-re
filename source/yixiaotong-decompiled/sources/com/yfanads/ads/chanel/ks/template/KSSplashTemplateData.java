package com.yfanads.ads.chanel.ks.template;
...
public class KSSplashTemplateData extends SplashTemplateData {
    public KSSplashTemplateData(String str, boolean z) {
        super(str, z);
    }
