...
public class HwMixBannerAdapter extends MixBannerCustomAdapter implements NativeAd.NativeAdLoadedListener {
    ...
    public HwMixBannerAdapter(YFNativeExpressSetting yFNativeExpressSetting) {
    ...
    public void m1208x201b9c1d(final Context context) {
        HwUtil.initHw(this.tag, this.sdkSupplier, context, getInitBean(), new InitUtils.InitListener() { // from class: com.yfanads.ads.chanel.hw.HwMixBannerAdapter.1
            @Override // com.yfanads.android.utils.InitUtils.InitListener
            public void success() {
                HwMixBannerAdapter.this.startLoadAD(context);
            }

            @Override // com.yfanads.android.utils.InitUtils.InitListener
            public void fail(String str, String str2) {
                HwMixBannerAdapter.this.handleFailed(str, str2);
            }
        });
        sendInterruptMsg();
    }
    ...
    public void loadBannerAd(Context context) {
        ...
        this.bannerView.setAdListener(new AdListener() { // from class: com.yfanads.ads.chanel.hw.HwMixBannerAdapter.2
            ...
            public void onAdLoaded() {
                if (HwMixBannerAdapter.this.isBidding()) {
                    HwMixBannerAdapter.this.setEcpm();
                }
                HwMixBannerAdapter.this.handleSucceed();
            }

            @Override // com.huawei.hms.ads.AdListener
            public void onAdFailed(int i) {
                HwMixBannerAdapter.this.handleFailed(YFAdError.parseErr(i));
                YFLog.debug("onAdFailed===>" + i);
            }

            @Override // com.huawei.hms.ads.AdListener
            public void onAdClicked() {
                HwMixBannerAdapter.this.handleClick(0, false);
            }

            @Override // com.huawei.hms.ads.AdListener
            public void onAdClosed() {
                HwMixBannerAdapter.this.closeAds(0);
            }

            @Override // com.huawei.hms.ads.AdListener
            public void onAdOpened() {
                YFLog.high(HwMixBannerAdapter.this.tag + " onAdOpened");
                if (HwMixBannerAdapter.this.isStartShow()) {
                    HwMixBannerAdapter.this.handleExposure(0);
                }
            }
        });
    ...
    public void doShowTemplateAd(Activity activity) {
        YFLog.warn(this.tag + " hw is not support templateAd ");
    ...
    public void loadNativeAd(Context context) {
        ...
        builder.setNativeAdLoadedListener(this).setAdListener(new AdListener() { // from class: com.yfanads.ads.chanel.hw.HwMixBannerAdapter.3
            @Override // com.huawei.hms.ads.AdListener
            public void onAdFailed(int i) {
            ...
            @Override // com.huawei.hms.ads.AdListener
            public void onAdClicked() {
                HwMixBannerAdapter.this.handleClick();
            }

            @Override // com.huawei.hms.ads.AdListener
            public void onAdImpression() {
                YFLog.high(HwMixBannerAdapter.this.tag + " onAdImpression");
                HwMixBannerAdapter.this.handleExposure();
            }
        });
    ...
    public void loadTemplateAd(Context context) {
        YFLog.warn(this.tag + " hw is not support load templateAd ");
        handleFailed(YFAdError.parseErr(YFAdError.ERROR_DATA_NULL));
    }

    protected void doShowBannerAd() {
        if (this.bannerView != null) {
            this.viewList.add(new YFExpView(this.bannerView, getAdType()));
            if (this.setting != null) {
    ...
    public void bindData(Activity activity, BannerTemplateData bannerTemplateData, final int i, AdBannerViewHolder adBannerViewHolder) {
        ...
        if (bannerTemplateData.showDownloadBtn()) {
            ...
            if (TextUtils.isEmpty(this.nativeAd.getCallToAction())) {
                callToAction2 = getContext().getString(R.string.yf_default_download_text);
            } else {
                callToAction2 = this.nativeAd.getCallToAction();
            }
            textView3.setText(callToAction2);
        ...
        adBannerViewHolder.getCloseView(bannerTemplateData).setOnClickListener(new View.OnClickListener() { // from class: com.yfanads.ads.chanel.hw.HwMixBannerAdapter$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m1109lambda$bindData$0$comyfanadsadschanelhwHwMixBannerAdapter(i, view);
            }
        });
        ...
        if (activity != null) {
            ...
            adBannerViewHolder.dislikeBtn.setOnClickListener(new View.OnClickListener() { // from class: com.yfanads.ads.chanel.hw.HwMixBannerAdapter$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m1110lambda$bindData$1$comyfanadsadschanelhwHwMixBannerAdapter(fragmentManager, view);
                }
            });
        }
    ...
    /* JADX INFO: renamed from: lambda$bindData$0$com-yfanads-ads-chanel-hw-HwMixBannerAdapter, reason: not valid java name */
    /* synthetic */ void m1109lambda$bindData$0$comyfanadsadschanelhwHwMixBannerAdapter(int i, View view) {
        closeAds(i);
    }

    /* JADX INFO: renamed from: lambda$bindData$1$com-yfanads-ads-chanel-hw-HwMixBannerAdapter, reason: not valid java name */
    /* synthetic */ void m1110lambda$bindData$1$comyfanadsadschanelhwHwMixBannerAdapter(FragmentManager fragmentManager, View view) {
    ...
    private void bindMediaView(AdBannerViewHolder adBannerViewHolder, BannerTemplateData bannerTemplateData, NativeAd nativeAd) {
        ...
        videoOperator.setVideoLifecycleListener(new VideoOperator.VideoLifecycleListener() { // from class: com.yfanads.ads.chanel.hw.HwMixBannerAdapter.4
    ...
    public void sendSucBiddingResult(SdkSupplier sdkSupplier) {
        ...
        String shortString = "";
        if (biddingInfo != null) {
            HwUtil.win(biddingInfo.getNurl(), sdkSupplier != null ? sdkSupplier.ecpm : 0L);
        ...
        NativeAd nativeAd = this.nativeAd;
        if (nativeAd != null) {
            nativeAd.sendBiddingSuccess(HwUtil.getWinBiddingInfo(sdkSupplier), new ReportUrlListener() { // from class: com.yfanads.ads.chanel.hw.HwMixBannerAdapter.5
                @Override // com.huawei.hms.ads.ReportUrlListener
                public void reportSuccess() {
                    YFLog.high(HwMixBannerAdapter.this.tag + " sendBiddingSucResult reportSuccess");
                }

                @Override // com.huawei.hms.ads.ReportUrlListener
                public void reportFailed(String str, int i) {
                    YFLog.high(HwMixBannerAdapter.this.tag + " sendBiddingSucResult reportFailed " + str + " code=" + i);
                }
            });
    ...
    public void sendLossBiddingResult(SdkSupplier sdkSupplier, SdkSupplier sdkSupplier2) {
        ...
        NativeAd nativeAd = this.nativeAd;
        if (nativeAd != null) {
            nativeAd.sendBiddingFailed(HwUtil.getLossBiddingInfo(sdkSupplier), new ReportUrlListener() { // from class: com.yfanads.ads.chanel.hw.HwMixBannerAdapter.6
                @Override // com.huawei.hms.ads.ReportUrlListener
                public void reportSuccess() {
                    YFLog.high(HwMixBannerAdapter.this.tag + " sendBiddingLossResult reportSuccess");
                }

                @Override // com.huawei.hms.ads.ReportUrlListener
                public void reportFailed(String str, int i) {
                    YFLog.high(HwMixBannerAdapter.this.tag + " sendBiddingLossResult reportFailed " + str + " code=" + i);
                }
            });
            YFLog.high(this.tag + " sendBiddingLossResult current=" + (this.sdkSupplier != null ? this.sdkSupplier.toShortString() : "") + " win=" + (UrlConst.isTestEnv() ? sdkSupplier.toShortString() : ""));
        }
