...
public class RYNativeExpressAdapter extends NativeExpressCustomAdapter implements PictureTextAdLoadListener {
    ...
    public void bindData(Activity activity, BannerTemplateData bannerTemplateData, final int i, AdBannerViewHolder adBannerViewHolder) {
        ...
        adBannerViewHolder.getCloseView(bannerTemplateData).setOnClickListener(new View.OnClickListener() { // from class: com.yfanads.ads.chanel.ry.RYNativeExpressAdapter$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m1158x8561dfa3(i, view);
            }
        });
        ...
        if (activity != null) {
            ...
            adBannerViewHolder.dislikeBtn.setOnClickListener(new View.OnClickListener() { // from class: com.yfanads.ads.chanel.ry.RYNativeExpressAdapter$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m1159x770b85c2(fragmentManager, view);
                }
            });
        }
    ...
    /* JADX INFO: renamed from: lambda$bindData$0$com-yfanads-ads-chanel-ry-RYNativeExpressAdapter, reason: not valid java name */
    /* synthetic */ void m1158x8561dfa3(int i, View view) {
        YFLog.debug(this.tag + "closeAds");
        closeAds(i);
    }

    /* JADX INFO: renamed from: lambda$bindData$1$com-yfanads-ads-chanel-ry-RYNativeExpressAdapter, reason: not valid java name */
    /* synthetic */ void m1159x770b85c2(FragmentManager fragmentManager, View view) {
    ...
    private void addVideoView(final AdBannerViewHolder adBannerViewHolder, final PictureTextExpressAd pictureTextExpressAd, final AdVideo adVideo, final boolean z) {
        ...
        adBannerViewHolder.mediaViewFrame.post(new Runnable() { // from class: com.yfanads.ads.chanel.ry.RYNativeExpressAdapter$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1157x720312c9(videoWidth, videoHeight, adBannerViewHolder, pictureTextExpressAd, adVideo, z);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$addVideoView$2$com-yfanads-ads-chanel-ry-RYNativeExpressAdapter, reason: not valid java name */
    /* synthetic */ void m1157x720312c9(int i, int i2, AdBannerViewHolder adBannerViewHolder, PictureTextExpressAd pictureTextExpressAd, AdVideo adVideo, boolean z) {
        int height;
        int i3;
        try {
    ...
    private void setVideoAdListener(final AdVideo adVideo, final boolean z) {
        adVideo.setVideoListener(new OnVideoPlayListener() { // from class: com.yfanads.ads.chanel.ry.RYNativeExpressAdapter.3
            ...
            public void onVideoError(int i, String str) {
                YFLog.debug(RYNativeExpressAdapter.this.tag + "onVideoError: " + i + "," + str);
                RYNativeExpressAdapter.this.handleFailed(i, str);
            }

            @Override // com.hihonor.adsdk.common.video.OnVideoPlayListener
            public void onVideoMute(boolean z2) {
                YFLog.debug(RYNativeExpressAdapter.this.tag + "onVideoMute: " + z2);
            }
    ...
    private void setNativeAdListener(PictureTextExpressAd pictureTextExpressAd, final int i) {
        pictureTextExpressAd.setAdListener(new AdListener() { // from class: com.yfanads.ads.chanel.ry.RYNativeExpressAdapter.4
            ...
            public void onAdClicked() {
                YFLog.debug(RYNativeExpressAdapter.this.tag + "onAdSkip: ");
                RYNativeExpressAdapter.this.handleClick(i, false);
            }

            @Override // com.hihonor.adsdk.base.callback.AdListener
            public void onAdImpression() {
                YFLog.debug(RYNativeExpressAdapter.this.tag + "onAdImpression: ");
                RYNativeExpressAdapter.this.handleExposure(i);
            }

            @Override // com.hihonor.adsdk.base.callback.AdListener
            public void onAdImpressionFailed(int i2, String str) {
                YFLog.debug(RYNativeExpressAdapter.this.tag + "onAdImpressionFailed: " + i2 + "," + str);
                RYNativeExpressAdapter.this.handleFailed(i2, str);
            }
