...
public class NativeUnifiedAD extends NativeAbstractAD<NUADI> {
    ...
    private static class AdListenerAdapter implements ADListener {
        ...
        private NativeADUnifiedListener f8477a;

        public AdListenerAdapter(NativeADUnifiedListener nativeADUnifiedListener) {
            this.f8477a = nativeADUnifiedListener;
        }
        ...
        public void onADEvent(ADEvent aDEvent) {
            if (this.f8477a != null) {
                ...
                if (type != 100) {
                    ...
                    this.f8477a.onNoAD(AdErrorConvertor.getAdError(aDEvent));
                    return;
                }
                ...
                this.f8477a.onADLoaded(arrayList);
            }
        }
    }
