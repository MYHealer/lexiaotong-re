...
public class NativeAdContainer extends FrameLayout {
    ...
    private ViewStatusListener f8481a;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f8482a[ViewStatus.DETACHED.ordinal()] = 2;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ViewStatusListener viewStatusListener = this.f8481a;
    ...
    public void setViewStatusListener(ViewStatusListener viewStatusListener) {
        this.f8481a = viewStatusListener;
        if (viewStatusListener != null) {
            int i = AnonymousClass1.f8482a[this.b.ordinal()];
            if (i == 1) {
                this.f8481a.onAttachToWindow();
            } else {
                if (i != 2) {
                    return;
                }
                this.f8481a.onDetachFromWindow();
            }
        }
    }
