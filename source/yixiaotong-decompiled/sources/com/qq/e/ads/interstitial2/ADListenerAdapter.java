...
class ADListenerAdapter implements ADListener {
    ...
    private final UnifiedInterstitialADListener f8473a;
    ...
    ADListenerAdapter(UnifiedInterstitialADListener unifiedInterstitialADListener) {
        this.f8473a = unifiedInterstitialADListener;
    }
    ...
    public void onADEvent(ADEvent aDEvent) {
        ...
        if (type == 109) {
            UnifiedInterstitialADListener unifiedInterstitialADListener = this.f8473a;
            if (unifiedInterstitialADListener == null || !a.b(unifiedInterstitialADListener)) {
                return;
            }
            this.f8473a.onRenderSuccess();
            return;
        }
        if (type == 110) {
            UnifiedInterstitialADListener unifiedInterstitialADListener2 = this.f8473a;
            if (unifiedInterstitialADListener2 == null || !a.a(unifiedInterstitialADListener2)) {
                return;
            }
            this.f8473a.onRenderFail();
            return;
        }
        if (type == 201) {
            UnifiedInterstitialADListener unifiedInterstitialADListener3 = this.f8473a;
        ...
        switch (type) {
            case 100:
                UnifiedInterstitialADListener unifiedInterstitialADListener4 = this.f8473a;
                if (unifiedInterstitialADListener4 != null) {
                    unifiedInterstitialADListener4.onADReceive();
                }
                break;
            case 101:
                UnifiedInterstitialADListener unifiedInterstitialADListener5 = this.f8473a;
                if (unifiedInterstitialADListener5 != null) {
                    unifiedInterstitialADListener5.onNoAD(AdErrorConvertor.getAdError(aDEvent));
                }
                break;
            case 102:
                UnifiedInterstitialADListener unifiedInterstitialADListener6 = this.f8473a;
                if (unifiedInterstitialADListener6 != null) {
                    unifiedInterstitialADListener6.onADOpened();
                }
                break;
            case 103:
                UnifiedInterstitialADListener unifiedInterstitialADListener7 = this.f8473a;
            ...
            case 104:
                ...
                break;
            case 105:
                UnifiedInterstitialADListener unifiedInterstitialADListener8 = this.f8473a;
                if (unifiedInterstitialADListener8 != null) {
                    unifiedInterstitialADListener8.onADClicked();
                }
                break;
            case 106:
                UnifiedInterstitialADListener unifiedInterstitialADListener9 = this.f8473a;
                    ...
                    default:
                        switch (type) {
                            ...
                            case 302:
                                ...
                                break;
                            case 303:
                                UnifiedInterstitialADListener unifiedInterstitialADListener10 = this.f8473a;
