...
public class e {
    ...
    private static String b(Context context) {
        ...
        try {
            ...
            try {
                return (TextUtils.isEmpty(string) || string.equalsIgnoreCase("a5f5faddde9e9f02") || string.equalsIgnoreCase("8e17f7422b35fbea") || string.equalsIgnoreCase("0000000000000000")) ? "" : string;
    ...
    public static String c(Context context) {
        ...
        return g.m1003a(subscriberId) ? a() : subscriberId;
    }
}
