...
public class a {
    ...
    public static String b(String str) {
        try {
            return new String(b(a(), m1002a(str)));
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    private static byte[] a() throws Exception {
        return f.a(new byte[]{33, 83, -50, -89, -84, -114, 80, 99, 10, Utf8.REPLACEMENT_BYTE, Ascii.SYN, -65, -11, Ascii.RS, 101, -118});
    }
    ...
    private static byte[] m1002a(String str) {
