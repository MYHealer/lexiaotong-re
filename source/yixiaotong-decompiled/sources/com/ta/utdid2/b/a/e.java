...
class e {
    ...
    public static final void a(byte[] bArr, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        for (byte b : bArr) {
            int i = b >> 4;
            sb.append(i >= 10 ? i + 87 : i + 48);
            int i2 = b & 255;
            sb.append(i2 >= 10 ? i2 + 87 : i2 + 48);
        }
    ...
    public static final void a(int[] iArr, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        for (int i : iArr) {
            ...
            xmlSerializer.attribute(null, oOOOoo00.OooOo0o, Integer.toString(i));
    ...
    public static final void a(Object obj, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        xmlSerializer.attribute(null, oOOOoo00.OooOo0o, obj.toString());
    ...
    public static final HashMap m1008a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static final int[] m1009a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
            ...
            do {
                if (eventType == 2) {
                    if (xmlPullParser.getName().equals("item")) {
                        try {
                            iArr[i] = Integer.parseInt(xmlPullParser.getAttributeValue(null, oOOOoo00.OooOo0o));
    ...
    private static Object b(XmlPullParser xmlPullParser, String[] strArr) throws XmlPullParserException, IOException {
        ...
        if (!name.equals("null")) {
            if (name.equals(TypedValues.Custom.S_STRING)) {
                ...
                objValueOf = Integer.valueOf(Integer.parseInt(xmlPullParser.getAttributeValue(null, oOOOoo00.OooOo0o)));
            } else if (name.equals("long")) {
                objValueOf = Long.valueOf(xmlPullParser.getAttributeValue(null, oOOOoo00.OooOo0o));
            } else if (name.equals(TypedValues.Custom.S_FLOAT)) {
                objValueOf = Float.valueOf(xmlPullParser.getAttributeValue(null, oOOOoo00.OooOo0o));
            } else if (name.equals("double")) {
                objValueOf = Double.valueOf(xmlPullParser.getAttributeValue(null, oOOOoo00.OooOo0o));
            } else if (name.equals(TypedValues.Custom.S_BOOLEAN)) {
                objValueOf = Boolean.valueOf(xmlPullParser.getAttributeValue(null, oOOOoo00.OooOo0o));
            } else {
                if (name.equals("int-array")) {
                    xmlPullParser.next();
                    int[] iArrM1009a = m1009a(xmlPullParser, "int-array", strArr);
                    strArr[0] = attributeValue;
                    return iArrM1009a;
                }
                if (name.equals("map")) {
                    xmlPullParser.next();
                    HashMap mapM1008a = m1008a(xmlPullParser, "map", strArr);
                    strArr[0] = attributeValue;
                    return mapM1008a;
                }
                if (name.equals("list")) {
