...
public class WebViewJavascriptBridge implements Serializable {
    ...
    public void _callbackJs(String str, String str2) {
        ...
        map.put(Constant.KEY_RESPONSE_DATA, str2);
    ...
    private void _dispatchMessage(Map map) {
        ...
        this.mContext.runOnUiThread(new w(this, String.format("javascript:WebViewJavascriptBridge._handleMessageFromJava('%s');", doubleEscapeString(string))));
    }
    ...
    private void _sendData(String str, ab abVar, String str2) {
        ...
        if (abVar != null) {
            ...
            this._uniqueId = j;
            String string = sb.append(j).toString();
            this._responseCallbacks.put(string, abVar);
