    ...
    public abstract class Stub extends Binder implements ITsmCallback {
        ...
        final class a implements ITsmCallback {
            ...
            public final void onError(String str, String str2) {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.unionpay.tsmservice.ITsmCallback");
                    parcelObtain.writeString(str);
                    parcelObtain.writeString(str2);
                    this.f9337a.transact(2, parcelObtain, parcelObtain2, 0);
            ...
            public final void onResult(Bundle bundle) {
                ...
                try {
                    ...
                    this.f9337a.transact(1, parcelObtain, parcelObtain2, 0);
                    parcelObtain2.readException();
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
        ...
        public static ITsmCallback asInterface(IBinder iBinder) {
            ...
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.unionpay.tsmservice.ITsmCallback");
