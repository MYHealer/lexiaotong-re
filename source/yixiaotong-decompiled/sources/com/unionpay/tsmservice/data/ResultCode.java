...
public class ResultCode {
    ...
    public static final String ERROR_DETAIL_ONLINE_PAYMENT_END = "0040";
    ...
    public static final String ERROR_DETAIL_UNKNOWN_SEID = "0043";
    public static final String ERROR_DETAIL_UNKNOWN_TEEID = "0042";
    public static final String ERROR_DETAIL_UNKNOWN_VENDOR_PACKAGE_NAME = "0041";
    ...
    public static final String ERROR_INTERFACE_CREATE_SSD = "10048";
    ...
    public static final String ERROR_INTERFACE_SEND_CUSTOM_DATA = "10047";
    ...
    public static String getResultCode(String str) {
        ...
        if ("10004".equals(str) || ERROR_INTERFACE_GET_APP_DETAIL.equals(str) || ERROR_INTERFACE_APP_LOCK.equals(str)) {
            return "00001";
        }
        ...
        return ERROR_INTERFACE_PREDOWNLOAD.equals(str) ? "00036" : "1" + str;
    }
}
