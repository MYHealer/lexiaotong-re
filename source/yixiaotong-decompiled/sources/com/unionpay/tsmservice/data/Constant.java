...
public class Constant {
    ...
    public static final String CMD_TYPE_READ = "CMD_READ";
    public static final String CMD_TYPE_WRITE = "CMD_WRITE";
    ...
    public static final int INTERFACE_CREATE_SSD = 46;
    ...
    public static final int INTERFACE_SEND_CUSTOM_DATA = 45;
    ...
    public static final int JAR_VERSION_CODE = 52;
    ...
    public static final String KEY_DEFAULT_CARD_AID = "_defaultCardAid";
    public static final String KEY_DEFAULT_CARD_TOKEN = "_defaultCardToken";
    ...
    public static final String KEY_NFC_ENABLE = "nfcEnable";
    ...
    public static final int NUM_TSM_INTERFACE = 47;
    ...
    public static final int TSM_UPPAY_CALLER = 3;
    ...
    public static final int UPPAY_APP_CALLER = 4;
