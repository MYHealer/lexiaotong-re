        ...
        if (this.mXBounds.range >= 1) {
            ...
            if (entryForIndex2 != 0) {
                ...
                while (true) {
                    ...
                    this.cubicPath.cubicTo(r5.getX() + ((entryForIndex3.getX() - r4.getX()) * cubicIntensity), (r5.getY() + ((entryForIndex3.getY() - r4.getY()) * cubicIntensity)) * phaseY, entryForIndex3.getX() - ((entryForIndex4.getX() - r5.getX()) * cubicIntensity), (entryForIndex3.getY() - ((entryForIndex4.getY() - r5.getY()) * cubicIntensity)) * phaseY, entryForIndex3.getX(), entryForIndex3.getY() * phaseY);
                    r4 = r5;
                    r5 = entryForIndex3;
                    r2 = entryForIndex4;
                    int i7 = i5;
                    ...
                    while (i3 < fArrGenerateTransformedValuesLine.length) {
                        ...
                        if (this.mViewPortHandler.isInBoundsLeft(f) && this.mViewPortHandler.isInBoundsY(f2)) {
                            ...
                            if (iLineDataSet.isDrawValuesEnabled()) {
                                drawValue(canvas, valueFormatter.getPointLabel(entryForIndex), f, f2 - i2, iLineDataSet.getValueTextColor(i4));
                            }
