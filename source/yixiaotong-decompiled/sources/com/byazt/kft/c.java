...
public class c implements sp {
    ...
    public final com.byazt.jr.tt f2411a;
    public long d;
    ...
    public final sp m;
    public final int n;
    public ViewTreeObserverOnGlobalLayoutListenerC0199c nb;
    public boolean nu;
    public boolean p;
    public boolean qy;
    public sp.c rh;
    ...
    private class ViewTreeObserverOnGlobalLayoutListenerC0199c implements ViewTreeObserver.OnGlobalLayoutListener {
        public final ViewGroup tt;
        public int ve;

        private ViewTreeObserverOnGlobalLayoutListenerC0199c(ViewGroup viewGroup) {
            this.ve = 10;
            this.tt = viewGroup;
        }
    ...
    public void c() {
        final ViewGroup viewGroup = (ViewGroup) this.f2411a.getView();
        viewGroup.removeAllViews();
        viewGroup.addView(this.da);
        this.nb = new ViewTreeObserverOnGlobalLayoutListenerC0199c(viewGroup);
    ...
    public void tt(final String str) {
        if (TextUtils.isEmpty(str)) {
            c(new ve(60008, 10002, "广告主图url为空"));
        } else {
            com.byazt.cph.tt.c().tt(str, new com.byazt.cph.tt.c<Bitmap>() { // from class: com.byazt.kft.c.11
                ...
                public void c(int i, String str2) {
                    ...
                    if (c.this.or <= 3) {
                        ...
                        c.this.c(new ve(60008, 10003, "广告主图url加载失败"));
                    }
                }
            });
        }
    ...
    private void c(String str, a aVar) {
        if (TextUtils.isEmpty(str)) {
            c(new ve(60008, 10004, "lottie音频url为空"));
            return;
        }
    ...
    public void release() {
        ...
        com.byazt.qk.tt.tt(new Runnable() { // from class: com.byazt.kft.c.8
            @Override // java.lang.Runnable
            public void run() {
                ViewGroup viewGroup = (ViewGroup) c.this.f2411a.getView();
                if (viewGroup != null) {
