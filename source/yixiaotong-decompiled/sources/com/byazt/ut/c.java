...
public final class c {
    ...
    public final com.byazt.lk.uj f2790a;
    public i c;
    ...
    public c() {
        ...
        this.f2790a = new com.byazt.lk.uj();
    ...
    public <T> T c(String str, com.byazt.dna.c cVar, boolean z) {
        ...
        synchronized (slVarC) {
            if (!z2) {
                if (slVarC.n && (pairC = this.f2790a.c(slVarC, cVar)) != null && pairC.second != null && (t = (T) this.n.c(slVarC, cVar, pairC.second, (Function) pairC.first, true)) != null) {
                    return t;
                }
            }
            ...
            if (t2 != null) {
                if (z2) {
                    ...
                    this.f2790a.c(slVarC, cVar, t2, (Function) pairC2.first);
                }
    ...
    public Map<String, Object> c() {
        return this.sl ? this.i : Collections.emptyMap();
    }
