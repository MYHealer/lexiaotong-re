...
public class c {
    ...
    public void c(View view, float f) {
        ...
        layoutParams.width = (int) (this.f2538a * f);
        view.setTranslationX((this.f2538a - layoutParams.width) / 2);
        if (view instanceof DynamicImageView) {
            ...
            while (true) {
                ...
                viewGroup.getChildAt(i).setTranslationX((-(this.f2538a - layoutParams.width)) / 2);
                i++;
            }
        }
    ...
    public void c(View view, int i, int i2) {
        ...
        this.uj = i / 2;
        this.n = i2 / 2;
        if (this.f2538a == 0 && view.getLayoutParams().width > 0) {
            this.f2538a = view.getLayoutParams().width;
        }
        try {
