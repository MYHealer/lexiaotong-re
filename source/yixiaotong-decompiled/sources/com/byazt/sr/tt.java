...
public class tt {
    ...
    public static void yp(String str) {
        try {
            c.put(str, new JSONObject("{\"values\":{\"widthMode\":\"flex\",\"paddingBottom\":0,\"bgColor\":\"#333333\",\"paddingRight\":0,\"width\":1,\"heightMode\":\"fixed\",\"borderSize\":0,\"paddingTop\":0,\"position\":\"0\",\"paddingLeft\":0,\"height\":1},\"areaType\":1,\"themeValues\":{},\"clickType\":\"\"}"));
        } catch (Exception e) {
            m.c(e);
        }
    }
    ...
    public static JSONObject iu(String str) {
        HashMap<String, JSONObject> map = c;
        if (!map.containsKey(str)) {
            ...
            switch (str.hashCode()) {
                ...
                case 1388616859:
                    ...
                    break;
                case 1671642405:
                    if (str.equals(com.byazt.dyf.tt.AD_TAG_DISLIKE)) {
                        b = 56;
                    }
                    break;
                case 1736639533:
