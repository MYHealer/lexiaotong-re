...
public class c {
    public static void c(View view, ic icVar, Context context) {
        ...
        ((com.byazt.nat.c) cVar.c(com.byazt.nat.c.class)).c((com.byazt.nat.c.InterfaceC0217c) rl.ve(icVar.lw(), com.byazt.nat.c.InterfaceC0217c.class));
        cVar.c(view, new da());
    }
