...
public class c implements gt, rh {
    ...
    public void c() {
        ...
        if (cVar == null) {
            com.byazt.qj.c cVar2 = this.f2663a;
            if (cVar2 != null) {
                cVar2.c(-1);
                return;
            }
        ...
        if (jSONObjectC == null) {
            com.byazt.hy.tt.c(this.ve, new com.byazt.hy.tt.InterfaceC0179tt() { // from class: com.byazt.qp.c.1
