...
public class tt extends AlertDialog implements qp.c {
    ...
    private void c() {
        ...
        this.f2681a = (TextView) findViewById(2114387833);
        if (this.x == null) {
            return;
        }
        pf.c((View) this.n, (View.OnClickListener) this.c, "goLiveListener");
        pf.c(this.f2681a, new View.OnClickListener() { // from class: com.byazt.rpt.tt.1
    ...
    public void handleMsg(Message message) {
        ...
        if (message.what == 101) {
            ...
            if (j > 0) {
                if (this.da) {
                    pf.c(this.f2681a, "残忍拒绝");
                } else {
                    pf.c(this.f2681a, String.format("残忍拒绝(%1$s)", String.valueOf(j)));
                }
                this.tt.sendEmptyMessageDelayed(101, 1000L);
                return;
            }
