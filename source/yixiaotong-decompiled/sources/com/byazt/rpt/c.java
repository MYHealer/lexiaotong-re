...
public class c {
    ...
    private void n() {
        ...
        this.f2680a = (TextView) this.x.findViewById(2114387864);
    ...
    public void c(com.byazt.hkv.tt ttVar) {
        ...
        TextView textView = this.f2680a;
        if (textView != null) {
            textView.setOnClickListener(ttVar);
            this.f2680a.setOnTouchListener(ttVar);
        }
    }
    ...
    public void c(String str) {
        TextView textView;
        if (TextUtils.isEmpty(str) || (textView = this.f2680a) == null) {
            return;
        }
