...
public abstract class n<T> extends com.byazt.vvt.tt<T> {
    ...
    public boolean c(final com.byazt.dj.tt ttVar, List<ic> list) {
        ...
        new com.byazt.ddx.c.C0129c().n(icVar.uj()).c(c() ? "rewarded_video" : "fullscreen_interstitial_ad").uj(icVar.w_()).tt("get_preload_ad").c(new com.byazt.ya.c() { // from class: com.byazt.cf.n.1
