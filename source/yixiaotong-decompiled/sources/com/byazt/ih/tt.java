...
public class tt {
    ...
    public c c(int i, int i2) {
        switch (i) {
            ...
            case 2:
                return new c(this.f2329a, com.byazt.kv.c.class);
            case 3:
    ...
    public String toString() {
        return "GMCustomInitConfig{mAppId='" + this.c + "', mAppKey='" + this.tt + "', mADNName='" + this.ve + "', mAdnInitClassName='" + this.uj + "', mBannerClassName='" + this.n + "', mInterstitialClassName='" + this.f2329a + "', mRewardClassName='" + this.sp + "', mFullVideoClassName='" + this.x + "', mSplashClassName='" + this.i + "', mDrawClassName='" + this.sl + "', mFeedClassName='" + this.da + "'}";
    }
}
