...
public class n {
    ...
    public static final n f2210a = new n(9);
    ...
    public void c(com.byazt.dj.tt ttVar, ic icVar, boolean z) {
        ...
        if (icVar.ym() == null || icVar.ym().optInt("save_type") != 1) {
    ...
    public static boolean c(ic icVar) {
        ...
        return icVar.ym() == null || icVar.ym().optInt("save_type") != 1;
    }
