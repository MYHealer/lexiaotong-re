...
public class uj implements tt {
    ...
    public void c(String str, sp.tt ttVar, a aVar, sp.c cVar, com.byazt.eti.c cVar2) {
        ...
        if (cVar.uj() > 0 && copyOnWriteArraySet.size() >= cVar.uj()) {
            ...
            if (cVar3 != null) {
                cVar2.c(new sp.tt(cVar3.uj, cVar3.c, cVar3.tt, cVar3.f2213a));
            }
    ...
    private sp.tt c(CopyOnWriteArraySet<String> copyOnWriteArraySet, sp.c cVar, long j, List<String> list) {
                        ...
                        if (iN != 1) {
                            if (iN != 2) {
                                if (iN == 3) {
                                    ...
                                    return new sp.tt(cVarC.uj, cVarC.c, cVarC.tt, cVarC.f2213a);
                                }
        ...
        if (cVar2 != null) {
            return new sp.tt(cVar2.uj, cVar2.c, cVar2.tt, cVar2.f2213a);
        }
        return null;
    }
    ...
    public void c(String str, sp.c cVar, com.byazt.eti.c cVar2) {
        ...
        while (it.hasNext()) {
            ...
            if (!cVarC.tt(cVar)) {
                ...
                cVar2.c(new sp.tt(cVarC.uj, cVarC.c, cVarC.tt, cVarC.f2213a));
            }
        }
    ...
    public void c(String str, String str2) {
        ...
        CopyOnWriteArraySet copyOnWriteArraySet2 = new CopyOnWriteArraySet();
        for (String str3 : copyOnWriteArraySet) {
            if (!TextUtils.equals(c.c(str3).f2213a, str2)) {
    ...
    public void c(String str, String str2, boolean z) {
        ...
        for (String str3 : copyOnWriteArraySet) {
            c cVarC = c.c(str3);
            if (TextUtils.equals(cVarC.f2213a, str2)) {
                cVarC.ve = z;
                copyOnWriteArraySet2.add(cVarC.toString());
            } else {
                copyOnWriteArraySet2.add(str3);
    ...
    @com.byazt.zqa.c(c = {0, 1, 384, AppTypeIdUtil.NewDevice4GBathOTA})
    private static class c {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                j2 = jOptLong3;
                                z = zOptBoolean;
                                iOptInt2 = jSONObject.optInt(com.hihonor.adsdk.base.g.j.e.a.L0, 0);
                                j3 = jOptLong;
                                j4 = jOptLong2;
                                str3 = strOptString2;
        ...
        public String toString() {
            ...
            try {
                ...
                jSONObject.put(Constant.MAP_KEY_UUID, this.f2213a);
                jSONObject.put("priority", this.sp);
                jSONObject.put(com.hihonor.adsdk.base.g.j.e.a.L0, this.x);
            } catch (JSONException unused) {
            }
