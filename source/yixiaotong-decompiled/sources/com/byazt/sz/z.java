...
public class z {
    ...
    public com.byazt.xj.ve<View> c(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3) {
        ...
        if (slVar != null) {
            ...
            this.zm.c(this.f2733a);
        }
        qy qyVar2 = this.f2733a;
        if (qyVar2 != null) {
            qyVar2.tt();
            this.ve.c(this.f2733a);
            this.f2733a.ve();
        }
        tt(this.ve);
        if (this.f2733a != null) {
    ...
    public com.byazt.xj.ve<View> c(i.c cVar, com.byazt.xj.ve<View> veVar) {
        List<i.c> listVe;
        com.byazt.xj.c.C0323c c0323c = null;
        if (!i.uj(cVar)) {
            return null;
        }
        x xVar = this.rl;
        ...
        if (veVar instanceof com.byazt.xj.c) {
            ...
            com.byazt.xj.c.C0323c c0323cX = cVar2.x();
            veVarC.c(cVar2);
            c0323c = c0323cX;
        }
            ...
            try {
                Collections.sort(listA, new Comparator<i.c>() { // from class: com.byazt.sz.z.1
                    ...
                    public int compare(i.c cVar3, i.c cVar4) {
                        return cVar3.n().optInt(AmmeterWalletDetailActivity.EXTRA_ORDER, 0) - cVar4.n().optInt(AmmeterWalletDetailActivity.EXTRA_ORDER, 0);
                    }
                });
    ...
    public com.byazt.xj.ve<View> tt(i.c cVar, com.byazt.xj.ve<View> veVar) {
        List<i.c> listVe;
        com.byazt.xj.c.C0323c c0323cX = null;
        if (!i.uj(cVar)) {
            return null;
        }
        x xVar = this.rl;
    ...
    public void c(com.byazt.xj.ve veVar) {
        ...
        if (cVarD != null) {
            com.byazt.xj.c.C0323c c0323cX = cVarD.x();
