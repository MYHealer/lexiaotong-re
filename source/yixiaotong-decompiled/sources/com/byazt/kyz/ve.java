...
public class ve extends u {
    ...
    public void uj(View view) {
        ...
        try {
            ...
            jSONObject2.put(IAdInterListener.AdReqParam.HEIGHT, this.sl.getHeight());
        } catch (JSONException unused) {
        }
        if (view != null) {
            ...
            try {
                ...
                jSONObject.put(IAdInterListener.AdReqParam.HEIGHT, view.getHeight());
    ...
    public void setDownloadListener(com.byazt.ocd.ve veVar) {
        ...
        this.c.c(com.byazt.pop.c.C0251c.c(veVar));
        yp ypVar = this.da;
        if (ypVar != null) {
    ...
    public n getDownloadStatusController() {
        ...
        if (this.f2445a == null && this.c != null && z) {
            this.f2445a = new n() { // from class: com.byazt.kyz.ve.8
