...
@com.byazt.zqa.c(c = {0, 1, TypedValues.TransitionType.TYPE_TRANSITION_FLAGS, 20})
public class c {
    ...
    public com.byazt.dbo.c f2345a = new com.byazt.dbo.c(4);
    ...
    private void c(final String str, final com.byazt.gat.tt<a, sp> ttVar) {
        ...
        this.c.c(this.uj, str, new com.byazt.tdq.c.InterfaceC0279c() { // from class: com.byazt.iox.c.1
            @Override // com.byazt.tdq.c.InterfaceC0279c
            public void c(final a aVar) {
                ...
                ic icVarTt = aVar.tt();
                c.this.f2345a.c(jCurrentTimeMillis);
                c.this.f2345a.tt(System.currentTimeMillis());
                ArrayList arrayList = new ArrayList();
                arrayList.add(icVarTt);
                c.this.f2345a.c(arrayList, new com.byazt.dbo.a() { // from class: com.byazt.iox.c.1.1
