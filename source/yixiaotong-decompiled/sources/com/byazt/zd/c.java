...
public abstract class c extends com.byazt.nj.c {
    ...
    public sp.c cu = new sp.c() { // from class: com.byazt.zd.c.2
        ...
        public void onPrepared(sp spVar) {
            ...
            if (com.byazt.ex.c.c(c.this.f2516a)) {
                c.this.f2516a.ve(spVar.getCodec());
            }
        ...
        public void onPlayPositionUpdate(final sp spVar, final long j, final long j2) {
            ...
            c.this.c.post(new Runnable() { // from class: com.byazt.zd.c.2.8
                ...
                public void run() {
                    ...
                    c.this.tt(j, j2);
                    c.this.c(j, j2);
                    if (c.this.f2516a.pb() <= 0 || j2 <= ((long) c.this.f2516a.pb()) * 1000 || j < ((long) c.this.f2516a.pb()) * 1000 || c.this.yp) {
                        return;
                    }
                    c.this.yp = true;
                    spVar.stop();
        ...
        public void onMonitorLog(sp spVar, JSONObject jSONObject, String str) {
            ...
            com.byazt.ddx.uj.c((Context) c.this.i.get(), c.this.f2516a, c.this.lt, "pangle_live_sdk_monitor", jSONObject);
        }
    ...
    public void c(InterfaceC0342c interfaceC0342c) {
        this.ic = interfaceC0342c;
    }
    ...
    public c(Context context, ViewGroup viewGroup, ic icVar, com.byazt.hkv.c cVar) {
        ...
        this.or = cVar;
        c(context);
        this.lr = nb.t(this.f2516a);
        this.lt = nb.tt(this.f2516a);
    }
    ...
    private void c(Context context) {
        ...
        this.n = new a(StubApp.getOrigApplicationContext(context.getApplicationContext()), new LayoutVideoPlayLayoutForLive(context), true, enumSetNoneOf, this.f2516a, this, this.or);
    ...
    public boolean c(com.byazt.jzl.a aVar) {
        ...
        this.d = (aVar.getUrl().startsWith("http") || com.byazt.ex.c.c(this.f2516a)) ? false : true;
    ...
    private boolean gr() {
        ...
        if (com.byazt.ic.c.tt(icVar)) {
            ...
            if (ttVarTk2 != null) {
                ...
                if (this.cu != null) {
                    this.cu.onError(null, new com.byazt.jzl.ve(60008, 10005, "创建Upie播放器时，iRenderView为null, mediaLayout is null: " + (this.n == null)));
                }
                m.uj("BaseVideoController", "[video] invoke NativeVideoController#playVideo error: iRenderView为null");
                return false;
            }
        } else {
            int iSl3 = nb.sl(this.f2516a);
            if (com.byazt.ex.c.c(this.f2516a)) {
                this.uj = com.byazt.btt.tt.c().createTTLiveVideoPlayer(gt.getContext(), p(), (long) xd.sp(this.f2516a), gt.tt().gy(), null);
                i = 3;
        ...
        if (icVar != null) {
            com.byazt.rgb.ve.c(icVar, String.valueOf(nb.t(this.f2516a)), nb.sl(this.f2516a), i, this.f2516a.zm());
        }
        return true;
    }
    ...
    public void bx() {
        if (this.f2516a != null) {
            new com.byazt.ddx.c.C0129c().tt("auto_replay").c(nb.tt(this.f2516a)).n(this.f2516a.uj()).uj(this.f2516a.w_()).c(new com.byazt.ya.c() { // from class: com.byazt.zd.c.4
                @Override // com.byazt.ya.c
                public void onSend(JSONObject jSONObject) throws JSONException {
                    n currentVideoInfo;
                    JSONObject jSONObject2 = new JSONObject();
                    if (t.c(c.this.f2516a)) {
    ...
    public boolean uj() {
        if (t.c(this.f2516a)) {
            return ((double) this.nb.get()) <= ((double) xd.nu(this.f2516a).sp());
        }
        return super.uj();
    }
    ...
    private void ve(com.byazt.jzl.a aVar) throws Exception {
        ...
        if (this.uj != null) {
            if (this.f2516a != null) {
                aVar.setCodeId(String.valueOf(nb.t(this.f2516a)));
            }
            aVar.setScene(1);
    ...
    public void a(boolean z) {
        if (md() && this.n != null) {
            ...
            this.n.n(true);
            if (nb.x(this.f2516a)) {
                this.n.c2(this.f2516a, this.i, true);
            } else {
                this.n.yv();
            }
            pu();
    ...
    private void lt() {
        InterfaceC0342c interfaceC0342c = this.ic;
    ...
    public void a() {
        ...
        if (!this.rl.c(64) || ve() || uj()) {
            if (this.rl.c(2) || t.c(this.f2516a)) {
    ...
    public void x() {
        ...
        if (this.uj != null) {
            if (this.uj.isPaused()) {
                if (this.da || ((this.qy != null && this.qy.isAudio()) || com.byazt.ic.c.tt(this.f2516a))) {
                    eo();
                } else {
                    tt(this.yv);
                }
    ...
    public boolean p_() {
        return this.f2516a == null || this.f2516a.fr() == 100.0f;
    }
    ...
    private boolean to() throws Throwable {
        return this.i == null || this.i.get() == null || tk() == null || this.uj == null || this.f2516a == null || pu.a(this.f2516a) != null || pu.sp(this.f2516a) != null || this.f2516a.cf() == 1;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void tt(int i, int i2) {
        try {
            if (this.i != null && this.i.get() != null && tk() != null && this.uj != null && this.f2516a != null) {
                int[] iArrTt = pf.tt(gt.getContext());
                boolean z = this.f2516a.by() == 1;
                float f = iArrTt[0];
                float f2 = iArrTt[1];
                float f3 = i;
                float f4 = i2;
    ...
    public void ve(int i, int i2) {
        try {
            m.c("changeVideoSize", "changeVideoSize start.......mMaterialMeta.getAdSlot()=" + this.f2516a.ij());
            if (to()) {
                return;
            }
    ...
    private void c(float f, float f2, float f3, float f4, boolean z) {
        ...
        if (f3 <= 0.0f || f4 <= 0.0f) {
            try {
                f3 = xd.uj(this.f2516a);
                f4 = xd.ve(this.f2516a);
            } catch (Throwable unused) {
                return;
            }
        }
    ...
    public boolean sp(int i) {
        ...
        if (iVe != 4 && iVe != 0) {
            ...
            this.z = true;
            this.hd = false;
            if (this.n != null && this.f2516a != null) {
                return this.n.c(i, xd.z(this.f2516a), true);
            }
        } else if (iVe == 4) {
            this.z = false;
            if (this.n != null) {
    ...
    public void c(int i) {
        if (com.byazt.ex.c.c(this.f2516a)) {
            ...
            if (!this.rl.c(512)) {
                this.rl.ve(512);
                if (iGu == 1) {
                    com.byazt.ddx.uj.c(this.f2516a, "rewarded_video", jCurrentTimeMillis, jSONObject, com.byazt.sw.uj.c(this.n));
                } else if (iGu == 2) {
                    com.byazt.ddx.uj.c(this.f2516a, "fullscreen_interstitial_ad", jCurrentTimeMillis, jSONObject, com.byazt.sw.uj.c(this.n));
                }
            }
            if (com.byazt.ex.c.c(this.f2516a)) {
                if (com.byazt.apd.tt.c().c(this.f2516a)) {
                    com.byazt.apd.tt.c().c(LiveMetrics.EVENT_LIVESDK_LIVE_WINDOW_DURATION_V2, this.f2516a, jCurrentTimeMillis);
                } else {
                    com.byazt.ex.c.c(LiveMetrics.EVENT_LIVESDK_LIVE_WINDOW_DURATION_V2, this.f2516a, jCurrentTimeMillis);
                }
            }
        }
    }
    ...
    public void n(int i) {
        Object obj;
        if (this.i == null || !com.byazt.ex.c.c(this.f2516a) || this.i.get() == null || (obj = (Context) this.i.get()) == null || !(obj instanceof com.byazt.fh.tt)) {
            return;
        }
    ...
    public void l() {
        if (com.byazt.ex.c.c(this.f2516a)) {
            ...
            this.rl.ve(1024);
            if (iGu == 1) {
                com.byazt.ddx.uj.c(this.f2516a, "rewarded_video", System.currentTimeMillis() - jLongValue, com.byazt.sw.uj.c(this.n));
            } else if (iGu == 2) {
                com.byazt.ddx.uj.c(this.f2516a, "fullscreen_interstitial_ad", System.currentTimeMillis() - jLongValue, com.byazt.sw.uj.c(this.n));
            }
        }
    }
    ...
    public void c(int i, String str) {
        if (com.byazt.ex.c.c(this.f2516a)) {
            int iGu = gu();
            if (iGu == 1) {
                com.byazt.ddx.uj.c(this.f2516a, "rewarded_video", i, str, com.byazt.sw.uj.c(this.n));
            } else if (iGu == 2) {
                com.byazt.ddx.uj.c(this.f2516a, "fullscreen_interstitial_ad", i, str, com.byazt.sw.uj.c(this.n));
            }
        }
    }
    ...
    public void lo() {
        this.c.post(new Runnable() { // from class: com.byazt.zd.c.7
            @Override // java.lang.Runnable
            public void run() {
                if (my.uj(c.this.f2516a) || !c.this.p_()) {
                    c cVar = c.this;
                    cVar.c(cVar.tk, c.this.kp);
                    return;
                }
                if (com.byazt.ex.c.c(c.this.f2516a) && c.this.f2516a.by() == 2 && c.this.p_()) {
                    return;
                }
                if (c.this.p_()) {
                    if (c.this.f2516a == null || c.this.f2516a.vi() != 0) {
                        if (c.this.f2516a == null || c.this.f2516a.vi() != 2) {
                            c cVar2 = c.this;
                            cVar2.ve(cVar2.tk, c.this.kp);
                            return;
                        } else {
                            c cVar3 = c.this;
                            cVar3.tt(cVar3.tk, c.this.kp);
                            return;
                        }
                    }
                    c cVar4 = c.this;
                    cVar4.uj(cVar4.tk, c.this.kp);
                    return;
                }
                c cVar5 = c.this;
    ...
    public Map<String, Object> pf() {
        ...
        for (Map.Entry<String, Object> entry2 : nb.c(this.h, this.f2516a, nu()).entrySet()) {
