...
@com.byazt.zqa.c(c = {0, 1, 189, 20})
public abstract class c implements z {
    public static final String n = "c";

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public WeakReference<Service> f2951a;
    ...
    public void c(int i, Notification notification) {
        WeakReference<Service> weakReference = this.f2951a;
        if (weakReference != null && weakReference.get() != null) {
            com.byazt.x.c.ve(n, "startForeground  id = " + i + ", service = " + this.f2951a.get() + ",  isServiceAlive = " + this.tt);
            try {
                this.f2951a.get().startForeground(i, notification);
                this.ve = true;
                return;
            } catch (Exception e) {
                com.byazt.nr.m.c(e);
    ...
    public void c(boolean z) {
        ...
        com.byazt.x.c.ve(n, "stopForeground  service = " + this.f2951a.get() + ",  isServiceAlive = " + this.tt);
        try {
            this.ve = false;
            this.f2951a.get().stopForeground(z);
        } catch (Exception e) {
            com.byazt.nr.m.c(e);
        }
    }
