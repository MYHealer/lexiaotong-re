...
@com.byazt.zqa.c(c = {0, 1, 189, 54})
public class ve {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static volatile com.byazt.b.c f2953a;
    ...
    public interface c {
        ...
        gt c(InterfaceC0351c interfaceC0351c);
    ...
    private static com.byazt.hs.sp tt(String str, List<com.byazt.t.ve> list, int i2, boolean z2, DownloadInfo downloadInfo) throws Throwable {
        ...
        if (z2) {
            try {
                ...
                iOException = iOException2;
                if (z2) {
                    com.byazt.zl.c.c(null, str, null, System.currentTimeMillis() - jCurrentTimeMillis, TtmlNode.TAG_HEAD, i2, iOException, downloadInfo);
                }
                throw th;
            }
        }
        try {
            try {
                ...
                if (z2) {
                    com.byazt.zl.c.c(spVarC, str, null, System.currentTimeMillis() - jCurrentTimeMillis, TtmlNode.TAG_HEAD, i2, null, downloadInfo);
                }
                return spVarC;
            } catch (IOException e2) {
                e = e2;
