...
@com.byazt.zqa.c(c = {0, 1, 189, 34})
public class a {
    public static final String c = "a";

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public DownloadTask f2950a;
    ...
    private void da() {
        DownloadTask downloadTask = this.f2950a;
        if (downloadTask != null) {
            this.ve = downloadTask.getDownloadInfo();
            this.sp = this.f2950a.getDownloadListeners(com.byazt.ev.a.MAIN);
            this.i = this.f2950a.getDownloadListeners(com.byazt.ev.a.NOTIFICATION);
            this.x = this.f2950a.getDownloadListeners(com.byazt.ev.a.SUB);
            this.m = this.f2950a.getDepend();
            this.nu = this.f2950a.getMonitorDepend();
        }
    }
    ...
    private BaseException ve(BaseException baseException) {
        ...
        return new BaseException(this.ve.isOnlyWifi() ? 1013 : 1049, baseException.getErrorMessage());
    }
    ...
    public void a() {
        ...
        if (!this.ve.isIgnoreDataVerify() && this.ve.getCurBytes() != this.ve.getTotalBytes()) {
            ...
            c(new com.byazt.m.a(AnalyticsListener.EVENT_DRM_SESSION_RELEASED, "current bytes is not equals to total bytes, bytes changed with process : " + this.ve.getByteInvalidRetryStatus()));
            return;
        }
        if (this.ve.getCurBytes() <= 0) {
            com.byazt.x.c.tt(c, this.ve.getErrorBytesLog());
            c(new com.byazt.m.a(AnalyticsListener.EVENT_DRM_KEYS_REMOVED, "curBytes is 0, bytes changed with process : " + this.ve.getByteInvalidRetryStatus()));
            return;
        }
    ...
    public void t() {
        try {
            ...
            c(new BaseException(1008, com.byazt.w.a.tt(th, "onCompleted")));
        }
    }
    ...
    private void u() throws BaseException {
        List<com.byazt.c.u> downloadCompleteHandlers = this.f2950a.getDownloadCompleteHandlers();
    ...
    public void x() {
        ...
        if (cVarD != null) {
            cVarD.c(this.ve.getId(), this.f2950a.getHashCodeForSameTask(), 8);
        }
    }
    ...
    private void c(int i, BaseException baseException, boolean z) {
        ...
        if (!this.ve.isAddListenerToSameTask()) {
            com.byazt.zl.c.c(this.f2950a, baseException, i);
        }
        if (i == 6) {
            this.ve.setStatus(2);
        } else if (i == -6) {
        ...
        if (z && this.n != null && (((sparseArray = this.sp) != null && sparseArray.size() > 0) || ((sparseArray2 = this.i) != null && sparseArray2.size() > 0 && (this.ve.canShowNotification() || this.ve.isAutoInstallWithoutNotification())))) {
            this.n.obtainMessage(i, this.ve.getId(), this.f2950a.getHashCodeForSameTask(), baseException).sendToTarget();
            return;
        }
        com.byazt.b.c cVarD = ve.d();
        if (cVarD != null) {
            cVarD.c(this.ve.getId(), this.f2950a.getHashCodeForSameTask(), i);
        }
    }
}
