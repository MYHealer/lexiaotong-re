...
public class n extends c {
    ...
    @Override // com.byazt.hp.c
    public void tt() {
        this.f2304a = (float) this.c.optDouble("start", 0.0d);
        this.sp = this.c.optString(HiAnalyticsConstant.HaKey.BI_KEY_DIRECTION, TtmlNode.CENTER);
    }
    ...
    public List<PropertyValuesHolder> ve() {
        PropertyValuesHolder propertyValuesHolderOfFloat = PropertyValuesHolder.ofFloat(uj(), this.f2304a, 1.0f);
