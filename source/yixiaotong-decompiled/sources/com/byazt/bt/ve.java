...
@com.byazt.zqa.c(c = {0, 1, 274, 54})
public class ve {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static volatile String f2015a;
    ...
    private static WifiManager uj(Context context) {
        ...
        synchronized (ve.class) {
            ...
            d = (WifiManager) StubApp.getOrigApplicationContext(context.getApplicationContext()).getSystemService("wifi");
            return d;
        }
    }
    ...
    public static String c(Boolean bool, com.byazt.dna.c cVar, Context context) {
        ...
        return m ? tt : c(customController, bool.booleanValue(), context);
    }
    ...
    private static void n(Context context) {
        synchronized (ve.class) {
            ...
            if (uj.c(context, "android.permission.READ_PHONE_STATE") == 0) {
                nu = true;
    ...
    private static String a(Context context) {
        ...
        synchronized (ve.class) {
            ...
            try {
                f2015a = telephonyManagerC.getSubscriberId();
            } catch (Throwable unused) {
            }
            gt = true;
            return f2015a;
    ...
    private static void c(com.byazt.dna.c cVar, boolean z2, int i2, com.byazt.lz.ve veVar) {
        ...
        x.c(o0OO000o.o00OoOo, strC, cVar, i2);
    ...
    private static String ve(com.byazt.dna.c cVar, boolean z2, int i2, com.byazt.lz.ve veVar) {
        try {
            ...
            if (!TextUtils.isEmpty(strTt)) {
                ...
                long j = jSONObject.getLong(CrashHianalyticsData.TIME);
                String strDecryptAESWithCBC = ((com.byazt.dna.n) com.byazt.ut.uj.getService("armor_service")).decryptAESWithCBC(jSONObject.getString(oOOOoo00.OooOo0o));
