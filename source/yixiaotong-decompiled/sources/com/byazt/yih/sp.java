...
@com.byazt.zqa.c(c = {0, 1, 730, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
    ...
    public boolean c(final com.byazt.qt.c cVar) {
        ...
        da.c().postDelayed(new Runnable() { // from class: com.byazt.yih.sp.1
            ...
            public void run() {
                ...
                map.put(com.hihonor.adsdk.base.g.j.e.a.v, Integer.valueOf(cVar.uj()));
                map.put("package_name", cVar.ve());
                JSONObject jSONObject = new JSONObject();
                try {
                    jSONObject.putOpt(oOOOoo00.OooOo0o, cVar.x());
