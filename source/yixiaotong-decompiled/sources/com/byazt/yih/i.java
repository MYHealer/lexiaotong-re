...
public class i {
    ...
    public static String c(ic icVar, boolean z) {
        ...
        try {
            ...
            if (icVar != null) {
                ...
                jSONObject.put(ba.D, icVar.uj());
                jSONObject.put("rit", nb.c(icVar, ""));
            }
            Context context = gt.getContext();
            if (context == null) {
                jSONObject.put(CrashHianalyticsData.MESSAGE, "context is null");
                yp.c().c("dl_path_empty", jSONObject, (Throwable) null);
                return "";
            }
            File fileTt = com.byazt.qh.tt.tt(context);
            if (fileTt == null) {
                jSONObject.put(CrashHianalyticsData.MESSAGE, "file is null");
                yp.c().c("dl_path_empty", jSONObject, (Throwable) null);
                return "";
            }
            if (!fileTt.exists() && !fileTt.mkdirs()) {
                jSONObject.put(CrashHianalyticsData.MESSAGE, "mkdirs failed");
                yp.c().c("dl_path_empty", jSONObject, (Throwable) null);
            }
            return fileTt.exists() ? fileTt.getAbsolutePath() : "";
        } catch (Throwable th) {
            try {
                jSONObject.put(CrashHianalyticsData.MESSAGE, "path:".concat(""));
    ...
    public static boolean tt() {
        return com.byazt.xgx.n.c().c(gt.getContext(), "android.permission.WRITE_EXTERNAL_STORAGE");
    }
