...
public class n implements uj {
    ...
    private String ve(com.byazt.qt.c cVar) {
        ...
        if (context != null && (applicationInfo = context.getApplicationInfo()) != null && applicationInfo.targetSdkVersion >= 33 && Build.VERSION.SDK_INT >= 33 && !com.byazt.xgx.n.c().tt(gt.getContext(), com.huawei.openalliance.ad.constant.x.cK)) {
    ...
    public boolean c(final com.byazt.qt.c cVar) {
        ...
        c("notification", cVar, ba.ah, "othershow", strVe, "failure");
        return false;
    }
            ...
            public void onSuccess(m<Bitmap> mVar) {
                if (mVar != null) {
                    ...
                    if (result != null) {
                        ...
                        n.c("notification", cVar, zTt ? "open" : ba.ah, "othershow", str + "_" + cVar.ve(), "success");
    ...
    public boolean c(long j, int i, long j2) {
        ...
        try {
            ...
            if (lValueOf.longValue() >= 0 && i2 >= 0 && lValueOf.longValue() != 0 && i2 != 0) {
                ...
                int i3 = length - i2;
                Long lValueOf2 = Long.valueOf(Long.parseLong(strArrSplit[i3]));
                if (jCurrentTimeMillis - Long.valueOf(Long.parseLong(strArrSplit[length - 1])).longValue() > j2 && jCurrentTimeMillis - lValueOf2.longValue() > lValueOf.longValue()) {
