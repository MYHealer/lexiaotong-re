...
@com.byazt.zqa.c(c = {0, 1, 31, 145})
public class my {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final com.byazt.ddx.n f2566a;
    public final ic c;
    public c cu;
    ...
    public my(Context context, com.byazt.nc.u uVar, ic icVar, String str) {
        ...
        this.tt = context;
        this.sp = str;
        this.f2566a = new com.byazt.ddx.n(icVar, str);
    }
    ...
    public void c(final ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, List<View> list4, View view, final com.byazt.lsp.c cVar, com.byazt.lsp.c cVar2) {
        ...
        c cVar3 = new c(this.f2566a, viewGroup);
        this.cu = cVar3;
        ...
        if (emptyViewVe == null) {
            ic icVar2 = this.c;
            EmptyView emptyView2 = new EmptyView(this.tt, viewGroup, icVar2 != null ? icVar2.m760if() : 1000) { // from class: com.byazt.omf.my.3
        ...
        emptyView.setCallback(new EmptyView.c() { // from class: com.byazt.omf.my.4
            ...
            public void c(boolean z) {
                my.this.f2566a.c(zb.tt(viewGroup), z ? 12 : 13);
                com.byazt.nr.zm zmVar = my.this.my;
                if (zmVar != null) {
                    if (z) {
                        zmVar.c(my.this.c != null ? my.this.c.eo() : 0);
            ...
            public void c() {
                ...
                my.this.f2566a.c(zb.tt(viewGroup), 14);
            }
            ...
            public void tt() {
                ...
                my.this.f2566a.c(zb.tt(viewGroup), 15);
            }
            ...
            public void c(View view2, Map<String, Object> map) {
                ...
                my.this.ve();
                my.this.f2566a.c(zb.tt(viewGroup), 11);
    ...
    private void c(final com.byazt.hkv.tt ttVar, ViewGroup viewGroup, View view, final com.byazt.lsp.c cVar, final com.byazt.lsp.c cVar2, final int i) {
        ...
        if (i != 3) {
            ...
            map.put(com.hihonor.adsdk.base.g.j.e.a.hnadsh, 1);
            ((com.byazt.vis.c) ttVar.c(com.byazt.vis.c.class)).c(map);
        }
        ttVar.c(viewGroup);
        ttVar.tt(view);
        ((com.byazt.nat.c) ttVar.c(com.byazt.nat.c.class)).c(this.uj);
        com.byazt.nat.c.InterfaceC0217c interfaceC0217c = new com.byazt.nat.c.InterfaceC0217c() { // from class: com.byazt.omf.my.5
        ...
        ((com.byazt.nat.c) ttVar.c(com.byazt.nat.c.class)).c(interfaceC0217c);
        ic icVar = this.c;
        if (icVar != null) {
    ...
    public Map<String, Object> sp() {
        ...
        if (this.yp != null) {
            ...
            try {
                jSONObject2.put("width", this.yp.getWidth());
                jSONObject2.put("height", this.yp.getHeight());
    ...
    public void tt() {
        ...
        com.byazt.nr.da.tt().post(new Runnable() { // from class: com.byazt.omf.my.2
            @Override // java.lang.Runnable
            public void run() {
                com.byazt.ddx.n nVar = my.this.f2566a;
                if (nVar != null) {
                    nVar.c(16);
                }
            }
