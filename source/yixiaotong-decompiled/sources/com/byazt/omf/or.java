...
public class or {
    ...
    private static boolean c(Object obj) {
        if (obj == null || !(obj instanceof com.byazt.ua.c.InterfaceC0286c)) {
            return false;
        }
        try {
            return ((com.byazt.ua.c.InterfaceC0286c) obj).getHasUseCustomizeVideo();
        } catch (Throwable unused) {
            return false;
        }
    }
    ...
    private static void c(Context context, ic icVar, Object obj, boolean z, Intent intent) {
        ...
        if (obj != null) {
            videoModel = obj instanceof com.byazt.ua.c.InterfaceC0286c ? ((com.byazt.ua.c.InterfaceC0286c) obj).getVideoModel() : null;
            if (videoModel != null) {
    ...
    private static void c(Context context, String str, ic icVar, int i, String str2, Intent intent) {
        ...
        intent.putExtra("title", icVar.v_());
        intent.putExtra("sdk_version", p.uj);
        intent.putExtra("ad_id", icVar.uj());
