...
public class zm extends com.byazt.dj.uj implements Serializable, Function<SparseArray<Object>, Object> {
    ...
    public boolean isCanUseLocation() {
        ...
        if (ujVar == null) {
            if (super.isCanUseLocation() && com.byazt.xgx.n.c().c(gt.getContext(), g.h) && com.byazt.xgx.n.c().c(gt.getContext(), "android.permission.ACCESS_FINE_LOCATION")) {
                return true;
            }
        } else if (ujVar.isCanUseLocation() && com.byazt.xgx.n.c().c(gt.getContext(), g.h) && com.byazt.xgx.n.c().c(gt.getContext(), "android.permission.ACCESS_FINE_LOCATION")) {
            return true;
        }
        return false;
    }
    ...
    public boolean isCanUsePhoneState() {
        ...
        return ujVar.isCanUsePhoneState() && com.byazt.xgx.n.c().c(gt.getContext(), "android.permission.READ_PHONE_STATE");
    }
