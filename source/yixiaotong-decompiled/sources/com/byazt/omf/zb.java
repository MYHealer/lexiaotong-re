...
public class zb {
    ...
    private static int ve(View view, int i) {
        if (i == 3) {
            return (int) (((double) pf.uj(StubApp.getOrigApplicationContext(view.getContext().getApplicationContext()))) * 0.7d);
        }
        return 20;
    }
    ...
    private static int uj(View view, int i) {
        if (i == 3) {
            return pf.n(StubApp.getOrigApplicationContext(view.getContext().getApplicationContext())) / 2;
        }
        return 20;
    }
