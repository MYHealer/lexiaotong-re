...
public class c extends tt {
    ...
    public UgenLottieView c() {
        ...
        ugenLottieViewC.setEventMonitorProxy(new C0267c(this, ttVar));
    ...
    public class AnonymousClass5 implements uj {
        ...
        public Bitmap c(final i iVar) {
            ...
            ((UgenLottieView) c.this.n).c(strC, new com.byazt.rs.i() { // from class: com.byazt.si.c.5.1
                ...
                @Override // com.byazt.rs.i
                public void c() {
                    n.c().tt().c(c.this.i, strC, new com.byazt.sa.c.InterfaceC0263c() { // from class: com.byazt.si.c.5.1.1
    ...
    @com.byazt.zqa.c(c = {0, 1, 608, 44})
    private static class C0267c implements com.byazt.qm.tt {
        ...
        public C0267c(ve veVar, LottieAnimationView.tt ttVar) {
