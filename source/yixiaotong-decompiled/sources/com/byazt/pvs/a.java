...
public class a implements n {
    ...
    public List<uj> c() {
        ...
        Cursor cursorQuery = com.byazt.ym.tt.query(this.tt, com.hihonor.adsdk.base.g.j.e.a.m, null, null, null, null, null, null, this.c);
        if (cursorQuery != null) {
    ...
    public void insert(uj ujVar) {
        ...
        contentValues.put("extra", com.byazt.nr.c.tt(ujVar.c().toString()));
        contentValues.put("encrypt", (Integer) 1);
        com.byazt.ym.tt.insert(this.tt, com.hihonor.adsdk.base.g.j.e.a.m, contentValues, this.c);
    }
    ...
    public void update(uj ujVar) {
        ...
        contentValues.put("extra", com.byazt.nr.c.tt(ujVar.c().toString()));
        contentValues.put("encrypt", (Integer) 1);
        com.byazt.ym.tt.update(this.tt, com.hihonor.adsdk.base.g.j.e.a.m, contentValues, "id=?", new String[]{ujVar.tt()}, this.c);
    }

    @Override // com.byazt.pvs.n
    public void delete(uj ujVar) {
        com.byazt.ym.tt.delete(this.tt, com.hihonor.adsdk.base.g.j.e.a.m, "id=?", new String[]{ujVar.tt()}, this.c);
    }
}
