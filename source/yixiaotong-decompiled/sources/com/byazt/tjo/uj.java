...
public class uj {
    ...
    public com.byazt.omf.ve f2745a;
    ...
    public void c(Context context, com.byazt.lkb.c cVar, com.byazt.fb.ve veVar, long j, com.byazt.omf.ve veVar2, long j2, JSONObject jSONObject) {
        ...
        if (cVar != null) {
            ...
            if (!c) {
                ...
                try {
                    jSONObject.put("0-init", a.f2742a - a.n);
    ...
    public void ve() {
        if (this.n != null) {
            ...
            if (this.f2745a != null && p.uj < 7500) {
                com.byazt.yxi.uj ujVarC = com.byazt.yxi.uj.c();
                ujVarC.c(23, this.f2745a.getReuseServiceMap());
                nVarC.c(ujVarC.tt());
            }
            ve = nVarC.tt();
            this.n.c(0, ve);
    ...
    private com.byazt.yf.c c(com.byazt.lkb.c cVar) {
        return new com.byazt.yf.c.C0332c().c(cVar.n()).tt(cVar.a()).c(cVar.uj()).ve(cVar.z()).tt(cVar.m()).c(ve.c(cVar.nu())).c(cVar.rh()).c(cVar.yp()).ve(cVar.my()).c(cVar.gt()).uj(cVar.t()).c(new com.byazt.yf.t.c().c(cVar.sp()).tt(cVar.x()).c(cVar.i()).c(cVar.da()).tt(cVar.sl()).c(cVar.u()).c(ve.c(cVar.rh())).c()).c(new com.byazt.yf.x.c().c(cVar.qy()).c(cVar.rl()).tt(cVar.gu()).ve(cVar.gr()).c()).c(cVar.tt()).c();
    }
}
