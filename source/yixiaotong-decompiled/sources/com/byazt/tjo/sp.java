...
@com.byazt.zqa.c(c = {0, 1, 516, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp implements Function<SparseArray<Object>, Object> {
    ...
    public void c(int i, SparseArray<Object> sparseArray, PluginValueSet pluginValueSet, Function<SparseArray<Object>, Object> function, Map<String, Object> map, boolean z) {
        ...
        boolean z3 = !TextUtils.isEmpty(cVar4.h());
        if (i == 1) {
            if (com.byazt.vq.c.c().c(cVar4.uj(), 1, z3)) {
        ...
        if (i == 3) {
            if (com.byazt.vq.c.c().c(cVar4.uj(), 3, z3)) {
                com.byazt.eu.tt.tt("TMe", "load m splash 广告位 = " + cVar.n() + ",ritId:" + cVar4.uj());
            } else if (com.byazt.ck.uj.c().ve() && cVar.sp() != null && !TextUtils.isEmpty(cVar.sp().c()) && !TextUtils.isEmpty(cVar.sp().ve()) && !TextUtils.isEmpty(cVar.sp().tt())) {
            ...
            final com.byazt.bc.tt ttVar = new com.byazt.bc.tt(function);
            if (!rh.c) {
                m.uj("TMe", h.NOT_INIT_TIPS_MSG);
                ...
                com.byazt.yf.da.c(new com.byazt.ko.c() { // from class: com.byazt.tjo.sp.2
                    ...
                    public void c() {
                        com.byazt.qv.tt.c(sp.this.tt, cVar4, cVar, ttVar, z4);
                    }
                });
                return;
            }
        ...
        if (i == 5) {
            ...
            if (com.byazt.vq.c.c().c(cVar4.uj(), 5, z3)) {
        ...
        if (i == 7) {
            if (com.byazt.vq.c.c().c(cVar4.uj(), 7, z3)) {
        ...
        if (i != 8) {
            if (i == 9) {
                if (com.byazt.vq.c.c().c(cVar4.uj(), 9, z3)) {
        ...
        if (com.byazt.vq.c.c().c(cVar4.uj(), 8, z3) || com.byazt.vq.c.c().c(cVar4.uj(), 10, z3)) {
