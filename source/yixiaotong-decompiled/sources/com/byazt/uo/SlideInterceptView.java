...
public class SlideInterceptView extends View implements qp.c {
    ...
    private boolean ve(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (motionEvent.getPointerCount() > 0) {
                ...
                this.f2787a = motionEvent.getY(0);
                this.uj = motionEvent;
            }
            if (z) {
                this.sp = true;
    ...
    private boolean c(tt ttVar, float f, float f2, long j, float f3, float f4, MotionEvent motionEvent, boolean z) {
        ...
        if (ttVar.f2788a || !c(f, f2, j, iGu, iVe2)) {
            return false;
        }
        ttVar.f2788a = true;
        c cVar2 = this.i;
    ...
    public void handleMsg(Message message) {
        if (gt.tt().tw()) {
            ...
            while (it.hasNext()) {
                ...
                if (value != null && !value.f2788a && c(value.uj - value.c, value.n - value.tt, System.currentTimeMillis() - value.ve, this.x.gu(), pf.ve(getContext(), this.x.gr()))) {
                    value.f2788a = true;
                    c cVar = this.i;
                    if (cVar != null) {
        ...
        if (!c(this.n - this.c, this.f2787a - this.tt, System.currentTimeMillis() - this.ve, this.x.gu(), pf.ve(getContext(), this.x.gr())) || this.sp) {
            return;
        }
        this.sp = true;
        c cVar2 = this.i;
        if (cVar2 != null) {
            cVar2.c(this, c(this.n, this.f2787a, this.uj, (byte) 5));
        }
    }
