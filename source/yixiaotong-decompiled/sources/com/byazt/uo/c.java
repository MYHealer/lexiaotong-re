...
public class c extends com.byazt.nc.tt implements qp.c, TsView.c {
    ...
    public View.OnTouchListener f2789a;
    public String aw;
    ...
    private void da() {
        ...
        ic icVar = this.tt;
        if (icVar != null && icVar.ek() != null && this.tt.ek().tt() == 0) {
    ...
    private void sl() {
        EmptyView emptyView = new EmptyView(this.sv, this.c, this.tt.m760if());
        ...
        com.byazt.nat.c.InterfaceC0217c interfaceC0217c = new com.byazt.nat.c.InterfaceC0217c() { // from class: com.byazt.uo.c.9
        ...
        ((com.byazt.nat.c) this.n.c(com.byazt.nat.c.class)).c(interfaceC0217c);
        ic icVar = this.tt;
        if (icVar != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void t() {
        com.byazt.omf.x.m().ve().ve(new C0293c(this.tt));
    }
    ...
    private static class C0293c implements com.byazt.aas.c.tt {
        public ic c;
