...
@com.byazt.zqa.c(c = {0, 1, 528, TypedValues.Custom.TYPE_REFERENCE})
public class PlayableFeedWebView extends SSWebView implements com.byazt.nl.ve.c, com.byazt.kyz.tt, i {
    ...
    private void i() {
        ...
        com.byazt.vgp.n nVar = new com.byazt.vgp.n(this.f2722a);
        ...
        if (this.f2722a == null || setDa == null || setDa.size() <= 0) {
            return;
        }
        final WeakReference weakReference = new WeakReference(this.nu);
        Iterator<String> it = setDa.iterator();
        while (it.hasNext()) {
            this.f2722a.a().c(it.next(), (com.byazt.pct.n<?, ?>) new com.byazt.pct.n<JSONObject, JSONObject>() { // from class: com.byazt.sy.PlayableFeedWebView.4
    ...
    private void sl() {
        ...
        com.byazt.ol.n.c().c(this, this.f2722a);
        setWebChromeClient(new com.byazt.jwd.ve(this.f2722a));
    }

    @Override // com.byazt.sy.i
    public void L_() {
        if (this.f2722a == null || ((ViewGroup) getParent()) == null) {
            return;
        }
        setOnShakeListener(new com.byazt.ouz.p(this, this.f2722a, this.sp));
        if (this.x != null) {
    ...
    public static class c extends com.byazt.jwd.uj {
        ...
        public WebResourceResponse shouldInterceptRequest(final WebView webView, String str) {
            try {
                com.byazt.six.c cVarC = com.byazt.jlk.c.c(webView, this.c, str, new com.byazt.jlk.c.InterfaceC0190c() { // from class: com.byazt.sy.PlayableFeedWebView.c.1
                    @Override // com.byazt.jlk.c.InterfaceC0190c
                    public boolean c() {
                        return false;
                    }
    ...
    public void tt(int i) {
        ...
        if (this.f2722a != null) {
            try {
                ...
                this.f2722a.tt("expressAdShow", jSONObject);
            } catch (Exception e) {
                com.byazt.nr.m.c(e);
            }
        }
        com.byazt.kp.c.c(this.f2722a, i == 0, true, true);
    }
    ...
    public void destroy() {
        ...
        if (dVar != null) {
            dVar.n();
            this.f2722a.c((SSWebView.tt) null);
        }
        this.f2722a = null;
        super.destroy();
    }
