...
public class InteractWebView extends SSWebView {
    ...
    public void a() {
        ...
        if (obj instanceof ic) {
            this.x = (ic) obj;
            this.f2721a = (d) this.sp.get("key_js_object");
            if (this.sp.containsKey("key_data_list") && (this.sp.get("key_data_list") instanceof List)) {
                this.f2721a.tt((List<JSONObject>) this.sp.get("key_data_list"));
            }
            this.f2721a.tt(this).c(this.x).c(nb.tt(this.x)).tt(this.x.uj()).uj(this.x.w_()).n(nb.my(this.x)).c((SSWebView) this);
        }
    }
    ...
    public void sp() {
        ...
        com.byazt.ol.n.c().c(this, this.f2721a);
        setWebChromeClient(new com.byazt.jwd.ve(this.f2721a));
    }
    ...
    public static class c extends com.byazt.jwd.uj {
        ...
        public WebResourceResponse shouldInterceptRequest(final WebView webView, String str) {
            try {
                com.byazt.six.c cVarC = com.byazt.jlk.c.c(webView, this.c, str, new com.byazt.jlk.c.InterfaceC0190c() { // from class: com.byazt.sy.InteractWebView.c.1
