...
public abstract class c<K, A> {
    ...
    public final List<InterfaceC0132c> c = new ArrayList(1);
    public boolean uj = false;
    public float tt = 0.0f;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public A f2080a = null;
    public float sp = -1.0f;
    public float x = -1.0f;

    /* JADX INFO: renamed from: com.byazt.dg.c$1, reason: invalid class name */
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_GET_VIDEODECODER_FPS, 26})
    ...
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_GET_VIDEODECODER_FPS, 187})
