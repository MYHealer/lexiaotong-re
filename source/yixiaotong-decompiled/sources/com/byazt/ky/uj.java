...
public class uj implements com.byazt.zyd.ve {
    ...
    public com.byazt.aas.c.tt n = new com.byazt.aas.c.tt() { // from class: com.byazt.ky.uj.1
        ...
        public void onAppBackground() {
            if (com.byazt.omf.x.m().d() || uj.this.uj || uj.this.f2443a == null || uj.this.f2443a.i == null) {
                return;
            }
            try {
                JSONObject jSONObject = new JSONObject();
                jSONObject.putOpt("ad_load_id", uj.this.f2443a.c);
                jSONObject.putOpt("ad_show_id", uj.this.f2443a.c());
                jSONObject.putOpt("node_line_name", "ad_node_line");
                uj ujVar = uj.this;
                ujVar.c(ujVar.f2443a.c(), jSONObject);
                com.byazt.qcl.uj.c(jSONObject, uj.this.f2443a, uj.this.f2443a.f2284a, "ad_show");
    ...
    public void sp(com.byazt.ha.ve veVar, com.byazt.ip.x xVar) {
        ...
        com.byazt.qcl.tt ttVar = new com.byazt.qcl.tt("ad_show", TtmlNode.END, xVar != null ? xVar.c() : System.currentTimeMillis(), veVar.tt);
        veVar.f2284a.add(ttVar);
        com.byazt.qcl.ve.c(ttVar, veVar.i, veVar);
        c(veVar);
    }
    ...
    private void c(com.byazt.ha.ve veVar) {
        ...
        m.c("Tme_node_line", "show_observer_send  l_id:" + veVar.c() + "  load_l_id:" + veVar.c + "  n_l:" + com.byazt.qcl.uj.c(veVar.f2284a));
        for (com.byazt.qcl.tt ttVar : veVar.f2284a) {
        ...
        if (!(this.tt == 0 && this.ve == 0 && this.c == 0) && c()) {
            try {
                ...
                com.byazt.qcl.uj.c(veVar.f2284a, veVar, "ad_node_line", jSONObject);
