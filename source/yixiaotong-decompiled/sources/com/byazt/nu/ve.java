...
public final class ve implements Function<SparseArray<Object>, Object> {
    ...
    private Map<String, Object> tt(Map<String, Object> map) {
        ...
        RemoteViews remoteViews = new RemoteViews(this.tt.getPackageName(), this.tt.getResources().getIdentifier("tt_install_notification_layout", TtmlNode.TAG_LAYOUT, this.tt.getPackageName()));
        int iU = c.u();
        int iT = c.t();
        int iYp = c.yp();
        int iZ = c.z();
    ...
    /* JADX WARN: Code duplicated, block: B:249:0x04da  */
    /* JADX WARN: Code duplicated, block: B:250:0x04dc  */
    /* JADX WARN: Code duplicated, block: B:253:0x04e6  */
    private Map<String, Object> ve(Map<String, Object> map) {
        ...
        int i4;
        int i5;
        RemoteViews remoteViews = new RemoteViews(this.tt.getPackageName(), this.tt.getResources().getIdentifier("tt_adl_notification_layout", TtmlNode.TAG_LAYOUT, this.tt.getPackageName()));
        HashMap map2 = new HashMap();
        ...
        Object obj5 = map.get(com.hihonor.adsdk.base.g.j.e.a.hnadsh);
    ...
    /* JADX WARN: Code duplicated, block: B:26:0x002d A[EXC_TOP_SPLITTER, PHI: r4
