...
public class u implements Runnable {
    ...
    private void ve(i iVar) throws BaseException {
        try {
            try {
                ...
                this.i = str;
                com.byazt.hs.i iVarC = com.byazt.zz.ve.c(this.u.isNeedDefaultHttpServiceBackUp(), this.u.getMaxBytes(), strReplaceFirst, str, listC, 0, jCurrentTimeMillis - this.zb > C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS && this.yp.tt("monitor_download_connect") > 0, this.u);
                if (iVarC == null) {
  ...
  0x0300: PHI (r15v7 com.byazt.h.c) = (r15v6 com.byazt.h.c), (r15v9 com.byazt.h.c) binds: [B:166:0x02f0, B:213:0x0300] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    private void uj(i iVar) throws BaseException {
        long j;
        n nVarUj;
        ...
        try {
            try {
                ...
                try {
                    ...
                    long jX = this.m.x();
                    if (jX == 0) {
                        throw new com.byazt.m.a(1004, "the content-length is 0, contentLength = ".concat(String.valueOf(jX)));
                    }
                    cVarTt = c(veVar, inputStreamC);
                    try {
                        if (this.zm || this.gr) {
                            throw new m("probe");
                        }
                        this.sl.tt(this, iVar);
                        nVarUj = this.sl.uj(this, iVar);
                        try {
                            long jA = iVar.a();
                            if (jA <= 0) {
                                jA = jX > 0 ? (jX + jN) - 1 : Long.MAX_VALUE;
                            }
                            int i4 = cVarTt.ve;
                            long j4 = i4;
                            j = jN + j4;
                            try {
                                if (j > jA) {
                                    long j5 = jA + 1;
                                    if (j > j5 && (i3 = (int) (j4 - (j - j5))) > 0 && i3 < i4) {
                                        cVarTt.ve = i3;
                                        j = j5;
                                    }
                                    this.rl = j;
                                    nVarUj.tt(cVarTt);
                                    com.byazt.w.a.c(inputStreamC);
                                    if (nVarUj != null) {
                                        try {
                                            c cVarTt3 = veVar.tt();
                                            try {
                                    ...
                                    if (j > jN) {
                                        com.byazt.zl.c.c(this.yp, this.u, this.x, this.i, this.da, this.gr || this.zm, this.z, this.qp, j - jN, TimeUnit.MILLISECONDS.toNanos(this.sp - this.f2283a));
                                    }
                                } else {
                                    this.rl = j;
                                    nVarUj.tt(cVarTt);
                                        ...
                                        try {
                                            if (this.md) {
                                                synchronized (this) {
                                                    this.md = z3;
                                                    if (this.zm || this.gr) {
                                                        throw new m("loopAndRead");
                                                    }
                                                }
                                                synchronized (this.sl) {
                                                    if (this.my != 0) {
                                                        com.byazt.x.c.ve("SegmentReader", "loopAndRead:  change readEnd = " + jU + ", segmentNewEndOffset = " + this.my + ", segment = " + iVar);
                                                        jU = u();
                                                        if (j > jU) {
                                                            long j6 = jU + 1;
                                                            long j7 = j - j6;
                                                            if (j7 > 0) {
                                                                com.byazt.x.c.n("SegmentReader", "loopAndRead: redundant = ".concat(String.valueOf(j7)));
                                                            }
                                                            try {
                                                                this.rl = j6;
                                                                j = j6;
                                                    ...
                                                    if (j > jU) {
                                                        j3 = jU + 1;
                                                        if (j > j3 && (i2 = (int) (j8 - (j - j3))) > 0 && i2 < i) {
                                                            cVarTt2.ve = i2;
                                                            j = j3;
                                                        }
                                                        this.rl = j;
                                                        nVarUj.tt(cVarTt2);
                                                        com.byazt.x.c.ve("SegmentReader", "loopAndRead: bytesRead = " + (j - jN) + ", url = " + this.tt.c);
                                                        j2 = 0;
                                                        break;
                                                    }
                                                    this.rl = j;
                                            ...
                                            th = th2;
                                            cVarTt = null;
                                            com.byazt.x.c.n("SegmentReader", "loopAndRead: " + th + ",stack = " + Log.getStackTraceString(th));
                                            com.byazt.nr.m.c(th);
                                            try {
                                                com.byazt.w.a.c(th, "loopAndRead");
                                                com.byazt.w.a.c(inputStreamC);
                                                if (nVarUj != null) {
                                                    if (cVarTt == null) {
                                                        try {
                                                            ...
                                                            if (j > jN) {
                                                                ...
                                                                com.byazt.zl.c.c(cVar3, downloadInfo, str, str2, str3, z2, this.z, this.qp, j - jN, TimeUnit.MILLISECONDS.toNanos(this.sp - this.f2283a));
                                                            }
                                                            this.sl.ve(this, iVar);
                                                        }
                                                    }
                                                    cVarTt.ve = -1;
                                                    nVarUj.tt(cVarTt);
                                    ...
                                    if (jU > j2 && jU != Long.MAX_VALUE && j <= jU) {
                                        throw new BaseException(1051, String.format("range[%d, %d] , but readCurrent[%d] , readStart[%d]", Long.valueOf(jN), Long.valueOf(jU), Long.valueOf(j), Long.valueOf(jN)));
                                    }
                                    com.byazt.w.a.c(inputStreamC);
                                    if (nVarUj != null) {
                                        try {
                    ...
                    if (cVarTt == null) {
                        try {
                            ...
                            if (j > jN) {
                                ...
                                com.byazt.zl.c.c(cVar6, downloadInfo2, str4, str5, str6, z, this.z, this.qp, j - jN, TimeUnit.MILLISECONDS.toNanos(this.sp - this.f2283a));
                            }
                            this.sl.ve(this, iVar);
                            throw th7;
                        }
                ...
                this.sp = System.currentTimeMillis();
                if (j > jN) {
                    com.byazt.k.c cVar7 = this.yp;
                    DownloadInfo downloadInfo3 = this.u;
                    String str7 = this.x;
                    String str8 = this.i;
                    String str9 = this.da;
                    if (this.gr) {
                    ...
                    com.byazt.zl.c.c(cVar7, downloadInfo3, str7, str8, str9, z, this.z, this.qp, j - jN, TimeUnit.MILLISECONDS.toNanos(this.sp - this.f2283a));
                }
                this.sl.ve(this, iVar);
                throw th7;
            }
