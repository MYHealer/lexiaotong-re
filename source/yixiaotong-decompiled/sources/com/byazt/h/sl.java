...
public class sl implements a, com.byazt.hs.ve.c {
    ...
    public volatile boolean f2280a = false;
    ...
    private void i() {
        ...
        veVarC.c(this.c.getUrl(), this, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
        if (iT <= 2 || (backUpUrls = this.c.getBackUpUrls()) == null) {
            return;
        }
        for (String str : backUpUrls) {
            if (!TextUtils.isEmpty(str)) {
                veVarC.c(str, this, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
            }
        }
    }
    ...
    public void c(u uVar, i iVar, nu nuVar, com.byazt.t.uj ujVar) throws BaseException, com.byazt.m.i {
        synchronized (this) {
            if (this.f2280a || this.sp) {
                throw new m(com.huawei.openalliance.ad.constant.x.bs);
            }
    ...
    public void c(u uVar, nu nuVar, i iVar, BaseException baseException, int i, int i2) {
        ...
        if (errorCode == 1047 || errorCode == 1074 || errorCode == 1055 || zTt || i >= i2) {
            ve(uVar);
        }
    }
        ...
        if (!nuVar.uj) {
            ...
            if (this.sl == null) {
                ...
                if (this.c.getTotalBytes() <= 0) {
                    long jDa = ujVar.da();
                    com.byazt.x.c.ve("SegmentDispatcher", "checkSegmentHttpResponse:len=" + jDa + ",url=" + nuVar.c);
                    this.c.setTotalBytes(jDa);
                }
                synchronized (this.my) {
                    this.my.notify();
                }
    ...
    private void n(u uVar, i iVar) throws da {
        ...
        if (iVar2 != iVar) {
            if (iVar2.ve() == iVar.ve()) {
                ...
                if (jC > 0) {
                    u uVar2 = iVar2.c;
                    if (uVar2 != null && (jC >= PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED || uVar.f2283a - uVar2.f2283a <= 1000 || iVar2.n() - iVar.n() >= jC / 2)) {
        ...
        for (int i2 = iC + 1; i2 < size; i2++) {
            ...
            if (iVar4.c() > 0 || iVar4.c != null) {
                ...
                long j2 = jVe2 - 1;
                iVar.ve(j2);
                com.byazt.x.c.ve("SegmentDispatcher", "applySegment: segment set end:" + j2 + ", later = " + iVar4);
                break;
            }
        }
        long jA3 = iVar.a();
        if (jA3 > 0 && (jVe > jA3 || iVar.n() > jA3)) {
    ...
    public void c() {
        com.byazt.x.c.ve("SegmentDispatcher", Constant.CASH_LOAD_CANCEL);
        this.f2280a = true;
        synchronized (this) {
            Iterator<u> it = this.x.iterator();
            while (it.hasNext()) {
    ...
    private i m() {
        ...
        while (true) {
            ...
            if (jCurrentTimeMillis - uVar.f2283a > ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS && c(uVar, jCurrentTimeMillis - ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS, jCurrentTimeMillis, 500L, 1.0d)) {
                if (this.md) {
