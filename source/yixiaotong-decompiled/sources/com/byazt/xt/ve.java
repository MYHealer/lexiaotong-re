...
public class ve implements com.byazt.db.tt, c {
    ...
    private void c(int i, com.byazt.yl.ve veVar, int i2, String str, long j) {
        ...
        i iVar = this.ve;
        int i3 = (iVar == null || !iVar.f2497a) ? 0 : 1;
        if (this.c.gu() || veVar == null) {
            daVar = daVarX;
        } else {
            daVar = daVarX;
            com.byazt.ng.a.c(veVar, i, str2, this.sp, this.uj, this.c.ve(), i2, i3, str, j, this.f2875a != -1 ? SystemClock.elapsedRealtime() - this.f2875a : -1L);
            com.byazt.iz.tt ttVar2 = this.tt;
            if (ttVar2 != null) {
