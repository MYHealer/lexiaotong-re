...
public class a implements c {
    ...
    public void c(c.InterfaceC0331c interfaceC0331c) {
        ...
        da daVarX = interfaceC0331c.c().x();
        com.byazt.ll.tt ttVarGu = interfaceC0331c.tt().gu();
        if (daVarX != null) {
            ...
            if (daVarX.gt() && com.byazt.hk.c.c().uj(ttVarGu.gt(), strRh, ttVarGu.n())) {
                ...
                interfaceC0331c.c().ve(iC);
                if (iC == 3) {
                    interfaceC0331c.c().c(2);
                    if (c(interfaceC0331c.tt(), interfaceC0331c.c(), ttVarGu, strRh, daVarX, 2)) {
                        return;
                    }
                } else if (iC == 2 && (listC = com.byazt.hk.c.c().c(strRh, ttVarGu, ttVarGu.n())) != null && listC.size() > 0) {
                    interfaceC0331c.c().tt(listC.get(0).c.getMediationRitReqType(ttVarGu.c()));
                }
            }
        }
