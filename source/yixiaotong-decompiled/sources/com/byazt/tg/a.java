...
public class a implements i {
    ...
    public boolean c(final com.byazt.dd.tt ttVar, int i, final x xVar) {
        ...
        if (curBytes <= 0 || totalBytes <= 0 || (iC = com.byazt.gq.da.c(downloadInfoTt.getId(), (int) ((curBytes * 100) / totalBytes))) <= c(ttVar.my())) {
            return false;
        }
        c = new com.byazt.de.uj() { // from class: com.byazt.tg.a.1
            ...
            public void tt() {
                ...
                try {
                    jSONObject.putOpt("pause_optimise_type", "download_percent");
                    jSONObject.putOpt("pause_optimise_action", Constant.CASH_LOAD_CANCEL);
                } catch (JSONException e) {
                    m.c(e);
                }
                com.byazt.zn.c.c().c("pause_optimise", jSONObject, ttVar);
