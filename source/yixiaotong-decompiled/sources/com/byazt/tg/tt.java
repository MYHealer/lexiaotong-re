...
public class tt implements sp {
        ...
        if (jC >= 0 && totalBytes > 0) {
            if (totalBytes <= c(ttVar.my())) {
                ...
                c = new com.byazt.de.uj() { // from class: com.byazt.tg.tt.1
                    ...
                    public void tt() {
                        com.byazt.de.uj unused = tt.c = null;
                        tt.this.c(i2, i2, ttVar, "apk_size_cancel", Constant.CASH_LOAD_CANCEL);
                        xVar.c(ttVar);
                    }
                };
                ...
                if (veVar != null) {
                    c(new com.byazt.de.ve() { // from class: com.byazt.tg.tt.2
                        ...
                        public void delete() {
                            com.byazt.de.uj unused = tt.c = null;
                            tt.this.c(i2, i2, ttVar, "apk_size_cancel", Launcher.Method.DELETE_CALLBACK);
                            veVar.delete();
                        }
                    });
                }
    ...
    private int c(int i) {
        return com.byazt.k.c.c(i).c("cancel_pause_optimise_apk_size", 100) * 1048576;
    }
