...
public class ve {
    ...
    public static boolean c(final File file, final String str, final int i) {
        ...
        try {
            ...
            com.byazt.ao.c.c(false, new com.byazt.ao.c.InterfaceC0094c() { // from class: com.byazt.uwt.ve.1
                @Override // com.byazt.ao.c.InterfaceC0094c
                public void c() throws Throwable {
                    ve.a(file, str, i, stringBuffer);
                }
            }, new com.byazt.ao.c.InterfaceC0094c() { // from class: com.byazt.uwt.ve.2
                @Override // com.byazt.ao.c.InterfaceC0094c
                public void c() throws Throwable {
                    ...
                    if (i.sp()) {
                        ...
                        com.byazt.ao.c.c(false, new com.byazt.ao.c.InterfaceC0094c() { // from class: com.byazt.uwt.ve.2.1
                            @Override // com.byazt.ao.c.InterfaceC0094c
                            public void c() throws Throwable {
                                ve.tt(str, i, (Map<String, List<ZipEntry>>) mapSp, stringBuffer);
                            }
                        }, new com.byazt.ao.c.InterfaceC0094c() { // from class: com.byazt.uwt.ve.2.2
                            @Override // com.byazt.ao.c.InterfaceC0094c
                            public void c() throws Throwable {
    ...
    public static void tt(String str, String str2, int i, StringBuffer stringBuffer) throws c {
        ...
        stringBuffer.append(iC == 100 ? "modifyRes" : "noModifyRes").append(" cost:").append(System.currentTimeMillis() - jCurrentTimeMillis).append(";");
        if (iC == 100 || iC == 200) {
            return;
        }
        String string = sb.toString();
        c(com.byazt.gvs.tt.n, com.byazt.gvs.tt.c.md, str2, i, -1L, string);
        c.c(1100, -2, str2, i, null);
