...
public class uj {
    ...
    public boolean c(String str) {
        ...
        synchronized (plugin) {
            ...
            if (zC) {
                ...
                slVar.c(AdDIStatus.HAS_INSTALL_SUCCESS, 0, plugin.mPkgName, plugin.getVersion(), null);
            } else {
                ...
                slVar.c(AdDIStatus.HAS_INSTALL_SUCCESS, -1, plugin.mPkgName, plugin.getVersion(), null);
            }
        ...
        try {
            ...
            try {
                ...
                if (i.rh()) {
                    ...
                    z = true;
                    com.byazt.ao.c.c(true, new com.byazt.ao.c.InterfaceC0094c() { // from class: com.byazt.uwt.uj.1
                        @Override // com.byazt.ao.c.InterfaceC0094c
                        public void c() throws Exception {
                            uj.this.c(plugin, strTt, file, fileC, sb);
                        }
                    }, new com.byazt.ao.c.InterfaceC0094c() { // from class: com.byazt.uwt.uj.2
                        @Override // com.byazt.ao.c.InterfaceC0094c
                ...
                sb.append("loadPluginInternal ").append(th.getMessage()).append(";").append(stackTraceString);
    ...
    private boolean tt(String str, Plugin plugin, StringBuilder sb) {
        ...
        sb.append("removeEntry skip 4 ").append(zTt).append(PPSLabelView.Code).append(zA).append(";");
        return false;
    }
    ...
    private void c(Plugin plugin, StringBuilder sb, PackageInfo packageInfo) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        ...
        if (activityInfoArr != null) {
            for (ActivityInfo activityInfo : activityInfoArr) {
                if (TextUtils.isEmpty(activityInfo.processName) || !activityInfo.processName.contains(x.bQ)) {
                    activityInfo.processName = "main";
                } else {
                    activityInfo.processName = activityInfo.processName.split(x.bQ)[1];
                }
        ...
        if (serviceInfoArr != null) {
            for (ServiceInfo serviceInfo : serviceInfoArr) {
                if (TextUtils.isEmpty(serviceInfo.processName) || !serviceInfo.processName.contains(x.bQ)) {
                    serviceInfo.processName = "main";
                } else {
                    serviceInfo.processName = serviceInfo.processName.split(x.bQ)[1];
                }
        ...
        if (activityInfoArr2 != null) {
            for (ActivityInfo activityInfo2 : activityInfoArr2) {
                if (TextUtils.isEmpty(activityInfo2.processName) || !activityInfo2.processName.contains(x.bQ)) {
                    activityInfo2.processName = "main";
                } else {
                    activityInfo2.processName = activityInfo2.processName.split(x.bQ)[1];
                }
        ...
        if (providerInfoArr != null) {
            for (ProviderInfo providerInfo : providerInfoArr) {
                if (TextUtils.isEmpty(providerInfo.processName) || !providerInfo.processName.contains(x.bQ)) {
                    providerInfo.processName = "main";
                } else {
                    providerInfo.processName = providerInfo.processName.split(x.bQ)[1];
                }
    ...
    public static void c(String str, int i, String str2, int i2, long j, String str3) {
        ...
        try {
            jSONObject.putOpt(o0OO000o.o000o0oo, com.byazt.blh.ve.c(Integer.valueOf(i)));
            ...
            jSONObject3.putOpt("duration", Integer.valueOf(com.byazt.blh.ve.tt(Long.valueOf(j))));
            jSONObject2.putOpt(CrashHianalyticsData.MESSAGE, com.byazt.blh.ve.c(str3));
