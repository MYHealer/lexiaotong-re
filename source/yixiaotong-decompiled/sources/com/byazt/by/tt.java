...
public class tt {
    ...
    public void c(String str, String str2, boolean z) {
        try {
            (z ? this.ve : this.tt).put(str, str2);
    ...
    public String tt(String str, String str2, boolean z) {
        try {
            return (z ? this.ve : this.tt).getString(str, str2);
        } catch (Throwable unused) {
            return str2;
        }
    }
