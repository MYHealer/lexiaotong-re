...
public class a {
    ...
    private Pair<Integer, JSONObject> sp(String str) {
        ...
        if (nVarTt != null) {
            ...
            if (jSONObjectN == null || TextUtils.isEmpty(jSONObjectN.optString(CrashHianalyticsData.MESSAGE))) {
    ...
    public JSONObject n(String str) {
        ...
        try {
            ...
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(CrashHianalyticsData.MESSAGE, strEncodeToString);
    ...
    public static Pair<Boolean, JSONObject> c(com.byazt.hm.tt ttVar, String str, boolean z) {
        ...
        String strN = ttVar.n();
        if (strN != null && !strN.startsWith("{") && !strN.endsWith(i.d) && !strN.contains(CrashHianalyticsData.MESSAGE) && !strN.contains("cypher")) {
            return new Pair<>(Boolean.FALSE, c(ttVar.sl(), str));
        }
