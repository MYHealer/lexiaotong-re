...
public final class ve {
    ...
    public volatile String f2021a = null;
    ...
    public String uj() {
        try {
            if (TextUtils.isEmpty(this.f2021a)) {
                if (this.c.get()) {
                    this.f2021a = com.byazt.ti.tt.tt("sp_bidding_opt_libra", "key_url_ads", "api-access.pangolin-sdk-toutiao.com");
                } else {
                    if (this.da == null) {
                        this.da = u();
                    }
                    this.f2021a = this.da.getString("key_url_ads", "api-access.pangolin-sdk-toutiao.com");
                }
            }
        } catch (Throwable unused) {
        }
        this.f2021a = TextUtils.isEmpty(this.f2021a) ? "api-access.pangolin-sdk-toutiao.com" : this.f2021a;
        return this.f2021a;
    }
            ...
            try {
                ...
                if (this.c.get()) {
                    try {
                        ...
                        com.byazt.ti.tt.c("sp_bidding_opt_libra", "_use_pl_", Integer.valueOf(zOptBoolean ? 1 : 0));
