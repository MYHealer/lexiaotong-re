...
public class uj {
    ...
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_FILEPLAY_NO_BUFFRING, AppTypeIdUtil.NewDevice4GBathOTA})
    ...
    public void ve(String str) {
        if (str == null || !str.equals(this.z)) {
            this.z = str;
            c(com.hihonor.adsdk.base.c.y.hnadsa, str);
        }
    }

    public String uj(String str) {
        if (this.z == null) {
            this.z = tt(com.hihonor.adsdk.base.c.y.hnadsa, str);
        }
        return this.z;
    }
    ...
    public String i() {
        if (this.f2020a == null) {
            this.f2020a = tt("dev08", (String) null);
        }
        return this.f2020a;
    }
    ...
    public String ve(String str, long j) {
        ...
        try {
            ...
            JSONObject jSONObject = new JSONObject(strTt);
            if (System.currentTimeMillis() - jSONObject.getLong(CrashHianalyticsData.TIME) <= j) {
                return jSONObject.getString(oOOOoo00.OooOo0o);
            }
        } catch (Exception unused) {
        }
        return null;
    ...
    public void ve(String str, String str2) {
        ...
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(oOOOoo00.OooOo0o, str2);
    ...
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_FILEPLAY_NO_BUFFRING, 153})
    public static class tt {
        ...
        public tt sp(String str) {
            if (str == null || str.equals(uj.c().f2020a)) {
                return this;
            }
            uj.c().f2020a = str;
