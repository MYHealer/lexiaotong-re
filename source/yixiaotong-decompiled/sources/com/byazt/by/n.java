...
public class n {
    ...
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_FILEPLAY_NO_BUFFRING, 151})
    ...
    public long tt() {
        if (this.uj == -1) {
            this.uj = c("duration", ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT);
        }
        return this.uj;
    }
    ...
    public static class tt {
        ...
        public tt c(String str) {
            if (str != null && str.equals(n.c().f2019a)) {
                return this;
            }
            n.c().f2019a = str;
