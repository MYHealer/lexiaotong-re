...
public class tt implements com.byazt.pq.c, c {
    ...
    public boolean tt(com.byazt.nbs.da daVar, int i) {
        ...
        if (this.tt.n()) {
            ...
            if (!p.c(this.uj.sl()) || !p.c(this.uj.t()) || !p.c(this.uj.yp())) {
                ...
                this.sl = true;
                c(new com.byazt.pp.c(10003, com.byazt.pp.c.c(10003)));
            }
            return true;
        }
        if (this.tt.x()) {
    ...
    public void c(List<com.byazt.yl.ve> list, com.byazt.nbs.da daVar) {
        ...
        com.byazt.oi.ve.c(this.f2558a, daVar, !p.tt(list) ? list.get(0) : null);
        tt(list);
        ...
        if (this.tt.n()) {
            c((List<com.byazt.yl.ve>) null, new com.byazt.pp.c(RequestManager.NOTIFY_CONNECT_FAILED, "load ad timeout !!!"));
        } else {
    ...
    private void tt(List<com.byazt.yl.ve> list) {
        ...
        if (list.get(0).canAdReuse() && com.byazt.hk.c.c().n(this.f2558a, adNetworkSlotId, this.sp.n()) == 1) {
            ArrayList arrayList = new ArrayList();
    ...
    private void ve(List<com.byazt.yl.ve> list) {
        ...
        for (com.byazt.yl.ve veVar : list) {
            if (veVar != null) {
                com.byazt.ix.uj.c().c(this.f2558a, new com.byazt.ix.sp(veVar, this.uj.eo(), this.sp));
            }
        }
    }
}
