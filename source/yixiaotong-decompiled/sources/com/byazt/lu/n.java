...
public class n extends tt {
    ...
    public static final long[] uj = {ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT, ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT, SilenceSkippingAudioProcessor.DEFAULT_PADDING_SILENCE_US, SilenceSkippingAudioProcessor.DEFAULT_PADDING_SILENCE_US, 60000, 6000, 180000, 180000, 540000, 540000};
    ...
    @Override // com.byazt.lu.tt
    public long c() {
        return this.c.uj().u() + ((long) (this.c.a().ve() ? 21600000 : ac.c));
    }
