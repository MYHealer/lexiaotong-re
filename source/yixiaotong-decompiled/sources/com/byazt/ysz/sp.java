...
@com.byazt.zqa.c(c = {0, 1, 589, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp extends a {
    ...
    public void u() {
        ...
        if (functionLt != null && (objApply = functionLt.apply(com.byazt.yxi.uj.c().c(6).c(Boolean.class).c(0, "com.byted.live.lite").tt())) != null && ((Boolean) objApply).booleanValue() && this.i != 2) {
            this.i = 1;
        }
    ...
    private Map m() {
        ...
        aw awVarCf = gt.tt().cf();
        if (awVarCf != null) {
            map.put(com.alipay.sdk.app.statistic.c.ab, awVarCf.ve());
        ...
        if (!com.byazt.omf.x.m().sp()) {
            map2.put("enable_init_oaid", ez.V);
        }
        if (!com.byazt.omf.x.m().u()) {
            map2.put("can_use_ip", ez.V);
        }
        if (!com.byazt.omf.x.m().uj()) {
            map2.put("can_use_sensor", ez.V);
        }
    ...
    private void c(Map map, Map<String, Object> map2) {
        ...
        map2.put("sec_init_use_thread", com.byazt.ogz.uj.f2551a);
        map.put("live_tob_init_extra", map2);
    }
    ...
    public int n() {
        Object objTt;
        return (this.c != null && a() && (objTt = tt("hasAuthenticated")) != null && (objTt instanceof Boolean) && ((Boolean) objTt).booleanValue()) ? 2 : 1;
    }
    ...
    public void c(boolean z, String str) {
        ...
        if (this.f2896a != null && this.f2896a.get() != null) {
            com.byazt.ddx.uj.c(z ? 2 : 1, this.tt != null ? this.tt : "", this.f2896a.get());
        }
    ...
    public void c(Map<String, String> map) {
        ...
        ic icVar = this.f2896a != null ? this.f2896a.get() : null;
        ...
        new com.byazt.ddx.c.C0129c().c(this.tt).tt(str).c(cVar);
    ...
    private void c(int i, i iVar, boolean z, int i2) {
        ...
        try {
            ...
            jSONObject.put(o0OO000o.o00O0O0O, iVar.w_());
    ...
    public void tt(Map<String, String> map) {
        ...
        if ("1".equals(str2) && !TextUtils.isEmpty(str)) {
            try {
                JSONObject jSONObjectOptJSONObject = tt(Integer.parseInt(str), str4).optJSONObject("extra");
                ...
                if (TextUtils.isEmpty(jSONObject.optString("name")) || (ttVar = (com.byazt.ocd.tt) rl.c(this.uj, com.byazt.ocd.tt.class)) == null) {
                    return;
                }
                HashMap map2 = new HashMap();
