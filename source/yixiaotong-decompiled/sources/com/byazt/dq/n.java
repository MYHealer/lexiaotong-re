...
public class n {
    ...
    public float f2103a = Float.MIN_VALUE;
            ...
            if (actionMasked == 1) {
                if (this.sp.containsKey(Integer.valueOf(pointerId)) && this.x.containsKey(Integer.valueOf(pointerId))) {
                    ...
                    if (TextUtils.equals(this.sl, "up")) {
                        ...
                        iTt = iTt2;
                    } else if (TextUtils.equals(this.sl, TtmlNode.LEFT)) {
                        iTt = -iTt;
                    } else if (!TextUtils.equals(this.sl, TtmlNode.RIGHT)) {
    ...
    private boolean ve(rh rhVar, com.byazt.xj.ve veVar, MotionEvent motionEvent, boolean z) {
        ...
        if (action == 0) {
            ...
            x = motionEvent.getX();
            y = motionEvent.getY();
            if (!this.u && Math.abs(x - this.n) <= 10.0f && Math.abs(y - this.f2103a) <= 10.0f && rhVar != null) {
                tt();
                rhVar.c(this.da, veVar, veVar);
                return true;
            }
            ...
            iTt2 = x.tt(this.t, y - this.f2103a);
            if (TextUtils.equals(this.sl, "up")) {
                iTt = -iTt2;
            } else if (!TextUtils.equals(this.sl, "down")) {
                iTt = iTt2;
            ...
            if (this.n == Float.MIN_VALUE || this.f2103a == Float.MIN_VALUE) {
                return false;
            }
