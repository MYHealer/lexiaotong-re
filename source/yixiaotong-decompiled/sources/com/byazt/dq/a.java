...
public class a implements i.c {
    ...
    public void c() {
        ...
        try {
            this.tt = Integer.parseInt(com.byazt.wj.tt.c(jSONObjectVe.optString(am.aT, "8000"), this.f2102a.da()));
    ...
    public void c(Message message) {
        ...
        if (rhVar != null) {
            m mVar = this.n;
            com.byazt.xj.ve veVar = this.f2102a;
