...
public class ve {
    ...
    public ve(Context context, m mVar) {
        this.uj = context;
        this.ve = mVar;
        this.f2105a = ViewConfiguration.get(context).getScaledTouchSlop();
    }
    ...
    public boolean c(rh rhVar, com.byazt.xj.ve veVar, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 2) {
                ...
                if (Math.abs(x - this.c) >= this.f2105a || Math.abs(y - this.tt) >= this.f2105a) {
                    this.n = true;
                }
            } else if (action == 3) {
                this.n = false;
            ...
            if (Math.abs(x2 - this.c) >= this.f2105a || Math.abs(y2 - this.tt) >= this.f2105a) {
                this.n = false;
            } else if (rhVar != null) {
