                ...
                try {
                    c(file, hashSet, new x() { // from class: com.byazt.vnu.ve.1
                        ...
                        public int c(int i2) {
                            ...
                            int identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.split(PPSLabelView.Code)[1], str2.split(PPSLabelView.Code)[0], Zeus.getAppApplication().getPackageName());
                            if (identifier == 0) {
                                identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.split(PPSLabelView.Code)[1].replaceAll("_", "."), str2.split(PPSLabelView.Code)[0], Zeus.getAppApplication().getPackageName());
                            }
                            if (identifier == 0) {
