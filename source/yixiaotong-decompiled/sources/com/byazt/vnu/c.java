...
public class c {
    ...
    public static final Logger f2821a = Logger.getLogger(c.class.getName());
    public final byte[] c;
    public C0306c n;
    public final x tt;
    public final n uj;
    ...
    private void uj() throws IOException {
        ...
        while (s == 513) {
            ...
            if (this.uj.c() < this.n.n) {
                f2821a.warning("Unknown data detected. Skipping: " + (this.n.n - this.uj.c()) + " byte(s)");
    ...
    private void a() throws IOException {
        ...
        if (i3 != this.uj.c()) {
            f2821a.warning("Invalid data detected. Skipping: " + (i3 - this.uj.c()) + " byte(s)");
    ...
    private void da() throws IOException {
        ...
        if (i3 > 0) {
            ...
            if (bigInteger.equals(BigInteger.ZERO)) {
                f2821a.fine(String.format("Config flags size > %d, but exceeding bytes are all zero, so it should be ok.", 56));
            } else {
                f2821a.warning(String.format("Config flags size > %d. Size = %d. Exceeding bytes: 0x%X.", 56, Integer.valueOf(i), bigInteger));
            }
        }
        int i4 = i - i2;
        if (i4 > 0) {
    ...
    private C0306c sl() throws IOException {
        C0306c c0306cC = C0306c.c(this.ve, this.uj);
        this.n = c0306cC;
        return c0306cC;
    }
    ...
    public static class C0306c {
        ...
        public C0306c(short s, int i, int i2, int i3) {
            this.c = s;
            this.tt = i;
            this.ve = i2;
            this.uj = i3;
        ...
        public static C0306c c(sp spVar, n nVar) throws IOException {
            int iC = nVar.c();
            try {
                return new C0306c(spVar.readShort(), spVar.readShort(), spVar.readInt(), iC);
            } catch (EOFException unused) {
                return new C0306c((short) -1, 0, 0, nVar.c());
            }
        }
    }
}
