    ...
    private JSONObject c(List<com.byazt.vb.tt> list, boolean z, boolean z2) {
        ...
        try {
            ...
            if (z) {
                ...
                jSONObject.put(am.s, com.byazt.fh.c.a());
                jSONObject.put("app_version", com.byazt.fh.c.n());
                jSONObject.put("package", nb.x());
                jSONObject.put("region", Locale.getDefault().getCountry());
                jSONObject.put("tz_name", Calendar.getInstance().getTimeZone().getID());
                jSONObject.put("tz_offset", Calendar.getInstance().getTimeZone().getOffset(System.currentTimeMillis()) / 1000);
                ArrayList<String> arrayListC = com.byazt.nr.ve.c(context, "MD5");
            ...
            jSONObject.put(am.Q, rh.sp(context));
            ...
            int iVe = com.byazt.ml.c.ve(list, com.byazt.epi.c.uj(AdnConfig.a.hnadsb));
            if (iVe != 0) {
            ...
            jSONObject.put(o0OO000o.o00O00oO, this.tt);
            ...
            jSONObject.put("pan_code_serial", AdnConfig.b.hnadsa);
        } catch (Throwable th) {
