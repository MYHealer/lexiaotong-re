...
public class c {
    ...
    public static volatile boolean f2480a;
    public static JSONObject c;
    public static volatile boolean i;
    public static volatile int x;
    public static final String[] uj = {"GET", "POST"};
    public static final String[] n = {"aid", "app_version", "tt_data"};
  ...
  0x01d9: PHI (r12v3 java.lang.String) = (r12v2 java.lang.String), (r12v13 java.lang.String) binds: [B:87:0x020b, B:74:0x01d7] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
        ...
        try {
            try {
                ...
                if (z) {
                    ...
                    map.put("log-encode-type", AsyncHttpClient.ENCODING_GZIP);
                    str = str + "&tt_data=a";
                    if (z2) {
    ...
    public static int c(String[] strArr, byte[] bArr, x xVar) {
                ...
                try {
                    ...
                    if (iOptInt == 200) {
                        if ("ss_app_log".equals(jSONObject.optString("magic_tag"))) {
                            iOptInt = "success".equals(jSONObject.optString(CrashHianalyticsData.MESSAGE)) ? 200 : Integer.valueOf("101").intValue();
                        } else {
        ...
        if (iOptInt == 200) {
            ...
            if (jSONObjectOptJSONObject != null) {
                JSONArray jSONArrayOptJSONArray = jSONObjectOptJSONObject.optJSONArray(b.f);
                ...
                JSONArray jSONArrayOptJSONArray2 = jSONObjectOptJSONObject.optJSONArray(com.huawei.hms.feature.dynamic.b.u);
    ...
    public static JSONObject ve(String str, JSONObject jSONObject) {
        ...
        if (jSONObject2 == null || !"success".equals(jSONObject2.optString(CrashHianalyticsData.MESSAGE, ""))) {
            return null;
        }
