...
public class sl {
    ...
    public RefreshableBannerView f2322a;
        ...
        public void run() {
            sl.this.x.post(new Runnable() { // from class: com.byazt.hz.sl.3.1
                ...
                public void run() {
                    ...
                    if (viewC != null) {
                        sl.this.c(sl.this.n);
                        if (sl.this.f2322a != null) {
                            sl.this.f2322a.c(viewC);
                        }
    ...
    public sl(Context context) {
        ...
        if (context != null) {
            ...
            this.f2322a = refreshableBannerView;
            refreshableBannerView.addOnAttachStateChangeListener(onAttachStateChangeListener);
            this.f2322a.setVisibilityChangeListener(new RefreshableBannerView.c() { // from class: com.byazt.hz.sl.4
    ...
    public void ve() {
        ...
        m();
        RefreshableBannerView refreshableBannerView = this.f2322a;
    ...
    public View n() {
        ...
        a aVar2 = this.uj;
        aVar2.c(aVar2.uj);
        if (viewC == null || this.f2322a == null) {
            return null;
        }
