...
public abstract class uj extends da {
    ...
    @com.byazt.zqa.c(c = {0, 1, 701, AppTypeIdUtil.NewDevice4GBathOTA})
    ...
    private boolean c(Activity activity, Activity activity2, com.byazt.yl.ve veVar) {
        ...
        if (com.byazt.cz.c.c(veVar.getAdNetWorkName(), veVar.getAdType(), veVar.getSubAdType())) {
            ...
            com.byazt.ng.a.c(this.f2323a, 81011);
            return false;
        }
        if (activity != null) {
            return true;
        ...
        com.byazt.ng.a.c(this.f2323a, 81010);
        return false;
    }
    ...
    public boolean c(Activity activity) {
        ...
        if (iMd == 2) {
            ...
            com.byazt.ng.a.c(this.f2323a, 81008);
            return false;
        }
        if (iMd == 1) {
            com.byazt.eu.tt.tt("TTMediationSDK", "--==--- 插全屏轮播，仅有自定义adn广告可用，停止轮播");
            com.byazt.ng.a.c(this.f2323a, 81009);
            return false;
        }
        int iTt = tt(this.n);
        if (iTt == 0) {
        ...
        com.byazt.ng.a.c(this.f2323a, iTt);
        return false;
    }
    ...
    private int md() {
        ...
        if (listTt != null && listTt.size() > 0) {
            for (com.byazt.nbs.da daVar : listTt) {
                ...
                if (daVar.gt() && com.byazt.hk.c.c().uj(this.n, strRh, rh()) && com.byazt.hk.c.c().c(strRh, this.f2323a, false) == 3) {
