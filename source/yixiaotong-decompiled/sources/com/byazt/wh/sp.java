...
@com.byazt.zqa.c(c = {0, 1, 1172, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public SQLiteStatement f2844a;
    ...
    public SQLiteStatement ve() {
        if (this.f2844a == null) {
            ...
            synchronized (this) {
                if (this.f2844a == null) {
                    this.f2844a = sQLiteStatementCompileStatement;
                }
            }
            if (this.f2844a != sQLiteStatementCompileStatement) {
                sQLiteStatementCompileStatement.close();
            }
        }
        return this.f2844a;
