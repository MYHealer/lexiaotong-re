...
public class a implements ServiceConnection, gt {
    ...
    public ve c;
    public Future<?> i;
    public com.byazt.zz.ve.c.InterfaceC0351c sp;
    public Handler n = new Handler(Looper.getMainLooper());

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public tt f2842a = null;
    ...
    public void c(com.byazt.zz.ve.c.InterfaceC0351c interfaceC0351c) {
        this.sp = interfaceC0351c;
    }
        ...
        this.i = com.byazt.zz.ve.t().submit(new Runnable() { // from class: com.byazt.wh.a.2
            ...
            public void run() {
                ...
                synchronized (this) {
                    try {
                        try {
                            if (a.this.f2842a != null && a.this.c != null) {
                                a.this.c.c(a.this.f2842a);
                            }
                            a.this.da.countDown();
                            iBinder2 = iBinder;
                            deathRecipient = new IBinder.DeathRecipient() { // from class: com.byazt.wh.a.2.1
                                ...
                                public void binderDied() {
                                    ...
                                    a.this.n.postDelayed(a.this.x, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
                                }
                            };
