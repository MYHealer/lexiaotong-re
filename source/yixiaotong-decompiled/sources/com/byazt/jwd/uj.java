...
public class uj extends WebViewClient implements SSWebView.ve {
    ...
    private void c(String str) {
        ...
        if (str.contains("weixin://wap/pay") || str.contains("weixin://dl/business/?ticket") || str.contains("alipays://platformapi/startapp?appId")) {
            com.byazt.ddx.uj.ve(this.tt.x(), x.dh, "lp_pay");
        }
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        try {
            ...
            if (com.byazt.omf.x.m().nb() != null && ((Boolean) com.byazt.omf.x.m().nb().apply(com.byazt.yxi.uj.c().c(15).c(Boolean.class).c(0, new zb().c(ContentProviderManager.PROVIDER_URI, uri)).tt())).booleanValue()) {
                d dVar2 = this.tt;
