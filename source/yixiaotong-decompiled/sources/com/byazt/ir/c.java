...
public class c implements sp, qp.c {
        ...
        public void run() {
            ...
            if (!c.this.u) {
                if (c.this.f2348a != null) {
                    c.this.f2348a.postDelayed(this, c.this.md);
                }
            } else {
                c cVar3 = c.this;
    ...
    public final ILiveListener nb = new ILiveListener() { // from class: com.byazt.ir.c.7
        ...
        public void onFirstFrame(boolean z) {
            ...
            c.this.zm = true;
            c.this.f2348a.removeCallbacks(c.this.zb);
            if (c.this.gu > 0) {
                c.this.f2348a.postDelayed(c.this.zb, c.this.md);
            }
            c.this.m = false;
            if (z) {
    ...
    public c(Context context, boolean z, long j, JSONObject jSONObject, Looper looper) {
        ...
        if (looper != null) {
            this.f2348a = new d(looper, this);
            this.sp = true;
        } else if (this.f2348a == null) {
            this.f2348a = ((qp) uj.getService("thread_service")).obtainHandler(this, "tt-live-video-player");
        }
        c(z);
    }

    private void c(final boolean z) {
        Handler handler = this.f2348a;
        if (handler != null) {
            handler.post(new Runnable() { // from class: com.byazt.ir.c.2
                ...
                public void run() {
                    try {
                        ...
                        c cVar = c.this;
                        cVar.c = VideoLiveManager.newBuilder(cVar.ve).setProjectKey("pangle_ad_live").setNetworkClient(new C0187c()).setForceHttpDns(false).setForceTTNetHttpDns(false).setSettingsBundle(iLiveSettingBundle).setPlayerType(1).setListener(c.this.nb).build();
        ...
        if (this.i.get() && this.da && this.c != null) {
            ...
            c(new Runnable() { // from class: com.byazt.ir.c.3
                ...
                public void run() {
                    ...
                    if (c.this.f2348a != null) {
                        c.this.f2348a.sendEmptyMessage(100);
                    }
                }
            });
        }
        this.x.set(true);
        if (!this.i.get() || (handler = this.f2348a) == null) {
            return;
        }
    ...
    private void ve() {
        ...
        this.f2348a.post(new Runnable() { // from class: com.byazt.ir.c.6
            @Override // java.lang.Runnable
            public void run() {
                if (c.this.f2348a == null || c.this.f2348a.getLooper() == null) {
                    return;
                }
                try {
                    c.this.p = null;
                    c.this.yv = null;
                    if (c.this.sp) {
                        c.this.f2348a.removeCallbacksAndMessages(null);
                    } else {
                        ((qp) uj.getService("thread_service")).recycleHandler(c.this.f2348a);
                    }
                    c.this.f2348a = null;
    ...
    public static class C0187c implements INetworkClient {
        ...
        public INetworkClient.Result doRequest(String str, String str2) {
            ...
            try {
                try {
                    com.byazt.gqp.m mVarTt = this.c.c(new yp.c().c(str).tt("host", str2).tt()).tt();
                    if (mVarTt.uj()) {
                        strTt = mVarTt.a().tt();
                        try {
