...
@com.byazt.zqa.c(c = {0, 1, 163, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_BARRAGE_MASK})
        ...
        try {
            if (jSONObject != null) {
                ...
                if (jSONObjectOptJSONObject != null) {
                    String strOptString = jSONObjectOptJSONObject.optString(com.huawei.openalliance.ad.constant.x.cy);
                    ...
                    long j2 = 0;
                    try {
                        j = Long.parseLong(jSONObjectOptJSONObject.optString(oOOOoo00.OooOo0o));
