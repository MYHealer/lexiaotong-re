...
@com.byazt.zqa.c(c = {0, 1, 163, MediaPlayer.MEDIA_PLAYER_OPTION_FILE_SIZE})
public class l extends com.byazt.pct.n<JSONObject, JSONObject> {
    ...
    public JSONObject c(JSONObject jSONObject, com.byazt.pct.a aVar) throws Exception {
        ...
        switch (str) {
            case "changeSize":
                JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(OapsKey.KEY_SIZE);
            ...
            case "changeFrame":
                ...
                JSONArray jSONArrayOptJSONArray3 = jSONObject.optJSONArray(OapsKey.KEY_SIZE);
