...
public class uj implements com.byazt.sa.c {
    ...
    public void c(yp ypVar, String str, ImageView imageView, com.byazt.sa.c.InterfaceC0263c interfaceC0263c) {
    ...
    @Override // com.byazt.sa.c
    public void c(yp ypVar, String str, final ImageView imageView, int i, int i2, com.byazt.sa.c.InterfaceC0263c interfaceC0263c) {
    ...
    @Override // com.byazt.sa.c
    public void c(yp ypVar, String str, com.byazt.sa.c.InterfaceC0263c interfaceC0263c) {
        tt(ypVar, str, interfaceC0263c);
    }
    ...
    public void tt(yp ypVar, String str, final com.byazt.sa.c.InterfaceC0263c interfaceC0263c) {
        ...
        ypVarType.to(new gr() { // from class: com.byazt.xs.uj.3
            ...
            public void onSuccess(m mVar) {
                if (mVar == null) {
                    interfaceC0263c.c(null);
                    return;
                }
                com.byazt.sa.c.InterfaceC0263c interfaceC0263c2 = interfaceC0263c;
                if (interfaceC0263c2 != null) {
                    if (mVar.getResult() instanceof Bitmap) {
                        interfaceC0263c.c((Bitmap) mVar.getResult());
                        return;
                    } else {
                        if (mVar.getResult() instanceof byte[]) {
                            try {
                                interfaceC0263c.c(BitmapFactory.decodeByteArray((byte[]) mVar.getResult(), 0, ((byte[]) mVar.getResult()).length));
                                return;
