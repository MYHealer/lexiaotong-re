...
public class c implements rh, qp.c, tt {
    ...
    public final com.byazt.nr.d f2873a = new com.byazt.nr.d(Looper.getMainLooper(), this);
    ...
    private JSONObject c(JSONObject jSONObject) {
        ...
        try {
            ...
            jSONObject2.put(ld.L, jSONObjectOptJSONObject.opt(ld.L));
    ...
    public void tt(JSONObject jSONObject, JSONObject jSONObject2, com.byazt.ux.sp spVar) {
        ...
        zVar.c(this);
        zVar.tt(jSONObject2);
        com.byazt.nr.d dVar2 = this.f2873a;
        if (dVar2 != null) {
    ...
    private void tt() {
        com.byazt.nr.d dVar = this.f2873a;
        if (dVar == null) {
            return;
        }
