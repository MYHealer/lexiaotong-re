...
public final class da {
    ...
    public static String c(String str) {
        ...
        if (str.contains(com.huawei.openalliance.ad.constant.x.bQ)) {
    ...
    private static InetAddress ve(String str, int i, int i2) {
        ...
        while (i < i2) {
            ...
            if (i5 != 0) {
                if (!str.regionMatches(i, com.huawei.openalliance.ad.constant.x.bQ, 0, 1)) {
                    if (!str.regionMatches(i, ".", 0, 1) || !c(str, i7, i2, bArr, i5 - 2)) {
                        return null;
                    }
                    i5 += 2;
                    break;
    ...
    private static String c(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if (i2 == i) {
                ...
                cVar.tt(((bArr[i2] & 255) << 8) | (bArr[i2 + 1] & 255));
                i2 += 2;
            }
        }
        return cVar.ve();
