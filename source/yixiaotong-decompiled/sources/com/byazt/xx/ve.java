...
public class ve {
    ...
    public static void c(String str, String str2, String str3) {
        if (com.byazt.bp.tt.tt().lt() != null) {
            com.byazt.ik.ve.c().insert(str, str2, str3, br.b.V);
        }
    }
    ...
    public static void c(String str, int i) {
        ...
        com.byazt.eu.tt.tt("TMe", "---预缓存优化删除存储的过期数据 primeRit = " + str + " startTime = " + new SimpleDateFormat(TimeUtils.FORMATDATETIME).format(new Date(jCurrentTimeMillis)));
                ...
                if (next2 != null) {
                    ...
                    if (cVar2 == null) {
                        ...
                        if (dC == 0.0d && dTt == 0.0d) {
                            ...
                            List<com.byazt.ik.tt> listQuery = com.byazt.ik.ve.c().query(strNu, strNb, jCurrentTimeMillis - ((long) (i2 * 3600000)), jCurrentTimeMillis);
                            if (listQuery != null && listQuery.size() != 0) {
                                ...
                                while (it4.hasNext()) {
                                    ...
                                    if (TextUtils.equals(next3.c(), "send")) {
                                        ...
                                        i3++;
                                    } else if (TextUtils.equals(next3.c(), br.b.V)) {
                                        i4++;
                                    }
                                    it4 = it5;
                                }
