...
@com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.SINGLE_IMG, 46})
public class n extends sp {
    public VideoFrame da;
    public float i;
    public LottieAnimationView sl;
    public com.byazt.ga.i.c.C0157c t;
    public float x;

    public n(com.byazt.ga.x xVar, x xVar2, Context context, com.byazt.ga.i.c.C0157c c0157c) {
        super(xVar, xVar2);
        this.x = -1.0f;
        this.i = -1.0f;
        this.t = c0157c;
        ...
        if (viewC instanceof TextureView) {
            this.da = new VideoFrame(context, (TextureView) viewC, c0157c);
        }
    ...
    public void z() {
        ...
        if (videoFrame != null) {
            ...
            if (parent2 instanceof ViewGroup) {
                this.da.setTranslationX(2.14748365E9f);
