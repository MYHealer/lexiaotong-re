...
@com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.SINGLE_IMG, 54})
public abstract class ve implements com.byazt.zy.n, com.byazt.dg.c.InterfaceC0132c {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public BlurMaskFilter f2927a;
    ...
    public ve(com.byazt.ga.x xVar, x xVar2) {
        ...
        m mVarDa = xVar2.z().da();
        this.uj = mVarDa;
        mVarDa.c((com.byazt.dg.c.InterfaceC0132c) this);
    ...
    private void yp() {
        if (!this.ve.uj().isEmpty()) {
            ...
            this.gr = ujVar;
            ujVar.c();
            this.gr.c(new com.byazt.dg.c.InterfaceC0132c() { // from class: com.byazt.zk.ve.1
                @Override // com.byazt.dg.c.InterfaceC0132c
                public void c() {
                    ve veVar = ve.this;
    ...
    @com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.SINGLE_IMG, MediaPlayer.MEDIA_PLAYER_OPTION_DROP_AUDIO_COST_TIME})
