...
@com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.SINGLE_IMG, 15})
public class uj extends ve {
    ...
    @com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.SINGLE_IMG, z.k})
    ...
    public void tt(Canvas canvas, Matrix matrix, int i) {
        ...
        for (int size = this.x.size() - 1; size >= 0; size--) {
            if ((!this.t && "__container".equals(this.ve.a())) || this.da.isEmpty() || canvas.clipRect(this.da)) {
