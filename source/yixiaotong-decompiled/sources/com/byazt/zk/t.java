...
@com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.SINGLE_IMG, 66})
public class t extends ve {
    ...
    private void c(com.byazt.nb.tt ttVar, Matrix matrix, com.byazt.nb.ve veVar, Canvas canvas) {
        ...
        if (cVar2 != null) {
            ...
            if (ttVar.u != null || ttVar.u.y <= 0.0f) {
                ...
                float f5 = ttVar.u.y;
                float f6 = ttVar.f2493a * fC2;
                if (f6 > 0.0f) {
                    float f7 = f5 - ((ttVar.f2493a * 0.6f) * fC2);
                    if (f7 > 0.0f) {
                        iMin = ((int) (f7 / f6)) + 1;
                    } else {
                        iMin = Integer.MAX_VALUE;
    ...
    private void c(com.byazt.nb.tt ttVar, com.byazt.nb.ve veVar, Canvas canvas) {
        ...
        if (cVar2 != null) {
            ...
            if (ttVar.u != null || ttVar.u.y <= 0.0f) {
                ...
                float fC2 = com.byazt.kk.da.c();
                float f3 = ttVar.u.y;
                float f4 = ttVar.f2493a * fC2;
                if (f4 > 0.0f) {
                    float f5 = f3 - ((ttVar.f2493a * 0.6f) * fC2);
                    if (f5 > 0.0f) {
                        iMin = ((int) (f5 / f4)) + 1;
                    } else {
                        iMin = Integer.MAX_VALUE;
    ...
    private void c(Canvas canvas, com.byazt.nb.tt ttVar, int i, float f) {
        ...
        float f2 = (i * ttVar.f2493a * fC) + (pointF == null ? 0.0f : (ttVar.f2493a * 0.6f * fC) + pointF.y);
    ...
    @com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.SINGLE_IMG, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_PTS_SYNCED_SEI_NOTIFICATION})
    ...
    @com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.SINGLE_IMG, AppTypeIdUtil.NewDevice4GDrinkOTA_2})
