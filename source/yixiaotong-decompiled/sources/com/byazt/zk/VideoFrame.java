...
@com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.SINGLE_IMG, 2067})
public class VideoFrame extends View {
    ...
    public final com.byazt.ga.i.c.C0157c ve;
    public int x;

    public VideoFrame(Context context, TextureView textureView, com.byazt.ga.i.c.C0157c c0157c) {
        super(context);
        this.f2926a = -1L;
        this.sp = null;
        this.x = 0;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (jElapsedRealtime - this.f2926a >= 40) {
            this.f2926a = jElapsedRealtime;
