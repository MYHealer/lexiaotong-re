...
public final class ve extends com.byazt.jb.sp.tt implements i {
    ...
    public String toString() {
        StringBuilder sbAppend = new StringBuilder("Connection{").append(this.x.c().c().sp()).append(x.bQ).append(this.x.c().c().x()).append(", proxy=").append(this.x.tt()).append(" hostAddress=").append(this.x.ve()).append(" cipherSuite=");
        nu nuVar = this.sl;
