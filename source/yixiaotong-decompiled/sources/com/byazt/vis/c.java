...
public class c extends tt {
    ...
    public Map<String, Object> f2814a;
    public i n;
    public String sl;
    public String sp;
    ...
    public int c(Map<String, Object> map, com.byazt.zo.ve veVar) {
        ...
        if (map.containsKey("reward_browse_banner_from")) {
            this.f2814a.put("refer", "banner");
        }
        if (h.c(this.c) && !uj.c(String.valueOf(nb.t(this.c))) && this.c.zo() != null) {
            this.f2814a.put("refresh_num", Integer.valueOf(this.c.zo().ve()));
        }
        Object obj3 = map.get("click_saas_action");
        if (obj3 != null && (obj3 instanceof Integer)) {
            this.f2814a.put("click_saas_action", obj3);
        }
        Object obj4 = map.get("click_saas_area");
        if (obj3 != null && (obj3 instanceof Integer)) {
            this.f2814a.put("click_saas_area", obj4);
        }
        c(true);
        com.byazt.ddx.uj.c("click", this.c, this.n, this.sp, zBooleanValue, this.f2814a, this.ve.x() ? 1 : 2, this.x, this.ve.c());
        return 0;
    }
    ...
    public void c(Map<String, Object> map) {
        Map<String, Object> map2 = this.f2814a;
        if (map2 == null) {
            this.f2814a = map;
        } else {
            map2.putAll(map);
    ...
    private void a() {
        ...
        if (j == 0) {
            Map<String, Object> map = this.f2814a;
            if (map != null) {
