...
public class a {
    ...
    public int ve = -1;
    public String sp = com.huawei.openalliance.ad.constant.x.dh;
    public long x = 0;
    public long i = 0;
    public long da = 0;
    public long sl = 0;
    ...
    public void c(WebView webView, int i) {
        if (this.sl == 0 && i > 0) {
            ...
            if (!com.huawei.openalliance.ad.constant.x.dh.equals(this.sp) || this.c == 3) {
                return;
            }
    ...
    public void c(WebView webView, String str, Bitmap bitmap) {
        ...
        try {
            jSONObject.putOpt(com.hihonor.adsdk.base.g.j.e.a.S0, "h5");
    ...
    public void c(WebView webView) {
        ...
        try {
            ...
            jSONObject.put(com.hihonor.adsdk.base.g.j.e.a.hnadst, this.uj);
    ...
    public void uj() {
        ...
        if (com.huawei.openalliance.ad.constant.x.dh.equals(this.sp) || "landingpage_endcard".equals(this.sp)) {
            if (this.h.compareAndSet(false, true)) {
                com.byazt.qw.ve.ve().c("landingStart", this.f2068a, this.d);
            } else {
                com.byazt.qw.ve.ve().c("landingContinue", this.f2068a, this.d);
            }
        }
    }
    ...
    public void n() {
        if (this.yv) {
            ...
            try {
                ...
                com.byazt.ic.c.c(jSONObject, this.f2068a);
            } catch (JSONException e) {
                m.c(e);
            }
            uj.c(this.f2068a, com.huawei.openalliance.ad.constant.x.dh, "agg_stay_page", new com.byazt.ya.c() { // from class: com.byazt.ddx.a.1
        ...
        if (this.c == 2) {
            if (this.da > 0 || !tt()) {
                ...
                com.byazt.qw.ve.ve().c("landingPause", this.f2068a, this.d);
            }
        }
    }
    ...
    public void a() {
        ...
        if (!this.gr.get() && this.tt) {
            uj.ve(this.f2068a, this.sp, System.currentTimeMillis() - this.yp);
        }
        if (com.huawei.openalliance.ad.constant.x.dh.equals(this.sp) || "landingpage_endcard".equals(this.sp)) {
            com.byazt.qw.ve.ve().c("landingFinish", this.f2068a, this.d);
        }
        this.md = null;
        if (this.eo.isEmpty()) {
            return;
        ...
        com.byazt.ukr.yp.c().tt(new com.byazt.ee.c() { // from class: com.byazt.ddx.a.2
            ...
            public com.byazt.qal.c c() {
                ...
                if (a.this.f2068a != null) {
                    ttVarC.a(a.this.f2068a.qy());
                }
                JSONObject jSONObject = new JSONObject();
    ...
    private void c(String str, JSONObject jSONObject, long j) {
        if (!this.rl || this.f2068a == null || TextUtils.isEmpty(str)) {
            return;
        }
        ...
        uj.ve(this.f2068a, this.sp, str, jSONObject2);
    }

    public void tt(String str) {
        if (this.rl) {
            if ("load_finish".equals(str) && com.huawei.openalliance.ad.constant.x.dh.equals(this.sp)) {
                ...
                com.byazt.hq.c.c(new com.byazt.hq.c.RunnableC0173c(this.md));
            }
    ...
    public void i() {
        try {
            if (!TextUtils.isEmpty(com.byazt.hq.c.c) && this.f2068a != null) {
                StringBuilder sb = new StringBuilder(com.byazt.hq.c.c);
                JSONObject jSONObject = new JSONObject();
                jSONObject.putOpt(ba.D, this.f2068a.uj());
                jSONObject.putOpt("ad_id", this.f2068a.gu());
                jSONObject.put("log_extra", this.f2068a.w_());
                JSONObject jSONObject2 = new JSONObject();
                jSONObject2.put("web_init_time", this.m);
                jSONObject2.put("click_time", this.z);
                jSONObject2.put("web_url", this.f2068a.x());
    ...
    public void sp() {
        ...
        cVarMa.c(ujVar.getWebView(), this.f2068a);
    }
}
