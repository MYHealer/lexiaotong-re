...
public class da implements com.byazt.rbg.c {
            ...
            com.byazt.nr.da.c().post(new Runnable() { // from class: com.byazt.ddx.da.1
                ...
                public void run() {
                    ...
                    if (jSONObjectNu != null) {
                        da.this.c(jSONObject, OapsKey.KEY_SIZE, jSONObjectNu);
                    }
                    da daVar4 = da.this;
        ...
        try {
            com.byazt.nr.da.c().post(new Runnable() { // from class: com.byazt.ddx.da.26
                ...
                public void run() {
                    ...
                    JSONObject jSONObject = new JSONObject();
                    da.this.c(jSONObject, "ts", Long.valueOf(jCurrentTimeMillis));
                    da.this.c(jSONObject, "code", Integer.valueOf(i));
                    String str2 = str;
                    if (str2 != null) {
                        da.this.c(jSONObject, "reason", str2);
                    }
                    da daVar = da.this;
        ...
        try {
            com.byazt.nr.da.c().post(new Runnable() { // from class: com.byazt.ddx.da.6
                ...
                public void run() {
                    ...
                    if (da.this.ve != null) {
                        if (pu.x(da.this.ve)) {
                            da.this.c(jSONObject, "engine_version", b.u);
                        } else {
                            da.this.c(jSONObject, "engine_version", com.huawei.hms.ads.dynamicloader.b.f);
                        }
                    }
                    da daVar = da.this;
        ...
        try {
            com.byazt.nr.da.c().post(new Runnable() { // from class: com.byazt.ddx.da.17
                ...
                public void run() {
                    ...
                    da.this.c(jSONObject, "duration", Long.valueOf(j2 - j));
                    da daVar = da.this;
    ...
    public void c(boolean z, int i) {
        try {
            ...
            this.yp.put("webview_result", !z ? 1 : 0);
        } catch (Exception e) {
            m.c(e);
        }
    }
    ...
    public void c(int i, int i2, String str) {
        try {
            ...
            this.yp.put(com.hihonor.adsdk.base.g.j.e.a.S0, i);
    ...
    public boolean rh() {
        ...
        return this.f2071a.booleanValue() && this.n.booleanValue();
    }
