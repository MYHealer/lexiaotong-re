...
public class c implements com.byazt.fo.tt {
    ...
    public c(C0129c c0129c) {
        this.uj = new JSONObject();
        this.c = TextUtils.isEmpty(c0129c.c) ? UUID.randomUUID().toString() : c0129c.c;
        this.da = c0129c.sl;
        this.sl = c0129c.n;
        this.n = c0129c.tt;
        this.f2069a = c0129c.ve;
        if (TextUtils.isEmpty(c0129c.uj)) {
            this.sp = "app_union";
        } else {
            this.sp = c0129c.uj;
        }
        this.x = c0129c.f2070a;
        this.i = c0129c.sp;
        this.uj = c0129c.i = c0129c.i != null ? c0129c.i : new JSONObject();
            ...
            if (this.t != 0) {
                ...
                if (!TextUtils.isEmpty(strOptString)) {
                    ...
                    if (jSONObject2.optInt("sdk_event_self_count") == 0) {
                        jSONObject2.put("sdk_event_self_count", com.byazt.ml.c.c(this.f2069a));
                    }
                ...
                jSONObject3.put("sdk_event_self_count", com.byazt.ml.c.c(this.f2069a));
    ...
    private void x() throws JSONException {
        ...
        this.tt.putOpt("label", this.f2069a);
        this.tt.putOpt(com.huawei.openalliance.ad.constant.x.cy, this.sp);
        if (!TextUtils.isEmpty(this.x)) {
            try {
                this.tt.putOpt(oOOOoo00.OooOo0o, Long.valueOf(Long.parseLong(this.x)));
            } catch (NumberFormatException unused) {
                this.tt.putOpt(oOOOoo00.OooOo0o, 0L);
            }
        }
        ...
        if (!TextUtils.equals(this.f2069a, "pangle_live_sdk_monitor")) {
    ...
    public static final class C0129c {
        ...
        public C0129c c(JSONObject jSONObject) {
            if (jSONObject == null) {
                return this;
            }
            this.i = jSONObject;
        ...
        public C0129c n(String str) {
            this.f2070a = str;
            return this;
        }

        public C0129c sp(String str) {
            this.x = str;
            return this;
        }

        public C0129c tt(String str) {
            this.ve = str;
            return this;
        }

        public C0129c uj(String str) {
            this.n = str;
            return this;
        }

        public C0129c ve(String str) {
            this.uj = str;
            return this;
        }
        ...
        public void c(com.byazt.ya.c cVar) {
            if (com.byazt.ukr.n.c(this.ve, 1.0d)) {
                if (this.n != null) {
                    com.byazt.qw.ve.ve().c(this.ve, this.f2070a, this.x, (JSONObject) null, this.n);
                }
                this.sl = cVar;
                c cVar2 = new c(this);
                try {
    ...
    public boolean a() {
        ...
        if (TextUtils.isEmpty(strOptString)) {
            ...
            return ve.c.contains(this.f2069a);
        }
