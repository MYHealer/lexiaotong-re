...
public class uj {
    ...
    public static void c(String str, String str2, String str3, String str4, com.byazt.ya.c cVar) {
        new c.C0129c().n(str3).uj(str4).c(str).tt(str2).c(cVar);
    }
    ...
    public static void c(ic icVar, String str, String str2, com.byazt.ya.c cVar) {
        ...
        new c.C0129c().n(icVar.uj()).uj(icVar.w_()).c(str).tt(str2).sp(icVar.qy()).c(cVar);
    }
    ...
    public static void c(String str, String str2, String str3, String str4, String str5, JSONObject jSONObject, com.byazt.ya.c cVar) {
        new c.C0129c().uj(str4).c(str).ve(str3).tt(str2).n(str5).c(jSONObject).c(cVar);
    }
    ...
    public static void c(ic icVar, String str, String str2, JSONObject jSONObject, com.byazt.ya.c cVar) {
        ...
        new c.C0129c().n(icVar.uj()).uj(icVar.w_()).c(str).tt(str2).c(jSONObject).sp(icVar.qy()).c(cVar);
    }
        ...
        com.byazt.bzd.x.c((Runnable) new com.byazt.bwm.sp("repost_show_check") { // from class: com.byazt.ddx.uj.22
            ...
            public void run() {
                ...
                uj.c(icVar, str, "show_check", new com.byazt.ya.c() { // from class: com.byazt.ddx.uj.22.1
                    ...
                    public void onSend(JSONObject jSONObject) throws JSONException {
                        JSONObject jSONObject2 = new JSONObject();
                        jSONObject2.put(e.n, com.byazt.by.c.c(gt.getContext(), com.byazt.ouz.i.c(str)).toString());
                        jSONObject2.put("is_cache", icVar.up() ? 1 : 0);
                        ...
                        jSONObject2.put(com.hihonor.adsdk.base.g.j.e.a.j1, !rh.tt.get() ? 1 : 0);
                        ...
                        jSONObject2.put(HiAnalyticsConstant.HaKey.BI_KEY_DIRECTION, com.byazt.pf.c.c().a());
                        ...
                        jSONObject.putOpt(com.hihonor.adsdk.base.g.j.e.a.U0, Float.valueOf(f));
                    }
                });
            }
        });
    ...
    public static void tt(final ic icVar, final String str, final Map<String, Object> map, final Double d) {
        ...
        icVar.bn().ve();
        c++;
        c(icVar, str, br.b.V, new com.byazt.ya.c() { // from class: com.byazt.ddx.uj.38
            @Override // com.byazt.ya.c
            public void onSend(JSONObject jSONObject) throws JSONException {
                JSONObject jSONObject2 = new JSONObject();
                jSONObject2.put(e.n, com.byazt.by.c.c(gt.getContext(), com.byazt.ouz.i.c(str)).toString());
            ...
            public void c(ic icVar2, Double d2, JSONObject jSONObject) {
                ...
                try {
                    ...
                    if (d2 != null) {
                        jSONObject.put("ttdsp_price", d2);
                    } else if (icVar2.nq() && (obj2 = mapYt.get(OapsKey.KEY_PRICE)) != null) {
        ...
        if (!TextUtils.isEmpty(strC2)) {
            ...
            map2.put(ba.D, icVar.uj());
            map2.put("req_id", icVar.qy());
            map2.put("customer_id", nb.yp(icVar));
            com.byazt.ukr.tt.c(strC2, listPr, true, map2, c(icVar, str, br.b.V));
        } else if (listPr != null && listPr.size() != 0) {
            c(icVar, listPr, str, "no did", br.b.V);
        }
    ...
    private static void c(ic icVar, List<String> list, String str, String str2, String str3) {
        ...
        try {
            ...
            jSONObject.put(com.hihonor.adsdk.base.g.j.e.a.hnadst, str2);
    ...
    public static void c(final String str, ic icVar, String str2, final int i, final Map<String, Long> map) {
        ...
        c(icVar, str2, "ad_show_time", new com.byazt.ya.c() { // from class: com.byazt.ddx.uj.40
            ...
            public void onSend(JSONObject jSONObject) throws JSONException {
                JSONObject jSONObject2 = new JSONObject();
                jSONObject2.putOpt(ba.at, Integer.valueOf(i));
                Map map2 = map;
                if (map2 != null) {
    ...
    public static void c(String str, final ic icVar, final com.byazt.ete.i iVar, final String str2, final boolean z, final Map<String, Object> map, final int i, boolean z2, final boolean z3) {
        ...
        c(icVar, str2, str, new com.byazt.ya.c() { // from class: com.byazt.ddx.uj.2
            ...
            public void onSend(JSONObject jSONObject) throws JSONException {
                ...
                if (iVar2 != null) {
                    ...
                    jSONObjectC.put(e.n, com.byazt.by.c.c(gt.getContext(), com.byazt.ouz.i.c(str2)).toString());
        ...
        gr.c(1, 2);
        if (m.ve()) {
            m.c("AdEvent", str + PPSLabelView.Code + icVar.uj());
        }
    }
    ...
    public static void tt(ic icVar, String str) {
        if (icVar != null) {
            ...
            veVar.setId("0:00");
            veVar.setName(str);
            com.byazt.qw.ve.ve().c(dd.F, icVar.uj(), icVar.qy(), icVar.q_(), (String) null);
            c(icVar.wq(), veVar);
        }
    }
    ...
    public static void c(Context context, ic icVar, String str, String str2, JSONObject jSONObject) {
        ...
        Object objOpt = jSONObject.opt(oOOOoo00.OooOo0o);
        if (objOpt == null) {
            objOpt = icVar.uj();
        }
        String strOptString = jSONObject.optString(com.huawei.openalliance.ad.constant.x.cy);
        ...
        new c.C0129c().n(objOpt == null ? "" : objOpt.toString()).ve(strOptString).uj(objOpt2 != null ? objOpt2.toString() : "").c(str).c(jSONObject).tt(str2).c(new com.byazt.ya.c() { // from class: com.byazt.ddx.uj.4
            @Override // com.byazt.ya.c
            public void onSend(JSONObject jSONObject2) throws JSONException {
            }
        });
    ...
    public static void c(final long j, final ic icVar) {
        ...
        c(icVar, "splash_ad", dd.F, new com.byazt.ya.c() { // from class: com.byazt.ddx.uj.5
            @Override // com.byazt.ya.c
            public void onSend(JSONObject jSONObject) throws JSONException {
                JSONObject jSONObject2 = new JSONObject();
    ...
    public static void c(String str, String str2, String str3, String str4) {
        new c.C0129c().c(str3).tt(str4).n(str).uj(str2).c((com.byazt.ya.c) null);
        if (m.ve()) {
            m.c("AdEvent", "tag: " + str3 + "label: " + str4 + PPSLabelView.Code + str);
        }
    }
    ...
    public static void c(String str, final String str2, final String str3, long j, long j2, JSONObject jSONObject, final byte b) {
        ...
        new c.C0129c().c(str2).tt(str3).ve(str).n(String.valueOf(j)).a(String.valueOf(j2)).c(jSONObject).c(new com.byazt.ya.c() { // from class: com.byazt.ddx.uj.18
            @Override // com.byazt.ya.c
            public void onSend(JSONObject jSONObject2) throws JSONException {
                ...
                jSONObject3.put(e.n, com.byazt.by.c.c(gt.getContext(), com.byazt.ouz.i.c(str2)).toString());
                ...
                if ("click".equals(str3)) {
                    ...
                    jSONObject2.putOpt(com.hihonor.adsdk.base.g.j.e.a.U0, Float.valueOf(f));
                }
            }
        });
        if (m.ve()) {
    ...
    public static void ve(ic icVar, String str, String str2, JSONObject jSONObject) {
        ...
        new c.C0129c().n(icVar.uj()).uj(icVar.w_()).c(str).tt(str2).c(jSONObject).c((com.byazt.ya.c) null);
    }
    ...
    public static void tt(final ic icVar) {
        c(icVar, com.huawei.openalliance.ad.constant.x.dh, "open_url_h5", new com.byazt.ya.c() { // from class: com.byazt.ddx.uj.20
            @Override // com.byazt.ya.c
            public void onSend(JSONObject jSONObject) throws JSONException {
                JSONObject jSONObject2 = new JSONObject();
                jSONObject2.putOpt(com.hihonor.adsdk.base.g.j.e.a.S0, "h5");
            ...
            c(icVar, str, "open_live", new com.byazt.ya.c() { // from class: com.byazt.ddx.uj.28
                ...
                public void onSend(JSONObject jSONObject) throws JSONException {
                    ...
                    if (nuVarYp != null) {
                        ...
                        jSONObject2.put(MeishuOpenDeepLinkActivity.KEY_DEEP_LINK, strTt);
