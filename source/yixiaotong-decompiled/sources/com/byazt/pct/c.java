...
@com.byazt.zqa.c(c = {0, 1, AppTypeIdUtil.NewDevice4GDrinkOTA_1, 20})
public abstract class c {
    ...
    public final void c(da daVar, rl rlVar) {
        ...
        this.ve = daVar.uj;
        this.tt = daVar.i;
        this.f2618a = new sp(daVar, this, rlVar);
        this.uj = daVar.sl;
        c(daVar);
    }
    ...
    public final <T> void c(String str, T t) {
        ...
        c("{\"__msg_type\":\"event\",\"__event_id\":\"" + str + "\",\"__params\":" + strC + com.alipay.sdk.util.i.d);
    }
    ...
    public final void tt(String str, m mVar) {
        ...
        if (TextUtils.isEmpty(mVar.f2620a)) {
        ...
        c(z.c().c("__msg_type", "callback").c("__callback_id", mVar.f2620a).c("__params", jSONObject).tt(), mVar);
    }
    ...
    public m c(JSONObject jSONObject) {
        ...
        String strOptString3 = jSONObject.optString(ICBCWebChromeClient.JAVASCRIPT_COMMON_VALUE_FUNCTION);
        try {
    ...
    private sp tt(String str) {
        return (TextUtils.equals(str, this.uj) || TextUtils.isEmpty(str)) ? this.f2618a : this.x.get(str);
    }
}
