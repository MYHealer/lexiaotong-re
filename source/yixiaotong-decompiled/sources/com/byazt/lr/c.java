...
public class c extends Dialog {
    ...
    private View c() {
        ...
        this.f2462a = textView4;
        textView4.setText("放弃下载");
        this.f2462a.setTextSize(1, 12.0f);
        this.f2462a.setTextColor(Color.parseColor("#4D161823"));
        LinearLayout.LayoutParams layoutParams9 = new LinearLayout.LayoutParams(-2, -2);
        layoutParams9.topMargin = u.c(this.i, 11.0f);
        layoutParams9.bottomMargin = u.c(this.i, 15.0f);
        linearLayout.addView(this.f2462a, layoutParams9);
    ...
    private void tt() {
        ...
        this.tt.setText("版本号：" + u.c(this.t.f2523a, "--"));
        ...
        this.f2462a.setOnClickListener(new View.OnClickListener() { // from class: com.byazt.lr.c.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                c.this.dismiss();
