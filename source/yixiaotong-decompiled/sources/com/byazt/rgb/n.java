...
public class n {
    ...
    public static void c(String str, long j, int i) {
        ...
        if (aVarC != null) {
            ...
            xVar.c(ba.at, Integer.valueOf(i));
    ...
    public static void tt() {
        if (gt.tt().vl()) {
            ...
            try {
                ...
                jSONObject.putOpt("type", TtmlNode.END);
                jSONObject.putOpt("ts", Long.valueOf(System.currentTimeMillis()));
                jSONObject.putOpt(ba.at, 2);
                tt(com.byazt.vxy.c.uj()).put(com.byazt.qcl.c.c("app") + c, jSONObject.toString());
