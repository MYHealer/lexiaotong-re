...
public class TopLayoutImpl extends FrameLayout implements c<TopLayoutImpl> {
    ...
    public TopLayoutImpl c(ic icVar) {
        ...
        this.f2247a = findViewById(2114387713);
    ...
    private void uj() {
        ...
        pf.c(this.f2247a, new View.OnClickListener() { // from class: com.byazt.ge.TopLayoutImpl.7
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                if (TopLayoutImpl.this.rl != null) {
    ...
    public boolean getSkipOrCloseVisible() {
        return pf.uj(this.da) || (this.f2247a != null && pf.uj(this.sl) && !TextUtils.isEmpty(this.sl.getText()));
    }
