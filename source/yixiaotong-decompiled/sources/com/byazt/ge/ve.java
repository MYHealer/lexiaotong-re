...
public abstract class ve implements tt {
    ...
    public TTBaseVideoActivity f2248a;
    public boolean c;
    ...
    public ve(TTBaseVideoActivity tTBaseVideoActivity, ic icVar, com.byazt.kcl.tt ttVar, com.byazt.kcl.n nVar, boolean z) {
        this.f2248a = tTBaseVideoActivity;
        this.tt = icVar;
        this.uj = ttVar;
        this.n = nVar;
        this.c = z;
    ...
    public boolean c() {
        ...
        yp.c().c(this.tt, "stats_reward_full_close_force", this.f2248a.lt().c(new JSONObject()));
        this.f2248a.finish();
        return true;
    }
    ...
    public boolean c(da daVar) {
        ic icVar = this.ve;
        if (icVar != null) {
            return this.f2248a.c(icVar, daVar);
        }
        return this.f2248a.c(this.tt, daVar);
    }
}
