...
public class z {
    ...
    public static void c(Context context) {
        ...
        if (!atomicBoolean.get()) {
            synchronized (z.class) {
                if (!atomicBoolean.get()) {
                    f2097a = StubApp.getOrigApplicationContext(context.getApplicationContext());
                    if (sp() != null) {
                        String strC = sp().c(tt);
    ...
    private static boolean x() {
        return UMModuleRegister.INNER.equals(p.x);
    }
    ...
    private static boolean tt(final Context context) {
        ...
        if (x()) {
            try {
                cVarC = com.byazt.di.da.c(origApplicationContext).c(AdBaseConstants.DownloadConfigureName.PANGOLIN);
            } catch (Throwable unused) {
                cVarC = com.byazt.di.da.c(origApplicationContext).c();
            }
        } else {
            cVarC = com.byazt.di.da.c(origApplicationContext).c();
        }
        ...
        cVarC.c(new uj()).c(new tt()).c(new n(origApplicationContext)).c(new ve()).c(new com.byazt.s.sp() { // from class: com.byazt.dk.z.9
        ...
        }).c(new com.byazt.e.c.C0140c().tt("143").c("open_news").ve(p.n).uj(String.valueOf(p.uj)).c()).c(new rh() { // from class: com.byazt.dk.z.5
        ...
        }).c(c(origApplicationContext, i())).c();
        com.byazt.hu.c.c();
        if (!p.x.equals(UMModuleRegister.INNER)) {
            com.byazt.di.da.c(origApplicationContext).uj().c(1);
            com.byazt.di.da.c(origApplicationContext).c(i);
        ...
        try {
            if (i2 == 101) {
                ...
                if (zTt) {
                    ...
                    boolean zC = com.byazt.z.uj.c(f2097a, cVar.uj());
                    if (zC) {
                        str = "mem install";
                    } else {
                        str = "cache install";
                        zC = com.byazt.z.uj.c(f2097a, c(cVar.da(), cVar.i()));
                    }
                    String str4 = str;
                    z = zC;
                    str2 = str4;
                ...
                com.byazt.yih.n.c(cVar.sp(), cVar, str3, "media_install", str2, z ? "success" : "failure");
            } else {
    ...
    public static JSONObject tt(com.byazt.e.ve veVar) {
        ...
        try {
            jSONObject.put(com.huawei.openalliance.ad.constant.x.cy, veVar.c());
    ...
    public static boolean c(Activity activity, final com.byazt.ocd.c cVar) {
        return com.byazt.de.c.c().c(activity, false, new com.byazt.de.c.InterfaceC0131c() { // from class: com.byazt.dk.z.3
            @Override // com.byazt.de.c.InterfaceC0131c
            public void c() {
