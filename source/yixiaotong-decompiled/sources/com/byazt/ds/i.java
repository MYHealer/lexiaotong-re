...
public class i {
    ...
    public static final String[] f2110a = {"channel", "package", "app_version"};
    public boolean c;
    ...
    public String ve() {
        String strOptString = this.c ? z().optString("app_version", null) : null;
        for (int i = 0; i < 3 && strOptString == null; i++) {
            a();
            strOptString = this.c ? z().optString("app_version", null) : null;
        }
        return strOptString;
    }
    ...
    private boolean c(ve veVar) {
        ...
        if (com.byazt.yv.da.tt) {
            com.byazt.yv.da.c("needSyncFromSub " + veVar + PPSLabelView.Code + z, null);
        }
        return z;
    }
