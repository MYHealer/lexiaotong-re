...
public final class rh {
    ...
    public String toString() {
        ...
        int iC = c();
        for (int i = 0; i < iC; i++) {
            sb.append(c(i)).append(": ").append(tt(i)).append(IOUtils.LINE_SEPARATOR_UNIX);
        }
        return sb.toString();
    }
    ...
    public static final class c {
        ...
        public c c(String str) {
            int iIndexOf = str.indexOf(com.huawei.openalliance.ad.constant.x.bQ, 1);
            if (iIndexOf != -1) {
                return tt(str.substring(0, iIndexOf), str.substring(iIndexOf + 1));
            }
            if (str.startsWith(com.huawei.openalliance.ad.constant.x.bQ)) {
