...
public final class t {
  ...
  0x00c0: PHI (r0v16 long) = (r0v2 long), (r0v6 long) binds: [B:42:0x00be, B:53:0x00e1] A[DONT_GENERATE, DONT_INLINE]] */
    public static t c(long j, my myVar, String str) {
        ...
        char c3 = '=';
        int iC2 = com.byazt.kh.ve.c(str, 0, iC, '=');
        if (iC2 == iC) {
            return null;
        }
        ...
        while (i < length) {
            ...
            if (ClientCookie.EXPIRES_ATTR.equalsIgnoreCase(strVe3)) {
                try {
                ...
                jC = c(strVe4);
                z3 = true;
            } else if (ClientCookie.DOMAIN_ATTR.equalsIgnoreCase(strVe3)) {
                strTt = tt(strVe4);
                z4 = false;
            } else if ("path".equalsIgnoreCase(strVe3)) {
                str3 = strVe4;
            } else if (ClientCookie.SECURE_ATTR.equalsIgnoreCase(strVe3)) {
                z = true;
    ...
    private static long c(String str) {
        try {
            ...
            if (str.matches("-?\\d+")) {
                return str.startsWith(com.huawei.openalliance.ad.constant.x.A) ? Long.MIN_VALUE : Long.MAX_VALUE;
            }
            throw e;
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        t tVar = (t) obj;
        return tVar.n.equals(this.n) && tVar.f2142a.equals(this.f2142a) && tVar.x.equals(this.x) && tVar.i.equals(this.i) && tVar.sp == this.sp && tVar.da == this.da && tVar.sl == this.sl && tVar.t == this.t && tVar.u == this.u;
    }

    public int hashCode() {
        int iHashCode = (((((((this.n.hashCode() + 527) * 31) + this.f2142a.hashCode()) * 31) + this.x.hashCode()) * 31) + this.i.hashCode()) * 31;
        long j = this.sp;
