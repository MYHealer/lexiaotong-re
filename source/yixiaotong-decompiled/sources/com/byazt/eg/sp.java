...
@com.byazt.zqa.c(c = {0, 1, 16, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public final class sp {
    ...
    public void c(String str, List<Certificate> list) throws SSLPeerUnverifiedException {
        ...
        sb.append("\n  Pinned certificates for ").append(str).append(com.huawei.openalliance.ad.constant.x.bQ);
