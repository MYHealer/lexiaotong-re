...
public class c {
    ...
    public static void c() {
        ...
        f2401a = jSONObjectZb.optInt("disable_task_setting", 0) == 1;
    ...
    public static c c(DownloadInfo downloadInfo) {
        return downloadInfo == null ? tt : c(downloadInfo.getId(), downloadInfo);
    }
    ...
    public static c c(JSONObject jSONObject) {
        if (jSONObject == null || jSONObject == tt() || f2401a) {
            return tt;
        }
        c cVar = sp;
    ...
    private static c ve(int i) {
        ...
        return (contextIc == null || (downloadInfo = Downloader.getInstance(contextIc).getDownloadInfo(i)) == null) ? tt : tt(downloadInfo);
    }
