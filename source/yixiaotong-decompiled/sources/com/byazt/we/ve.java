...
public final class ve implements Function<SparseArray<Object>, Object> {
    ...
    public static void reportException(String str, Throwable th) {
        try {
            ...
            jSONObject.put(com.hihonor.adsdk.base.g.j.e.a.InterfaceC0437a.hnadsd, str);
            if (th != null) {
    ...
    private final class C0309ve implements TTPluginListener {
        public int c;
        public String tt;
