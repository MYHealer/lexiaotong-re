            ...
            switch (strNextName) {
                case "d":
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if ("o".equals(strNextString2)) {
                            ttVar4 = ttVarC2;
                        } else if (com.kuaishou.weapon.p0.t.t.equals(strNextString2) || OapsKey.KEY_GRADE.equals(strNextString2)) {
                            aVar.c(true);
                ...
                case "g":
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (strNextName3.equals(com.kuaishou.weapon.p0.t.f4727a)) {
