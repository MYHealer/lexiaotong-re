...
public class tt extends uj {
                            ...
                            try {
                                try {
                                    ...
                                    try {
                                        ...
                                        while (true) {
                                            int i4 = inputStreamVe.read(bArr, i, 16384 - i);
                                            if (i4 == i3) {
                                                break;
                                            }
                                            i += i4;
    ...
    /* JADX WARN: Code duplicated, block: B:133:0x02e1 A[Catch: all -> 0x0300, TryCatch #0 {all -> 0x0300, blocks: (B:131:0x02da, B:133:0x02e1, B:134:0x02e4), top: B:178:0x02da, outer: #5 }] */
    /* JADX WARN: Code duplicated, block: B:205:0x02f9 A[DONT_GENERATE, EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    public com.byazt.hm.tt c() {
        ...
        try {
            ...
            try {
                ...
                if (zA) {
                    jC += length2;
                    String str3 = (String) map.get("Content-Range");
                    if (!TextUtils.isEmpty(str3)) {
                        String str4 = "bytes " + length2 + x.A + (jC - 1);
    ...
    public static boolean x(Map<String, String> map) {
        return TextUtils.equals(map.get("Content-Encoding"), AsyncHttpClient.ENCODING_GZIP);
    }
