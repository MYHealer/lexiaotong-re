    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 2) {
                ...
                this.sp = y;
                if (Math.abs(y - this.f2335a) > 10.0f) {
                    this.x = true;
                }
            ...
            if (!this.sl && (xVar3 = this.i) != null) {
                ...
                int iTt = com.byazt.or.x.tt(com.byazt.sr.uj.getContext(), Math.abs(this.sp - this.f2335a));
                if (this.sp - this.f2335a < 0.0f && iTt > this.da && (xVar2 = this.i) != null) {
                    xVar2.c();
