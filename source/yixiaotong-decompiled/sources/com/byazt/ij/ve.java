    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 2) {
                ...
                if (this.uj > this.c && iTt > this.sp && (xVar3 = this.f2336a) != null) {
                    xVar3.c();
                    this.i = true;
                }
            }
            ...
            if (this.uj > this.c && iTt2 > this.sp && (xVar2 = this.f2336a) != null) {
                xVar2.c();
                this.i = true;
            }
            float fAbs = Math.abs(x - this.c);
            float fAbs2 = Math.abs(y - this.tt);
            if ((fAbs < 8.0f || fAbs2 < 8.0f) && (xVar = this.f2336a) != null) {
                xVar.tt();
                this.i = true;
            }
        }
