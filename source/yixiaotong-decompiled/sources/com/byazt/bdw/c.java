        ...
        if (accessibleMethod != null) {
            ...
            while (true) {
                ...
                try {
                    ...
                    ZeusLogger.w(ZeusLogger.TAG_LOAD, "AssetManagerProcessor invoke AssetManager.addAssetPath() failed, cookie = " + iIntValue + PPSLabelView.Code + str);
                } catch (Exception e) {
            ...
            if (i2 >= 0) {
                try {
                    synchronized (assetManager) {
                        ...
                        if (iIntValue == 0) {
                            ZeusLogger.w(ZeusLogger.TAG_LOAD, "AssetManagerProcessor invoke AssetManager.appendAssetPathSafely() failed, cookie = " + iIntValue + PPSLabelView.Code + str);
                        } else {
