...
@com.byazt.zqa.c(c = {0, 1, DetailedCreativeType.LONG_TEXT, 15})
public class uj implements SensorEventListener {
    ...
    public final List<Float> f2251a = new ArrayList(1);
    ...
    private uj() {
        this.yp = null;
        this.z = null;
        SensorManager sensorManager = (SensorManager) StubApp.getOrigApplicationContext(a.ve().getApplicationContext()).getSystemService("sensor");
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (this.f2251a.size() <= 0) {
            this.f2251a.add(Float.valueOf(sensorEvent.values[0]));
    ...
    private synchronized void a() {
        if (!this.tt && this.ve.size() > 0 && this.f2251a.size() > 0) {
            this.tt = true;
            n();
            com.byazt.bwm.n.tt(new sp("har") { // from class: com.byazt.gf.uj.1
                ...
                public void run() {
                    JSONObject jSONObject = new JSONObject();
                    try {
                        float[] fArrC = ve.c(uj.this.ve, uj.this.uj, uj.this.n, uj.this.f2251a, uj.this.sp, uj.this.x);
                        uj.this.c(fArrC);
                        ...
                        jSONObject.put(b.f, jCurrentTimeMillis);
                    } catch (Exception unused) {
                        jSONObject = null;
                    }
                    if (uj.this.my != null) {
