...
public final class ve {
    ...
    public static final Charset f2414a = Charset.forName("ISO-8859-1");
    public static final Charset yp = Charset.forName(CharEncoding.UTF_16BE);
    ...
    public static String c(com.byazt.eg.my myVar, boolean z2) {
        String strSp;
        if (myVar.sp().contains(x.bQ)) {
            strSp = "[" + myVar.sp() + "]";
        } else {
            strSp = myVar.sp();
        }
        return (z2 || myVar.x() != com.byazt.eg.my.c(myVar.ve())) ? strSp + x.bQ + myVar.x() : strSp;
    }
    ...
    private static InetAddress uj(String str, int i2, int i3) {
        ...
        while (i2 < i3) {
            ...
            if (i6 != 0) {
                if (!str.regionMatches(i2, x.bQ, 0, 1)) {
                    if (!str.regionMatches(i2, ".", 0, 1) || !c(str, i8, i3, bArr, i6 - 2)) {
                        return null;
                    }
                    i6 += 2;
                    break;
    ...
    private static String c(byte[] bArr) {
        ...
        while (i3 < bArr.length) {
            if (i3 == i2) {
                ...
                veVar.sl(((bArr[i3] & 255) << 8) | (bArr[i3 + 1] & 255));
                i3 += 2;
            }
        }
        return veVar.z();
