...
public abstract class c implements ve, qp.c, com.byazt.ua.c.InterfaceC0286c, tt {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public ic f2516a;
    public volatile String gr;
    public InterfaceC0219c gu;
    ...
    public void c(InterfaceC0219c interfaceC0219c) {
        this.gu = interfaceC0219c;
    }
    ...
    public com.byazt.jzl.tt c(String str) {
        ic icVar;
        if (!gt.tt().qy() || (icVar = this.f2516a) == null) {
            return null;
        }
        long cachedSize = sl.c(icVar.xx()).getCachedSize(this.qy);
        int iC = uj.c(this.f2516a, this.qy, cachedSize);
        ...
        return new com.byazt.jzl.n.c().c("video_life").c(nb.sl(this.f2516a)).uj(nb.c(this.f2516a, "")).ve(this.f2516a.qy()).tt(this.f2516a.uj()).tt(this.f2516a.xx()).ve(iC).c(cachedSize).c(video_duration).uj(this.f2516a.il()).c(jSONObject).c();
    }
    ...
    public void c(Runnable runnable) {
        if (runnable == null || this.f2516a == null) {
            return;
        }
        if ((this.n.u() && this.da) || t.c(this.f2516a) || com.byazt.ic.c.tt(this.f2516a)) {
            runnable.run();
        } else {
            tt(runnable);
        }
    ...
    public void tt(int i) {
        ...
        String strTt = nb.tt(this.f2516a);
    ...
    private JSONObject c(int i, String str) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str2)) {
                ...
                jSONObject.putOpt(CrashHianalyticsData.TIME, this.rl.tt(i));
                return jSONObject;
            }
    ...
    public void nb() {
        ...
        uj.c(this.f2516a, (com.byazt.oce.c) this.n, this.qy, true, this.gr);
    }
    ...
    public void c(long j, long j2) {
        if (!this.p.get() && gt.tt().ri() && (j * 1.0d) / j2 > 0.3d) {
            this.p.set(true);
            com.byazt.qw.ve.ve().c("videoPercent30", this.f2516a);
        }
    }
}
