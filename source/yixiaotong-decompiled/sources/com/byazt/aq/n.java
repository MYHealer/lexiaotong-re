...
public class n {
    ...
    static {
        ...
        map.put(com.byazt.dyf.tt.AD_TAG_DISLIKE, 3);
        map.put("close", 3);
        map.put("close-fill", 3);
        map.put("webview-close", 22);
        map.put("feedback-dislike", 12);
        map.put(com.hihonor.adsdk.base.g.j.e.a.hnadsk, 2);
        ...
        map.put(dd.F, 27);
        map.put("timedown", 13);
        map.put(com.huawei.openalliance.ad.constant.x.cL, 16);
    ...
    public String toString() {
        return "DynamicLayoutBrick{type='" + this.tt + "', data='" + this.ve + "', value=" + this.n + ", themeValue=" + this.f1978a + ", dataExtraInfo='" + this.sp + "'}";
    }
}
