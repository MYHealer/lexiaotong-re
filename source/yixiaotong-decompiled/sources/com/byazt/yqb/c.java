...
public class c {
    ...
    public void c() {
        ...
        this.f2894a = linearLayout;
        linearLayout.setGravity(1);
        this.f2894a.setPadding(0, pf.ve(this.c, 16.0f), 0, 0);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, pf.ve(this.c, 76.0f));
        ...
        this.f2894a.addView(textView2, layoutParams2);
        c(25, xd.tt(this.tt));
        int iVe = pf.ve(this.c, 76.0f);
        this.uj.addView(this.f2894a, layoutParams);
        try {
            int iTt = x.tt(this.c);
            ...
            ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this.f2894a, "translationY", iTt, (iTt - iVe) + iZ);
            ...
            m.uj(TtmlNode.TAG_LAYOUT, th.getMessage());
        }
    }
            ...
            public void onSuccess(com.byazt.yj.m<Bitmap> mVar) {
                try {
                    ...
                    com.byazt.bzd.x.c(new Runnable() { // from class: com.byazt.yqb.c.2.1
                        ...
                        public void run() {
                            if (c.this.f2894a != null) {
                                c.this.f2894a.setBackgroundColor(Color.parseColor("#66000000"));
                            }
                            if (c.this.ve != null) {
    ...
    public void uj() {
        ...
        LinearLayout linearLayout = this.f2894a;
