...
public class NativeExpressView extends FrameLayout implements com.byazt.kn.uj, com.byazt.xv.c, com.byazt.xl.x, com.byazt.xl.z, m, sl, com.byazt.qdk.tt {
    ...
    public com.byazt.dh.ve.InterfaceC0133ve u;
    public Dialog uj;
    ...
    public void setVideoAdInteractionListener(com.byazt.dh.ve.InterfaceC0133ve interfaceC0133ve) {
        this.u = interfaceC0133ve;
    }
    ...
    public void sl() {
        this.rl = new FrameLayout(this.f2599a);
        this.cu = new FrameLayout(this.f2599a);
        this.qp = new FrameLayout(this.f2599a);
        addView(this.rl);
        addView(this.cu);
        addView(this.qp);
    ...
    private void gu() {
        ...
        if (TextUtils.equals(this.sp, "splash_ad") && (ttVar = this.x) != null && this.md == ttVar.sp() && this.p == this.x.a()) {
            this.md = pf.uj(this.f2599a, this.md);
            int iUj = pf.uj(this.f2599a);
            float f = this.p;
            float f2 = iUj;
            if (f < f2) {
                this.p = pf.uj(this.f2599a, f2);
            } else {
                this.p = pf.uj(this.f2599a, f);
            }
        }
    }
    ...
    private void gr() {
        try {
            ...
            this.f2599a.registerReceiver(this.l, intentFilter, nb.p(), null);
        } catch (Throwable th) {
            com.byazt.nr.m.c(th);
        }
    }
    ...
    private void zm() {
        ...
        if (pu.tt(this.i) == 3 && com.byazt.ic.c.uj(this.i) && (listPa = this.i.pa()) != null && !listPa.isEmpty() && (zbVar = listPa.get(0)) != null) {
            cVar.i(zbVar.c());
            cVar.c(new UpieImageView(this.f2599a, com.byazt.ic.c.i(this.i), com.byazt.nj.c.c(this.i), com.byazt.ic.c.da(this.i)));
        }
    ...
    private int getRenderThread() {
        if ((md() && com.byazt.omf.gt.tt().x(nb.t(this.i)) == 4) || (com.byazt.by.n.c().t() & 2) == 2) {
            return 1;
        }
        return pu.uj(this.i);
    }
    ...
    private void h() {
        ...
        int i = this.tt;
        if (i == 3) {
            com.byazt.xl.tt ttVar = new com.byazt.xl.tt(this.f2599a, this.os, this.l, this.gt, new com.byazt.du.sp(), this, cVar);
            this.kp = ttVar;
            this.to.add(ttVar);
            this.kp.c(com.byazt.omf.gt.tt().ra());
        } else if (i == 7) {
            com.byazt.atv.n nVar = new com.byazt.atv.n(this.f2599a, this.i, (com.byazt.atv.tt) this.os, this);
            this.d = nVar.da();
            com.byazt.atv.a aVar = new com.byazt.atv.a(this.f2599a, nVar, this, this.os, this);
            this.q = aVar;
            this.to.add(aVar);
        } else if (i == 10) {
            com.byazt.atv.sp spVar = new com.byazt.atv.sp(this.f2599a, this.i, (com.byazt.atv.tt) this.os, this);
            this.pu = spVar;
            this.d = spVar.da();
            this.q = new com.byazt.atv.a(this.f2599a, this.pu, this, this.os, this);
            ...
            this.lo = new yv(this.f2599a, this.os, this.l, this.h, this.i, this.tx, this);
            com.byazt.xl.m mVar = new com.byazt.xl.m(this.f2599a, this.os, this.lo, this);
            this.tk = mVar;
            this.to.add(mVar);
        }
        int iVe = pu.ve(this.i);
        if (iVe > 0 && yv() && TextUtils.equals(this.sp, com.byazt.dyf.tt.AD_TAG_FEED)) {
            this.to.add(new com.byazt.atv.a(this.f2599a, new com.byazt.ouc.ve(this.f2599a, this.i, (com.byazt.atv.tt) this.os, this), this, this.os, this));
        } else {
            boolean z = iVe == 1;
            this.c = z;
            if (z || this.tt == 1000) {
                com.byazt.xl.a aVar2 = new com.byazt.xl.a(this.f2599a, this.os, new my(this, this.l, this.os));
                this.b = aVar2;
                this.to.add(aVar2);
    ...
    private void c(com.byazt.xj.ve veVar, com.byazt.qdk.ve veVar2, int i) {
        ...
        View viewI = veVar.i();
        try {
            if ((viewI instanceof TextView) && (text = ((TextView) viewI).getText()) != null && text.toString().contains(com.hihonor.adsdk.base.c.g1.hnadsa)) {
    ...
    public void c(View view, int i, com.byazt.sr.ve veVar, int i2) {
        ...
        switch (i) {
            ...
            case 6:
                ...
                break;
            case 7:
                if (!nb.c(strOptString, this.i, this.f2599a)) {
                    com.byazt.aas.n.c(this.f2599a, this.i);
                }
                break;
            case 8:
                sp();
                break;
            case 9:
                tt(this.i, this.f2599a, this.sp);
                break;
            case 10:
                c(this.i, this.f2599a, this.sp);
                break;
            case 12:
                ve(this.i, this.f2599a, this.sp);
                break;
            case 13:
                ...
                if (!TextUtils.isEmpty(strOptString2)) {
                    TTDelegateActivity.uj(this.f2599a, strOptString2, strOptString3);
                }
                break;
        }
    }
    ...
    private void c(ic icVar, com.byazt.ete.uj ujVar) {
        ...
        if (frameLayout2 != null) {
            ...
            this.or = new FrameLayout(this.f2599a);
        }
    ...
    public void sp() {
        if (yv() && TextUtils.equals(this.sp, com.byazt.dyf.tt.AD_TAG_FEED)) {
            ...
            ttVar.tt(com.byazt.dyf.tt.AD_TAG_DISLIKE);
            com.byazt.pr.c.c().c(this.f2599a, ttVar, "close_success");
        }
    }
