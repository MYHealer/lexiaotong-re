...
public class SiteGestureView extends View {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            this.f2600a = motionEvent.getRawY();
    ...
    private void tt(int i, MotionEvent motionEvent) {
        int[] iArrC = pf.c(this);
        com.byazt.ete.gr grVarC = new com.byazt.ete.gr.c().c("express_gesture_view").uj(this.n).ve(this.f2600a).tt(motionEvent.getRawX()).c(motionEvent.getRawY()).tt(this.sp).ve(getWidth()).uj(getHeight()).c(iArrC == null ? 0 : iArrC[0]).tt(iArrC != null ? iArrC[1] : 0).c(true).c(System.currentTimeMillis()).c();
        this.tt.c(i);
