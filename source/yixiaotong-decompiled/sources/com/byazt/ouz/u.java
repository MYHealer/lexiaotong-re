...
public class u extends BackupView {
    public static rh[] u = {new rh(2, 3.0241935f, MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_RENDER_MS_GAPS, AppTypeIdUtil.NewDevice4GDrinkOTA_1), new rh(3, 1.25f, MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_RENDER_MS_GAPS, 300), new rh(4, 1.4044944f, MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_RENDER_MS_GAPS, 267), new rh(16, 1.25f, MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_RENDER_MS_GAPS, 300), new rh(5, 1.25f, MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_RENDER_MS_GAPS, 300), new rh(15, 1.25f, MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_RENDER_MS_GAPS, 300)};
    public ImageView gt;
    ...
    private void ve(int i) {
        ...
        this.f2598a = pf.ve(this.c, this.m.getExpectExpressWidth());
        this.sp = pf.ve(this.c, this.m.getExpectExpressHeight());
        if (this.f2598a <= 0) {
            this.f2598a = pf.uj(this.c);
        }
        if (this.sp <= 0) {
            this.sp = Float.valueOf(this.f2598a / rhVarUj.ve).intValue();
        }
        if (this.f2598a > 0 && this.f2598a > pf.uj(this.c)) {
            float fUj = pf.uj(this.c) / this.f2598a;
            this.f2598a = pf.uj(this.c);
            this.sp = Float.valueOf(this.sp * fUj).intValue();
        }
        ViewGroup.LayoutParams layoutParams = getLayoutParams();
        if (layoutParams == null) {
            layoutParams = new ViewGroup.LayoutParams(this.f2598a, this.sp);
        }
        layoutParams.width = this.f2598a;
    ...
    private void sp() {
        ...
        View viewC = c(this.m);
        if (viewC != null) {
            int i = (this.f2598a * AppTypeIdUtil.NewDevice4GBathOTA) / MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_RENDER_MS_GAPS;
    ...
    private void i() {
        ...
        if (viewC != null) {
            frameLayout.removeAllViews();
            frameLayout.addView(viewC, new ViewGroup.LayoutParams(this.f2598a, (this.f2598a * 9) / 16));
        }
        c(this, false);
        c(textView, true);
    }
