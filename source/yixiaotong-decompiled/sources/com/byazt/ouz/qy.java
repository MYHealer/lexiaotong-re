...
public class qy {
    ...
    public List<com.byazt.xj.ve<View>> f2605a;
    public double c;
    ...
    public qy(ic icVar, JSONObject jSONObject, NativeExpressView nativeExpressView) {
        ...
        if (jSONObject != null) {
            ...
            this.tt = jSONObject.optInt(HiAnalyticsConstant.HaKey.BI_KEY_DIRECTION, 30);
    ...
    public boolean c() {
        View viewI;
        List<com.byazt.xj.ve<View>> list = this.f2605a;
        if (list == null || list.size() == 0) {
            return false;
        }
        for (com.byazt.xj.ve<View> veVar : this.f2605a) {
