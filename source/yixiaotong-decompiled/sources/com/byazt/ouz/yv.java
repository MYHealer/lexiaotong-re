...
@com.byazt.zqa.c(c = {0, 1, 27, ai.y})
public class yv extends com.byazt.ol.c implements yp, z {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Map<String, com.byazt.pop.ve> f2607a;
    ...
    public yv(Context context, com.byazt.xl.u uVar, ThemeStatusBroadcastReceiver themeStatusBroadcastReceiver, com.byazt.rbg.c cVar, ic icVar, com.byazt.xl.i iVar, m mVar) {
        ...
        this.f2607a = Collections.synchronizedMap(new HashMap());
        this.yp = 8;
        this.z = true;
        this.m = true;
        this.qy = -1L;
    ...
    public static String c(ic icVar) {
        return com.byazt.six.tt.tt(pu.x(icVar) ? b.u : null);
    }
    ...
    public void u() {
        ...
        this.ve.setDownloadListener(new DownloadListener() { // from class: com.byazt.ouz.yv.1
            ...
            public void onDownloadStart(String str, String str2, String str3, String str4, long j) {
                if (yv.this.f2607a.containsKey(str)) {
                    com.byazt.pop.ve veVar = (com.byazt.pop.ve) yv.this.f2607a.get(str);
                    if (veVar != null) {
