...
@com.byazt.zqa.c(c = {0, 1, 1606, 13})
public class tt implements Function<SparseArray<Object>, Object> {
    public final TTAdNative.FeedAdListener c;

    public tt(TTAdNative.FeedAdListener feedAdListener) {
    ...
    public Object apply(SparseArray<Object> sparseArray) {
        ...
        switch (valueSetTt.intValue(-99999987)) {
            ...
            case 164102:
                ...
                while (it.hasNext()) {
                    arrayList2.add(new i((Function) it.next()));
                }
                this.c.onFeedAdLoad(arrayList2);
                return null;
            default:
                return null;
        }
