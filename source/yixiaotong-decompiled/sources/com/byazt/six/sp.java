...
@com.byazt.zqa.c(c = {0, 1, 502, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp {
    ...
    private void c(String str, String str2, String str3) {
        ...
        String strOptString = jSONObjectVe.optString("md5");
    ...
    private void c(String str, String str2, String str3, c cVar) {
        ...
        if (jSONObjectC != null) {
            String strOptString = jSONObjectC.optString("md5");
