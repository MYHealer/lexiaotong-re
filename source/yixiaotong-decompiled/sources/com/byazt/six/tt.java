...
public class tt {
    ...
    private static boolean c(String str, String str2) {
        ...
        for (com.byazt.ku.c.C0205c c0205c : cVar.getResources()) {
            if (c0205c != null && TextUtils.equals(str, c0205c.c())) {
                return true;
            }
        }
        return false;
    ...
    private static boolean ve(String str) {
        com.byazt.ku.c cVarUj;
        List<com.byazt.ku.c.C0205c> resources;
        if (!n() || (cVarUj = uj()) == null || (resources = cVarUj.getResources()) == null) {
            return false;
        }
        for (com.byazt.ku.c.C0205c c0205c : resources) {
            if (c0205c != null && TextUtils.equals(str, c0205c.c())) {
                return true;
            }
        }
    ...
    private static File uj(String str) {
        ...
        for (com.byazt.ku.c.C0205c c0205c : uj().getResources()) {
            if (c0205c.c() != null && c0205c.c().equals(str)) {
                File file = new File(n.sp(), com.byazt.nr.a.tt(c0205c.c()));
                String strC = com.byazt.nr.a.c(file);
                if (c0205c.tt() == null || !c0205c.tt().equals(strC)) {
                    return null;
                }
                return file;
            }
    ...
    private static File tt(String str, String str2) {
        ...
        for (com.byazt.ku.c.C0205c c0205c : cVar.getResources()) {
            if (c0205c.c() != null && c0205c.c().equals(str2)) {
                File file = new File(n.sp(), com.byazt.nr.a.tt(c0205c.c()));
                String strC = com.byazt.nr.a.c(file);
                if (c0205c.tt() == null || !c0205c.tt().equals(strC)) {
                    return null;
