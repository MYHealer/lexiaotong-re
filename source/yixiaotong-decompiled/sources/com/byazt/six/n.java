...
public class n extends ve {
    ...
    public AtomicBoolean f2706a = new AtomicBoolean(false);
    ...
    public void c(boolean z) {
        List<com.byazt.ku.c.C0205c> listC;
        boolean z2;
        if (this.ve.get()) {
            return;
        }
        try {
            ...
            if (cVarVe != null && cVarVe.a()) {
                ...
                if (!zC) {
                    List<com.byazt.ku.c.C0205c> listTt = tt(cVarVe, cVarTt);
    ...
    public static File sp() {
        if (c == null) {
            try {
                File file = new File(new File(uj.c(), "tt_tmpl_pkg"), "template");
                file.mkdirs();
                c = file;
            } catch (Throwable th) {
