...
public abstract class ve {
    ...
    public boolean c(List<com.byazt.ku.c.C0205c> list) {
        if (list == null || list.size() <= 0 || c() == null) {
            return false;
        }
        for (com.byazt.ku.c.C0205c c0205c : list) {
            String strTt = com.byazt.nr.a.tt(c0205c.c());
            if (TextUtils.isEmpty(strTt)) {
                return false;
            }
            File file = new File(c(), strTt);
            String strC = com.byazt.nr.a.c(file);
            if (!file.exists() || !file.isFile() || c0205c.tt() == null || !c0205c.tt().equals(strC)) {
                return false;
            }
        }
        return true;
    ...
    public List<com.byazt.ku.c.C0205c> c(com.byazt.ku.c cVar, com.byazt.ku.c cVar2) {
        ...
        if (mapC.size() == 0) {
            ...
            for (String str : mapC.keySet()) {
                ...
                if (cVar6 == null && cVar5 != null) {
                    ...
                    for (com.byazt.ku.c.C0205c c0205c : cVar5.getResources()) {
                        if (c0205c != null && !cVar6.getResources().contains(c0205c) && c0205c.tt() != null && c0205c.c() != null) {
                            arrayList2.add(c0205c);
                        }
                    }
                    for (com.byazt.ku.c.C0205c c0205c2 : cVar6.getResources()) {
                        if (c0205c2 != null && !cVar5.getResources().contains(c0205c2)) {
                            arrayList.add(c0205c2);
                        }
                    }
                }
            }
    ...
    private boolean c(List<com.byazt.ku.c.C0205c> list, List<com.byazt.ku.c.C0205c> list2) {
        for (com.byazt.ku.c.C0205c c0205c : list) {
            String strC = c0205c.c();
    ...
    public List<com.byazt.ku.c.C0205c> tt(com.byazt.ku.c cVar, com.byazt.ku.c cVar2) {
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList();
        ArrayList arrayList3 = new ArrayList();
        if (cVar2 == null || cVar2.getResources().isEmpty()) {
            ...
            for (com.byazt.ku.c.C0205c c0205c : cVar.getResources()) {
                if (!cVar2.getResources().contains(c0205c) && c0205c != null && c0205c.c() != null && c0205c.tt() != null) {
                    arrayList2.add(c0205c);
                }
            }
            for (com.byazt.ku.c.C0205c c0205c2 : cVar2.getResources()) {
                if (!cVar.getResources().contains(c0205c2)) {
                    arrayList.add(c0205c2);
                }
            }
        }
    ...
    public void tt(List<com.byazt.ku.c.C0205c> list) {
        if (list == null || list.isEmpty()) {
            return;
        }
        Iterator<com.byazt.ku.c.C0205c> it = list.iterator();
        while (it.hasNext()) {
    ...
    public void ve(List<com.byazt.ku.c.C0205c> list) {
        if (list == null || list.isEmpty()) {
            return;
        }
        Iterator<com.byazt.ku.c.C0205c> it = list.iterator();
    ...
    public static void tt(File file, com.byazt.ku.c cVar, String str) {
        ...
        if (cVar.getResources() != null) {
            Iterator<com.byazt.ku.c.C0205c> it = cVar.getResources().iterator();
            while (it.hasNext()) {
                try {
