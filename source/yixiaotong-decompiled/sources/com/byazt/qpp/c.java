...
@com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_TIMESCALE_ENABLE, 20})
public class c {
    public volatile int c = -1;
    public volatile SharedPreferences tt = com.byazt.nys.tt.tt(gt.getContext(), "sp_ad_common_config", 0);

    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_TIMESCALE_ENABLE, MediaPlayer.MEDIA_PLAYER_OPTION_ABR_AVERAGE_PLAY_SPEED})
    ...
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_TIMESCALE_ENABLE, 44})
    public static class C0259c {
        public Map<String, Object> c = new HashMap();

        public C0259c c(int i) {
            if (c.c().c == i) {
                return this;
            }
            c.c().c = i;
