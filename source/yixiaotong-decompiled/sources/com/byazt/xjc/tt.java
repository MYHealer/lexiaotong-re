...
public class tt implements c {
    ...
    public int sp;
    public TextView t;
    public final c.InterfaceC0324c tt;
    public TextView u;
    public ve ve;
    public int x;
    public int yp;
    ...
    public tt(c.InterfaceC0324c interfaceC0324c) {
        this.tt = interfaceC0324c;
    }
    ...
    public boolean c(int i) {
        if (this.tt.i()) {
            return kp.md(this.tt.ve()) == a.n || (kp.md(this.tt.ve()) == a.f2226a && !this.tt.x());
        }
        return false;
    }
