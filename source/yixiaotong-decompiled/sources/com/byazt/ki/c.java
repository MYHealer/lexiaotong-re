...
public class c {
    ...
    public static String tt(Uri uri) {
        ...
        return tt.c(uri.getQueryParameter("id"), uri.getQueryParameter("packagename"), uri.getQueryParameter(OapsKey.KEY_PKG), uri.getQueryParameter("package_name"), uri.getQueryParameter("appId"));
    }
    ...
    public static Uri c(Context context, String str) {
        ...
        if (!TextUtils.isEmpty(string) && t.i().optInt("enable_persit_market_scheme_opt", 1) == 1) {
            return builder.scheme("prizeappcenter").authority(BaseConstants.MARKET_URI_AUTHORITY_DETAIL).appendQueryParameter(OapsKey.KEY_PKG, str).build();
        }
