...
public interface c extends IInterface {
    ...
    public static abstract class AbstractBinderC0194c extends Binder implements c {
        @Override // android.os.IInterface
        public IBinder asBinder() {
            return this;
        }

        public AbstractBinderC0194c() {
        ...
        private static class C0195c implements c {
            public static c c;
            public IBinder tt;
            ...
            public void c(int i, long j, boolean z, float f, double d, String str) throws Throwable {
                ...
                try {
                    ...
                    try {
                        if (!this.tt.transact(1, parcelObtain, parcelObtain2, 0) && AbstractBinderC0194c.tt() != null) {
                            AbstractBinderC0194c.tt().c(i, j, z, f, d, str);
                        } else {
            ...
            public void c(int i, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.tt.transact(2, parcelObtain, parcelObtain2, 0) && AbstractBinderC0194c.tt() != null) {
                        AbstractBinderC0194c.tt().c(i, bundle);
                    } else {
                        parcelObtain2.readException();
                    }
                } finally {
