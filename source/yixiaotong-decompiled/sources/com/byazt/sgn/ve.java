...
public class ve extends AlertDialog {
    ...
    private LinearLayout c(int i, LinearLayout linearLayout, LinearLayout linearLayout2, int i2) {
        ...
        this.f2701a = new TextView(this.c);
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-2, -2);
        layoutParams2.gravity = 1;
        layoutParams2.topMargin = pf.ve(this.c, 5.0f);
        this.f2701a.setLayoutParams(layoutParams2);
        this.f2701a.setEllipsize(TextUtils.TruncateAt.END);
        this.f2701a.setSingleLine(true);
        this.f2701a.setAlpha(0.5f);
        this.f2701a.setTextColor(Color.parseColor("#161823"));
        this.f2701a.setTextSize(14.0f);
        this.f2701a.setGravity(17);
        linearLayout2.addView(this.f2701a);
    ...
    private void c(int i, int i2) {
        ...
        this.rh = ttVar;
        ttVar.c(OapsKey.KEY_SRC, this.yv);
        this.rh.c("loop", ez.Code);
        this.rh.c("autoPlay", ez.Code);
        this.rh.c("width", String.valueOf(iVe2));
        this.rh.c("height", String.valueOf(iVe2));
    ...
    public void ve() {
        ...
        if (this.t != null) {
            if (TextUtils.isEmpty(this.qy)) {
                ...
                str = String.format("版本号：%1$s", this.qy);
            }
            if (i == 2) {
        ...
        if (textView6 != null) {
            ...
            if (TextUtils.isEmpty(this.zm)) {
                ...
                str2 = String.format("开发者：%1$s", this.zm);
            }
            if (i == 2) {
                str2 = str2 + "  " + str;
            }
