...
public class tt extends AlertDialog {
    ...
    private LinearLayout c(LinearLayout linearLayout, View view) {
        ...
        linearLayout2.setOrientation(1);
        linearLayout.addView(linearLayout2);
        this.f2698a = new ListView(this.c);
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-1, 0);
        layoutParams2.weight = 1.0f;
        layoutParams2.topMargin = pf.ve(this.c, 20.0f);
        int iVe = pf.ve(this.c, 16.0f);
        this.f2698a.setPadding(iVe, 0, iVe, 0);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setColor(-1);
        gradientDrawable.setShape(2);
        gradientDrawable.setStroke(pf.ve(this.c, 1.0f), Color.parseColor("#F0F0F0"));
        this.f2698a.setDivider(gradientDrawable);
        this.f2698a.setDividerHeight(pf.ve(this.c, 24.0f));
        this.f2698a.setSelector(new ColorDrawable(0));
        this.f2698a.setLayoutParams(layoutParams2);
        linearLayout2.addView(this.f2698a);
    ...
    public void ve() {
        ...
        this.f2698a.setAdapter((ListAdapter) new C0265tt(this.c, 0, this.t));
    }
    ...
    @com.byazt.zqa.c(c = {0, 1, 211, 240})
    class C0265tt extends ArrayAdapter<ve> {
        public C0265tt(Context context, int i, List<ve> list) {
