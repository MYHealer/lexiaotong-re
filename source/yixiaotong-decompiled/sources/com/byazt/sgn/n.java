...
public class n extends AlertDialog {
    ...
    private View c(int i) {
        ...
        this.f2694a.setMaxWidth(pf.ve(this.n, 46.0f));
        this.f2694a.setMinimumHeight(pf.ve(this.n, 46.0f));
        this.f2694a.setMinimumWidth(pf.ve(this.n, 46.0f));
        this.f2694a.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        com.byazt.vfu.ve veVar = new com.byazt.vfu.ve(pf.ve(this.n, 14.0f));
        veVar.c(-16777216);
        veVar.c(pf.ve(this.n, 2.0f));
        this.f2694a.setImageDrawable(veVar);
        relativeLayout.addView(this.f2694a);
    ...
    public void c() {
        ...
        this.f2694a.setOnClickListener(new View.OnClickListener() { // from class: com.byazt.sgn.n.1
