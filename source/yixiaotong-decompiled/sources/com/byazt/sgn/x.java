...
public class x extends AlertDialog {
    ...
    public x(String str, Context context, JSONObject jSONObject, JSONObject jSONObject2, com.byazt.ux.sp spVar, ic icVar) {
        ...
        this.n = str;
        this.tt = jSONObject2;
        this.f2702a = new com.byazt.xs.c(context, icVar);
    }
    ...
    public void c(sp.c cVar) {
        this.uj = cVar;
        com.byazt.xs.c cVar2 = this.f2702a;
        if (cVar2 != null) {
            cVar2.c(cVar);
        }
    }
    ...
    private void tt() {
        if (this.c == null || this.tt == null || this.f2702a == null) {
            return;
        }
        this.x = false;
        final FrameLayout frameLayout = new FrameLayout(this.ve);
        this.f2702a.c(this.c, this.tt, new com.byazt.ux.sp() { // from class: com.byazt.sgn.x.1
