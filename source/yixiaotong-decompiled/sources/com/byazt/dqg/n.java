...
public class n {
    ...
    public void c(com.byazt.ouz.a aVar, com.byazt.ouz.n nVar) {
        ic icVar;
        if (this.i == null || (icVar = this.f2107a) == null) {
            return;
        }
        ...
        com.byazt.ddx.uj.c(this.f2107a);
        EmptyView emptyViewC = c((ViewGroup) this.i);
        if (emptyViewC == null) {
            ic icVar2 = this.f2107a;
            EmptyView emptyView = new EmptyView(this.n, this.i, icVar2 != null ? icVar2.m760if() : 1000);
            emptyView.c(this.f2107a, this.sp);
