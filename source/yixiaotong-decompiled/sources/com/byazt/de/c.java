...
public class c {
    ...
    private boolean c(Activity activity, DownloadInfo downloadInfo, boolean z, InterfaceC0131c interfaceC0131c) {
        long jLastModified;
            ...
            try {
                ...
                if (activity != null && !activity.isFinishing()) {
                    ...
                    if (downloadInfo == null && this.ve.isEmpty()) {
                        c(activity, new com.byazt.nn.c(downloadInfo.getId(), 0L, 0L, downloadInfo.getPackageName(), downloadInfo.getTitle(), null, downloadInfo.getTargetFilePath()), z, interfaceC0131c);
                        return true;
                    }
                    if (downloadInfo != null) {
                    ...
                    while (listIterator.hasPrevious()) {
                        ...
                        if (cVarPrevious == null && !u.n(t.getContext(), cVarPrevious.uj) && u.c(cVarPrevious.sp)) {
                            if (new File(cVarPrevious.sp).lastModified() >= jLastModified) {
                                c(activity, cVarPrevious, z, interfaceC0131c);
                            } else {
                                c(activity, new com.byazt.nn.c(downloadInfo.getId(), 0L, 0L, downloadInfo.getPackageName(), downloadInfo.getTitle(), null, downloadInfo.getTargetFilePath()), z, interfaceC0131c);
                            }
    ...
    public boolean c(Activity activity, boolean z, InterfaceC0131c interfaceC0131c) {
        if (t.i().optInt("disable_install_app_dialog") == 1 || this.uj) {
            return false;
        }
        return c(activity, c(activity), z, interfaceC0131c);
    }

    public void c(Context context, com.byazt.nn.c cVar, boolean z, InterfaceC0131c interfaceC0131c) {
        this.ve.clear();
        c(context, cVar, interfaceC0131c, z);
        this.uj = true;
        da.c(context).ve();
        this.f2077a.tt("sp_ad_install_back_dialog", "key_uninstalled_list");
    ...
    public void c(long j, long j2, long j3, String str, String str2, String str3, String str4) {
        for (int i = 0; i < this.ve.size(); i++) {
            ...
            if (cVar != null && cVar.tt == j2) {
                ...
                this.f2077a.c("sp_ad_install_back_dialog", "key_uninstalled_list", this.ve);
                return;
            }
        }
    ...
    private void c(final Context context, final com.byazt.nn.c cVar, final InterfaceC0131c interfaceC0131c, boolean z) {
        ...
        uVarVe.tt(cVarC.tt(String.format("%1$s下载完成，是否立即安装？", objArr)).ve("立即安装").uj(z ? "暂不安装" : String.format("退出%1$s", context.getResources().getString(StubApp.getOrigApplicationContext(context.getApplicationContext()).getApplicationInfo().labelRes))).c(false).c(u.c(context, cVar.sp)).c(new com.byazt.e.tt.InterfaceC0141tt() { // from class: com.byazt.de.c.1
            @Override // com.byazt.e.tt.InterfaceC0141tt
            ...
            public void tt(DialogInterface dialogInterface) {
                ...
                InterfaceC0131c interfaceC0131c2 = interfaceC0131c;
