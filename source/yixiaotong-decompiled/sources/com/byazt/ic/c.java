...
public class c {
    ...
    private static com.byazt.cph.c.C0125c sl(ic icVar) {
        int[] iArrN = xd.n(icVar);
        rh rhVarIc = icVar.ic();
        String strVe = rhVarIc != null ? rhVarIc.ve() : null;
        com.byazt.cph.c.C0125c c0125c = new com.byazt.cph.c.C0125c();
        if (TextUtils.isEmpty(strVe)) {
            strVe = "";
        }
        com.byazt.cph.c.C0125c c0125cTt = c0125c.c(strVe).c((iArrN == null || iArrN.length < 2) ? MediaDiscoverer.Event.Started : iArrN[0]).tt((iArrN == null || iArrN.length < 2) ? 720 : iArrN[1]);
        if (tt(icVar)) {
            com.byazt.jzl.c cVarNu = xd.nu(icVar);
            c0125cTt.ve(t(icVar)).tt(cVarNu != null ? cVarNu.n() : "").c(((long) xd.sp(icVar)) * 1000);
        }
        if (uj(icVar)) {
            c0125cTt.ve(t(icVar));
        }
    ...
    public static com.byazt.cph.c i(ic icVar) {
        if (!uj(icVar) && !c(icVar)) {
            return new com.byazt.cph.c.C0125c().ve(t(icVar)).c();
        }
        com.byazt.cph.c.C0125c c0125cSl = sl(icVar);
        JSONObject jSONObjectYg = icVar.yg();
        if (jSONObjectYg != null) {
            try {
                jSONObjectYg.put(am.x, "android");
            } catch (JSONException unused) {
            }
        }
        c0125cSl.c(jSONObjectYg);
        return c0125cSl.c();
    }
    ...
    public static void c(boolean z, i.c cVar) {
        ...
        if (cVar == null || (jSONObjectN = cVar.n()) == null || !TextUtils.equals("${image[0].url}", jSONObjectN.optString(OapsKey.KEY_SRC))) {
            return;
        }
        try {
            if (z) {
                ...
                jSONObjectN.put("name", "UpieImage");
            }
        } catch (JSONException e) {
            m.c(e);
        }
