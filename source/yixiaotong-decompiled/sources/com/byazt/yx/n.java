...
public final class n {
    ...
    public static long c(rh rhVar) {
        return c(rhVar.c("Content-Length"));
    }
    ...
    public static boolean ve(h hVar) {
        if (hVar.c().tt().equals("HEAD")) {
            return false;
        }
        int iVe = hVar.ve();
        return (((iVe >= 100 && iVe < 200) || iVe == 204 || iVe == 304) && c(hVar) == -1 && !HTTP.CHUNK_CODING.equalsIgnoreCase(hVar.c("Transfer-Encoding"))) ? false : true;
    }
