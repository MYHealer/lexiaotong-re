...
public abstract class c implements com.byazt.hl.c {
    ...
    public boolean c() {
        return (this.c == null || tt() == null || this.ve == null || this.da == null || TextUtils.isEmpty(this.f1996a) || TextUtils.isEmpty(this.uj) || this.n == null) ? false : true;
    }
    ...
    private void a(Map<String, Object> map) {
        ...
        c(this.yp, iUj);
        if (this.ve == null || TextUtils.isEmpty(this.f1996a) || !sp(map)) {
            return;
        }
        this.n.c(tt(iUj), this.c);
        zb<String, Object> zbVarC = new zb().c("downloadUrl", this.f1996a);
    ...
    private boolean c(Map<String, Object> map, final String str, final boolean z) {
        Object objApply = this.da.apply(com.byazt.yxi.uj.c().c(6).c(Boolean.class).c(0, new zb().c("hashCode", Integer.valueOf(uj(map))).c("downloadUrl", this.f1996a)).tt());
    ...
    public boolean c(com.byazt.ete.uj ujVar, final com.byazt.wrq.c cVar, final Map<String, Object> map) {
        ...
        this.n.c(ujVar, this.uj, this.f1996a, new com.byazt.av.tt() { // from class: com.byazt.bb.c.2
    ...
    public void ve(final Map<String, Object> map) {
        ...
        if (i == 1) {
            ...
            com.byazt.bwm.n.tt(new com.byazt.bwm.sp("tt_download_check") { // from class: com.byazt.bb.c.4
                @Override // java.lang.Runnable
                public void run() {
                    com.byazt.ete.uj ujVarC = com.byazt.omf.gt.c().c(c.this.tt(), c.this.f1996a);
