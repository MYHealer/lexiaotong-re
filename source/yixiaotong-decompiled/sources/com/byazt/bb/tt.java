...
public class tt implements com.byazt.hl.c {
    ...
    public Map<String, Object> f1997a;
    public i c;
    ...
    public boolean c(final Map<String, Object> map) {
        yp ypVarMy;
        if (this.c.n() == 9 && Objects.equals(this.f1997a.get("saas_status_while_click"), 2)) {
        ...
        if (da.n(com.byazt.ppf.ve.c(this.c, this.f1997a))) {
            com.byazt.hl.c cVar2 = this.uj;
            return cVar2 != null && cVar2.c(map);
        }
        if (da.uj(com.byazt.ppf.ve.c(this.c, this.f1997a))) {
            com.byazt.hl.c cVar3 = this.uj;
            return cVar3 != null && cVar3.c(map);
        }
        new com.byazt.wdw.ve(this.c, ypVarMy, this.tt, this.f1997a).c(this.ve).c(new com.byazt.wdw.ve.c() { // from class: com.byazt.bb.tt.1
            @Override // com.byazt.wdw.ve.c
            public void c() {
                if (tt.this.uj.c(map)) {
                    return;
                }
                tt.this.n.c(tt.this.f1997a, (com.byazt.qb.c) null);
            }
        });
        return true;
    }
