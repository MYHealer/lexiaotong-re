...
@com.byazt.zqa.c(c = {0, 1, 269, 1711})
public class FlowLightView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        while (it.hasNext()) {
            c next = it.next();
            this.u = new LinearGradient(next.tt, 0.0f, next.tt + this.sp, this.f2583a, this.x, (float[]) null, Shader.TileMode.CLAMP);
            this.da.setColor(-1);
    ...
    @com.byazt.zqa.c(c = {0, 1, 269, 2286})
