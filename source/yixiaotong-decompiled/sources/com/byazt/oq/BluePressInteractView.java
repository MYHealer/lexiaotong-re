...
@com.byazt.zqa.c(c = {0, 1, 269, 2347})
public class BluePressInteractView extends FrameLayout {
    ...
    private void uj() {
        ...
        ObjectAnimator objectAnimatorOfFloat5 = ObjectAnimator.ofFloat(this.f2575a, "scaleX", 1.0f, 1.5f, 1.0f);
        ObjectAnimator objectAnimatorOfFloat6 = ObjectAnimator.ofFloat(this.f2575a, "scaleY", 1.0f, 1.5f, 1.0f);
        ObjectAnimator objectAnimatorOfFloat7 = ObjectAnimator.ofFloat(this.sp, Key.ROTATION, 0.0f, -20.0f, 0.0f);
