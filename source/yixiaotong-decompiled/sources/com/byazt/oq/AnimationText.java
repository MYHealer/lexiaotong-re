...
@com.byazt.zqa.c(c = {0, 1, 269, 2084})
public class AnimationText extends TextSwitcher implements ViewSwitcher.ViewFactory, WeakHandler.IHandler {
    ...
    public AnimationText(Context context, int i, float f, int i2, int i3) {
        ...
        this.c = new Animation.AnimationListener() { // from class: com.byazt.oq.AnimationText.1
            ...
            public void onAnimationEnd(Animation animation) {
                if (AnimationText.this.f2574a != null) {
                    AnimationText.this.f2574a.setText("");
                }
            }
        };
        this.n = context;
    ...
    public View makeView() {
        ...
        this.f2574a.setTextSize(this.i);
        this.f2574a.setMaxLines(this.da);
        this.f2574a.setTextAlignment(this.u);
        return this.f2574a;
    }
