...
@com.byazt.zqa.c(c = {0, 1, 269, 870})
public class SlideUpView extends RelativeLayout {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public AnimatorSet f2593a;
    public ImageView c;
    public String da;
    ...
    public void c() {
        ve();
        this.f2593a.start();
        this.f2593a.addListener(new AnimatorListenerAdapter() { // from class: com.byazt.oq.SlideUpView.1
    ...
    public void ve() {
        ...
        this.f2593a.playSequentially(this.x, this.i, this.sp);
    }

    public void tt() {
        try {
            AnimatorSet animatorSet = this.f2593a;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
