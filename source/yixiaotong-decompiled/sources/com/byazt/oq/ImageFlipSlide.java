...
@com.byazt.zqa.c(c = {0, 1, 269, 1207})
public class ImageFlipSlide extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.x) {
            this.f2586a.left = (int) (bitmap.getWidth() * (1.0f - this.tt));
            this.f2586a.right = this.ve.getWidth();
            this.f2586a.top = 0;
            this.f2586a.bottom = this.ve.getHeight();
            this.sp.left = (int) (getWidth() * (1.0f - this.tt));
            this.sp.right = getWidth();
            this.sp.top = 0;
            this.sp.bottom = getHeight();
            canvas.drawBitmap(this.ve, this.f2586a, this.sp, this.c);
            return;
        }
