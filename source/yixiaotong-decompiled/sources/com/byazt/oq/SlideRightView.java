...
public class SlideRightView extends FrameLayout {
    ...
    private void uj() {
        ...
        this.f2592a.playSequentially(this.x, this.i, this.sp);
    }

    public void c() {
        uj();
        this.f2592a.start();
        this.f2592a.addListener(new AnimatorListenerAdapter() { // from class: com.byazt.oq.SlideRightView.3
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                SlideRightView.this.postDelayed(new Runnable() { // from class: com.byazt.oq.SlideRightView.3.1
                    @Override // java.lang.Runnable
                    public void run() {
                        SlideRightView.this.f2592a.start();
                    }
                }, 200L);
            }
        });
    ...
    public void tt() {
        try {
            AnimatorSet animatorSet = this.f2592a;
            if (animatorSet != null) {
                animatorSet.cancel();
            }
