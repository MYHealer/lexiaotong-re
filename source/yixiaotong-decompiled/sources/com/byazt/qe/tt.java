...
public class tt implements qp.c {
    ...
    public final AtomicBoolean f2652a = new AtomicBoolean(false);
    ...
    private tt(com.byazt.qe.c cVar) {
        ...
        if (com.byazt.bp.c.t().yp()) {
            try {
                context.registerReceiver(new C0256tt(), new IntentFilter("com.bytedance.msdk.core.setting.SettingsReceiver"), ve.c, null);
            } catch (Throwable th) {
                m.c(th);
            }
        }
                ...
                public void c(com.byazt.va.uj ujVar, final com.byazt.hm.tt ttVar) {
                    ...
                    n.c(new Runnable() { // from class: com.byazt.qe.tt.3.1
                        ...
                        public void run() {
                            ...
                            if (ttVar != null) {
                                ...
                                if (eo.c(ttVar)) {
                                    ...
                                    if (!TextUtils.isEmpty(strC)) {
                                        try {
                                            tt.this.c(iArr2, iArr, ttVar, new JSONObject(strC), strC, iArr3, nVar, jSONObject2, i, z2, jElapsedRealtime, jSONObject);
                                            z3 = true;
                                            c2 = 0;
                                        } catch (Throwable th) {
                                            c3 = 0;
                                                ...
                                                if (iOptInt == 4) {
                                                    ...
                                                    if (TextUtils.isEmpty(strDecryptWithCBC)) {
                                                        ...
                                                        try {
                                                            ...
                                                            m.c(th2);
                                                            com.byazt.eu.tt.c("SdkSettingsHelper", ">>>>> setting data error: " + th2.toString());
                                                            jSONObject5 = jSONObject6;
                                                        }
                                                        str = strDecryptWithCBC;
                                                    }
                                                    ...
                                                    if (iOptInt != 2) {
                                                        z4 = true;
                                                        if (iOptInt == 1) {
                                                            String strTt = com.byazt.vx.c.tt(jSONObject6.optString(CrashHianalyticsData.MESSAGE), com.byazt.vx.tt.c());
                                                            if (TextUtils.isEmpty(strTt)) {
                                                                ...
                                                                try {
                                                                    ...
                                                                    com.byazt.eu.tt.c("SdkSettingsHelper", "setting data error: ", th3);
                                                                    jSONObject5 = jSONObject6;
                                                                }
                                                                str = strTt;
                                                            }
                                                        } else if (iOptInt == 0) {
                                                            String strOptString2 = jSONObject6.optString(CrashHianalyticsData.MESSAGE);
                                                            str = strOptString2;
                                                        ...
                                                        z3 = true;
                                                        c2 = 0;
                                                        tt.this.c(iArr2, iArr, ttVar, jSONObject5, str, iArr3, nVar, jSONObject2, i, z2, jElapsedRealtime, jSONObject);
                                                    } else {
                                                        String strC2 = eo.c(jSONObject6.optString(CrashHianalyticsData.MESSAGE));
                                                        if (TextUtils.isEmpty(strC2)) {
                                                            ...
                                                            try {
                                                                ...
                                                                com.byazt.eu.tt.c("SdkSettingsHelper", ">>>>> setting data error: " + th4.toString());
                                                                jSONObject5 = jSONObject6;
                                                            }
                                                            str = strC2;
                                                        }
                                                    ...
                                                    iArr2[c2] = 81006;
                                                    tt.this.c(nVar, i, iArr2[c2], th.getMessage(), z2, jSONObject);
                                                }
                                                tt.this.c(iArr2, iArr, ttVar, jSONObject5, str, iArr3, nVar, jSONObject2, i, z2, jElapsedRealtime, jSONObject);
                                            } catch (Throwable th5) {
                                                th = th5;
                            ...
                            com.byazt.sx.uj.c(iArr[c2], iArr2[c2], SystemClock.elapsedRealtime() - jElapsedRealtime, z, i == 0 ? z3 : c2, jSONObject3, iArr3[c2], jSONObject2);
                        }
                    });
                }
                    ...
                    try {
                        if (eo.c(ttVar)) {
                            ...
                            if (jSONObject3.optInt("cypher", -1) == 4) {
                                String strOptString = jSONObject3.optString(CrashHianalyticsData.MESSAGE);
                                com.byazt.dna.n nVarA = eo.a();
                                String strDecryptWithCBC = nVarA != null ? nVarA.decryptWithCBC(strOptString) : null;
                                if (TextUtils.isEmpty(strDecryptWithCBC)) {
                                    jSONObject2 = null;
                        ...
                        if (iOptInt == 20000) {
                            ...
                            a.c(jCurrentTimeMillis2, false, jSONObject2.optString(CrashHianalyticsData.MESSAGE), iOptInt);
                        }
    ...
    private JSONObject tt(JSONObject jSONObject) {
        ...
        try {
            ...
            jSONObject2.put("package_name", eo.c());
            jSONObject2.put("app_version", eo.ve());
            ...
            jSONObject3.put(am.x, uVar.getOs());
            ...
            jSONObject3.put(am.J, uVar.getDeviceName());
            jSONObject3.put("pb", "");
            jSONObject3.put("boot", uVar.getBoot());
            jSONObject3.put("country_code", com.byazt.bp.tt.tt().t());
            jSONObject3.put("total_mem", nb.t());
            jSONObject3.put(am.ai, uVar.getDeviceModel());
            jSONObject3.put("language", uVar.getLanguage());
            jSONObject3.put("android_os_version_int", Build.VERSION.SDK_INT);
            jSONObject2.put(e.n, jSONObject3);
            JSONObject jSONObject4 = new JSONObject();
            jSONObject4.put(com.baidu.mobads.sdk.internal.d.f1799a, com.byazt.bp.c.t().ve());
            ...
            if (!com.byazt.bp.c.t().sp()) {
                jSONObject2.put(FileDownloadModel.ETAG, com.byazt.bp.tt.tt().yp());
            }
    ...
    private JSONObject tt(PluginValueSet pluginValueSet) {
        ...
        try {
            ...
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put(am.x, ((u) uj.getService("device_info_new")).getOs());
    ...
    public static JSONObject c(com.byazt.yf.a aVar) {
        ...
        jSONObject.put(PtgRewardConstant.REWARD_PARAMS.USER_ID, strTt);
        jSONObject.put("channel", aVar != null ? aVar.ve() : "");
        jSONObject.put(o0OO000o.o00O0, aVar != null ? aVar.uj() : "");
    ...
    @com.byazt.zqa.c(c = {0, 1, 697, 240})
    private class C0256tt extends BroadcastReceiver {
        private C0256tt() {
        }
