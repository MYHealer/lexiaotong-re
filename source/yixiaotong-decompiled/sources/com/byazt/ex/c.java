...
public class c {
        ...
        x.tt(new Runnable() { // from class: com.byazt.ex.c.1
            ...
            public void run() {
                try {
                    ...
                    jSONObjectFilterParam.put(oOOOoo00.OooO, SystemClock.elapsedRealtime() - Process.getStartElapsedRealtime());
    ...
    public static Map<String, String> c(Context context) {
        ...
        map.put(am.M, String.valueOf(c()));
        map.put(am.Q, rh.sp(context));
        map.put("openudid", DeviceUtils.tt());
        map.put("aid", "1371");
        map.put(am.s, com.byazt.fh.c.a());
        map.put("app_version", com.byazt.fh.c.n());
        map.put("package", nb.x());
        ...
        map.put(am.H, Build.MANUFACTURER);
        ArrayList<String> arrayListC = ve.c(context, "MD5");
