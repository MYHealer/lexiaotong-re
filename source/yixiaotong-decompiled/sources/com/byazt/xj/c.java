...
public class c<E extends ViewGroup> extends ve {
    ...
    public static class C0323c {
        ...
        public String toString() {
            return "LayoutParams{mWidth=" + this.c + ", mHeight=" + this.tt + ", mMargin=" + this.n + ", mMarginLeft=" + this.f2862a + ", mMarginRight=" + this.sp + ", mMarginTop=" + this.x + ", mMarginBottom=" + this.i + ", mParams=" + this.gr + '}';
        }

        public ViewGroup.LayoutParams c() {
            ViewGroup.MarginLayoutParams marginLayoutParams = new ViewGroup.MarginLayoutParams((int) this.c, (int) this.tt);
            marginLayoutParams.leftMargin = (int) (this.gt ? this.f2862a : this.n);
