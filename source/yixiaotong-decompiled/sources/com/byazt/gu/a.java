...
public class a extends t {
    ...
    public com.byazt.gqp.tt c(yp ypVar) {
        ...
        if (ypVar.a() != null) {
            if (ve(ypVar.a())) {
                ...
                cVar.c(ypVar.ve(), new qy.c().c(qy.n).c(ypVar.a().tt(), ypVar.a().c(), p.c(rl.c("multipart/form-data"), ypVar.a().n)).c());
            } else if (tt(ypVar.a())) {
    ...
    private boolean c(z zVar) {
        return zVar != null && zVar.f2272a == z.c.FILE_TYPE && zVar.n != null && zVar.n.length > 0;
    }

    private boolean tt(z zVar) {
        return zVar != null && zVar.f2272a == z.c.BYTE_ARRAY_TYPE && zVar.n != null && zVar.n.length > 0;
    }

    private boolean ve(z zVar) {
        return (zVar == null || zVar.f2272a != z.c.STRING_TYPE || TextUtils.isEmpty(zVar.uj)) ? false : true;
    }
}
