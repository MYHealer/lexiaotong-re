...
@com.byazt.zqa.c(c = {0, 1, 1017, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp {
    ...
    public static com.byazt.t.c c(final DownloadTask downloadTask) {
        ...
        return new com.byazt.t.c.AbstractBinderC0277c() { // from class: com.byazt.w.sp.1
