...
public abstract class c extends uj implements qp.c {
    ...
    public class C0319c extends com.byazt.bwm.sp {
        public String c;
        public String n;
        public long tt;
        public String uj;
        ...
        public C0319c(String str, long j, long j2, String str2, String str3) {
            super("DownloadCallbackRunnable");
            this.c = str;
            this.tt = j;
            this.ve = j2;
    ...
    public boolean sl() {
        if (this.ve.yp() != null) {
            ...
            if (!TextUtils.isEmpty(strTt)) {
                ...
                map.put(ba.at, "AbsDMLibManager");
                map.put("scheme", nb.c(strTt));
                com.byazt.ddx.uj.c(this.ve, this.uj, map, this.u);
                if (nb.c(intent)) {
                    try {
                        nb.c(this.u, this.ve, this.uj, sp());
                        com.byazt.nr.tt.startActivity(getContext(), intent, TextUtils.equals(p.x, UMModuleRegister.INNER));
    ...
    public void c(String str, long j, long j2, String str2, String str3) {
        C0319c c0319c = this.z;
        if (c0319c == null) {
            this.z = new C0319c(str, j, j2, str2, str3);
        } else {
            c0319c.c(str);
            this.z.c(j);
            this.z.tt(j2);
    ...
    public boolean sp(boolean z) {
        ...
        if (zC) {
            ...
            this.da.sendMessageDelayed(messageObtain, C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS);
            com.byazt.omf.tt.c().put("save_jump_success_time", System.currentTimeMillis());
            com.byazt.omf.tt.c().put("save_jump_success_ad_tag", this.uj);
            com.byazt.omf.tt.c().put("save_dpl_success_materialmeta", this.ve.yg().toString());
        } else {
