...
@com.byazt.zqa.c(c = {0, 1, 65, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp extends uj {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final ic f2854a;
    ...
    public com.byazt.yzg.ve x() {
        if (this.da == null) {
            synchronized (this) {
                if (this.da == null) {
                    this.da = new com.byazt.yzg.ve(getContext(), this.f2854a);
                }
            }
        }
        return this.da;
    ...
    @Override // com.byazt.pop.ve
    public void c() {
        com.byazt.qt.ve.c(this.n, this.sp, this.f2854a, (JSONObject) null, gt());
        com.byazt.qt.ve.c(this.f2854a, gt(), nb.yv(this.f2854a));
    ...
    public void c(JSONObject jSONObject, boolean z) {
        if (this.f2854a != null) {
            com.byazt.rgb.c.c(this.f2854a.zm(), uj() ? 1 : 2);
        }
        x().c(i());
        if (nu()) {
            if (uj() || !u()) {
    ...
    public boolean u() {
        ...
        if (i != 1) {
            ...
            com.byazt.bwm.n.tt(new com.byazt.bwm.sp("tt_download_check") { // from class: com.byazt.wz.sp.1
                ...
                public void run() {
                    com.byazt.ete.uj ujVarC = gt.c().c(sp.this.f2854a, sp.this.n);
                    if (ujVarC == null || !ujVarC.sp()) {
                        x.c(gt.getContext(), sp.this.f2854a, "web_2");
                        return;
                    }
                    com.byazt.ete.a aVarC = x.c(ujVarC.x());
                    com.byazt.ete.a aVarRh = sp.this.f2854a.rh();
                    if (aVarRh == null) {
                        sp.this.f2854a.c(aVarC);
                    } else {
                        aVarRh.da(aVarC.yp());
                        aVarRh.tt(aVarC.n());
                        aVarRh.uj(aVarC.sp());
        ...
        x.c(gt.getContext(), this.f2854a, "web_1");
        return true;
    }
    ...
    private boolean m() {
        ...
        String strTt = this.f2854a.yp().tt();
    ...
    private boolean tt(com.byazt.ete.uj ujVar) {
        ...
        if (c(getContext(), this.f2854a, this.sp)) {
            return true;
        }
    ...
    private boolean nu() {
        if (this.x == null || com.byazt.ete.gt.m(this.f2854a) == 1) {
            return true;
        }
        if (gt.tt().jg()) {
    ...
    private Map<String, Object> rl() {
        long jLongValue = Double.valueOf(this.f2854a.uj()).longValue();
        if (t()) {
            return new zb().c("userAgent", null).c("isDisableDialog", Boolean.TRUE).c("downloadStatusChangeListener", null).c("action_type_button", 2).c("id", Long.valueOf(jLongValue)).c(TTDownloadField.TT_ACTIVITY, getContext()).c("open_market_in_app", Boolean.valueOf(com.byazt.ete.gt.my(this.f2854a))).c("hashCode", Integer.valueOf(gt()));
        }
        return new zb().c("downloadUrl", this.n).c("hashCode", Integer.valueOf(gt())).c("id", Long.valueOf(jLongValue)).c(TTDownloadField.TT_ACTIVITY, getContext()).c("open_market_in_app", Boolean.valueOf(com.byazt.ete.gt.my(this.f2854a))).c("action_type_button", 2);
    }
    ...
    public void tt(boolean z) {
        if (z) {
            this.sl = true;
            if (uj()) {
                com.byazt.qt.ve.c(true, com.byazt.qt.ve.c(this.f2854a, this.t), gt());
            }
        }
    }
