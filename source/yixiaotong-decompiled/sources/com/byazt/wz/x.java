...
public class x {
    ...
    public static String c(ic icVar, String str, boolean z) {
        ...
        if (TextUtils.isEmpty(str) && !z) {
            ...
            try {
                jSONObject.put(CrashHianalyticsData.MESSAGE, "download_url is null");
                if (icVar != null) {
    ...
    public static void tt(ic icVar, String str) {
        ...
        try {
            if (icVar == null) {
                jSONObject.put(CrashHianalyticsData.MESSAGE, "meta is null");
            } else {
                gt gtVarU_ = icVar.u_();
                if (gtVarU_ == null) {
                    jSONObject.put(CrashHianalyticsData.MESSAGE, "download_conf is null");
                } else {
