...
public class ve extends n implements Handler.Callback {
    ...
    public void c(int i, String str) {
        try {
            ...
            com.byazt.ml.ve.tt("_flush", "notify runOnce check: " + zC + PPSLabelView.Code + str, this.tt);
            if (zC) {
                Message messageObtain = Message.obtain();
        ...
        if (zUj && !zC && z4) {
            if (i == 3) {
                ...
                if (i == 74 || i == 1) {
                    ...
                    this.n.c(3, C.DEFAULT_SEEK_FORWARD_INCREMENT_MS, this.sl);
                    return;
                }
    ...
    private void i() {
        synchronized (this.uj) {
            try {
                try {
                    if (this.f2461a == 0 && com.byazt.ml.c.c(this.tt)) {
                        int iTt = this.c.tt() + this.c.c();
                        int iTt2 = this.tt.x().tt();
                        if (iTt != 0 && iTt2 != 0) {
                            this.f2461a = (iTt / iTt2) + 4;
                        }
                    }
