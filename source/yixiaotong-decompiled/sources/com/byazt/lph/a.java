...
public class a {
    ...
    public final com.byazt.mv.tt f2460a;
        ...
        synchronized (obj) {
            try {
                ...
                if (i == -2) {
                    ...
                    this.f2460a.c(1);
                    if (!handlerTt.hasMessages(3) && System.currentTimeMillis() - this.uj >= C.DEFAULT_SEEK_FORWARD_INCREMENT_MS) {
                        this.uj = System.currentTimeMillis();
                        c(3, C.DEFAULT_SEEK_FORWARD_INCREMENT_MS, handlerTt);
                    }
                }
                if (i2 == 72) {
                    obj.notify();
