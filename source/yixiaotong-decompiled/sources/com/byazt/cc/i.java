...
public class i {
    ...
    public com.byazt.pop.ve f2032a;
    public Context c;
    ...
    public void c(String str, int i, com.byazt.cc.c cVar, com.byazt.ocd.ve veVar) {
        ...
        ((com.byazt.nat.c) cVar2.c(com.byazt.nat.c.class)).c(this.f2032a);
        com.byazt.nat.c.InterfaceC0217c interfaceC0217c = new com.byazt.nat.c.InterfaceC0217c() { // from class: com.byazt.cc.i.1
        ...
        ((com.byazt.nat.c) cVar2.c(com.byazt.nat.c.class)).c(interfaceC0217c);
        ic icVar = this.tt;
        if (icVar != null) {
    ...
    private void c(String str, final ViewGroup viewGroup, com.byazt.ocd.ve veVar) {
        ...
        this.f2032a = c(icVar, str);
        EmptyView emptyView = new EmptyView(this.c, viewGroup, this.tt.m760if());
        ...
        emptyView.setCallback(new EmptyView.c() { // from class: com.byazt.cc.i.2
            ...
            public void c() {
                ...
                Context context;
                if (i.this.f2032a != null) {
                    i.this.f2032a.c();
                }
                if (i.this.f2032a == null || (viewGroup2 = viewGroup) == null || viewGroup2.getParent() == null) {
                    return;
                }
                try {
                ...
                i.this.f2032a.c((Activity) context, false);
            }
    ...
    private void c(final com.byazt.ocd.ve veVar) {
        com.byazt.pop.ve veVar2 = this.f2032a;
        if (veVar2 == null) {
            return;
        }
        ...
        this.i.postDelayed(new Runnable() { // from class: com.byazt.cc.i.4
            ...
            public void run() {
                if (com.byazt.yzg.a.c) {
                    ...
                    if (i.this.f2032a instanceof com.byazt.wz.c) {
                        ((com.byazt.wz.c) i.this.f2032a).x().c(new com.byazt.av.c() { // from class: com.byazt.cc.i.4.1
