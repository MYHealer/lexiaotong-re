...
@com.byazt.zqa.c(c = {0, 1, 448, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp {
    ...
    public static void c(Context context, y yVar, ic icVar, boolean z, long j) {
        ...
        try {
            ...
            if (z) {
                jSONObject.put("splash_final_type", DeviceUtils.SP_NAME);
            } else {
    ...
    public static void tt(ic icVar, com.byazt.im.uj ujVar) {
        ...
        try {
            ...
            jSONObject.put("final_t", ujVar.x() ? DeviceUtils.SP_NAME : "real_time_ad");
