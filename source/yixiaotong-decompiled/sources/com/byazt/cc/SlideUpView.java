...
public class SlideUpView extends RelativeLayout {
    ...
    public void c() {
        ...
        this.f2025a.setDuration(50L);
        this.x.setDuration(1500L);
        this.sp.setDuration(50L);
        this.f2025a.playTogether(objectAnimatorOfFloat2, objectAnimatorOfFloat7, objectAnimatorOfFloat5);
        ...
        this.n.playSequentially(this.sp, this.x, this.f2025a);
    }
    ...
    public void tt() {
        ...
        AnimatorSet animatorSet3 = this.f2025a;
