...
public class SplashClickBarArrow extends FrameLayout {
    ...
    private View c(Context context) {
        ...
        this.f2027a = frameLayout2;
        frameLayout2.setId(2114387587);
        FrameLayout.LayoutParams layoutParams6 = new FrameLayout.LayoutParams(-1, -1);
        this.f2027a.setClipChildren(false);
        this.f2027a.setLayoutParams(layoutParams6);
        frameLayout.addView(this.f2027a);
        pf.c((View) this.f2027a, 8);
    ...
    private void tt(Context context) {
        ...
        this.f2027a.addView(splashDiffuseView, 0);
