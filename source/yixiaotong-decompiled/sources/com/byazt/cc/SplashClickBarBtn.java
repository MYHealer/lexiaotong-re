...
public class SplashClickBarBtn extends RelativeLayout {
    ...
    private View c(Context context) {
        ...
        this.f2028a = new RelativeLayout(context);
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
        this.f2028a.setId(2114387576);
        this.f2028a.setClipChildren(false);
        layoutParams2.addRule(13);
        this.f2028a.setLayoutParams(layoutParams2);
        relativeLayout.addView(this.f2028a);
    ...
    private void n() {
        ...
        this.f2028a.addView(splashClickBarArrow);
