...
public class uj extends ve implements View.OnClickListener {
    ...
    private View c(Context context) {
        ...
        this.f2034a.addView(relativeLayout3);
    ...
    public void c(Context context, ViewGroup viewGroup, ic icVar) {
        ...
        this.f2034a.setOutlineProvider(new ViewOutlineProvider() { // from class: com.byazt.cc.uj.1
        ...
        this.f2034a.setClipToOutline(true);
    ...
    private void c(ic icVar) {
        if (icVar == null || this.f2034a == null || oz.n(icVar) != 1) {
            return;
        }
        pf.c((View) this.gt, 0);
        pf.c((View) this.nu, 8);
    ...
    public void c(com.byazt.un.uj ujVar, i.c cVar) {
        ...
        this.tt.post(new Runnable() { // from class: com.byazt.cc.uj.6
            @Override // java.lang.Runnable
            public void run() {
                if (!uj.this.f2034a.isAttachedToWindow()) {
    ...
    public Runnable a() {
        return new Runnable() { // from class: com.byazt.cc.uj.8
            ...
            public void run() {
                ...
                uj.this.sp.animate().scaleX(uj.this.f2034a.getWidth() / uj.this.sp.getWidth()).scaleY(uj.this.f2034a.getHeight() / uj.this.sp.getHeight()).setInterpolator(new OvershootInterpolator(0.0f)).setDuration(500L).setListener(new Animator.AnimatorListener() { // from class: com.byazt.cc.uj.8.1
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        uj.this.f2034a.setVisibility(0);
