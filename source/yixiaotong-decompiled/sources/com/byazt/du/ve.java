...
@com.byazt.zqa.c(c = {0, 1, 441, 54})
public class ve {
    public JSONObject c(List<com.byazt.aq.uj.c> list, int i, JSONObject jSONObject) {
        com.byazt.aq.uj.c next;
        JSONObject jSONObject2;
        if (list == null || list.size() <= 0) {
            return null;
        }
        Iterator<com.byazt.aq.uj.c> it = list.iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
        ...
        if (next == null || (jSONObject2 = next.tt) == null) {
            return null;
        }
