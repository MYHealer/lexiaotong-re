...
public class sl {
    public static final Set<String> c = Collections.unmodifiableSet(new HashSet(Arrays.asList(com.byazt.dyf.tt.AD_TAG_DISLIKE, "close", "close-fill", "webview-close")));
    ...
    /* JADX WARN: Code duplicated, block: B:216:0x03f8  */
    /* JADX WARN: Code duplicated, block: B:219:0x0407 A[Catch: Exception -> 0x0418, JSONException -> 0x041d, TryCatch #3 {Exception -> 0x0418, blocks: (B:217:0x03fc, B:219:0x0407, B:224:0x0411), top: B:264:0x03fc }] */
    /* JADX WARN: Code duplicated, block: B:221:0x040d A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:223:0x0410  */
    public static tt.ve c(String str, String str2, String str3, boolean z, boolean z2, int i, com.byazt.aq.x xVar, double d, int i2, double d2, String str4, u uVar) {
        ...
        if (TextUtils.equals("skip-with-countdowns-skip-countdown", str2)) {
            return c("| ".concat(String.valueOf(String.format("%1$ss后可跳过", "00"))), str3);
        }
        ...
        if ("text".equals(str2) && com.byazt.sr.uj.c() && TextUtils.isEmpty(strOptString) && (aVarN = xVar.da().n()) != null) {
            strOptString = aVarN.r() != null ? xVar.da().n().r().optString(com.byazt.or.x.uj(com.byazt.sr.uj.getContext())) : "";
        }
        if ("fillButton".equals(str2) || "text".equals(str2) || com.hihonor.adsdk.base.g.j.e.a.hnadsk.equals(str2) || "downloadWithIcon".equals(str2) || "downloadButton".equals(str2) || "laceButton".equals(str2) || "cardButton".equals(str2) || "colourMixtureButton".equals(str2) || "arrowButton".equals(str2) || ((ba.at.equals(str2) && (!com.byazt.sr.uj.c() || !"open_ad".equals(strA))) || TextUtils.equals("app-version", str2) || TextUtils.equals("development-name", str2))) {
        ...
        try {
            ...
            if (com.huawei.openalliance.ad.constant.x.cL.equals(str2)) {
                veVar.c = fOptDouble2;
                veVar.tt = fOptDouble2;
                return veVar;
            }
            if (!z) {
                ...
                if (!"title".equals(str2) || (com.byazt.sr.uj.c() && "open_ad".equals(strA) && ba.at.equals(str2))) {
                    try {
