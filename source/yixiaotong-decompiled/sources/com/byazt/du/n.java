...
public class n {
    ...
    public void c(com.byazt.aq.x xVar, float f, float f2) {
        ...
        ttVar.i = 1280.0f;
        ttVar.f1980a = xVar2;
        ttVar.f1980a.ve(ttVar.c);
        ttVar.f1980a.uj(ttVar.tt);
        ttVar.f1980a.n(ttVar.ve);
        ttVar.f1980a.a(ttVar.uj);
    ...
    public com.byazt.aq.tt c(com.byazt.aq.tt ttVar, float f) {
        ...
        com.byazt.aq.x xVar = ttVar3.f1980a;
        if (xVar == null) {
            return ttVar3;
        }
        xVar.rl();
        ...
        if (f9 >= f8) {
            ...
            if (TextUtils.equals(strAw, TtmlNode.CENTER)) {
                fC2 = (f8 - f9) / 2.0f;
        ...
        while (i < listNu.size()) {
            ...
            if (f13 >= f7) {
                ...
                if (TextUtils.equals(strSv, TtmlNode.CENTER)) {
                    fC3 = (f7 - f13) / 2.0f;
            ...
            while (it8.hasNext()) {
                ...
                if (fMax2 <= f19 || TextUtils.equals(strIr, "flex-start")) {
                    ...
                    strIr.hashCode();
                    if (strIr.equals(TtmlNode.CENTER)) {
                        f3 = (fMax2 - f19) / 2.0f;
                ...
                list = list;
                ttVar4.da = list;
                ttVar4.f1980a.ve(ttVar4.c);
                ttVar4.f1980a.uj(ttVar4.tt);
                ttVar4.f1980a.n(ttVar4.ve);
                ttVar4.f1980a.a(ttVar4.uj);
                float f21 = f20;
