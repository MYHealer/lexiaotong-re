...
public class tt {
    ...
    private ve a(com.byazt.aq.x xVar, float f, float f2) {
        ...
        int iHd = aVarN.hd();
        C0137tt c0137tt = new C0137tt();
        c0137tt.c = fRh;
        c0137tt.tt = iLt;
        c0137tt.ve = iTk;
        c0137tt.uj = dPu;
        c0137tt.n = f;
        return c(xVar.da().tt(), c0137tt, zIc, zKp, iHd, xVar);
    }

    private ve c(String str, C0137tt c0137tt, boolean z, boolean z2, int i, com.byazt.aq.x xVar) {
        return sl.c(str, xVar.da().getType(), C0137tt.c(c0137tt).toString(), z, z2, i, xVar, this.n, this.f2120a, this.sp, this.x, this.i);
    }
    ...
    private boolean c(List<com.byazt.aq.x> list, boolean z) {
        for (com.byazt.aq.x xVar : list) {
            com.byazt.aq.a aVarN = xVar.da().n();
            String strP = aVarN.p();
            if (TextUtils.equals(strP, "flex") || (z && ((TextUtils.equals(aVarN.md(), "flex") && TextUtils.equals(aVarN.p(), "scale") && com.byazt.aq.n.c.get(xVar.da().getType()).intValue() == 7) || TextUtils.equals(strP, "flex")))) {
                return true;
            }
        }
        Iterator<com.byazt.aq.x> it = list.iterator();
    ...
    private String uj(List<com.byazt.aq.x> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (i < list.size() - 1) {
                sb.append(strVe).append(com.huawei.openalliance.ad.constant.x.A);
            } else {
                sb.append(strVe);
            }
        }
    ...
    @com.byazt.zqa.c(c = {0, 1, 441, 240})
    static class C0137tt {
        public float c;
        public float n;
        public int tt;
        public double uj;
        ...
        public static JSONObject c(C0137tt c0137tt) {
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put(TtmlNode.ATTR_TTS_FONT_SIZE, c0137tt.c);
                jSONObject.put("letterSpacing", c0137tt.tt);
                jSONObject.put("lineHeight", c0137tt.uj);
                jSONObject.put("maxWidth", c0137tt.n);
                jSONObject.put(TtmlNode.ATTR_TTS_FONT_WEIGHT, c0137tt.ve);
