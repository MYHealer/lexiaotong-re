        ...
        if (!Zeus.isPluginInstalled("com.byted.pangle")) {
            ...
            try {
                if (!zTt) {
                    ...
                    this.f2541a.await(i, TimeUnit.MILLISECONDS);
                }
            ...
            Zeus.setDecodeCallback(new t() { // from class: com.byazt.nys.i.4
                ...
                public String c(String str) {
                    try {
                        ...
                        String strOptString2 = jSONObject.optString(CrashHianalyticsData.MESSAGE);
