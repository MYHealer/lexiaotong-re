...
public class da extends com.byazt.bog.c {
    ...
    public SharedPreferences f2540a;
    public sp n;
    ...
    @com.byazt.zqa.c(c = {0, 1, 430, ai.t})
    ...
    private static final class ve {
        ...
        private static Initializer tt(sp spVar) throws uj {
            try {
                ...
                if (i.c(TTAppContextHolder.getContext()).c(spVar, 60000) == null) {
    ...
    public long c(boolean z) {
        ...
        if (this.i < 0) {
            try {
                this.i = this.f2540a.getLong("bstlayer_init_delay_time", 0L);
    ...
    private void x() {
        if (this.x == Integer.MIN_VALUE) {
            if (this.f2540a == null) {
                this.f2540a = com.byazt.nys.tt.tt(TTAppContextHolder.getContext(), "sp_bidding_opt_libra", 0);
            }
            int i = this.f2540a.getInt("bst_pl_exec_conf", -1);
            this.x = i;
            if (i >= 0) {
                return;
            }
            this.x = this.f2540a.getInt("_use_pl_", 0);
        }
    }
