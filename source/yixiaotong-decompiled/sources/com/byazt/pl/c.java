...
public class c {
    public static Map<String, C0250c> c = new ConcurrentHashMap();

    public static void c(com.byazt.ll.tt ttVar, da daVar, Map<String, Object> map) {
        C0250c c0250c;
        if (ttVar == null || daVar == null || map == null || !daVar.or() || !"baidu".equals(daVar.z()) || (c0250c = c.get(ttVar.gt())) == null) {
            return;
        }
        map.put(MediationConstant.BIDDING_WIN_ADN, c0250c.c);
        map.put(MediationConstant.BIDDING_WIN_PRICE, Double.valueOf(c0250c.ve));
        Boolean boolValueOf = Boolean.valueOf(com.byazt.bp.tt.tt().y());
        map.put(MediationConstant.BIDDING_IS_OPEN_ECPM, boolValueOf);
        if (boolValueOf.booleanValue()) {
            map.put(MediationConstant.BIDDING_REQUEST_ID_MAP, c0250c.uj);
            map.put(MediationConstant.BIDDING_WIN_ADN_ID, c0250c.tt);
        }
    }
    ...
    public static void c(com.byazt.ll.tt ttVar, com.byazt.nbs.tt ttVar2, List<com.byazt.yl.ve> list, List<com.byazt.yl.ve> list2) {
        ...
        if (next != null) {
            ...
            c.put(ttVar2.nb(), new C0250c(next.getAdNetworkSlotId(), next.getAdNetWorkName(), next.getCpm(), map));
        }
    }
    ...
    static class C0250c {
        ...
        public C0250c(String str, String str2, double d, Map<String, String> map) {
            this.c = str2;
            this.ve = d;
            this.uj = map;
            this.tt = str;
