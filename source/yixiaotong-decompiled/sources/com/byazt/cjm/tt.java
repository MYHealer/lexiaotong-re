...
public class tt implements c {
    ...
    public tt(c.InterfaceC0124c interfaceC0124c) {
    ...
    public boolean ve(int i) {
        c.InterfaceC0124c interfaceC0124c = this.c;
        if (interfaceC0124c == null || interfaceC0124c.getActivity() == null || this.c.c() == null || this.ve.get() || !this.i) {
            return false;
        }
        if (i == 1) {
            c.InterfaceC0124c interfaceC0124c2 = this.c;
            interfaceC0124c2.c(0, c(interfaceC0124c2.getActivity()));
            i();
            ...
            if (i == 3) {
                c.InterfaceC0124c interfaceC0124c3 = this.c;
                interfaceC0124c3.c(0, c(interfaceC0124c3.getActivity()));
                i();
    ...
    public void uj() {
        c.InterfaceC0124c interfaceC0124c = this.c;
        if (interfaceC0124c == null || interfaceC0124c.getActivity() == null || this.c.c() == null || !l.c(this.c.c())) {
            return;
        }
        if (!this.x) {
            boolean z = this.sp == 0;
    ...
    public void i() {
        try {
            ...
            if (TextUtils.isEmpty(strUj)) {
                strUj = String.valueOf(this.f2050a);
            }
            if (TextUtils.isEmpty(strUj)) {
                    ...
                    x.c(new Runnable() { // from class: com.byazt.cjm.tt.3.2
                        ...
                        public void run() {
                            ...
                            if (!(zVar2 instanceof com.byazt.yi.ve)) {
                                ...
                                veVar.setPlayAgainSourceRit(tt.this.f2050a);
    ...
    public void uj(final String str) {
        c.InterfaceC0124c interfaceC0124c = this.c;
        if (interfaceC0124c == null || interfaceC0124c.getActivity() == null) {
            return;
        }
    ...
    public String x() {
        ...
        try {
            ...
            jSONObject.put("mSourceRitId", this.f2050a);
    ...
    public void ve(String str) {
        try {
            ...
            this.f2050a = jSONObject.optInt("mSourceRitId");
