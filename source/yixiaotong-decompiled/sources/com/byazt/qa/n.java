...
public class n extends com.byazt.xj.c<FlexboxLayout> {
    ...
    public com.byazt.xj.c.C0323c x() {
        return new c(this);
    }

    @com.byazt.zqa.c(c = {0, 1, 598, 151})
    public static class c extends com.byazt.xj.c.C0323c {
        public int cu;
        public float d;
        public int eo;
        public int h;
        ...
        public FlexboxLayout.c c() {
            ...
            cVar.leftMargin = (int) this.f2862a;
