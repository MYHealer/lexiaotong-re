...
public class ve extends sl {
    ...
    public ArrayList<RecyclerView.gu> f2436a = new ArrayList<>();
    ...
    public void c(final c cVar) {
        ...
        if (view != null) {
            ...
            duration.translationY(cVar.f2438a - cVar.uj);
    ...
    @Override // com.byazt.kt.RecyclerView.a
    public boolean tt() {
        return (this.sl.isEmpty() && this.u.isEmpty() && this.t.isEmpty() && this.da.isEmpty() && this.n.isEmpty() && this.f2436a.isEmpty() && this.uj.isEmpty() && this.sp.isEmpty() && this.tt.isEmpty() && this.c.isEmpty() && this.ve.isEmpty()) ? false : true;
    }
    ...
    private static class c {
        ...
        public String toString() {
            return "ChangeInfo{oldHolder=" + this.c + ", newHolder=" + this.tt + ", fromX=" + this.ve + ", fromY=" + this.uj + ", toX=" + this.n + ", toY=" + this.f2438a + '}';
        }
    }
