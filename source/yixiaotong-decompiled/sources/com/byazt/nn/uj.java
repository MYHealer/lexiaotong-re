...
@com.byazt.zqa.c(c = {0, 1, 1020, 15})
public class uj {
    public static volatile uj c;
    public final LinkedList<c> tt = new LinkedList<>();
    public static final String[] ve = {"com", "android", "ss"};
    public static final int[] uj = {DIResultCode.UNSUPPORTED_ACTION, DIResultCode.AGREEMENT_NOT_AGREED, 3103, 3201, 3202, 3203};

    /* JADX INFO: renamed from: com.byazt.nn.uj$1, reason: invalid class name */
    @com.byazt.zqa.c(c = {0, 1, 1020, z.k})
    ...
    private c ve(String str) {
        try {
            ...
            if (packageInfo != null) {
                return new c(str, packageInfo.versionCode, packageInfo.versionName, (String) packageManager.getApplicationLabel(packageInfo.applicationInfo), System.currentTimeMillis(), null);
            }
            return null;
        } catch (Throwable th) {
            m.c(th);
    ...
    @com.byazt.zqa.c(c = {0, 1, 1020, AppTypeIdUtil.NewDevice4GBathOTA})
    public static class c {
        ...
        public /* synthetic */ c(String str, int i, String str2, String str3, long j, AnonymousClass1 anonymousClass1) {
