...
public class tt {
    ...
    private static void tt(final DownloadInfo downloadInfo) {
        ...
        final int iC = (((!downloadInfo.isAutoResumed() || downloadInfo.isShowNotificationForNetworkResumed()) && !com.byazt.z.ve.tt(downloadInfo.getExtra()) && !TextUtils.isEmpty(downloadInfo.getMimeType()) && downloadInfo.getMimeType().equals(AdBaseConstants.MIME_APK)) || com.byazt.k.c.c(downloadInfo.getId()).c("auto_install_when_resume", 0) == 1) ? com.byazt.z.ve.c(contextIc, downloadInfo.getId(), false) : 2;
