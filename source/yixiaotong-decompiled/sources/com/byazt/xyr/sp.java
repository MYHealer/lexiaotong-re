...
@com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_FIND_STREAM_INFO_PROBE_DURATION, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp {
        ...
        if (this.c) {
            try {
                ...
                if (action == 0) {
                    ...
                    this.n = z;
                    this.f2879a = motionEvent.getEventTime();
    ...
    private JSONObject c(MotionEvent motionEvent) {
        ...
        try {
            ...
            jSONObject.put("ts", motionEvent.getEventTime() - this.f2879a);
        } catch (Exception e) {
            m.c(e);
        }
        return jSONObject;
    ...
    private void c(JSONArray jSONArray, SensorEvent sensorEvent) {
        ...
        try {
            ...
            jSONObject.put("ts", (sensorEvent.timestamp - this.sp) / 1000000);
        } catch (Exception e) {
            m.c(e);
        }
    ...
    private void tt(JSONArray jSONArray, SensorEvent sensorEvent) {
        ...
        try {
            ...
            jSONObject.put(am.aD, Math.round(((double) sensorEvent.values[2]) * 100.0d) / 100.0d);
            jSONObject.put("ts", (sensorEvent.timestamp - this.sp) / 1000000);
        } catch (Exception e) {
            m.c(e);
        }
