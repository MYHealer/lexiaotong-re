...
public class ve {
    ...
    public static final ComponentCallbacks f2720a = new ComponentCallbacks() { // from class: com.byazt.sx.ve.4
    ...
    private static void tt(final Context context, final JSONObject jSONObject) {
        ...
        m();
        uj.c(StubApp.getOrigApplicationContext(context.getApplicationContext()));
    ...
    public static void z() {
        ...
        ComponentCallbacks componentCallbacks = f2720a;
        ...
        if (cVarVe != null) {
            ...
            cVarVe.c(new com.byazt.aas.c.tt() { // from class: com.byazt.sx.ve.5
                ...
                public void onAppBackground() {
                    ...
                    if (jElapsedRealtime - ve.x >= C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS) {
