...
public class tt {
            ...
            public boolean accept(File file) {
                if (file != null && !strConcat.equals(file.getName())) {
                    ...
                    if (file.getName().matches("^version-(\\d+)$")) {
                        u.c().c(str, Integer.parseInt(file.getName().split(x.A)[1]), false);
                    }
                }
                return false;
            }
                ...
                try {
                    ...
                    for (File file : listUj) {
                        if (file.getName().endsWith(".dex")) {
                            ...
                            com.byazt.uq.x.c(file.getAbsolutePath(), strC);
                        }
                    }
                    if (fileN.getName().endsWith(".json")) {
                        ...
                        com.byazt.uq.x.c(fileN.getAbsolutePath(), strSl2);
                    }
                    if (ve.i(strSp, iVe)) {
    ...
    private static String tt(String str) {
        return (str == null || !str.endsWith(x.bQ)) ? str : str.substring(0, str.length() - 1);
    }
