...
public class c {
    ...
    private boolean i() {
        ...
        if (list != null && list.size() != 0 && (jSONObject = this.ve) != null && jSONObject.length() != 0) {
            ...
            ZeusLogger.i(ZeusLogger.TAG_INSTALL, "DexPluginConfig check md5 " + (z ? "success" : "fail") + ", packageName=" + this.tt + " fileSize=" + size + " configFileSize=" + length);
            return z;
        }
