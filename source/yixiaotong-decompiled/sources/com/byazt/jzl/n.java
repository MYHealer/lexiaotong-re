...
public class n implements tt {
    ...
    /* JADX INFO: renamed from: com.byazt.jzl.n$1, reason: invalid class name */
    @com.byazt.zqa.c(c = {0, 1, 1574, 219})
    ...
    public JSONObject c() {
        ...
        try {
            ...
            jSONObject.put(ba.D, this.uj);
            jSONObject.put("adtype", this.f2398a);
            jSONObject.put("req_id", this.ve);
            jSONObject.put("duration", this.sp);
    ...
    private JSONObject tt() {
        ...
        try {
            ...
            jSONObject.put(com.hihonor.adsdk.base.g.j.e.a.hnadst, this.my);
            int i2 = this.gt;
            if (i2 != -8888) {
    ...
    @com.byazt.zqa.c(c = {0, 1, 1574, 151})
