...
@com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_ABR_SWITCH_COUNT, 1367})
public abstract class AbsServerManager extends ContentProvider {
    ...
    public IBinder onBind(String str) {
        ...
        if (str.equals("package")) {
            return com.byazt.er.c.tt();
        }
        if (str.equals("service")) {
            return com.byazt.p000if.c.tt();
        }
        return null;
    }
    ...
    public Bundle call(String str, String str2, Bundle bundle) {
        ...
        bundle2.putParcelable(BUNDLE_BINDER, new c(iBinderOnBind));
        return bundle2;
    }
}
