...
public class ve extends com.byazt.lq.c implements LazeLayout.c<NativeVideoTsView>, com.byazt.lbn.c<NativeVideoTsView> {
    ...
    public View getAdView() {
        ...
        if (icVar == null || this.f2642a == null) {
            return null;
        }
        ...
        if (ic.ve(this.sp)) {
            if (x.c()) {
                this.i = new LazeLayout(this.f2642a, this, this);
            } else {
                try {
                    nativeVideoTsViewInflate = inflate(this.f2642a);
    ...
    private boolean c(int i) {
        ...
        if (1 != iA || !rh.uj(this.f2642a)) {
            if (2 == iA) {
                if (!rh.n(this.f2642a) && !rh.uj(this.f2642a)) {
                    rh.a(this.f2642a);
                }
            } else if (5 == iA && !rh.uj(this.f2642a)) {
                rh.a(this.f2642a);
            }
        }
        return true;
