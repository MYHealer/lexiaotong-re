...
public class uj extends yp {
    ...
    public void render() {
        ...
        if (veVar != null) {
            if (veVar.isExpressAd()) {
                ...
                this.tt.render();
                c(this.tt);
                if (this.tt.getSubAdType() != 3 || (ttVar = this.f2935a) == null) {
                    return;
                }
            ...
            if (ttVar2 != null) {
                try {
                    ...
                    this.uj = viewC;
                    if (viewC != null) {
                        com.byazt.ft.tt ttVar3 = this.f2935a;
                        if (ttVar3 != null) {
                            ttVar3.c(viewC, 0.0f, 0.0f);
                            return;
                        }
                        return;
                    }
                    com.byazt.eu.tt.c("TTMediationSDK", "--==-- 自渲染信息流转模板，getMediationBannerViewFromNativeAd()返回null，将无法展示该广告");
                    com.byazt.ft.tt ttVar4 = this.f2935a;
                    if (ttVar4 != null) {
                        ttVar4.c((View) null, "渲染失败", -99999);
                        return;
                    }
                    return;
                } catch (Throwable th) {
    ...
    private void tt() {
        ...
        veVar.setTTAdatperCallback(new com.byazt.zq.c() { // from class: com.byazt.zu.uj.4
            ...
            public void c(View view) {
                if (uj.this.f2935a != null) {
                    uj.this.f2935a.c(view, 0);
                }
                uj.this.n();
            }
        ...
        if (veVar.isExpressAd()) {
            this.tt.setGMDrawAdListener(new com.byazt.fy.uj() { // from class: com.byazt.zu.uj.5
                ...
                public void c(float f, float f2) {
                    if (uj.this.f2935a != null) {
                        uj.this.f2935a.c((View) null, f, f2);
                    }
                }
    ...
    public void c(View view) {
        ...
        com.byazt.ft.tt ttVar = this.f2935a;
        if (ttVar != null) {
            ttVar.tt(view, 0);
        }
