...
public class uj implements Comparable<uj> {
    ...
    public final ArrayList<Long> f2670a = new ArrayList<>();
    ...
    public void c(String str, String str2) {
        ...
        switch (str) {
            ...
            case "dislike":
                ...
                break;
            case "play_start":
                this.f2670a.add(Long.valueOf(SystemClock.elapsedRealtime()));
                if (gt.tt().ts()) {
                    this.sp++;
                }
                if (!TextUtils.isEmpty(str2)) {
