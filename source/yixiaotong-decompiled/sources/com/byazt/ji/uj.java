...
public class uj extends tt {
    ...
    public boolean c(Object... objArr) {
        ...
        if (this.n != null) {
            Object obj3 = this.n.get(HiAnalyticsConstant.HaKey.BI_KEY_DIRECTION);
            String strValueOf = TtmlNode.COMBINE_ALL;
            ...
            if (motionEvent.getRawY() != 0.0f || rawX != 0.0f) {
                ...
                switch (this.rh) {
                    case 3739:
                        ...
                        break;
                    case 96673:
                        if (r6.equals(TtmlNode.COMBINE_ALL)) {
                            b = -1;
                        } else {
                            b = 4;
                        }
    ...
    private boolean c(com.byazt.xj.ve veVar, float f, float f2) {
        ...
        this.c.c(veVar, this.f2381a, this.ve.tt(), this.ve);
