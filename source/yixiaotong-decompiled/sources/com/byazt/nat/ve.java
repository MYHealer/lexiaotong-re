...
public class ve extends c {
    ...
    public int c(Map<String, Object> map, com.byazt.zo.ve veVar) {
        ...
        tt(this.c.i());
        ve();
        final c.InterfaceC0217c interfaceC0217cC = this.n.c();
        x.c(new Runnable() { // from class: com.byazt.nat.ve.1
            @Override // java.lang.Runnable
            public void run() {
                c.InterfaceC0217c interfaceC0217c = interfaceC0217cC;
                if (interfaceC0217c != null) {
                    interfaceC0217c.c(ve.this.uj, ve.this.n.ve());
                }
            }
        });
        ...
        if (this.uj instanceof TextView) {
            ...
            z = text != null && (text.toString().contains(com.hihonor.adsdk.base.c.g1.hnadsa) || text.toString().contains("安装"));
    ...
    private boolean i() {
        ...
        if (this.f2492a == 0) {
            this.f2492a = nb.sl(this.c);
        }
        n();
        sp();
        a();
        if (this.f2492a == 5 && sl() && sp() && !n() && !a()) {
            return false;
        }
        int i = this.f2492a;
        return i == 1 || i == 2 || i == 5;
