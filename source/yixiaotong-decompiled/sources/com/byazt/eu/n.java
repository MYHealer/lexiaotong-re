...
public class n {
    ...
    public static Handler f2214a = null;
    ...
    public static void c() {
        try {
            ...
            n = handlerThread;
            handlerThread.start();
            f2214a = new Handler(n.getLooper());
        } catch (Throwable th) {
            m.c(th);
        }
    }
    ...
    private static boolean x() {
        ...
        return (handlerThread == null || !handlerThread.isAlive() || f2214a == null) ? false : true;
    }
