...
public class c extends gt {
    ...
    private static final class C0213c extends com.byazt.jtc.ve {
        public C0213c() {
            super("Okio Watchdog");
            setDaemon(true);
        }
    ...
    public static c uj() throws InterruptedException {
        ...
        if (cVar == null) {
            long jNanoTime = System.nanoTime();
            c.class.wait(tt);
            if (c.f2476a != null || System.nanoTime() - jNanoTime < uj) {
                return null;
            }
            return c;
        }
        ...
        if (jTt > 0) {
            long j = jTt / 1000000;
            c.class.wait(j, (int) (jTt - (1000000 * j)));
            return null;
        }
        c.f2476a = cVar.f2476a;
        cVar.f2476a = null;
        return cVar;
    }
}
