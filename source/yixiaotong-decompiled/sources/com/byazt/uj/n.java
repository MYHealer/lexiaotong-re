...
@com.byazt.zqa.c(c = {0, 1, 15, 46})
public class n extends x {
    public n(com.byazt.wn.tt ttVar, Function<SparseArray<Object>, Object> function) {
    ...
    public com.byazt.nc.sp getDislikeDialog(Activity activity) {
        ...
        Object objApply = this.i.apply(com.byazt.yxi.uj.c().c(6072).c(Function.class).c(20033, activity).tt());
        if (!(objApply instanceof Function)) {
            return null;
        }
        final com.byazt.ch.a aVar = new com.byazt.ch.a((Function) objApply);
        return new com.byazt.nc.sp() { // from class: com.byazt.uj.n.1
    ...
    public Integer isReadyStatus() {
        if (this.i != null) {
            Integer numC = com.byazt.sq.c.c(this.i.apply(com.byazt.yxi.uj.c().c(8121).c(Object.class).c(20068, 1).tt()));
            if (numC != null) {
                return numC;
            }
        }
    ...
    public void callNativeRenderFail(View view, String str, int i) {
        if (getGMNativeAdListener() instanceof com.byazt.me.a) {
            try {
                ((com.byazt.me.a) getGMNativeAdListener()).c(view, str, i);
            } catch (Exception e) {
                m.c(e);
            }
        }
    ...
    public void callNativeRenderSuccess(float f, float f2) {
        if (getGMNativeAdListener() instanceof com.byazt.me.a) {
            try {
                ((com.byazt.me.a) getGMNativeAdListener()).c(f, f2);
            } catch (Exception e) {
                m.c(e);
            }
        }
    ...
    public void callNativeAdClick() {
        checkClick(new c() { // from class: com.byazt.uj.n.2
            @Override // com.byazt.uj.c
            public void c() {
                if (n.this.getGMNativeAdListener() != null) {
                    n.this.getGMNativeAdListener().c(null);
                }
            }
        });
    }
    ...
    public void callNativeAdShow() {
        checkShow(new c() { // from class: com.byazt.uj.n.3
            @Override // com.byazt.uj.c
            public void c() {
                if (n.this.getGMNativeAdListener() != null) {
                    n.this.getGMNativeAdListener().c();
                }
            }
        });
    }
    ...
    public <T> T applyFunction(int i, PluginValueSet pluginValueSet, Class<T> cls) {
        if (i == 8134) {
            ...
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeRenderFail code:" + iIntValue + " msg:" + strStringValue + " view" + view);
            ...
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeRenderSuccess width:" + fFloatValue + " height:" + fFloatValue2);
            callNativeRenderSuccess(fFloatValue, fFloatValue2);
        } else if (i == 8130) {
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeAdClick");
            callNativeAdClick();
        } else if (i == 8113) {
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeAdShow");
            callNativeAdShow();
        } else if (i == 8145) {
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeVideoStart");
            callNativeVideoStart();
        } else if (i == 8146) {
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeVideoPause");
            callNativeVideoPause();
        } else if (i == 8150) {
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeVideoResume");
            callNativeVideoResume();
        } else if (i == 8118) {
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeVideoCompleted");
            ...
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeVideoError code:" + iIntValue2 + " msg:" + strStringValue2);
            ...
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeVideoError current:" + jLongValue + " duration:" + jLongValue2);
            callNativeVideoProgressUpdate(jLongValue, jLongValue2);
        } else if (i == 8152) {
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeOnIdle");
            callNativeOnIdle();
        } else if (i == 8187) {
            ...
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeOnDownloadActive totalBytes:" + jLongValue3 + " curlBytes:" + jLongValue4);
            ...
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeOnDownloadPaused totalBytes:" + jLongValue5 + " curlBytes:" + jLongValue6 + " fileName:" + strStringValue3 + " appName:" + strStringValue4);
            ...
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeOnDownloadFailed totalBytes:" + jLongValue7 + " curlBytes:" + jLongValue8 + " fileName:" + strStringValue5 + " appName:" + strStringValue6);
            ...
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeOnDownloadFinished totalBytes:" + jLongValue9 + " fileName:" + strStringValue7 + " appName:" + strStringValue8);
            ...
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeOnDownloadFinished  fileName:" + strStringValue9 + " appName:" + strStringValue10);
            callNativeOnInstalled(strStringValue9, strStringValue10);
        } else if (i == 8185) {
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeDislikeShow");
            callNativeDislikeShow();
        } else if (i == 8184) {
            com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeDislikeCancel");
            callNativeDislikeCancel();
        } else if (i != 6085) {
            if (i == 8110) {
                boolean zIsClientBiddingAd = isClientBiddingAd();
                com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : isClientBiddingAd :".concat(String.valueOf(zIsClientBiddingAd)));
                return (T) Boolean.valueOf(zIsClientBiddingAd);
            }
            if (i == 8136) {
                boolean zIsServerBiddingAd = isServerBiddingAd();
                com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : isServerBiddingAd :".concat(String.valueOf(zIsServerBiddingAd)));
                return (T) Boolean.valueOf(zIsServerBiddingAd);
            }
            if (i == 8160) {
                boolean zIsUseCustomVideo = isUseCustomVideo();
                com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : isUseCustomVideo :".concat(String.valueOf(zIsUseCustomVideo)));
                return (T) Boolean.valueOf(zIsUseCustomVideo);
            }
            if (i == 8226) {
                int adNetworkSlotType = getAdNetworkSlotType();
                com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : getBiddingType :".concat(String.valueOf(adNetworkSlotType)));
            ...
            if (i == 8132) {
                ...
                com.byazt.eu.tt.tt("TTMediationSDK", "Adn custom feed ad : callNativeDislikeSelected postion:" + iIntValue3 + " value:" + strStringValue11);
