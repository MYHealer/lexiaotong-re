...
@com.byazt.zqa.c(c = {0, 1, AdaptiveTrackSelection.DEFAULT_MAX_HEIGHT_TO_DISCARD, 20})
public class c {
    ...
    public JSONArray f2451a = new JSONArray();
    ...
    public void c(JSONObject jSONObject) {
        if (gt.tt().rl()) {
            try {
                ...
                jSONObject.put("pkg_info", this.f2451a);
                int[] iArr = this.i;
                if (iArr != null) {
