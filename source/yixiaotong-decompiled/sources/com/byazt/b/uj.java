...
@com.byazt.zqa.c(c = {0, 1, 223, 15})
public class uj implements com.byazt.zz.da {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public com.byazt.u.x f1993a;
    public gt tt;
    ...
    public uj() {
        ...
        if (!com.byazt.k.c.ve().c("fix_sigbus_downloader_db") || com.byazt.w.a.c() || !com.byazt.zz.ve.lo()) {
            ...
            this.tt = com.byazt.zz.ve.pu().c(new com.byazt.zz.ve.c.InterfaceC0351c() { // from class: com.byazt.b.uj.2
                @Override // com.byazt.zz.ve.c.InterfaceC0351c
                public void c() {
        ...
        this.ve = false;
        this.f1993a = new com.byazt.u.x(Looper.getMainLooper(), this.n);
        sp();
    }
    ...
    public void x() {
        this.f1993a.sendMessageDelayed(this.f1993a.obtainMessage(1), com.byazt.k.c.ve().c("task_resume_delay") ? 4000L : 1000L);
    }
