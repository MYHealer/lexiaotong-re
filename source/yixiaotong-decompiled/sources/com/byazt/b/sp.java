...
@com.byazt.zqa.c(c = {0, 1, 223, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp implements IDownloadHttpService {
    ...
    public com.byazt.hs.i downloadWithConnection(int i, String str, List<com.byazt.t.ve> list) throws IOException {
        ...
        final InputStream gZIPInputStream = (strHeader == null || !AsyncHttpClient.ENCODING_GZIP.equalsIgnoreCase(strHeader) || (inputStreamByteStream instanceof GZIPInputStream)) ? inputStreamByteStream : new GZIPInputStream(inputStreamByteStream);
