...
@com.byazt.zqa.c(c = {0, 1, 223, 115})
public class rh implements Handler.Callback, com.byazt.g.c.InterfaceC0156c {
        ...
        com.byazt.zz.ve.t().execute(new Runnable() { // from class: com.byazt.b.rh.1
            ...
            public void run() {
                try {
                    if (rh.this.tt != null) {
                        rh rhVar = rh.this;
                        rhVar.x = (ConnectivityManager) StubApp.getOrigApplicationContext(rhVar.tt.getApplicationContext()).getSystemService("connectivity");
    ...
    public void c(int i2, boolean z) {
        ...
        synchronized (this) {
            if (!z) {
                if (jCurrentTimeMillis - this.f1991a < ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT) {
                    return;
                }
            }
            this.f1991a = jCurrentTimeMillis;
            ...
            this.ve.sendMessageDelayed(messageObtain, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
        }
    }
    ...
    public int sp() {
        try {
            if (this.x == null) {
                this.x = (ConnectivityManager) StubApp.getOrigApplicationContext(this.tt.getApplicationContext()).getSystemService("connectivity");
            }
