...
public abstract class c implements com.byazt.u.x.c {
    ...
    public final SparseArray<DownloadTask> f1990a = new SparseArray<>();
    ...
    private void c(DownloadTask downloadTask, boolean z) {
        ...
        if (this.f1990a.get(id) != null) {
            this.f1990a.remove(id);
        }
    ...
    public synchronized eo x(int i) {
        ...
        DownloadTask downloadTask5 = this.f1990a.get(i);
    ...
    public synchronized boolean t(int i) {
        DownloadInfo downloadInfo;
        DownloadTask downloadTask = this.f1990a.get(i);
        if (downloadTask == null || (downloadInfo = downloadTask.getDownloadInfo()) == null) {
            return false;
        }
        if (downloadInfo.canReStartAsyncTask()) {
    ...
    public synchronized void c(int i, int i2, final IDownloadListener iDownloadListener, com.byazt.ev.a aVar, boolean z, boolean z2) {
        ...
        if (downloadTaskZ != null) {
            ...
            final DownloadInfo downloadInfo = downloadTaskZ.getDownloadInfo();
            if (z2 && downloadInfo != null && !c(i) && ((aVar == com.byazt.ev.a.MAIN || aVar == com.byazt.ev.a.NOTIFICATION) && (aVar != com.byazt.ev.a.NOTIFICATION || downloadInfo.canShowNotification()))) {
    ...
    public DownloadTask z(int i) {
        ...
        DownloadTask downloadTask4 = this.n.get(i);
        return downloadTask4 == null ? this.f1990a.get(i) : downloadTask4;
    }
            ...
            if (i3 != -7) {
                ...
                if (i3 == -4) {
                    ...
                    if (i3 != 7) {
                        if (i3 == 8) {
                            DownloadTask downloadTask = this.tt.get(i);
                            if (downloadTask != null && this.f1990a.get(i) == null) {
                                this.f1990a.put(i, downloadTask);
                            }
                        }
                        return;
                    }
