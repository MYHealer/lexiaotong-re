...
public class c implements Function<SparseArray<Object>, Object> {
    ...
    private void sp(PluginValueSet pluginValueSet) {
        try {
            ...
            spVar.c(z, (String) map.get("open_uid"));
        } catch (Exception e) {
            m.tt("LiveServiceBridge", e);
        }
    }
    ...
    private Integer x(PluginValueSet pluginValueSet) {
        ...
        if (strSp.replaceAll(".", "").startsWith("2112")) {
    ...
    public void logEvent(boolean z, String str, String str2, Map<String, String> map) {
        ...
        new com.byazt.ddx.c.C0129c().c(str).tt(str2).ve(BaseConstants.CATEGORY_UMENG).n(jSONObject.optString(oOOOoo00.OooOo0o)).uj(jSONObject.optString("log_extra")).c(new com.byazt.ya.c() { // from class: com.byazt.cn.c.1
