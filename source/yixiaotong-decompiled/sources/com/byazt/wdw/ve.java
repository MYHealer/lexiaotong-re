...
public class ve {
    ...
    private void c(yp ypVar) {
        ...
        x.c(new Runnable() { // from class: com.byazt.wdw.ve.2
            ...
            public void run() {
                try {
                    h.tt(StubApp.getOrigApplicationContext(ve.this.ve.getApplicationContext()), strUj, 0, 17, 0, 0);
                } catch (Throwable th) {
                    m.c(th);
                }
            }
    ...
    private void tt(JSONObject jSONObject) {
        ...
        String strOptString = jSONObject.optString(a.E);
        ...
        if (this.f2840a != null) {
            if (zOptBoolean && "success".equals(strOptString)) {
                ...
                this.f2840a.c(strOptString, zOptBoolean);
            }
        }
    }
