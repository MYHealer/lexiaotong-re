...
public final class t {
    ...
    public static void c(JSONObject jSONObject, View view, int i, boolean z) {
        ...
        try {
            ...
            jSONObject2.put(Constant.MAP_KEY_TOP, iArr[1]);
            jSONObject2.put(TtmlNode.RIGHT, iArr[0] + view.getWidth());
            ...
            if (z) {
                ...
                if (sb.length() > 0) {
                    ...
                    jSONObject.put("view_tree_path", PPSLabelView.Code);
                    jSONObject.put("view_tree_path_hash", PPSLabelView.Code);
                }
