...
@com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_FIX_PROCESS_TIMER, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public final class sp {
    ...
    private static Iterable<String> uj() {
        ...
        if (ve == null) {
            ...
            ve = arrayList;
            arrayList.add(c(new byte[]{120, 117, 113, 102, 120, 109}));
            ve.add(c(new byte[]{108, 122, 110, 105, 106}));
            ve.add(c(new byte[]{124, 106, 113, 104, 116, 114, 106}));
            ve.add(c(new byte[]{110, 115, 121, 106, 119, 120, 121, 110, 121, 110, 102, 113}));
            ve.add(c(new byte[]{119, 116, 122, 121, 106, 119}));
            ve.add(c(new byte[]{119, 116, 122, 121, 106}));
            ve.add(c(new byte[]{121, 119, 102, 115, 120, 110, 121, 110, 116, 115}));
    ...
    public static void c(Activity activity) {
        if (activity != null && rh(activity)) {
            ...
            cVarVe.f2363a = activity.isTaskRoot();
            activity.hashCode();
        }
    }
    ...
    public static void tt(Activity activity, final int i2, boolean z) {
        ...
        long jCurrentTimeMillis = System.currentTimeMillis();
        if (z || cVarVe.i <= 0 || jCurrentTimeMillis - cVarVe.i >= ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS) {
    ...
    public static void tt(Activity activity, String str, int i2, int i3) {
        ...
        if (ttVarC == null || ttVarC.uj == null || ttVarC.uj.isEmpty()) {
            sl(activity);
            uj(str);
                    ...
                    if (activity2 != null && !activity2.isFinishing()) {
                        if (sp.rh(activity)) {
                            if (sp.da(activity2)) {
                                ...
                                long j2 = cVarVe.uj;
                                long j3 = cVarVe.n;
                                if (j > 0 && j2 < j && j3 <= 0 && System.currentTimeMillis() - j >= C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS) {
    ...
    private static void i(final Activity activity) {
        ...
        cVarVe.sp = i2;
        long j = ((long) i2) * C.DEFAULT_MAX_SEEK_TO_PREVIOUS_POSITION_MS;
        activity.hashCode();
        final WeakReference weakReference = new WeakReference(activity);
    ...
    private static boolean t(Activity activity) {
        return activity != null && n && activity.hashCode() == f2362a && my(activity).equals(sp);
    }
    ...
    public static String tt() {
        ...
        if (TextUtils.isEmpty(str) || System.currentTimeMillis() - j <= 604800000) {
            uj = str;
            return str;
        }
