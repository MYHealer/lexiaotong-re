...
public class n {
    ...
    public static Method f2360a = null;
    public static List<C0189n> c = null;
    ...
    /* JADX INFO: renamed from: com.byazt.iyp.n$1, reason: invalid class name */
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_FIX_PROCESS_TIMER, 219})
    static /* synthetic */ class AnonymousClass1 {
    }

    public static List<C0189n> ve() {
        return c;
    }

    static {
        AnonymousClass1 anonymousClass1 = null;
        t = new c(anonymousClass1);
        u = new uj(anonymousClass1);
    }
    ...
    public static boolean c() {
        ...
        for (C0189n c0189n : list) {
            if (c0189n == null || c0189n.tt == null || !c0189n.tt.isAttachedToWindow()) {
                return false;
            }
        }
        return true;
    ...
    public static tt c(Activity activity) {
        ...
        if (activity != null && activity.getWindow() != null) {
            ...
            List<C0189n> listC = c(viewGroupC);
            ttVar.uj = listC;
    ...
    public static class C0189n {
        public final int c;
        public final View tt;
        public final Rect uj;
        public String ve;

        public C0189n(int i, View view, String str, Rect rect) {
            this.c = i;
            this.tt = view;
            this.ve = str;
            this.uj = rect;
                    ...
                    if (rect.bottom >= 0.9d * d && rect.height() <= d * 0.2d) {
                        ...
                        while (true) {
                            if (it.hasNext()) {
                                ...
                                while (it2.hasNext()) {
                                    if (((View) it2.next()) instanceof ViewGroup) {
                                        return viewGroup;
                                    }
                                }
                                break;
                    ...
                    if (size >= 3 && size <= 6) {
                        ...
                        while (true) {
                            if (i10 < size) {
                                ...
                                while (it3.hasNext()) {
                                    if (((View) it3.next()) instanceof ViewGroup) {
                                        if (zC) {
                                            arrayList.size();
                                        }
                                        return viewGroup;
    ...
    private static List<C0189n> c(ViewGroup viewGroup) {
        ...
        for (int i2 = 0; i2 < listTt.size(); i2++) {
            ...
            arrayList.add(new C0189n(i2, view, tt(view), new Rect(rect)));
        }
        return arrayList;
    }
    ...
    private static boolean ve(String str) {
        ...
        return str.contains(c(new byte[]{-36, -82, -80, -33, 125, -121})) || str.contains(c(new byte[]{-33, -118, -100, -37, -82, 119})) || str.contains(c(new byte[]{-35, -100, -123, -37, 126, -97})) || str.contains(c(new byte[]{-34, -85, -112, -33, -120, -89})) || str.contains(c(new byte[]{-36, -123, -122, -35, -124, -90})) || str.contains(c(new byte[]{-35, -80, -104, -37, -126, 123})) || str.contains(c(new byte[]{-36, -86, -79, -37, -128, -98})) || str.contains(c(new byte[]{-38, -79, -79, -37, -128, -105})) || str.contains(c(new byte[]{-34, -85, -112}));
    }
    ...
    private static ve c(List<C0189n> list) {
        HashMap map;
        if (list == null || list.isEmpty()) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            C0189n c0189n = list.get(i4);
            boolean zVe = ve(c0189n.ve);
            uj ujVarVe = ve(c0189n.tt);
            if (ujVarVe.c) {
    ...
    private static uj ve(View view) {
        ...
        ujVar.c = false;
        c(view, ujVar);
        ujVar.c = ujVar.tt || ujVar.ve || ujVar.uj || ujVar.n || ujVar.f2361a;
        return ujVar;
    }
    ...
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_FIX_PROCESS_TIMER, 151})
    ...
    private static void tt(ViewGroup viewGroup, List<C0189n> list) {
        for (C0189n c0189n : list) {
            com.byazt.iyp.uj.c(c0189n.tt, c0189n);
        }
    }
