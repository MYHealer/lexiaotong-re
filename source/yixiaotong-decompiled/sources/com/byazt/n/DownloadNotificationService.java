...
public class DownloadNotificationService extends Service {
    ...
    public static volatile long f2486a = 0;
        ...
        spVar.c(new Runnable() { // from class: com.byazt.n.DownloadNotificationService.1
            ...
            public void run() {
                ...
                if (action.equals("android.net.conn.CONNECTIVITY_CHANGE")) {
                    try {
                        if (a.c((Context) DownloadNotificationService.this, g.b) && (connectivityManager = (ConnectivityManager) StubApp.getOrigApplicationContext(DownloadNotificationService.this.getApplicationContext()).getSystemService("connectivity")) != null && (activeNetworkInfo = connectivityManager.getActiveNetworkInfo()) != null && activeNetworkInfo.isConnected()) {
    ...
    public void c(final NotificationManager notificationManager, final int i2, Notification notification) {
        synchronized (this.sl) {
            ...
            long jCurrentTimeMillis = i - (System.currentTimeMillis() - f2486a);
            if (jCurrentTimeMillis <= 0) {
                jCurrentTimeMillis = 0;
            }
            if (jCurrentTimeMillis > SilenceSkippingAudioProcessor.DEFAULT_PADDING_SILENCE_US) {
                jCurrentTimeMillis = 20000;
            }
            long jCurrentTimeMillis2 = System.currentTimeMillis() + jCurrentTimeMillis;
            sp = jCurrentTimeMillis2;
            f2486a = jCurrentTimeMillis2;
            if (jCurrentTimeMillis <= 0) {
    ...
    public void tt(NotificationManager notificationManager, int i2, Notification notification) {
            ...
            try {
                ...
                if ((!z && tt == 0) || (z && ve == 0)) {
                    ...
                    if (uVarVe.sp() && !uVarVe.tt()) {
                        com.byazt.x.c.ve(c, "doNotify, startForeground, ======== id = " + i2 + ", isIndependentProcess = " + z);
                        if (z) {
                            ve = i2;
                        } else {
                            tt = i2;
                        ...
                        com.byazt.x.c.ve(c, "doNotify: canStartForeground = true, but proxy can not startForeground, isIndependentProcess = ".concat(String.valueOf(z)));
                    }
                }
            } catch (Throwable th) {
                m.c(th);
        ...
        try {
            ...
            if (f2486a < jCurrentTimeMillis) {
                f2486a = jCurrentTimeMillis;
            }
