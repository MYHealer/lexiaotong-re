...
public class n implements sp, com.byazt.hu.yp.c {
    ...
    public final Map<Integer, Object> f2259a;
    ...
    public n tt(int i, DownloadStatusChangeListener downloadStatusChangeListener) {
        if (downloadStatusChangeListener != null) {
            if (t.i().optInt("back_use_softref_listener") == 1) {
                this.f2259a.put(Integer.valueOf(i), downloadStatusChangeListener);
            } else if (t.i().optInt("use_weakref_listener") == 1) {
                this.f2259a.put(Integer.valueOf(i), new WeakReference(downloadStatusChangeListener));
            } else {
                this.f2259a.put(Integer.valueOf(i), new SoftReference(downloadStatusChangeListener));
            }
        }
        return this;
    }
    ...
    public void c() {
        ...
        this.ve.c(this.yp);
        m();
        if (t.i().optInt("enable_empty_listener", 1) == 1 && this.f2259a.get(Integer.MIN_VALUE) == null) {
    ...
    public boolean c(int i) {
        if (i == 0) {
            ...
            this.f2259a.remove(Integer.valueOf(i));
        }
        ...
        if (this.f2259a.size() == 1 && this.f2259a.containsKey(Integer.MIN_VALUE)) {
            this.ve.tt(this.x);
        }
        return false;
    }
    ...
    public void a() {
        this.tt.post(new Runnable() { // from class: com.byazt.gq.n.2
            ...
            public void run() {
                Iterator<DownloadStatusChangeListener> it = x.c((Map<Integer, Object>) n.this.f2259a).iterator();
                while (it.hasNext()) {
    ...
    public void c(Message message) {
        if (message != null && this.sl && message.what == 3) {
            ...
            this.ve.c(message, nu(), this.f2259a);
        }
    }
    ...
    public void c(boolean z, final boolean z2) {
        ...
        if (!com.byazt.hu.u.c()) {
            if (!com.byazt.hu.da.tt("android.permission.WRITE_EXTERNAL_STORAGE") && !u().enableNewActivity()) {
                this.z.setFilePath(this.ve.tt());
            }
        } else if (!com.byazt.hu.da.tt(PermissionUtil.PERSSION_READ_MEDIA_IMAGES) && !com.byazt.hu.da.tt(PermissionUtil.PERSSION_READ_MEDIA_AUDIO) && !com.byazt.hu.da.tt(PermissionUtil.PERSSION_READ_MEDIA_VIDEO) && !u().enableNewActivity()) {
            this.z.setFilePath(this.ve.tt());
        }
    ...
    private boolean z() {
        if (!com.byazt.k.c.ve().c("fix_click_start")) {
            ...
            return !(downloadInfo.getStatus() == -3 || Downloader.getInstance(t.getContext()).canResume(this.x.getId())) || this.x.getStatus() == 0;
        }
    ...
    public void x(boolean z) {
        Iterator<DownloadStatusChangeListener> it = x.c(this.f2259a).iterator();
        while (it.hasNext()) {
        ...
        public void onPostExecute(DownloadInfo downloadInfo) {
            ...
            try {
                ...
                if (downloadInfo != null && downloadInfo.getId() != 0 && (zC || !Downloader.getInstance(t.getContext()).isDownloadSuccessAndFileNotExist(downloadInfo))) {
                    ...
                    n.this.ve.c(n.this.x, n.this.nu(), x.c((Map<Integer, Object>) n.this.f2259a), zC);
                } else {
