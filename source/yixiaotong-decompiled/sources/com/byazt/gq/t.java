...
public class t {
    ...
    public static com.byazt.ou.x f2261a;
    ...
    public static boolean gr() {
        return (ve == null || f2261a == null || x == null || da == null || rl == null) ? false : true;
    }
    ...
    public static void tt(Context context) {
        if (tt != null || context == null || StubApp.getOrigApplicationContext(context.getApplicationContext()) == null) {
            return;
        }
        tt = StubApp.getOrigApplicationContext(context.getApplicationContext());
    }
    ...
    public static JSONObject i() {
        ...
        return (slVar == null || slVar.c() == null) ? c : x.c();
    }

    public static com.byazt.e.c da() {
        if (i == null) {
            i = new com.byazt.e.c.C0140c().c();
        }
        return i;
    }
