...
public class i extends c {
    ...
    public final LongSparseArray<LinearGradient> f2940a;
    public final int da;
    ...
    public i(com.byazt.ga.x xVar, com.byazt.zk.ve veVar, com.byazt.jx.a aVar) {
        ...
        this.f2940a = new LongSparseArray<>();
    ...
    private LinearGradient tt() {
        long jUj = uj();
        LinearGradient linearGradient = this.f2940a.get(jUj);
        ...
        this.f2940a.put(jUj, linearGradient2);
