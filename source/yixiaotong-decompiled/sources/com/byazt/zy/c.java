...
public abstract class c implements n, sl, com.byazt.dg.c.InterfaceC0132c {
    ...
    public final Path f2938a = new Path();
    public final RectF sp = new RectF();
    public final List<C0349c> i = new ArrayList();

    /* JADX INFO: renamed from: com.byazt.zy.c$1, reason: invalid class name */
    @com.byazt.zqa.c(c = {0, 1, 1698, 26})
    ...
    @Override // com.byazt.dg.c.InterfaceC0132c
    public void c() {
        ...
        for (int size2 = list2.size() - 1; size2 >= 0; size2--) {
            ...
            if (veVar2 instanceof rl) {
                ...
                if (rlVar3.getType() == com.byazt.jx.my.c.INDIVIDUALLY) {
                    ...
                    c0349c = new C0349c(rlVar3, anonymousClass1);
                    rlVar3.c(this);
                } else if (!(veVar2 instanceof u)) {
                    if (c0349c == null) {
                        c0349c = new C0349c(rlVar, anonymousClass1);
                    }
                    c0349c.c.add((u) veVar2);
                }
            } else if (!(veVar2 instanceof u)) {
                if (c0349c == null) {
                    c0349c = new C0349c(rlVar, anonymousClass1);
    ...
    public void c(Canvas canvas, Matrix matrix, int i) {
        ...
        for (int i2 = 0; i2 < this.i.size(); i2++) {
            C0349c c0349c = this.i.get(i2);
            if (c0349c.tt != null) {
                c(canvas, c0349c, matrix);
            } else {
                com.byazt.ga.n.c("StrokeContent#buildPath");
                this.n.reset();
                for (int size = c0349c.c.size() - 1; size >= 0; size--) {
                    this.n.addPath(((u) c0349c.c.get(size)).uj(), matrix);
                }
    ...
    private void c(Canvas canvas, C0349c c0349c, Matrix matrix) {
        float f;
        float f2;
        float fMin;
        ...
        float fFloatValue = c0349c.tt.tt().sp().floatValue() / 100.0f;
        float fFloatValue2 = c0349c.tt.ve().sp().floatValue() / 100.0f;
        float fFloatValue3 = c0349c.tt.uj().sp().floatValue() / 360.0f;
        ...
        float f5 = 0.0f;
        for (int size2 = c0349c.c.size() - 1; size2 >= 0; size2--) {
            this.f2938a.set(((u) c0349c.c.get(size2)).uj());
            this.f2938a.transform(matrix);
            this.uj.setPath(this.f2938a, false);
            ...
            if (fMin2 > length) {
                ...
                if (f6 >= f5 + length2 || f5 >= f6) {
                    ...
                    if (f < f4 && f5 <= fMin2) {
                        if (f > fMin2 || f4 >= f5) {
                            ...
                            canvas.drawPath(this.f2938a, this.tt);
                        }
                    }
                } else {
                ...
                com.byazt.kk.da.c(this.f2938a, f2, fMin, 0.0f);
                canvas.drawPath(this.f2938a, this.tt);
            } else {
                f = f5 + length2;
                if (f < f4) {
    ...
    public void c(RectF rectF, Matrix matrix, boolean z) {
        ...
        for (int i = 0; i < this.i.size(); i++) {
            C0349c c0349c = this.i.get(i);
            for (int i2 = 0; i2 < c0349c.c.size(); i2++) {
                this.n.addPath(((u) c0349c.c.get(i2)).uj(), matrix);
            }
        }
    ...
    private static final class C0349c {
        ...
        public /* synthetic */ C0349c(rl rlVar, AnonymousClass1 anonymousClass1) {
            this(rlVar);
        }

        private C0349c(rl rlVar) {
