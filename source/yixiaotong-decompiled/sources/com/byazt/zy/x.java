...
public class x implements n, sl, com.byazt.dg.c.InterfaceC0132c {
    public float c;
    ...
    public final LongSparseArray<RadialGradient> f2947a = new LongSparseArray<>();
    ...
    private RadialGradient ve() {
        long jUj = uj();
        RadialGradient radialGradient = this.f2947a.get(jUj);
        ...
        this.f2947a.put(jUj, radialGradient2);
