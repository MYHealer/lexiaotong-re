...
public class tt {
    ...
    public interface InterfaceC0198tt {
        void c();
    ...
    public void c() {
        ...
        if (rl.tt(this.tt)) {
            this.t = new com.byazt.ac.ve(this.c, this.tt, this.ve, this.n, this.f2405a, this.uj, this.sp);
        }
        if (!TextUtils.isEmpty(xd.i(this.tt)) && !gt.tt().qi()) {
            this.sl = new com.byazt.ac.tt(this.c, this.tt, this.ve, this.n, this.f2405a, this.uj, this.sp);
        }
    ...
    public void c(com.byazt.ua.c cVar) {
        ...
        if (veVar != null) {
            ...
            this.t.c(new InterfaceC0198tt() { // from class: com.byazt.kcl.tt.2
                @Override // com.byazt.kcl.tt.InterfaceC0198tt
                public void c() {
    ...
    public void yp() {
        ...
        if (this.yp == null && gt.tt().qi() && !TextUtils.isEmpty(xd.i(this.tt))) {
            com.byazt.ac.tt ttVar = new com.byazt.ac.tt(this.c, this.tt, this.ve, this.n, this.f2405a, this.uj, this.sp);
            this.sl = ttVar;
    ...
    private void c(long j) {
        ...
        if (!kp.nu(this.tt)) {
            if (i > 0) {
                this.x.c(false, i + "s", null, false, false);
            } else {
    ...
    public void c(ic icVar, com.byazt.hkv.tt ttVar) {
        ...
        if (rl.tt(icVar)) {
            if (this.t == null) {
                this.t = new com.byazt.ac.ve(this.c, icVar, this.ve, this.n, this.f2405a, this.uj, this.sp);
            }
            com.byazt.ac.ve veVar = this.t;
            this.yp = veVar;
            ...
            this.t.c(new InterfaceC0198tt() { // from class: com.byazt.kcl.tt.7
                @Override // com.byazt.kcl.tt.InterfaceC0198tt
                public void c() {
                    tt.this.c.tt(true, true);
                }
    ...
    private void ic() {
        try {
            ...
            float[] fArrC = com.byazt.biq.tt.c(StubApp.getOrigApplicationContext(this.c.getApplicationContext()), this.tt.fr(), this.tt.by());
            float f = fArrC[0];
            float f2 = fArrC[1];
            ...
            int[] iArrC = com.byazt.biq.tt.c(StubApp.getOrigApplicationContext(this.c.getApplicationContext()), this.tt.fr(), this.tt.qe(), this.tt.by());
            int i = iArrC[0];
            int i2 = iArrC[1];
            int i3 = iArrC[2];
            int i4 = iArrC[3];
