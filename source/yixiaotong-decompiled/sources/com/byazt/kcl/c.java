...
public class c {
    ...
    private void x() {
        ic icVar = this.f2403a;
        if (icVar == null || icVar.i() != 4) {
            return;
        }
        this.tt = x.c(this.n, this.f2403a, this.sp);
    }

    public void c() {
        ic icVar;
        if (this.tt == null && (icVar = this.f2403a) != null && icVar.i() == 4) {
            this.tt = x.c(this.n, this.f2403a, this.sp);
        }
    }
    ...
    public void c(String str, boolean z) {
        if (this.c.containsKey(str)) {
            ...
            if (veVar != null) {
                if (z) {
                    veVar.c(com.byazt.wz.x.c(this.f2403a));
                }
                ...
                veVar.c(nb.qy(this.f2403a), false);
                return;
            }
            return;
        }
        com.byazt.pop.ve veVarC = x.c(this.n, str, this.f2403a, this.sp);
        if (z) {
            veVarC.c(com.byazt.wz.x.c(this.f2403a));
        }
        ...
        veVarC.c(nb.qy(this.f2403a), false);
    }

    public void c(final InterfaceC0197c interfaceC0197c) {
            ...
            public boolean c(int i, String str, String str2, String str3, Object obj) {
                if (i == 1 && !TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str3)) {
                    ...
                    if (z && str3.equals("click_start")) {
                        interfaceC0197c.c(c.this.ve, new da());
                        c.this.ve = null;
                        return true;
                    }
                    if (z) {
                        ...
                        if (str3.equals("click_continue")) {
                            com.byazt.ddx.uj.tt(c.this.f2403a, str2, "click_play_continue", (Map<String, Object>) null);
                        } else if (str3.equals("click_pause")) {
                            com.byazt.ddx.uj.tt(c.this.f2403a, str2, "click_play_pause", (Map<String, Object>) null);
                            return true;
                        }
                    }
                }
    ...
    public void c(View view, InterfaceC0197c interfaceC0197c, da daVar) {
        if (this.tt != null && view != null) {
            if (view.getId() == 2114387609) {
                interfaceC0197c.c("click_play_star_level", (JSONObject) null);
                return;
            }
            if (view.getId() == 2114387630) {
                interfaceC0197c.c("click_play_star_nums", (JSONObject) null);
                return;
            } else if (view.getId() == 2114387875) {
                interfaceC0197c.c("click_play_source", (JSONObject) null);
                return;
            } else {
                if (view.getId() == 2114387793) {
                    interfaceC0197c.c("click_play_logo", (JSONObject) null);
                    return;
                }
                return;
            }
        }
        interfaceC0197c.c(view, daVar);
    }
    ...
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_PRIMING_WORK_AROUND, 187})
    ...
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_PRIMING_WORK_AROUND, 132})
