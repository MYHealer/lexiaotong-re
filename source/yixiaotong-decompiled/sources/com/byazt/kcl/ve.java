...
public class ve {
    ...
    public void c() {
        ...
        com.byazt.ddx.uj.c(this.tt, this.ve, dd.F, new com.byazt.ya.c() { // from class: com.byazt.kcl.ve.1
    ...
    public void c(boolean z, int i, long j) {
        new com.byazt.ddx.c.C0129c().n(this.tt.uj()).c(this.ve).tt(z ? "scroll_up" : "scroll_down").uj(this.tt.w_()).c(new c(i, j, c(new JSONObject())));
    }
    ...
    private static class c implements com.byazt.ya.c {
        ...
        public void onSend(JSONObject jSONObject) throws JSONException {
            ...
            jSONObject2.put("duration", this.tt);
    ...
    public com.byazt.ddx.n n() {
        if (this.f2407a == null) {
            this.f2407a = new com.byazt.ddx.n(this.tt, this.ve);
        }
        return this.f2407a;
    }
}
