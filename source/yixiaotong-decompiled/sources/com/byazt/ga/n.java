...
public class n {
    ...
    public static long[] f2243a = null;
    ...
    public static float tt(String str) {
        ...
        if (!str.equals(n[i3])) {
            throw new IllegalStateException("Unbalanced trace call " + str + ". Expected " + n[sp] + ".");
        }
        Trace.endSection();
        return (System.nanoTime() - f2243a[sp]) / 1000000.0f;
    }
                ...
                if (spVar == null) {
                    ...
                    if (nVar == null) {
                        nVar = new com.byazt.xy.n() { // from class: com.byazt.ga.n.1
                            ...
                            public File c() {
                                return new File(com.byazt.nys.tt.tt(origApplicationContext), "lottie_network_cache");
                            }
                        };
                    }
