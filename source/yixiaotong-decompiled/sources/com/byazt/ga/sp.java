...
@com.byazt.zqa.c(c = {0, 1, 256, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp {
    ...
    public static u<a> tt(Context context, final String str, final String str2) {
        ...
        return c(str2, new Callable<t<a>>() { // from class: com.byazt.ga.sp.4
            ...
            @Override // java.util.concurrent.Callable
            public t<a> call() throws Exception {
                return sp.ve(origApplicationContext, str, str2);
            }
        });
    }
    ...
    public static u<a> c(Context context, final int i, final String str) {
        ...
        return c(str, new Callable<t<a>>() { // from class: com.byazt.ga.sp.5
            ...
            public t<a> call() throws Exception {
                ...
                if (context2 == null) {
                    context2 = origApplicationContext;
                }
                    ...
                    if (name.contains("../")) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (!file.delete()) {
                                    com.byazt.kk.a.tt("Failed to delete temp font file " + file.getAbsolutePath() + ".");
                                }
