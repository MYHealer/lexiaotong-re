...
public class a {
    ...
    public static n c(Context context) {
        ...
        Context context2 = context == null ? com.byazt.bp.tt.getContext() : StubApp.getOrigApplicationContext(context.getApplicationContext());
        if (context2 == null) {
            return null;
        }
        ...
        int iC = com.byazt.ka.tt.c(context2, "android.permission.ACCESS_FINE_LOCATION");
