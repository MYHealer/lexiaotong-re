...
public class DynamicTextView extends DynamicBaseWidgetImp {
    ...
    private void da() {
        int iC;
        if (TextUtils.equals(this.u.da().getType(), ba.at) || TextUtils.equals(this.u.da().getType(), "title") || TextUtils.equals(this.u.da().getType(), "text_star")) {
            ...
            if (TextUtils.equals(this.u.da().getType(), ba.at) && (iC = ((this.x - ((int) com.byazt.or.x.c(getContext(), this.t.n()))) - iC2) - iC5) > 1 && iC <= iMin * 2) {
                int i = iC / 2;
    ...
    public String getText() {
        ...
        return (TextUtils.equals(this.u.da().getType(), "title") || TextUtils.equals(this.u.da().getType(), MediaFormat.KEY_SUBTITLE)) ? strA.replace(IOUtils.LINE_SEPARATOR_UNIX, "") : strA;
    }
