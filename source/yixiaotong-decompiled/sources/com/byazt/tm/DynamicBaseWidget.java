...
public abstract class DynamicBaseWidget extends FrameLayout implements com.byazt.nwh.tt, n, uj {
    ...
    public DynamicBaseWidget(Context context, DynamicRootView dynamicRootView, x xVar) {
        ...
        this.x = (int) com.byazt.or.x.c(this.sl, this.f2748a);
    ...
    public void c(View view) {
        try {
            ...
            jSONObject.put("width", this.u.x());
            jSONObject.put("height", this.u.i());
    ...
    private void i() {
        if (isShown()) {
            ...
            if (iC == 2) {
                if (this.rl == null) {
                    this.rl = new zm(StubApp.getOrigApplicationContext(getContext().getApplicationContext()), 1, this.qy);
                }
                ...
                if (this.rl == null) {
                    this.rl = new zm(StubApp.getOrigApplicationContext(getContext().getApplicationContext()), 2, this.qy);
                }
