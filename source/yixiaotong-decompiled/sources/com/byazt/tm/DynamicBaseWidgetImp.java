...
public class DynamicBaseWidgetImp extends DynamicBaseWidget {
    ...
    public boolean x() {
        ...
        String strYv = null;
        String strC = (TextUtils.isEmpty(strYf) || this.yp == null || this.yp.getRenderRequest() == null || this.yp.getRenderRequest().n() == null || (jSONObjectOptJSONObject = this.yp.getRenderRequest().n().optJSONObject(ClickAreaSource.CREATIVE)) == null) ? null : c(jSONObjectOptJSONObject.opt(strYf));
        ...
        if (this.t.gt()) {
            ...
            if (!strC.startsWith(UrlConst.HTTP) && !strC.startsWith(UrlConst.HTTPS)) {
