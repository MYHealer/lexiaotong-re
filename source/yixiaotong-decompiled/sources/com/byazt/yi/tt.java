...
public class tt extends sl {
    ...
    public void setDownloadListener(com.byazt.ocd.ve veVar) {
        this.z = com.byazt.pop.c.C0251c.c(veVar);
    }
    ...
    public void showFullScreenVideoAd(Activity activity) {
        ...
        ic icVar2 = this.tt;
        new com.byazt.ddx.c.C0129c().n(icVar2 != null ? icVar2.uj() : "0").c("fullscreen_interstitial_ad").tt("show_start").uj(strW_).c((com.byazt.ya.c) null);
