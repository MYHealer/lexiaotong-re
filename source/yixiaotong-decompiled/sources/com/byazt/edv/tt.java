...
public class tt {
    ...
    private static long tt(InputStream inputStream, OutputStream outputStream) {
    ...
    public static boolean c(HashMap<String, HashMap<String, byte[]>> map, String str) {
        try {
