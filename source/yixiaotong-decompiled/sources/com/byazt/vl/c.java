...
public class c extends com.byazt.iw.c {
    ...
    public final List<String> f2816a;
    ...
    public List<String> c() {
        this.f2816a.add("d_i0");
        this.f2816a.add("d_a0");
        return this.f2816a;
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(strC)) {
                        jSONObject2.putOpt(CrashHianalyticsData.MESSAGE, "ok");
    ...
    public void tt(final JSONObject jSONObject) {
        ...
        com.byazt.ww.c.c(new Runnable() { // from class: com.byazt.vl.c.2
            ...
            public void run() {
                JSONObject jSONObject3 = new JSONObject();
                try {
                    jSONObject.putOpt(am.ai, Build.MODEL);
