...
@com.byazt.zqa.c(c = {0, 1, 154, 20})
public class c implements com.byazt.aas.c.tt {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final HashSet f2439a;
    ...
    static {
        ...
        n = new HashMap<>();
        f2439a = new HashSet(Arrays.asList("dalvik.system.VMStack.getThreadStackTrace", "java.lang.Thread.getStackTrace", name));
    }
    ...
    private JSONArray c(Object obj) {
        ...
        for (StackTraceElement stackTraceElement : (StackTraceElement[]) obj) {
            if (stackTraceElement != null && !f2439a.contains(stackTraceElement.getClassName() + "." + stackTraceElement.getMethodName())) {
