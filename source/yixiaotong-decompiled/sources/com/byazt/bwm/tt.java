...
public final class tt {
    ...
    public static ScheduledExecutorService ve(ThreadFactory threadFactory) {
        return new ScheduledExecutorServiceC0103tt(new ScheduledThreadPoolExecutor(1, threadFactory));
    }
    ...
    @com.byazt.zqa.c(c = {0, 1, 33, 240})
    protected static class ScheduledExecutorServiceC0103tt extends c implements ScheduledExecutorService {
        public final ScheduledExecutorService c;

        public ScheduledExecutorServiceC0103tt(ScheduledExecutorService scheduledExecutorService) {
