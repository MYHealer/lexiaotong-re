...
public class c extends com.byazt.n.c {
    ...
    public c(Context context, int i, String str, String str2, String str3, String str4) {
        ...
        this.tt = origApplicationContext;
        this.ve = origApplicationContext.getResources();
    }
    ...
    public void c(DownloadInfo downloadInfo) {
        ...
        this.f2615a = downloadInfo.getExtra();
    }
 ...
 binds: [B:93:0x029c, B:95:0x029f, B:96:0x02a1, B:66:0x01fe] A[DONT_GENERATE, DONT_INLINE]
  ...
  0x020b: PHI (r20v5 java.lang.Object) = (r20v2 java.lang.Object), (r20v2 java.lang.Object), (r20v2 java.lang.Object), (r20v7 java.lang.Object) binds: [B:93:0x029c, B:95:0x029f, B:96:0x02a1, B:66:0x01fe] A[DONT_GENERATE, DONT_INLINE]] */
    private Notification c(com.byazt.s.ve veVar, BaseException baseException, boolean z) {
        ...
        map.put(a.hnadsh, Integer.valueOf(iC));
        int iC2 = c();
        ...
        if (iC == 1 || iC == 4) {
            ...
            cVar2 = this;
            map.put("is_bind_app", Boolean.valueOf(com.byazt.z.ve.c(cVar2.f2615a)));
        } else if (iC == 2) {
            map.put("download_size", com.byazt.z.ve.c(jTt) + "/" + com.byazt.z.ve.c(jVe));
            if (iTt == 1) {
                map.put("progress_70", Integer.valueOf(cVarC.c("noti_progress_show_th", 70)));
            }
            map.put("is_bind_app", Boolean.valueOf(com.byazt.z.ve.c(this.f2615a)));
            if (!com.byazt.z.ve.c(this.f2615a) && iTt2 >= 2) {
            ...
            if (iN2 == -1 || iN2 == -4) {
                cVar = cVarC;
                boolean zI = com.byazt.w.a.i(baseException);
                boolean zX = com.byazt.w.a.x(baseException);
                ...
                if (baseException2 != null) {
                    ...
                    if (iTt2 < 2 && iN2 == -1 && zI) {
                        ...
                        map.put(obj2, Boolean.valueOf(com.byazt.w.a.tt(baseException2, downloadInfo)));
                    } else {
                        obj2 = "is_wait_wifi_and_in_net";
                    }
                } else {
            ...
            boolean zI2 = com.byazt.w.a.i(baseException);
            boolean zX2 = com.byazt.w.a.x(baseException);
            ...
            if (iTt2 >= 2 && iN2 == -1 && (zI2 || zX2)) {
                boolean zTt = com.byazt.w.a.tt(baseException2, downloadInfo);
