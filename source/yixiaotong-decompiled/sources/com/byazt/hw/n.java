...
public class n {
    ...
    public synchronized void c(Context context, boolean z) {
        if (!this.f2316a) {
            if (context != null) {
                this.sp = StubApp.getOrigApplicationContext(context.getApplicationContext());
            }
            this.nu = z;
        ...
        if (this.nu) {
            if (com.byazt.lf.a.c(this.sp)) {
                ...
                if ("http".equals(protocol) || "https".equals(protocol)) {
                    ...
                    com.byazt.lf.ve.tt("TNCManager", "onResponse, url matched: " + protocol + "://" + host + "#" + strC + "#" + iVe + PPSLabelView.Code + this.sl + "#" + this.t.size() + "#" + this.u.size() + PPSLabelView.Code + this.yp + "#" + this.z.size() + "#" + this.m.size());
                    if (iVe > 0) {
                        if (c(iVe)) {
                ...
                if (this.nu) {
                    if (com.byazt.lf.a.c(this.sp)) {
                        ...
                        if ("http".equals(protocol) || "https".equals(protocol)) {
                            ...
                            com.byazt.lf.ve.tt("TNCManager", "onError, url matched: " + protocol + "://" + host + "#" + strC + "# " + this.sl + "#" + this.t.size() + "#" + this.u.size() + PPSLabelView.Code + this.yp + "#" + this.z.size() + "#" + this.m.size());
                            this.sl++;
                            this.t.put(path, 0);
                            this.u.put(strC, 0);
                            if (this.sl >= veVarA.n && this.t.size() >= veVarA.f2317a && this.u.size() >= veVarA.sp) {
    ...
    private void c(com.byazt.gqp.m mVar, String str) {
        ...
        if (mVar != null && this.nu) {
            ...
            com.byazt.lf.ve.tt("TNCManager", "handleTncProbe, local: " + this.i + "@" + this.da + " svr: " + i + "@" + j + PPSLabelView.Code + str);
            if (j <= this.da) {
                return;
            }
            this.i = i;
            ...
            com.byazt.lf.ve.tt("TNCManager", "handleTncProbe, updateConfig delay: " + jNextInt + PPSLabelView.Code + str);
            c(true, jNextInt);
        }
    }
