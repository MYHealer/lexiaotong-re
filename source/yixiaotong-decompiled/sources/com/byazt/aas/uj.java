...
public class uj {
    ...
    public static void c(com.byazt.ete.c cVar, int i, int i2, String str) {
        ...
        try {
            ...
            for (ic icVar : listTt) {
                ...
                jSONObject.put(CrashHianalyticsData.MESSAGE, strTt);
        ...
        if (!TextUtils.isEmpty(strOptString)) {
            try {
                if (strOptString.contains("pre_fetch_time")) {
                    strOptString = new JSONObject(strOptString).optString(CrashHianalyticsData.MESSAGE);
                }
    ...
    @com.byazt.zqa.c(c = {0, 1, 131, AppTypeIdUtil.NewDevice4GBathOTA})
