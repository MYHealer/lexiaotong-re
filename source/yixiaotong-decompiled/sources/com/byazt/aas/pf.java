...
public class pf {
    ...
    public static volatile int f1960a = -1;
    ...
    private static boolean sp() {
        return tt < 0.0f || ve < 0 || uj < 0.0f || n < 0 || f1960a < 0;
    }
    ...
    public static void c(Context context) {
        ...
        if (sp()) {
            ...
            f1960a = displayMetrics.heightPixels;
        }
    ...
    public static JSONObject c(JSONObject jSONObject, String str) {
        ...
        try {
            ...
            if (!jSONObject.has("lock_scene")) {
                jSONObject.put("lock_scene", !c() ? 1 : 0);
            }
