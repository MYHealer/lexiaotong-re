...
public class DeviceUtils {
    ...
    public static volatile long f1955a = -1;
    ...
    public static class DeviceStatusBroadCastReceiver extends BroadcastReceiver {
        ...
        public void c(Intent intent) {
            ...
            if ("android.intent.action.BATTERY_CHANGED".equals(intent.getAction())) {
                ...
                c.tt = (intent.getIntExtra("level", -1) * 100) / intent.getIntExtra("scale", -1);
            ...
            if (com.huawei.openalliance.ad.constant.x.co.equals(intent.getAction()) && intExtra == 3) {
                com.byazt.nr.da.c().post(new com.byazt.bwm.sp("tt_vol") { // from class: com.byazt.aas.DeviceUtils.DeviceStatusBroadCastReceiver.2
                    @Override // java.lang.Runnable
                    public void run() {
                        int i;
                        try {
                            AudioManager audioManager = (AudioManager) com.byazt.omf.gt.getContext().getSystemService("audio");
    ...
    public static void uj(Context context) {
        if (!x) {
            try {
                ...
                StubApp.getOrigApplicationContext(context.getApplicationContext()).registerReceiver(da, intentFilter);
                x = true;
            } catch (Throwable unused) {
            }
        }
        ...
        com.byazt.cb.c cVar = new com.byazt.cb.c(com.byazt.omf.gt.getContext(), com.byazt.nr.da.tt(), new com.byazt.cb.c.InterfaceC0120c() { // from class: com.byazt.aas.DeviceUtils.1
            @Override // com.byazt.cb.c.InterfaceC0120c
    ...
    public static JSONObject c(int i2, boolean z2) {
        ...
        try {
            ...
            jSONObject.put("name", com.byazt.omf.x.m().qy());
            tt(jSONObject);
    ...
    private static void tt(JSONObject jSONObject) {
        try {
            jSONObject.put("package_name", nb.x());
    ...
    public static long i() {
        return f1955a != -1 ? f1955a : com.byazt.by.uj.c().tt("dev19", -1L);
    }
    ...
    public static void sl() {
        try {
            if (x && da != null) {
                StubApp.getOrigApplicationContext(com.byazt.omf.gt.getContext().getApplicationContext()).unregisterReceiver(da);
            }
        } catch (Throwable th) {
            com.byazt.nr.m.c(th);
        }
