...
public class c implements Application.ActivityLifecycleCallbacks {
    ...
    public volatile CopyOnWriteArrayList<InterfaceC0093c> t = new CopyOnWriteArrayList<>();
    ...
    @com.byazt.zqa.c(c = {0, 1, 131, 132})
    public static abstract class ve implements InterfaceC0093c {
        @Override // com.byazt.aas.c.InterfaceC0093c
        public void c() {
        }
    ...
    public void c(InterfaceC0093c interfaceC0093c) {
        this.uj = interfaceC0093c;
    }
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        Iterator<InterfaceC0093c> it = this.t.iterator();
        while (it.hasNext()) {
            it.next();
        }
        try {
    ...
    public void c(Activity activity, String str, Window window) {
        ...
        for (InterfaceC0093c interfaceC0093c : this.t) {
            if (interfaceC0093c != null) {
                interfaceC0093c.c(str, window);
            }
        }
        pf.n(activity);
    }
    ...
    public void tt(InterfaceC0093c interfaceC0093c) {
        if (this.t.contains(interfaceC0093c)) {
            return;
        }
        this.t.add(interfaceC0093c);
    }
