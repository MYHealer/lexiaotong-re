...
public class i implements com.byazt.kkb.ve {
    ...
    private void rl() {
        this.f2040a = xd.i(this.rh);
        float fFr = this.rh.fr();
        if (TextUtils.isEmpty(this.f2040a)) {
            return;
        }
        if (this.yv == 1) {
            if (this.f2040a.contains("?")) {
                this.f2040a += "&orientation=portrait";
            } else {
                this.f2040a += "?orientation=portrait";
            }
        }
        if (this.f2040a.contains("?")) {
            this.f2040a += "&height=" + this.md + "&width=" + this.p + "&aspect_ratio=" + fFr;
        } else {
            this.f2040a += "?height=" + this.md + "&width=" + this.p + "&aspect_ratio=" + fFr;
        }
        this.f2040a = com.byazt.biq.c.c(this.f2040a);
    }
    ...
    public void ve() {
        ...
        com.byazt.jwd.uj ujVar = new com.byazt.jwd.uj(this.c, this.uj, this.rh.uj(), this.x) { // from class: com.byazt.cj.i.13
            ...
            public void onReceivedHttpError(WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
                ...
                if (i.this.f2040a.equals(String.valueOf(webResourceRequest.getUrl()))) {
                    if (webResourceRequest.isForMainFrame()) {
                        i.this.u.set(false);
                    }
