...
@com.byazt.ls.tt
@com.byazt.zqa.c(c = {0, 1, 55, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public class sp implements com.byazt.kkb.ve {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @com.byazt.ls.c(c = "download_popup_manager")
    public com.byazt.yzg.ve f2043a;
    ...
    public boolean c(Map<String, Object> map, Map<String, Object> map2, com.byazt.cq.c cVar) {
        ...
        com.byazt.bb.uj ujVar = new com.byazt.bb.uj(this.c, this.tt, this.uj, this.f2043a, this.da, this.z, map2, false);
        ujVar.tt(this.i);
        ujVar.c(this.x, iUj);
        ujVar.c(this.n);
        ujVar.c(this.ve);
    ...
    private boolean c() {
        ...
        return (TextUtils.isEmpty(this.uj) || this.f2043a == null) ? false : true;
    }
}
