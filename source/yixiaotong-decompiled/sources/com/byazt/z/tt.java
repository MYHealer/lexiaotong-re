...
public class tt {
    ...
    /* JADX WARN: Code duplicated, block: B:91:0x015f A[PHI: r15
  0x015f: PHI (r15v13 com.byazt.z.c) = (r15v2 com.byazt.z.c), (r15v8 com.byazt.z.c), (r15v14 com.byazt.z.c) binds: [B:90:0x015d, B:80:0x0135, B:60:0x00e8] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:92:0x0161  */
    /* JADX WARN: Code duplicated, block: B:98:0x0182 A[DONT_INVERT, PHI: r0 r1
  0x0182: PHI (r0v2 boolean) = 
  (r0v0 boolean)
  (r0v0 boolean)
  (r0v0 boolean)
  (r0v0 boolean)
  ...
  (r0v0 boolean)
  (r0v0 boolean)
 binds: [B:43:0x0086, B:96:0x0173, B:88:0x0150, B:84:0x013e, B:76:0x0123, B:74:0x011b, B:70:0x0108, B:66:0x00fb, B:91:0x015f, B:63:0x00f0, B:68:0x0104, B:54:0x00ca, B:58:0x00dc, B:47:0x00a3] A[DONT_GENERATE, DONT_INLINE]
  0x0182: PHI (r1v1 com.byazt.z.c) = 
  (r1v0 com.byazt.z.c)
  (r1v0 com.byazt.z.c)
  (r1v0 com.byazt.z.c)
  (r1v0 com.byazt.z.c)
 ...
 binds: [B:43:0x0086, B:96:0x0173, B:88:0x0150, B:84:0x013e, B:76:0x0123, B:74:0x011b, B:70:0x0108, B:66:0x00fb, B:91:0x015f, B:63:0x00f0, B:68:0x0104, B:54:0x00ca, B:58:0x00dc, B:47:0x00a3] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            if (!TextUtils.isEmpty(strOptString)) {
                ...
                switch (strOptString) {
                    ...
                    case "plan_b":
                        ...
                        break;
                    case "plan_c":
                        if ((jSONObject.optInt("enable_for_all", 0) != 1 && !z) || jSONObject.optInt("show_unknown_source_on_startup") == 1) {
                            if (z2) {
                                downloadInfo.getTempCacheData().put("ah_attempt", cVar.c());
                            }
                            if (tt != null) {
                    ...
                    case "plan_g":
                        ...
                        break;
                    case "plan_h":
                        String strC = com.byazt.i.ve.c(cVarC2.ve("bh"), cVarC2.ve("s"));
    ...
    public static boolean c(Context context, Intent intent, int i, JSONObject jSONObject) {
        try {
            ...
            if (context.getApplicationInfo().targetSdkVersion >= 26 && !n(context)) {
                ...
                if (ttVar.c()) {
                    c(context, intent, i, jSONObject, new InterfaceC0340tt() { // from class: com.byazt.z.tt.2
                        @Override // com.byazt.z.tt.InterfaceC0340tt
    ...
    static class AnonymousClass1 implements InterfaceC0340tt {
        @Override // com.byazt.z.tt.InterfaceC0340tt
    ...
    private static void uj(int i, JSONObject jSONObject) {
        ...
        try {
            jSONObject2.put(com.hihonor.adsdk.base.g.j.e.a.InterfaceC0437a.hnadsd, i2);
        } catch (Exception e) {
            m.c(e);
        }
    ...
    public static void tt(int i, boolean z, boolean z2) {
        ...
        int i2 = 1;
        try {
            jSONObject.put(com.hihonor.adsdk.base.g.j.e.a.InterfaceC0437a.hnadsd, z ? 1 : 2);
            if (!z2) {
                i2 = 2;
            }
    ...
    private static void c(Context context, Intent intent, int i, JSONObject jSONObject, InterfaceC0340tt interfaceC0340tt) {
        if (ve != null) {
            com.byazt.g.c.c().tt(ve);
            ve = null;
        }
        ve = new c(context, intent, i, jSONObject, interfaceC0340tt);
    ...
    private static class uj implements Callable<Boolean> {
        ...
        public final InterfaceC0340tt tt;
        public final long uj;
        public final Handler ve;

        public uj(Handler handler, Context context, InterfaceC0340tt interfaceC0340tt, long j) {
            this.c = context;
            this.tt = interfaceC0340tt;
            this.ve = handler;
            this.uj = j;
        }
        ...
        public Boolean call() throws Exception {
            try {
                InterfaceC0340tt interfaceC0340tt = this.tt;
                if (interfaceC0340tt != null) {
                    long j = this.uj;
                    if (j > 0 && j <= ILivePlayer.RETRY_TIME_INTERVAL_DEFAULT) {
                        Context context = this.c;
                        boolean zC = context != null ? interfaceC0340tt.c(context) : false;
    ...
    private static class c implements com.byazt.g.c.InterfaceC0156c {
        public final n c;
        public final int tt;
        public JSONObject ve;

        public c(Context context, Intent intent, int i, JSONObject jSONObject, InterfaceC0340tt interfaceC0340tt) {
            this.ve = jSONObject;
            int iOptInt = jSONObject.optInt("query_interval", 1000);
            this.tt = iOptInt;
            this.c = new n(context, intent, i, interfaceC0340tt, iOptInt);
        }
        ...
        public void tt() {
            if (!this.c.i) {
                Message messageObtain = Message.obtain();
                messageObtain.what = 2;
                this.c.f2911a.sendMessage(messageObtain);
            }
        ...
        public void ve() {
            ...
            this.c.f2911a.sendMessageDelayed(messageObtain2, iOptInt * 1000);
        }
    }
    ...
    private static class n implements x.c {
        ...
        public final InterfaceC0340tt n;
        public final long sp;
        public final Intent uj;
        public final Context ve;
        public Future<Boolean> x;

        public n(Context context, Intent intent, int i, InterfaceC0340tt interfaceC0340tt, long j) {
            this.ve = context;
            this.uj = intent;
            tt = i;
            this.n = interfaceC0340tt;
            this.f2911a = new x(Looper.getMainLooper(), this);
            this.sp = j;
        }
        ...
        public void c(Message message) {
            if (message != null) {
                if (message.what == 1) {
                    ...
                    c = 1;
                    this.x = com.byazt.zz.ve.t().submit(new uj(this.f2911a, this.ve, this.n, this.sp));
                    return;
                }
                if (message.what == 2) {
                    c = 2;
