...
public class uj {
    ...
    public int c(n nVar) {
        ...
        try {
            ...
            String str2 = strVe;
            if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(strBx)) {
                String strL = nVar.l();
                if (TextUtils.isEmpty(strL)) {
                    strL = strC;
                }
                int iC = com.byazt.zz.ve.c(strL, str2);
                ...
                boolean zPf = nVar.pf();
                boolean z2 = (com.byazt.k.c.c(iC).c("modify_force", 1) == 1 && !zPf && com.byazt.w.a.uj(str2, strBx) && Downloader.getInstance(nVar.getContext()).getDownloadInfo(iC) == null) ? true : zPf;
                ...
                if (iDownloadListenerDa == null && (nVar.n() || nVar.a())) {
                    if (nVar.yp() != null) {
                        ...
                        iDownloadListenerDa = new com.byazt.p.tt(nVar.getContext(), iC, strTt, str2, strBx, nVar.sl());
                    }
                }
                yp ypVarAw = nVar.aw();
                if (ypVarAw == null) {
                ...
                if (autoInstall != null) {
                    if (z3 && nVar.lo() && nVar.getActivity() != null && !nVar.getActivity().isFinishing() && !com.byazt.p.uj.c()) {
                        final String str3 = strTt;
                        com.byazt.p.uj.c(nVar.getActivity(), new com.byazt.s.yp() { // from class: com.byazt.z.uj.5
                            @Override // com.byazt.s.yp
                            public void c() {
                                com.byazt.x.c.tt(uj.c, "notification permission granted, start download :" + str3);
                                uj.this.c(autoInstall, iMy, z);
                            }

                            @Override // com.byazt.s.yp
                            public void tt() {
                                com.byazt.x.c.tt(uj.c, "notification permission denied, start download :" + str3);
                                uj.this.c(autoInstall, iMy, z);
                            }
                        });
                    } else {
