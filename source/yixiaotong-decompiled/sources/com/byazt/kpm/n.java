...
public class n<K, V> {
    ...
    public int c(Object obj, int i) {
        ...
        if (iC < 0 || obj.equals(this.f2419a[iC << 1])) {
            return iC;
        }
        int i3 = iC + 1;
        while (i3 < i2 && this.n[i3] == i) {
            if (obj.equals(this.f2419a[i3 << 1])) {
                return i3;
            }
            i3++;
        }
        for (int i4 = iC - 1; i4 >= 0 && this.n[i4] == i; i4--) {
            if (obj.equals(this.f2419a[i4 << 1])) {
                return i4;
            }
        }
        return ~i3;
    ...
    public int c() {
        ...
        int iC = c(this.n, i, 0);
        if (iC < 0 || this.f2419a[iC << 1] == null) {
            return iC;
        }
        int i2 = iC + 1;
        while (i2 < i && this.n[i2] == 0) {
            if (this.f2419a[i2 << 1] == null) {
                return i2;
            }
            i2++;
        }
        for (int i3 = iC - 1; i3 >= 0 && this.n[i3] == 0; i3--) {
            if (this.f2419a[i3 << 1] == null) {
                return i3;
            }
        }
        return ~i2;
    ...
    public V get(Object obj) {
        int iC = c(obj);
        if (iC >= 0) {
            return (V) this.f2419a[(iC << 1) + 1];
        }
        return null;
    }

    public K c(int i) {
        return (K) this.f2419a[i << 1];
    }

    public V tt(int i) {
        return (V) this.f2419a[(i << 1) + 1];
    }
    ...
    public V put(K k, V v) {
        ...
        if (i2 >= iArr.length) {
            ...
            if (iArr2.length > 0) {
                ...
                System.arraycopy(objArr2, 0, this.f2419a, 0, objArr2.length);
            }
            c(iArr, objArr2, i2);
        }
        if (i4 < i2) {
        ...
        if (i3 <= 1) {
            ...
            if (iArr.length > 8 && i3 < iArr.length / 3) {
                ...
                if (i > 0) {
                    ...
                    System.arraycopy(objArr, 0, this.f2419a, 0, i2);
                }
                if (i < i5) {
                    int i6 = i + 1;
                    int i7 = i5 - i;
                    System.arraycopy(iArr, i6, this.n, i, i7);
                    System.arraycopy(objArr, i6 << 1, this.f2419a, i2, i7 << 1);
                }
            } else {
                if (i < i5) {
                    int i8 = i + 1;
