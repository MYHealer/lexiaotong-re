...
@com.byazt.zqa.c(c = {0, 1, 1714, 71})
public class x extends yp<com.byazt.jx.yp, Path> {
    ...
    public x(List<com.byazt.vc.c<com.byazt.jx.yp>> list) {
        super(list);
    }

    @Override // com.byazt.kd.u
    /* JADX INFO: renamed from: uj, reason: merged with bridge method [inline-methods] */
    public com.byazt.dg.u c() {
        return new com.byazt.dg.u(this.c);
    }
}
