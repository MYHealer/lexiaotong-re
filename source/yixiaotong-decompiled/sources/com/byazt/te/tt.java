    ...
    public void c(String str, String str2) {
        ...
        switch (str) {
            case "boxImage":
                ...
                n.c().tt().c(this.i, str2, new com.byazt.sa.c.InterfaceC0263c() { // from class: com.byazt.te.tt.1
            ...
            case "after":
                ...
                break;
            case "boxFinishImage":
                n.c().tt().c(this.i, str2, new com.byazt.sa.c.InterfaceC0263c() { // from class: com.byazt.te.tt.2
                    @Override // com.byazt.sa.c.InterfaceC0263c
                    public void c(Bitmap bitmap) {
