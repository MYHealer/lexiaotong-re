...
public final class a implements com.byazt.yx.ve {
    ...
    public static final com.byazt.mk.a f2367a;
    ...
    static {
        ...
        tt = aVarC;
        com.byazt.mk.a aVarC2 = com.byazt.mk.a.c("host");
        ve = aVarC2;
        ...
        i = aVarC8;
        da = com.byazt.kh.ve.c(aVarC, aVarC2, aVarC3, aVarC4, aVarC6, aVarC5, aVarC7, aVarC8, ve.ve, ve.uj, ve.n, ve.f2379a);
    ...
    public static List<ve> tt(yv yvVar) {
        ...
        if (strC != null) {
            arrayList.add(new ve(ve.f2379a, strC));
        }
