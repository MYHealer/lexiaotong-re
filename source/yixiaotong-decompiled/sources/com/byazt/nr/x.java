...
public class x {
    public static File c(Context context, boolean z, String str, String str2) {
        ...
        if (z) {
            strConcat = c(context) + com.huawei.openalliance.ad.constant.x.A + str;
        } else {
    ...
    public static File tt(Context context, boolean z, String str, String str2) {
        ...
        if (z) {
            str = c(context) + com.huawei.openalliance.ad.constant.x.A + str;
        }
    ...
    public static String c(Context context) {
        ...
        return (TextUtils.isEmpty(strC) || !strC.contains(com.huawei.openalliance.ad.constant.x.bQ)) ? strC : strC.replace(com.huawei.openalliance.ad.constant.x.bQ, com.huawei.openalliance.ad.constant.x.A);
    }
}
