...
public class c {
    ...
    public void c(Map<String, com.byazt.db.c> map, Context context, com.byazt.pl.ve veVar, final InterfaceC0287c interfaceC0287c) {
        ...
        nVar.c(new com.byazt.mh.c() { // from class: com.byazt.ug.c.1
            ...
            public void c(uj ujVar, com.byazt.hm.tt ttVar3) {
                ...
                if (ttVar3 != null) {
                    ...
                    if (eo.c(ttVar3)) {
                        ...
                        if (!TextUtils.isEmpty(strC2)) {
                            try {
                                c.this.c(new JSONObject(strC2), jSONObject3, interfaceC0287c, z2, j);
                                return;
                            } catch (Throwable th) {
                                c.this.c(81014, th.getMessage(), interfaceC0287c, z2);
                                return;
                            }
                        }
                        com.byazt.eu.tt.uj("ServerBiddingHelper", "Server Bidding Request onResponse...response v4 is empty");
                        c.this.c(iTt, "response is empty", interfaceC0287c, z2);
                        return;
                    }
                    if (!TextUtils.isEmpty(ttVar3.n())) {
                        try {
                            ...
                            String strOptString = jSONObject6.optString(CrashHianalyticsData.MESSAGE);
                            if (iOptInt >= 0 && !TextUtils.isEmpty(strOptString)) {
                                ...
                                c.this.c(jSONObject4, jSONObject3, interfaceC0287c, z2, j);
                                return;
                            }
                            int iOptInt2 = jSONObject6.optInt(o0OO000o.o000o0oo, -2);
                            int iOptInt3 = jSONObject6.optInt("reason", -2);
                            String strOptString2 = jSONObject6.optString("desc");
                            com.byazt.eu.tt.uj("ServerBiddingHelper", "Server Bidding onResponse error ");
                            c.this.c(iOptInt2, "reason is " + iOptInt3 + "，desc is " + strOptString2, interfaceC0287c, z2);
                            return;
                        } catch (Throwable th4) {
                            c.this.c(81006, th4.getMessage(), interfaceC0287c, z2);
                            return;
                        }
                    }
                ...
                c.this.c(-1, "response is null", interfaceC0287c, z2);
            }
            ...
            public void c(uj ujVar, IOException iOException) {
                ...
                c.this.c(i2, "request fail " + iOException.getMessage(), interfaceC0287c, z2);
            }
        });
    }
    ...
    public void c(int i, String str, InterfaceC0287c interfaceC0287c, boolean z) {
        yv.c(z ? "v4Enc_exchange" : "v2Enc_exchange", false, 0L, "code = " + i + "，msg = " + str);
        c(interfaceC0287c, new com.byazt.pp.c(i, str));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void c(JSONObject jSONObject, JSONObject jSONObject2, InterfaceC0287c interfaceC0287c, boolean z, long j) {
        String str;
        JSONArray jSONArray;
        String str2;
        ...
        if (jSONObject != null) {
            if (!TextUtils.isEmpty(jSONObject.toString())) {
                sp spVar = new sp();
                spVar.c(jSONObject2);
                spVar.ve(jSONObject.optString("request_id"));
                    ...
                    while (i < jSONArrayOptJSONArray.length()) {
                        try {
                            ...
                            try {
                                ...
                                xVar2.n(jSONObjectOptJSONObject2.optString("name"));
                ...
                if (jSONArrayOptJSONArray3 != null && jSONArrayOptJSONArray3.length() > 0) {
                    for (int i3 = 0; i3 < jSONArrayOptJSONArray3.length(); i3++) {
                        try {
                            ...
                            aVar.c(jSONObjectOptJSONObject6.optString("name"));
                            ...
                            aVar.ve(jSONObjectOptJSONObject6.optString(com.hihonor.adsdk.base.g.j.e.a.hnadst));
        ...
        try {
            ...
            if (jSONObject3 != null) {
                if (!TextUtils.isEmpty(jSONObject3.toString())) {
                    spVar.ve(jSONObject3.optString("request_id"));
    ...
    private x c(JSONObject jSONObject) {
        ...
        try {
            ...
            String strOptString2 = jSONObject3.optString(CrashHianalyticsData.MESSAGE);
            ...
            if (jSONObject2 != null) {
                if (!TextUtils.isEmpty(jSONObject2.toString())) {
                    ...
                    xVar.ve(jSONObject2.optString(OapsKey.KEY_PRICE));
                    xVar.uj(jSONObject2.optString("load_price"));
                    xVar.da(jSONObject2.optString("adm"));
                    xVar.n(jSONObject2.optString("name"));
    ...
    public void c(String str, InterfaceC0287c interfaceC0287c) {
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                c(interfaceC0287c, new com.byazt.pp.c(-1, string));
                return;
            }
        }
        com.byazt.eu.tt.uj("ServerBiddingHelper", "Server Bidding Request onResponse...response is invalid");
        c(interfaceC0287c, new com.byazt.pp.c(-1, "response is invalid"));
    }

    private void c(final InterfaceC0287c interfaceC0287c, final com.byazt.pp.c cVar) {
        com.byazt.eu.n.c(new Runnable() { // from class: com.byazt.ug.c.2
            @Override // java.lang.Runnable
            public void run() {
                InterfaceC0287c interfaceC0287c2 = interfaceC0287c;
                if (interfaceC0287c2 != null) {
                    interfaceC0287c2.c(cVar);
                }
            }
        });
    }

    private void c(final InterfaceC0287c interfaceC0287c, final sp spVar) {
        com.byazt.eu.n.c(new Runnable() { // from class: com.byazt.ug.c.3
            @Override // java.lang.Runnable
            public void run() {
                InterfaceC0287c interfaceC0287c2 = interfaceC0287c;
                if (interfaceC0287c2 != null) {
                    interfaceC0287c2.c(spVar);
                }
            }
        });
    }
    ...
    /*  JADX ERROR: Type inference failed
        jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 16431. Try increasing type updates limit count.
    ...
    private JSONObject c(tt ttVar) {
        ...
        try {
            jSONObject.put("request_id", ttVar.c());
    ...
    private JSONObject tt(tt ttVar) {
        ...
        try {
            ...
            jSONObject.put(com.hihonor.adsdk.base.g.j.e.a.O, i);
        } catch (Exception unused) {
        }
        return jSONObject;
    }
    ...
    private void ve(JSONObject jSONObject) {
        ...
        if (nVarC != null) {
            try {
                ...
                jSONObject.put(com.hihonor.adsdk.base.g.j.e.a.H0, jSONObject2);
            } catch (Exception unused) {
            }
        }
    }
    ...
    private JSONObject ve() {
        ...
        try {
            ...
            jSONObject.put("name", com.byazt.bp.c.t().my());
            tt(jSONObject);
            ve(jSONObject);
        } catch (Exception unused) {
        }
