...
public class tt extends ve<RoundImageView> {
    ...
    private void q() {
        if (this.mq > 0.0f) {
            ...
            n.c().tt().c(this.i, this.c, new com.byazt.sa.c.InterfaceC0263c() { // from class: com.byazt.vn.tt.1
        ...
        n.c().tt().c(this.i, this.c, (ImageView) this.n, ((RoundImageView) this.n).getWidth(), ((RoundImageView) this.n).getHeight(), new com.byazt.sa.c.InterfaceC0263c() { // from class: com.byazt.vn.tt.2
            @Override // com.byazt.sa.c.InterfaceC0263c
            public void c(Bitmap bitmap) {
                if (bitmap == null) {
                    if (tt.this.nt != null) {
        ...
        if (this.vp || this.cf > 0.0f) {
            n.c().tt().c(this.i, this.c, new com.byazt.sa.c.InterfaceC0263c() { // from class: com.byazt.vn.tt.3
                @Override // com.byazt.sa.c.InterfaceC0263c
                public void c(Bitmap bitmap) {
                    if (bitmap == null) {
                        return;
