...
public class c implements qp.c {
    ...
    private void n() {
        ...
        if (lo.tt(this.ve) == 1) {
            ...
            this.f1965a.addView(playableVideoContainer, layoutParams);
        ...
        this.f1965a.addView(playableVideoContainer2, layoutParams2);
    ...
    private void a() {
        pf.c((View) this.f1965a, 8);
        pf.c((View) this.sp, 8);
    }

    private void sp() {
        pf.c((View) this.f1965a, 0);
        pf.c((View) this.sp, 0);
    }
    ...
    private void c(long j) {
        ...
        if (this.yp != null || t.c(this.ve)) {
            ...
            this.x = veVar2;
            veVar2.c(new com.byazt.zd.c.InterfaceC0342c() { // from class: com.byazt.ab.c.3
    ...
    public void ve() {
        if (this.u && this.i && this.x != null) {
            this.sl = false;
            this.uj.sendEmptyMessageDelayed(1, ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS);
            if (this.x.lr()) {
                return;
            }
            this.x.x();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void da() {
        if (this.sp == null || this.f1965a == null) {
            return;
        }
        sp();
