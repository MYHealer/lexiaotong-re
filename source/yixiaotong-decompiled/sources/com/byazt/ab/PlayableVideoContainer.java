...
@com.byazt.zqa.c(c = {0, 1, 757, 2005})
public class PlayableVideoContainer extends FrameLayout {
    ...
    private void tt() {
        ...
        this.f1964a = uj();
        frameLayout.addView(this.f1964a, new ViewGroup.MarginLayoutParams(-1, -1));
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        this.c.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, getMeasuredHeight(), new int[]{Color.parseColor("#FFDD42"), Color.parseColor("#FFB744")}, (float[]) null, Shader.TileMode.CLAMP));
