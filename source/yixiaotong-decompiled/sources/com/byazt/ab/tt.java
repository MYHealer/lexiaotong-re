...
public class tt {
    ...
    public CopyOnWriteArrayList<String> f1966a = new CopyOnWriteArrayList<>();
    ...
    private void uj(final ic icVar) {
        ...
        if (this.n.contains(strWo) || this.f1966a.contains(strWo) || this.tt.get(strWo) != null) {
            return;
        }
        this.n.add(strWo);
    ...
    public void c(ic icVar, final String str) {
        com.byazt.hy.tt.c(icVar, icVar == null ? null : icVar.jm(), new com.byazt.at.uj() { // from class: com.byazt.ab.tt.3
            ...
            public void c(boolean z, List<ic> list, boolean z2) {
                try {
                    if (tt.this.f1966a != null && tt.this.f1966a.contains(str)) {
