...
public class ve implements com.byazt.iy.n {
    ...
    public final Map<String, Object> f2849a = new ConcurrentHashMap();
    ...
    private Map<String, ?> uj() {
        HashMap map = new HashMap(this.f2849a);
        map.putAll(this.sp);
        return map;
    }
    ...
    private boolean c(String str, boolean z) {
        try {
            ...
            if (bool == null) {
                bool = (Boolean) this.f2849a.get(str);
            }
    ...
    public boolean contains(String str) {
        ...
        synchronized (this.n) {
            tt();
            zContainsKey = this.f2849a.containsKey(str);
        }
        return zContainsKey;
    }
    ...
    public Map<String, Object> n() {
        ...
        HashMap map2 = new HashMap(this.f2849a);
    ...
    public void c(String str, Throwable th) {
        ...
        if (zVar != null) {
            ...
            try {
                jSONObject.put(UriUtil.LOCAL_FILE_SCHEME, this.ve.getAbsolutePath());
