...
@com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY, 54})
public class ve extends tt {
    ...
    private com.byazt.yxi.uj c(com.byazt.dv.tt ttVar, com.byazt.ll.tt ttVar2, Map<String, Object> map) {
        ...
        if (iVarTt != null) {
            map3.put(d.D, Double.valueOf(iVarTt.tt()));
            map3.put(d.C, Double.valueOf(iVarTt.c()));
