...
public class ve extends com.byazt.ac.c implements qp.c, a.tt {
    ...
    public final d md;
    public com.byazt.kcl.tt.InterfaceC0198tt nb;
    ...
    public void c(com.byazt.kcl.tt.InterfaceC0198tt interfaceC0198tt) {
        this.nb = interfaceC0198tt;
    }
    ...
    public void cu() {
        ...
        com.byazt.kcl.tt.InterfaceC0198tt interfaceC0198tt = this.nb;
        if (interfaceC0198tt != null) {
            interfaceC0198tt.c();
        }
    }
    ...
    private void nb() {
        ...
        this.da = builderBuildUpon.appendQueryParameter("height", String.valueOf(this.rl)).appendQueryParameter("width", String.valueOf(this.gt)).appendQueryParameter("aspect_ratio", String.valueOf(fFr)).toString();
    }
    ...
    public void or() {
        ...
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(ba.D, this.tt.uj());
