...
public class or {
    ...
    public static final ArrayList<int[]> f2189a = new ArrayList<>();
                ...
                if (jSONArrayOptJSONArray3 != null && jSONArrayOptJSONArray3.length() > 0) {
                    ...
                    for (int i3 = 0; i3 < jSONArrayOptJSONArray3.length(); i3++) {
                        ...
                        if (jSONArrayOptJSONArray4 != null && jSONArrayOptJSONArray4.length() == 2) {
                            f2189a.add(new int[]{jSONArrayOptJSONArray4.optInt(0), jSONArrayOptJSONArray4.optInt(1)});
                        }
                    }
                } else {
                    f2189a.add(new int[]{0, 500});
                }
            ...
            if (stringSet2 != null && !stringSet2.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (strArrSplit2.length == 2) {
                        f2189a.add(new int[]{Integer.parseInt(strArrSplit2[0]), Integer.parseInt(strArrSplit2[1])});
                    }
                }
            }
    ...
    public static void tt(com.byazt.it.n nVar) {
        try {
            ...
            ArrayList<int[]> arrayList2 = f2189a;
