...
public class oz {
    ...
    public static boolean c(ic icVar) {
        oz ozVarT = t(icVar);
        if (ozVarT != null && !icVar.bw() && icVar.by() != 2 && ozVarT.f2190a && da(icVar) < com.byazt.omf.gt.tt().fq() && sl(icVar)) {
            return ozVarT.f2190a;
        }
        return false;
    }
    ...
    public static void tt(ic icVar) {
        oz ozVarT = t(icVar);
        if (ozVarT == null || icVar.bw() || icVar.by() == 2 || !ozVarT.f2190a || da(icVar) >= com.byazt.omf.gt.tt().fq()) {
            return;
        }
