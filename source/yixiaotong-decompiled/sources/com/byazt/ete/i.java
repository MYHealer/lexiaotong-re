...
public class i {
    ...
    /* JADX INFO: renamed from: com.byazt.ete.i$1, reason: invalid class name */
    @com.byazt.zqa.c(c = {0, 1, 8, 203})
    static /* synthetic */ class AnonymousClass1 {
    }

    public /* synthetic */ i(c cVar, AnonymousClass1 anonymousClass1) {
        this(cVar);
    }
    ...
    public JSONObject c(ic icVar) {
        ...
        try {
            ...
            if (iArr2 != null && iArr2.length == 2) {
                jSONObject.putOpt("width", Integer.valueOf(iArr2[0])).putOpt("height", Integer.valueOf(this.tt[1]));
            }
            int[] iArr3 = this.ve;
            ...
            if (this.qy != null) {
                for (int i = 0; i < this.qy.size(); i++) {
                    ...
                    if (cVarValueAt != null) {
                        ...
                        jSONObject3.putOpt("force", Double.valueOf(cVarValueAt.ve)).putOpt("mr", Double.valueOf(cVarValueAt.tt)).putOpt(TypedValues.CycleType.S_WAVE_PHASE, Integer.valueOf(cVarValueAt.c)).putOpt("ts", Long.valueOf(cVarValueAt.uj));
                        jSONArray.put(jSONObject3);
                    }
                }
            }
            jSONObject2.putOpt("ftc", Integer.valueOf(this.nu)).putOpt("info", jSONArray);
            jSONObject.putOpt("down_x", Float.toString(this.n)).putOpt("down_y", Float.toString(this.f2178a)).putOpt("up_x", Float.toString(this.sp)).putOpt("up_y", Float.toString(this.x)).putOpt("down_time", Long.valueOf(this.i)).putOpt("up_time", Long.valueOf(this.da)).putOpt("toolType", Integer.valueOf(this.sl)).putOpt("deviceId", Integer.valueOf(this.t)).putOpt(ba.at, Integer.valueOf(this.u)).putOpt(bf.ar, Float.valueOf(this.yp)).putOpt("densityDpi", Integer.valueOf(this.z)).putOpt("scaleDensity", Float.valueOf(this.m)).putOpt("ft", jSONObject2).putOpt("click_area_type", this.rh).putOpt("areaType", this.my).putOpt("rectInfo", this.rl).putOpt("click_area_id", this.gt);
            int i2 = this.gu;
            if (i2 != -1) {
