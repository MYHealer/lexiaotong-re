...
public class my {
    ...
    public my(JSONObject jSONObject) {
        ...
        if (jSONObjectOptJSONObject != null) {
            ...
            this.f2186a = jSONObjectOptJSONObject.optInt("show_type");
    ...
    public void c(JSONObject jSONObject) {
        ...
        try {
            ...
            jSONObject2.put("show_type", this.f2186a);
    ...
    public static boolean sp(ic icVar) {
        my myVarRh = rh(icVar);
        return myVarRh != null && myVarRh.f2186a == 3;
    }
