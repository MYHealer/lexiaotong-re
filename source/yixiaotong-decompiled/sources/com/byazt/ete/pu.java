...
public class pu {
    ...
    public pu(JSONObject jSONObject, String str, bm bmVar) {
        ...
        if (jSONObjectOptJSONObject2 != null) {
            ...
            dzVar.ve(jSONObjectOptJSONObject2.optString("md5"));
        ...
        if (jSONObjectOptJSONObject3 != null) {
            ...
            this.sp = maVarC;
            com.byazt.nq.tt.c().c(maVarC, str, "ad");
        }
    ...
    public void tt(JSONObject jSONObject) {
        try {
            ...
            if (this.f2193a != null) {
                ...
                jSONObject3.put("id", this.f2193a.tt());
                jSONObject3.put("md5", this.f2193a.ve());
                jSONObject3.put("url", this.f2193a.uj());
                jSONObject3.put("data", this.f2193a.n());
                jSONObject3.put("diff_data", this.f2193a.a());
                jSONObject3.put("version", this.f2193a.c());
                jSONObject3.put("dynamic_creative", this.f2193a.sp());
                jSONObject3.put("material_type", this.f2193a.x());
                jSONObject3.put("ugen_url", this.f2193a.i());
                jSONObject3.put("ugen_md5", this.f2193a.da());
                jSONObject3.put("engine_version", this.f2193a.sl());
                jSONObject3.put("express_gesture_priority", this.f2193a.t());
    ...
    private com.byazt.ku.uj c(String str) {
        dz dzVar = this.f2193a;
        if (dzVar == null) {
            return null;
        }
        String strTt = dzVar.tt();
        String strUj = this.f2193a.uj();
        String strVe = this.f2193a.ve();
        String strN = this.f2193a.n();
        return com.byazt.ku.uj.c().c(strTt).tt(strVe).ve(strUj).uj(strN).n(this.f2193a.c()).a(String.valueOf(str));
    }
