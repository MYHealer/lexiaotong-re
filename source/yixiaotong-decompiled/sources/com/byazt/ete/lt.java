...
public class lt {
    ...
    public lt(JSONObject jSONObject) {
        ...
        if (jSONObjectOptJSONObject != null) {
            ...
            this.f2184a = jSONObjectOptJSONObject.optInt("skip_btn_right_style", 0);
        ...
        JSONObject jSONObjectOptJSONObject2 = jSONObject.optJSONObject(com.umeng.analytics.pro.d.K);
    ...
    public void c(JSONObject jSONObject) {
        try {
            ...
            jSONObject2.put("skip_btn_right_style", this.f2184a);
