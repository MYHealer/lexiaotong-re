...
public class c implements u, Function {
    ...
    public String getDeviceName() {
        ...
        this.uj = Settings.Global.getString(this.p.getContentResolver(), am.J);
        return this.uj;
    }
    ...
    public String getMnc() {
        ...
        if (TextUtils.isEmpty(this.f2163a)) {
            this.f2163a = com.byazt.bt.ve.sp(this.md.c(), this.p);
        }
        return this.f2163a;
    }
