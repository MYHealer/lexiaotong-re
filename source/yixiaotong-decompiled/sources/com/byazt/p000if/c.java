...
public class c extends n.c {
    ...
    public final C0184c<Intent> n = new C0184c<>();

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final HashMap<ComponentName, com.byazt.fgi.c> f2328a = new HashMap<>();
    ...
    class C0184c<T> extends HashMap<x, T> {
        public C0184c() {
        }
    ...
    public synchronized ComponentName tt(Intent intent, String str) {
        ...
        if (!this.f2328a.containsKey(component)) {
            com.byazt.fgi.c cVarVe = ve(intent, str);
            if (cVarVe == null) {
                return component;
            }
            this.f2328a.put(component, cVarVe);
            this.sp.add(component);
        }
        com.byazt.fgi.c cVar = this.f2328a.get(component);
        if (cVar != null) {
    ...
    public synchronized boolean c(ComponentName componentName) {
        if (!this.f2328a.containsKey(componentName)) {
            return false;
        }
    ...
    private void ve(ComponentName componentName) {
        com.byazt.fgi.c cVarRemove = this.f2328a.remove(componentName);
        ...
        for (ComponentName componentName : this.uj.keySet()) {
            ...
            if (ttVar.contains(xVar)) {
                ...
                if (ttVar.size() == 0) {
                    ...
                    com.byazt.fgi.c cVar = this.f2328a.get(componentName);
                    if (cVar != null) {
