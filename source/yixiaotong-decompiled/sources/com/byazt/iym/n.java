...
public class n extends RecyclerView.gu implements qp.c {
    ...
    private static class tt implements com.byazt.zd.c.InterfaceC0342c {
        ...
        public tt(com.byazt.zd.c.InterfaceC0342c interfaceC0342c, int i, c cVar, d dVar) {
        ...
        public void c(long j, long j2) {
            ...
            if (j2 > SilenceSkippingAudioProcessor.DEFAULT_PADDING_SILENCE_US && j > Math.min(((long) this.uj) * 1000, j2) * 0.75f) {
                c(false);
                this.ve = true;
            }
            com.byazt.zd.c.InterfaceC0342c interfaceC0342c = this.c;
