...
public class tt {
    ...
    public int uj() {
        ...
        if (this.t) {
            int iTt = lt.tt(this.tt) - this.f2358a;
            this.f2358a = lt.tt(this.tt);
            return iTt;
        }
        if (this.f2358a >= lt.tt(this.tt)) {
            return 0;
        }
        this.f2358a++;
        return 1;
    ...
    public com.byazt.zd.c.InterfaceC0342c n() {
        return new com.byazt.zd.c.InterfaceC0342c() { // from class: com.byazt.iym.tt.4
