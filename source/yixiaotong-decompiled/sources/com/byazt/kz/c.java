...
public class c {
    ...
    @com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_SPADE, 132})
    private static class ve implements com.byazt.ya.c {
        ...
        public void onSend(JSONObject jSONObject) throws JSONException {
            ...
            jSONObject2.putOpt("wifi_auth_status", this.ve ? "success" : "failure");
            String str = this.uj;
            if (str == null) {
                str = "";
            }
            ...
            jSONObject2.putOpt("wifi_auth_redirect_time", Integer.valueOf(this.f2449a));
    ...
    private static class tt extends sp {
        ...
        public void run() {
            if (this.tt == null) {
                ...
                uj.c(this.ve, "wifi_auth", "click_other", new ve(System.currentTimeMillis() - this.n, 0, false, "context is null", this.f2448a, this.sp));
                return;
            }
            new a(this.tt, new com.byazt.fiq.c()).c(this.uj, new C0207c(this.c, this.ve, this.n, this.f2448a, this.sp));
        }
    }
    ...
    private static class C0207c implements com.byazt.fiq.ve {
        public final WeakReference<SSWebView> c;
        public final int n;
        public final ic tt;
        public final int uj;
        ...
        public C0207c(WeakReference<SSWebView> weakReference, ic icVar, long j, int i, int i2) {
