...
public class a implements ve, com.byazt.aas.c.tt, Function {
    ...
    private Function<SparseArray<Object>, Object> tt() {
        Function<SparseArray<Object>, Object> functionC = gt.c(10003);
    ...
    public void onAppForeground() {
        ...
        try {
            ...
            functionTt.apply(com.byazt.yxi.uj.c().c(1008).c(Void.class).c(36, 0).tt());
        } catch (Throwable th) {
            m.c(th);
        }
    }
    ...
    public void onAppBackground() {
        ...
        try {
            ...
            functionTt.apply(com.byazt.yxi.uj.c().c(1008).c(Void.class).c(36, 1).tt());
        } catch (Throwable th) {
            m.c(th);
        }
    }
                ...
                functionC.apply(com.byazt.yxi.uj.c(com.byazt.rl.c.c().c(21, jSONObject).c(22, context).c(38, this.ve).c(1, new x() { // from class: com.byazt.whk.a.2
                    ...
                    public PluginValueSet c(int i, n nVar) {
                        ...
                        if (nVar.c()) {
                            ...
                            if (function2 != null) {
                                function2.apply(com.byazt.yxi.uj.c().c(0).c(Void.class).tt());
                            }
                            a.this.c();
                        } else {
                            if (nVar.tt() != null) {
                            ...
                            if (function3 != null) {
                                function3.apply(com.byazt.yxi.uj.c().c(-1).c(Void.class).tt());
                            }
                        }
            ...
            this.ve = new x() { // from class: com.byazt.whk.a.3
                ...
                public <T> T applyFunction(int i, PluginValueSet pluginValueSet, Class<T> cls) {
                    ...
                    try {
                        ...
                        switch (i) {
                            case 1:
                                c.c().c(jSONObjectC.optString(am.e), jSONObjectC.optString("key"), jSONObjectC.optString(oOOOoo00.OooOo0o), com.byazt.vxy.c.uj());
                                JSONObject jSONObject2 = new JSONObject();
                                jSONObject2.put("success", true);
                                return (T) com.byazt.yxi.uj.c().c(37, jSONObject2).tt();
                            case 2:
                                String strOptString = jSONObjectC.optString(am.e);
                            ...
                            case 3:
                                c.c().c(jSONObjectC.optString(am.e), jSONObjectC.optString("key"), "-1", com.byazt.vxy.c.uj());
                                JSONObject jSONObject4 = new JSONObject();
                                jSONObject4.put("success", true);
                                return (T) com.byazt.yxi.uj.c().c(37, jSONObject4).tt();
                            case 4:
                                String strOptString3 = jSONObjectC.optString(am.e, jSONObjectC.optString("table"));
                            ...
                            case 5:
                                String strOptString5 = jSONObjectC.optString(am.e, jSONObjectC.optString("table"));
                                String strOptString6 = jSONObjectC.optString("key");
                                String strOptString7 = jSONObjectC.optString(oOOOoo00.OooOo0o);
                            ...
                            case 6:
                                c.c().c(jSONObjectC.optString(am.e, jSONObjectC.optString("table")), jSONObjectC.optString("key"), "-1", com.byazt.vxy.c.uj());
