...
public class u {
    ...
    private static String c(int i, String str) {
        return i + com.huawei.openalliance.ad.constant.x.A + z.c() + com.huawei.openalliance.ad.constant.x.A + tt.incrementAndGet() + com.huawei.openalliance.ad.constant.x.A + str + com.huawei.openalliance.ad.constant.x.A + System.currentTimeMillis();
    }
    ...
    public static void c(int i, long j, ic icVar, com.byazt.jzl.a aVar) {
        ...
        try {
            ...
            if (jSONObjectC != null) {
                ...
                String strOptString = jSONObjectC.optString("trace_id");
    ...
    private JSONObject tt(com.byazt.jzl.a aVar) {
        ...
        try {
            ...
            if (icVarC != null) {
                ...
                jSONObject.put("package", tt("video_cache"));
                ...
                jSONObject.put(am.Q, jSONObjectC.optString(am.Q));
    ...
    private JSONObject c() {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(am.Q, rh.sp(gt.getContext()));
    ...
    private JSONObject c(com.byazt.jzl.a aVar, int i, int i2) {
        ...
        try {
            ...
            jSONObject.put("trace_id", c(i, aVar.getFileNameKey()));
        } catch (Exception e) {
            m.c(e);
        }
        return jSONObject;
    ...
    private JSONObject tt() {
        ...
        try {
            ...
            jSONObject.put("ext_api_code", p.f2567a);
