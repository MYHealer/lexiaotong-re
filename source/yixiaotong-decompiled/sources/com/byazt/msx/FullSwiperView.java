...
@com.byazt.zqa.c(c = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_GET_FIRST_VIDEO_POS, 704})
public class FullSwiperView extends FrameLayout {
    ...
    public void c() {
        ...
        this.c.c(false).c(TtmlNode.TEXT_EMPHASIS_MARK_DOT).uj(false).ve(false).tt(false);
        this.c.setOnPageChangeListener(new com.byazt.nw.c() { // from class: com.byazt.msx.FullSwiperView.1
            ...
            public void c(boolean z, int i, int i2, boolean z2, boolean z3) {
                ...
                if (!FullSwiperView.this.sp && i > 0) {
                    ...
                    uj.tt(FullSwiperView.this.f2482a);
                }
