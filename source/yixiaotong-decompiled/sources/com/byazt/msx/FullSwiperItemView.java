...
public class FullSwiperItemView extends FrameLayout implements qp.c, sl {
    ...
    public void sl() {
        ...
        this.f2481a = (FrameLayout) viewT.findViewById(2114387679);
    ...
    public void t() {
        ...
        int iBy = icVarC.by();
        float fQe = icVarC.qe();
        float[] fArrC = com.byazt.biq.tt.c(StubApp.getOrigApplicationContext(this.t.getApplicationContext()), icVarC.fr(), icVarC.by());
        float f = fArrC[0];
        float f2 = fArrC[1];
        if (fFr == 100.0f) {
            this.x = f;
        ...
        int[] iArrC = com.byazt.biq.tt.c(StubApp.getOrigApplicationContext(this.t.getApplicationContext()), fFr, fQe, iBy);
        int i = iArrC[0];
        int i2 = iArrC[1];
        int i3 = iArrC[2];
        int i4 = iArrC[3];
    ...
    private static class ve implements com.byazt.zd.c.InterfaceC0342c {
        public final com.byazt.zd.c.InterfaceC0342c c;
        public final d n;
        public final c tt;
        public final int uj;
        ...
        public ve(com.byazt.zd.c.InterfaceC0342c interfaceC0342c, int i, c cVar, d dVar) {
        ...
        public void c() {
            this.ve = false;
            com.byazt.zd.c.InterfaceC0342c interfaceC0342c = this.c;
