...
public final class uj {
    ...
    private void c(int i, tt.uj ujVar) {
        ...
        float fC2 = c(ujVar.n, ujVar.f2300a);
        if (fC2 < 0.0f) {
            fC2 = 0.0f;
        }
        ...
        this.da[i2] = fC2;
        double d = fVe;
        this.f2302a[i2] = ((float) Math.cos(d)) * fC3;
