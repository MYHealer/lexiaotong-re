...
public class ViewPager extends ViewGroup {
    ...
    public static final Interpolator f1972a = new Interpolator() { // from class: com.byazt.an.ViewPager.2
    ...
    public void c() {
        ...
        this.u = new Scroller(context, f1972a);
    ...
    public int getChildDrawingOrder(int i, int i2) {
        ...
        return ((ve) this.os.get(i2).getLayoutParams()).f1973a;
    }
  ...
  0x00f5: PHI (r15v7 float) = (r15v5 float), (r15v6 float), (r15v4 float) binds: [B:62:0x00ea, B:59:0x00d4, B:53:0x00be] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static class sp extends com.byazt.an.c {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.tt + i.d;
        }
        ...
        if (action == 0) {
            ...
            if (action != 2) {
                ...
                if (iFindPointerIndex3 == -1) {
                    ...
                    if (this.md) {
                        zX = tt(motionEvent.getX(iFindPointerIndex));
                    }
                }
                if (zX) {
                    postInvalidateOnAnimation();
    ...
    @com.byazt.zqa.c(c = {0, 1, 1270, RendererDiscoverer.Event.ItemDeleted})
