...
public class ve implements a, Runnable {
    ...
    public final ArrayList<tt> f2765a = new ArrayList<>();
    ...
    public void c() {
        ...
        try {
            for (tt ttVar : (ArrayList) this.f2765a.clone()) {
                if (ttVar != null) {
                    ttVar.c();
                }
            }
    ...
    private void sl() {
        ...
        while (true) {
            ...
            if (this.md > 0) {
                ...
                this.qy.c(new com.byazt.m.a(AnalyticsListener.EVENT_DRM_SESSION_RELEASED, "current bytes is not equals to total bytes, bytes invalid retry status is : " + this.m.getByteInvalidRetryStatus()));
                return;
            } else if (this.m.getCurBytes() <= 0) {
                com.byazt.x.c.tt(c, this.m.getErrorBytesLog());
                this.qy.c(new com.byazt.m.a(AnalyticsListener.EVENT_DRM_KEYS_REMOVED, "curBytes is 0, bytes invalid retry status is : " + this.m.getByteInvalidRetryStatus()));
                return;
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (atomicInteger != null && atomicInteger.get() > 0) {
                                        ...
                                        tt(new BaseException(1018, String.format("retry for Throwable, but retry Time %s all used, last error is %s", String.valueOf(this.m.getRetryCount()), e2.c())));
                                        break;
                                    } else {
                                        this.m.setStatus(5);
        ...
        if (zGu || z) {
            ...
            if (z2) {
                try {
                    ...
                    gr monitorDepend = this.ve.getMonitorDepend();
                    DownloadInfo downloadInfo = this.m;
                    BaseException baseException = new BaseException(1014, com.byazt.w.a.tt(th, "removeDownloadRunnable"));
                    DownloadInfo downloadInfo2 = this.m;
    ...
    private boolean gu() {
        if (this.yp == com.byazt.ev.x.RUN_STATUS_ERROR) {
            ...
            try {
                ...
                tt(new BaseException(1008, com.byazt.w.a.tt(th, "doTaskStatusHandle onComplete")));
            }
        }
        return true;
    }
    ...
    private void c(List<com.byazt.t.tt> list, long j) throws BaseException {
            ...
            if (ttVar != null) {
                ...
                if (jM > 0) {
                    ...
                    if (this.m.isNeedReuseFirstConnection() && this.gr != null && (!this.m.isHeadConnectionAvailable() || this.d)) {
                        if (ttVar.my() == 0) {
                            this.f2765a.add(new tt(ttVar, this.ve, this.gr, this));
                        } else if (ttVar.my() > 0) {
                            this.f2765a.add(new tt(ttVar, this.ve, this));
                        }
                    } else {
                        this.f2765a.add(new tt(ttVar, this.ve, this));
                    }
        ...
        if (com.byazt.w.c.c(64)) {
            ArrayList arrayList = new ArrayList(this.f2765a.size());
            for (tt ttVar2 : this.f2765a) {
                if (this.yp == com.byazt.ev.x.RUN_STATUS_CANCELED) {
                    ttVar2.tt();
                } else if (this.yp == com.byazt.ev.x.RUN_STATUS_PAUSE) {
                    ttVar2.c();
        ...
        ArrayList arrayList2 = new ArrayList(this.f2765a.size());
        for (tt ttVar3 : this.f2765a) {
            if (this.yp == com.byazt.ev.x.RUN_STATUS_CANCELED) {
                ttVar3.tt();
            } else if (this.yp == com.byazt.ev.x.RUN_STATUS_PAUSE) {
                ttVar3.c();
                        ...
                        if (Uj < totalBytes) {
                            ...
                            if (Uj > 0) {
                                ...
                                if (cVarC.c("download_when_space_negative", 0) != 1) {
                                    throw new BaseException(1052, "availableSpace " + (Uj == 0 ? "=" : SimpleComparison.LESS_THAN_OPERATION) + " 0");
                                }
                                j2 = j;
                                z = false;
                                Uj = nVar3;
    ...
    private void eo() throws com.byazt.m.a {
        if (this.m.isOnlyWifi() && !com.byazt.w.a.c(com.byazt.zz.ve.ic(), g.b)) {
            throw new com.byazt.m.a(1019, String.format("download task need permission:%s", g.b));
        }
    ...
    private void zb() throws BaseException {
        ...
        if (!file.exists()) {
            ...
            if (com.byazt.k.c.c(this.m.getId()).c("opt_mkdir_failed", 0) == 1) {
                ...
                if (com.byazt.w.a.uj(this.m.getSavePath()) < 16384) {
                    throw new BaseException(1006, "download savePath directory can not created:" + this.m.getSavePath());
                }
                throw new BaseException(1030, "download savePath directory can not created:" + this.m.getSavePath());
            }
            throw new BaseException(1030, "download savePath directory can not created:" + this.m.getSavePath());
        }
        if (file.isDirectory()) {
    ...
    public void c(String str, com.byazt.hs.sp spVar, long j) throws BaseException, com.byazt.m.i {
        ...
        try {
            ...
            this.sl = ujVar.c();
            String str2 = this.m.geteTag();
            String strVe = ujVar.ve();
            String strA = ujVar.a();
            String strSp = ujVar.sp();
            String str3 = c;
            com.byazt.x.c.tt(str3, "dcache=responseCode=" + i + " last_modified=" + strA + " CACHE_CONTROL=" + strSp + " max-age=" + ujVar.sl() + " isDeleteCacheIfCheckFailed=" + this.m.isDeleteCacheIfCheckFailed());
            com.byazt.x.c.tt(str3, "dcache=firstOffset=" + j + " cur=" + strA + " before=" + this.m.getLastModified() + " cur=" + ujVar.da() + " before=" + this.m.getTotalBytes());
            ...
            if (this.m.isExpiredRedownload() && this.zb && !TextUtils.isEmpty(this.eo)) {
                if (i == 304 || ((!TextUtils.isEmpty(this.m.getLastModified()) || !this.m.isDeleteCacheIfCheckFailed()) && TextUtils.equals(strA, this.m.getLastModified()))) {
                    com.byazt.x.c.tt(str3, "dcache=responseCode=" + i + " lastModified not changed, use local file  " + strA);
                    throw new com.byazt.m.c(this.eo);
                }
                com.byazt.w.a.c(this.m);
            }
            if (j > 0 && this.m.isExpiredRedownload() && !TextUtils.equals(strA, this.m.getLastModified())) {
                com.byazt.x.c.tt(str3, "dcache cdn file change, so retry");
                c("", "cdn file changed");
            }
            ...
            if (c(i, str2, str4)) {
                ...
                if (spVar2 instanceof i) {
                    ...
                    c(str4, "eTag of server file changed");
                } else {
            ...
            if (zI) {
                ...
                String strTt = com.byazt.w.a.tt(spVar2, "Content-Range");
                com.byazt.x.c.ve(str3, "firstConnection: contentRange = " + strTt);
                if (!TextUtils.isEmpty(strTt) && this.qp.tt("fix_get_total_bytes", true)) {
                    jTt = com.byazt.w.a.tt(strTt);
                    com.byazt.x.c.ve(str3, "firstConnection: 1 totalLength = " + jTt);
                } else {
                    jTt = j + jX;
                    com.byazt.x.c.n(str3, "firstConnection: 2 totalLength = " + jTt + ", contentLength = " + jX);
                }
            }
    ...
    private com.byazt.t.tt c(com.byazt.t.tt ttVar, int i) {
        com.byazt.t.tt ttVar2 = null;
        if (!ttVar.uj()) {
            return null;
        }
        long jVe = ttVar.ve(true);
        com.byazt.x.c.tt(c, "reuseChunk retainLen:" + jVe + " chunkIndex:" + i);
        if (!ttVar.a() && jVe > com.byazt.ev.n.f2216a && this.m.isNeedReuseChunkRunnable()) {
        ...
        if (ttVar.a()) {
            for (int i2 = 1; i2 < ttVar.sp().size(); i2++) {
                com.byazt.t.tt ttVar3 = ttVar.sp().get(i2);
                if (ttVar3 != null) {
                    com.byazt.x.c.tt(c, "check can checkUnCompletedChunk -- chunkIndex:" + ttVar3.my() + " currentOffset:" + ttVar3.yp() + "  startOffset:" + ttVar3.t() + " contentLen:" + ttVar3.nu());
                    if (ttVar3.my() < 0 || (!ttVar3.i() && !ttVar3.ve())) {
                        ttVar2 = ttVar3;
                        break;
                    }
                }
            ...
            if (ttVar2 != null) {
                com.byazt.x.c.tt(c, "unComplete chunk " + ttVar.my() + " curOffset:" + ttVar.yp() + " reuseChunk chunkIndex:" + i + " for subChunk:" + ttVar2.my());
                this.z.c(ttVar2.sl(), ttVar2.my(), ttVar2.tt(), i);
                ttVar2.ve(i);
                ttVar2.c(true);
            }
        }
