...
public class tt implements Runnable {
    ...
    public tt(com.byazt.t.tt ttVar, DownloadTask downloadTask, a aVar) {
        ...
        if (downloadTask != null) {
            this.f2764a = downloadTask.getDownloadInfo();
        }
        this.sp = aVar;
    ...
    private String ve() {
        return this.f2764a.getConnectionUrl();
    }
    ...
    private boolean c(com.byazt.t.tt ttVar) {
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    try {
                        try {
                            if (!this.t) {
                                List<com.byazt.t.ve> listC = com.byazt.w.a.c(this.f2764a.getExtraHeaders(), this.f2764a.geteTag(), j2, j3);
                                listC.add(new com.byazt.t.ve("Chunk-Index", String.valueOf(ttVar.my())));
                                com.byazt.w.a.c(listC, this.f2764a);
                                com.byazt.w.a.tt(listC, this.f2764a);
                                this.x = com.byazt.zz.ve.c(this.f2764a.isNeedDefaultHttpServiceBackUp(), this.f2764a.getMaxBytes(), strVe, listC);
                            }
                            i iVar3 = this.x;
                        ...
                        try {
                            ...
                            z = false;
                            j = jYp2;
                            this.uj = new com.byazt.zz.n(this.f2764a, strVe, this.x, ttVar, this.sp);
                            if (ttVar2 != null) {
                                jVe = ttVar2.ve(false);
                                if (j3 != 0) {
                                    jVe = (j3 - j2) + 1;
            ...
            try {
                ...
                if (!this.sp.c(e)) {
                    if (!this.f2764a.isNeedChunkDowngradeRetry() || this.f2764a.isChunkDowngradeRetryUsed() || this.f2764a.getChunkCount() <= 1 || !com.byazt.w.a.c(e, this.f2764a)) {
                        this.sp.tt(e);
                        uj();
                        return z;
                    }
