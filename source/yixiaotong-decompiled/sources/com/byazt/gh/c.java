...
public class c {
    ...
    public void c(Function function, boolean z) {
        ...
        if (objApply instanceof Map) {
            ...
            for (Map.Entry entry : new ArrayList(((Map) objApply).entrySet())) {
                ...
                if (slVarC != null) {
                    if (TextUtils.equals(str, slVarC.f2791a)) {
                        if (value != null && slVarC.c((com.byazt.dna.c) null) == null) {
                            if (iC < 7500) {
                        ...
                        jSONObject.put("model_key", slVarC.f2791a);
                        jSONObject.put("origin_key", str);
                        jSONObject.put("origin", name);
    ...
    private void c(String str, sl slVar, Object obj, Function function, int i) {
        if (slVar.n) {
            ...
            if ((list == null || !list.contains(slVar.f2791a)) && slVar.uj <= 0) {
        ...
        try {
            ...
            if (z2) {
                try {
                    ...
                    try {
                        uj ujVar = uj.getInstance();
                        jSONObject3.put("model_key", slVar.f2791a);
                        jSONObject3.put("origin_key", str);
                        jSONObject3.put("sameClassLoader", z5);
                        jSONObject3.put("origin", name);
                ...
                try {
                    ...
                    try {
                        new StringBuilder("reuse service success: ").append(slVar.f2791a).append(", service = ").append(objC).append(" ,ats = ").append(function);
                        obj2 = objC;
                        jSONObject2 = null;
                    } catch (Throwable th5) {
                        th = th5;
