...
public class c {
    ...
    public static void ve() {
        ...
        try {
            ...
            declaredField2.set(obj, Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), new Class[]{cls}, new C0175c(obj2)));
        ...
        if (com.byazt.gq.t.i().optInt("hook", 0) == 1 && (objArr[1] instanceof String)) {
            ...
            if (obj instanceof Intent) {
                ...
                if ("android.intent.action.VIEW".equals(intent.getAction()) && com.byazt.ev.n.c.equals(intent.getType())) {
                    ...
                    if (com.byazt.i.n.c()) {
                        String strOptString5 = com.byazt.gq.t.i().optString("hook_huawei_arg1", com.huawei.openalliance.ad.constant.x.af);
                        if (!"null".equals(strOptString5)) {
                            objArr[1] = strOptString5;
                        }
                        intent.putExtra("caller_package", com.byazt.gq.t.i().optString("hook_huawei_arg2", com.huawei.openalliance.ad.constant.x.af));
                    }
                }
            }
        }
    ...
    private static class C0175c implements InvocationHandler {
        public Object c;

        private C0175c(Object obj) {
            this.c = obj;
        }
