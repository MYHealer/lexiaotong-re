...
public class c implements Thread.UncaughtExceptionHandler {
    ...
    public volatile boolean f2887a = true;
    ...
    public void uncaughtException(Thread thread, Throwable th) {
        tt ttVar;
        if (SystemClock.uptimeMillis() - this.n < SilenceSkippingAudioProcessor.DEFAULT_PADDING_SILENCE_US) {
            return;
        }
