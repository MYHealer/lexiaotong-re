...
public class c implements com.byazt.pk.c, com.byazt.z.tt.ve, com.byazt.g.c.InterfaceC0156c, zb {
    ...
    public synchronized void c(final String str) {
        ...
        new com.byazt.us.tt().c(ttVarC, new com.byazt.us.sp() { // from class: com.byazt.di.c.1
            ...
            public void c(boolean z) {
                ...
                if (z) {
                    if (!(com.byazt.us.a.ve(ttVarC) && com.byazt.us.c.c(str, ttVarC)) && com.byazt.us.a.uj(ttVarC) && ttVarC.pf() == 4) {
    ...
    public void c(String str, com.byazt.dd.tt ttVar) {
        if (ttVar != null && com.byazt.hu.u.tt(ttVar) && ttVar.ve.compareAndSet(false, true)) {
            ...
            com.byazt.zn.c.c().c(ttVar.da(), "install_finish", c(ttVar, str, i), ttVar);
            com.byazt.nn.i.c().c(ttVar);
        }
    }
    ...
    public static JSONObject c(JSONObject jSONObject, DownloadInfo downloadInfo) {
        if (jSONObject != null && downloadInfo != null) {
            ...
            try {
                ...
                jSONObject.put(o0OO000o.o000o0oo, downloadInfo.getHttpStatusCode());
    ...
    private static void c(com.byazt.dd.tt ttVar) {
        ...
        com.byazt.zn.c.c().tt("download_finish", jSONObjectC, ttVar);
    }
    ...
    private int c(com.byazt.dd.tt ttVar, DownloadInfo downloadInfo, String str, JSONObject jSONObject) {
        ...
        if (iTt > 0 && iTt2 > 0 && iTt != iTt2) {
            return iTt2 > iTt ? MspSdkCode.CODE_METHOD_CALL_EXCEPTION : MspSdkCode.CODE_NOT_SUPPORT_KITINFP_SERVICE;
        }
    ...
    public void c(int i) {
        ...
        n.c().c(new RunnableC0134c(i), this.tt > 0 ? ExoPlayer.DEFAULT_DETACH_SURFACE_TIMEOUT_MS : 8000L);
    ...
    public void c(ConcurrentHashMap<Long, com.byazt.dd.tt> concurrentHashMap, int i) {
        ...
        for (com.byazt.dd.tt ttVar : concurrentHashMap.values()) {
            if (ttVar.ve.get()) {
                if (jCurrentTimeMillis - ttVar.cu() >= com.byazt.k.c.c(ttVar.my()).c("start_event_expire_hours", Opcodes.JSR) * 3600000) {
                    arrayList.add(Long.valueOf(ttVar.tt()));
                }
            } else if (ttVar.or() == 1) {
                if (tt(ttVar) <= 0 && jCurrentTimeMillis - ttVar.cu() >= com.byazt.k.c.c(ttVar.my()).c("start_event_expire_hours", Opcodes.JSR) * 3600000) {
                    arrayList.add(Long.valueOf(ttVar.tt()));
                }
            } else if (ttVar.or() == 2) {
                if (!ttVar.kp()) {
                    if (com.byazt.hu.u.tt(ttVar)) {
                        ...
                        i.c().c(ttVar);
                    } else if (jCurrentTimeMillis - ttVar.cu() >= com.byazt.k.c.c(ttVar.my()).c("finish_event_expire_hours", Opcodes.JSR) * 3600000) {
                        arrayList.add(Long.valueOf(ttVar.tt()));
    ...
    private JSONObject c(com.byazt.dd.tt ttVar, String str, int i) {
        ...
        try {
            DownloadInfo downloadInfo = Downloader.getInstance(t.getContext()).getDownloadInfo(ttVar.my());
            jSONObject.putOpt(com.hihonor.adsdk.base.g.j.e.a.InterfaceC0437a.hnadsd, Integer.valueOf(i));
