...
public class c {
    ...
    public void c(uj ujVar, tt ttVar, String str, boolean z, String str2, int i, Map<String, Object> map) {
        ...
        ujVar.c("mediation_request").c("server_bidding_extra", str2).c("mediation_req_type", Integer.valueOf(i2)).c(a.O, Integer.valueOf(ttVar != null ? ttVar.gr() : 0)).tt(i).sl(strC);
        ...
        if (ttVar != null && ttVar.ve() == 5) {
            try {
                ...
                jSONObject.put(am.aT, com.byazt.ix.uj.c().uj());
        ...
        com.byazt.ng.a.c(ujVar, ttVar, (da) null, (com.byazt.yl.ve) null, map2);
    ...
    public void c(uj ujVar, com.byazt.yl.ve veVar, tt ttVar, com.byazt.nbs.tt ttVar2, long j, String str, boolean z, int i, boolean z2, boolean z3) {
        ujVar.c("mediation_fill").c(j).c("server_bidding_extra", str).c("mediation_req_type", Integer.valueOf(!z ? 1 : 0)).c(a.O, Integer.valueOf(i)).tt(0).sl("");
        ...
        com.byazt.ng.a.c(ujVar, ttVar, (da) null, veVar, map);
    ...
    public void c(uj ujVar, tt ttVar, com.byazt.yl.ve veVar, long j, int i, int i2, int i3, String str, int i4, int i5, com.byazt.nbs.tt ttVar2, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        ujVar.c("mediation_request_end").c(j).c(a.O, Integer.valueOf(i4)).c("reason", Integer.valueOf(i5)).tt(i3);
        HashMap map = new HashMap();
        com.byazt.ng.a.c(ujVar, ttVar, (da) null, veVar, map);
    ...
    public void c(uj ujVar, tt ttVar, com.byazt.pp.c cVar, String str) {
        ...
        ujVar.c(a.O, Integer.valueOf(ttVar != null ? ttVar.gr() : 0));
        com.byazt.ng.a.c(ujVar, ttVar, (da) null, (com.byazt.yl.ve) null, map);
        com.byazt.ng.ve.c(com.byazt.bp.tt.getContext(), ujVar, map);
    }
    ...
    public void c(uj ujVar, da daVar, tt ttVar, String str, boolean z, int i, int i2, int i3, int i4, com.byazt.pp.c cVar, long j, boolean z2, boolean z3, String str2, long j2) {
        ...
        ujVar.c("media_request").a(str).c(j2).c(a.O, Integer.valueOf(ttVar != null ? ttVar.gr() : 0)).c("adn_count", Integer.valueOf(i2)).c("mediationrit_req_type", Integer.valueOf(i3)).c("mediationrit_req_type_src", Integer.valueOf(i4)).c("mediation_req_type", Integer.valueOf(!z ? 1 : 0)).c("media_req_type", Integer.valueOf(i));
        HashMap map = new HashMap();
        map.put("timeout_req", Integer.valueOf(z2 ? 1 : 0));
        map.put("is_callback", Integer.valueOf(z3 ? 1 : 0));
        ...
        com.byazt.ng.a.c(ujVar, ttVar, daVar, (com.byazt.yl.ve) null, map);
        com.byazt.ng.ve.c(com.byazt.bp.tt.getContext(), ujVar, map);
    }
    ...
    public void c(uj ujVar, com.byazt.yl.ve veVar, int i, String str, long j, tt ttVar, int i2, int i3, int i4, String str2, long j2, long j3) {
        ujVar.c("media_fill").c(j).tt(i).sl(str).c("adn_count", Integer.valueOf(i2)).c("adn_preload", Integer.valueOf((veVar == null || !veVar.isAdnPreload()) ? 0 : 1)).c(a.O, Integer.valueOf(i3));
        ...
        Long lC = c(veVar);
        if (lC != null) {
            ujVar.c(ba.D, String.valueOf(lC));
        }
        com.byazt.ng.a.c(ujVar, ttVar, (da) null, veVar, map);
        com.byazt.ng.ve.c(com.byazt.bp.tt.getContext(), ujVar, map);
    }
    ...
    public void c(uj ujVar, com.byazt.pp.c cVar, tt ttVar, da daVar, int i, int i2, int i3, String str, long j, String str2, String str3, String str4, long j2) {
        if (cVar instanceof com.byazt.bnd.ve) {
            ...
            ujVar.tt(cVar != null ? cVar.ve : -1).sl(cVar != null ? cVar.uj : ErrorCode.ERROR_MSG_UNKNOWN_ERROR);
            tt(ujVar);
        }
    ...
    public void c(uj ujVar, com.byazt.yl.ve veVar, tt ttVar, List<com.byazt.yl.ve> list, List<com.byazt.yl.ve> list2) {
        ...
        HashMap map2 = new HashMap();
        com.byazt.ng.a.c(ujVar, ttVar, (da) null, veVar, map2);
    ...
    public void c(uj ujVar, tt ttVar, JSONObject jSONObject) {
        ujVar.c("start_bidding_request").c(2).c(a.O, Integer.valueOf(ttVar != null ? ttVar.gr() : 0));
        HashMap map = new HashMap();
        if (jSONObject != null) {
    ...
    public void c(uj ujVar, tt ttVar, com.byazt.pl.tt ttVar2, int i) {
        ...
        ujVar.c("return_bidding_result").c(ttVar2.sp).setResult(ttVar2.f2629a).tt(ttVar2.x == null ? 0 : ttVar2.x.c).sl(ttVar2.x == null ? "" : ttVar2.x.tt).c(2).c("fill_type", Integer.valueOf(i)).c("server_bidding_extra", ttVar2.uj).c(a.O, Integer.valueOf(ttVar2.i));
        HashMap map = new HashMap();
    ...
    public void c(uj ujVar, com.byazt.yl.ve veVar, tt ttVar, da daVar, long j) {
        ...
        com.byazt.ng.a.c(ujVar, ttVar, daVar, veVar, map);
        com.byazt.ng.ve.c(com.byazt.bp.tt.getContext(), ujVar, map);
    }
