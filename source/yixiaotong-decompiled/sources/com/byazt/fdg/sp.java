...
@com.byazt.zqa.c(c = {0, 1, AVMDLDataLoader.KeyIsPreloadWaitListType, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_AUTO_RECOVERY})
public abstract class sp {
    public static final byte[] c = new byte[8];

    /* JADX INFO: renamed from: com.byazt.fdg.sp$1, reason: invalid class name */
    @com.byazt.zqa.c(c = {0, 1, AVMDLDataLoader.KeyIsPreloadWaitListType, 135})
    ...
    public static c c(RandomAccessFile randomAccessFile, u uVar, i iVar) throws NoSuchAlgorithmException, DigestException, IOException, SecurityException {
        ...
        byteBufferC.putInt(byteBufferC4.limit() + 68);
        byteBufferC.flip();
    ...
    private static class tt implements da {
        ...
        public /* synthetic */ tt(byte[] bArr, ByteBuffer byteBuffer, AnonymousClass1 anonymousClass1) throws NoSuchAlgorithmException {
    ...
    private static void c(RandomAccessFile randomAccessFile, u uVar, byte[] bArr, ByteBuffer byteBuffer) throws NoSuchAlgorithmException, DigestException, IOException {
        tt ttVar = new tt(bArr, byteBuffer, null);
        c(ttVar, new t(randomAccessFile.getFD(), 0L, uVar.tt), 1048576);
        long j = uVar.uj;
        c(ttVar, new t(randomAccessFile.getFD(), uVar.ve, (16 + j) - uVar.ve), 1048576);
    ...
    private static byte[] c(RandomAccessFile randomAccessFile, u uVar, byte[] bArr, int[] iArr, ByteBuffer byteBuffer) throws NoSuchAlgorithmException, DigestException, IOException {
        ...
        while (true) {
            ...
            if (length >= 0) {
                ...
                tt ttVar = new tt(bArr, byteBufferC2, anonymousClass1);
                c(ttVar, xVar, 4096);
                ttVar.c();
                ttVar.tt();
                length--;
                ...
                tt ttVar2 = new tt(bArr, ByteBuffer.wrap(bArr2), anonymousClass1);
