            ...
            try {
                ...
                try {
                    try {
                        ...
                        try {
                            try {
                                ve.C0147ve c0147veC = ve.c(randomAccessFile2, str);
                                Signature[] signatureArrC = c(new Certificate[][]{c0147veC.c});
                                if (c0147veC.tt != null) {
                                    int size = c0147veC.tt.c.size();
                                    Signature[] signatureArr2 = new Signature[size];
                                    iArr = new int[c0147veC.tt.tt.size()];
                                    for (int i2 = 0; i2 < size; i2++) {
                                        signatureArr2[i2] = new Signature(c0147veC.tt.c.get(i2).getEncoded());
                                        iArr[i2] = c0147veC.tt.tt.get(i2).intValue();
                                    }
