...
public class ve {
    ...
    public static C0147ve c(RandomAccessFile randomAccessFile, String str) throws yp, IOException {
    ...
    private static C0147ve c(RandomAccessFile randomAccessFile, u uVar, boolean z) throws SecurityException, IOException {
        ...
        try {
            ...
            try {
                ...
                int i = 0;
                C0147ve c0147veC = null;
                while (byteBufferC.hasRemaining()) {
                    try {
                        c0147veC = c(a.c(byteBufferC), arrayMap, certificateFactory);
                        i++;
                    } catch (c unused) {
                    } catch (IOException e) {
                        e = e;
                ...
                if (arrayMap.containsKey(3)) {
                    c0147veC.ve = a.c((byte[]) arrayMap.get(3), randomAccessFile.length(), uVar);
                }
                return c0147veC;
    ...
    private static C0147ve c(ByteBuffer byteBuffer, Map<Integer, byte[]> map, CertificateFactory certificateFactory) throws c, IOException, SecurityException {
    ...
    private static C0147ve c(ByteBuffer byteBuffer, List<X509Certificate> list, CertificateFactory certificateFactory) throws IOException {
        ...
        return new C0147ve(x509CertificateArr, ttVarC);
    }
    ...
    public static class C0147ve {
        public final X509Certificate[] c;
        public final tt tt;
        public byte[] ve;

        public C0147ve(X509Certificate[] x509CertificateArr, tt ttVar) {
