...
public abstract class RSAEncrypt {
    ...
    public static String encrypt(String str, String str2) {
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2)) {
            b.f(TAG, "content or public key is null");
            return "";
        }
    ...
    public static String decrypt(String str, String str2) {
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2)) {
            b.f(TAG, "content or private key is null");
            return "";
        }
    ...
    public static String decrypt(String str, PrivateKey privateKey) {
        ...
        try {
            ...
            b.f(TAG, "RSA decrypt exception : " + e.getMessage());
            return "";
        } catch (Exception e2) {
    ...
    public static byte[] encrypt(byte[] bArr, PublicKey publicKey) {
        ...
        try {
            ...
            b.f(TAG, "RSA encrypt exception : " + e.getMessage());
            return bArr2;
        }
    }
    ...
    public static Map<String, Key> generateRSAKeyPair(int i2) throws NoSuchAlgorithmException {
        ...
        if (i2 < 2048) {
            b.f(TAG, "generateRSAKeyPair: key length is too short");
            return map;
        }
        SecureRandom secureRandomGenSecureRandom = EncryptUtil.genSecureRandom();
        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance(K);
