package com.hihonor.secure.android.common.encrypt.rsa;

import android.text.TextUtils;
import android.util.Base64;
import com.hihonor.secure.android.common.encrypt.keystore.rsa.RSASignKS;
...
public abstract class RSASign {
    ...
    private static String a(String str, PrivateKey privateKey, boolean z) {
        try {
            ...
            b.f(TAG, "sign UnsupportedEncodingException: " + e.getMessage());
            return "";
        }
    }
    ...
    public static byte[] sign(byte[] bArr, PrivateKey privateKey, boolean z) {
        ...
        try {
            if (z) {
                signature = Signature.getInstance(L);
            ...
            b.f(TAG, "sign InvalidAlgorithmParameterException: " + e.getMessage());
            return bArr2;
        } catch (InvalidKeyException e2) {
            b.f(TAG, "sign InvalidKeyException: " + e2.getMessage());
            return bArr2;
        } catch (NoSuchAlgorithmException e3) {
            b.f(TAG, "sign NoSuchAlgorithmException: " + e3.getMessage());
            return bArr2;
        } catch (SignatureException e4) {
            b.f(TAG, "sign SignatureException: " + e4.getMessage());
            return bArr2;
        } catch (Exception e5) {
            b.f(TAG, "sign Exception: " + e5.getMessage());
            return bArr2;
        }
    }
    ...
    private static boolean a(String str, String str2, PublicKey publicKey, boolean z) {
        try {
            ...
            b.f(TAG, "verifySign UnsupportedEncodingException: " + e.getMessage());
            return false;
        } catch (Exception e2) {
    ...
    public static boolean verifySign(byte[] bArr, byte[] bArr2, PublicKey publicKey, boolean z) {
        ...
        try {
            ...
            b.f(TAG, "check sign exception: " + e.getMessage());
            return false;
        } catch (Exception e2) {
