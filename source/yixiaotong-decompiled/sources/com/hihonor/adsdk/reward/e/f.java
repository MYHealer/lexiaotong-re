...
public class f extends com.hihonor.adsdk.reward.e.a<b> {
    ...
    public b a(View view, Context context) {
        ...
        return (iOrdinal == 0 || iOrdinal == 1) ? new v(view, context) : new q(view, context);
    }
    ...
    public int a() {
        int iOrdinal = b().ordinal();
        if (iOrdinal == 0) {
            return R.layout.honor_ads_reward_horizontal_1280_720_01;
        }
        if (iOrdinal != 1) {
            return iOrdinal != 2 ? R.layout.honor_ads_reward_portrait_style1_download : R.layout.honor_ads_reward_portrait_style1;
        }
        return R.layout.honor_ads_reward_horizontal_1280_720_01_download;
    }
}
