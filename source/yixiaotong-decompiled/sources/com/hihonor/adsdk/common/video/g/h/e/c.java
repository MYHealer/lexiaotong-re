...
public class c extends com.hihonor.adsdk.common.video.g.h.b implements e {
    private static final String hnadsd = "GooglePlayerCacheManager";
    ...
    public void hnadsb(Context context, String str) {
        ...
        if (!this.hnadsc.containsKey(str)) {
            ...
            this.hnadsc.put(str, com.hihonor.adsdk.common.video.g.h.e.b.hnadsa(context, new HashMap(), this));
        }
    ...
    protected com.hihonor.adsdk.common.video.g.h.a hnadsc(Context context) {
        return new com.hihonor.adsdk.common.video.g.h.e.a(context, com.hihonor.adsdk.common.video.g.a.hnadsb, null);
    }
    ...
    public Cache hnadsd(Context context) {
        ...
        com.hihonor.adsdk.common.video.g.h.e.a aVar = aVarHnadsb instanceof com.hihonor.adsdk.common.video.g.h.e.a ? (com.hihonor.adsdk.common.video.g.h.e.a) aVarHnadsb : null;
        if (aVar == null) {
            return null;
        }
    ...
    public MediaSource hnadsa(Context context, String str, boolean z) {
        ...
        if (dVarHnadsa != null) {
            ...
            dVarHnadsa = com.hihonor.adsdk.common.video.g.h.e.b.hnadsa(context, new HashMap());
        }
