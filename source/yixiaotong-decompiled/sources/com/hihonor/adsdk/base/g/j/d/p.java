...
public class p extends e1 {
    ...
    public p(LinkedHashMap<String, String> linkedHashMap, int i, int i2, String str, com.hihonor.adsdk.base.g.j.d.h1.a aVar) {
        super(str, aVar);
        this.hnadse = "4";
        ...
        this.hnadsd.put(com.hihonor.adsdk.base.g.j.e.a.hnadsk, "4");
    }
