...
public class v extends e1 {
    ...
    public v(LinkedHashMap<String, String> linkedHashMap, int i, int i2, String str, com.hihonor.adsdk.base.g.j.d.h1.a aVar) {
        super(str, aVar);
        this.hnadse = "7";
        ...
        this.hnadsd.put(com.hihonor.adsdk.base.g.j.e.a.hnadsk, "7");
    }
