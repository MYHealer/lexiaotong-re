...
public class f extends AdnAdapterBaseFunction implements Bridge {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private NativeUnifiedADData f991a;
    private Function<SparseArray<Object>, Object> b;
    private volatile boolean c = false;
    private NativeADMediaListener d = new NativeADMediaListener() { // from class: com.X2bigomM7HG.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.f.1
    ...
    public f(NativeUnifiedADData nativeUnifiedADData) {
        this.f991a = nativeUnifiedADData;
    }

    private void a(int i) {
        NativeUnifiedADData nativeUnifiedADData = this.f991a;
    ...
    private void a(Map<String, Object> map) {
        int iA;
        if (map == null || this.f991a == null || (iA = com.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.a.a(map.get(MediationConstant.BIDDING_LOSE_REASON))) <= 0) {
            return;
        }
        this.f991a.sendLossNotification(0, iA, null);
    }
    ...
    private void i() {
        this.f991a.setNativeAdEventListener(new NativeADEventListener() { // from class: com.X2bigomM7HG.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.d4tpAwlrhRJ.f.2
    ...
    public <T> T applyFunction(int i, SparseArray<Object> sparseArray, Class<T> cls) {
        ...
        if (i == 40039) {
            ?? r11 = (T) r();
            t.a("getAuthorName authorName = " + ((String) r11));
            return r11;
        }
        if (i == 40040) {
            long jQ = q();
        ...
        if (i == 40041) {
            ?? r12 = (T) p();
            t.a("getPermissionsUrl permissionsUrl = " + ((String) r12));
            return r12;
        }
        if (i == 40042) {
            ?? r13 = (T) o();
            t.a("getPrivacyAgreement privacyAgreement = " + ((String) r13));
            return r13;
        }
        if (i == 40044) {
            ?? r14 = (T) m();
            t.a("getDescriptionUrl descriptionUrl = " + ((String) r14));
            return r14;
        }
        if (i == 40043) {
            ?? r15 = (T) n();
            t.a("getVersionName versionName = " + ((String) r15));
            return r15;
        }
        if (i == 40032) {
            ?? r16 = (T) t();
            t.a("getTitle title = " + ((String) r16));
            return r16;
        }
        if (i == 40033) {
            ?? r17 = (T) u();
            t.a("desc title = " + ((String) r17));
            return r17;
        }
        if (i == 40045) {
            ?? r18 = (T) l();
            t.a("getCTAText ctaTest = " + ((String) r18));
            return r18;
        }
        if (i == 40046) {
            ?? r19 = (T) k();
            t.a("getIconUrl iconUrl = " + ((String) r19));
            return r19;
        }
        if (i == 40047) {
            ?? r110 = (T) j();
            t.a("getImgUrl imgUrl = " + ((String) r110));
            return r110;
        }
        if (i == 40048) {
            NativeUnifiedADData nativeUnifiedADData2 = this.f991a;
        ...
        if (i == 40049) {
            NativeUnifiedADData nativeUnifiedADData3 = this.f991a;
        ...
        if (i == 40050) {
            NativeUnifiedADData nativeUnifiedADData4 = this.f991a;
        ...
        if (i == 40051) {
            NativeUnifiedADData nativeUnifiedADData5 = this.f991a;
        ...
        if (i == 40052) {
            NativeUnifiedADData nativeUnifiedADData6 = this.f991a;
        ...
        if (i == 40003) {
            NativeUnifiedADData nativeUnifiedADData7 = this.f991a;
            int ecpm = nativeUnifiedADData7 != null ? nativeUnifiedADData7.getECPM() : -1;
            t.a("getECPM ecpm = " + ecpm);
            return (T) Integer.valueOf(ecpm);
        }
        if (i == 40004) {
            NativeUnifiedADData nativeUnifiedADData8 = this.f991a;
            ?? r111 = nativeUnifiedADData8 != null ? (T) nativeUnifiedADData8.getECPMLevel() : (T) "";
            t.a("getECPMLevel level = " + ((String) r111));
            return (T) r111;
        }
        if (i == 40053) {
            NativeUnifiedADData nativeUnifiedADData9 = this.f991a;
        ...
        if (i == 40010) {
            NativeUnifiedADData nativeUnifiedADData10 = this.f991a;
            T t2 = (T) Boolean.valueOf(nativeUnifiedADData10 != null ? nativeUnifiedADData10.isValid() : false);
            t.a("isValid  flag  = " + t2);
            return t2;
        }
        if (i == 40054) {
            T t3 = (T) Boolean.valueOf(((View) MediationValueUtil.objectValue(sparseArray.get(PtgErrorCode.SDK_DP_PERMISSION_PROHIBIT), View.class, null)) instanceof NativeAdContainer);
        ...
        if (i == 40055) {
            ...
            NativeUnifiedADData nativeUnifiedADData11 = this.f991a;
            ...
            if ((viewGroup2 instanceof MediaView) && (nativeUnifiedADData = this.f991a) != null) {
            ...
            NativeUnifiedADData nativeUnifiedADData12 = this.f991a;
            ...
            if (i == 40021) {
                NativeUnifiedADData nativeUnifiedADData13 = this.f991a;
            ...
            if (i == 40061) {
                t.a("onResume");
                NativeUnifiedADData nativeUnifiedADData14 = this.f991a;
                if (nativeUnifiedADData14 != null) {
                    nativeUnifiedADData14.resume();
                }
            } else if (i == 40062) {
                t.a("onPause");
                NativeUnifiedADData nativeUnifiedADData15 = this.f991a;
                ...
                if (i == 40063) {
                    ...
                    NativeUnifiedADData nativeUnifiedADData16 = this.f991a;
                    if (nativeUnifiedADData16 != null) {
                        nativeUnifiedADData16.pauseAppDownload();
                    }
                } else if (i == 40064) {
                    t.a("resumeAppDownload");
                    NativeUnifiedADData nativeUnifiedADData17 = this.f991a;
                    ...
                    NativeUnifiedADData nativeUnifiedADData18 = this.f991a;
                    if (nativeUnifiedADData18 != null) {
                        nativeUnifiedADData18.negativeFeedback();
                    }
                } else if (i == 40007 && this.f991a != null) {
                    ...
                    this.f991a.setBidECPM(iIntValue2);
                }
            }
        }
        return null;
