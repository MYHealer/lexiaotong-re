...
public class JsonStreamerEntity implements HttpEntity {
    ...
    private static final byte[] JSON_TRUE = ez.Code.getBytes();
    private static final byte[] JSON_FALSE = ez.V.getBytes();
    ...
    public void writeTo(OutputStream outputStream) throws IOException {
        ...
        outputStream.write(AppTypeIdUtil.NewDevice4GBathOTA);
                ...
                try {
                    ...
                    if (obj == null) {
                        ...
                        if (z || (obj instanceof RequestParams.StreamWrapper)) {
                            ...
                            outputStream.write(AppTypeIdUtil.NewDevice4GDrinkOTA_2);
