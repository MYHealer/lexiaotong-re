...
public class Orange {
    ...
    private static final String sdkVersion = "1.4.6.83.10f752d7";
    ...
    /* JADX WARN: Unreachable blocks removed: 2, instructions: 2 */
    public synchronized String sted(Context context, String str, boolean z) {
        try {
            if (isReject()) {
                return "";
            }
            if (Build.VERSION.SDK_INT >= 31 && a.b()) {
                return "";
            }
            if ("com.heytap.music".equalsIgnoreCase(context.getPackageName())) {
                return "";
            }
