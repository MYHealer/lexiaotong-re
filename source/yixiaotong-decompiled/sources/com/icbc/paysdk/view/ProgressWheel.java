...
public class ProgressWheel extends View {
    ...
    /* JADX INFO: renamed from: com.icbc.paysdk.view.ProgressWheel$1, reason: invalid class name */
    ...
    public ProgressWheel(Context context, AttributeSet attributeSet) {
        ...
        this.barColor = Color.parseColor("#FF727F");
        this.barSpinCycleTime = 3000.0d;
        this.barWidth = dip2px(context, 2.0f);
        this.circleRadius = dip2px(context, 22.0f);
        spin();
        setAnimationEnabled();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.shouldAnimate) {
            ...
            if (this.isSpinning) {
                ...
                float f2 = (jUptimeMillis * this.spinSpeed) / 1000.0f;
                ...
                canvas.drawArc(this.circleBounds, f, f5, false, this.barPaint);
            } else {
                float f6 = this.mProgress;
                if (f6 != this.mTargetProgress) {
