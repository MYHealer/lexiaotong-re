...
public class ck {
    ...
    private JSONObject n() {
        try {
            ...
            jSONObject.put(BaseWrapper.ENTER_ID_GAME_CENTER, "com.kuaishou.weapon");
            jSONObject.put(BaseWrapper.ENTER_ID_AD_SDK, WeaponHI.sKSSdkver);
            return jSONObject;
