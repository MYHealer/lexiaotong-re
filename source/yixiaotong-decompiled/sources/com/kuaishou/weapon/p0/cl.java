...
public class cl {
        ...
        try {
            ...
            if (hVarA.b(dd.aP, 0) == 1 && (zE || zE2)) {
                ...
                if (hVarA.b(dd.bc, 1) == 1) {
                    jSONObject.put(ResultCode.ERROR_INTERFACE_ECASH_TOPUP, beVar.f(this.f4674a));
                }
            }
            if (hVarA.b(dd.aQ, 1) == 1 && (zE || zE2)) {
                jSONObject.put("01011", bf.e(this.f4674a));
            }
            if (hVarA.b(dd.aR, 1) == 1 && (zE || zE2)) {
                String strP = bf.p(this.f4674a);
            ...
            if (hVarA.b(dd.aF, 1) == 1) {
                if (zE || zE2) {
                    String strF = bf.f(this.f4674a);
                    if (!TextUtils.isEmpty(strF) && !strF.startsWith("RISK")) {
                        jSONObject.put("01013", strF);
                    }
                    jSONObject.put("02042", bf.u(this.f4674a));
                }
                try {
                    if (Engine.loadSuccess) {
                        try {
                            jSONObject.put("02019", bj.b(this.f4674a));
                            jSONObject.put("02021", bj.d(this.f4674a));
                            jSONObject.put("02022", bj.c(this.f4674a));
                            jSONObject.put("02030", bj.f(this.f4674a));
                            cc ccVar = new cc(this.f4674a);
                        ...
                        clVar = this;
                        try {
                            jSONObject.put("02019", bj.b(clVar.f4674a));
                            jSONObject.put("02020", bj.u());
                            jSONObject.put("02021", bj.d(clVar.f4674a));
                            jSONObject.put("02022", bj.c(clVar.f4674a));
                            jSONObject.put("02030", bj.f(clVar.f4674a));
                    ...
                    str = "";
                    jSONObject.put("02067", StubApp.getOrigApplicationContext(clVar.f4674a.getApplicationContext()).getPackageResourcePath().replace("/data/app/", str).replace("/base.apk", str));
                    jSONObject.put("02039", bf.i());
                    jSONObject.put("02040", bf.j());
                    jSONObject.put("02041", bf.t(clVar.f4674a));
                    ...
                    try {
                        jSONObject.put("03064", Settings.System.getInt(clVar.f4674a.getContentResolver(), "screen_brightness_mode"));
                        jSONObject.put("03065", Settings.System.getInt(clVar.f4674a.getContentResolver(), "accelerometer_rotation"));
                    } catch (Throwable unused3) {
                    }
                    jSONObject.put("03081", bj.L());
                    jSONObject.put("03052", bj.i(clVar.f4674a));
                    jSONObject.put("03050", bj.h(clVar.f4674a));
                    jSONObject.put("03049", bj.g(clVar.f4674a));
            ...
            if (hVar.b(dd.aG, 1) == 1) {
                ...
                jSONObject.put("03007", bt.a(clVar.f4674a));
                jSONObject.put("03008", bt.c(clVar.f4674a));
                jSONObject.put("03011", am.b(clVar.f4674a));
                jSONObject.put("03012", am.b());
                jSONObject.put("03014", bf.g(clVar.f4674a));
                jSONObject.put("03034", bf.h(clVar.f4674a));
                jSONObject.put("03020", bt.b(clVar.f4674a));
                jSONObject.put("03037", bj.I());
                jSONObject.put("03038", bj.J());
                jSONObject.put("03077", bj.K());
                try {
                    be beVar2 = new be();
                    jSONObject.put("03006", beVar2.a(clVar.f4674a));
                    jSONObject.put("03010", beVar2.b(clVar.f4674a));
                    jSONObject.put("03033", beVar2.c(clVar.f4674a));
                    jSONObject.put("03021", beVar2.e(clVar.f4674a));
                    jSONObject.put("03030", be.d(clVar.f4674a));
                    jSONObject.put(ResultCode.ERROR_INTERFACE_GET_CARDINFO_BY_SAMSUNGPAY, beVar2.a());
                } catch (Exception unused5) {
                }
            }
            if (hVar.b(dd.aU, 0) == 1) {
                jSONObject.put("03019", bf.k(clVar.f4674a));
                String strM = bf.m(clVar.f4674a);
                if (!TextUtils.isEmpty(strM)) {
                    jSONObject.put("03047", strM);
                }
            }
            if (hVar.b(dd.aV, 1) == 1) {
                jSONObject.put("02059", bk.a(clVar.f4674a));
                jSONObject.put("02060", bk.a());
                jSONObject.put("02062", bk.c());
                if (Engine.loadSuccess) {
                    by byVar = new by(clVar.f4674a);
            ...
            if (hVar.b(dd.aK, 0) == 1 && (zE != 0 || zE2 != 0)) {
                Object objF = bf.f();
                if (objF != null) {
                    jSONObject.put("06014", objF);
                }
                if (Engine.loadSuccess) {
                    cd cdVar = new cd(clVar.f4674a);
            ...
            if (hVar.b(dd.aI, 0) == 1 && (zE != 0 || zE2 != 0)) {
                if (Engine.loadSuccess) {
                    jSONObject.put("07007", new ca(clVar.f4674a).a("07007"));
                }
                JSONArray jSONArrayA = bp.a(clVar.f4674a);
            ...
            if (hVar.b(dd.aJ, 1) == 1 && Engine.loadSuccess) {
                String strA17 = new cb(clVar.f4674a).a("05001");
                try {
            ...
            jSONObject.put("11009", bq.a(StubApp.getOrigApplicationContext(clVar.f4674a.getApplicationContext())));
            try {
                String strW = bf.w(clVar.f4674a);
                if (!TextUtils.isEmpty(strW)) {
                    jSONObject.put("01026", strW);
                }
                if (hVar.b(dd.aL, 1) == 1) {
                    String strQO = com.kwad.sdk.e.b.QY().QO();
                    if (!TextUtils.isEmpty(strQO)) {
                        jSONObject.put("11102", strQO);
                    }
                    jSONObject.put("11104", com.kwad.sdk.e.b.QY().QU());
                    jSONObject.put("11105", com.kwad.sdk.e.b.QY().getDeviceId());
                    jSONObject.put("11106", com.kwad.sdk.e.b.QY().getIccId());
                    jSONObject.put("11107", com.kwad.sdk.e.b.QY().getIMEI());
                    jSONObject.put("11108", com.kwad.sdk.e.b.QY().QP());
                    jSONObject.put("11109", com.kwad.sdk.e.b.QY().QQ());
                    jSONObject.put("11110", com.kwad.sdk.e.b.QY().QR());
                    jSONObject.put("11111", com.kwad.sdk.e.b.QY().getIp());
                    jSONObject.put("11112", com.kwad.sdk.e.b.QY().getLocation());
                    jSONObject.put("11113", com.kwad.sdk.e.b.QY().getOaid());
                    jSONObject.put("11114", com.kwad.sdk.e.b.QY().getMac());
                    jSONObject.put("11115", com.kwad.sdk.e.b.QY().QT());
                    jSONObject.put("11116", com.kwad.sdk.e.b.QY().QS());
                    jSONObject.put("11202", bf.b(com.kwad.sdk.e.b.QY().QO()));
                    jSONObject.put("11204", bf.b(com.kwad.sdk.e.b.QY().QU()));
                    jSONObject.put("11205", bf.b(com.kwad.sdk.e.b.QY().getDeviceId()));
                    jSONObject.put("11206", bf.b(com.kwad.sdk.e.b.QY().getIccId()));
                    jSONObject.put("11207", bf.b(com.kwad.sdk.e.b.QY().getIMEI()));
                    jSONObject.put("11208", bf.b(com.kwad.sdk.e.b.QY().QP()));
                    jSONObject.put("11209", bf.b(com.kwad.sdk.e.b.QY().QQ()));
                    jSONObject.put("11210", bf.b(com.kwad.sdk.e.b.QY().QR()));
                    jSONObject.put("11211", bf.b(com.kwad.sdk.e.b.QY().getIp()));
                    jSONObject.put("11212", bf.b(com.kwad.sdk.e.b.QY().getLocation()));
                    jSONObject.put("11213", bf.b(com.kwad.sdk.e.b.QY().getOaid()));
                    jSONObject.put("11214", bf.b(com.kwad.sdk.e.b.QY().getMac()));
                    jSONObject.put("11215", bf.b(com.kwad.sdk.e.b.QY().QT()));
                    jSONObject.put("11216", bf.b(com.kwad.sdk.e.b.QY().QS()));
            ...
            try {
                ...
                String string = Settings.Global.getString(clVar.f4674a.getContentResolver(), "Phenotype_boot_count");
                if (!TextUtils.isEmpty(string)) {
                    jSONObject.put("03085", string);
                }
                String string2 = Settings.Global.getString(clVar.f4674a.getContentResolver(), "boot_count");
                if (!TextUtils.isEmpty(string2)) {
                    jSONObject.put("03086", string2);
                }
                String string3 = Settings.System.getString(clVar.f4674a.getContentResolver(), "power_on_times");
                if (!TextUtils.isEmpty(string3)) {
                    jSONObject.put("03091", string3);
                }
                String string4 = Settings.System.getString(clVar.f4674a.getContentResolver(), "first_boot_flag");
    ...
    public String a(String str) {
        ...
        try {
            JSONObject jSONObjectA2 = new ck(str, ci.j).a(this.f4674a);
