...
public class bu {
    ...
    public JSONObject a() {
        try {
            ...
            h hVarA = h.a(this.f4655a, "re_po_rt");
            ...
            jSONObject.put("11013", Integer.parseInt(bv.a(StubApp.getOrigApplicationContext(this.f4655a.getApplicationContext())), 2));
            jSONObject.put("11012", bv.b(this.f4655a));
            try {
            ...
            String strW = bf.w(this.f4655a);
            if (!TextUtils.isEmpty(strW)) {
                jSONObject.put("01026", strW);
            }
            if (iB == 1) {
                try {
                    Object objA = ai.a(this.f4655a);
                    if (objA != null) {
                        jSONObject.put("11015", objA);
                    }
                    if (Engine.loadSuccess) {
                        cc ccVar = new cc(this.f4655a);
                    ...
                    jSONObject.put("02021", bj.d(this.f4655a));
                    jSONObject.put("02022", bj.c(this.f4655a));
                    jSONObject.put("02044", bj.t());
                    jSONObject.put("11009", bq.a(StubApp.getOrigApplicationContext(this.f4655a.getApplicationContext())));
                    if (Engine.loadSuccess) {
                        bx bxVar = new bx(this.f4655a);
    ...
    public String a(String str) {
        try {
            synchronized (d) {
                JSONObject jSONObjectA = new ck(str, ci.j).a(this.f4655a);
                if (jSONObjectA == null) {
                    return null;
                }
