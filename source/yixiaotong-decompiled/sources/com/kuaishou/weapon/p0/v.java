        ...
        try {
            ...
            if (packageInfo == null || packageInfo.applicationInfo == null) {
                ...
                if (applicationInfo != null) {
                    String string = applicationInfo.loadLabel(this.r.getPackageManager()).toString();
                    if (!TextUtils.isEmpty(string)) {
                        return string;
                    }
                }
            } else {
                String string2 = this.p.applicationInfo.loadLabel(this.r.getPackageManager()).toString();
