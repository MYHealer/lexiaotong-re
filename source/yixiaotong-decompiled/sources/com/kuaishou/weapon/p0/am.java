...
public class am {
    ...
    private static final String f4625a = "tun";
            ...
            try {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (strA.contains(f4625a) || strA.contains(b)) {
        ...
        try {
            ...
            if (keyStore != null) {
                ...
                while (enumerationAliases.hasMoreElements()) {
                    ...
                    if (x509Certificate.getIssuerDN().getName().contains("2022") || x509Certificate.getIssuerDN().getName().contains("2023") || x509Certificate.getIssuerDN().getName().contains("HttpCanary") || x509Certificate.getIssuerDN().getName().contains("macbook") || x509Certificate.getIssuerDN().getName().contains("proxy") || x509Certificate.getIssuerDN().getName().contains("Proxy") || x509Certificate.getIssuerDN().getName().contains(com.baidu.mobads.sdk.internal.ax.f1734a) || x509Certificate.getIssuerDN().getName().contains("github")) {
