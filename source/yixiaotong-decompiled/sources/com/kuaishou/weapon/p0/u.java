...
public class u implements Runnable {
    ...
    public JSONObject a() {
        try {
            String str = cs.f4682a + cs.g;
            String strA = ct.a(this.j);
            if (!TextUtils.isEmpty(strA)) {
                str = str + "?" + strA;
            }
            JSONObject jSONObject = new JSONObject();
            JSONObject jSONObjectC = ct.c(this.j);
            if (jSONObjectC != null) {
                jSONObject.put("data", new bl(this.j).c(jSONObjectC.toString()));
            }
            l lVarA = l.a(this.j);
            ...
            if (iOptInt != 1) {
                ...
                dn.a(this.j).a(dn.f4709a, 1, false);
                return null;
            }
            String strA2 = new bl(this.j).a(jSONObject2.getString("antispamPluginManageRsp"));
            ...
            dnVar.a(dn.b, System.currentTimeMillis(), true);
            return null;
            ...
            synchronized (u.class) {
                try {
                    ...
                    if (i == 1 || i == 2 || i == 4 || this.r || System.currentTimeMillis() - o >= 300000) {
                        ...
                        if ((System.currentTimeMillis() - this.n.a(dn.b)) - (((long) this.n.a(dn.c, 6)) * bg.s) > 0) {
                            ...
                            while (itKeys2.hasNext()) {
                                ...
                                if (sVarA != null) {
                                    if (z && !sVarA.y && (next2.endsWith("32") || next2.endsWith("64") || next2.endsWith("v7") || next2.endsWith("v8"))) {
                                        sVarA.y = true;
                                    }
                                    if (sVarA.v) {
                                    ...
                                    if (iIndexOf >= 0 && sVarA.y) {
                                        ...
                                        if (dl.b(sVarA.d, sVar.d)) {
                                            if (sVarA.x != sVar.x) {
                                                this.l.c(sVarA.f4726a, sVarA.x);
                                            }
                                            if (!this.l.d(sVarA.f4726a)) {
                                                arrayList2.add(sVarA);
                                            }
                                        } else {
                                            this.n.a(dn.b, System.currentTimeMillis(), true);
                                            if (sVarA.x != sVar.x) {
                                                this.l.c(sVarA.f4726a, sVarA.x);
                                            }
                                            arrayList.add(sVarA);
                            ...
                            for (s sVar2 : listA) {
                                if (!arrayList4.contains(sVar2.c)) {
                                    ...
                                    if (list != null) {
                                        list.add(Integer.valueOf(sVar2.f4726a));
                                    }
                                    this.k.a(sVar2.c);
                                }
                            }
                            for (s sVar3 : arrayList3) {
                                if (!arrayList4.contains(sVar3.c)) {
                                    ...
                                    if (list2 != null) {
                                        list2.add(Integer.valueOf(sVar3.f4726a));
                                    }
                                    this.k.a(sVar3.c);
                                }
                            }
                            ...
                            for (s sVar4 : arrayList5) {
                                if (sVar4 != null) {
                                    if (arrayList.contains(sVar4)) {
                                        this.k.a(sVar4.f4726a, sVar4.d, (PackageInfo) null);
    ...
    private void a(s sVar) {
        try {
            if (!TextUtils.isEmpty(sVar.j) && sVar.j.length() >= 10) {
                ...
                File file = new File(this.m, sVar.f4726a + com.huawei.openalliance.ad.constant.x.A + sVar.d + ".tmp");
                File file2 = new File(this.m, sVar.f4726a + com.huawei.openalliance.ad.constant.x.A + sVar.d + ".zip");
                ...
                if (zA) {
                    ...
                    this.s.put(Integer.valueOf(sVar.f4726a), new a(3));
                }
                ...
                if (zA && sVar.j.equals(strA)) {
                    ...
                    if (this.k.a(sVar, (String) null, (String) null)) {
                        ...
                        if (map != null && !map.containsKey(Integer.valueOf(sVar.f4726a))) {
                            this.s.put(Integer.valueOf(sVar.f4726a), new a(1));
                        }
                        this.n.a(dn.b, System.currentTimeMillis(), true);
                        return;
                    }
                    Map<Integer, a> map2 = this.s;
                    if (map2 != null && !map2.containsKey(Integer.valueOf(sVar.f4726a))) {
                        this.s.put(Integer.valueOf(sVar.f4726a), new a(4));
                    }
                    this.k.a(sVar.f4726a, sVar.d, (PackageInfo) null);
                    return;
                }
                if (file.exists()) {
                    file.length();
