...
public class bp {
    ...
    public static final String f4652a = "7";
    ...
    public static JSONArray a(Context context) throws Throwable {
        ...
        try {
            try {
                ...
                Cursor cursorQuery = contentResolver.query(RingtoneManager.getActualDefaultRingtoneUri(StubApp.getOrigApplicationContext(context.getApplicationContext()), 1), null, null, null, null);
                try {
                    try {
                        ...
                        cursorQuery.close();
                        Cursor cursorQuery2 = contentResolver.query(RingtoneManager.getActualDefaultRingtoneUri(StubApp.getOrigApplicationContext(context.getApplicationContext()), 2), null, null, null, null);
                        if (cursorQuery2.moveToNext()) {
                            JSONObject jSONObject2 = new JSONObject();
                            str = "_data";
                            crc32.update(cursorQuery2.getString(cursorQuery2.getColumnIndexOrThrow(str)).getBytes());
                        ...
                        cursorQuery2.close();
                        String str2 = str;
                        Cursor cursorQuery3 = contentResolver.query(RingtoneManager.getActualDefaultRingtoneUri(StubApp.getOrigApplicationContext(context.getApplicationContext()), 4), null, null, null, null);
                        if (cursorQuery3.moveToNext()) {
                            JSONObject jSONObject3 = new JSONObject();
                            crc32.update(cursorQuery3.getString(cursorQuery3.getColumnIndexOrThrow(str2)).getBytes());
                        ...
                        if (cursorQuery4.moveToNext()) {
                            ...
                            crc32.update(cursorQuery4.getString(cursorQuery4.getColumnIndexOrThrow(str2)).getBytes());
                        ...
                        try {
                            ...
                            try {
                                if (cursorQuery.moveToNext()) {
                                    ...
                                    crc32.update(cursorQuery.getString(cursorQuery.getColumnIndexOrThrow(str2)).getBytes());
