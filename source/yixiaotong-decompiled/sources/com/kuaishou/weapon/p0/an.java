...
public class an {
    ...
    public static final String f4626a = "de.robv.android.xposed.XposedHelpers";
            ...
            while (true) {
                try {
                    ...
                    if (line.endsWith(".so") || line.endsWith(".jar")) {
                        hashSet2.add(line.substring(line.lastIndexOf(PPSLabelView.Code) + 1));
                    }
    ...
    public Set<String> c() {
        Set setKeySet;
        try {
            Class<?> clsLoadClass = ClassLoader.getSystemClassLoader().loadClass(f4626a);
            if (clsLoadClass == null) {
                return null;
            }
    ...
    public JSONObject f() {
        try {
            ...
            boolean zA3 = a(MessageDigest.class, "update", byte[].class);
            jSONObject.put("2", zA3 ? 1 : 0);
            if (zA3) {
                zA = true;
            }
            ...
            boolean zA7 = a(Activity.class, "finish", new Class[0]);
