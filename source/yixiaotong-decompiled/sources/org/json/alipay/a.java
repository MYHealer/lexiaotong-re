...
public class a {
    ...
    public a(Object obj) throws JSONException {
        ...
        for (int i = 0; i < length; i++) {
            this.f9714a.add(Array.get(obj, i));
        }
    }
    ...
    public a(Collection collection) {
        this.f9714a = collection == null ? new ArrayList() : new ArrayList(collection);
    }
    ...
    private String a(String str) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            stringBuffer.append(b.a(this.f9714a.get(i)));
        }
    ...
    public final Object a(int i) throws JSONException {
        Object obj = (i < 0 || i >= this.f9714a.size()) ? null : this.f9714a.get(i);
        if (obj != null) {
            return obj;
        }
