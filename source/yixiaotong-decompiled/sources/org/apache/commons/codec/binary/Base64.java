        ...
        if (i11 != 0) {
            if (i11 == 1) {
                ...
                if (this.encodeTable == STANDARD_ENCODE_TABLE) {
                    int i14 = context.pos;
                    context.pos = i14 + 1;
                    bArrEnsureBufferSize2[i14] = kotlin.io.encoding.Base64.padSymbol;
                    int i15 = context.pos;
                    context.pos = i15 + 1;
                    bArrEnsureBufferSize2[i15] = kotlin.io.encoding.Base64.padSymbol;
                }
            } else if (i11 == 2) {
                int i16 = context.pos;
                context.pos = i16 + 1;
