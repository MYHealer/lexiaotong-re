    ...
    private static Map<String, List<Rule>> parseRules(Scanner scanner, String str) {
        ...
        while (scanner.hasNextLine()) {
            ...
            if (z) {
                ...
                int iIndexOf = strNextLine.indexOf(UrlConst.PRD_KEY);
                ...
                if (strTrim.length() == 0) {
                    ...
                    if (strTrim2.contains(PPSLabelView.Code)) {
                    ...
                    try {
                        Rule rule = new Rule(stripQuotes(strArrSplit[0]), stripQuotes(strArrSplit[1]), stripQuotes(strArrSplit[2]), parsePhonemeExpr(stripQuotes(strArrSplit[3])), i, str) { // from class: org.apache.commons.codec.language.bm.Rule.2
