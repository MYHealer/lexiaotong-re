...
public class PhoneticEngine {
    ...
    static {
        ...
        enumMap.put(NameType.SEPHARDIC, Collections.unmodifiableSet(new HashSet(Arrays.asList("al", t.n, "da", "dal", "de", "del", "dela", "de la", "della", "des", "di", "do", "dos", d.W, "van", "von"))));
        enumMap.put(NameType.GENERIC, Collections.unmodifiableSet(new HashSet(Arrays.asList("da", "dal", "de", "del", "dela", "de la", "della", "des", "di", "do", "dos", d.W, "van", "von"))));
    }
    ...
    public String encode(String str, Languages.LanguageSet languageSet) {
        ...
        if (this.nameType == NameType.GENERIC) {
            if (strTrim.length() >= 2 && strTrim.substring(0, 2).equals("d'")) {
                ...
                return "(" + encode(strSubstring) + ")-(" + encode(t.t + strSubstring) + ")";
            }
            for (String str2 : NAME_PREFIXES.get(this.nameType)) {
                if (strTrim.startsWith(str2 + PPSLabelView.Code)) {
        ...
        if (this.concat) {
            strJoin = join(arrayList, PPSLabelView.Code);
            ...
            while (it2.hasNext()) {
                sb.append(x.A).append(encode((String) it2.next()));
            }
