...
public class Lang {
    ...
    private static final class LangRule {
        ...
        /* synthetic */ LangRule(Pattern pattern, Set set, boolean z, AnonymousClass1 anonymousClass1) {
            this(pattern, set, z);
        }
                    ...
                    if (scanner.hasNextLine()) {
                        ...
                        if (z) {
                            ...
                            if (strTrim.length() != 0) {
                                ...
                                arrayList.add(new LangRule(Pattern.compile(strArrSplit[0]), new HashSet(Arrays.asList(strArrSplit[1].split("\\+"))), strArrSplit[2].equals(ez.Code), null));
                            }
                        }
                    } else {
                        scanner.close();
