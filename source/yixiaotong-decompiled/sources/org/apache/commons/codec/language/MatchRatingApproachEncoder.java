...
public class MatchRatingApproachEncoder implements StringEncoder {
    private static final String[] DOUBLE_CONSONANT = {"BB", "CC", "DD", "FF", "GG", "HH", "JJ", "KK", "LL", "MM", "NN", "PP", ld.Code, "RR", "SS", GlobalSetting.TT_SDK_WRAPPER, "VV", "WW", "XX", "YY", "ZZ"};
    ...
    public boolean isEncodeEquals(String str, String str2) {
        ...
        return leftToRightThenRightToLeftProcessing(first3Last3, first3Last4) >= getMinRating(Math.abs(first3Last3.length() + first3Last4.length()));
    }
    ...
    String removeVowels(String str) {
        ...
        String strReplaceAll = str.replaceAll("A", "").replaceAll(ExifInterface.LONGITUDE_EAST, "").replaceAll("I", "").replaceAll("O", "").replaceAll("U", "").replaceAll("\\s{2,}\\b", " ");
