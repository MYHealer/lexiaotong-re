...
public class FileSystemUtils {
    ...
    long freeSpaceUnix(String str, boolean z, boolean z2, long j) throws Throwable {
        ...
        StringTokenizer stringTokenizer = new StringTokenizer(listPerformCommand.get(1), PPSLabelView.Code);
        if (stringTokenizer.countTokens() < 4) {
            if (stringTokenizer.countTokens() == 1 && listPerformCommand.size() >= 3) {
                stringTokenizer = new StringTokenizer(listPerformCommand.get(2), PPSLabelView.Code);
            } else {
